...
export default (function(native1, native2, native3, native4, native5, native6, native7) {
    ...
    var5 = '../discord_common/js/packages/rtn-codegen/js/TTIMeasurementNativeComponent.tsx';
