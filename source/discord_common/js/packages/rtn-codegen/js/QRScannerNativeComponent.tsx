...
export default (function(_, argBar, __, ___, ____, argFre, argPlu) {
    ...
    entity = {};
    report = {};
    option = 'onQRCodeFound';
    report['registrationName'] = option;
    entity['topQRCodeFound'] = report;
    ...
    report = '../discord_common/js/packages/rtn-codegen/js/QRScannerNativeComponent.tsx';
