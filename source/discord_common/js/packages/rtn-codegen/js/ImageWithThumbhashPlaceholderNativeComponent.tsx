...
export default (function(native1, native2, native3, native4, native5, native6, native7) {
    ...
    var2 = {};
    var9 = 'DCDImageWithThumbhashPlaceholderView';
    var2['uiViewClassName'] = var9;
    var1 = {'uri': true, 'placeholder': true, 'placeholderVersion': true, 'alt': true};
    ...
    var5 = '../discord_common/js/packages/rtn-codegen/js/ImageWithThumbhashPlaceholderNativeComponent.tsx';
