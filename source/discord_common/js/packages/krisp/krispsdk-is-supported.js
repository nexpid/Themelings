...
module.exports = (function(_, argBar, __, ___, argGrault, ____, argPlugh) {
 ...
 0:
            ...
            oscar = zulu == tango;
            entity = undefined;
            if(oscar) { _fun51157_ip = 25; continue _fun51157 }
 19:
            entity = tango.vendor;
 25:
            if(!entity) { _fun51157_ip = 82; continue _fun51157 }
 28:
            oscar = mike.navigator;
            golf = zulu == oscar;
            tango = undefined;
            if(golf) { _fun51157_ip = 72; continue _fun51157 }
 43:
            oscar = oscar.vendor;
            zulu = zulu == oscar;
            tango = undefined;
            if(zulu) { _fun51157_ip = 72; continue _fun51157 }
 58:
 ...
 72:
            ...
            entity = tango > zulu;
 82:
            if(!entity) { _fun51157_ip = 97; continue _fun51157 }
 85:
            zulu = mike.navigator;
            entity = zulu.userAgent;
 97:
            if(!entity) { _fun51157_ip = 138; continue _fun51157 }
 100:
            zulu = mike.navigator;
            ...
            entity = zulu == tango;
 138:
            if(!entity) { _fun51157_ip = 179; continue _fun51157 }
 141:
            mike = mike.navigator;
 ...
 0:
            ...
            mike = mike.userAgent;
            if(mike) { _fun51158_ip = 43; continue _fun51158 }
 17:
            tango = entity.navigator;
            zulu = null;
            report = zulu == tango;
            zulu = undefined;
            if(report) { _fun51158_ip = 40; continue _fun51158 }
 34:
            zulu = tango.vendor;
 40:
            mike = zulu;
 43:
            if(mike) { _fun51158_ip = 72; continue _fun51158 }
 46:
            zulu = entity.window;
            entity = null;
            tango = entity == zulu;
            entity = undefined;
            if(tango) { _fun51158_ip = 69; continue _fun51158 }
 63:
            entity = zulu.opera;
 69:
            mike = entity;
 72:
            ...
            golf = mike;
            if(entity) { _fun51158_ip = 126; continue _fun51158 }
 102:
 ...
 126:
            if(entity) { _fun51158_ip = 170; continue _fun51158 }
 129:
 ...
 0:
            ...
            entity = !entity;
            if(!entity) { _fun51159_ip = 38; continue _fun51159 }
 25:
            mike = mike.isMobile;
            mike = mike.bind(zulu)();
            entity = !mike;
