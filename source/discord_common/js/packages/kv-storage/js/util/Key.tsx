...
export default (function(argFoo, argBar, _, __, ___, argFred, argPlugh) {
 ...
 0:
            ...
            if(entity) { _fun37876_ip = 57; continue _fun37876 }
 27:
            entity = new Array(1);
            options = 0;
            offset = entity;
            ...
            zulu = 1;
            zulu = tango + zulu;
            _fun37876_ip = 86; continue _fun37876;
 57:
            zulu = new Array(0);
            options = 0;
            offset = zulu;
 ...
 86:
            tango = entity.length;
            zulu = 1;
            if(!(tango >= zulu)) { _fun37876_ip = 137; continue _fun37876 }
 98:
            tango = entity.length;
            ...
            if(!(!(tango <= zulu))) { _fun37876_ip = 217; continue _fun37876 }
 137:
            tango = mike.Error;
            golf = entity.length;
            report = mike.JSON;
 ...
 0:
            ...
            entity = zulu.isArray;
            entity = entity.bind(zulu)(report);
            if(entity) { _fun37877_ip = 57; continue _fun37877 }
 27:
            entity = new Array(1);
            options = 0;
            offset = entity;
            ...
            zulu = 1;
            zulu = tango + zulu;
            _fun37877_ip = 86; continue _fun37877;
 57:
            zulu = new Array(0);
            options = 0;
            offset = zulu;
 ...
 86:
            ...
            zulu = oscar.bind(zulu)(report);
            zulu = zulu.MAXIMUM_KEY_BITS;
            if(!(!(tango <= zulu))) { _fun37877_ip = 205; continue _fun37877 }
 125:
            tango = mike.Error;
            golf = entity.length;
            report = mike.JSON;
