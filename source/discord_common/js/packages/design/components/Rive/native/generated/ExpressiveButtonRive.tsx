...
export default (function(global, require, metroImportDefault, metroImportAll, moduleObject, exports, dependencyMap) {
    ...
    var4 = {};
    var8 = {'posy': 'number', 'posx': 'number', 'buttonColor': 'color', 'cornerRadius': 'number', 'pressed': 'boolean'};
    var4['Mobile Expressive Button Lightmode'] = var8;
    var8 = {'posy': 'number', 'posx': 'number', 'buttonColor': 'color', 'cornerRadius': 'number', 'pressed': 'boolean'};
    var4['Ambient_Lightmode'] = var8;
    var8 = {'posy': 'number', 'posx': 'number', 'buttonColor': 'color', 'cornerRadius': 'number', 'pressed': 'boolean'};
    var4['Mobile Expressive Button Dark Mode'] = var8;
    var8 = {'posy': 'number', 'posx': 'number', 'buttonColor': 'color', 'cornerRadius': 'number', 'pressed': 'boolean'};
    var4['Ambient'] = var8;
...
case 4:
    ...
    var4 = '../discord_common/js/packages/design/components/Rive/native/generated/ExpressiveButtonRive.tsx';
    var4 = var5.bind(var6)(var4);
    var3['ExpressiveButtonRive'] = var2;
    return var1;
})();