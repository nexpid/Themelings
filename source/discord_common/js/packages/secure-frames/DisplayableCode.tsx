...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
 ...
 45:
            ...
            update = 10;
            echo = offset;
            entity = exponentiationOperator(update, echo);
            golf = undefined;
            ...
            mike = 0;
            entity = zulu;
            if(!foxtrot) { _fun00002_ip = 198; continue _fun00001 }
 96:
 ...
 117:
            ...
            sizing = mike + sizing;
            sizing = romeo[sizing];
            sizing = result.bind(golf)(sizing);
            kilo = output | sizing;
            backup = backup - 1;
            foxtrot = kilo;
 ...
 158:
            ...
            foxtrot = backup.padStart;
            foxtrot = foxtrot.bind(backup)(offset, report);
            zulu = zulu + foxtrot;
            mike = mike + offset;
            entity = zulu;
            if(mike < yankee) { _fun00002_ip = 96; continue _fun00001 }
 198:
            return entity;
 200:
            entity = global;
