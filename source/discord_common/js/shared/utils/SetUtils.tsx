...
export default (function(argFoo, argBar, _, __, ___, argFre, argPlu) {
 ...
 0:
            michal = argFoo;
            report = argBar;
            if(!(michal !== report)) { _fun00008_ip = 95; continue _fun00007 }
 10:
            zuuluu = michal.size;
            entity = report.size;
 ...
 0:
            tangon = argFoo;
            entity = null;
            if(!(entity != tangon)) { _fun00010_ip = 58; continue _fun00009 }
 9:
            michal = global;
            entity = michal.Set;
            zuuluu = tangon instanceof entity;
            entity = tangon;
