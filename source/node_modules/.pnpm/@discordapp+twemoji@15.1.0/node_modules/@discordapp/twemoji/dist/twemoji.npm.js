...
module.exports = (function(argFoo, argBar, _, __, argGra, ___, argPlu) {
 ...
 0:
                    ...
                    tangon = 0;
                    michal = oscard;
                    if(!(report < tangon)) { _fun00008_ip = 53; continue _fun00007 }
 34:
 ...
 0:
                    ...
                    tangon = undefined;
                    zuuluu = undefined;
                    if(!michal) { _fun00010_ip = 631; continue _fun00009 }
 76:
                    ...
                    cntext = 0;
                    oscard = record;
                    if(!vacuum) { _fun00010_ip = 558; continue _fun00009 }
 149:
 ...
 190:
                    ...
                    variable39 = status;
                    whisks = record;
                    if(!quebec) { _fun00010_ip = 473; continue _fun00009 }
 242:
                    variable41 = limora;
                    variable40 = sierra;
                    variable39 = status;
                    whisks = record;
                    if(!equals) { _fun00010_ip = 473; continue _fun00009 }
 260:
 ...
 427:
                    ...
                    whisks = variable42;
 473:
                    if(whisks) { _fun00010_ip = 497; continue _fun00009 }
 476:
 ...
 558:
                    if(!michal) { _fun00010_ip = 619; continue _fun00009 }
 561:
                    michal = papara.length;
                    if(!(cntext < michal)) { _fun00010_ip = 601; continue _fun00009 }
 570:
 ...
 0:
                        ...
                        entity = oscard;
                        if(!report) { _fun00012_ip = 346; continue _fun00011 }
 45:
                        entity = oscard;
                        if(!echoed) { _fun00012_ip = 346; continue _fun00011 }
 54:
                        result = '<img ';
 ...
 204:
                            ...
                            if(!result) { _fun00012_ip = 236; continue _fun00011 }
 221:
                            echoed = update.indexOf;
                            echoed = echoed.bind(update)(report);
                            result = zuuluu !== echoed;
 236:
                            if(!result) { _fun00012_ip = 262; continue _fun00011 }
 239:
