...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
            ...
            if(!(!(oscar < zulu))) { _fun44629_ip = 283; continue _fun44629 }
 140:
            zulu = 120;
            if(!(!(oscar < zulu))) { _fun44629_ip = 260; continue _fun44629 }
 147:
            zulu = 180;
            if(!(!(oscar < zulu))) { _fun44629_ip = 237; continue _fun44629 }
 154:
            zulu = 240;
            if(!(!(oscar < zulu))) { _fun44629_ip = 214; continue _fun44629 }
 161:
            zulu = 300;
            if(!(!(oscar < zulu))) { _fun44629_ip = 191; continue _fun44629 }
 171:
            oscar = new Array(3);
            oscar[0] = options;
            zulu = 0;
            oscar[1] = zulu;
            oscar[2] = golf;
            _fun44629_ip = 212; continue _fun44629;
 191:
            zulu = new Array(3);
            zulu[0] = golf;
            verify = 0;
            ...
            oscar = zulu;
 212:
            _fun44629_ip = 235; continue _fun44629;
 214:
            zulu = [0];
            zulu[1] = golf;
            zulu[2] = options;
            oscar = zulu;
 235:
            _fun44629_ip = 258; continue _fun44629;
 237:
            zulu = [0];
            zulu[1] = options;
            zulu[2] = golf;
            oscar = zulu;
 258:
            _fun44629_ip = 281; continue _fun44629;
 260:
            zulu = new Array(3);
            zulu[0] = golf;
            zulu[1] = options;
            ...
            oscar = zulu;
 281:
            _fun44629_ip = 304; continue _fun44629;
 283:
            zulu = new Array(3);
            zulu[0] = options;
            zulu[1] = golf;
 ...
 0:
                ...
                report = 15.5;
                zulu = oscar;
                if(!(!(mike > report))) { _fun44633_ip = 137; continue _fun44633 }
 127:
                mike = '0';
                zulu = mike + oscar;
 137:
                ...
                oscar = entity.green;
                mike = golf;
                if(!(!(oscar > report))) { _fun44633_ip = 168; continue _fun44633 }
 158:
                oscar = '0';
                mike = oscar + golf;
 168:
                ...
                zulu = entity.blue;
                entity = tango;
                if(!(!(zulu > report))) { _fun44633_ip = 195; continue _fun44633 }
 185:
                zulu = '0';
                entity = zulu + tango;
 195:
 ...
 0:
                ...
                oscar = 0;
                report = 0;
                if(!(mike > oscar)) { _fun44634_ip = 185; continue _fun44634 }
 149:
                backup = golf.Math;
                foxtrot = backup.abs;
                golf = offset * tango;
                ...
                report = mike / golf;
 185:
                if(!(oscar !== mike)) { _fun44634_ip = 280; continue _fun44634 }
 189:
                if(!(verify !== yankee)) { _fun44634_ip = 234; continue _fun44634 }
 193:
                if(!(options !== yankee)) { _fun44634_ip = 220; continue _fun44634 }
 197:
                golf = 0;
                if(!(entity === yankee)) { _fun44634_ip = 249; continue _fun44634 }
 203:
                yankee = options - entity;
                romeo = yankee / mike;
                yankee = 4;
                golf = romeo + yankee;
                _fun44634_ip = 249; continue _fun44634;
 220:
 ...
 249:
                ...
                entity['alpha'] = zulu;
                _fun44634_ip = 305; continue _fun44634;
 280:
                mike = {};
                mike['hue'] = oscar;
 ...
 0:
                ...
                report = entity / mike;
                mike = 0.03928;
                if(!(!(tango <= mike))) { _fun44635_ip = 110; continue _fun44635 }
 50:
                entity = global;
                options = entity.Math;
                golf = options.pow;
                ...
                _fun44635_ip = 124; continue _fun44635;
 110:
                entity = 12.92;
                zulu = tango / entity;
 124:
                entity = 0.2126;
                zulu = entity * zulu;
                if(!(!(oscar <= mike))) { _fun44635_ip = 202; continue _fun44635 }
 142:
                entity = global;
                options = entity.Math;
                golf = options.pow;
                ...
                _fun44635_ip = 216; continue _fun44635;
 202:
                entity = 12.92;
                tango = oscar / entity;
 216:
                entity = 0.7152;
                entity = entity * tango;
                if(!(!(report <= mike))) { _fun44635_ip = 294; continue _fun44635 }
 234:
                mike = global;
                golf = mike.Math;
                oscar = golf.pow;
                ...
                _fun44635_ip = 308; continue _fun44635;
 294:
                mike = 12.92;
                tango = report / mike;
 308:
 ...
 0:
                ...
                mike = null;
                if(!(mike == report)) { _fun44636_ip = 69; continue _fun44636 }
 30:
                report = tango.match;
                ...
                mike = mike != entity;
                entity = undefined;
                if(!mike) { _fun44636_ip = 67; continue _fun44636 }
 54:
                mike = zulu.parseHexString;
                entity = mike.bind(zulu)(tango);
 67:
                _fun44636_ip = 80; continue _fun44636;
 69:
 ...
 0:
                ...
                mike = this;
                entity = 'transparent';
                if(!(entity !== zulu)) { _fun44637_ip = 27; continue _fun44637 }
 14:
                entity = mike.parseColorFnString;
                entity = entity.bind(mike)(zulu);
                _fun44637_ip = 62; continue _fun44637;
 27:
                tango = _closure2_slot0;
 ...
 0:
                ...
                romeo = null;
                if(!(romeo != mike)) { _fun44638_ip = 345; continue _fun44638 }
 30:
                tango = [6, 8];
                zulu = tango.includes;
                mike = report.length;
                mike = zulu.bind(tango)(mike);
                if(mike) { _fun44638_ip = 345; continue _fun44638 }
 61:
                ...
                mike = 6;
                zulu = report;
                if(!(tango < mike)) { _fun44638_ip = 172; continue _fun44638 }
 95:
                ...
                mike = mike + tango;
                zulu = mike;
                if(!(romeo != entity)) { _fun44638_ip = 172; continue _fun44638 }
 164:
 ...
 172:
                ...
                if(!(romeo != offset)) { _fun44638_ip = 345; continue _fun44638 }
 204:
                ...
                yankee = offset[mike];
                yankee = romeo != yankee;
                if(!yankee) { _fun44638_ip = 311; continue _fun44638 }
 288:
                golf = golf.parseInt;
                mike = offset[mike];
 ...
 0:
                ...
                tango = null;
                if(!(tango == golf)) { _fun44639_ip = 33; continue _fun44639 }
 29:
                golf = new Array(0);
 33:
                ...
                if(!(tango != verify)) { _fun44639_ip = 74; continue _fun44639 }
 70:
                if(!(tango == offset)) { _fun44639_ip = 76; continue _fun44639 }
 74:
                return zulu;
 76:
 ...
 0:
                        ...
                        if(mike) { _fun44642_ip = 184; continue _fun44642 }
 43:
                        mike = entity[zulu];
                        entity = 'h';
                        if(!(entity === mike)) { _fun44642_ip = 109; continue _fun44642 }
 55:
                        mike = /turn$/;
                        entity = mike.test;
                        entity = entity.bind(mike)(report);
                        if(entity) { _fun44642_ip = 157; continue _fun44642 }
 82:
                        mike = /rad$/;
                        entity = mike.test;
                        entity = entity.bind(mike)(report);
                        if(entity) { _fun44642_ip = 126; continue _fun44642 }
 109:
                        entity = global;
                        mike = entity.parseFloat;
                        entity = undefined;
                        entity = mike.bind(entity)(report);
                        _fun44642_ip = 247; continue _fun44642;
 126:
                        mike = global;
 ...
 184:
                        mike = 3;
                        if(!(mike !== zulu)) { _fun44642_ip = 222; continue _fun44642 }
 191:
                        mike = global;
                        ...
                        mike = 100;
                        mike = zulu / mike;
                        _fun44642_ip = 244; continue _fun44642;
 222:
                        zulu = global;
 ...
 247:
                ...
                mike = 'hsl';
                if(!(mike !== verify)) { _fun44639_ip = 242; continue _fun44639 }
 167:
                ...
                verify = typeof mike;
                mike = golf;
                if(!(backup === verify)) { _fun44639_ip = 208; continue _fun44639 }
 204:
                mike = tango[report];
 208:
