...
export default (function(argFoo, argBar, argBaz, _, __, argFre, argPlu) {
    ...
    golfie = tangon.GuildSettingsSubsections;
    var _closure1_slot6 = golfie;
    tangon = tangon.LinkingTypes;
    var _closure1_slot7 = tangon;
    tangon = 2;
    tangon = oscard[tangon];
    tangon = report.bind(entity)(tangon);
    tangon = tangon.UPDATE_CONFIG;
    var _closure1_slot8 = tangon;
    tangon = /feature\\/([\w-]+)/;
    var _closure1_slot9 = tangon;
    tangon = /feature\\/boost\\/([0-9]+)/;
    var _closure1_slot10 = tangon;
    tangon = /users\\/(\d+)/;
    var _closure1_slot11 = tangon;
    tangon = /(?:connect|oauth2)\\/authorize/;
    var _closure1_slot12 = tangon;
    tangon = /promos\.discord\.gg/;
    var _closure1_slot13 = tangon;
    tangon = /mweb-handoff/;
    var _closure1_slot14 = tangon;
    tangon = /connections\\/(xbox|playstation|playstation-stg|crunchyroll)\\/link/;
    var _closure1_slot15 = tangon;
    tangon = /connections\\/([a-z-]+)/;
    var _closure1_slot16 = tangon;
    tangon = /guilds\\/(\d+)\\/settings(?:\\/([a-z-]+)(?:\\/([a-z-]+))?)?/;
    var _closure1_slot17 = tangon;
    tangon = /guilds\\/settings(?:\\/([a-z-]+)(?:\\/([a-z-]+))?)?/;
    var _closure1_slot18 = tangon;
    tangon = /activate/;
    var _closure1_slot19 = tangon;
    tangon = /quests\\/(\d+)/;
    var _closure1_slot20 = tangon;
    tangon = function(argFoo) { // Original name: parseQuery
 ...
 63:
                    ...
                    michal = tangon;
                    if(!zuuluu) { _fun00004_ip = 101; continue _fun00003 }
 95:
                    zuuluu = 0;
 ...
 94: // catch_target0
    ...
    tangon = 'utils/native/parseURL.tsx';
    tangon = report.bind(oscard)(tangon);
    michal = function(argFoo) { // Original name: parseURL
        _fun00005: for(var _fun00006_ip = 0; ; ) switch(_fun00006_ip) {
 0:
            ctrled = arguments[1];
            yankee = undefined;
            if(!(ctrled === yankee)) { _fun00006_ip = 13; continue _fun00005 }
 11:
            ctrled = false;
 13:
            ...
            michal = tangon.sanitizeUrl;
            entity = argFoo;
            limora = michal.bind(tangon)(entity);
            backup = null;
            if(!(backup != limora)) { _fun00006_ip = 4532; continue _fun00005 }
 63:
            michal = _closure1_slot1;
 ...
 138:
            ...
            tangon = oscard.attemptId;
            romeon = oscard.custom_id;
            offset = oscard.referrer_id;
            verify = oscard.link_id;
 ...
 216:
            ...
            if(!(option !== golfie)) { _fun00006_ip = 4478; continue _fun00005 }
 260:
            option = oscard.type;
            sizing = _closure1_slot0;
            golfie = _closure1_slot2;
            ...
            if(!(option !== golfie)) { _fun00006_ip = 4433; continue _fun00005 }
 301:
            option = oscard.type;
            sizing = _closure1_slot0;
            golfie = _closure1_slot2;
            ...
            if(!(option !== golfie)) { _fun00006_ip = 4388; continue _fun00005 }
 342:
            option = oscard.type;
            sizing = _closure1_slot0;
            golfie = _closure1_slot2;
 ...
 914:
            ...
            sizing = sizing.ACTIVITY;
            option['type'] = sizing;
            sizing = oscard.code;
            option['applicationId'] = sizing;
            option['customId'] = romeon;
            option['referrerId'] = offset;
            option['linkId'] = verify;
 ...
 978:
            ...
            golfie = option.bind(yankee)(golfie);
            golfie = golfie.findGiftCodes;
            verify = golfie.bind(yankee)(limora);
            golfie = verify.length;
            option = 0;
            if(!(!(golfie > option))) { _fun00006_ip = 4344; continue _fun00005 }
 1023:
 ...
 1059:
            ...
            if(!(!(golfie > option))) { _fun00006_ip = 4304; continue _fun00005 }
 1071:
 ...
 1105:
            ...
            if(!golfie) { _fun00006_ip = 2834; continue _fun00005 }
 1139:
            if(!(backup != whisks)) { _fun00006_ip = 2834; continue _fun00005 }
 1146:
            ...
            if(!(backup == romeon)) { _fun00006_ip = 4191; continue _fun00005 }
 1184:
            kiloes = whisks.match;
 ...
 1203:
            ...
            sizing = 1;
            if(!(!(golfie > sizing))) { _fun00006_ip = 4147; continue _fun00005 }
 1218:
            kiloes = whisks.match;
 ...
 1237:
            ...
            result = 1;
            if(!(!(golfie > result))) { _fun00006_ip = 4104; continue _fun00005 }
 1252:
            kiloes = whisks.match;
 ...
 1271:
            ...
            source = kiloes.bind(yankee)(golfie);
 ...
 1310:
            ...
            if(!(backup == source)) { _fun00006_ip = 4044; continue _fun00005 }
 1322:
            kiloes = whisks.match;
 ...
 1341:
            ...
            golfie = 1;
            if(!(!(vacuum > golfie))) { _fun00006_ip = 4001; continue _fun00005 }
 1356:
            sequen = whisks.match;
            vacuum = _closure1_slot9;
            sequen = sequen.bind(whisks)(vacuum);
            if(!(backup != sequen)) { _fun00006_ip = 2667; continue _fun00005 }
 1378:
            record = sequen.length;
            vacuum = 1;
            if(!(record > vacuum)) { _fun00006_ip = 2667; continue _fun00005 }
 1393:
            record = sequen[vacuum];
            vacuum = 'composeMessage';
            if(!(vacuum !== record)) { _fun00006_ip = 2641; continue _fun00005 }
 1410:
            vacuum = 'contactSync';
            if(!(vacuum !== record)) { _fun00006_ip = 2620; continue _fun00005 }
 1423:
            vacuum = 'addFriends';
            if(!(vacuum !== record)) { _fun00006_ip = 2599; continue _fun00005 }
 1436:
            vacuum = 'friends';
            if(!(vacuum !== record)) { _fun00006_ip = 2546; continue _fun00005 }
 1447:
            vacuum = 'editProfile';
            if(!(vacuum !== record)) { _fun00006_ip = 2525; continue _fun00005 }
 1460:
            vacuum = 'voiceChannel';
            if(!(vacuum !== record)) { _fun00006_ip = 2431; continue _fun00005 }
 1471:
            vacuum = 'sessionManagement';
            if(!(vacuum !== record)) { _fun00006_ip = 2407; continue _fun00005 }
 1484:
            vacuum = 'home';
            if(!(vacuum !== record)) { _fun00006_ip = 2330; continue _fun00005 }
 1495:
            vacuum = 'icymi';
            if(!(vacuum !== record)) { _fun00006_ip = 2306; continue _fun00005 }
 1506:
            vacuum = 'connections';
            if(!(vacuum !== record)) { _fun00006_ip = 2251; continue _fun00005 }
 1517:
            vacuum = 'family-center';
            if(!(vacuum !== record)) { _fun00006_ip = 2222; continue _fun00005 }
 1530:
            vacuum = 'promo-url';
            if(!(vacuum !== record)) { _fun00006_ip = 2154; continue _fun00005 }
 1543:
            vacuum = 'account-standing';
            if(!(vacuum !== record)) { _fun00006_ip = 2125; continue _fun00005 }
 1556:
            vacuum = 'open-shop';
            if(!(vacuum !== record)) { _fun00006_ip = 2101; continue _fun00005 }
 1569:
            vacuum = 'authorized-apps';
            if(!(vacuum !== record)) { _fun00006_ip = 2077; continue _fun00005 }
 1582:
            vacuum = 'share';
            if(!(vacuum !== record)) { _fun00006_ip = 1850; continue _fun00005 }
 1593:
            vacuum = 'dave-protocol-verification';
            if(!(vacuum !== record)) { _fun00006_ip = 1706; continue _fun00005 }
 1603:
            vacuum = 'gift';
            if(!(vacuum !== record)) { _fun00006_ip = 1682; continue _fun00005 }
 1611:
            vacuum = 'store';
            if(!(vacuum !== record)) { _fun00006_ip = 1658; continue _fun00005 }
 1619:
            sequen = 'connected-games';
            vacuum = null;
            if(!(sequen === record)) { _fun00006_ip = 2660; continue _fun00005 }
 1634:
            sequen = {};
            ...
            sequen['type'] = record;
            vacuum = sequen;
            _fun00006_ip = 2660; continue _fun00005;
 1658:
            sequen = {};
            record = _closure1_slot7;
 ...
 1706:
            ...
            sequen = entity;
            if(!cntext) { _fun00006_ip = 1723; continue _fun00005 }
 1720:
            sequen = foxtra;
 1723:
            ...
            vacuum = null;
            if(!sequen) { _fun00006_ip = 2660; continue _fun00005 }
 1751:
 ...
 1763:
            ...
            sierra = status.bind(yankee)(sequen);
            status = sierra.getSecureFramesDeeplinkExperiment;
            sequen = {};
            equals = 'parseUrl';
            sequen['location'] = equals;
 ...
 1888:
            ...
            cntext = backup != foxtra;
            sequen = entity;
            if(!cntext) { _fun00006_ip = 1905; continue _fun00005 }
 1902:
            sequen = foxtra;
 1905:
            record = record.bind(yankee)(sequen);
            ...
            sequen = record.shareId;
            quebec = record.attachmentManifest;
            equals = function(argFoo) { // Original name: isValidUUID
                zuuluu = /^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/i;
                michal = zuuluu.test;
                entity = argFoo;
                entity = michal.bind(zuuluu)(entity);
                return entity;
            };
            _closure2_slot0 = equals;
            sierra = 'string';
            variable36 = typeof sequen;
            record = undefined;
            if(!(sierra === variable36)) { _fun00006_ip = 1967; continue _fun00005 }
 1954:
            equals = equals.bind(yankee)(sequen);
            record = undefined;
            if(!equals) { _fun00006_ip = 1967; continue _fun00005 }
 1964:
            record = sequen;
 1967:
            sequen = typeof quebec;
            if(!(sierra !== sequen)) { _fun00006_ip = 1978; continue _fun00005 }
 1974:
            equals = {};
            _fun00006_ip = 1997; continue _fun00005;
 1978:
            sequen = global;
            sierra = sequen.JSON;
            sequen = sierra.parse;
 ...
 1997:
            ...
            equals = sequen.bind(sierra)(equals);
            sierra = equals.reduce;
            sequen = function(argFoo, argBar) {
                _fun00007: for(var _fun00008_ip = 0; ; ) switch(_fun00008_ip) {
 0:
                    entity = argFoo;
                    golfie = argBar;
                    tangon = golfie[Symbol.iterator];
                    golfie = tangon().next;
                    michal = golfie().value;
                    zuuluu = tangon;
                    report = undefined;
                    ...
                    zuuluu = undefined;
                    if(oscard) { _fun00008_ip = 30; continue _fun00007 }
 27:
                    zuuluu = michal;
 30:
                    michal = undefined;
                    if(oscard) { _fun00008_ip = 60; continue _fun00007 }
 35:
                    option = golfie().value;
                    golfie = tangon;
 ...
 99:
            ...
            update = {};
            sequen = sierra.bind(equals)(sequen, update);
            update = {};
 ...
 2154:
            ...
            update = entity;
            if(!record) { _fun00006_ip = 2171; continue _fun00005 }
 2168:
            update = foxtra;
 2171:
            ...
            vacuum = null;
            if(!(yankee !== sequen)) { _fun00006_ip = 2660; continue _fun00005 }
 2193:
            update = {};
            record = _closure1_slot7;
 ...
 2251:
            ...
            record = backup != foxtra;
            update = entity;
            if(!record) { _fun00006_ip = 2268; continue _fun00005 }
 2265:
            update = foxtra;
 2268:
            update = sequen.bind(yankee)(update);
 ...
 2330:
            ...
            record = backup != foxtra;
            update = entity;
            if(!record) { _fun00006_ip = 2347; continue _fun00005 }
 2344:
            update = foxtra;
 2347:
            update = sequen.bind(yankee)(update);
            ...
            sequen = update.highlight_message_id;
            update = {};
            status = _closure1_slot7;
            status = status.GUILD_HOME;
            update['type'] = status;
            update['guildId'] = cntext;
 ...
 2431:
            ...
            record = backup != foxtra;
            update = entity;
            if(!record) { _fun00006_ip = 2448; continue _fun00005 }
 2445:
            update = foxtra;
 2448:
            update = sequen.bind(yankee)(update);
            ...
            cntext = update.user_id;
            record = update.via;
            sequen = update.action;
            update = {};
            equals = _closure1_slot7;
            equals = equals.VOICE_CHANNEL;
            update['type'] = equals;
            update['guildId'] = sierra;
            update['channelId'] = status;
            update['userId'] = cntext;
            update['via'] = record;
 ...
 2546:
            ...
            record = backup != foxtra;
            update = entity;
            if(!record) { _fun00006_ip = 2563; continue _fun00005 }
 2560:
            update = foxtra;
 2563:
            update = sequen.bind(yankee)(update);
 ...
 2641:
            ...
            vacuum = update;
 2660:
            if(!(backup == vacuum)) { _fun00006_ip = 3982; continue _fun00005 }
 2667:
            ...
            if(!(backup == config)) { _fun00006_ip = 3916; continue _fun00005 }
 2702:
            sequen = whisks.match;
            update = _closure1_slot14;
            update = sequen.bind(whisks)(update);
            if(!(backup == update)) { _fun00006_ip = 3583; continue _fun00005 }
 2724:
            sequen = whisks.match;
            update = _closure1_slot15;
            sequen = sequen.bind(whisks)(update);
            if(!(backup == sequen)) { _fun00006_ip = 3481; continue _fun00005 }
 2746:
            record = whisks.match;
            update = _closure1_slot16;
            cntext = record.bind(whisks)(update);
            if(!(backup == cntext)) { _fun00006_ip = 3377; continue _fun00005 }
 2768:
            record = whisks.match;
            update = _closure1_slot17;
            record = record.bind(whisks)(update);
            if(!(backup == record)) { _fun00006_ip = 3248; continue _fun00005 }
 2790:
            status = whisks.match;
            update = _closure1_slot18;
            status = status.bind(whisks)(update);
            if(!(backup == status)) { _fun00006_ip = 3094; continue _fun00005 }
 2812:
            sierra = whisks.match;
            update = _closure1_slot19;
            update = sierra.bind(whisks)(update);
            if(!(backup == update)) { _fun00006_ip = 3013; continue _fun00005 }
 2834:
            sierra = backup == target;
            update = undefined;
            if(sierra) { _fun00006_ip = 2858; continue _fun00005 }
 2843:
            whisks = target.match;
            sierra = _closure1_slot13;
            update = whisks.bind(target)(sierra);
 2858:
            if(!(backup == update)) { _fun00006_ip = 2971; continue _fun00005 }
 2862:
            update = _closure1_slot8;
            sierra = backup == update;
            update = undefined;
            if(sierra) { _fun00006_ip = 2890; continue _fun00005 }
 2875:
            sierra = _closure1_slot8;
            sierra = sierra.url;
            update = sierra.host;
 2890:
            if(!(target !== update)) { _fun00006_ip = 2929; continue _fun00005 }
 2894:
            update = {};
            ...
            _fun00006_ip = 2969; continue _fun00005;
 2929:
            target = {};
            ...
            whisks = whisks.MOBILE_NATIVE_UPDATE;
            sierra['type'] = whisks;
            sierra['url'] = limora;
            target['payload'] = sierra;
            update = target;
 2969:
            _fun00006_ip = 3011; continue _fun00005;
 2971:
            target = {};
            target['fingerprint'] = michal;
            target['attemptId'] = tangon;
 ...
 3013:
            ...
            update = entity;
            if(!limora) { _fun00006_ip = 3038; continue _fun00005 }
 3035:
            update = foxtra;
 3038:
 ...
 3094:
            ...
            update = 1;
            variable37 = target[update];
            update = 2;
            whisks = target[update];
            target = _closure1_slot21;
            status = backup != foxtra;
            update = entity;
            if(!status) { _fun00006_ip = 3138; continue _fun00005 }
 3135:
            update = foxtra;
 3138:
            update = target.bind(yankee)(update);
            ...
            target = {};
            sierra = _closure1_slot7;
            sierra = sierra.GUILD_SETTINGS_PICKER;
            target['type'] = sierra;
            limora = _closure1_slot1;
            equals = _closure1_slot2;
            sierra = 17;
            quebec = equals[sierra];
            variable36 = limora.bind(yankee)(quebec);
            quebec = _closure1_slot5;
            quebec = variable36.bind(yankee)(quebec, variable37);
            target['settingsSection'] = quebec;
            sierra = equals[sierra];
            limora = limora.bind(yankee)(sierra);
            sierra = _closure1_slot6;
            sierra = limora.bind(yankee)(sierra, whisks);
            target['settingsSubsection'] = sierra;
 ...
 3248:
            ...
            target = target.GUILD_SETTINGS;
            record['type'] = target;
            record['guildId'] = papara;
            target = _closure1_slot1;
            sierra = _closure1_slot2;
            papara = 17;
            limora = sierra[papara];
            whisks = target.bind(yankee)(limora);
            limora = _closure1_slot5;
            limora = whisks.bind(yankee)(limora, equals);
            record['settingsSection'] = limora;
            papara = sierra[papara];
            target = target.bind(yankee)(papara);
            papara = _closure1_slot6;
            papara = target.bind(yankee)(papara, status);
 ...
 3377:
            ...
            update = entity;
            if(!target) { _fun00006_ip = 3426; continue _fun00005 }
 3423:
            update = foxtra;
 3426:
            ...
            record = {};
            target = _closure1_slot7;
            target = target.USER_CONNECTIONS_CALLBACK;
            record['type'] = target;
            record['provider'] = papara;
 ...
 3481:
            ...
            update = entity;
            if(!papara) { _fun00006_ip = 3506; continue _fun00005 }
 3503:
            update = foxtra;
 3506:
            update = cntext.bind(yankee)(update);
            ...
            record = update.state;
            update = 1;
            papara = sequen[update];
            update = {};
            update['fingerprint'] = michal;
            update['attemptId'] = tangon;
            sequen = {};
            target = _closure1_slot7;
            target = target.USER_CONNECTIONS_LINK_CALLBACK;
            sequen['type'] = target;
            sequen['provider'] = papara;
            sequen['callbackCode'] = cntext;
 ...
 3583:
            ...
            sequen = sequen.bind(yankee)(foxtra);
            sequen = record.bind(yankee)(sequen);
            papara = sequen.key;
            target = sequen.redirect;
            status = sequen.fingerprint;
            if(!(backup != papara)) { _fun00006_ip = 3788; continue _fun00005 }
 3629:
            if(!(backup != target)) { _fun00006_ip = 3788; continue _fun00005 }
 3636:
            cntext = update.URL;
            sequen = update.location;
            sierra = sequen.protocol;
            sequen = update.window;
            sequen = sequen.GLOBAL_ENV;
            record = sequen.WEBAPP_ENDPOINT;
            sequen = update.HermesInternal;
            sequen = sequen.concat;
            variable39 = sequen.bind(entity)(sierra, record);
            record = cntext.prototype;
            record = Object.create(record, {constructor: {value: cntext}});
            variable41 = record;
            variable40 = target;
            sequen = new variable41[cntext](variable40, variable39, variable38);
            cntext = sequen instanceof Object ? sequen : record;
            if(!(backup != status)) { _fun00006_ip = 3738; continue _fun00005 }
 3716:
 ...
 3738:
            ...
            record = {};
            target = _closure1_slot7;
            target = target.MOBILE_WEB_HANDOFF;
            record['type'] = target;
            record['nonce'] = papara;
            record['redirectUrl'] = cntext;
 ...
 3788:
            ...
            target = record.bind(yankee)(sequen);
            papara = target.track;
            sequen = _closure1_slot4;
            cntext = sequen.MOBILE_WEB_HANDOFF_FAILURE;
            record = {};
            sequen = 'invalid_query_params';
            record['reason'] = sequen;
            sierra = _closure1_slot0;
            sequen = 16;
            sequen = limora[sequen];
            sierra = sierra.bind(yankee)(sequen);
            sequen = sierra.maybeExtractId;
            sequen = sequen.bind(sierra)(status);
            record['fingerprint'] = sequen;
            sequen = {};
            sequen['fingerprint'] = status;
            sequen = papara.bind(target)(cntext, record, sequen);
            record = update.Error;
            update = record.prototype;
            sequen = Object.create(update, {constructor: {value: record}});
            variable40 = 'Missing nonce or redirect query params';
            variable41 = sequen;
 ...
 3916:
            ...
            sequen = {};
            record = _closure1_slot7;
            record = record.GUILD_EVENT_DETAILS;
            sequen['type'] = record;
            record = config.guildEventId;
            sequen['guildEventId'] = record;
            record = config.guildId;
            sequen['guildId'] = record;
            config = config.recurrenceId;
 ...
 4044:
            ...
            update = update.OAUTH2_AUTHORIZE;
            kiloes['type'] = update;
            update = {};
            variable40 = update;
            variable39 = source;
 ...
 4191:
            ...
            if(!kiloes) { _fun00006_ip = 4205; continue _fun00005 }
 4202:
            entity = foxtra;
 4205:
            ...
            if(!(backup == foxtra)) { _fun00006_ip = 4251; continue _fun00005 }
 4239:
