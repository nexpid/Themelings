...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    mike = function(argFoo) { // Original name: I18nLink
        _fun122773: for(var _fun122773_ip = 0; ; ) switch(_fun122773_ip) {
 0:
            entity = argFoo;
            report = entity.node;
            ...
            options = zulu.alwaysShowLinkDecorations;
            zulu = _closure1_slot6;
            options = zulu.bind(tango)(options);
            zulu = report.context;
            offset = null;
            if(!(offset != zulu)) { _fun122773_ip = 147; continue _fun122773 }
 100:
            yankee = report.context;
            zulu = report.target;
            zulu = yankee[zulu];
            if(!zulu) { _fun122773_ip = 127; continue _fun122773 }
 118:
            yankee = zulu.onClick;
            if(yankee) { _fun122773_ip = 135; continue _fun122773 }
 127:
            verify['onClick'] = zulu;
            _fun122773_ip = 147; continue _fun122773;
 135:
            zulu = zulu.onClick;
            verify['onClick'] = zulu;
 147:
            zulu = verify.onClick;
            if(!(offset == zulu)) { _fun122773_ip = 170; continue _fun122773 }
 157:
            mike = function() {
 ...
 170:
    ...
    report = {};
    options = {};
    verify = verify.PRIMARY_SEMIBOLD;
    options['fontFamily'] = verify;
    report['strong'] = options;
    options = {};
    verify = 'italic';
    options['fontStyle'] = verify;
    report['italic'] = options;
    options = {};
    verify = 'underline';
    options['textDecorationLine'] = verify;
    report['underline'] = options;
    ...
    report = function(argFoo) {
        _fun122775: for(var _fun122775_ip = 0; ; ) switch(_fun122775_ip) {
 0:
            entity = {};
            mike = {};
            report = _closure1_slot1;
            ...
            zulu = 'none';
            tango = argFoo;
            if(!tango) { _fun122775_ip = 58; continue _fun122775 }
 54:
            zulu = 'underline';
 58:
    ...
    report = 'i18n/native/updateRules.tsx';
    report = oscar.bind(golf)(report);
    tango = function(argFoo) { // Original name: updateRules
        entity = argFoo;
        mike = {};
        oscar = entity.paragraph;
        golf = mike;
