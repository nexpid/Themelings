...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
 ...
 0:
                    ...
                    if(oscard) { _fun00014_ip = 918; continue _fun00013 }
 18:
 ...
 192: // try_start_0
                    ...
                    yankee = 18;
                    offset = 17;
                    if(golfie) { _fun00014_ip = 765; continue _fun00013 }
 407:
                    golfie = romeon;
                    golfie = golfie.value;
                    kiloes = golfie;
 ...
 460:
                    ...
                    if(option) { _fun00014_ip = 762; continue _fun00013 }
 469:
                    ...
                    if(!(!(golfie > option))) { _fun00014_ip = 708; continue _fun00013 }
 611:
                    output = foxtra;
                    result = sizing;
                    option = result.getMaxTotalAttachmentSize;
                    option = option.bind(result)();
                    if(!(!(output > option))) { _fun00014_ip = 654; continue _fun00013 }
 631:
                    option = backup;
                    option = option.bind(verify)();
                    romeon = option;
                    option = option.done;
                    if(option) { _fun00014_ip = 765; continue _fun00013 }
 649:
 ...
 851: // try_end2
                    return tangon;
 854: // catch_target0 // catch_target1 // catch_target2
 ...
 0:
                    ...
                    if(tangon) { _fun00020_ip = 953; continue _fun00019 }
 21:
 ...
 77:
                    ...
                    if(tangon) { _fun00020_ip = 950; continue _fun00019 }
 86:
 ...
 194: // try_start_0
                    ...
                    golfie = global;
                    offset = 17;
                    if(option) { _fun00020_ip = 767; continue _fun00019 }
 411:
                    option = romeon;
                    option = option.value;
                    kiloes = option;
 ...
 464:
                    ...
                    if(verify) { _fun00020_ip = 764; continue _fun00019 }
 473:
                    ...
                    verify = result.bind(echoed)(output, verify);
                    if(!(!(option > verify))) { _fun00020_ip = 711; continue _fun00019 }
 615:
                    output = foxtra;
                    result = sizing;
                    verify = result.getMaxTotalAttachmentSize;
                    verify = verify.bind(result)();
                    if(!(!(output > verify))) { _fun00020_ip = 658; continue _fun00019 }
 635:
                    verify = backup;
                    verify = verify.bind(zuuluu)();
                    romeon = verify;
                    verify = verify.done;
                    if(verify) { _fun00020_ip = 767; continue _fun00019 }
 653:
                    _fun00020_ip = 411; continue _fun00019;
 658:
 ...
 881: // try_end2
                    return report;
 884: // catch_target0 // catch_target1 // catch_target2
 ...
 15:
                    ...
                    if(zuuluu) { _fun00026_ip = 578; continue _fun00025 }
 31:
 ...
 112:
                    ...
                    if(report) { _fun00026_ip = 560; continue _fun00025 }
 121:
 ...
 198:
                    ...
                    if(verify) { _fun00026_ip = 557; continue _fun00025 }
 207:
                    verify = tangon.files;
                    offset = verify.length;
                    verify = 0;
                    if(!(verify !== offset)) { _fun00026_ip = 498; continue _fun00025 }
 227:
                    yankee = tangon.files;
                    offset = yankee.every;
                    ...
                    if(verify) { _fun00026_ip = 288; continue _fun00025 }
 252:
                    verify = global;
                    yankee = verify.Error;
 ...
 288:
                    ...
                    option = offset;
                    verify = null;
                    if(!(verify != offset)) { _fun00026_ip = 327; continue _fun00025 }
 309:
                    verify = option;
 ...
 496: // try_end1
                    _fun00026_ip = 588; continue _fun00025;
 498: // try_start_2
                    option = _closure1_slot19;
                    golfie = option.log;
                    offset = tangon.id;
 ...
 0:
                    ...
                    if(zuuluu) { _fun00028_ip = 599; continue _fun00027 }
 19:
                    zuuluu = undefined;
 ...
 47:
                    ResumeGenerator(result_out_reg=1, return_bool_out_reg=5);
                    if(oscard) { _fun00028_ip = 596; continue _fun00027 }
 56:
 ...
 162: // try_start_0
                    ...
                    if(!tangon) { _fun00028_ip = 211; continue _fun00027 }
 194:
 ...
 225:
                    ...
                    if(oscard) { _fun00028_ip = 565; continue _fun00027 }
 234:
                    if(tangon) { _fun00028_ip = 240; continue _fun00027 }
 237: // try_end0
                    return zuuluu;
 240: // try_start_1
 ...
 311:
                    ...
                    if(offset) { _fun00028_ip = 562; continue _fun00027 }
 320:
                    offset = report.files;
                    foxtra = offset.length;
                    offset = 0;
                    if(!(offset === foxtra)) { _fun00028_ip = 352; continue _fun00027 }
 337:
                    offset = verify;
                    offset = offset.content;
                    if(!(yankee !== offset)) { _fun00028_ip = 513; continue _fun00027 }
 352:
                    foxtra = report.files;
                    yankee = foxtra.every;
                    ...
                    offset = global;
                    if(yankee) { _fun00028_ip = 415; continue _fun00027 }
 381:
                    backup = offset.Error;
 ...
 415:
                    ...
                    foxtra = romeon;
                    verify = null;
                    if(!(verify == foxtra)) { _fun00028_ip = 487; continue _fun00027 }
 477:
                    verify = report._defaultHandleRequestError;
                    _fun00028_ip = 490; continue _fun00027;
 487:
                    verify = romeon;
 490:
 ...
 501:
                    ResumeGenerator(result_out_reg=7, return_bool_out_reg=8);
                    if(verify) { _fun00028_ip = 510; continue _fun00027 }
 507: // try_end1
                    return option;
 510:
                    return option;
 ...
 0:
                ...
                michal = null;
                if(!(michal != backup)) { _fun00032_ip = 464; continue _fun00031 }
 24:
 ...
 54:
                kiloes = tangon;
 57:
                if(!(michal != kiloes)) { _fun00032_ip = 464; continue _fun00031 }
 64:
                tangon = kiloes.length;
                oscard = 0;
                if(!(oscard !== tangon)) { _fun00032_ip = 464; continue _fun00031 }
 78:
 ...
 143:
                ...
                if(!(tangon === michal)) { _fun00032_ip = 464; continue _fun00031 }
 185:
                foxtra = new Array(0);
 ...
 0:
                        ...
                        entity = zuuluu.id;
                        report = null;
                        if(!(report != entity)) { _fun00034_ip = 290; continue _fun00033 }
 23:
 ...
 72:
                        ...
                        tangon = undefined;
                        if(oscard) { _fun00034_ip = 204; continue _fun00033 }
 199:
                        tangon = michal.item;
 204:
                        tangon = report != tangon;
                        if(!tangon) { _fun00034_ip = 233; continue _fun00033 }
 211:
                        oscard = report == michal;
                        golfie = undefined;
                        if(oscard) { _fun00034_ip = 225; continue _fun00033 }
 220:
                        golfie = michal.item;
 225:
 ...
 233:
                        if(!tangon) { _fun00034_ip = 260; continue _fun00033 }
 236:
                        oscard = report == michal;
                        zuuluu = undefined;
                        if(oscard) { _fun00034_ip = 256; continue _fun00033 }
 245:
                        oscard = michal.item;
 ...
 260:
                        zuuluu = false;
                        if(!tangon) { _fun00034_ip = 276; continue _fun00033 }
 265:
                        michal = michal.item;
 ...
 290:
                ...
                if(!report) { _fun00032_ip = 448; continue _fun00031 }
 430:
                oscard = {};
 ...
 0:
                    ...
                    if(!(zuuluu === michal)) { _fun00038_ip = 92; continue _fun00037 }
 55:
                    michal = 0;
 ...
 0:
                    ...
                    if(!michal) { _fun00040_ip = 368; continue _fun00039 }
 43:
                    michal = _closure3_slot0;
                    ...
                    tangon = 100;
                    if(!(!(golfie >= tangon))) { _fun00040_ip = 243; continue _fun00039 }
 145:
                    ...
                    oscard['_file'] = michal;
                    _fun00040_ip = 340; continue _fun00039;
 243:
                    ...
                    oscard = michal.items;
                    michal = null;
                    if(!(michal != oscard)) { _fun00040_ip = 290; continue _fun00039 }
 273:
 ...
 0:
                    ...
                    oscard = this;
                    ResumeGenerator(result_out_reg=0, return_bool_out_reg=1);
                    if(michal) { _fun00042_ip = 1335; continue _fun00041 }
 18:
                    var _closure4_slot0 = oscard;
                    romeon = source;
                    verify = argBar;
 ...
 230: // try_start_0
                    ...
                    foxtra = output;
                    yankee = null;
                    if(!(yankee != output)) { _fun00042_ip = 269; continue _fun00041 }
 251:
                    result = foxtra;
 ...
 146:
                    ...
                    foxtra = output.bind(result)(foxtra);
                    if(foxtra) { _fun00042_ip = 981; continue _fun00041 }
 849:
                    foxtra = offset;
                    offset = {};
                    output = oscard._url;
 ...
 904:
                    ...
                    if(foxtra) { _fun00042_ip = 978; continue _fun00041 }
 910:
                    tangon = offset;
                    foxtra = romeon;
                    foxtra = foxtra.channel_id;
                    if(!(yankee != foxtra)) { _fun00042_ip = 973; continue _fun00041 }
 925:
 ...
 973: // try_end0
                    _fun00042_ip = 1236; continue _fun00041;
 978:
                    return offset;
 981: // try_start_1
                    foxtra = _closure1_slot19;
                    ...
                    offset = verify;
                    if(!(yankee != offset)) { _fun00042_ip = 1032; continue _fun00041 }
 1009:
                    foxtra = verify;
                    romeon = {};
                    yankee = 500;
 ...
 1050: // catch_target0 // catch_target1
                    ...
                    if(offset) { _fun00042_ip = 1309; continue _fun00041 }
 1064:
                    offset = backup;
                    yankee = offset.status;
                    offset = 400;
                    if(!(yankee >= offset)) { _fun00042_ip = 1123; continue _fun00041 }
 1082:
                    yankee = verify;
                    offset = null;
                    if(!(offset != yankee)) { _fun00042_ip = 1123; continue _fun00041 }
 1091:
                    yankee = verify;
                    verify = backup;
                    offset = verify.body;
 ...
 1123:
                    ...
                    sizing = undefined;
                    if(option) { _fun00042_ip = 1154; continue _fun00041 }
 1146:
                    option = backup;
 ...
 1154:
                    ...
                    yankee = undefined;
                    if(kiloes) { _fun00042_ip = 1185; continue _fun00041 }
 1180:
                    yankee = backup.body;
 1185:
 ...
 1236:
                    ...
                    verify = undefined;
                    if(yankee) { _fun00042_ip = 1266; continue _fun00041 }
 1261:
                    verify = report.body;
 1266:
                    report = oscard.files;
                    ...
                    tangon = undefined;
                    if(option) { _fun00042_ip = 1301; continue _fun00041 }
 1296:
                    tangon = golfie.body;
 1301:
                    tangon = report.bind(oscard)(tangon);
