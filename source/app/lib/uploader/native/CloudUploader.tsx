...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
 ...
 0:
                    ...
                    if(oscard) { _fun00014_ip = 921; continue _fun00013 }
 18:
 ...
 198: // try_start_0
                    ...
                    config = undefined;
                    ctrled = report;
                    yankee = config[output](sequen, vacuum, ctrled, source, update);
 ...
 854: // try_end2
                    return tangon;
 857: // catch_target0 // catch_target1 // catch_target2
 ...
 0:
                    ...
                    if(tangon) { _fun00020_ip = 956; continue _fun00019 }
 21:
 ...
 198: // try_start_0
                    ...
                    verify['filename'] = echoed;
                    yankee = output.bind(result)(yankee, verify);
                    verify = new Array(2);
                    verify[0] = yankee;
                    verify[1] = option;
                    ...
                    golfie = global;
                    offset = 17;
                    if(option) { _fun00020_ip = 766; continue _fun00019 }
 409:
                    option = romeon;
                    option = option.value;
                    kiloes = option;
 ...
 463:
                    ...
                    if(verify) { _fun00020_ip = 763; continue _fun00019 }
 472:
                    ...
                    if(!(!(option > verify))) { _fun00020_ip = 710; continue _fun00019 }
 614:
                    output = foxtra;
                    result = sizing;
                    verify = result.getMaxTotalAttachmentSize;
                    verify = verify.bind(result)();
                    if(!(!(output > verify))) { _fun00020_ip = 657; continue _fun00019 }
 634:
                    verify = backup;
                    verify = verify.bind(zuuluu)();
                    romeon = verify;
                    verify = verify.done;
                    if(verify) { _fun00020_ip = 766; continue _fun00019 }
 652:
                    _fun00020_ip = 409; continue _fun00019;
 657:
 ...
 884: // try_end2
                    return report;
 887: // catch_target0 // catch_target1 // catch_target2
 ...
 0:
                    ...
                    tangon = this;
                    ResumeGenerator(result_out_reg=0, return_bool_out_reg=1);
                    if(michal) { _fun00026_ip = 595; continue _fun00025 }
 15:
                    michal = undefined;
                    option = undefined;
                    zuuluu = tangon._aborted;
                    if(zuuluu) { _fun00026_ip = 582; continue _fun00025 }
 31:
 ...
 112:
                    ...
                    if(report) { _fun00026_ip = 564; continue _fun00025 }
 121:
 ...
 198:
                    ...
                    if(verify) { _fun00026_ip = 561; continue _fun00025 }
 207:
                    verify = tangon.files;
                    offset = verify.length;
                    verify = 0;
                    if(!(verify !== offset)) { _fun00026_ip = 502; continue _fun00025 }
 227:
                    yankee = tangon.files;
                    offset = yankee.every;
 ...
 0:
                    ...
                    if(zuuluu) { _fun00028_ip = 603; continue _fun00027 }
 19:
                    zuuluu = undefined;
 ...
 47:
                    ResumeGenerator(result_out_reg=1, return_bool_out_reg=5);
                    if(oscard) { _fun00028_ip = 600; continue _fun00027 }
 56:
                    oscard = report._aborted;
                    if(oscard) { _fun00028_ip = 587; continue _fun00027 }
 68:
 ...
 313:
                    ...
                    if(offset) { _fun00028_ip = 566; continue _fun00027 }
 322:
                    offset = report.files;
 ...
 339:
                    ...
                    if(!(yankee !== offset)) { _fun00028_ip = 517; continue _fun00027 }
 354:
                    foxtra = report.files;
                    yankee = foxtra.every;
 ...
 419:
                    ...
                    foxtra = romeon;
                    verify = null;
                    if(!(verify == foxtra)) { _fun00028_ip = 491; continue _fun00027 }
 481:
                    verify = report._defaultHandleRequestError;
                    _fun00028_ip = 494; continue _fun00027;
 491:
                    verify = romeon;
 494:
 ...
 505:
                    ResumeGenerator(result_out_reg=7, return_bool_out_reg=8);
                    if(verify) { _fun00028_ip = 514; continue _fun00027 }
 511: // try_end1
                    return option;
 514:
                    return option;
 ...
 569:
                    return tangon;
 572: // catch_target0 // catch_target1 // catch_target2
 ...
 0:
                    ...
                    oscard = this;
                    ResumeGenerator(result_out_reg=0, return_bool_out_reg=1);
                    if(michal) { _fun00042_ip = 1343; continue _fun00041 }
 18:
                    var _closure4_slot0 = oscard;
                    romeon = source;
                    verify = argBar;
 ...
 977: // try_end0
                    _fun00042_ip = 1244; continue _fun00041;
 982:
                    return offset;
 985: // try_start_1
                    foxtra = _closure1_slot19;
                    ...
                    offset = verify;
                    if(!(yankee != offset)) { _fun00042_ip = 1038; continue _fun00041 }
 1013:
                    foxtra = verify;
                    romeon = {};
                    yankee = 500;
 ...
 1051: // try_end1
                    offset = undefined;
                    return offset;
 1056: // catch_target0 // catch_target1
                    CatchBlockStart(arg_register=13);
                    offset = oscard._aborted;
                    if(offset) { _fun00042_ip = 1317; continue _fun00041 }
 1070:
                    offset = backup;
                    yankee = offset.status;
                    offset = 400;
                    if(!(yankee >= offset)) { _fun00042_ip = 1131; continue _fun00041 }
 1088:
                    yankee = verify;
                    offset = null;
                    if(!(offset != yankee)) { _fun00042_ip = 1131; continue _fun00041 }
 1097:
                    yankee = verify;
                    verify = backup;
                    offset = verify.body;
 ...
 1131:
                    ...
                    sizing = undefined;
                    if(option) { _fun00042_ip = 1162; continue _fun00041 }
 1154:
                    option = backup;
 ...
 1162:
                    ...
                    yankee = undefined;
                    if(kiloes) { _fun00042_ip = 1193; continue _fun00041 }
 1188:
                    yankee = backup.body;
 1193:
 ...
 1244:
                    ...
                    verify = undefined;
                    if(yankee) { _fun00042_ip = 1274; continue _fun00041 }
 1269:
                    verify = report.body;
 1274:
                    report = oscard.files;
                    ...
                    tangon = undefined;
                    if(option) { _fun00042_ip = 1309; continue _fun00041 }
 1304:
                    tangon = golfie.body;
 1309:
                    tangon = report.bind(oscard)(tangon);
