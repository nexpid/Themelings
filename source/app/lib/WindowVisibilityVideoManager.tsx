...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
 ...
 0:
            ...
            if(entity) { _fun52510_ip = 48; continue _fun52510 }
 35:
            entity = verify.apply;
            entity = entity.bind(verify)(tango, zulu);
            _fun52510_ip = 86; continue _fun52510;
 48:
            oscar = global;
 ...
 70: // try_end0
            _fun52511_ip = 74; continue _fun52511;
 72: // catch_target0
 ...
 0:
                    ...
                    if(!(report !== mike)) { _fun52516_ip = 176; continue _fun52516 }
 49:
                    ...
                    if(mike) { _fun52516_ip = 153; continue _fun52516 }
 127:
                    oscar = zulu.start;
                    ...
                    _fun52516_ip = 176; continue _fun52516;
 153:
                    mike = zulu.stop;
                    mike = mike.bind(zulu)();
 ...
 0:
                ...
                if(!(entity !== mike)) { _fun52519_ip = 99; continue _fun52519 }
 22:
                zulu = tango.logger;
                mike = zulu.info;
