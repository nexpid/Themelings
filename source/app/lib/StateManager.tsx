...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
 ...
 0:
                ...
                zulu = this;
                entity = undefined;
                if(!(mike === entity)) { _fun106306_ip = 14; continue _fun106306 }
 12:
                mike = true;
 14:
 ...
 0:
                ...
                tango = this;
                report = undefined;
                if(!(oscar === report)) { _fun106311_ip = 17; continue _fun106311 }
 15:
                oscar = {};
 17:
                if(!(entity === report)) { _fun106311_ip = 23; continue _fun106311 }
 21:
                entity = false;
 23:
                ...
                if(entity) { _fun106311_ip = 173; continue _fun106311 }
 63:
                entity = global;
                zulu = entity.Object;
                entity = zulu.keys;
                ...
                entity = golf < entity;
                zulu = 2;
                if(!entity) { _fun106311_ip = 221; continue _fun106311 }
 101:
                verify = options[golf];
                entity = tango.dirty;
                if(entity) { _fun106311_ip = 153; continue _fun106311 }
 114:
 ...
 153:
                ...
                golf = golf + 1;
                entity = options.length;
                if(golf < entity) { _fun106311_ip = 101; continue _fun106311 }
 171:
                _fun106311_ip = 221; continue _fun106311;
 173:
 ...
 221:
                entity = tango.dirty;
                if(!entity) { _fun106311_ip = 242; continue _fun106311 }
 230:
                zulu = tango.shouldCommit;
                entity = zulu.bind(tango)();
 242:
                zulu = entity;
                if(zulu) { _fun106311_ip = 254; continue _fun106311 }
 248:
                zulu = tango.alwaysUpdateState;
 254:
                if(!zulu) { _fun106311_ip = 263; continue _fun106311 }
 257:
                tango['state'] = mike;
 263:
                mike = !entity;
                entity = !mike;
                if(mike) { _fun106311_ip = 298; continue _fun106311 }
 272:
                mike = false;
                tango['dirty'] = mike;
