...
export default (function(argFoo, argBar, argBaz, _, __, argFre, argPlu) {
 ...
 0:
                ...
                zuuluu = report.getMessageForwardingExperimentConfig;
                michal = {};
                entity = 'SearchTokens';
 ...
 75:
                ...
                entity = option[entity];
                entity = oscard.bind(romeon)(entity);
                entity = entity.t;
 ...
 141:
                ...
                record = result;
                config = michal;
                entity = arraySpread(record, config, sequen);
                ...
                oscard = backup.bind(romeon)(oscard);
                michal['regex'] = oscard;
                ...
                update = backup.bind(romeon)(update);
                michal['regex'] = update;
                ...
                update = update.i96lOz;
                update = source.bind(ctrled)(update);
                update = offset.bind(romeon)(update);
                michal['key'] = update;
                update = foxtra[option];
                update = yankee.bind(romeon)(update);
                ctrled = update.intl;
                ...
                kiloes = kiloes.CqCvio;
                kiloes = sizing.bind(output)(kiloes);
                kiloes = offset.bind(romeon)(kiloes);
                michal['key'] = kiloes;
                kiloes = foxtra[option];
                kiloes = yankee.bind(romeon)(kiloes);
                output = kiloes.intl;
                ...
                sizing = backup.bind(romeon)(sizing);
                michal['regex'] = sizing;
                sizing = foxtra[option];
                sizing = yankee.bind(romeon)(sizing);
                result = sizing.intl;
                ...
                sizing = sizing.TMNjFh;
                sizing = output.bind(result)(sizing);
                sizing = offset.bind(romeon)(sizing);
                michal['key'] = sizing;
                sizing = foxtra[option];
                sizing = yankee.bind(romeon)(sizing);
                result = sizing.intl;
 ...
 0:
                        ...
                        michal = '#';
                        oscard = tangon;
                        if(!(michal === zuuluu)) { _fun00022_ip = 39; continue _fun00021 }
 25:
 ...
 0:
                                ...
                                report = undefined;
                                if(oscard) { _fun00024_ip = 37; continue _fun00023 }
 32:
                                report = tangon.name;
 37:
                                if(!(zuuluu == report)) { _fun00024_ip = 46; continue _fun00023 }
 41:
                                report = michal.name;
 46:
                                zuuluu = global;
                ...
                verify = kiloes.bind(sizing)(verify);
                verify = backup.bind(romeon)(verify);
                michal['regex'] = verify;
                verify = oscard.FILTER;
                michal['componentType'] = verify;
                verify = foxtra[option];
 ...
 0:
                        ...
                        entity = 'true';
                        if(!(entity !== michal)) { _fun00026_ip = 58; continue _fun00025 }
 25:
                        entity = 'false';
 ...
 0:
            ...
            var _closure2_slot0 = michal;
            report = undefined;
            if(!(zuuluu === report)) { _fun00028_ip = 48; continue _fun00027 }
 18:
            michal = global;
