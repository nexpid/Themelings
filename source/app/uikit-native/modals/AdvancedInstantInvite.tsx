...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    mike = function(argFoo) { // Original name: AdvancedInstantInvite
        _fun127524: for(var _fun127524_ip = 0; ; ) switch(_fun127524_ip) {
 0:
            entity = argFoo;
            golf = entity.channel;
            zulu = entity.guild;
            ...
            entity = verify != golf;
            equality = null;
            if(!entity) { _fun127524_ip = 138; continue _fun127524 }
 102:
 ...
 138:
            entity = verify != golf;
            output = ' ';
            if(!entity) { _fun127524_ip = 195; continue _fun127524 }
 149:
 ...
 195:
            ...
            options[1] = yankee;
            yankee = null;
            if(romeo) { _fun127524_ip = 1017; continue _fun127524 }
 795:
 ...
 1017:
            options[2] = yankee;
            verify = null;
            if(!offset) { _fun127524_ip = 1306; continue _fun127524 }
 1029:
