...
export default (function(argFoo, argBar, _, __, ___, argFred, argPlugh) {
 ...
 0:
                ...
                entity = 0;
                mike = zulu < entity;
                if(mike) { _fun93135_ip = 28; continue _fun93135 }
 12:
                mike = 1;
                tango = zulu > mike;
                if(tango) { _fun93135_ip = 25; continue _fun93135 }
 22:
                mike = zulu;
 25:
                entity = mike;
 ...
 0:
                ...
                offset = tango % report;
                report = 0;
                if(!(report !== offset)) { _fun93137_ip = 200; continue _fun93137 }
 107:
                if(!(entity !== offset)) { _fun93137_ip = 189; continue _fun93137 }
 111:
                entity = 2;
                if(!(entity !== offset)) { _fun93137_ip = 178; continue _fun93137 }
 118:
                entity = 3;
                if(!(entity !== offset)) { _fun93137_ip = 167; continue _fun93137 }
 125:
                entity = 4;
                if(!(entity !== offset)) { _fun93137_ip = 156; continue _fun93137 }
 132:
                verify = 5;
                entity = 0;
                tango = 0;
                report = 0;
                if(!(verify === offset)) { _fun93137_ip = 209; continue _fun93137 }
 145:
                entity = golf;
                tango = mike;
                report = options;
                _fun93137_ip = 209; continue _fun93137;
 156:
                entity = oscar;
                tango = mike;
                report = golf;
 ...
 0:
                ...
                tango = report;
                mike = 0;
                if(!(offset !== yankee)) { _fun93139_ip = 286; continue _fun93139 }
 130:
                if(!(golf <= yankee)) { _fun93139_ip = 152; continue _fun93139 }
 134:
                romeo = yankee < verify;
                entity = options;
                tango = report;
                mike = 0;
                if(romeo) { _fun93139_ip = 286; continue _fun93139 }
 152:
                if(!(verify <= yankee)) { _fun93139_ip = 174; continue _fun93139 }
 156:
                verify = 120;
                ...
                tango = options;
                mike = 0;
                if(verify) { _fun93139_ip = 286; continue _fun93139 }
 174:
                verify = 120;
                if(!(verify <= yankee)) { _fun93139_ip = 199; continue _fun93139 }
 181:
                verify = 180;
                verify = yankee < verify;
                entity = 0;
 ...
 199:
                verify = 180;
                if(!(verify <= yankee)) { _fun93139_ip = 224; continue _fun93139 }
 206:
                verify = 240;
                verify = yankee < verify;
                entity = 0;
 ...
 224:
                verify = 240;
                if(!(verify <= yankee)) { _fun93139_ip = 252; continue _fun93139 }
 231:
                verify = 300;
                verify = yankee < verify;
                entity = report;
 ...
 252:
                ...
                if(!verify) { _fun93139_ip = 269; continue _fun93139 }
 265:
