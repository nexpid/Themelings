...
export default (function(argFoo, argBar, _, __, ___, argFred, argPlugh) {
 ...
 0:
            ...
            entity['width'] = golf;
            oscar = 0;
            if(!tango) { _fun63273_ip = 49; continue _fun63273 }
 35:
            options = 2.5;
            oscar = golf / options;
 49:
            oscar = golf + oscar;
            entity['height'] = oscar;
            if(tango) { _fun63273_ip = 66; continue _fun63273 }
 60:
            report = golf / report;
            _fun63273_ip = 73; continue _fun63273;
 66:
            oscar = 4;
            report = golf / oscar;
 73:
            ...
            report = 0;
            if(!tango) { _fun63273_ip = 107; continue _fun63273 }
 104:
            report = 1;
 107:
            report = oscar + report;
            ...
            zulu = 0;
            if(!tango) { _fun63273_ip = 128; continue _fun63273 }
 125:
            zulu = 1;
 128:
            mike = mike + zulu;
 ...
 0:
            ...
            zulu = zulu.SMALL;
            if(!(zulu !== report)) { _fun63274_ip = 191; continue _fun63274 }
 26:
            zulu = _closure1_slot1;
            zulu = zulu.REFRESH_MEDIUM_10;
            if(!(zulu !== report)) { _fun63274_ip = 168; continue _fun63274 }
 43:
            zulu = _closure1_slot1;
            zulu = zulu.MEDIUM;
            if(!(zulu !== report)) { _fun63274_ip = 145; continue _fun63274 }
 57:
            zulu = _closure1_slot1;
            zulu = zulu.LARGE;
            if(!(zulu !== report)) { _fun63274_ip = 122; continue _fun63274 }
 71:
            zulu = _closure1_slot1;
            zulu = zulu.XLARGE;
            if(!(zulu !== report)) { _fun63274_ip = 99; continue _fun63274 }
 85:
 ...
 99:
            ...
            if(entity) { _fun63274_ip = 114; continue _fun63274 }
 106:
            zulu = tango.containerXLarge;
            _fun63274_ip = 120; continue _fun63274;
 114:
 ...
 122:
            tango = _closure1_slot2;
            if(entity) { _fun63274_ip = 137; continue _fun63274 }
 129:
            zulu = tango.containerLarge;
            _fun63274_ip = 143; continue _fun63274;
 137:
 ...
 145:
            tango = _closure1_slot2;
            if(entity) { _fun63274_ip = 160; continue _fun63274 }
 152:
            zulu = tango.containerMedium;
            _fun63274_ip = 166; continue _fun63274;
 160:
 ...
 168:
            tango = _closure1_slot2;
            if(entity) { _fun63274_ip = 183; continue _fun63274 }
 175:
            zulu = tango.containerRefreshMedium;
            _fun63274_ip = 189; continue _fun63274;
 183:
 ...
 191:
            ...
            if(entity) { _fun63274_ip = 206; continue _fun63274 }
 198:
            entity = mike.containerSmall;
            _fun63274_ip = 212; continue _fun63274;
 206:
