...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
            ...
            options = mike.source;
            golf = mike.style;
            yankee = mike.iconStyle;
            backup = mike.size;
            var _closure2_slot0 = backup;
            verify = mike.disableColor;
            output = mike.accessibilityLabel;
            kilo = mike.accessibilityHidden;
 ...
 0:
                    ...
                    zulu = zulu.MEDIUM_32;
                    if(!(zulu !== tango)) { _fun104511_ip = 72; continue _fun104511 }
 24:
                    zulu = _closure1_slot5;
                    zulu = zulu.LARGE_40;
                    if(!(zulu !== tango)) { _fun104511_ip = 60; continue _fun104511 }
 38:
 ...
 72:
            ...
            sizing = undefined;
            if(kilo) { _fun104510_ip = 156; continue _fun104510 }
 153:
            sizing = output;
 156:
            ...
            if(!(backup !== romeo)) { _fun104510_ip = 269; continue _fun104510 }
 238:
            ...
            _fun104510_ip = 298; continue _fun104510;
 269:
            backup = _closure1_slot1;
            ...
            romeo = foxtrot.MEDIUM;
 298:
            report['size'] = romeo;
            romeo = null;
            if(verify) { _fun104510_ip = 312; continue _fun104510 }
 307:
            romeo = offset.icon;
 312:
            offset = new Array(2);
 ...
 0:
            ...
            verify = zulu.style;
            golf = zulu.size;
            oscar = zulu.disableColor;
            mike = {'style': 0, 'size': 0, 'disableColor': 0};
            foxtrot = null;
            backup = mike;
            ...
            if(!(yankee !== golf)) { _fun104512_ip = 137; continue _fun104512 }
 91:
            yankee = _closure1_slot5;
            yankee = yankee.MEDIUM_32;
            if(!(yankee !== golf)) { _fun104512_ip = 129; continue _fun104512 }
 105:
            offset = _closure1_slot5;
            yankee = offset.LARGE_40;
            offset = undefined;
            if(!(yankee === golf)) { _fun104512_ip = 143; continue _fun104512 }
 121:
            offset = options.largeCircular;
            _fun104512_ip = 143; continue _fun104512;
 129:
 ...
 143:
    ...
    options = {};
    romeo = {'borderRadius': null, 'alignItems': 'center', 'justifyContent': 'center'};
    foxtrot = 3;
    ...
    options['smallCircular'] = romeo;
    romeo = {};
    backup = report.MEDIUM_32;
    backup = backup / kilo;
    romeo['borderRadius'] = backup;
    options['mediumCircular'] = romeo;
    romeo = {};
    backup = report.LARGE_40;
    backup = backup / kilo;
    romeo['borderRadius'] = backup;
    options['largeCircular'] = romeo;
    romeo = {};
    foxtrot = golf[foxtrot];
    foxtrot = oscar.bind(entity)(foxtrot);
    foxtrot = foxtrot.DARK_PRIMARY_300_LIGHT_PRIMARY_500;
    ...
    zulu['SquareIconButton'] = tango;
    zulu['CircularIconButton'] = mike;
    return entity;
})();