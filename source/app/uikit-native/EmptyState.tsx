...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
    ...
    tangon = 'uikit-native/EmptyState.tsx';
 ...
 394:
            ...
            verify = option.Text;
            option = {'variant': 'text-md/medium', 'color': 'text-muted', 'maxFontSizeMultiplier': 2};
            backup = romeon.emptyBody;
            romeon = new Array(2);
            romeon[0] = backup;
            romeon[1] = foxtra;
            option['style'] = romeon;
