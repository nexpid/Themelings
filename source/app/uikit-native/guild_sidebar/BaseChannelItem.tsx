...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
            ...
            entity = null;
            zulu = entity == golf;
            if(zulu) { _fun113536_ip = 105; continue _fun113536 }
 37:
 ...
 0:
            ...
            if(!(mike !== zulu)) { _fun113537_ip = 132; continue _fun113537 }
 20:
            zulu = _closure1_slot9;
            zulu = zulu.RELEVANT;
            if(!(mike !== zulu)) { _fun113537_ip = 132; continue _fun113537 }
 34:
            ...
            if(!(mike !== zulu)) { _fun113537_ip = 120; continue _fun113537 }
 48:
            zulu = _closure1_slot9;
            zulu = zulu.MUTED;
            if(!(mike !== zulu)) { _fun113537_ip = 104; continue _fun113537 }
 62:
            entity = _closure1_slot9;
            entity = entity.SELECTED;
            if(!(mike !== entity)) { _fun113537_ip = 88; continue _fun113537 }
 76:
            entity = {'variant': 'text-md/medium', 'color': 'redesign-channel-name-muted-text'};
            _fun113537_ip = 102; continue _fun113537;
 88:
            entity = {'variant': 'text-md/medium', 'color': 'redesign-channel-name-text'};
 102:
            _fun113537_ip = 118; continue _fun113537;
 104:
            entity = {'variant': 'text-md/medium', 'color': 'interactive-muted'};
 118:
            _fun113537_ip = 130; continue _fun113537;
 120:
            entity = {'variant': 'text-md/medium', 'color': 'redesign-channel-name-muted-text'};
 130:
            _fun113537_ip = 146; continue _fun113537;
 132:
 ...
 0:
            ...
            zulu = _closure1_slot9;
            zulu = zulu.UNREAD_IMPORTANT;
            if(!(mike !== zulu)) { _fun113538_ip = 94; continue _fun113538 }
 20:
            zulu = _closure1_slot9;
            zulu = zulu.RELEVANT;
            if(!(mike !== zulu)) { _fun113538_ip = 94; continue _fun113538 }
 ...
 48:
            entity = _closure1_slot9;
            entity = entity.MUTED;
            if(!(mike !== entity)) { _fun113538_ip = 78; continue _fun113538 }
 62:
            entity = {'variant': 'text-xs/medium', 'color': 'text-muted'};
            _fun113538_ip = 92; continue _fun113538;
 78:
            entity = {'variant': 'text-xs/medium', 'color': 'interactive-muted'};
 92:
            _fun113538_ip = 108; continue _fun113538;
 94:
 ...
 0:
            ...
            tango = undefined;
            if(!(mike === tango)) { _fun113539_ip = 48; continue _fun113539 }
 46:
            mike = false;
 48:
            ...
            result = golf.unread;
            if(!(result === tango)) { _fun113539_ip = 71; continue _fun113539 }
 69:
            result = false;
 71:
 ...
 0:
                    ...
                    if(!mike) { _fun113540_ip = 37; continue _fun113540 }
 27:
 ...
 37:
                    ...
                    mike = mike.SELECTED;
                    mike = tango === mike;
                    if(!mike) { _fun113540_ip = 75; continue _fun113540 }
 65:
 ...
 75:
            ...
            backup = echo === verify;
            if(!backup) { _fun113539_ip = 220; continue _fun113539 }
 194:
 ...
 220:
            ...
            verify[0] = backup;
            backup = !romeo;
            if(!backup) { _fun113539_ip = 322; continue _fun113539 }
 234:
            ...
            if(!(echo !== result)) { _fun113539_ip = 301; continue _fun113539 }
 289:
            result = _closure1_slot5;
            result = result.ALL_MESSAGES;
            _fun113539_ip = 311; continue _fun113539;
 301:
 ...
 322:
            verify[1] = backup;
            romeo = !romeo;
            if(!romeo) { _fun113539_ip = 335; continue _fun113539 }
 332:
            romeo = foxtrot;
 335:
            verify[2] = romeo;
            ...
            if(mike) { _fun113539_ip = 392; continue _fun113539 }
 364:
            ...
            _fun113539_ip = 412; continue _fun113539;
 392:
 ...
 0:
            ...
            foxtrot[0] = entity;
            entity = true;
            if(!(entity !== output)) { _fun113541_ip = 152; continue _fun113541 }
 111:
            zulu = foxtrot.push;
            if(offset) { _fun113541_ip = 141; continue _fun113541 }
 119:
            if(options) { _fun113541_ip = 133; continue _fun113541 }
 122:
            if(verify) { _fun113541_ip = 133; continue _fun113541 }
 125:
            entity = oscar.channelIconNormal;
            _fun113541_ip = 139; continue _fun113541;
 133:
            entity = oscar.channelIconUnread;
 139:
            _fun113541_ip = 147; continue _fun113541;
 141:
 ...
 152:
            entity = null;
            if(!(entity != yankee)) { _fun113541_ip = 168; continue _fun113541 }
 158:
            zulu = foxtrot.push;
            zulu = zulu.bind(foxtrot)(yankee);
 168:
            if(!(entity == report)) { _fun113541_ip = 244; continue _fun113541 }
 172:
            ...
            _fun113541_ip = 320; continue _fun113541;
 244:
            ...
            if(golf) { _fun113541_ip = 310; continue _fun113541 }
 277:
            golf = 'interactive-muted';
            if(offset) { _fun113541_ip = 307; continue _fun113541 }
 286:
            if(options) { _fun113541_ip = 298; continue _fun113541 }
 289:
            options = 'channel-icon';
            if(!verify) { _fun113541_ip = 304; continue _fun113541 }
 298:
