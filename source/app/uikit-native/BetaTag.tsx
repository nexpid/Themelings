...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    mike = {};
    verify = {'backgroundColor': null, 'borderRadius': null, 'marginLeft': 8, 'paddingHorizontal': 8, 'justifyContent': 'center'};
    offset = 4;
    romeo = golf[offset];
 ...
 272:
            ...
            oscar = oscar.PREMIUM_TIER_2_TRI_COLOR;
            mike['colors'] = oscar;
            oscar = 7;
            oscar = romeo[oscar];
            oscar = yankee.bind(report)(oscar);
