...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    tango = 'hooks/useRequest.tsx';
    tango = report.bind(oscar)(tango);
    mike = function(argFoo) { // Original name: useRequest
        golf = argFoo;
        ...
        options = undefined;
        offset = 2;
        report = yankee.bind(options)(zulu, offset);
        zulu = 0;
        tango = report[zulu];
        verify = 1;
        ...
        report = yankee.bind(options)(report, offset);
        zulu = report[zulu];
        report = report[verify];
 ...
 0:
                    ...
                    if(mike) { _fun96695_ip = 323; continue _fun96695 }
 10:
                    backup = 0;
                    zulu = copyRestArgs(backup);
                    oscar = undefined;
 ...
 22:
                    ...
                    if(tango) { _fun96695_ip = 320; continue _fun96695 }
 31: // try_start_0 // try_start_1
                    ...
                    foxtrot = zulu;
                    romeo = undefined;
                    zulu = apply(backup, foxtrot, romeo);
                    SaveGenerator(address=92);
 90:
                    return zulu;
 92:
                    ResumeGenerator(result_out_reg=2, return_bool_out_reg=6);
                    if(golf) { _fun96695_ip = 112; continue _fun96695 }
 ...
 126: // try_start_2 // catch_target0
                    ...
                    if(!(golf !== tango)) { _fun96695_ip = 285; continue _fun96695 }
 198:
                    ...
                    if(golf) { _fun96695_ip = 277; continue _fun96695 }
 235:
                    ...
                    _fun96695_ip = 280; continue _fun96695;
 277:
                    zulu = report;
 280:
                    zulu = tango.bind(oscar)(zulu);
