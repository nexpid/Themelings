...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    yankee['color'] = result;
    yankee['fontSize'] = output;
    tango['rowText'] = yankee;
    yankee = {};
    output = verify[romeo];
    ...
    yankee['color'] = output;
    tango['rowActivityText'] = yankee;
    yankee = {};
    output = 0.3;
    yankee['opacity'] = output;
    tango['rowOffline'] = yankee;
    yankee = {'paddingRight': 4, 'paddingTop': 0};
    tango['roleDot'] = yankee;
    yankee = {};
    yankee['marginLeft'] = sizing;
    tango['icon'] = yankee;
    ...
    tango['placeholderAvatar'] = yankee;
    yankee = {};
    output = 20;
    ...
    tango['voiceIndicator'] = yankee;
    yankee = {};
    sizing = 'column-reverse';
    yankee['flexDirection'] = sizing;
    tango['inviteRowContainer'] = yankee;
    yankee = {};
    yankee['flexShrink'] = kilo;
    tango['inviteRow'] = yankee;
    yankee = {};
    kilo = verify[romeo];
    ...
    tango['inviteIconWrapper'] = yankee;
    yankee = {};
    backup = verify[romeo];
    ...
    yankee['color'] = backup;
    tango['themeIcon'] = yankee;
    yankee = {'width': 32, 'height': 32, 'borderRadius': null, 'backgroundColor': null, 'alignItems': 'center', 'justifyContent': 'center'};
    backup = verify[romeo];
    backup = foxtrot.bind(entity)(backup);
    backup = backup.radii;
    backup = backup.lg;
    ...
    tango['addIconWrapper'] = yankee;
    tango = report.bind(oscar)(tango);
    var _closure1_slot21 = tango;
    tango = function(argFoo) { // Original name: placeholderRowWidth
        entity = global;
        tango = entity.Math;
        zulu = tango.sin;
        mike = argFoo;
    ...
    tango = {'duration': 1300, 'easing': null, 'useNativeDriver': true, 'isInteraction': false};
    oscar = golf.inOut;
    report = golf.ease;
 ...
 0:
            ...
            tango = undefined;
            if(!(offset === tango)) { _fun86348_ip = 25; continue _fun86348 }
 23:
            offset = true;
 25:
            oscar = entity.style;
            ...
            if(!offset) { _fun86348_ip = 133; continue _fun86348 }
 130:
            offset = !entity;
 133:
            ...
            verify = verify.bind(entity)(golf, zulu);
            zulu = new Array(2);
            zulu[0] = verify;
            romeo = entity.timing;
            verify = {};
            ...
            verify = romeo.bind(entity)(golf, verify);
            zulu[1] = verify;
 ...
 0:
                    ...
                    if(entity) { _fun86351_ip = 26; continue _fun86351 }
 14:
                    entity = mike.stop;
                    entity = entity.bind(mike)();
                    _fun86351_ip = 35; continue _fun86351;
 26:
                    entity = mike.start;
                    entity = entity.bind(mike)();
 35:
            ...
            report = {};
            oscar = yankee.placeholderAvatar;
            report['style'] = oscar;
            ...
            verify['style'] = offset;
            offset = {};
            romeo = yankee.placeholderText;
            yankee = new Array(2);
            yankee[0] = romeo;
            romeo = {};
            foxtrot = _closure1_slot22;
            sizing = foxtrot.bind(tango)(backup);
            foxtrot = global;
            foxtrot = foxtrot.HermesInternal;
            kilo = foxtrot.concat;
            backup = '';
            foxtrot = '%';
            foxtrot = kilo.bind(backup)(sizing, foxtrot);
            romeo['width'] = foxtrot;
            yankee[1] = romeo;
            offset['style'] = yankee;
            offset = options.bind(tango)(golf, offset);
            verify['children'] = offset;
            verify = options.bind(tango)(golf, verify);
    ...
    tango = function(argFoo) { // Original name: VoiceIndicator
 ...
 0:
                    ...
                    if(entity) { _fun86353_ip = 119; continue _fun86353 }
 27:
                    oscar = report.getVoiceState;
                    ...
                    golf = oscar == entity;
                    zulu = undefined;
                    if(golf) { _fun86353_ip = 68; continue _fun86353 }
 63:
                    zulu = entity.channelId;
 68:
                    golf = oscar != zulu;
                    entity = null;
                    if(!golf) { _fun86353_ip = 117; continue _fun86353 }
 77:
                    verify = _closure1_slot10;
                    options = verify.canWithPartialContext;
                    ...
                    entity = null;
                    if(!tango) { _fun86353_ip = 117; continue _fun86353 }
 114:
                    entity = zulu;
 117:
                    return entity;
 119:
                    tango = report.isInChannel;
                    entity = _closure2_slot1;
                    zulu = entity.id;
                    entity = _closure2_slot0;
                    zulu = tango.bind(report)(zulu, entity);
                    entity = null;
                    if(!zulu) { _fun86353_ip = 158; continue _fun86353 }
 149:
                    mike = _closure2_slot1;
                    entity = mike.id;
 158:
 ...
 0:
                    ...
                    tango = mike != entity;
                    entity = null;
                    if(!tango) { _fun86354_ip = 61; continue _fun86354 }
 18:
                    ...
                    zulu = mike == tango;
                    mike = undefined;
                    if(zulu) { _fun86354_ip = 58; continue _fun86354 }
 48:
 ...
 61:
            ...
            options = oscar.bind(golf)(tango, entity, zulu);
            entity = null;
            mike = entity != mike;
            if(!mike) { _fun86352_ip = 296; continue _fun86352 }
 158:
            tango = _closure1_slot19;
            zulu = _closure1_slot4;
            mike = {};
            golf = yankee.voiceIndicator;
            oscar = new Array(1);
            oscar[0] = golf;
            mike['style'] = oscar;
            ...
            oscar['size'] = romeo;
            yankee = yankee.themeIcon;
            yankee = yankee.color;
            oscar['color'] = yankee;
            yankee = _closure1_slot2;
            if(options) { _fun86352_ip = 264; continue _fun86352 }
 255:
            options = 19;
            options = yankee[options];
            _fun86352_ip = 271; continue _fun86352;
 264:
            offset = 18;
 ...
 0:
            ...
            foxtrot = entity.isMobileOnline;
            control = entity.activities;
            ...
            echo = entity.isOwner;
            report = undefined;
            if(!(echo === report)) { _fun86355_ip = 63; continue _fun86355 }
 61:
            echo = false;
 63:
            golf = entity.applicationStream;
            vacuum = entity.nick;
            output = entity.premiumSince;
            ...
            entity = null;
            if(!(entity != romeo)) { _fun86355_ip = 1286; continue _fun86355 }
 199:
            tango = entity != mike;
            sequence = undefined;
            if(!tango) { _fun86355_ip = 211; continue _fun86355 }
 208:
            sequence = mike;
 211:
            mike = 'username';
            papa = undefined;
            if(!(mike === zulu)) { _fun86355_ip = 224; continue _fun86355 }
 221:
            papa = sequence;
 224:
            mike = 'dot';
            result = mike === zulu;
            if(!result) { _fun86355_ip = 239; continue _fun86355 }
 235:
 ...
 239:
            ...
            mike = {};
            update = 'button';
            mike['accessibilityRole'] = update;
            context = 22;
            update = oscar[context];
            update = offset.bind(report)(update);
            status = update.intl;
            ...
            offset = {};
            oscar = vacuum;
            if(!(entity == vacuum)) { _fun86355_ip = 349; continue _fun86355 }
 344:
 ...
 349:
            ...
            record = 23;
            sierra = oscar[record];
            lima = config.bind(report)(sierra);
            sierra = lima.humanizeStatus;
            sierra = sierra.bind(lima)(backup);
            offset['status'] = sierra;
            offset = target.bind(status)(update, offset);
            mike['accessibilityLabel'] = offset;
            offset = oscar[context];
            offset = config.bind(report)(offset);
            update = offset.intl;
            offset = update.string;
            oscar = oscar[context];
            oscar = config.bind(report)(oscar);
            oscar = oscar.t;
            oscar = oscar.cSgdvL;
            oscar = offset.bind(update)(oscar);
            mike['accessibilityHint'] = oscar;
            offset = source.row;
            oscar = new Array(3);
            oscar[0] = offset;
            offset = sizing;
            if(!offset) { _fun86355_ip = 473; continue _fun86355 }
 467:
 ...
 473:
            ...
            update = 25;
            oscar = context[update];
            verify = config.bind(report)(oscar);
            oscar = {};
            oscar['user'] = romeo;
            target = yankee.guild_id;
            oscar['guildId'] = target;
            target = _closure1_slot0;
            update = context[update];
            update = target.bind(report)(update);
            update = update.AvatarSizes;
            update = update.REFRESH_MEDIUM_32;
            oscar['size'] = update;
            update = 26;
            update = context[update];
            update = config.bind(report)(update);
            update = update.bind(report)(control);
            oscar['streaming'] = update;
            oscar['isMobileOnline'] = foxtrot;
            foxtrot = null;
            if(sizing) { _fun86355_ip = 599; continue _fun86355 }
 596:
            foxtrot = backup;
 599:
            ...
            foxtrot = romeo.avatarDecoration;
            oscar['avatarDecoration'] = foxtrot;
            ...
            verify = {};
            backup = source.rowInner;
            verify['style'] = backup;
            backup = {};
            sizing = source.rowHeaderWrapper;
            backup['style'] = sizing;
            if(!result) { _fun86355_ip = 727; continue _fun86355 }
 674:
            ...
            update = sizing.RoleDot;
            sizing = {};
            sizing['color'] = sequence;
 ...
 727:
            ...
            sequence[0] = config;
            if(!(report === papa)) { _fun86355_ip = 783; continue _fun86355 }
 779:
            config = {};
            _fun86355_ip = 792; continue _fun86355;
 783:
            context = {};
            context['color'] = papa;
            config = context;
 792:
            ...
            if(!(entity == vacuum)) { _fun86355_ip = 840; continue _fun86355 }
 812:
            config = _closure1_slot1;
            sequence = _closure1_slot2;
 ...
 840:
            ...
            update = romeo.bot;
            result = null;
            if(!update) { _fun86355_ip = 952; continue _fun86355 }
 865:
            ...
            control = control.bind(report)(update);
            update = {};
            sequence = source.icon;
            update['style'] = sequence;
            sequence = romeo.isVerifiedBot;
            sequence = sequence.bind(romeo)();
            update['verified'] = sequence;
            config = _closure1_slot0;
            sequence = 30;
            sequence = record[sequence];
            config = config.bind(report)(sequence);
            sequence = config.getBotTagTypeFromUser;
 ...
 952:
            sizing[2] = result;
            result = null;
            if(!echo) { _fun86355_ip = 1050; continue _fun86355 }
 961:
            control = _closure1_slot19;
            ...
            vacuum = 17;
            echo = config[vacuum];
            update = sequence.bind(report)(echo);
            echo = {};
 ...
 1050:
            ...
            output = null;
            if(!result) { _fun86355_ip = 1152; continue _fun86355 }
 1063:
 ...
 0:
                    mike = _closure2_slot1;
                    entity = null;
                    if(!(entity != mike)) { _fun86358_ip = 176; continue _fun86358 }
 16:
                    zulu = _closure1_slot1;
                    ...
                    golf = golf.rowActivityText;
                    mike['textStyle'] = golf;
                    mike['hideEmoji'] = oscar;
                    oscar = false;
                    mike['animate'] = oscar;
 ...
 176:
            ...
            oscar[1] = verify;
            if(!(entity == golf)) { _fun86355_ip = 1238; continue _fun86355 }
 1207:
            offset = _closure1_slot19;
            ...
            _fun86355_ip = 1270; continue _fun86355;
 1238:
            offset = _closure1_slot19;
            verify = _closure1_slot1;
            yankee = _closure1_slot2;
 ...
 1286:
    ...
    tango = function(argFoo) {
        ...
        zulu[4] = offset;
        mike = function() {
            _fun86361: for(var _fun86361_ip = 0; ; ) switch(_fun86361_ip) {
 0:
                ...
                mike = null;
                if(!(mike != entity)) { _fun86361_ip = 48; continue _fun86361 }
 36:
                entity = entity.bot;
                if(entity) { _fun86361_ip = 236; continue _fun86361 }
 48:
                report = _closure1_slot12;
                mike = report.isFriend;
                entity = _closure2_slot0;
                entity = entity.id;
                entity = mike.bind(report)(entity);
                if(entity) { _fun86361_ip = 109; continue _fun86361 }
 75:
                entity = _closure2_slot0;
                mike = entity.id;
                ...
                entity = report.getId;
                entity = entity.bind(report)();
                if(!(mike !== entity)) { _fun86361_ip = 109; continue _fun86361 }
 102:
                entity = {};
                _fun86361_ip = 234; continue _fun86361;
 109:
                mike = {};
                options = _closure1_slot11;
                golf = options.isMobileOnline;
                report = _closure2_slot0;
                oscar = report.id;
                oscar = golf.bind(options)(oscar);
                mike['isMobileOnline'] = oscar;
                golf = options.getStatus;
                oscar = report.id;
                oscar = golf.bind(options)(oscar);
                mike['status'] = oscar;
                golf = options.getActivities;
                oscar = report.id;
                oscar = golf.bind(options)(oscar);
                mike['activities'] = oscar;
                options = _closure1_slot7;
                golf = options.getAnyStreamForUser;
                oscar = report.id;
                oscar = golf.bind(options)(oscar);
                mike['applicationStream'] = oscar;
                ...
                entity = mike;
 234:
                _fun86361_ip = 269; continue _fun86361;
 236:
                mike = {};
                report = _closure1_slot11;
                tango = report.getStatus;
 ...
 0:
            ...
            var _closure2_slot0 = zulu;
            oscar = mike.style;
            golf = mike.canManageChannelMembers;
            tango = undefined;
            var _closure2_slot1 = tango;
            mike = _closure1_slot21;
            ...
            mike = zulu.isDM;
            mike = mike.bind(zulu)();
            if(mike) { _fun86362_ip = 191; continue _fun86362 }
 60:
            ...
            mike = mike.t;
            if(options) { _fun86362_ip = 160; continue _fun86362 }
 117:
            if(golf) { _fun86362_ip = 140; continue _fun86362 }
 120:
            golf = mike.Ab/6S0;
            ...
            _fun86362_ip = 253; continue _fun86362;
 140:
            golf = mike.z9Mqlp;
            yankee = zulu.bind(report)(golf);
            options = function() { // Original name: c
 ...
 160:
            ...
            mike = function() { // Original name: inviteFriends
                tango = _closure1_slot0;
 ...
 0:
                    ...
                    zulu = tango.bind(report)(zulu);
                    if(zulu) { _fun86365_ip = 104; continue _fun86365 }
 63:
                    zulu = _closure1_slot1;
                    tango = _closure1_slot2;
                    mike = 39;
                    ...
                    mike['onClick'] = tango;
                    mike = zulu.bind(entity)(mike);
                    _fun86365_ip = 115; continue _fun86365;
 104:
                    mike = _closure2_slot1;
 ...
 253:
            ...
            report = new Array(2);
            report[0] = oscar;
            oscar = foxtrot.inviteRowContainer;
            report[1] = oscar;
            entity['style'] = report;
            ...
            options = new Array(2);
            options[0] = backup;
            backup = foxtrot.inviteRow;
            options[1] = backup;
            report['style'] = options;
            options = {};
            backup = foxtrot.inviteIconWrapper;
            ...
            offset = verify.Text;
            verify = {'style': null, 'maxFontSizeMultiplier': 2, 'variant': 'text-md/medium', 'color': 'header-primary'};
            backup = foxtrot.rowText;
            romeo = new Array(2);
            romeo[0] = backup;
            foxtrot = foxtrot.rowInner;
            romeo[1] = foxtrot;
            verify['style'] = romeo;
    ...
    golf = 'components_native/chat_sidebar/ChatSidebarMembersRow.tsx';
    golf = options.bind(verify)(golf);
    zulu['PlaceholderRow'] = oscar;
    zulu['Row'] = report;
    zulu['GuildMemberRow'] = report;
    zulu['PrivateChannelMemberRow'] = tango;
    zulu['InviteRow'] = mike;
    return entity;
})();