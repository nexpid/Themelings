...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
            ...
            mike = tango.useChatInputManager;
            ...
            mike = report.useChatInputManager;
            entity = function(argFoo) {
                entity = argFoo;
            ...
            entity = backup[zulu];
            kilo = offset.bind(oscar)(entity);
            report = kilo.useChatInputManager;
            entity = function(argFoo) {
                entity = argFoo;
                entity = entity.shouldShowJumpToPresentButton;
                return entity;
            };
            entity = report.bind(kilo)(entity);
            zulu = backup[zulu];
            kilo = offset.bind(oscar)(zulu);
            report = kilo.useChatInputManager;
            ...
            if(tango) { _fun101714_ip = 352; continue _fun101714 }
 233:
            if(mike) { _fun101714_ip = 352; continue _fun101714 }
 236:
            if(!entity) { _fun101714_ip = 352; continue _fun101714 }
 239:
            ...
            _fun101714_ip = 440; continue _fun101714;
 352:
            mike = null;
            if(!report) { _fun101714_ip = 437; continue _fun101714 }
 357:
            mike = null;
            if(!zulu) { _fun101714_ip = 437; continue _fun101714 }
 362:
            ...
            options = golf.MemoedVoicePanelDismissChatButton;
            golf = {};
