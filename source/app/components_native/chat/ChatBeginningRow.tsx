...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
 ...
 0:
            ...
            option = verify.bind(offset)(option, zuuluu);
            zuuluu = golfie[report];
 ...
 175:
            oscard = zuuluu.nick;
 181:
            if(!(michal == oscard)) { _fun00002_ip = 216; continue _fun00001 }
 185:
 ...
 259:
            oscard = 'username';
            if(!(oscard !== offset)) { _fun00002_ip = 428; continue _fun00001 }
 270:
 ...
 298:
            ...
            verify = {};
            verify['color'] = zuuluu;
            foxtra = foxtra.threadCreatorRoleDot;
            verify['containerStyles'] = foxtra;
 ...
 0:
            ...
            entity = null;
            if(michal) { _fun00024_ip = 649; continue _fun00023 }
 171:
 ...
 329:
            ...
            golfie = !golfie;
            if(!golfie) { _fun00024_ip = 495; continue _fun00023 }
 352:
            kiloes = _closure1_slot41;
            ...
            result = result.t;
            echoed = result.imPXd3;
            result = {};
            ctrled = function(argFoo, argBar) { // Original name: usernameHook
                report = _closure1_slot41;
 ...
 495:
            ...
            golfie = null;
            if(!romeon) { _fun00024_ip = 635; continue _fun00023 }
 514:
 ...
 0:
                            ...
                            if(michal) { _fun00034_ip = 166; continue _fun00033 }
 10:
 ...
 90:
                            report = null;
                            if(!(report != michal)) { _fun00034_ip = 160; continue _fun00033 }
 96:
                            oscard = _closure1_slot1;
                            report = _closure1_slot2;
                            ...
                            golfie = _closure2_slot2;
                            verify = verify.bind(offset)(golfie, michal);
 ...
 117:
                    ...
                    report = oscard.useIsStealthRemediationEnabled;
                    zuuluu = {};
                    golfie = 'RelationshipButton';
 ...
 174:
                    entity = _closure1_slot34;
                    entity = entity.NONE;
                    if(!(entity !== michal)) { _fun00050_ip = 828; continue _fun00049 }
 191:
                    entity = _closure1_slot34;
                    entity = entity.PENDING_INCOMING;
                    if(!(entity !== michal)) { _fun00050_ip = 420; continue _fun00049 }
 208:
                    entity = _closure1_slot34;
                    entity = entity.PENDING_OUTGOING;
                    if(!(entity !== michal)) { _fun00050_ip = 226; continue _fun00049 }
 222:
                    entity = null;
                    return entity;
 226:
 ...
 534:
                    golfie = output.ZcibdX;
                    _fun00050_ip = 550; continue _fun00049;
 542:
                    golfie = output.+WbSn5;
 550:
                    golfie = romeon.bind(sizing)(golfie);
                    report['text'] = golfie;
                    golfie = _closure1_slot1;
                    romeon = _closure1_slot2;
 ...
 828:
                    ...
                    oscard = report.bot;
                    report = null;
                    if(oscard) { _fun00050_ip = 1050; continue _fun00049 }
 873:
 ...
 0:
            ...
            cntext = michal.bind(tangon)(result);
            report = _closure1_slot5;
            michal = report.useState;
            backup = false;
            oscard = michal.bind(report)(backup);
            ...
            record = oscard.bind(golfie)(zuuluu, michal);
 ...
 174:
            ...
            zuuluu[1] = source;
            zuuluu[2] = option;
            oscard = golfie.bind(report)(oscard, zuuluu);
 ...
 115:
            ...
            option = {};
            sizing = sequen.avatarRedesign;
            option['style'] = sizing;
            option['channel'] = result;
            sizing = 90;
            ...
            yankee = verify.Text;
            verify = {};
            backup = sequen.dmTitle;
            verify['style'] = backup;
            backup = null;
            output = backup != cntext;
            echoed = 'heading-xxl/extrabold';
            sizing = echoed;
            if(!output) { _fun00056_ip = 488; continue _fun00055 }
 464:
            vacuum = cntext.length;
            output = 40;
 ...
 488:
            ...
            foxtra = sequen.gdmText;
            verify['style'] = foxtra;
            output = _closure1_slot0;
            sizing = _closure1_slot2;
            config = 36;
            foxtra = sizing[config];
 ...
 596:
            ...
            foxtra = output.bind(tangon)(foxtra);
            foxtra = foxtra.t;
            foxtra = foxtra.0Q7uk5;
            foxtra = echoed.bind(vacuum)(foxtra);
 ...
 630:
            ...
            sizing = {};
            sizing['name'] = cntext;
            foxtra = echoed.bind(vacuum)(output, sizing);
 669:
 ...
 706:
            ...
            foxtra = {};
            vacuum = sequen.gdmInviteFriends;
            foxtra['style'] = vacuum;
            ...
            foxtra['IconComponent'] = vacuum;
            vacuum = 'blurple';
            foxtra['iconVariant'] = vacuum;
            vacuum = ctrled[config];
            vacuum = papara.bind(tangon)(vacuum);
            cntext = vacuum.intl;
            vacuum = cntext.string;
            ctrled = ctrled[config];
            ctrled = papara.bind(tangon)(ctrled);
            ctrled = ctrled.t;
            ctrled = ctrled.LR+Ptb;
            ctrled = vacuum.bind(cntext)(ctrled);
            foxtra['title'] = ctrled;
            sizing = echoed.bind(tangon)(output, foxtra);
 824:
            foxtra = new Array(3);
            foxtra[0] = sizing;
            echoed = _closure1_slot41;
            output = _closure1_slot54;
            sizing = {};
            vacuum = sequen.gdmShareInviteLink;
            ctrled = new Array(2);
            ctrled[0] = vacuum;
            vacuum = null;
            if(record) { _fun00056_ip = 867; continue _fun00055 }
 861:
            vacuum = sequen.gdmShareInviteLinkNoRelationships;
 867:
            ctrled[1] = vacuum;
            sizing['style'] = ctrled;
            ...
            ctrled = ctrled.LinkIcon;
            sizing['IconComponent'] = ctrled;
