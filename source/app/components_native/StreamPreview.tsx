...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
            ...
            if(entity) { _fun104030_ip = 51; continue _fun104030 }
 38:
            entity = verify.apply;
            entity = entity.bind(verify)(tango, oscar);
            _fun104030_ip = 92; continue _fun104030;
 51:
            golf = global;
            options = golf.Reflect;
            golf = options.construct;
            if(oscar) { _fun104030_ip = 71; continue _fun104030 }
 67:
            oscar = new Array(0);
 71:
 ...
 72: // try_end0
            _fun104031_ip = 76; continue _fun104031;
 74: // catch_target0
 ...
 76:
    ...
    tango[foxtrot] = kilo;
    verify['wrapper'] = tango;
    kilo = {'textAlign': 'center', 'fontSize': 14, 'lineHeight': 18, 'marginTop': 16};
    tango = 14;
    foxtrot = 10;
    ...
    sizing = '100%';
    kilo['width'] = sizing;
    verify['fallbackImage'] = kilo;
    verify = offset.bind(yankee)(verify);
    var _closure1_slot13 = verify;
    offset = golf.PureComponent;
    verify = function(argFoo) {
        tango = function() { // Original name: DefaultFallback
            report = this;
            tango = undefined;
            entity = undefined;
 ...
 0:
                ...
                golf = verify.isThemeDark;
                golf = golf.bind(verify)(offset);
                verify = _closure1_slot1;
                offset = _closure1_slot2;
                if(golf) { _fun104036_ip = 134; continue _fun104036 }
 120:
                golf = 13;
                golf = offset[golf];
                golf = verify.bind(tango)(golf);
                _fun104036_ip = 146; continue _fun104036;
 134:
                options = 12;
 ...
 146:
    ...
    verify = verify.ThemeContext;
    offset['contextType'] = verify;
    options = oscar[options];
    offset = report.bind(entity)(options);
    verify = offset.createLegacyClassComponentStyles;
    options = {};
    yankee = {'flex': 1, 'width': '100%', 'height': null, 'aspectRatio': 1.7777777777777777};
    ...
    golf = function(argFoo) {
        tango = function(argFoo) { // Original name: StreamPreview
            oscar = this;
            yankee = 0;
            ...
            zulu = {'isImageLoaded': false, 'isImageErrored': false};
            entity['state'] = zulu;
            zulu = function() {
                zulu = _closure3_slot0;
                mike = zulu.setState;
                entity = {'isImageLoaded': false, 'isImageErrored': false};
            ...
            zulu = function() {
                ...
                entity = {};
                tango = true;
                entity['isImageLoaded'] = tango;
                entity = mike.bind(zulu)(entity);
                entity = undefined;
                return entity;
            };
            entity['handleLoad'] = zulu;
            mike = function() {
                zulu = _closure3_slot0;
                mike = zulu.setState;
                entity = {};
                tango = true;
                entity['isImageErrored'] = tango;
                entity = mike.bind(zulu)(entity);
                entity = undefined;
                return entity;
            };
 ...
 0:
                ...
                entity = output.props;
                echo = entity.url;
                romeo = entity.ctaText;
                backup = entity.isFetching;
                zulu = entity.renderFallback;
                ...
                entity = null;
                if(!(entity != echo)) { _fun104042_ip = 225; continue _fun104042 }
 102:
                if(backup) { _fun104042_ip = 225; continue _fun104042 }
 105:
                if(offset) { _fun104042_ip = 225; continue _fun104042 }
 108:
                offset = undefined;
                if(verify) { _fun104042_ip = 133; continue _fun104042 }
 113:
                kilo = entity == zulu;
                verify = undefined;
                if(kilo) { _fun104042_ip = 130; continue _fun104042 }
 122:
                kilo = true;
                verify = zulu.bind(tango)(kilo, mike);
 130:
                offset = verify;
 133:
                ...
                result = output.handleLoadStart;
                verify['onLoadStart'] = result;
                result = output.handleLoad;
                verify['onLoad'] = result;
                output = output.handleError;
                verify['onError'] = output;
                verify = sizing.bind(tango)(kilo, verify);
                _fun104042_ip = 245; continue _fun104042;
 225:
                kilo = entity == zulu;
                entity = undefined;
                if(kilo) { _fun104042_ip = 240; continue _fun104042 }
 234:
                entity = zulu.bind(tango)(backup, mike);
 240:
                offset = entity;
                verify = undefined;
 245:
                ...
                entity = {'accessibilityRole': 'button', 'accessibilityLabel': null, 'activeOpacity': 0.6};
                entity['accessibilityLabel'] = romeo;
                backup = options.touchable;
                romeo = new Array(2);
                romeo[0] = backup;
                romeo[1] = foxtrot;
                entity['style'] = romeo;
                ...
                report = {};
                options = options.imageContainer;
    ...
    tango = {};
    options = function(argFoo, argBar) { // Original name: renderFallback
 ...
 0:
            ...
            oscar = report.t;
            report = argFoo;
            if(report) { _fun104043_ip = 86; continue _fun104043 }
 73:
            report = oscar.uQZTBQ;
            report = golf.bind(options)(report);
            _fun104043_ip = 97; continue _fun104043;
 86:
            oscar = oscar.NQ7H8f;
 ...
 97:
    ...
    tango['renderFallback'] = options;
    golf['defaultProps'] = tango;
    tango = 19;
    tango = oscar[tango];
    oscar = report.bind(entity)(tango);
    report = oscar.fileFinishedImporting;
    tango = 'components_native/StreamPreview.tsx';
    tango = report.bind(oscar)(tango);
    mike = function(argFoo) { // Original name: ConnectedStreamPreview
        report = argFoo;
        ...
        mike = mike.bind(tango)(options, golf, zulu);
        options = mike.previewUrl;
        golf = mike.isLoading;
