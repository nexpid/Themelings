...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    tango = 'components_native/premium/premium_guild_subscribe_modal/PremiumGuildSubscribeModal.tsx';
    tango = report.bind(oscar)(tango);
    mike = function(argFoo) { // Original name: PremiumGuildSubscribeModal
        entity = argFoo;
        mike = entity.guildId;
 ...
 0:
                ...
                entity = null;
                if(!(entity == zulu)) { _fun57471_ip = 64; continue _fun57471 }
 17:
                zulu = mike.push;
                entity = {};
                tango = _closure1_slot6;
                tango = tango.GUILD_SELECT;
                entity['name'] = tango;
                tango = {};
                oscar = _closure2_slot1;
                tango['previousGuildSubscriptionSlot'] = oscar;
                entity['params'] = tango;
                entity = zulu.bind(mike)(entity);
                _fun57471_ip = 117; continue _fun57471;
 64:
                zulu = mike.push;
                entity = {};
                tango = _closure1_slot6;
                tango = tango.OVERVIEW;
                entity['name'] = tango;
                tango = {};
                oscar = _closure2_slot0;
                tango['guildId'] = oscar;
                report = _closure2_slot1;
                tango['previousGuildSubscriptionSlot'] = report;
                entity['params'] = tango;
                entity = zulu.bind(mike)(entity);
 117:
                entity = {};
                entity['initialStack'] = mike;
                zulu = function() { // Original name: getScreens
                    entity = {};
                    mike = _closure1_slot6;
                    oscar = mike.GUILD_SELECT;
                    zulu = {};
                    golf = false;
                    zulu['headerShown'] = golf;
 ...
 0:
                            ...
                            if(oscar) { _fun57474_ip = 95; continue _fun57474 }
 81:
                            oscar = 12;
                            oscar = verify[oscar];
                            oscar = options.bind(zulu)(oscar);
                            _fun57474_ip = 107; continue _fun57474;
 95:
                            golf = 11;
                            golf = verify[golf];
                            oscar = options.bind(zulu)(golf);
 107:
                            entity['source'] = oscar;
                            ...
                            report = function() { // Original name: onPress
                                ...
                                mike = report.GUILD_BOOSTING;
                                mike = oscar.bind(golf)(mike);
                                mike = 8;
                                mike = tango[mike];
                                oscar = zulu.bind(entity)(mike);
                                mike = oscar.closeApplyBoostModal;
 ...
 0:
                            ...
                            golf = golf > report;
                            report = null;
                            if(!golf) { _fun57476_ip = 154; continue _fun57476 }
 112:
 ...
 154:
                    ...
                    report = report.closeApplyBoostModal;
                    report = oscar.bind(golf)(report);
        ...
        zulu = oscar[mike];
        zulu = zulu.name;
        romeo = verify.bind(yankee)(zulu);
        verify = _closure1_slot3;
        zulu = 2;
        verify = verify.bind(tango)(romeo, zulu);
        mike = verify[mike];
 ...
 0:
                ...
                entity = entity.GUILD_SELECT;
                entity = zulu === entity;
                if(!entity) { _fun57479_ip = 61; continue _fun57479 }
 27:
 ...
 61:
        ...
        report = function(argFoo) { // Original name: onStateChange
 ...
 0:
                ...
                entity = undefined;
                mike = undefined;
                if(report) { _fun57480_ip = 31; continue _fun57480 }
 16:
                report = tango.routes;
                tango = tango.index;
                mike = report[tango];
 31:
                if(!(zulu != mike)) { _fun57480_ip = 52; continue _fun57480 }
 35:
