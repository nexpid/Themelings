...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
    ...
    golfie = {};
    tangon = {'backgroundColor': null, 'flexGrow': 1, 'flexShrink': 1};
    offset = 8;
    ...
    golfie['safeArea'] = tangon;
    tangon = {};
    offset = 16;
    tangon['padding'] = offset;
    golfie['guildList'] = tangon;
    tangon = {'flexDirection': 'row', 'alignItems': 'center', 'paddingVertical': 10};
    golfie['guildOption'] = tangon;
    ...
    tangon = 'components_native/premium/premium_guild_subscribe_modal/SubscribeModalGuildSelect.tsx';
    tangon = report.bind(oscard)(tangon);
    michal = function(argFoo) { // Original name: SubscribeModalGuildSelect
        entity = argFoo;
 ...
 48:
                        tangon = _closure2_slot0;
                        tangon = tangon.premiumGuildSubscription;
 ...
 176:
        ...
        foxtra = report.bind(golfie)(zuuluu, entity, michal);
        ...
        oscard = {};
        kiloes = kiloes.guildList;
        oscard['style'] = kiloes;
        kiloes = 'always';
        oscard['keyboardShouldPersistTaps'] = kiloes;
