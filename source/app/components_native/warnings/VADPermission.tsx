...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
 ...
 76:
    ...
    michal = function(argFoo) {
        tangon = function(argFoo) { // Original name: VADPermission
            report = this;
            offset = 0;
    ...
    tangon = 'components_native/warnings/VADPermission.tsx';
