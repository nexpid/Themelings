...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    golf = {};
    yankee = {'flex': 1, 'padding': 20, 'alignItems': 'center', 'justifyContent': 'center'};
    romeo = 'center';
    foxtrot = 6;
    ...
    yankee = {'width': 300, 'height': 200, 'resizeMode': 'contain'};
    golf['emptyImage'] = yankee;
    yankee = {};
    yankee['textAlign'] = romeo;
    golf['emptyTitle'] = yankee;
    yankee = {};
    yankee['textAlign'] = romeo;
    golf['emptyDescription'] = yankee;
    yankee = {'marginBottom': 8, 'marginHorizontal': 4, 'alignItems': 'center', 'flexGrow': 0};
    golf['button'] = yankee;
 ...
 0:
            ...
            tango = zulu == mike;
            zulu = undefined;
            if(tango) { _fun101927_ip = 35; continue _fun101927 }
 29:
            zulu = mike.nsfwAllowed;
 35:
            mike = false;
            mike = mike === zulu;
            entity['nsfwDisallowed'] = mike;
            return entity;
        }
    };
    tango = options.bind(verify)(golf, tango);
    mike = function(argFoo) { // Original name: GuildNSFW
 ...
 0:
            ...
            backup = mike.nsfwDisallowed;
            mike = 8;
            mike = entity[mike];
            zulu = oscar.bind(tango)(mike);
            mike = zulu.useNsfwSource;
            zulu = mike.bind(zulu)();
            echo = 9;
            mike = entity[echo];
            ...
            options = entity.intl;
            if(backup) { _fun101928_ip = 187; continue _fun101928 }
 152:
            oscar = options.string;
            entity = report[echo];
            entity = mike.bind(tango)(entity);
            entity = entity.t;
            entity = entity.E4Cd5O;
            result = oscar.bind(options)(entity);
            offset = zulu;
            _fun101928_ip = 274; continue _fun101928;
 187:
            ...
            verify = verify.NSFW_AGE_GATING;
            verify = yankee.bind(romeo)(verify);
            entity['helpURL'] = verify;
            result = oscar.bind(options)(mike, entity);
            mike = 11;
            mike = report[mike];
 ...
 274:
            ...
            report = 1.5;
            golf = golf < report;
            if(!golf) { _fun101928_ip = 369; continue _fun101928 }
 339:
            verify = _closure1_slot6;
            options = _closure1_slot3;
            report = {};
            yankee = update.emptyImage;
            report['style'] = yankee;
 ...
 369:
            ...
            verify = golf.Text;
            golf = {'variant': 'heading-xxl/bold', 'maxFontSizeMultiplier': 2};
            ...
            output = sizing.t;
            if(backup) { _fun101928_ip = 503; continue _fun101928 }
 490:
            sizing = output.ZmwvDQ;
            sizing = source.bind(control)(sizing);
            _fun101928_ip = 514; continue _fun101928;
 503:
            output = output.NEabBQ;
            sizing = source.bind(control)(output);
 514:
            ...
            sizing = romeo.Text;
            romeo = {'color': 'text-muted', 'variant': 'text-md/medium', 'style': null, 'maxFontSizeMultiplier': 2};
            ...
            oscar = {};
            offset = null;
            if(backup) { _fun101928_ip = 748; continue _fun101928 }
 641:
 ...
 748:
            ...
            offset = {};
            sizing = 'secondary';
            if(!backup) { _fun101928_ip = 799; continue _fun101928 }
 795:
            sizing = 'primary';
 799:
            ...
            kilo = kilo.t;
            if(backup) { _fun101928_ip = 860; continue _fun101928 }
 847:
            backup = kilo.hg1uxs;
            backup = sizing.bind(output)(backup);
            _fun101928_ip = 871; continue _fun101928;
 860:
            kilo = kilo.13/7kZ;
 ...
 0:
                    ...
                    report = oscar.nsfwReturnToSafety;
                    zulu = _closure2_slot0;
                    tango = zulu.guildId;
                    tango = report.bind(oscar)(tango);
                    tango = zulu.onReturnToSafety;
                    zulu = null;
                    if(!(zulu != tango)) { _fun101930_ip = 74; continue _fun101930 }
 60:
                    zulu = _closure2_slot0;
                    mike = zulu.onReturnToSafety;
                    mike = mike.bind(zulu)();
 74:
                    return entity;
                }
    ...
    tango = 'components_native/warnings/GuildNSFW.tsx';
    tango = report.bind(oscar)(tango);
    zulu['default'] = mike;
    return entity;
})();