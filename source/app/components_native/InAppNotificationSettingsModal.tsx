...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
            ...
            if(entity) { _fun86730_ip = 51; continue _fun86730 }
 38:
            entity = verify.apply;
            entity = entity.bind(verify)(tango, oscar);
            _fun86730_ip = 92; continue _fun86730;
 51:
            golf = global;
            options = golf.Reflect;
            golf = options.construct;
            if(oscar) { _fun86730_ip = 71; continue _fun86730 }
 67:
            oscar = new Array(0);
 71:
 ...
 72: // try_end0
            _fun86731_ip = 76; continue _fun86731;
 74: // catch_target0
 ...
 0:
                ...
                report = null;
                golf = report != yankee;
                if(!golf) { _fun86735_ip = 150; continue _fun86735 }
 104:
                options = _closure1_slot0;
                verify = _closure1_slot2;
                golf = 16;
                golf = verify[golf];
                offset = options.bind(zulu)(golf);
                ...
                sizing = offset;
                kilo = yankee;
                report = sizing[verify](kilo, backup, foxtrot, romeo, yankee);
 150:
        ...
        mike['render'] = zulu;
        entity['IN_APP_NOTIFICATION_SETTINGS'] = mike;
        return entity;
    };
    ...
    tango = function(argFoo) {
        tango = function(argFoo) { // Original name: InAppNotificationSettingsScreen
            oscar = this;
            yankee = 0;
 ...
 0:
                    ...
                    zulu = null;
                    if(!(zulu != mike)) { _fun86739_ip = 134; continue _fun86739 }
 29:
 ...
 134:
            ...
            entity['handleOpenUserSettings'] = mike;
            return entity;
        };
        ...
        report = {};
        entity = 'renderGroupDMNotificationSettings';
        report['key'] = entity;
 ...
 0:
                ...
                entity = null;
                if(!(entity != options)) { _fun86741_ip = 210; continue _fun86741 }
 28:
                ...
                mike = sizing[mike];
                report = undefined;
                oscar = romeo.bind(report)(mike);
                tango = oscar.computeChannelName;
                zulu = _closure1_slot13;
                mike = _closure1_slot11;
                kilo = tango.bind(oscar)(options, zulu, mike);
                tango = _closure1_slot16;
                oscar = 17;
                mike = sizing[oscar];
                ...
                oscar['label'] = yankee;
                oscar['value'] = offset;
                verify = verify.handleGroupDMMute;
 ...
 210:
        ...
        entity[0] = report;
        report = {};
        golf = 'renderTextChannelNotificationSettings';
        report['key'] = golf;
 ...
 0:
                ...
                entity = null;
                mike = entity == oscar;
                if(mike) { _fun86742_ip = 68; continue _fun86742 }
 22:
 ...
 68:
        ...
        entity[1] = report;
        report = {};
        golf = 'renderChannelNotificationSettings';
        report['key'] = golf;
        golf = function() { // Original name: value
 ...
 0:
                ...
                mike = entity.channel;
                entity = null;
                if(!(entity != mike)) { _fun86743_ip = 99; continue _fun86743 }
 19:
                tango = mike.type;
                report = _closure1_slot14;
                report = report.GROUP_DM;
                if(!(report !== tango)) { _fun86743_ip = 85; continue _fun86743 }
 41:
                report = _closure1_slot14;
                report = report.GUILD_TEXT;
                if(!(report !== tango)) { _fun86743_ip = 71; continue _fun86743 }
 55:
                mike = _closure1_slot14;
                mike = mike.GUILD_ANNOUNCEMENT;
                if(!(mike !== tango)) { _fun86743_ip = 71; continue _fun86743 }
 69:
                return entity;
 71:
                mike = zulu.renderTextChannelNotificationSettings;
                mike = mike.bind(zulu)();
                return mike;
 85:
                mike = zulu.renderGroupDMNotificationSettings;
                mike = mike.bind(zulu)();
                return mike;
 99:
                return entity;
        ...
        oscar = function() { // Original name: value
            ...
            mike = entity.Form;
            entity = {};
            report = output.renderChannelNotificationSettings;
            options = report.bind(output)();
            report = new Array(3);
            report[0] = options;
            yankee = _closure1_slot16;
            options = foxtrot[oscar];
            options = romeo.bind(zulu)(options);
            offset = options.FormSection;
            options = {};
            verify = 18;
            ...
            result = romeo.bind(zulu)(result);
            update = result.intl;
            echo = update.string;
            result = foxtrot[verify];
            result = romeo.bind(zulu)(result);
            result = result.t;
            result = result.cHMabW;
            result = echo.bind(update)(result);
            backup['label'] = result;
            output = output.handleOpenUserSettings;
            backup['onPress'] = output;
            echo = _closure1_slot16;
            output = foxtrot[oscar];
            output = romeo.bind(zulu)(output);
    ...
    tango = function(argFoo) { // Original name: ConnectedInAppNotificationSettingsScreen
        entity = argFoo;
        oscar = entity.channel;
 ...
 0:
                ...
                report = undefined;
                entity = undefined;
                if(!zulu) { _fun86746_ip = 81; continue _fun86746 }
 20:
                ...
                entity = undefined;
                if(!tango) { _fun86746_ip = 81; continue _fun86746 }
 46:
 ...
 81:
    ...
    mike = function(argFoo) {
        ...
        report = 'IN_APP_NOTIFICATION_SETTINGS';
    ...
    tango = 'components_native/InAppNotificationSettingsModal.tsx';
    tango = report.bind(oscar)(tango);
    zulu['default'] = mike;
    return entity;
})();