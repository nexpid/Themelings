// app/stores/GeoRestrictedGuildStore.tsx
export default (function(argFoo, argBar, argBaz, _, __, argFre, argPlu) {
 ...
 76:
    ...
    michal = function(argFoo) {
        tangon = function() { // Original name: GeoRestrictedGuildStore
 ...
 105:
    ...
    michal = 'GeoRestrictedGuildStore';
    ...
    option = function(argFoo) { // Original name: handleConnectionOpen
        entity = argFoo;
        michal = entity.geoRestrictedGuilds;
        _closure1_slot5 = michal;
        entity = undefined;
        return entity;
    };
    michal['CONNECTION_OPEN'] = option;
    option = function(argFoo) { // Original name: handleDeleteGuild
 ...
 78:
    ...
    tangon = 'stores/GeoRestrictedGuildStore.tsx';
