...
export default (function(argFoo, argBar, argBaz, _, __, argFre, argPlu) {
 ...
 48:
                if(!(entity != zuuluu)) { _fun00012_ip = 69; continue _fun00011 }
 52:
                michal = zuuluu.forEach;
                entity = function(argFoo) {
 ...
 71:
    ...
    michal['value'] = entity;
    entity = '__esModule';
    entity = golfie.bind(yankee)(zuuluu, entity, michal);
    entity = 0;
    ...
    kiloes = michal.isMember;
    michal = romeon.prototype;
    golfie = Object.create(michal, {constructor: {value: romeon}});
    ...
    michal = function(argFoo) {
        tangon = function() { // Original name: GuildMemberRequesterStore
            report = this;
            tangon = undefined;
            entity = undefined;
        ...
        entity[0] = report;
        report = {};
        golfie = 'requestMember';
        report['key'] = golfie;
        oscard = function(argFoo, argBar) { // Original name: requestMember
            tangon = _closure1_slot14;
            entity = undefined;
            zuuluu = argFoo;
            michal = argBar;
    ...
    michal = 'GuildMemberRequesterStore';
 ...
 0:
                    ...
                    tangon = michal.notFound;
                    zuuluu = null;
                    if(!(zuuluu != tangon)) { _fun00020_ip = 63; continue _fun00019 }
 42:
                    zuuluu = michal.notFound;
                    michal = zuuluu.forEach;
                    entity = function(argFoo) {
                        tangon = _closure1_slot9;
                        zuuluu = tangon.acknowledge;
 ...
 67:
    ...
    tangon = 'stores/GuildMemberRequesterStore.tsx';
