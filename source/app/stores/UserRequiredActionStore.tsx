...
export default (function(argFoo, argBar, argBaz, _, __, argFre, argPlu) {
 ...
 76:
    ...
    tangon = function(argFoo) { // Original name: handleRequiredAction
        entity = argFoo;
        michal = entity.requiredAction;
    ...
    michal = function(argFoo) {
        tangon = function() { // Original name: UserRequiredActionStore
 ...
 105:
    ...
    michal = 'UserRequiredActionStore';
    ...
    tangon = 'stores/UserRequiredActionStore.tsx';
