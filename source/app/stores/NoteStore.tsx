...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
 ...
 74:
    ...
    mike = function(argFoo) {
        tango = function() { // Original name: NoteStore
            report = this;
            tango = undefined;
            entity = undefined;
    ...
    options = function(argFoo) { // Original name: handleNoteUpdate
        tango = argFoo;
    ...
    mike['USER_NOTE_UPDATE'] = options;
    options = function(argFoo) { // Original name: handleNoteLoadStart
        entity = argFoo;
        zulu = entity.userId;
        mike = _closure1_slot5;
 ...
 0:
            ...
            entity = undefined;
            report = undefined;
            if(golf) { _fun00006_ip = 49; continue _fun00005 }
 43:
            report = oscar.note;
 49:
            mike['note'] = report;
