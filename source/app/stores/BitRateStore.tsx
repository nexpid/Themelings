...
export default (function(argFoo, argBar, argBaz, _, __, argFre, argPlu) {
 ...
 74:
    ...
    michal = michal.DEFAULT_VOICE_BITRATE;
    ...
    michal = function(argFoo) {
        tangon = function() { // Original name: BitRateStore
 ...
 105:
    ...
    michal = {};
    tangon = function(argFoo) { // Original name: handleSetChannelBitrate
        entity = argFoo;
        michal = entity.bitrate;
        _closure1_slot5 = michal;
        entity = undefined;
        return entity;
    };
    michal['SET_CHANNEL_BITRATE'] = tangon;
    ...
    tangon = 'stores/BitRateStore.tsx';
