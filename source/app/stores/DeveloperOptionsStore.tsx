...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
            ...
            if(entity) { _fun35932_ip = 51; continue _fun35932 }
 38:
            entity = verify.apply;
            entity = entity.bind(verify)(tango, oscar);
            _fun35932_ip = 92; continue _fun35932;
 51:
            golf = global;
            options = golf.Reflect;
            golf = options.construct;
            if(oscar) { _fun35932_ip = 71; continue _fun35932 }
 67:
            oscar = new Array(0);
 71:
 ...
 70: // try_end0
            _fun35933_ip = 74; continue _fun35933;
 72: // catch_target0
 ...
 74:
    ...
    entity = function(argFoo) { // Original name: setOptions
        entity = {};
        ...
        entity = entity.sourceMapsEnabled;
    ...
    update = '';
    result = '//';
    sizing = '/__development/source_maps';
    ...
    echo = verify;
    output = true;
    mike = new update[offset](echo, result, output, sizing);
 ...
 0:
                ...
                zulu = entity.status;
                mike = 401;
                if(!(mike !== zulu)) { _fun35938_ip = 200; continue _fun35938 }
 21:
                zulu = entity.status;
                mike = 403;
                if(!(mike !== zulu)) { _fun35938_ip = 200; continue _fun35938 }
 39:
                zulu = entity.status;
                mike = 200;
                if(!(mike === zulu)) { _fun35938_ip = 157; continue _fun35938 }
 51:
                ...
                entity = entity.body;
                oscar = entity.sourceMapCookieTTLSeconds;
                ...
                _fun35938_ip = 251; continue _fun35938;
 157:
                entity = global;
 ...
 200:
                ...
                mike = zulu.setDeveloperOptionSettings;
                entity = {};
                tango = false;
                entity['sourceMapsEnabled'] = tango;
 ...
 0:
            ...
            zulu = null;
            entity = zulu != entity;
            if(!(tango !== entity)) { _fun35940_ip = 170; continue _fun35940 }
 23:
            entity = global;
            if(tango) { _fun35940_ip = 146; continue _fun35940 }
 28:
            ...
            _fun35940_ip = 170; continue _fun35940;
 146:
            report = entity.setTimeout;
            tango = _closure1_slot13;
            zulu = undefined;
 ...
 170:
    ...
    options = function(argFoo) {
        tango = function() { // Original name: DeveloperOptionsStore
            report = this;
            tango = undefined;
            entity = undefined;
 ...
 0:
                ...
                mike = null;
                if(!(mike != tango)) { _fun35943_ip = 78; continue _fun35943 }
 51:
                mike = {};
                oscar = _closure1_slot16;
                golf = mike;
 ...
 78:
        ...
        golf = function() { // Original name: get
            entity = _closure1_slot17;
            entity = entity.canary;
            return entity;
        };
        report['get'] = golf;
        entity[2] = report;
        report = {};
        golf = 'isLoggingGatewayEvents';
        report['key'] = golf;
        golf = function() { // Original name: get
            entity = _closure1_slot17;
            entity = entity.logGatewayEvents;
            return entity;
        };
        report['get'] = golf;
        entity[3] = report;
        report = {};
        golf = 'isLoggingOverlayEvents';
        report['key'] = golf;
        golf = function() { // Original name: get
            entity = _closure1_slot17;
            entity = entity.logOverlayEvents;
            return entity;
        };
        report['get'] = golf;
        entity[4] = report;
        report = {};
        golf = 'isLoggingAnalyticsEvents';
        report['key'] = golf;
        golf = function() { // Original name: get
            entity = _closure1_slot17;
            entity = entity.logAnalyticsEvents;
            return entity;
        };
        report['get'] = golf;
        entity[5] = report;
        ...
        golf = function() { // Original name: get
            entity = _closure1_slot17;
            entity = entity.axeEnabled;
            return entity;
        };
        report['get'] = golf;
        entity[6] = report;
        report = {};
        golf = 'cssDebuggingEnabled';
        report['key'] = golf;
        golf = function() { // Original name: get
            entity = _closure1_slot17;
            entity = entity.cssDebuggingEnabled;
            return entity;
        };
        report['get'] = golf;
        entity[7] = report;
        report = {};
        golf = 'layoutDebuggingEnabled';
        report['key'] = golf;
        golf = function() { // Original name: get
            entity = _closure1_slot17;
            entity = entity.layoutDebuggingEnabled;
            return entity;
        };
        report['get'] = golf;
        entity[8] = report;
        report = {};
        golf = 'sourceMapsEnabled';
        report['key'] = golf;
        golf = function() { // Original name: get
            entity = _closure1_slot17;
            entity = entity.sourceMapsEnabled;
        ...
        entity[9] = report;
        report = {};
        golf = 'isAnalyticsDebuggerEnabled';
        report['key'] = golf;
        golf = function() { // Original name: get
            entity = _closure1_slot17;
            entity = entity.analyticsDebuggerEnabled;
            return entity;
        };
        report['get'] = golf;
        entity[10] = report;
        report = {};
        golf = 'isBugReporterEnabled';
        report['key'] = golf;
        golf = function() { // Original name: get
            entity = _closure1_slot17;
            entity = entity.bugReporterEnabled;
            return entity;
        };
        report['get'] = golf;
        entity[11] = report;
        report = {};
        golf = 'isIdleStatusIndicatorEnabled';
        report['key'] = golf;
        golf = function() { // Original name: get
            entity = _closure1_slot17;
            entity = entity.idleStatusIndicatorEnabled;
            return entity;
        };
        report['get'] = golf;
        entity[12] = report;
        report = {};
        golf = 'onlyShowPreviewAppCollections';
        report['key'] = golf;
        golf = function() { // Original name: get
            entity = _closure1_slot17;
            entity = entity.onlyShowPreviewAppCollections;
            return entity;
        };
        report['get'] = golf;
        entity[13] = report;
        report = {};
        golf = 'disableAppCollectionsCache';
        report['key'] = golf;
        golf = function() { // Original name: get
            entity = _closure1_slot17;
            entity = entity.disableAppCollectionsCache;
            return entity;
        };
        report['get'] = golf;
        entity[14] = report;
        report = {};
        golf = 'isStreamInfoOverlayEnabled';
        report['key'] = golf;
        golf = function() { // Original name: get
            entity = _closure1_slot17;
            entity = entity.isStreamInfoOverlayEnabled;
            return entity;
        };
        report['get'] = golf;
        entity[15] = report;
        report = {};
        golf = 'preventPopoutClose';
        report['key'] = golf;
        golf = function() { // Original name: get
            entity = _closure1_slot17;
            entity = entity.preventPopoutClose;
            return entity;
        };
        report['get'] = golf;
        entity[16] = report;
        report = {};
        golf = 'getDebugOptionsHeaderValue';
        report['key'] = golf;
        oscar = function() { // Original name: getDebugOptionsHeaderValue
            zulu = global;
            oscar = zulu.Object;
            report = oscar.keys;
 ...
 0:
            ...
            mike = tango != entity;
            oscar = 0;
            if(!mike) { _fun35964_ip = 27; continue _fun35964 }
 24:
            oscar = entity;
 27:
            ...
            mike = report === mike;
            oscar = mike;
            if(oscar) { _fun35964_ip = 75; continue _fun35964 }
 60:
            zulu = zulu.user;
            zulu = zulu.personal_connection_id;
            oscar = tango != zulu;
 75:
            if(!mike) { _fun35964_ip = 102; continue _fun35964 }
 78:
            tango = _closure1_slot14;
            zulu = tango.set;
            mike = _closure1_slot17;
            mike = mike.sourceMapsEnabled;
            mike = zulu.bind(tango)(mike);
 102:
    ...
    mike['DEVELOPER_OPTIONS_UPDATE_SETTINGS'] = tango;
    ...
    tango = 'stores/DeveloperOptionsStore.tsx';
    tango = report.bind(oscar)(tango);
    zulu['default'] = mike;
    return entity;
})();