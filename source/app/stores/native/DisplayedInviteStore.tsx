...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
 ...
 76:
    ...
    mike = function(argFoo) {
        tango = function() { // Original name: DisplayedInviteStore
            report = this;
            tango = undefined;
            entity = undefined;
    ...
    mike = 'DisplayedInviteStore';
    golf['displayName'] = mike;
    mike = 6;
    mike = report[mike];
    yankee = oscar.bind(entity)(mike);
    mike = {};
    options = function(argFoo) { // Original name: handleInviteShow
        entity = argFoo;
        tango = entity.code;
        zulu = entity.username;
        mike = entity.deeplinkAttemptId;
    ...
    mike['DISPLAYED_INVITE_SHOW'] = options;
    tango = function() { // Original name: handleClearDisplayedInvite
        entity = null;
    ...
    mike['DISPLAYED_INVITE_CLEAR'] = tango;
    ...
    tango = 'stores/native/DisplayedInviteStore.tsx';
