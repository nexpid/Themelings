...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
 ...
 0:
            ...
            if(entity) { _fun108878_ip = 51; continue _fun108878 }
 38:
            entity = verify.apply;
            entity = entity.bind(verify)(tango, oscar);
            _fun108878_ip = 92; continue _fun108878;
 51:
            golf = global;
            options = golf.Reflect;
            golf = options.construct;
            if(oscar) { _fun108878_ip = 71; continue _fun108878 }
 67:
            oscar = new Array(0);
 71:
 ...
 72: // try_end0
            _fun108879_ip = 76; continue _fun108879;
 74: // catch_target0
 ...
 76:
    ...
    verify = function(argFoo) { // Original name: handleTokenUpdated
        entity = argFoo;
        mike = entity.token;
    ...
    mike = options.getSuperPropertiesBase64;
    ...
    mike = function(argFoo) {
        tango = function() { // Original name: ShareStore
            report = this;
            tango = undefined;
            entity = undefined;
    ...
    offset = function() { // Original name: handleLogout
        ...
        report = zulu.ShareManager;
        tango = report.setSelectedChannel;
        entity = null;
        tango = tango.bind(report)(entity, entity);
        report = zulu.ShareManager;
        tango = report.setAuthenticationToken;
    ...
    mike['LOGOUT'] = offset;
    mike['REGISTER_SUCCESS'] = verify;
    mike['LOGIN_SUCCESS'] = verify;
    mike['UPDATE_TOKEN'] = verify;
    verify = function() { // Original name: handleStartSession
 ...
 0:
            ...
            if(!(zulu === entity)) { _fun108889_ip = 325; continue _fun108889 }
 28:
            zulu = _closure1_slot16;
            entity = null;
            if(!(entity != zulu)) { _fun108889_ip = 283; continue _fun108889 }
 41:
            ...
            zulu = entity != golf;
            oscar = null;
            if(!zulu) { _fun108889_ip = 97; continue _fun108889 }
 68:
            zulu = global;
            report = zulu.JSON;
 ...
 97:
            ...
            zulu = entity != options;
            report = null;
            if(!zulu) { _fun108889_ip = 253; continue _fun108889 }
 134:
            zulu = global;
            golf = zulu.JSON;
            tango = golf.stringify;
            zulu = {};
            verify = options.toJS;
            foxtrot = verify.bind(options)();
            backup = zulu;
            verify = copyDataProperties(backup, foxtrot);
            offset = options.recipients;
            if(!(entity == offset)) { _fun108889_ip = 181; continue _fun108889 }
 177:
            offset = new Array(0);
 181:
            verify = offset.map;
            options = _closure1_slot13;
            options = options.getUser;
            ...
            options = undefined;
            options = romeo.bind(options)(yankee);
 ...
 253:
            zulu = _closure1_slot7;
            tango = zulu.ShareManager;
            zulu = tango.setSelectedChannel;
            zulu = zulu.bind(tango)(report, oscar);
            _closure1_slot15 = entity;
            _closure1_slot16 = entity;
 283:
            zulu = _closure1_slot17;
            if(!(entity != zulu)) { _fun108889_ip = 325; continue _fun108889 }
 291:
            zulu = _closure1_slot7;
            oscar = zulu.ShareManager;
            report = oscar.setAuthenticationToken;
 ...
 325:
    ...
    tango = 'stores/native/ShareStore.tsx';
