...
export default (function(_, argBar, __, ___, ____, argFre, argPlu) {
    ...
    oscard = {};
    entity = 'track_focus';
    oscard['TRACK_FOCUS'] = entity;
    entity = 'untrack_focus';
    oscard['UNTRACK_FOCUS'] = entity;
    report = {};
    entity = 'UNSET';
    report['UNSET'] = entity;
    ...
    golfie = 'flow/Action.tsx';
    golfie = option.bind(verify)(golfie);
    zuuluu['DevToolsFocusedPidsTrackMode'] = oscard;
