...
export default (function(argFoo, argBar, argBaz, argCorge, argGrault, argFred, argPlugh) {
 ...
 0:
            ...
            kilo = zulu.token;
            entity = undefined;
            if(!(kilo === entity)) { _fun74989_ip = 44; continue _fun74989 }
 42:
            kilo = null;
 44:
            backup = zulu.duration;
            if(!(backup === entity)) { _fun74989_ip = 55; continue _fun74989 }
 53:
            backup = 0;
 55:
            var _closure2_slot2 = backup;
            yankee = zulu.closed;
            if(!(yankee === entity)) { _fun74989_ip = 71; continue _fun74989 }
 69:
            yankee = false;
 71:
            offset = zulu.exePath;
            if(!(offset === entity)) { _fun74989_ip = 83; continue _fun74989 }
 81:
            offset = null;
 83:
            verify = zulu.voiceChannelId;
            if(!(verify === entity)) { _fun74989_ip = 95; continue _fun74989 }
 93:
            verify = null;
 95:
            options = zulu.sessionId;
            if(!(options === entity)) { _fun74989_ip = 107; continue _fun74989 }
 105:
            options = null;
 107:
            golf = zulu.mediaSessionId;
            if(!(golf === entity)) { _fun74989_ip = 119; continue _fun74989 }
 117:
            golf = null;
 119:
 ...
 0:
            ...
            zulu = null;
            if(!(zulu != mike)) { _fun74993_ip = 205; continue _fun74993 }
 69:
            ...
            romeo = zulu != yankee;
            report = '';
            if(!romeo) { _fun74993_ip = 111; continue _fun74993 }
 108:
            report = yankee;
 111:
 ...
 0:
                    ...
                    if(!(verify !== oscar)) { _fun74994_ip = 92; continue _fun74994 }
 80:
                    oscar = _closure1_slot8;
                    oscar = oscar.APPLICATION;
                    _fun74994_ip = 102; continue _fun74994;
 92:
 ...
 102:
                    ...
                    oscar = null;
                    options = oscar != golf;
                    if(!options) { _fun74994_ip = 168; continue _fun74994 }
 158:
                    golf = golf.body;
                    oscar = golf.id;
 168:
 ...
 0:
                    ...
                    if(mike) { _fun75000_ip = 173; continue _fun75000 }
 10:
                    report = {};
                    mike = _closure2_slot3;
                    zulu = null;
                    if(!(zulu != mike)) { _fun75000_ip = 35; continue _fun75000 }
 25:
                    mike = _closure2_slot3;
                    report['channel_id'] = mike;
 35:
                    mike = _closure2_slot4;
                    if(!(zulu != mike)) { _fun75000_ip = 53; continue _fun75000 }
 43:
                    mike = _closure2_slot4;
 ...
 150:
                    ...
                    if(zulu) { _fun75000_ip = 170; continue _fun75000 }
 156:
                    zulu = mike.body;
                    zulu = zulu.secret;
                    return zulu;
 ...
 0:
                    StartGenerator();
                    ResumeGenerator(result_out_reg=0, return_bool_out_reg=1);
                    if(mike) { _fun75003_ip = 139; continue _fun75003 }
 10:
 ...
 122:
                    ResumeGenerator(result_out_reg=1, return_bool_out_reg=2);
                    if(zulu) { _fun75003_ip = 136; continue _fun75003 }
 128:
                    zulu = mike.body;
                    return zulu;
 136:
