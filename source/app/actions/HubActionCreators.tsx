...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
 ...
 0:
                ...
                zulu = undefined;
                report = undefined;
                if(tango) { _fun93709_ip = 38; continue _fun93709 }
 16:
                mike = mike.body;
                tango = entity == mike;
                report = undefined;
 ...
 38:
                ...
                tango = false;
                if(!entity) { _fun93709_ip = 87; continue _fun93709 }
 47:
                mike = report.split;
                entity = '.';
 ...
 0:
                    ...
                    if(mike) { _fun93712_ip = 189; continue _fun93712 }
 10:
 ...
 0:
                            ...
                            zulu = undefined;
                            tango = undefined;
                            if(report) { _fun93713_ip = 36; continue _fun93713 }
 16:
                            entity = entity.body;
                            mike = mike == entity;
                            tango = undefined;
                            if(mike) { _fun93713_ip = 36; continue _fun93713 }
 30:
 ...
 172:
                    ...
                    if(zulu) { _fun93712_ip = 186; continue _fun93712 }
 178:
                    zulu = mike.body;
                    return zulu;
 186:
 ...
 0:
                    StartGenerator();
                    ResumeGenerator(result_out_reg=0, return_bool_out_reg=1);
                    if(mike) { _fun93716_ip = 289; continue _fun93716 }
 10:
                    mike = undefined;
                    report = undefined;
                    zulu = _closure2_slot0;
                    golf = null;
                    if(!(golf != zulu)) { _fun93716_ip = 286; continue _fun93716 }
 30: // try_start_0
 ...
 145:
                    ...
                    if(oscar) { _fun93716_ip = 226; continue _fun93716 }
 151:
                    oscar = zulu.body;
                    oscar = oscar.guild;
                    report = oscar;
                    oscar = golf == oscar;
                    golf = undefined;
                    if(oscar) { _fun93716_ip = 178; continue _fun93716 }
 173:
                    golf = report.id;
 178:
 ...
 224: // try_end0
                    _fun93716_ip = 286; continue _fun93716;
 226:
                    return zulu;
 229: // catch_target0
 ...
 0:
                    StartGenerator();
                    ResumeGenerator(result_out_reg=0, return_bool_out_reg=1);
                    if(mike) { _fun93719_ip = 315; continue _fun93719 }
 10:
                    report = undefined;
                    oscar = undefined;
                    zulu = undefined;
                    ...
                    options = null;
                    if(!(options == mike)) { _fun93719_ip = 32; continue _fun93719 }
 29:
                    return report;
 32: // try_start_0
 ...
 163:
                    ...
                    if(golf) { _fun93719_ip = 253; continue _fun93719 }
 169:
                    zulu = mike;
                    golf = mike.body;
                    golf = golf.guild;
                    ...
                    golf = options == golf;
                    options = undefined;
                    if(golf) { _fun93719_ip = 199; continue _fun93719 }
 194:
                    options = oscar.id;
 199:
                    oscar = _closure1_slot1;
