...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
 ...
 0:
            ...
            if(oscar) { _fun98946_ip = 120; continue _fun98946 }
 89:
            ...
            _fun98946_ip = 161; continue _fun98946;
 120:
 ...
 0:
            ...
            report = {};
            zulu = null;
            if(!(zulu != tango)) { _fun98947_ip = 24; continue _fun98947 }
 16:
            report['survey_override'] = tango;
 24:
            if(!(zulu != mike)) { _fun98947_ip = 36; continue _fun98947 }
 28:
 ...
 0:
                    ...
                    tango = undefined;
                    report = undefined;
                    if(mike) { _fun98948_ip = 36; continue _fun98948 }
 16:
                    entity = entity.body;
                    mike = oscar == entity;
                    report = undefined;
 ...
 36:
                    ...
                    oscar = oscar == report;
                    tango = undefined;
                    if(oscar) { _fun98948_ip = 81; continue _fun98948 }
 76:
                    tango = report.key;
 81:
                    entity['key'] = tango;
 ...
 0:
                    ...
                    options = golf == oscar;
                    report = undefined;
                    if(options) { _fun98949_ip = 76; continue _fun98949 }
 56:
                    oscar = oscar.body;
                    golf = golf == oscar;
                    report = undefined;
                    if(golf) { _fun98949_ip = 76; continue _fun98949 }
 70:
                    report = oscar.survey;
 76:
                    mike['survey'] = report;
 ...
 0:
            ...
            entity = null;
            if(!(entity !== mike)) { _fun98951_ip = 71; continue _fun98951 }
 34:
            if(!(entity != mike)) { _fun98951_ip = 67; continue _fun98951 }
 38:
            entity = global;
            zulu = entity.Date;
            entity = zulu.now;
            ...
            if(!(!(mike >= entity))) { _fun98951_ip = 71; continue _fun98951 }
 67:
            entity = undefined;
            return entity;
 71:
