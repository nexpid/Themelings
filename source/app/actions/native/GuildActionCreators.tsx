...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
    ...
    tango = function(argFoo, argBar) { // Original name: batchChannelUpdate
        _fun126147: for(var _fun126147_ip = 0; ; ) switch(_fun126147_ip) {
 0:
            report = argBar;
            mike = report.length;
            entity = 0;
            if(!(!(mike <= entity))) { _fun126147_ip = 155; continue _fun126147 }
 17:
 ...
 155:
    ...
    mike = function(argFoo, argBar) { // Original name: batchRoleUpdate
        _fun126149: for(var _fun126149_ip = 0; ; ) switch(_fun126149_ip) {
 0:
            report = argBar;
            mike = report.length;
            entity = 0;
            if(!(!(mike <= entity))) { _fun126149_ip = 155; continue _fun126149 }
 17:
            zulu = function() { // Original name: onEnd
                zulu = _closure1_slot1;
                mike = _closure1_slot2;
