...
export default (function(argFoo, argBar, _, __, ___, argFred, argPlugh) {
 ...
 18:
                ...
                golf = 'animate-always';
                zulu = oscar;
                if(!(golf !== options)) { _fun47894_ip = 112; continue _fun47894 }
 92:
                golf = 'respect-motion-settings';
                if(!(golf === options)) { _fun47894_ip = 108; continue _fun47894 }
 102:
                zulu = oscar;
                if(!mike) { _fun47894_ip = 112; continue _fun47894 }
 108:
 ...
 112:
        ...
        tango = tango.accessibilityPreferencesSharedValue;
        zulu['accessibilityPreferencesSharedValue'] = tango;
        tango = 2;
        tango = golf[tango];
        tango = oscar.bind(report)(tango);
        tango = tango.withSpring;
        zulu['REAwithSpring'] = tango;
        tango = _closure1_slot2;
        zulu['CONFIG_NEVER_ANIMATE'] = tango;
        entity['__closure'] = zulu;
        zulu = 14617353056916.0;
    ...
    tango = 'design/animation/reanimated/spring/spring.tsx';
    tango = report.bind(oscar)(tango);
    zulu['withSpring'] = mike;
    return entity;
})();