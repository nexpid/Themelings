...
export default (function(_, argBar, __, ___, ____, argFre, argPlu) {
    ...
    oscard = report[michal];
    oscard = tangon.bind(entity)(oscard);
    oscard = oscard.ThemeContextProvider;
    zuuluu['ThemeContextProvider'] = oscard;
    oscard = report[michal];
    oscard = tangon.bind(entity)(oscard);
    oscard = oscard.RootThemeContextProvider;
    zuuluu['RootThemeContextProvider'] = oscard;
    oscard = report[michal];
    oscard = tangon.bind(entity)(oscard);
    ...
    oscard = report[michal];
    oscard = tangon.bind(entity)(oscard);
    oscard = oscard.DisableCustomTheme;
    zuuluu['DisableCustomTheme'] = oscard;
    oscard = report[michal];
    oscard = tangon.bind(entity)(oscard);
    oscard = oscard.UseThemeContext;
    zuuluu['UseThemeContext'] = oscard;
    oscard = report[michal];
    oscard = tangon.bind(entity)(oscard);
    oscard = oscard.ThemeContextFlags;
    zuuluu['ThemeContextFlags'] = oscard;
    oscard = report[michal];
    oscard = tangon.bind(entity)(oscard);
    oscard = oscard.setThemeFlag;
    zuuluu['setThemeFlag'] = oscard;
    oscard = report[michal];
    oscard = tangon.bind(entity)(oscard);
    oscard = oscard.hasThemeFlag;
    zuuluu['hasThemeFlag'] = oscard;
    michal = report[michal];
    michal = tangon.bind(entity)(michal);
