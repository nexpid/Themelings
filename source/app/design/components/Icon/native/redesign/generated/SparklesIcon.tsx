...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    tango = 'design/components/Icon/native/redesign/generated/SparklesIcon.tsx';
    tango = report.bind(oscar)(tango);
    mike = function(argFoo) {
        _fun120786: for(var _fun120786_ip = 0; ; ) switch(_fun120786_ip) {
 0:
            zulu = argFoo;
            oscar = zulu.style;
            golf = zulu.color;
            tango = undefined;
            if(!(golf === tango)) { _fun120786_ip = 53; continue _fun120786 }
 19:
