...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
                ...
                golf = 1;
                tango = 0;
                if(!entity) { _fun77380_ip = 146; continue _fun77380 }
 74:
                ...
                mike = offset[entity];
                entity = tango;
                if(!(yankee >= backup)) { _fun77380_ip = 133; continue _fun77380 }
 113:
                backup = backup + kilo;
                if(!(yankee <= backup)) { _fun77380_ip = 133; continue _fun77380 }
 121:
                if(!(romeo >= mike)) { _fun77380_ip = 133; continue _fun77380 }
 125:
                mike = mike + foxtrot;
                if(!(!(romeo <= mike))) { _fun77380_ip = 166; continue _fun77380 }
 133:
                tango = entity + oscar;
                mike = offset.length;
                if(tango < mike) { _fun77380_ip = 74; continue _fun77380 }
 146:
                tango = report.set;
                mike = -1;
 ...
 166:
                ...
                entity = entity !== tango;
                if(!entity) { _fun77380_ip = 269; continue _fun77380 }
 186:
                mike = report.set;
 ...
 0:
                    ...
                    mike = entity.menu;
                    zulu = null;
                    if(!(zulu != mike)) { _fun77385_ip = 25; continue _fun77385 }
 15:
                    mike = {};
                    mike['menu'] = zulu;
                    entity = mike;
 ...
 0:
            ...
            mike = entity.length;
            entity = 0;
            if(!(mike > entity)) { _fun77390_ip = 81; continue _fun77390 }
 67:
            mike = zulu.set;
            entity = new Array(0);
            entity = mike.bind(zulu)(entity);
