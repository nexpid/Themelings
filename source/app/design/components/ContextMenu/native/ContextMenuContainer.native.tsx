...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    tango['overlayView'] = verify;
    verify = options.absoluteFillObject;
    tango['wrapperView'] = verify;
    tango = golf.bind(options)(tango);
    var _closure1_slot7 = tango;
    tango = new Array(0);
    var _closure1_slot8 = tango;
    tango = function() { // Original name: EMPTY_CALLBACK
        entity = undefined;
        return entity;
    };
    var _closure1_slot9 = tango;
    tango = function(argFoo, argBar, argBaz, argCorge) { // Original name: renderItem
 ...
 0:
            ...
            golf = mike.bind(zulu)();
            zulu = null;
            if(!(zulu == golf)) { _fun00002_ip = 49; continue _fun00001 }
 43:
 ...
 60:
            options = zulu == golf;
            mike = undefined;
            if(options) { _fun00002_ip = 75; continue _fun00001 }
 69:
            mike = golf.requestClose;
 75:
            if(!(zulu == mike)) { _fun00002_ip = 83; continue _fun00001 }
 79:
 ...
 83:
            ...
            options = function() {
                ...
                zulu = mike.hideContextMenu;
                mike = 'keyboardDidHide';
            ...
            zulu = new Array(0);
            zulu = verify.bind(golf)(options, zulu);
 ...
 0:
                    ...
                    options = 'auto';
                    verify = 0;
                    if(!(verify === offset)) { _fun00004_ip = 73; continue _fun00003 }
 69:
                    options = 'none';
 73:
                    report['pointerEvents'] = options;
                    options = _closure1_slot7;
                    options = options.wrapperView;
    ...
    zulu['ContextMenuContainer'] = mike;
    return entity;
})();