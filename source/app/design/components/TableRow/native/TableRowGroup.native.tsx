...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    tango = function(argFoo) { // Original name: TableRowGroupTitle
        entity = argFoo;
        report = entity.title;
        ...
        mike = entity.Text;
        entity = {'accessibilityRole': 'header', 'variant': 'text-sm/semibold', 'color': 'header-secondary'};
        oscar = oscar.title;
        entity['style'] = oscar;
    ...
    report = 'design/components/TableRow/native/TableRowGroup.native.tsx';
 ...
 0:
            ...
            tango = undefined;
            if(!(backup === tango)) { _fun63720_ip = 41; continue _fun63720 }
 37:
            backup = 'none';
 41:
            foxtrot = zulu.accessibilityLabel;
 ...
 0:
                    ...
                    mike = zulu == options;
                    entity = null;
                    if(mike) { _fun63721_ip = 218; continue _fun63721 }
 17:
                    mike = _closure2_slot0;
                    mike = zulu == mike;
                    if(!mike) { _fun63721_ip = 49; continue _fun63721 }
 31:
                    report = _closure1_slot2;
                    tango = report.isValidElement;
                    mike = tango.bind(report)(options);
 49:
                    if(!mike) { _fun63721_ip = 92; continue _fun63721 }
 52:
                    report = options.type;
                    ...
                    mike = report === tango;
 92:
                    if(!mike) { _fun63721_ip = 113; continue _fun63721 }
 95:
                    mike = options.props;
                    mike = mike.icon;
                    mike = zulu != mike;
 ...
 113:
                    ...
                    if(mike) { _fun63721_ip = 131; continue _fun63721 }
 120:
                    mike = true;
                    _closure2_slot1 = mike;
                    mike = options;
                    _fun63721_ip = 215; continue _fun63721;
 131:
                    ...
                    verify = golf.TableRowDivider;
                    golf = {};
                    yankee = _closure2_slot0;
                    golf['adjustSpacingForIcon'] = yankee;
                    verify = offset.bind(zulu)(verify, golf);
                    golf = new Array(2);
                    golf[0] = verify;
                    golf[1] = options;
                    tango['children'] = golf;
 ...
 218:
            ...
            romeo = mike.bind(zulu)(report, entity);
            zulu = _closure1_slot4;
            mike = _closure1_slot0;
            ...
            offset = null;
            yankee = offset != echo;
            if(!yankee) { _fun63720_ip = 193; continue _fun63720 }
 173:
            output = _closure1_slot4;
            sizing = _closure1_slot8;
            options = {};
            options['title'] = echo;
            yankee = output.bind(tango)(sizing, options);
 193:
            options = new Array(3);
            options[0] = yankee;
            offset = offset != result;
            if(!offset) { _fun63720_ip = 270; continue _fun63720 }
 208:
            output = _closure1_slot4;
