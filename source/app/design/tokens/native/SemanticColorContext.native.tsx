...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
 ...
 0:
            ...
            report = null;
            if(!(report != oscar)) { _fun47677_ip = 321; continue _fun47677 }
 96:
            ...
            verify = report == zulu;
            entity = null;
            if(verify) { _fun47677_ip = 318; continue _fun47677 }
 126:
            ...
            if(!(report != romeo)) { _fun47677_ip = 178; continue _fun47677 }
 175:
            zulu = romeo;
 178:
            ...
            golf = 'dark';
            if(!romeo) { _fun47677_ip = 279; continue _fun47677 }
 275:
            golf = 'light';
 279:
            zulu['theme'] = golf;
 ...
 321:
            ...
            zulu = 1;
            golf = zulu;
            if(verify) { _fun47677_ip = 339; continue _fun47677 }
 336:
            golf = options;
 339:
            entity['contrast'] = golf;
            report = report != oscar;
            if(report) { _fun47677_ip = 354; continue _fun47677 }
 351:
            zulu = tango;
 354:
