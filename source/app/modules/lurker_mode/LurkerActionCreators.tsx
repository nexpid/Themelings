...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
 ...
 0:
                    ...
                    if(zulu) { _fun65315_ip = 165; continue _fun65315 }
 15:
                    ...
                    report = oscar.length;
                    tango = 0;
                    if(!(tango !== report)) { _fun65315_ip = 157; continue _fun65315 }
 62:
 ...
 0:
                                    ...
                                    if(mike) { _fun65319_ip = 188; continue _fun65319 }
 10:
                                    golf = argFoo;
                                    mike = undefined;
                                    oscar = undefined;
 ...
 120:
                                    ...
                                    if(report) { _fun65319_ip = 128; continue _fun65319 }
 126: // try_end0
                                    _fun65319_ip = 185; continue _fun65319;
 128:
                                    return tango;
 131: // catch_target0
 ...
 151:
                    ...
                    if(zulu) { _fun65315_ip = 162; continue _fun65315 }
 157:
                    zulu = undefined;
                    return zulu;
 162:
 ...
 0:
                    ...
                    report = arguments[0];
                    ResumeGenerator(result_out_reg=0, return_bool_out_reg=1);
                    if(mike) { _fun65323_ip = 171; continue _fun65323 }
 13:
                    tango = undefined;
                    if(!(report === tango)) { _fun65323_ip = 21; continue _fun65323 }
 19:
                    report = null;
 21:
 ...
 25:
                    ResumeGenerator(result_out_reg=1, return_bool_out_reg=2);
                    if(zulu) { _fun65323_ip = 168; continue _fun65323 }
 34:
                    ...
                    options = golf.length;
                    oscar = 0;
                    if(!(oscar !== options)) { _fun65323_ip = 162; continue _fun65323 }
 62:
                    oscar = null;
                    if(!(oscar != report)) { _fun65323_ip = 81; continue _fun65323 }
 68:
                    oscar = golf.includes;
                    oscar = oscar.bind(golf)(report);
                    if(oscar) { _fun65323_ip = 162; continue _fun65323 }
 81:
                    golf = new Array(2);
                    golf[0] = report;
 ...
 156:
                    ...
                    if(report) { _fun65323_ip = 165; continue _fun65323 }
 162:
                    return tango;
 165:
                    return zulu;
