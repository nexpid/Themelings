...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
 ...
 15:
                ...
                report = mike[zulu];
                mike = null;
                if(!(mike != report)) { _fun00004_ip = 74; continue _fun00003 }
 31:
                tango = global;
 ...
 0:
                    ...
                    offset = offset === romeo;
                    zulu = offset;
                    if(offset) { _fun00012_ip = 35; continue _fun00011 }
 32:
                    oscar = verify;
 35:
                    report = oscar;
                    oscar = undefined;
                    verify = zulu;
                    if(verify) { _fun00012_ip = 66; continue _fun00011 }
 46:
 ...
 66: // try_start_0
                    ...
                    yankee = yankee === romeo;
                    options = yankee;
                    if(yankee) { _fun00012_ip = 99; continue _fun00011 }
 96:
                    verify = offset;
 99:
                    golf = verify;
 ...
 108: // try_end0
                    oscar = zulu;
                    if(oscar) { _fun00012_ip = 117; continue _fun00011 }
 114:
                    mike.return();
 117:
                    verify = report;
 ...
 192: // catch_target0
                    ...
                    _fun00012_ip = 198; continue _fun00011;
 196:
                    CatchBlockStart(arg_register=0);
 198:
 ...
 0:
                    ...
                    offset = offset === romeo;
                    zulu = offset;
                    if(offset) { _fun00014_ip = 35; continue _fun00013 }
 32:
                    oscar = verify;
 35:
                    report = oscar;
                    oscar = undefined;
                    verify = zulu;
                    if(verify) { _fun00014_ip = 66; continue _fun00013 }
 46:
                    options = options().value;
                    verify = mike;
                    verify = verify === romeo;
 ...
 66: // try_start_0
                    ...
                    yankee = yankee === romeo;
                    options = yankee;
                    if(yankee) { _fun00014_ip = 99; continue _fun00013 }
 96:
                    verify = offset;
 99:
                    golf = verify;
 ...
 108: // try_end0
                    oscar = zulu;
                    if(oscar) { _fun00014_ip = 117; continue _fun00013 }
 114:
                    mike.return();
 117:
                    verify = report;
 ...
 191:
                    CatchBlockStart(arg_register=0);
 193:
                    if(zulu) { _fun00014_ip = 199; continue _fun00013 }
 196:
                    mike.return();
 199:
                    throw entity;
