...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
 ...
 0:
            ...
            if(entity) { _fun106314_ip = 48; continue _fun106314 }
 35:
            entity = verify.apply;
            entity = entity.bind(verify)(tango, zulu);
            _fun106314_ip = 86; continue _fun106314;
 48:
            oscar = global;
 ...
 72: // try_end0
            _fun106315_ip = 76; continue _fun106315;
 74: // catch_target0
 ...
 0:
                ...
                if(!options) { _fun106322_ip = 148; continue _fun106322 }
 128:
 ...
 148:
                if(!options) { _fun106322_ip = 243; continue _fun106322 }
 151:
                ...
                offset = report == zulu;
                tango = undefined;
                if(offset) { _fun106322_ip = 181; continue _fun106322 }
 176:
                tango = zulu.state;
 181:
                ...
                zulu = zulu.ACTIVE;
                zulu = tango === zulu;
                if(zulu) { _fun106322_ip = 240; continue _fun106322 }
 198:
                ...
                offset = report == tango;
                report = undefined;
                if(offset) { _fun106322_ip = 226; continue _fun106322 }
 221:
                report = tango.state;
 226:
 ...
 243:
                ...
                zulu = zulu.bind(tango)();
                offset = mike;
                if(!mike) { _fun106322_ip = 283; continue _fun106322 }
 263:
 ...
 283:
                if(!offset) { _fun106322_ip = 321; continue _fun106322 }
 286:
                ...
                romeo = report == yankee;
                tango = undefined;
                if(romeo) { _fun106322_ip = 317; continue _fun106322 }
 311:
                tango = yankee.windowHandle;
 317:
                offset = report != tango;
 321:
                if(!offset) { _fun106322_ip = 327; continue _fun106322 }
 324:
                offset = zulu;
 327:
                tango = _closure1_slot0;
                ...
                if(options) { _fun106322_ip = 366; continue _fun106322 }
 363:
                options = offset;
 366:
                ...
                if(!tango) { _fun106322_ip = 438; continue _fun106322 }
 435:
                tango = mike;
 438:
                if(!tango) { _fun106322_ip = 461; continue _fun106322 }
 441:
 ...
 0:
                ...
                report = entity.flags;
                entity = undefined;
                if(!(report === entity)) { _fun106326_ip = 65; continue _fun106326 }
 63:
                report = 0;
 65:
                if(!verify) { _fun106326_ip = 115; continue _fun106326 }
 68:
                ...
                kilo = tango == backup;
                tango = undefined;
                if(kilo) { _fun106326_ip = 101; continue _fun106326 }
 96:
                tango = backup.type;
 101:
                zulu = _closure1_slot15;
                zulu = zulu.GUILD_STAGE_VOICE;
                if(!(tango !== zulu)) { _fun106326_ip = 173; continue _fun106326 }
 115:
                backup = mike.socket;
                ...
                _fun106326_ip = 234; continue _fun106326;
 173:
                tango = mike.socket;
