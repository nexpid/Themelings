...
export default (function(argFoo, argBar, argBaz, _, __, argFre, argPlu) {
 ...
 239:
    ...
    tangon = function(argFoo) { // Original name: getAudioFeedbackOptions
        ...
        foxtra = offset[oscard];
        foxtra = verify.bind(michal)(foxtra);
        foxtra = foxtra.WyMQjI;
        foxtra = backup.bind(kiloes)(foxtra);
        tangon['label'] = foxtra;
        entity[5] = tangon;
        tangon = {};
        foxtra = romeon.TOO_LOUD;
        tangon['value'] = foxtra;
        foxtra = yankee.SOMEONE;
        tangon['variant'] = foxtra;
        foxtra = offset[golfie];
        ...
        entity[9] = tangon;
        tangon = {};
        foxtra = romeon.UNABLE_TO_FIND_INPUT_DEVICE;
        tangon['value'] = foxtra;
        foxtra = yankee.SELF;
        tangon['variant'] = foxtra;
        foxtra = offset[golfie];
        ...
        foxtra = offset[oscard];
        foxtra = verify.bind(michal)(foxtra);
        foxtra = foxtra.J2FWpq;
        foxtra = backup.bind(kiloes)(foxtra);
        tangon['label'] = foxtra;
        entity[10] = tangon;
        tangon = {};
        foxtra = romeon.UNABLE_TO_FIND_OUTPUT_DEVICE;
        tangon['value'] = foxtra;
        foxtra = yankee.SELF;
        tangon['variant'] = foxtra;
        foxtra = offset[golfie];
