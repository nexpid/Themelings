...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    entity = function() { // Original name: Placeholder
        ...
        golf = options.usePlaceholderWidth;
        report = 20;
        oscar = 90;
        sizing = golf.bind(options)(report, oscar);
        entity = zulu[entity];
        zulu = mike.bind(tango)(entity);
        mike = zulu.usePlaceholderWidth;
        entity = 70;
        kilo = mike.bind(zulu)(report, entity);
        zulu = _closure1_slot12;
        mike = _closure1_slot5;
        entity = {};
        report = foxtrot.commandContainer;
        entity['style'] = report;
        golf = _closure1_slot11;
        oscar = _closure1_slot5;
        report = {};
        options = foxtrot.loadingCommandIcon;
        ...
        verify = {};
        backup = foxtrot.loadingTextPlaceholder;
        romeo = new Array(2);
        romeo[0] = backup;
        backup = {};
        backup['width'] = sizing;
        ...
        offset = {};
        backup = foxtrot.loadingTextPlaceholderSmall;
        foxtrot = new Array(2);
        foxtrot[0] = backup;
        backup = {};
        backup['width'] = kilo;
 ...
 0:
            ...
            mike = oscar.useAppLauncherContext;
            mike = mike.bind(oscar)();
            foxtrot = mike.entrypoint;
            backup = mike.onActivityItemSelected;
            ...
            golf = golf.bind(verify)(oscar, mike);
            ...
            report = oscar.useActivityAction;
            zulu = {};
            zulu['context'] = output;
            ...
            zulu = null;
            oscar = zulu != mike;
            if(!oscar) { _fun118466_ip = 211; continue _fun118466 }
 205:
            oscar = mike.isLaunching;
 211:
            if(!oscar) { _fun118466_ip = 224; continue _fun118466 }
 214:
 ...
 224:
            ...
            zulu = report.useHandleActivityItemSelected;
            mike = {};
            result = offset.applicationId;
            mike['applicationId'] = result;
            mike['context'] = output;
            output = 15;
            ...
            mike['sectionName'] = output;
            mike['onActivityItemSelected'] = backup;
            backup = 30;
            ...
            mike['entrypoint'] = foxtrot;
            mike['launchingComponentId'] = romeo;
            romeo = false;
            mike['fetchesApplication'] = romeo;
            mike = zulu.bind(report)(mike);
            romeo = mike.handleActivityItemSelected;
            ...
            entity = {};
            entity['app'] = offset;
            if(golf) { _fun118466_ip = 440; continue _fun118466 }
 407:
            offset = _closure1_slot0;
            options = _closure1_slot2;
            options = options[yankee];
            options = offset.bind(tango)(options);
            options = options.ActivityAction;
 ...
 0:
            ...
            oscar = undefined;
            if(!(romeo === oscar)) { _fun118469_ip = 34; continue _fun118469 }
 32:
            romeo = false;
 34:
            ...
            zulu = mike.section;
            entity = null;
            if(!(entity != zulu)) { _fun118469_ip = 306; continue _fun118469 }
 69:
            ...
            report = foxtrot.getAppLauncherIconSource;
            zulu = mike.section;
            zulu = zulu.application;
            backup = report.bind(foxtrot)(zulu);
            ...
            zulu = {};
            if(verify) { _fun118469_ip = 145; continue _fun118469 }
 137:
            offset = yankee.appContainer;
            _fun118469_ip = 151; continue _fun118469;
 145:
            offset = yankee.appContainerDisabled;
 151:
            zulu['style'] = offset;
            zulu['disabled'] = verify;
 ...
 0:
                    ...
                    tango = null;
                    mike = tango != mike;
                    if(!mike) { _fun118470_ip = 34; continue _fun118470 }
 16:
                    ...
                    mike = tango != zulu;
 34:
                    if(!mike) { _fun118470_ip = 108; continue _fun118470 }
 37:
                    zulu = _closure2_slot1;
                    mike = {};
 ...
 108:
            ...
            if(!verify) { _fun118469_ip = 223; continue _fun118469 }
 177:
            ...
            golf['style'] = kilo;
            golf['source'] = backup;
            verify = foxtrot.bind(oscar)(offset, golf);
 223:
            golf = new Array(2);
            golf[0] = verify;
            ...
            verify = options.SubmittingOverlay;
            options = {};
            options['submitting'] = romeo;
 ...
 306:
    ...
    mike = golf[mike];
    mike = oscar.bind(entity)(mike);
    mike = mike.FrecencySectionSelection;
    ...
    kilo = kilo.PX_8;
    yankee['gap'] = kilo;
    mike['scrollViewContentContainer'] = yankee;
    kilo = 16;
    yankee = {'height': 16, 'width': 16};
    mike['contextMenuIcon'] = yankee;
    yankee = {};
    output = golf[romeo];
    ...
    echo = output.SHADOW_LOW;
    update = yankee;
    output = copyDataProperties(update, echo);
    mike['appContainer'] = yankee;
    yankee = {};
    output = golf[romeo];
    output = foxtrot.bind(entity)(output);
    output = output.colors;
    ...
    update = yankee;
    output = copyDataProperties(update, echo);
    mike['appContainerDisabled'] = yankee;
    yankee = {};
    output = golf[romeo];
    output = foxtrot.bind(entity)(output);
    output = output.colors;
    ...
    echo = backup.SHADOW_LOW;
    update = yankee;
    backup = copyDataProperties(update, echo);
    mike['commandContainer'] = yankee;
    ...
    mike['loadingCommandIcon'] = yankee;
    yankee = {};
    backup = golf[romeo];
    backup = foxtrot.bind(entity)(backup);
    backup = backup.colors;
    ...
    mike['loadingTextPlaceholder'] = yankee;
    yankee = {};
    sizing = golf[romeo];
    sizing = foxtrot.bind(entity)(sizing);
    ...
    yankee['alignSelf'] = backup;
    mike['loadingTextPlaceholderSmall'] = yankee;
    ...
    report = {};
    options = "function FrecencySectionTsx1(){const{withTiming,isRecentsMenuOpen}=this.__closure;return{transform:[{rotate:withTiming(isRecentsMenuOpen?'-180deg':'0deg')}]};}";
    report['code'] = options;
    ...
    tango = function(argFoo) { // Original name: FrecencySection
        _fun118471: for(var _fun118471_ip = 0; ; ) switch(_fun118471_ip) {
 0:
            entity = argFoo;
            mike = entity.context;
            var _closure2_slot0 = mike;
            mike = entity.sectionDescriptors;
            ...
            entity = mike.useAppLauncherContext;
            entity = entity.bind(mike)();
            mike = entity.entrypoint;
            ...
            control = 0;
            options = entity[control];
            var _closure2_slot9 = options;
            zulu = 1;
            entity = entity[zulu];
            var _closure2_slot10 = entity;
            entity = 14;
            foxtrot = verify[entity];
            output = report.bind(tango)(foxtrot);
            ...
            foxtrot = function() {
                ...
                entity = mike.getSelection;
                entity = entity.bind(mike)();
                return entity;
            };
            foxtrot = sizing.bind(output)(kilo, foxtrot);
            entity = verify[entity];
            kilo = report.bind(tango)(entity);
            ...
            update = verify.bind(kilo)(report, entity);
            verify = _closure1_slot4;
            report = verify.useState;
            entity = result.length;
            if(!(entity > control)) { _fun118471_ip = 320; continue _fun118471 }
 306:
            entity = _closure1_slot9;
            entity = entity.COMMANDS;
            if(!(foxtrot !== entity)) { _fun118471_ip = 332; continue _fun118471 }
 320:
            entity = _closure1_slot14;
            entity = entity.APPS;
            _fun118471_ip = 342; continue _fun118471;
 332:
            foxtrot = _closure1_slot14;
            entity = foxtrot.COMMANDS;
 342:
            report = report.bind(verify)(entity);
            entity = _closure1_slot3;
            entity = entity.bind(tango)(report, golf);
            report = entity[control];
 ...
 0:
                    ...
                    if(entity) { _fun118474_ip = 44; continue _fun118474 }
 10:
                    mike = _closure2_slot2;
                    mike = mike.length;
                    tango = 0;
                    mike = tango === mike;
                    if(!mike) { _fun118474_ip = 41; continue _fun118474 }
 28:
 ...
 41:
                    entity = mike;
 44:
                    if(entity) { _fun118474_ip = 267; continue _fun118474 }
 50:
                    mike = _closure1_slot0;
                    zulu = _closure1_slot2;
                    entity = 16;
                    ...
                    if(!(verify !== options)) { _fun118474_ip = 122; continue _fun118474 }
 111:
                    options = _closure2_slot2;
                    options = options.length;
                    _fun118474_ip = 131; continue _fun118474;
 122:
 ...
 131:
                    ...
                    oscar = oscar.APPS;
                    if(!(options !== oscar)) { _fun118474_ip = 188; continue _fun118474 }
 154:
                    ...
                    _fun118474_ip = 220; continue _fun118474;
 188:
                    verify = _closure1_slot0;
                    offset = _closure1_slot2;
                    options = 15;
                    ...
                    oscar = options.RECENT_APPS;
 220:
                    entity['section_name'] = oscar;
 ...
 267:
            ...
            kilo = golf.bind(verify)(mike, zulu);
            mike = {};
            mike['apps'] = kilo;
            mike['onlyActivityApps'] = entity;
 ...
 0:
                            ...
                            mike = report == entity;
                            entity = null;
                            if(mike) { _fun118478_ip = 119; continue _fun118478 }
 19:
                            mike = zulu.section;
                            mike = mike.application;
                            tango = report != mike;
                            mike = null;
                            if(!tango) { _fun118478_ip = 116; continue _fun118478 }
 38:
 ...
 0:
                    ...
                    mike = '0deg';
                    if(!oscar) { _fun118479_ip = 56; continue _fun118479 }
 50:
                    mike = '-180deg';
 56:
            ...
            golf['isRecentsMenuOpen'] = options;
            entity['__closure'] = golf;
            golf = 4528534448308.0;
            ...
            entity = result.length;
            if(!(control === entity)) { _fun118471_ip = 636; continue _fun118471 }
 624:
            entity = echo.length;
            if(!(control !== entity)) { _fun118471_ip = 1530; continue _fun118471 }
 636:
            entity = {};
            options = _closure1_slot0;
            mike = _closure1_slot2;
            ...
            zulu = mike.COMMANDS;
            mike = undefined;
            if(!(report === zulu)) { _fun118471_ip = 739; continue _fun118471 }
 713:
            golf = _closure1_slot0;
            options = _closure1_slot2;
            zulu = 20;
            ...
            mike = zulu.CheckmarkSmallBoldIcon;
 739:
            ...
            mike = function() { // Original name: action
                ...
                tango = report.setFrecencySectionSelection;
                ...
                zulu = mike.APP_LAUNCHER_FRECENTS_TOGGLED;
                mike = {};
            ...
            zulu = mike.APPS;
            mike = undefined;
            if(!(report === zulu)) { _fun118471_ip = 863; continue _fun118471 }
 837:
            golf = _closure1_slot0;
            options = _closure1_slot2;
            zulu = 20;
 ...
 863:
            ...
            mike = result.slice;
            entity = 8;
            zulu = mike.bind(result)(control, entity);
            mike = zulu.map;
            entity = function(argFoo) {
 ...
 0:
                    ...
                    offset = entity == zulu;
                    tango = undefined;
                    if(offset) { _fun118482_ip = 84; continue _fun118482 }
 79:
                    tango = zulu.application;
 84:
                    yankee = report.bind(verify)(tango);
                    if(!(entity != zulu)) { _fun118482_ip = 506; continue _fun118482 }
 96:
                    verify = _closure1_slot0;
                    tango = _closure1_slot2;
                    report = 9;
                    ...
                    tango = verify.getSectionName;
                    zulu = zulu.application;
                    if(!(entity == zulu)) { _fun118482_ip = 154; continue _fun118482 }
 131:
                    romeo = _closure1_slot0;
                    offset = _closure1_slot2;
                    offset = offset[report];
                    offset = romeo.bind(oscar)(offset);
                    zulu = offset.FAKE_BUILT_IN_APP;
 154:
                    ...
                    zulu = zulu.PRIMARY_ENTRY_POINT;
                    if(!(tango !== zulu)) { _fun118482_ip = 207; continue _fun118482 }
 200:
                    echo = mike.displayName;
                    _fun118482_ip = 240; continue _fun118482;
 207:
                    tango = _closure1_slot0;
                    zulu = _closure1_slot2;
                    zulu = zulu[report];
                    report = tango.bind(oscar)(zulu);
                    tango = report.formatPrimaryEntryPointCommandName;
                    zulu = mike.displayName;
                    echo = tango.bind(report)(zulu);
 240:
                    report = _closure1_slot12;
                    tango = _closure1_slot0;
                    verify = _closure1_slot2;
                    ...
                    options = options.commandContainer;
                    zulu['style'] = options;
                    golf = function() { // Original name: onPress
                    ...
                    if(!options) { _fun118482_ip = 349; continue _fun118482 }
 304:
                    offset = _closure1_slot11;
                    ...
                    romeo = 36;
                    golf['iconSize'] = romeo;
                    golf['iconSource'] = yankee;
                    options = offset.bind(oscar)(verify, golf);
 349:
                    golf = new Array(2);
                    golf[0] = options;
                    ...
                    output = result.bind(oscar)(output, yankee);
                    yankee = new Array(2);
                    yankee[0] = output;
                    ...
                    foxtrot = romeo.Text;
                    romeo = {'variant': 'text-xs/normal', 'color': 'text-secondary'};
                    romeo['children'] = kilo;
                    romeo = backup.bind(oscar)(foxtrot, romeo);
                    yankee[1] = romeo;
 ...
 0:
                    ...
                    mike = tango == entity;
                    entity = null;
                    if(mike) { _fun118485_ip = 179; continue _fun118485 }
 22:
                    mike = zulu.section;
                    mike = mike.application;
                    if(!(tango != mike)) { _fun118485_ip = 95; continue _fun118485 }
 36:
                    report = _closure1_slot0;
                    oscar = _closure1_slot2;
                    mike = 9;
                    ...
                    if(!mike) { _fun118485_ip = 95; continue _fun118485 }
 85:
                    mike = _closure2_slot13;
                    if(mike) { _fun118485_ip = 141; continue _fun118485 }
 95:
                    offset = _closure1_slot11;
                    ...
                    oscar['onAppSelected'] = mike;
                    report = zulu.applicationId;
                    mike = undefined;
                    mike = offset.bind(mike)(verify, oscar, report);
                    _fun118485_ip = 176; continue _fun118485;
 141:
 ...
 179:
            ...
            mike = result.length;
            if(!(control === mike)) { _fun118471_ip = 1010; continue _fun118471 }
 1001:
            mike = echo.length;
            if(!(!(mike > control))) { _fun118471_ip = 1046; continue _fun118471 }
 1010:
            mike = result.length;
            source = report;
            if(!(mike > control)) { _fun118471_ip = 1044; continue _fun118471 }
 1022:
            mike = echo.length;
            source = report;
            if(!(control === mike)) { _fun118471_ip = 1044; continue _fun118471 }
 1034:
            mike = _closure1_slot14;
            source = mike.COMMANDS;
 1044:
            _fun118471_ip = 1056; continue _fun118471;
 1046:
            mike = _closure1_slot14;
            source = mike.APPS;
 1056:
            ...
            mike = mike.COMMANDS;
            verify = zulu;
            if(!(source === mike)) { _fun118471_ip = 1080; continue _fun118471 }
 1077:
            verify = entity;
 1080:
            zulu = _closure1_slot12;
            ...
            sizing = kilo.ContextMenu;
            kilo = {};
            result = result.length;
            result = result > control;
            if(!result) { _fun118471_ip = 1172; continue _fun118471 }
 1163:
            echo = echo.length;
            result = echo > control;
 1172:
 ...
 0:
                    ...
                    golf = report > verify;
                    report = null;
                    if(!golf) { _fun118488_ip = 297; continue _fun118488 }
 172:
 ...
 190:
                    ...
                    foxtrot = foxtrot.contextMenuIcon;
                    offset['style'] = foxtrot;
                    offset = romeo.bind(entity)(yankee, offset);
                    golf['children'] = offset;
                    report = verify.bind(entity)(options, golf);
 297:
                    oscar[1] = report;
                    report = 'children';
                    mike[report] = oscar;
            ...
            echo = echo.APPS;
            echo = source === echo;
            if(!echo) { _fun118471_ip = 1289; continue _fun118471 }
 1286:
            echo = update;
 1289:
            sizing['disabled'] = echo;
            ...
            update = echo.Text;
            echo = {'variant': 'text-sm/medium', 'color': 'text-brand'};
            ...
            oscar = {};
            kilo = backup.scrollView;
            oscar['style'] = kilo;
            backup = backup.scrollViewContentContainer;
            oscar['contentContainerStyle'] = backup;
            oscar['horizontal'] = foxtrot;
            oscar['showsHorizontalScrollIndicator'] = romeo;
            if(!yankee) { _fun118471_ip = 1504; continue _fun118471 }
 1477:
            romeo = [1, 2, 3, 4, 5];
            yankee = romeo.map;
