...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
 ...
 78:
            ...
            golf = report == oscar;
            report = undefined;
            if(golf) { _fun00006_ip = 132; continue _fun00005 }
 127:
            report = oscar.id;
 132:
            mike['guildId'] = report;
 ...
 0:
            ...
            golf = null;
            if(!(golf != report)) { _fun00008_ip = 192; continue _fun00007 }
 43:
            oscar = report.id;
            if(!(golf != oscar)) { _fun00008_ip = 192; continue _fun00007 }
 55:
            oscar = entity.author;
            if(!(golf != oscar)) { _fun00008_ip = 192; continue _fun00007 }
 68:
            ...
            report = report.id;
            if(!(oscar === report)) { _fun00008_ip = 192; continue _fun00007 }
 88:
            ...
            if(!(!(oscar > entity))) { _fun00008_ip = 192; continue _fun00007 }
 173:
            entity = {};
