...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    mike = function(argFoo) { // Original name: GuildSettingsRoleEditDisplay
        _fun126328: for(var _fun126328_ip = 0; ; ) switch(_fun126328_ip) {
 0:
            zulu = argFoo;
            golf = zulu.guild;
            options = zulu.role;
            ...
            sizing = output;
            if(output) { _fun126328_ip = 146; continue _fun126328 }
 143:
            sizing = mike;
 146:
            mike = 0;
            if(!(mike === variable36)) { _fun126328_ip = 156; continue _fun126328 }
 152:
 ...
 156:
            ...
            verify = null;
            if(!(verify == papa)) { _fun126328_ip = 326; continue _fun126328 }
 249:
 ...
 326:
            ...
            options[0] = yankee;
            verify = null;
            if(!offset) { _fun126328_ip = 1213; continue _fun126328 }
 958:
 ...
 1213:
            ...
            verify = {};
            offset = sizing;
            if(sizing) { _fun126328_ip = 1290; continue _fun126328 }
 1287:
            offset = output;
 1290:
            ...
            offset = {};
            if(sizing) { _fun126328_ip = 1476; continue _fun126328 }
 1473:
            sizing = output;
 1476:
