...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    tango = 'modules/guild_settings/native/MembersPruneActionSheet.tsx';
    tango = report.bind(oscar)(tango);
    mike = function(argFoo) { // Original name: MembersPruneActionSheet
        entity = argFoo;
        golf = entity.guild;
        ...
        tango = undefined;
        options = 2;
        entity = verify.bind(tango)(entity, options);
        zulu = 0;
        output = entity[zulu];
        ...
        entity = function* () {
            entity = function* () { // Original name: ?anon_0_
                _fun126548: for(var _fun126548_ip = 0; ; ) switch(_fun126548_ip) {
 0:
                    StartGenerator();
                    ResumeGenerator(result_out_reg=0, return_bool_out_reg=1);
                    if(mike) { _fun126548_ip = 85; continue _fun126548 }
 7:
 ...
 64:
                    ...
                    if(report) { _fun126548_ip = 82; continue _fun126548 }
 70:
 ...
 85:
        ...
        golf = function(argFoo) { // Original name: onChange
            _fun126550: for(var _fun126550_ip = 0; ; ) switch(_fun126550_ip) {
 0:
                zulu = argFoo;
                mike = _closure2_slot2;
                mike = mike !== zulu;
                if(!mike) { _fun126550_ip = 27; continue _fun126550 }
 17:
                report = _closure2_slot1;
                tango = null;
                mike = tango != report;
 27:
                if(!mike) { _fun126550_ip = 41; continue _fun126550 }
 30:
 ...
 41:
        ...
        kilo = {};
        kilo['days'] = foxtrot;
        kilo = echo.bind(update)(sizing, kilo);
        golf['label'] = kilo;
        backup = options.bind(tango)(backup, golf);
        golf = new Array(2);
        golf[0] = backup;
        yankee = verify[yankee];
        yankee = romeo.bind(tango)(yankee);
        backup = yankee.TableRadioRow;
        yankee = {};
        source = 30;
        yankee['value'] = source;
        kilo = verify[foxtrot];
        ...
        kilo = echo.bind(update)(sizing, kilo);
        yankee['label'] = kilo;
        yankee = options.bind(tango)(backup, yankee);
        golf[1] = yankee;
        ...
        yankee = romeo.bind(tango)(yankee);
        yankee = yankee.t;
        backup = yankee.f13az8;
        yankee = {};
        yankee['members'] = result;
        yankee['days'] = output;
        ...
        offset = function() { // Original name: onPress
            _fun126551: for(var _fun126551_ip = 0; ; ) switch(_fun126551_ip) {
 0:
                mike = _closure2_slot1;
                tango = null;
                mike = tango != mike;
                if(!mike) { _fun126551_ip = 24; continue _fun126551 }
 16:
                zulu = _closure2_slot2;
                mike = tango != zulu;
 24:
                if(!mike) { _fun126551_ip = 94; continue _fun126551 }
 27:
