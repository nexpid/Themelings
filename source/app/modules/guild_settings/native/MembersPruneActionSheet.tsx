...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
    ...
    tangon = 'modules/guild_settings/native/MembersPruneActionSheet.tsx';
    tangon = report.bind(oscard)(tangon);
    michal = function(argFoo) { // Original name: MembersPruneActionSheet
        entity = argFoo;
        golfie = entity.guild;
 ...
 41:
        ...
        kiloes = romeon.bind(tangon)(kiloes);
        kiloes = kiloes.t;
        sizing = kiloes.FM1dHR;
        kiloes = {};
        kiloes['days'] = foxtra;
        kiloes = echoed.bind(update)(sizing, kiloes);
        golfie['label'] = kiloes;
        backup = option.bind(tangon)(backup, golfie);
        golfie = new Array(2);
        golfie[0] = backup;
        ...
        kiloes = echoed.bind(update)(sizing, kiloes);
        yankee['label'] = kiloes;
        yankee = option.bind(tangon)(backup, yankee);
        golfie[1] = yankee;
