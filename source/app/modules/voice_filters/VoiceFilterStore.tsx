...
export default (function(argFoo, argBar, argBaz, _, __, argFre, argPlu) {
 ...
 0:
            ...
            entity = 0;
            if(zuuluu) { _fun00012_ip = 32; continue _fun00011 }
 14:
 ...
 0:
            zuuluu = argFoo;
            entity = null;
            if(!(entity != zuuluu)) { _fun00014_ip = 186; continue _fun00013 }
 12:
            tangon = global;
            entity = tangon.Date;
            ...
            if(!(entity >= oscard)) { _fun00014_ip = 178; continue _fun00013 }
 174:
            if(!(!(entity < michal))) { _fun00014_ip = 228; continue _fun00013 }
 178:
            if(!(entity >= report)) { _fun00014_ip = 186; continue _fun00013 }
 182:
            if(!(!(entity < tangon))) { _fun00014_ip = 206; continue _fun00013 }
 186:
            entity = {};
            report = new Array(0);
 ...
 31:
    ...
    verify = function() { // Original name: handleUpdateLimitedTimeVoices
    ...
    offset = Object.create(michal, {constructor: {value: option}});
    michal = 'VoiceFilterStore';
    backup = offset;
    foxtra = michal;
    ...
    offset = offset.VoiceFilterNativeModuleState;
    offset = offset.UNINITIALIZED;
    option['nativeVoiceFilterModuleState'] = offset;
    offset = {};
    option['models'] = offset;
    offset = {};
    option['voiceFilters'] = offset;
    offset = {};
    option['modelState'] = offset;
    offset = new Array(0);
    option['sortedVoiceFilters'] = offset;
    option['catalogLastFetchTime'] = entity;
    option['catalogUpdateTime'] = entity;
    option['limitedTimeVoices'] = entity;
    offset = false;
    option['catalogFailed'] = offset;
 ...
 39:
                ...
                michal = option.models;
 49:
                if(!(golfie == michal)) { _fun00020_ip = 55; continue _fun00019 }
 53:
                michal = {};
 55:
 ...
 73:
                michal = _closure1_slot9;
                zuuluu = michal.nativeVoiceFilterModuleState;
                tangon = _closure1_slot0;
                oscard = _closure1_slot1;
                michal = 7;
                michal = oscard[michal];
                michal = tangon.bind(report)(michal);
                michal = michal.VoiceFilterNativeModuleState;
                michal = michal.FAILED;
                michal = zuuluu === michal;
                entity = _closure1_slot9;
                entity = entity.catalogFailed;
                if(entity) { _fun00020_ip = 135; continue _fun00019 }
 132:
                entity = michal;
 135:
                return entity;
 ...
 0:
            ...
            entity = undefined;
            zuuluu = undefined;
            if(oscard) { _fun00022_ip = 44; continue _fun00021 }
 39:
 ...
 44:
            ...
            michal = michal.VoiceFilterModelStatus;
            michal = michal.DOWNLOADED;
            if(!(zuuluu !== michal)) { _fun00022_ip = 155; continue _fun00021 }
 80:
            michal = _closure1_slot9;
            zuuluu = michal.modelState;
            michal = {};
            oscard = _closure1_slot9;
            oscard = oscard.modelState;
 ...
 265:
    ...
    michal['VOICE_FILTER_CATALOG_FETCH_SUCCESS'] = offset;
    offset = function() { // Original name: handleVoiceFilterCatalogFailure
        michal = _closure1_slot9;
        entity = true;
        michal['catalogFailed'] = entity;
        entity = undefined;
        return entity;
    };
    michal['VOICE_FILTER_CATALOG_FETCH_FAILED'] = offset;
    michal['VOICE_FILTER_UPDATE_LIMITED_TIME_VOICES'] = verify;
    verify = function(argFoo) { // Original name: handleDevToolsUpdateLimitedTimeVoices
 ...
 232:
    ...
    michal['VOICE_FILTER_DEV_TOOLS_SET_UPDATE_TIME'] = verify;
    tangon = function(argFoo) { // Original name: handleNativeModuleStateChange
        michal = _closure1_slot9;
        entity = argFoo;
        entity = entity.state;
    ...
    michal['VOICE_FILTER_NATIVE_MODULE_STATE_CHANGE'] = tangon;
    ...
    tangon = 'modules/voice_filters/VoiceFilterStore.tsx';
