...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
            ...
            report = mike.channel;
            mike = null;
            if(!(mike != oscar)) { _fun86353_ip = 251; continue _fun86353 }
 28:
            zulu = mike == entity;
            tango = undefined;
            options = undefined;
            if(zulu) { _fun86353_ip = 44; continue _fun86353 }
 39:
            options = entity.type;
 44:
            zulu = _closure1_slot5;
            zulu = zulu.CUSTOM_STATUS;
            if(!(options === zulu)) { _fun86353_ip = 251; continue _fun86353 }
 64:
            zulu = entity.emoji;
            if(!(mike != zulu)) { _fun86353_ip = 251; continue _fun86353 }
 77:
            entity = entity.emoji;
            zulu = entity.id;
            if(!(mike != zulu)) { _fun86353_ip = 247; continue _fun86353 }
 95:
            if(!(mike != report)) { _fun86353_ip = 247; continue _fun86353 }
 102:
            zulu = _closure1_slot4;
            mike = report.type;
            mike = zulu.bind(tango)(mike);
            if(!mike) { _fun86353_ip = 247; continue _fun86353 }
 122:
            ...
            mike = zulu.bind(tango)(mike);
            entity = !entity;
            if(entity) { _fun86353_ip = 245; continue _fun86353 }
 242:
            entity = mike;
 245:
            return entity;
