...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    tango['status'] = verify;
    verify = {'minHeight': 80, 'fontSize': 16, 'lineHeight': 20, 'fontFamily': null, 'color': null, 'flexGrow': 1, 'height': 'auto'};
    romeo = romeo.PRIMARY_MEDIUM;
    verify['fontFamily'] = romeo;
    romeo = oscar[offset];
    romeo = yankee.bind(entity)(romeo);
    romeo = romeo.colors;
    romeo = romeo.TEXT_PRIMARY;
    verify['color'] = romeo;
    ...
    tango = 'modules/custom_status/native/EditCustomStatus.tsx';
    tango = report.bind(oscar)(tango);
    mike = function(argFoo) { // Original name: EditCustomStatus
 ...
 0:
            ...
            entity = function() {
                ...
                oscar = oscar.EDIT_CUSTOM_STATUS_MODAL;
                mike['type'] = oscar;
            ...
            entity = golf.bind(report)(entity, zulu);
            ...
            entity = zulu.useCustomStatusActivity;
            ...
            golf = undefined;
            if(entity) { _fun80023_ip = 185; continue _fun80023 }
 180:
            golf = offset.state;
 185:
            options = verify != golf;
            entity = '';
            if(!options) { _fun80023_ip = 199; continue _fun80023 }
 196:
            entity = golf;
 199:
            ...
            entity = verify == offset;
            foxtrot = undefined;
            if(entity) { _fun80023_ip = 258; continue _fun80023 }
 252:
            foxtrot = offset.emoji;
 258:
            kilo = verify != foxtrot;
            entity = null;
            if(!kilo) { _fun80023_ip = 270; continue _fun80023 }
 267:
            entity = foxtrot;
 270:
 ...
 0:
                    ...
                    report = entity.id;
                    tango = null;
                    if(!(tango == report)) { _fun80027_ip = 54; continue _fun80027 }
 32:
 ...
 41:
                    ...
                    report = '';
                    if(!(report === oscar)) { _fun80027_ip = 75; continue _fun80027 }
 54:
                    report = entity.name;
                    oscar = tango != report;
                    tango = '';
                    if(!oscar) { _fun80027_ip = 73; continue _fun80027 }
 70:
                    tango = report;
 73:
                    _fun80027_ip = 80; continue _fun80027;
 75:
 ...
 80:
            ...
            romeo = golf.bind(report)(mike, zulu);
            mike = report.useRef;
            context = mike.bind(report)(verify);
 ...
 0:
                    ...
                    mike = entity.current;
                    entity = null;
                    if(!(entity != mike)) { _fun80029_ip = 28; continue _fun80029 }
 18:
                    entity = mike.blur;
 ...
 28:
            ...
            mike = new Array(0);
            record = golf.bind(report)(zulu, mike);
            zulu = report.useRef;
            mike = {};
            mike['statusText'] = config;
            mike['statusEmoji'] = vacuum;
            mike['clearAfter'] = sizing;
 ...
 0:
                    ...
                    entity = '';
                    golf = entity === mike;
                    if(!golf) { _fun80030_ip = 38; continue _fun80030 }
 28:
                    mike = _closure2_slot4;
                    entity = null;
                    golf = entity == mike;
 38:
                    if(golf) { _fun80030_ip = 119; continue _fun80030 }
 41:
                    mike = _closure2_slot3;
                    entity = _closure2_slot11;
                    entity = entity.current;
                    entity = entity.statusText;
                    entity = mike === entity;
                    if(!entity) { _fun80030_ip = 90; continue _fun80030 }
 67:
                    zulu = _closure2_slot4;
                    mike = _closure2_slot11;
                    mike = mike.current;
                    mike = mike.statusEmoji;
                    entity = zulu === mike;
 90:
                    if(!entity) { _fun80030_ip = 116; continue _fun80030 }
 93:
                    zulu = _closure2_slot6;
                    mike = _closure2_slot11;
                    mike = mike.current;
                    mike = mike.clearAfter;
                    entity = zulu === mike;
 116:
                    golf = entity;
 119:
                    ...
                    entity = undefined;
                    report = undefined;
                    if(golf) { _fun80030_ip = 224; continue _fun80030 }
 138:
                    romeo = _closure1_slot0;
                    foxtrot = _closure1_slot2;
                    golf = 16;
                    golf = foxtrot[golf];
                    verify = romeo.bind(entity)(golf);
 ...
 224:
            ...
            options = {};
            yankee = control.statusContainer;
            ...
            foxtrot = papa.bind(tango)(foxtrot);
            foxtrot = foxtrot.t;
            foxtrot = foxtrot.WkfRZG;
            foxtrot = output.bind(echo)(foxtrot);
            yankee['accessibilityLabel'] = foxtrot;
            foxtrot = {};
            echo = verify == vacuum;
            output = undefined;
            if(echo) { _fun80023_ip = 718; continue _fun80023 }
 713:
            output = vacuum.name;
 718:
            foxtrot['text'] = output;
            ...
            echo = 18;
            echo = output[echo];
            papa = romeo.bind(tango)(echo);
            echo = {};
            echo['emoji'] = vacuum;
            vacuum = control.emoji;
            echo['style'] = vacuum;
            vacuum = true;
            echo['withPlaceholder'] = vacuum;
            echo = foxtrot.bind(tango)(papa, echo);
            ...
            echo = romeo.bind(tango)(result);
            result = {};
            result['ref'] = context;
            context = _closure1_slot7;
            result['maxLength'] = context;
            ...
            context = status.bind(tango)(context);
            context = context.t;
            context = context.TM2l8P;
            context = papa.bind(target)(context);
            result['placeholder'] = context;
            context = control.inputPlaceholder;
            context = context.color;
            result['placeholderTextColor'] = context;
            context = output[update];
            context = status.bind(tango)(context);
            target = context.intl;
            papa = target.string;
            ...
            context = status.bind(tango)(context);
            context = context.t;
            context = context.xalUlZ;
            context = papa.bind(target)(context);
            result['accessibilityLabel'] = context;
            result['onSubmitEditing'] = record;
            record = control.status;
            result['style'] = record;
            result['value'] = config;
            result['onChange'] = sequence;
            result['multiline'] = vacuum;
            sequence = false;
            result['autoCorrect'] = sequence;
            result['showBorder'] = sequence;
            result['showTopContainer'] = sequence;
            sequence = 'top';
            result['textAlignVertical'] = sequence;
            sequence = 'none';
            result['autoCapitalize'] = sequence;
            result['showCharactersRemaining'] = vacuum;
            control = control.statusText;
            result['inputTextStyle'] = control;
            result = foxtrot.bind(tango)(echo, result);
            yankee[1] = result;
            options['children'] = yankee;
            yankee = golf.bind(tango)(oscar, options);
            options = new Array(3);
            options[0] = yankee;
            yankee = 20;
            ...
            yankee['onChange'] = backup;
            yankee = foxtrot.bind(tango)(romeo, yankee);
            options[1] = yankee;
            verify = verify != offset;
            if(!verify) { _fun80023_ip = 1301; continue _fun80023 }
 1112:
            ...
            source = source.TEXT_DANGER;
            output['color'] = source;
            output = romeo.bind(tango)(result, output);
            foxtrot['icon'] = output;
