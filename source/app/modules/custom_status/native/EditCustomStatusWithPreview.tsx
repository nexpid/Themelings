...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
            ...
            entity = offset == romeo;
            golf = undefined;
            if(entity) { _fun77802_ip = 235; continue _fun77802 }
 230:
            golf = romeo.state;
 235:
            options = offset != golf;
            echo = '';
            entity = echo;
            if(!options) { _fun77802_ip = 252; continue _fun77802 }
 249:
            entity = golf;
 252:
            ...
            entity = offset == romeo;
            verify = undefined;
            if(entity) { _fun77802_ip = 315; continue _fun77802 }
 309:
            verify = romeo.emoji;
 315:
            backup = offset != verify;
            entity = null;
            if(!backup) { _fun77802_ip = 327; continue _fun77802 }
 324:
            entity = verify;
 327:
 ...
 0:
                    ...
                    report = entity.id;
                    tango = null;
                    if(!(tango == report)) { _fun77807_ip = 54; continue _fun77807 }
 32:
 ...
 41:
                    ...
                    report = '';
                    if(!(report === oscar)) { _fun77807_ip = 75; continue _fun77807 }
 54:
                    report = entity.name;
                    oscar = tango != report;
                    tango = '';
                    if(!oscar) { _fun77807_ip = 73; continue _fun77807 }
 70:
                    tango = report;
 73:
                    _fun77807_ip = 80; continue _fun77807;
 75:
 ...
 0:
                    ...
                    mike = entity.current;
                    entity = null;
                    if(!(entity != mike)) { _fun77810_ip = 28; continue _fun77810 }
 18:
                    entity = mike.blur;
                    entity = entity.bind(mike)();
 28:
 ...
 0:
                    ...
                    mike = zulu !== mike;
                    if(mike) { _fun77811_ip = 54; continue _fun77811 }
 31:
                    ...
                    mike = tango !== zulu;
 54:
                    if(mike) { _fun77811_ip = 80; continue _fun77811 }
 57:
                    tango = _closure2_slot7;
                    zulu = _closure2_slot13;
                    zulu = zulu.current;
 ...
 80:
            ...
            mike = offset == update;
            entity = null;
            if(mike) { _fun77802_ip = 1909; continue _fun77802 }
 677:
            tango = _closure1_slot12;
            ...
            whiskey = undefined;
            if(quebec) { _fun77802_ip = 1062; continue _fun77802 }
 1057:
            whiskey = sizing.name;
 1062:
            ...
            if(sizing) { _fun77802_ip = 1423; continue _fun77802 }
 1419:
            sizing = echo !== result;
 1423:
            if(!sizing) { _fun77802_ip = 1446; continue _fun77802 }
 1426:
 ...
 1446:
            ...
            verify[2] = foxtrot;
            offset = offset != romeo;
            if(!offset) { _fun77802_ip = 1885; continue _fun77802 }
 1694:
