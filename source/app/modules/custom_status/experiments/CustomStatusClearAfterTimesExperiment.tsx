...
export default (function(native1, native2, native3, native4, native5, native6, native7) {
    ...
    var4 = {'kind': 'user', 'id': '2025-04_custom_status_clear_after_times', 'label': 'Custom Status Clear After Times Experiment'};
    var9 = {};
    var10 = false;
    var9['enabled'] = var10;
    var4['defaultConfig'] = var9;
    var10 = {'id': 1, 'label': 'Enable custom status clear after times'};
    var9 = {};
    var9['enabled'] = var11;
    var10['config'] = var9;
    var9 = new Array(1);
