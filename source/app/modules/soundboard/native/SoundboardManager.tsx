...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
 ...
 0:
            ...
            if(entity) { _fun110072_ip = 51; continue _fun110072 }
 38:
            entity = verify.apply;
            entity = entity.bind(verify)(tango, oscar);
            _fun110072_ip = 92; continue _fun110072;
 51:
            golf = global;
            options = golf.Reflect;
            golf = options.construct;
            if(oscar) { _fun110072_ip = 71; continue _fun110072 }
 67:
            oscar = new Array(0);
 71:
 ...
 72: // try_end0
            _fun110073_ip = 76; continue _fun110073;
 74: // catch_target0
 ...
 76:
    ...
    foxtrot = 'SoundboardManagerNative';
    backup = options;
    ...
    mike = function(argFoo) {
        zulu = function(argFoo) { // Original name: SoundboardManager
            oscar = this;
            yankee = 0;
            ...
            entity['_stopAndClearSounds'] = tango;
 ...
 0:
                    ...
                    golf = arguments[3];
                    entity = undefined;
                    if(!(tango === entity)) { _fun110080_ip = 21; continue _fun110080 }
 18:
                    tango = 1;
 21:
                    options = _closure1_slot10;
                    zulu = options.getVoiceChannelId;
                    zulu = zulu.bind(options)();
                    if(!(zulu !== golf)) { _fun110080_ip = 51; continue _fun110080 }
 42:
                    zulu = null;
                    if(!(zulu == golf)) { _fun110080_ip = 319; continue _fun110080 }
 51:
                    golf = _closure1_slot9;
                    zulu = golf.isDeaf;
                    zulu = zulu.bind(golf)();
                    if(zulu) { _fun110080_ip = 319; continue _fun110080 }
 71:
                    golf = _closure1_slot11;
                    zulu = golf.isLocalSoundboardMuted;
 ...
 92:
                    ...
                    tango = '';
                    zulu = '-';
                    golf = golf.bind(tango)(report, zulu, oscar);
                    tango = _closure1_slot12;
                    zulu = tango.get;
                    tango = zulu.bind(tango)(golf);
                    zulu = null;
                    if(!(zulu != tango)) { _fun110080_ip = 175; continue _fun110080 }
 165:
                    zulu = tango.stop;
 ...
 175:
                    ...
                    yankee = zulu.bind(entity)(options);
                    offset = yankee.createSound;
                    options = 'soundboard_sound';
                    options = offset.bind(yankee)(romeo, options, verify);
                    options['volume'] = verify;
                    ...
                    mike = zulu.reportSoundStartedPlaying;
                    mike = mike.bind(zulu)(oscar, report);
                    tango = _closure3_slot0;
                    zulu = tango._playSoundWithListener;
                    mike = {};
                    mike['sound'] = options;
                    mike['soundKey'] = golf;
                    mike['soundId'] = oscar;
 ...
 0:
                            ...
                            if(zulu) { _fun110083_ip = 178; continue _fun110083 }
 13:
                            options = mike.sound;
                            golf = mike.soundKey;
                            report = mike.soundId;
 ...
 44:
                            ...
                            if(verify) { _fun110083_ip = 175; continue _fun110083 }
 53:
                            oscar = false;
 55: // try_start_0
                            verify = options;
                            options = verify.playWithListener;
 ...
 72:
                            ...
                            if(verify) { _fun110083_ip = 83; continue _fun110083 }
 78:
                            oscar = options;
 81: // try_end0
                            _fun110083_ip = 120; continue _fun110083;
 83:
                            return options;
 86: // catch_target0
                            ...
                            offset = yankee.error;
                            verify = {};
                            verify['error'] = options;
                            options = 'Failed to play sound';
                            options = offset.bind(yankee)(options, verify);
                            oscar = true;
 120:
                            if(!oscar) { _fun110083_ip = 172; continue _fun110083 }
 123:
                            verify = _closure1_slot12;
                            ...
                            oscar = golf.reportSoundFinishedPlaying;
 ...
 178:
            ...
            mike = mike.bind(zulu)();
            entity['_playSoundWithListener'] = mike;
            return entity;
        };
    ...
    tango = 'modules/soundboard/native/SoundboardManager.tsx';
