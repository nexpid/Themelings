...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 106:
                    ...
                    zulu = {};
                    mike = romeo;
                    if(!(tango === foxtrot)) { _fun00004_ip = 349; continue _fun00003 }
 340:
                    mike = romeo;
 ...
 0:
                ...
                tango = undefined;
                if(!(options === tango)) { _fun00008_ip = 43; continue _fun00007 }
 41:
                options = false;
 43:
                ...
                output = null;
                romeo = output != zulu;
                if(romeo) { _fun00008_ip = 123; continue _fun00007 }
 113:
                zulu = kilo.emojiName;
                romeo = output != zulu;
 123:
 ...
 0:
                            ...
                            entity = 0;
                            if(!tango) { _fun00012_ip = 24; continue _fun00011 }
 21:
                            entity = 1;
 24:
                            entity = mike.bind(zulu)(entity);
                ...
                backup[1] = source;
                source = null;
                if(!control) { _fun00008_ip = 526; continue _fun00007 }
 520:
 ...
 545:
                backup[4] = update;
                update = null;
                if(!oscar) { _fun00008_ip = 565; continue _fun00007 }
 554:
                update = null;
                if(options) { _fun00008_ip = 565; continue _fun00007 }
 559:
 ...
 565:
                ...
                if(!romeo) { _fun00008_ip = 672; continue _fun00007 }
 640:
 ...
 743:
                ...
                report = new Array(2);
                report[0] = verify;
                if(!oscar) { _fun00008_ip = 796; continue _fun00007 }
 793:
                oscar = !options;
 796:
                if(!oscar) { _fun00008_ip = 847; continue _fun00007 }
 799:
