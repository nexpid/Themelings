...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
 ...
 0:
            ...
            oscar = report == tango;
            entity = undefined;
            if(oscar) { _fun65528_ip = 22; continue _fun65528 }
 17:
            entity = tango.guild_id;
 22:
            entity = report == entity;
            if(entity) { _fun65528_ip = 58; continue _fun65528 }
 29:
 ...
 58:
            if(entity) { _fun65528_ip = 77; continue _fun65528 }
 61:
            golf = mike.guildId;
            oscar = _closure1_slot10;
            entity = golf === oscar;
 77:
            if(entity) { _fun65528_ip = 103; continue _fun65528 }
 80:
            mike = mike.guildId;
            report = report == tango;
            zulu = undefined;
            if(report) { _fun65528_ip = 99; continue _fun65528 }
 94:
            zulu = tango.guild_id;
 99:
            entity = mike === zulu;
 ...
 0:
            ...
            mike = arguments[3];
            report = undefined;
            if(!(mike === report)) { _fun65529_ip = 17; continue _fun65529 }
 15:
            mike = true;
 17:
            ...
            if(entity) { _fun65529_ip = 82; continue _fun65529 }
 57:
            options = zulu.guildId;
            golf = null;
            verify = golf == oscar;
            golf = undefined;
            if(verify) { _fun65529_ip = 78; continue _fun65529 }
 73:
            golf = oscar.guild_id;
 78:
            entity = options === golf;
 82:
            if(entity) { _fun65529_ip = 98; continue _fun65529 }
 85:
            options = zulu.guildId;
            golf = _closure1_slot10;
            entity = options === golf;
 98:
            if(!entity) { _fun65529_ip = 111; continue _fun65529 }
 101:
            tango = _closure1_slot13;
            entity = tango.bind(report)(zulu, oscar);
 111:
            if(!entity) { _fun65529_ip = 129; continue _fun65529 }
 114:
            mike = !mike;
            if(mike) { _fun65529_ip = 126; continue _fun65529 }
 120:
            mike = zulu.available;
 126:
            entity = mike;
 ...
 0:
            ...
            mike = mike.suppress;
            entity = !entity;
            if(!entity) { _fun65530_ip = 66; continue _fun65530 }
 63:
            entity = !mike;
 66:
            return entity;
 ...
 0:
            ...
            tango = entity == mike;
            zulu = undefined;
            if(tango) { _fun65531_ip = 36; continue _fun65531 }
 30:
            zulu = mike.guilds;
 36:
            if(!(entity == zulu)) { _fun65531_ip = 42; continue _fun65531 }
 40:
            zulu = {};
 42:
            entity = global;
 ...
 0:
                    ...
                    if(mike) { _fun65535_ip = 447; continue _fun65535 }
 10:
                    ...
                    offset = null;
                    if(!(offset != oscar)) { _fun65535_ip = 444; continue _fun65535 }
 91:
                    options = _closure1_slot5;
                    report = options.has;
                    zulu = oscar.type;
                    zulu = report.bind(options)(zulu);
                    if(zulu) { _fun65535_ip = 444; continue _fun65535 }
 116:
                    if(!(offset != tango)) { _fun65535_ip = 444; continue _fun65535 }
 123:
 ...
 230:
                    ...
                    if(options) { _fun65535_ip = 441; continue _fun65535 }
 239:
                    verify = tango.guildId;
                    options = _closure1_slot9;
                    if(!(verify !== options)) { _fun65535_ip = 259; continue _fun65535 }
 252:
                    yankee = tango.guildId;
                    _fun65535_ip = 263; continue _fun65535;
 259:
 ...
 263:
                    ...
                    if(!(offset != verify)) { _fun65535_ip = 444; continue _fun65535 }
 292:
                    tango = _closure1_slot13;
                    options = tango.bind(mike)(verify, oscar);
                    tango = null;
                    if(!options) { _fun65535_ip = 438; continue _fun65535 }
 310:
 ...
 0:
            ...
            offset = '';
            verify = 0;
            if(!(offset !== yankee)) { _fun65536_ip = 101; continue _fun65536 }
 88:
            offset = global;
 ...
 0:
            ...
            entity = null;
            tango = entity == zulu;
            if(tango) { _fun65537_ip = 56; continue _fun65537 }
 50:
            mike = zulu.volume;
 56:
            zulu = entity != mike;
            entity = 100;
            if(!zulu) { _fun65537_ip = 69; continue _fun65537 }
 66:
            entity = mike;
 69:
            return entity;
 ...
 0:
            ...
            report = undefined;
            if(!(zulu === report)) { _fun65540_ip = 19; continue _fun65540 }
 17:
            zulu = false;
 19:
            tango = _closure1_slot0;
            ...
            entity = new Array(0);
            if(zulu) { _fun65540_ip = 238; continue _fun65540 }
 84:
 ...
 98:
            ...
            if(zulu) { _fun65540_ip = 196; continue _fun65540 }
 193:
            zulu = tango;
 196:
            if(!zulu) { _fun65540_ip = 238; continue _fun65540 }
 ...
 0:
                ...
                if(verify) { _fun65545_ip = 65; continue _fun65545 }
 57:
                oscar = mike.CUSTOM;
                _fun65545_ip = 71; continue _fun65545;
 65:
                oscar = mike.DEFAULT;
 71:
                options = zulu.joinSound;
                mike = null;
                if(!(mike == options)) { _fun65545_ip = 114; continue _fun65545 }
 83:
                options = _closure1_slot0;
                mike = _closure1_slot2;
                mike = mike[golf];
                ...
                options = mike.ADDED;
                _fun65545_ip = 143; continue _fun65545;
 114:
 ...
 143:
                ...
                mike['soundId'] = offset;
                if(verify) { _fun65545_ip = 174; continue _fun65545 }
 163:
                verify = _closure2_slot1;
                verify = verify.guildId;
                _fun65545_ip = 178; continue _fun65545;
 174:
