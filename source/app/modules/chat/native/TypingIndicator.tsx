...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
            ...
            options = sizing.getGuildId;
            options = options.bind(sizing)();
            entity['guildId'] = options;
            entity['typingUserIds'] = golf;
 ...
 0:
                    ...
                    mike = null;
                    report = mike != tango;
                    if(!report) { _fun100624_ip = 64; continue _fun100624 }
 25:
                    zulu = tango.y;
                    entity = zulu.toFixed;
                    golf = 2;
                    ...
                    oscar = tango.height;
                    entity = oscar.toFixed;
                    entity = entity.bind(oscar)(golf);
                    report = zulu === entity;
 64:
                    if(!report) { _fun100624_ip = 112; continue _fun100624 }
 67:
 ...
 112:
                    entity = {};
                    zulu = 0;
                    if(!report) { _fun100624_ip = 122; continue _fun100624 }
 119:
                    zulu = 1;
 122:
                    entity['opacity'] = zulu;
                    ...
                    foxtrot = undefined;
                    mike = undefined;
                    if(zulu) { _fun100624_ip = 142; continue _fun100624 }
 137:
                    mike = tango.height;
 142:
                    entity['top'] = mike;
                    ...
                    options = 0;
                    if(!report) { _fun100624_ip = 189; continue _fun100624 }
 181:
                    tango = tango.height;
                    options = -tango;
 189:
 ...
 6:
                            ...
                            entity = zulu === mike;
 54:
                            if(!entity) { _fun100625_ip = 103; continue _fun100625 }
 57:
 ...
 103:
            ...
            verify['transitionState'] = romeo;
            romeo = 8;
            romeo = oscar[romeo];
            romeo = backup.bind(tango)(romeo);
            romeo = romeo.TransitionStates;
            verify['TransitionStates'] = romeo;
            romeo = 9;
            romeo = oscar[romeo];
            romeo = backup.bind(tango)(romeo);
            romeo = romeo.withSpring;
            verify['withSpring'] = romeo;
            romeo = 10;
            romeo = oscar[romeo];
            romeo = backup.bind(tango)(romeo);
            romeo = romeo.springStandard;
            verify['springStandard'] = romeo;
            romeo = oscar[entity];
            romeo = backup.bind(tango)(romeo);
            romeo = romeo.runOnJS;
            ...
            yankee = backup != kilo;
            romeo = null;
            if(!yankee) { _fun100622_ip = 457; continue _fun100622 }
 425:
            ...
            yankee = {};
            romeo = result.bind(tango)(output, yankee);
 457:
            yankee = new Array(2);
            yankee[0] = romeo;
            result = _closure1_slot6;
            ...
            output = romeo.Text;
            romeo = {'lineClamp': 1, 'maxFontSizeMultiplier': 2, 'variant': 'text-xs/medium', 'color': 'interactive-normal'};
            romeo['children'] = kilo;
            romeo = result.bind(tango)(output, romeo);
            yankee[1] = romeo;
            options['children'] = yankee;
            verify = offset.bind(tango)(verify, options);
            options = new Array(2);
            options[0] = verify;
            offset = sizing.rateLimitPerUser;
            verify = 0;
            offset = offset > verify;
            verify = null;
            if(!offset) { _fun100622_ip = 622; continue _fun100622 }
 557:
            ...
            backup = backup != kilo;
            offset['hasTypingText'] = backup;
            foxtrot = _closure1_slot5;
            foxtrot = foxtrot.SendMessage;
            offset['slowmodeType'] = foxtrot;
 ...
 622:
    ...
    entity = function(argFoo, argBar, argBaz, argCorge) { // Original name: renderTypingIndicator
    ...
    mike = function(argFoo) { // Original name: TypingIndicator
        ...
        oscar = options.useChatInputManager;
        ...
        options = offset.useTypingUserIds;
        oscar = yankee.id;
        zulu = 4;
        offset = options.bind(offset)(oscar, zulu);
 ...
 0:
                ...
                entity = entity.rateLimitPerUser;
                mike = 0;
                if(!(!(entity > mike))) { _fun100629_ip = 37; continue _fun100629 }
 19:
                entity = _closure2_slot2;
                entity = entity.length;
                mike = entity > mike;
                entity = undefined;
                if(!mike) { _fun100629_ip = 68; continue _fun100629 }
 37:
 ...
 46:
                ...
                mike['channel'] = tango;
                zulu = _closure2_slot2;
                mike['typingUserIds'] = zulu;
                entity = mike;
 68:
                return entity;
            }
        };
        oscar = oscar.bind(options)(entity, zulu);
        zulu = _closure1_slot6;
        entity = 8;
        entity = golf[entity];
        entity = mike.bind(tango)(entity);
