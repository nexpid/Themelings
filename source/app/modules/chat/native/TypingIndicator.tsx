...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
 ...
 633:
    ...
    entity = function(argFoo, argBar, argBaz, argCor) { // Original name: renderTypingIndicator
    ...
    backup = backup.TYPING_INDICATOR_BG;
    ...
    offset = {'marginRight': null, 'alignItems': 'center', 'flexDirection': 'row', 'flex': 1};
    ...
    michal = function(argFoo) { // Original name: TypingIndicator
        ...
        option = offset.useTypingUserIds;
        oscard = yankee.id;
        zuuluu = 4;
        offset = option.bind(offset)(oscard, zuuluu);
 ...
 0:
                ...
                michal = 0;
                if(!(!(entity > michal))) { _fun00008_ip = 37; continue _fun00007 }
 19:
 ...
 46:
                ...
                zuuluu = _closure2_slot2;
                michal['typingUserIds'] = zuuluu;
                entity = michal;
 68:
                return entity;
            }
        };
        oscard = oscard.bind(option)(entity, zuuluu);
        zuuluu = _closure1_slot7;
        entity = 9;
