...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
    ...
    michal = function() { // Original name: closeGuildEventInfoActionSheet
    ...
    echoed = foxtra.bind(entity)(romeon);
    ...
    romeon = 14;
    source = kiloes.bind(entity)(backup, foxtra, romeon);
    ctrled = offset;
    ...
    tangon = function(argFoo) { // Original name: EventDetailInfoSheet
        _fun00001: for(var _fun00002_ip = 0; ; ) switch(_fun00002_ip) {
 0:
            entity = argFoo;
            romeon = entity.guildEvent;
            var _closure2_slot0 = romeon;
            backup = entity.safeBottomPadding;
            report = entity.onLayout;
            michal = entity.onCloseActionSheet;
            ...
            oscard = foxtra.bind(sizing)(verify, oscard);
            var _closure2_slot3 = oscard;
            oscard = option[entity];
            output = zuuluu.bind(tangon)(oscard);
            sizing = output.useStateFromStores;
            oscard = _closure1_slot8;
            foxtra = new Array(1);
            foxtra[0] = oscard;
            oscard = romeon.channel_id;
            verify = new Array(1);
            verify[0] = oscard;
            oscard = function() {
 ...
 50:
            ...
            oscard = sizing.bind(output)(foxtra, oscard, verify);
            verify = 15;
            verify = option[verify];
            sizing = zuuluu.bind(tangon)(verify);
            foxtra = sizing.recurrenceRuleFromServer;
            verify = romeon.recurrence_rule;
            foxtra = foxtra.bind(sizing)(verify);
            result = _closure1_slot3;
            output = result.useEffect;
            verify = romeon.guild_id;
            sizing = new Array(2);
            sizing[0] = verify;
            verify = romeon.id;
            sizing[1] = verify;
            ...
            verify = romeon.id;
            cntext = output.bind(tangon)(sizing, verify, offset);
 ...
 35:
                    ...
                    report = zuuluu.creator_id;
                    report = oscard.bind(golfie)(report);
                    michal['creator'] = report;
 ...
 105:
            ...
            entity = verify.bind(sizing)(option, entity, zuuluu);
 ...
 0:
                    ...
                    zuuluu = null;
                    if(!(zuuluu != tangon)) { _fun00008_ip = 34; continue _fun00007 }
 26:
 ...
 34:
            ...
            entity['onCloseAction'] = option;
            vacuum = _closure1_slot0;
            update = _closure1_slot2;
            option = 19;
            option = update[option];
            option = vacuum.bind(tangon)(option);
            option = option.ButtonSizes;
            ...
            option = option.SMALL_20;
            entity['iconSize'] = option;
            entity['isConnected'] = oscard;
            entity['recurrenceId'] = offset;
            output = zuuluu.bind(tangon)(michal, entity);
            zuuluu = _closure1_slot12;
            michal = _closure1_slot4;
            entity = {};
            option = kiloes.eventContainer;
            oscard = new Array(2);
            oscard[0] = option;
            option = {};
            verify = 16;
            ...
            oscard = report.GuildEventCardHeader;
            report = {'event': null, 'style': null, 'showUserCount': false, 'showEndDate': true, 'showCreator': false};
            report['event'] = romeon;
            option = kiloes.eventHeader;
            report['style'] = option;
            report['recurrenceId'] = offset;
            oscard = echoed.bind(tangon)(oscard, report);
            report = new Array(9);
            report[0] = oscard;
            oscard = update[sizing];
            oscard = vacuum.bind(tangon)(oscard);
            option = oscard.GuildEventCardTitle;
            oscard = {};
            oscard['event'] = romeon;
            verify = kiloes.eventTitle;
            oscard['textStyle'] = verify;
            verify = kiloes.eventTitleContainer;
            oscard['style'] = verify;
            oscard = echoed.bind(tangon)(option, oscard);
            report[1] = oscard;
            oscard = update[sizing];
            oscard = vacuum.bind(tangon)(oscard);
            option = oscard.GuildEventCardSimpleGuildInfo;
            oscard = {};
            oscard['event'] = romeon;
            verify = kiloes.guildTextStyle;
            oscard['textStyle'] = verify;
            oscard = echoed.bind(tangon)(option, oscard);
            report[2] = oscard;
            oscard = update[sizing];
            oscard = vacuum.bind(tangon)(oscard);
            option = oscard.GuildEventSimpleLocation;
            oscard = {};
            oscard['event'] = romeon;
            oscard = echoed.bind(tangon)(option, oscard);
            report[3] = oscard;
            oscard = {};
            option = kiloes.interestedContainer;
            oscard['style'] = option;
            ctrled = _closure1_slot1;
            option = update[source];
            verify = ctrled.bind(tangon)(option);
            option = {};
            backup = 21;
            ...
            option['size'] = backup;
            backup = kiloes.interestedIcon;
            option['style'] = backup;
            verify = echoed.bind(tangon)(verify, option);
            option = new Array(2);
            option[0] = verify;
            ctrled = 22;
            verify = update[ctrled];
            verify = vacuum.bind(tangon)(verify);
            backup = verify.Text;
            verify = {'variant': 'text-sm/medium', 'color': 'header-secondary'};
            target = 23;
            sequen = update[target];
            ...
            verify = echoed.bind(tangon)(backup, verify);
            option[1] = verify;
            ...
            if(!option) { _fun00002_ip = 992; continue _fun00001 }
 989:
            option = result;
 992:
            if(!option) { _fun00002_ip = 1217; continue _fun00001 }
 998:
            echoed = _closure1_slot12;
            backup = _closure1_slot4;
            verify = {};
            update = kiloes.interestedContainer;
            verify['style'] = update;
            sequen = _closure1_slot11;
            vacuum = _closure1_slot1;
            config = _closure1_slot2;
            cntext = 24;
            update = config[cntext];
            vacuum = vacuum.bind(tangon)(update);
            update = {};
            update['user'] = record;
            record = romeon.guild_id;
            update['guildId'] = record;
            record = _closure1_slot0;
            cntext = config[cntext];
            cntext = record.bind(tangon)(cntext);
            cntext = cntext.AvatarSizes;
            cntext = cntext.XSMALL_20;
            update['size'] = cntext;
            cntext = kiloes.interestedIcon;
            update['style'] = cntext;
            ...
            vacuum = ctrled.Text;
            ctrled = {'variant': 'text-sm/medium', 'color': 'header-secondary'};
 ...
 31:
                    ...
                    report = undefined;
                    if(golfie) { _fun00010_ip = 56; continue _fun00009 }
 46:
                    golfie = _closure2_slot5;
                    report = golfie.colorString;
 56:
 ...
 1217:
            ...
            verify = option.GuildEventCardDescription;
            option = {};
            option['event'] = romeon;
            echoed = kiloes.eventDescriptionContainer;
            option['style'] = echoed;
            ...
            option = {};
            kiloes = kiloes.controlsContainer;
            option['style'] = kiloes;
            kiloes = new Array(3);
            kiloes[0] = output;
            output = null;
            if(!result) { _fun00002_ip = 1374; continue _fun00001 }
 1308:
            ...
            echoed = result.GuildEventShareAction;
            result = {};
 ...
 1374:
            ...
            if(!oscard) { _fun00002_ip = 1545; continue _fun00001 }
 1474:
            ...
            golfie['recurrenceRule'] = foxtra;
            romeon = romeon.id;
            golfie['guildEventId'] = romeon;
 ...
 1545:
    ...
    zuuluu['closeGuildEventInfoActionSheet'] = michal;
    return entity;
})();