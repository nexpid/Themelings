...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    tango = {};
    verify = {'alignSelf': 'stretch', 'flexDirection': 'row', 'justifyContent': 'space-between'};
    tango['container'] = verify;
    verify = {'marginStart': 8, 'flexShrink': 0, 'flexGrow': 1};
    tango['eventHeader'] = verify;
    verify = {};
    offset = 7;
    romeo = oscar[offset];
    ...
    tango['active'] = verify;
    verify = {'alignItems': 'center', 'flexDirection': 'row', 'flexShrink': 0};
    tango['actions'] = verify;
    verify = {'flexShrink': 0, 'alignItems': 'center', 'flexDirection': 'row', 'padding': 8, 'marginLeft': 8};
    romeo = oscar[offset];
    romeo = yankee.bind(entity)(romeo);
    romeo = romeo.radii;
    romeo = romeo.xs;
    verify['borderRadius'] = romeo;
    tango['secondarySmallButton'] = verify;
    verify = {};
    offset = oscar[offset];
    ...
    tango['secondarySmallIcon'] = verify;
 ...
 0:
            ...
            oscar = entity == offset;
            mike = undefined;
            if(oscar) { _fun77031_ip = 151; continue _fun77031 }
 146:
            mike = offset.id;
 151:
            ...
            zulu = yankee[tango];
            foxtrot = oscar.bind(report)(zulu);
 ...
 0:
                    ...
                    entity = undefined;
                    if(report) { _fun77033_ip = 39; continue _fun77033 }
 30:
 ...
 39:
            ...
            zulu = romeo.bind(foxtrot)(golf, zulu);
 ...
 0:
                    ...
                    report = entity == report;
                    entity = undefined;
                    if(report) { _fun77034_ip = 39; continue _fun77034 }
 30:
                    tango = _closure2_slot3;
 ...
 39:
            ...
            golf = romeo.bind(foxtrot)(golf, tango);
            tango = 10;
            tango = yankee[tango];
            oscar = oscar.bind(report)(tango);
            tango = oscar.useManageResourcePermissions;
            if(!(entity != golf)) { _fun77031_ip = 272; continue _fun77031 }
 269:
            zulu = golf;
 272:
            ...
            if(!(entity != offset)) { _fun77031_ip = 842; continue _fun77031 }
 299:
            if(!(entity == mike)) { _fun77031_ip = 305; continue _fun77031 }
 303:
            mike = {};
 305:
            mike = mike.is_canceled;
            romeo = report !== mike;
            if(!romeo) { _fun77031_ip = 321; continue _fun77031 }
 318:
            romeo = mike;
 321:
 ...
 0:
                    ...
                    if(mike) { _fun77035_ip = 33; continue _fun77035 }
 23:
                    tango = _closure2_slot2;
                    zulu = null;
                    mike = zulu == tango;
 33:
                    if(mike) { _fun77035_ip = 51; continue _fun77035 }
 36:
 ...
 51:
            ...
            mike['onPress'] = oscar;
            oscar = '';
            mike['aria-label'] = oscar;
            golf = sizing.container;
            oscar = new Array(2);
            oscar[0] = golf;
            golf = undefined;
            if(!options) { _fun77031_ip = 401; continue _fun77031 }
 395:
            golf = sizing.active;
 401:
            oscar[1] = golf;
            ...
            golf = oscar.GuildEventCardHeader;
            oscar = {};
            oscar['event'] = offset;
            offset = sizing.eventHeader;
            oscar['style'] = offset;
            offset = false;
            oscar['showUserCount'] = offset;
            oscar['showCreator'] = offset;
            oscar['recurrenceId'] = verify;
            ...
            golf['style'] = offset;
            if(!romeo) { _fun77031_ip = 610; continue _fun77031 }
 510:
            ...
            foxtrot = offset.Text;
            offset = {'variant': 'text-sm/semibold', 'color': 'text-danger'};
            result = 14;
            echo = control[result];
            ...
            result = result.t;
            result = result.fyBVRk;
            result = echo.bind(update)(result);
            offset['children'] = result;
            romeo = output.bind(report)(foxtrot, offset);
 610:
            offset = new Array(2);
            offset[0] = romeo;
 ...
 0:
                    ...
                    mike = null;
                    if(!(mike != zulu)) { _fun77036_ip = 76; continue _fun77036 }
 26:
                    ...
                    tango = report.showGuildEventModeratorActionSheet;
 ...
 76:
            ...
            yankee['onPress'] = kilo;
            kilo = sizing.secondarySmallButton;
            yankee['style'] = kilo;
            result = _closure1_slot1;
            output = 16;
            backup = echo[output];
            kilo = result.bind(report)(backup);
            backup = {};
            update = 17;
            update = echo[update];
            ...
            backup['size'] = output;
            sizing = sizing.secondarySmallIcon;
            backup['style'] = sizing;
