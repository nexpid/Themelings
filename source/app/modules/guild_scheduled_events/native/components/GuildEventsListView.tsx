...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
    ...
    tangon = function(argFoo) { // Original name: GuildEventsListView
        _fun00001: for(var _fun00002_ip = 0; ; ) switch(_fun00002_ip) {
 0:
            entity = argFoo;
            romeon = entity.events;
            option = entity.guild;
            var _closure2_slot0 = option;
            michal = entity.onPressEvent;
            var _closure2_slot1 = michal;
            verify = entity.onCloseAction;
            var _closure2_slot2 = verify;
            michal = entity.isHubContext;
            var _closure2_slot3 = michal;
            michal = entity.lastAckedId;
            ...
            zuuluu = 0;
            if(!(zuuluu !== michal)) { _fun00002_ip = 396; continue _fun00001 }
 114:
            backup = new Array(0);
 ...
 64:
                    ...
                    michal = {};
                    oscard = function() { // Original name: handleHubEventsHeaderClose
 ...
 133:
            ...
            entity['renderItem'] = romeon;
            entity['ListHeaderComponent'] = oscard;
            ...
            entity['ListFooterComponent'] = oscard;
            oscard = {};
            golfie = 16;
