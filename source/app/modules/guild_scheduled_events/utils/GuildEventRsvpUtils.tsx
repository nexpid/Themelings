...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
 ...
 0:
            ...
            zulu = null;
            if(!(zulu != verify)) { _fun70278_ip = 439; continue _fun70278 }
 65:
            ...
            romeo = zulu == verify;
            offset = undefined;
            if(romeo) { _fun70278_ip = 144; continue _fun70278 }
 138:
            offset = verify.scheduled_start_time;
 144:
            offset = zulu != offset;
            foxtrot = null;
            if(!offset) { _fun70278_ip = 232; continue _fun70278 }
 153:
            romeo = _closure1_slot0;
            ...
            output = zulu == verify;
            offset = undefined;
            if(output) { _fun70278_ip = 202; continue _fun70278 }
 196:
            offset = verify.scheduled_start_time;
 202:
 ...
 232:
            if(!(zulu != foxtrot)) { _fun70278_ip = 255; continue _fun70278 }
 236:
            romeo = _closure1_slot5;
            offset = romeo.has;
            romeo = offset.bind(romeo)(foxtrot);
            offset = null;
            if(romeo) { _fun70278_ip = 293; continue _fun70278 }
 255:
            if(!(zulu == tango)) { _fun70278_ip = 290; continue _fun70278 }
 259:
 ...
 293:
            ...
            if(!(zulu != offset)) { _fun70278_ip = 388; continue _fun70278 }
 322:
            if(!(zulu == romeo)) { _fun70278_ip = 334; continue _fun70278 }
 326:
            verify = yankee.bind(entity)(verify, offset);
            _fun70278_ip = 439; continue _fun70278;
 334:
            if(!(zulu == tango)) { _fun70278_ip = 350; continue _fun70278 }
 338:
            verify = _closure1_slot4;
            verify = verify.UNINTERESTED;
            _fun70278_ip = 360; continue _fun70278;
 350:
 ...
 360:
            ...
            if(!(zulu != mike)) { _fun70278_ip = 439; continue _fun70278 }
 382:
            verify = mike.bind(entity)();
            _fun70278_ip = 439; continue _fun70278;
 388:
            if(!(zulu == tango)) { _fun70278_ip = 404; continue _fun70278 }
 392:
            tango = _closure1_slot4;
            tango = tango.INTERESTED;
            _fun70278_ip = 414; continue _fun70278;
 404:
