...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
 ...
 0:
            ...
            zulu = entity == tango;
            entity = undefined;
            if(zulu) { _fun70164_ip = 40; continue _fun70164 }
 23:
            zulu = tango.find;
 ...
 0:
                ...
                tango = mike == zulu;
                entity = undefined;
                if(tango) { _fun70167_ip = 42; continue _fun70167 }
 36:
                entity = zulu.guild_scheduled_event_exceptions;
 42:
                if(!(mike == entity)) { _fun70167_ip = 50; continue _fun70167 }
 46:
                entity = new Array(0);
 50:
                return entity;
 ...
 0:
            ...
            zulu = undefined;
            mike = undefined;
            if(oscar) { _fun70168_ip = 44; continue _fun70168 }
 38:
            mike = report.guild_scheduled_event_exceptions;
 44:
            if(!(entity == mike)) { _fun70168_ip = 52; continue _fun70168 }
 48:
            mike = new Array(0);
 52:
            entity = argFoo;
