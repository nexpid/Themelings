...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
    ...
    tango = {'delay': 50, 'autoplay': true, 'loop': false};
 ...
 0:
            ...
            report = undefined;
            if(!(mike === report)) { _fun00002_ip = 23; continue _fun00001 }
 21:
            mike = {};
 23:
            ...
            tango = {'value': null, 'timing': 0, 'duration': 200};
            mike = null;
            yankee = mike != options;
            mike = 1;
            oscar = mike;
            if(!yankee) { _fun00002_ip = 144; continue _fun00001 }
 141:
            oscar = options;
 144:
            tango['value'] = oscar;
            ...
            options[0] = tango;
            tango = oscar[verify];
            romeo = yankee.bind(report)(tango);
            yankee = romeo.useValueEffect;
 ...
 31:
            ...
            yankee = 4;
            yankee = oscar[yankee];
            romeo = tango.bind(report)(yankee);
            yankee = new Array(1);
            yankee[0] = offset;
            offset = new Array(1);
            offset[0] = options;
            ...
            foxtrot = 'reducedMotionFreezePercent';
            options[foxtrot] = mike;
            options = romeo.bind(report)(yankee, offset, options);
            entity = _closure1_slot3;
            entity = entity.bind(report)(options, verify);
            golf = entity[golf];
 ...
 14:
                        ...
                        zulu = 0;
                        if(!tango) { _fun00008_ip = 31; continue _fun00007 }
 28:
                        zulu = 1;
 31:
                        mike['scale'] = zulu;
