...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
            ...
            result = update != mike;
            tango = null;
            if(!result) { _fun84089_ip = 316; continue _fun84089 }
 268:
            echo = mike.type;
            ...
            result = result.TEXT;
            tango = null;
            if(!(echo === result)) { _fun84089_ip = 316; continue _fun84089 }
 311:
            tango = mike.id;
 316:
 ...
 0:
                    ...
                    entity = null;
                    if(!(entity == zulu)) { _fun84091_ip = 114; continue _fun84091 }
 73:
                    ...
                    _fun84091_ip = 133; continue _fun84091;
 114:
                    entity = _closure2_slot12;
                    tango = undefined;
                    entity = entity.bind(tango)(kilo);
                    zulu = '';
                    if(!(zulu === entity)) { _fun84091_ip = 137; continue _fun84091 }
 133:
                    entity = undefined;
                    return entity;
 137:
                    ...
                    oscar = oscar.RAINBOW;
                    if(!(golf === oscar)) { _fun84091_ip = 272; continue _fun84091 }
 231:
                    entity['color'] = zulu;
 ...
 0:
                    ...
                    zulu = null;
                    if(!(zulu != offset)) { _fun84092_ip = 334; continue _fun84092 }
 22:
                    ...
                    if(!(zulu != report)) { _fun84092_ip = 104; continue _fun84092 }
 59:
                    report = _closure2_slot2;
                    oscar = report.type;
                    ...
                    report = report.TEXT;
                    if(!(oscar !== report)) { _fun84092_ip = 204; continue _fun84092 }
 104:
                    ...
                    _fun84092_ip = 334; continue _fun84092;
 204:
                    oscar = _closure1_slot2;
                    ...
                    if(!(zulu == yankee)) { _fun84092_ip = 294; continue _fun84092 }
 256:
                    yankee = _closure1_slot0;
                    romeo = _closure1_slot3;
                    tango = 11;
                    ...
                    _fun84092_ip = 303; continue _fun84092;
 294:
                    yankee = _closure2_slot2;
 ...
 0:
                    ...
                    if(!mike) { _fun84093_ip = 69; continue _fun84093 }
 58:
 ...
 0:
                    ...
                    golf = report.color;
                    report = null;
                    if(!(report == golf)) { _fun84094_ip = 146; continue _fun84094 }
 142:
 ...
 146:
                    ...
                    report = report == tango;
                    golf = undefined;
                    if(report) { _fun84094_ip = 166; continue _fun84094 }
 160:
                    golf = tango.shader;
 166:
                    options = _closure1_slot0;
                    ...
                    if(!(golf === report)) { _fun84094_ip = 251; continue _fun84094 }
 202:
                    options = _closure1_slot0;
                    report = _closure1_slot3;
                    oscar = report[oscar];
