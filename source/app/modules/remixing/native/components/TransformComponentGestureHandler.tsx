...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
    ...
    tangon = {};
    golfie = "function TransformComponentGestureHandlerTsx10(e){const{minPointers,activeId,id,runOnJS,maybeBringToFront,onStart}=this.__closure;if(e.numberOfTouches<minPointers)return;if(activeId.get()===''){activeId.set(id);runOnJS(maybeBringToFront)();}if(onStart!=null){runOnJS(onStart)();}}";
    tangon['code'] = golfie;
    var _closure1_slot20 = tangon;
    tangon = {};
    golfie = 'function TransformComponentGestureHandlerTsx11(){const{isPanGestureActive}=this.__closure;isPanGestureActive.set(true);}';
    tangon['code'] = golfie;
    ...
    tangon = {};
    golfie = 'function TransformComponentGestureHandlerTsx16(){const{isPinchGestureActive}=this.__closure;isPinchGestureActive.set(true);}';
    tangon['code'] = golfie;
    ...
    tangon = {};
    golfie = 'function TransformComponentGestureHandlerTsx18(event){const{isPinchGestureActive,MIN_ZOOM,shouldUpdateStore,runOnJS,maybeUpdateStore}=this.__closure;isPinchGestureActive.set(false);const hasZoomed=Math.abs(event.scale-1)>MIN_ZOOM;shouldUpdateStore.set(shouldUpdateStore.get()||hasZoomed);runOnJS(maybeUpdateStore)();}';
    tangon['code'] = golfie;
    var _closure1_slot28 = tangon;
    tangon = {};
    golfie = 'function TransformComponentGestureHandlerTsx19(){const{isRotateGestureActive}=this.__closure;isRotateGestureActive.set(true);}';
    tangon['code'] = golfie;
