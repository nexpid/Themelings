...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
            ...
            zulu = 4;
            mike = 8;
            if(!(golf < options)) { _fun84129_ip = 146; continue _fun84129 }
 56:
            backup = entity.push;
            foxtrot = _closure1_slot0;
            yankee = _closure1_slot1;
            romeo = yankee[oscar];
            sizing = foxtrot.bind(report)(romeo);
            kilo = sizing.vec;
            romeo = verify / tango;
            romeo = kilo.bind(sizing)(romeo, golf);
            romeo = backup.bind(entity)(romeo);
            romeo = entity.push;
            yankee = yankee[oscar];
            kilo = foxtrot.bind(report)(yankee);
            backup = kilo.vec;
            foxtrot = verify / tango;
            yankee = golf + zulu;
            yankee = backup.bind(kilo)(foxtrot, yankee);
            yankee = romeo.bind(entity)(yankee);
            golf = golf + mike;
            if(golf < options) { _fun84129_ip = 56; continue _fun84129 }
 146:
            return entity;
        }
    };
 ...
 0:
            ...
            zulu = 4;
            mike = 8;
            if(!(golf < verify)) { _fun84130_ip = 146; continue _fun84130 }
 56:
            backup = entity.push;
            foxtrot = _closure1_slot0;
            yankee = _closure1_slot1;
            ...
            kilo = sizing.vec;
            romeo = options / tango;
            romeo = kilo.bind(sizing)(golf, romeo);
            romeo = backup.bind(entity)(romeo);
            romeo = entity.push;
            yankee = yankee[oscar];
            kilo = foxtrot.bind(report)(yankee);
            ...
            yankee = romeo.bind(entity)(yankee);
            golf = golf + mike;
            if(golf < verify) { _fun84130_ip = 56; continue _fun84130 }
 146:
            return entity;
        }
    };
 ...
 0:
            ...
            zulu = function(argFoo) {
                mike = argFoo;
                zulu = mike.xAxisOpacity;
                entity = new Array(2);
                entity[0] = zulu;
                mike = mike.yAxisOpacity;
                entity[1] = mike;
                return entity;
            };
            golf = golf.bind(tango)(zulu, oscar);
            ...
            zulu = new Array(0);
            sizing = yankee.bind(romeo)(offset, zulu);
            yankee = romeo.useMemo;
            ...
            mike = entity.Group;
            entity = {};
            if(!verify) { _fun84131_ip = 157; continue _fun84131 }
 154:
            oscar = options;
 157:
            ...
            kilo = golf.Points;
            golf = {'points': null, 'mode': 'lines', 'style': 'stroke', 'strokeWidth': 3, 'color': 'rgba(58, 135, 253, 1)'};
            golf['points'] = sizing;
