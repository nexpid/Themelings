...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
            ...
            mike = mike.ORIGINAL;
            if(!(mike !== golf)) { _fun00002_ip = 239; continue _fun00001 }
 56:
            zulu = _closure1_slot0;
            mike = _closure1_slot1;
            mike = mike[options];
            ...
            mike = offset;
            zulu = mike;
            if(!(report !== golf)) { _fun00002_ip = 308; continue _fun00001 }
 98:
            ...
            if(!(report !== golf)) { _fun00002_ip = 220; continue _fun00001 }
 131:
            yankee = _closure1_slot0;
            report = _closure1_slot1;
            report = report[options];
            ...
            if(!(report !== golf)) { _fun00002_ip = 201; continue _fun00001 }
 164:
            yankee = _closure1_slot0;
            report = _closure1_slot1;
            report = report[options];
 ...
 239:
            ...
            mike = entity;
            zulu = offset;
            if(!(yankee != verify)) { _fun00002_ip = 308; continue _fun00001 }
 251:
            report = verify.height;
            mike = entity;
            zulu = offset;
            if(!(yankee != report)) { _fun00002_ip = 308; continue _fun00001 }
 266:
            report = verify.width;
            mike = entity;
            zulu = offset;
 ...
 308:
            ...
            report = 0;
            tango = 0;
            if(!(golf !== oscar)) { _fun00002_ip = 356; continue _fun00001 }
 345:
            oscar = entity - mike;
            entity = 2;
            tango = oscar / entity;
 ...
 0:
                ...
                if(report) { _fun00004_ip = 266; continue _fun00003 }
 59:
                verify = {};
                report = 250;
