...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
    ...
    entity = function(argFoo, argBar, argBaz) { // Original name: _callSuper
        _fun106719: for(var _fun106719_ip = 0; ; ) switch(_fun106719_ip) {
 0:
            tango = argFoo;
            oscar = argBaz;
            ...
            if(entity) { _fun106719_ip = 51; continue _fun106719 }
 38:
            entity = verify.apply;
            entity = entity.bind(verify)(tango, oscar);
            _fun106719_ip = 92; continue _fun106719;
 51:
            golf = global;
            options = golf.Reflect;
            golf = options.construct;
            if(oscar) { _fun106719_ip = 71; continue _fun106719 }
 67:
            oscar = new Array(0);
 71:
 ...
 92:
    ...
    entity = function() { // Original name: _isNativeReflectConstruct
        _fun106720: for(var _fun106720_ip = 0; ; ) switch(_fun106720_ip) {
 0:
 2: // try_start_0
            mike = global;
            zulu = mike.Boolean;
 ...
 72: // try_end0
            _fun106720_ip = 76; continue _fun106720;
 74: // catch_target0
 ...
 76:
    ...
    mike = function(argFoo) {
        ...
        entity = function(argFoo) { // Original name: value
            _fun106725: for(var _fun106725_ip = 0; ; ) switch(_fun106725_ip) {
 0:
                tango = argFoo;
                mike = this;
                zulu = null;
                if(!(zulu == tango)) { _fun106725_ip = 19; continue _fun106725 }
 12:
 ...
 19:
                ...
                oscar = report[tango];
                if(!(zulu == oscar)) { _fun106725_ip = 91; continue _fun106725 }
 87:
                oscar = new Array(0);
 91:
                report = oscar.push;
 ...
 0:
                    ...
                    mike = mike - entity;
                    entity = 2592000000.0;
                    if(!(mike < entity)) { _fun106728_ip = 105; continue _fun106728 }
 77:
