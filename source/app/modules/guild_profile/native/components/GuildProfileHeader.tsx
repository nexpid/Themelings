...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
 ...
 0:
            ...
            entity = option.bind(romeon)(entity);
 ...
 302:
    ...
    golfie = {};
    yankee = 16;
    golfie['padding'] = yankee;
    option['content'] = golfie;
    golfie = {'borderRadius': 14.117647058823529, 'height': 60, 'width': 60};
    option['avatar'] = golfie;
    golfie = {};
    romeon = 11;
    ...
    option['avatarBackground'] = yankee;
    ...
    backup = backup.round;
    yankee['borderRadius'] = backup;
    option['communityPill'] = yankee;
    yankee = {'width': 16, 'height': 16, 'marginRight': 6};
    option['communityPillIcon'] = yankee;
    yankee = {};
    backup = oscard[romeon];
    backup = foxtra.bind(entity)(backup);
    backup = backup.colors;
    ...
    golfie = golfie.VERIFIED_AND_PARTNERED;
    tangon[2] = golfie;
    ...
    tangon = {};
    golfie = "function GuildProfileHeaderTsx1(){const{screenWidth,BANNER_RATIO,opacity}=this.__closure;return{width:'100%',height:screenWidth*BANNER_RATIO,opacity:opacity.get()};}";
    tangon['code'] = golfie;
    ...
    tangon = 'modules/guild_profile/native/components/GuildProfileHeader.tsx';
    tangon = report.bind(oscard)(tangon);
    michal = function(argFoo) { // Original name: GuildProfileHeader
 ...
 0:
            ...
            golfie = function() {
                ...
                michal = zuuluu.isSubscribedToAnyGuildChannel;
 ...
 13:
                    ...
                    michal = tangon instanceof zuuluu;
 28:
 ...
 31:
                    ...
                    michal = zuuluu.fetchGuildForPopout;
                    entity = _closure2_slot0;
                    entity = entity.id;
                    entity = michal.bind(zuuluu)(entity);
 76:
            ...
            sizing = null;
            michal = oscard;
            if(!(sizing != golfie)) { _fun00004_ip = 225; continue _fun00003 }
 222:
            michal = golfie;
 225:
            if(!(sizing != michal)) { _fun00004_ip = 232; continue _fun00003 }
 229:
            entity = michal;
 232:
            golfie = _closure1_slot1;
            ...
            golfie = verify.useGuildHeaderCounts;
            michal = entity.id;
            michal = golfie.bind(verify)(michal);
            backup = entity;
            entity = undefined;
            golfie = undefined;
            if(!option) { _fun00004_ip = 311; continue _fun00003 }
 299:
            entity = michal.onlineCount;
            golfie = michal.memberCount;
 311:
            papara = entity;
            target = golfie;
            if(!(sizing != oscard)) { _fun00004_ip = 353; continue _fun00003 }
 321:
            michal = entity;
            if(!(entity == sizing)) { _fun00004_ip = 334; continue _fun00003 }
 328:
            michal = oscard.presenceCount;
 334:
            entity = golfie;
            if(!(golfie == sizing)) { _fun00004_ip = 347; continue _fun00003 }
 341:
            entity = oscard.memberCount;
 347:
            target = entity;
            papara = michal;
 353:
            ...
            option = report.bind(oscard)(michal, entity);
            _closure2_slot3 = option;
            entity = _closure1_slot6;
            entity = backup instanceof entity;
            if(entity) { _fun00004_ip = 652; continue _fun00003 }
 445:
            report = _closure1_slot1;
            entity = _closure1_slot2;
            michal = 31;
            ...
            report = oscard.getGuildIconSource;
            entity = {};
            verify = backup.id;
            entity['id'] = verify;
            verify = backup.icon;
            ...
            romeon = null;
            if(report) { _fun00004_ip = 644; continue _fun00003 }
 555:
            romeon = null;
            if(zuuluu) { _fun00004_ip = 644; continue _fun00003 }
 560:
            report = _closure1_slot1;
            yankee = _closure1_slot2;
            michal = yankee[michal];
            oscard = report.bind(tangon)(michal);
            report = oscard.getGuildSplashSource;
            michal = {};
            verify = backup.id;
            michal['id'] = verify;
 ...
 644:
            offset = entity;
            _fun00004_ip = 879; continue _fun00003;
 652:
            ...
            oscard = vacuum.avatarBackground;
            entity['style'] = oscard;
            echoed = true;
            ...
            source = 30;
            oscard = sequen[source];
            yankee = yankee.bind(tangon)(oscard);
            oscard = {};
            ctrled = vacuum.avatar;
            oscard['style'] = ctrled;
            oscard['guild'] = backup;
            ...
            oscard['size'] = source;
            oscard['animate'] = echoed;
            oscard = output.bind(tangon)(yankee, oscard);
            entity['children'] = oscard;
            michal = report.bind(tangon)(michal, entity);
            entity = backup.banner;
            report = sizing == entity;
            entity = null;
            if(report) { _fun00004_ip = 873; continue _fun00003 }
 814:
            entity = null;
 ...
 819:
            ...
            report = oscard.getGuildBannerSource;
            zuuluu = {};
            yankee = backup.id;
            zuuluu['id'] = yankee;
            yankee = backup.banner;
            zuuluu['banner'] = yankee;
            entity = report.bind(oscard)(zuuluu, verify);
 873:
            romeon = entity;
            offset = michal;
 879:
            ...
            report = true;
            oscard = entity.bind(oscard)(backup, report);
            entity = 16;
            entity = zuuluu[entity];
            michal = michal.bind(tangon)(entity);
            entity = michal.getGuildTraits;
            sequen = entity.bind(michal)(backup);
            if(kiloes) { _fun00004_ip = 1010; continue _fun00003 }
 949:
            entity = sizing != oscard;
            record = null;
            if(!entity) { _fun00004_ip = 1008; continue _fun00003 }
 958:
 ...
 1008:
            _fun00004_ip = 1108; continue _fun00003;
 1010:
            michal = _closure1_slot0;
            zuuluu = _closure1_slot2;
            entity = 12;
            entity = zuuluu[entity];
            michal = michal.bind(tangon)(entity);
            entity = michal.getBadgeCategory;
            zuuluu = entity.bind(michal)(sequen);
            michal = _closure1_slot16;
            entity = michal.has;
            michal = entity.bind(michal)(zuuluu);
            entity = null;
            if(!michal) { _fun00004_ip = 1105; continue _fun00003 }
 1060:
            report = _closure1_slot12;
            zuuluu = _closure1_slot1;
            oscard = _closure1_slot2;
 ...
 1108:
            ...
            report = {};
            report['screenWidth'] = option;
            option = 0.56;
            report['BANNER_RATIO'] = option;
            report['opacity'] = golfie;
            ...
            michal = _closure1_slot4;
            entity = {};
            golfie = vacuum.headerContainer;
            report = new Array(2);
            report[0] = golfie;
            report[1] = oscard;
            entity['style'] = report;
            oscard = sizing != romeon;
            if(!oscard) { _fun00004_ip = 1338; continue _fun00003 }
 1290:
            option = _closure1_slot12;
            golfie = _closure1_slot1;
            report = _closure1_slot2;
 ...
 1338:
            ...
            romeon = 0;
            if(!foxtra) { _fun00004_ip = 1386; continue _fun00003 }
 1380:
            romeon = -48;
 1386:
            ...
            status = null;
            if(!record) { _fun00004_ip = 1492; continue _fun00003 }
 1486:
            status = '      ';
 1492:
            record = new Array(2);
            ...
            offset = null;
            if(!yankee) { _fun00004_ip = 1602; continue _fun00003 }
 1541:
 ...
 1602:
            ...
            offset['style'] = foxtra;
            output = null;
            if(!kiloes) { _fun00004_ip = 1669; continue _fun00003 }
 1631:
            foxtra = sequen.community;
            output = null;
            if(!foxtra) { _fun00004_ip = 1669; continue _fun00003 }
 1642:
 ...
 1669:
            ...
            if(!config) { _fun00004_ip = 1756; continue _fun00003 }
 1712:
 ...
 1756:
            ...
            if(!config) { _fun00004_ip = 1815; continue _fun00003 }
 1771:
 ...
 1815:
            ...
            backup = null;
            if(!output) { _fun00004_ip = 2101; continue _fun00003 }
 1867:
            backup = null;
            if(kiloes) { _fun00004_ip = 2101; continue _fun00003 }
 1875:
            ...
            kiloes['style'] = source;
            source = 'button';
            kiloes['accessibilityRole'] = source;
            ...
            source = sequen.bind(tangon)(result);
            result = {};
            ...
            source = ctrled.bind(tangon)(source, result);
            result = new Array(2);
            result[0] = source;
