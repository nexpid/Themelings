...
export default (function(_, argBar, argBaz, argCor, __, argFre, argPlu) {
    ...
    tangon = 'modules/guild_profile/native/components/RestrictedGuildProfileView.tsx';
    ...
    michal = function() { // Original name: RestrictedGuildProfileView
        ...
        option = option.bind(verify)(foxtra, romeon);
        ...
        verify = {'size': null, 'value': '?', 'selected': false};
        romeon = kiloes[romeon];
        romeon = backup.bind(tangon)(romeon);
        romeon = romeon.GuildIconSizes;
        romeon = romeon.XXLARGE;
        verify['size'] = romeon;
        romeon = golfie.restrictedAcronym;
