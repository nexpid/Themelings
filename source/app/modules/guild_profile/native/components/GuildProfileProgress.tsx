// app/modules/guild_profile/native/components/GuildProfileProgress.tsx
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
    ...
    tangon = 'modules/guild_profile/native/components/GuildProfileProgress.tsx';
    tangon = report.bind(oscard)(tangon);
    michal = function(argFoo) { // Original name: GuildProfileProgress
 ...
 0:
            ...
            michal = yankee.bind(oscard)(entity);
            entity = michal.useIsEligibleForGuildProgress;
 ...
 133:
            entity = null;
            if(!zuuluu) { _fun00002_ip = 329; continue _fun00001 }
 141:
 ...
 148:
            ...
            zuuluu = option.bind(oscard)(michal);
            michal = {};
            tangon = 7;
            ...
            tangon['guild'] = offset;
            yankee = verify.title;
            tangon['titleStyle'] = yankee;
            yankee = true;
            tangon['longPressDisabled'] = yankee;
            tangon['resume'] = yankee;
 ...
 228:
            ...
            golfie['guild'] = offset;
            verify = verify.title;
            golfie['titleStyle'] = verify;
            verify = true;
            golfie['longPressDisabled'] = verify;
            golfie['resume'] = verify;
