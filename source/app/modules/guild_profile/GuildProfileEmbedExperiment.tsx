...
export default (function(_, argBar, __, ___, ____, argFre, argPlu) {
    ...
    golfie = {'kind': 'user', 'id': '2025-03_guild_profile_invite_embed', 'label': 'Enables invite embeds using new guild profile components'};
    tangon = {};
    offset = false;
    tangon['enabled'] = offset;
    golfie['defaultConfig'] = tangon;
    yankee = {'id': 1, 'label': 'new embeds enabled'};
    tangon = 1;
    offset = {};
