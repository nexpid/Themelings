...
export default (function(argFoo, argBar, argBaz, _, __, argFre, argPlu) {
    ...
    michal = 'premium_preview';
    report['PREMIUM_PREVIEW'] = michal;
    ...
    golfie = 'modules/avatar_decorations/useAvatarDecorationSections.tsx';
 ...
 0:
                ...
                option = undefined;
                oscard = yankee.bind(option)(michal);
                report = oscard.getAvatarDecorations;
                ...
                tangon = {};
                michal = new Array(0);
                tangon['purchase'] = michal;
                michal = new Array(0);
                tangon['premium_purchase'] = michal;
                michal = new Array(0);
                tangon['preview'] = michal;
                michal = new Array(0);
                tangon['premium_preview'] = michal;
 ...
 119:
                        report = null;
                        if(!(report == option)) { _fun00004_ip = 244; continue _fun00003 }
 125:
 ...
 183:
                        michal = entity.premium_purchase;
                        zuuluu = michal.length;
                        michal = 0;
                        if(!(!(zuuluu > michal))) { _fun00004_ip = 208; continue _fun00003 }
 200:
                        zuuluu = entity.premium_preview;
