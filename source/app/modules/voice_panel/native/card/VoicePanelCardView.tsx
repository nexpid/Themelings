...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    entity = function(argFoo) { // Original name: getCardKey
        entity = argFoo;
        report = entity.type;
        tango = entity.id;
        entity = global;
    ...
    entity = function(argFoo, argBar, argBaz, argCorge) { // Original name: renderCard
    ...
    entity = function(argFoo) { // Original name: CardContentFreezer
        mike = argFoo;
        report = mike.children;
        var _closure2_slot0 = report;
        mike = function() { // Original name: useLazyContentFreeze
            _fun121947: for(var _fun121947_ip = 0; ; ) switch(_fun121947_ip) {
 0:
                ...
                oscar[0] = zulu;
                mike = function() {
                    _fun121948: for(var _fun121948_ip = 0; ; ) switch(_fun121948_ip) {
 0:
                        tango = _closure3_slot0;
                        zulu = _closure1_slot9;
                        zulu = zulu.IN_APP;
                        if(!(tango !== zulu)) { _fun121948_ip = 42; continue _fun121948 }
 26:
 ...
 42:
                        ...
                        tango = undefined;
                        zulu = function() {
                            _fun121949: for(var _fun121949_ip = 0; ; ) switch(_fun121949_ip) {
 0:
                                mike = _closure3_slot1;
                                mike = mike.current;
                                if(mike) { _fun121949_ip = 40; continue _fun121949 }
 15:
                                zulu = _closure3_slot1;
                                mike = true;
                                zulu['current'] = mike;
 ...
 40:
                ...
                entity = zulu === entity;
                if(!entity) { _fun121947_ip = 189; continue _fun121947 }
 186:
                entity = mike;
 189:
                return entity;
        ...
        mike = function(argFoo) { // Original name: useSpacerStyles
            oscar = argFoo;
            ...
            mike = yankee[mike];
            offset = undefined;
            mike = romeo.bind(offset)(mike);
            mike = zulu.bind(report)(mike);
            sizing = mike.connected;
            var _closure3_slot1 = sizing;
            result = mike.controlsSpecs;
            var _closure3_slot2 = result;
            output = mike.safeArea;
            var _closure3_slot3 = output;
            kilo = mike.contentDimensions;
            ...
            golf = mike.wrapperOffset;
            var _closure3_slot8 = golf;
            verify = _closure1_slot0;
            mike = 9;
            mike = yankee[mike];
            zulu = verify.bind(offset)(mike);
            mike = zulu.useAnimatedStyle;
            entity = function() { // Original name: o
                _fun121952: for(var _fun121952_ip = 0; ; ) switch(_fun121952_ip) {
 0:
                    ...
                    kilo = oscar.bind(options)(mike, entity);
                    mike = _closure1_slot1;
                    ...
                    offset = mike;
                    options = 0;
                    if(!oscar) { _fun121952_ip = 727; continue _fun121952 }
 153:
                    foxtrot = zulu + entity;
                    ...
                    foxtrot = 8;
                    if(!(backup < foxtrot)) { _fun121952_ip = 230; continue _fun121952 }
 212:
                    backup = _closure3_slot5;
                    foxtrot = backup.get;
                    foxtrot = foxtrot.bind(backup)();
                    oscar = foxtrot.height;
 230:
                    ...
                    offset = mike;
                    options = 0;
                    if(!(backup !== foxtrot)) { _fun121952_ip = 727; continue _fun121952 }
 268:
                    verify = oscar;
                    offset = mike;
                    options = 0;
                    if(!(romeo !== report)) { _fun121952_ip = 727; continue _fun121952 }
 283:
                    ...
                    offset = mike;
                    options = 0;
                    if(!report) { _fun121952_ip = 727; continue _fun121952 }
 316:
                    romeo = oscar - sizing;
                    ...
                    report = report.bind(romeo)();
                    report = report.height;
                    if(!(!(report > foxtrot))) { _fun121952_ip = 487; continue _fun121952 }
 442:
                    backup = _closure3_slot5;
                    report = backup.get;
                    report = report.bind(backup)();
                    ...
                    report = report.width;
                    report = romeo / report;
                    _fun121952_ip = 509; continue _fun121952;
 487:
                    backup = _closure3_slot4;
                    romeo = backup.get;
 ...
 509:
                    ...
                    romeo = romeo.height;
                    romeo = romeo < output;
                    if(!romeo) { _fun121952_ip = 556; continue _fun121952 }
 534:
 ...
 556:
                    backup = sizing;
                    if(!romeo) { _fun121952_ip = 629; continue _fun121952 }
 562:
                    update = _closure3_slot4;
                    romeo = update.get;
                    romeo = romeo.bind(update)();
                    romeo = romeo.height;
                    romeo = output - romeo;
                    result = 2;
                    output = romeo / result;
 ...
 629:
                    ...
                    romeo = romeo.height;
                    if(!(!(romeo > foxtrot))) { _fun121952_ip = 694; continue _fun121952 }
 651:
                    sizing = _closure3_slot5;
                    romeo = sizing.get;
                    romeo = romeo.bind(sizing)();
                    romeo = romeo.height;
                    romeo = romeo - entity;
                    ...
                    romeo = foxtrot / romeo;
                    romeo = backup + romeo;
                    _fun121952_ip = 713; continue _fun121952;
 694:
 ...
 727:
                    ...
                    oscar = oscar.bind(yankee)(verify);
                    entity['height'] = oscar;
                    oscar = {};
                    verify = _closure1_slot0;
                    romeo = 14;
                    ...
                    if(report) { _fun121952_ip = 884; continue _fun121952 }
 851:
                    backup = _closure3_slot6;
                    report = backup.get;
                    backup = report.bind(backup)();
                    report = _closure1_slot7;
                    report = report.PIP;
                    if(!(backup !== report)) { _fun121952_ip = 884; continue _fun121952 }
 878:
                    report = _closure1_slot12;
                    _fun121952_ip = 888; continue _fun121952;
 884:
                    report = _closure1_slot6;
 888:
                    report = verify.bind(foxtrot)(options, report);
                    ...
                    tango = _closure3_slot0;
                    if(!tango) { _fun121952_ip = 963; continue _fun121952 }
 961:
                    mike = 0;
 963:
                    entity['opacity'] = mike;
            ...
            report = {};
            report['controlsSpecs'] = result;
            result = _closure1_slot8;
            report['VoicePanelControlsModes'] = result;
            report['safeArea'] = output;
            output = _closure1_slot10;
            report['EDGE_GUTTER'] = output;
            output = 12;
            output = yankee[output];
            output = romeo.bind(offset)(output);
            report['calculateVoicePanelHeaderSpecs'] = output;
            report['connected'] = sizing;
            report['contentDimensions'] = kilo;
            report['windowDimensions'] = backup;
            report['mode'] = foxtrot;
            foxtrot = _closure1_slot7;
            ...
            report['roundToNearestPixel'] = options;
            options = 14;
            options = yankee[options];
            options = verify.bind(offset)(options);
            options = options.withSpring;
            report['withSpring'] = options;
            report['wrapperOffset'] = golf;
            golf = _closure1_slot6;
            report['LAYOUT_PHYSICS'] = golf;
            golf = _closure1_slot12;
            report['SCALE_PHYSICS'] = golf;
            report['freeze'] = oscar;
            entity['__closure'] = report;
            report = 12535849569890.0;
    ...
    tango = oscar[tango];
    tango = report.bind(entity)(tango);
    backup = tango.UI_SHOW_HIDE_PHYSICS;
    options = tango.VOICE_PANEL_CHUNK_DIVISOR;
    romeo = tango.LAYOUT_PHYSICS;
    ...
    mike = function(argFoo) { // Original name: VoicePanelCardView
        ...
        zulu = function(argFoo) { // Original name: useViewableChunkState
            foxtrot = argFoo;
            ...
            tango = function(argFoo) {
                ...
                mike = function(argFoo) {
                    _fun121957: for(var _fun121957_ip = 0; ; ) switch(_fun121957_ip) {
 0:
                        entity = argFoo;
                        tango = entity.start;
                        zulu = _closure4_slot0;
                        zulu = zulu.start;
                        if(!(tango === zulu)) { _fun121957_ip = 42; continue _fun121957 }
 24:
                        tango = entity.end;
                        zulu = _closure4_slot0;
                        zulu = zulu.end;
                        if(!(tango !== zulu)) { _fun121957_ip = 46; continue _fun121957 }
 42:
 ...
 46:
            ...
            golf = {};
            golf['viewableChunks'] = foxtrot;
            zulu['__closure'] = golf;
            golf = 1074173860641.0;
            zulu['__workletHash'] = golf;
            golf = _closure1_slot14;
            zulu['__initData'] = golf;
            mike = function(argFoo, argBar) { // Original name: s
                _fun121959: for(var _fun121959_ip = 0; ; ) switch(_fun121959_ip) {
 0:
                    zulu = argFoo;
                    golf = argBar;
                    ...
                    options = tango != golf;
                    tango = undefined;
                    if(!options) { _fun121959_ip = 51; continue _fun121959 }
 48:
                    tango = golf;
 51:
                    tango = report.bind(oscar)(zulu, tango);
                    if(tango) { _fun121959_ip = 102; continue _fun121959 }
 60:
                    tango = _closure1_slot0;
                    report = _closure1_slot2;
                    mike = 9;
 ...
 102:
            ...
            foxtrot = offset.bind(yankee)(foxtrot);
            foxtrot = foxtrot.cheapWorkletShallowEqual;
            golf['cheapWorkletShallowEqual'] = foxtrot;
            verify = romeo[verify];
            verify = offset.bind(yankee)(verify);
            verify = verify.runOnJS;
            golf['runOnJS'] = verify;
            golf['updateValueIfChange'] = options;
            mike['__closure'] = golf;
            golf = 13543715159803.0;
        ...
        zulu = tango.useChunkedParticipants;
        ...
        entity = function() {
            ...
            report['getItemKey'] = golf;
            golf = 1000;
            report['lazyCleanUpDelay'] = golf;
    ...
    tango = 'modules/voice_panel/native/card/VoicePanelCardView.tsx';
