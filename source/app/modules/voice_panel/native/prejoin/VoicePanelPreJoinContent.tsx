...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
 ...
 0:
            ...
            if(!oscard) { _fun00018_ip = 244; continue _fun00017 }
 214:
 ...
 63:
            ...
            if(!oscard) { _fun00018_ip = 412; continue _fun00017 }
 288:
            verify = _closure1_slot23;
            ...
            output = output.t;
            if(result) { _fun00018_ip = 363; continue _fun00017 }
 353:
            result = output.ToYK3N;
            _fun00018_ip = 371; continue _fun00017;
 363:
 ...
 412:
            ...
            oscard = ctrled.size;
            oscard = oscard > backup;
            if(!oscard) { _fun00018_ip = 531; continue _fun00017 }
 428:
            verify = _closure1_slot23;
            option = _closure1_slot40;
            golfie = {};
 ...
 531:
            ...
            if(!oscard) { _fun00018_ip = 1074; continue _fun00017 }
 545:
            verify = _closure1_slot24;
            option = _closure1_slot0;
            ...
            golfie = {};
            if(!(backup !== offset)) { _fun00018_ip = 648; continue _fun00017 }
 581:
            ...
            _fun00018_ip = 718; continue _fun00017;
 648:
 ...
 718:
            ...
            offset = sizing.done;
            output = 48;
            if(offset) { _fun00018_ip = 943; continue _fun00017 }
 753:
            offset = sizing.value;
            sequen = backup.length;
            if(!(!(sequen >= foxtra))) { _fun00018_ip = 943; continue _fun00017 }
 770:
            config = vacuum.has;
            sequen = offset.user;
            sequen = sequen.id;
            sequen = config.bind(vacuum)(sequen);
            if(sequen) { _fun00018_ip = 813; continue _fun00017 }
 793:
            record = ctrled.has;
            config = offset.user;
            config = config.id;
 ...
 813:
            if(sequen) { _fun00018_ip = 925; continue _fun00017 }
 816:
            sequen = backup.push;
 ...
 925:
            ...
            offset = sequen.done;
            sizing = sequen;
            if(!offset) { _fun00018_ip = 753; continue _fun00017 }
 943:
            offset = new Array(2);
            offset[0] = backup;
            yankee = yankee > foxtra;
            if(!yankee) { _fun00018_ip = 1060; continue _fun00017 }
 958:
 ...
 107:
    ...
    romeon = romeon.BASE_VOICE_PANEL_HEADER_HEIGHT;
    ...
    option['channelInfoWrapper'] = yankee;
    output = 'center';
    yankee = {'textAlign': 'center', 'paddingTop': 16, 'paddingBottom': 16};
    option['subheading'] = yankee;
    ...
    echoed = echoed.radii;
    echoed = echoed.lg;
    yankee['borderRadius'] = echoed;
    echoed = oscard[romeon];
    echoed = foxtra.bind(entity)(echoed);
    echoed = echoed.colors;
    echoed = echoed.BLACK;
    yankee['backgroundColor'] = echoed;
    option['previewImageWrapper'] = yankee;
    yankee = {};
    ctrled = sizing.absoluteFillObject;
    vacuum = yankee;
    echoed = copyDataProperties(vacuum, ctrled);
    update = 0.5;
    echoed = 'opacity';
    yankee[echoed] = update;
    option['previewImage'] = yankee;
    yankee = {};
    yankee['paddingHorizontal'] = kiloes;
    option['activityInfoWrapper'] = yankee;
    yankee = {};
    yankee['marginBottom'] = result;
    option['activityInfoHeader'] = yankee;
    ...
    yankee[sizing] = output;
    option['joinButtonWrapper'] = yankee;
    yankee = {};
    yankee['marginHorizontal'] = kiloes;
    option['optInChannelsContainer'] = yankee;
    ...
    kiloes = kiloes.INFO_WARNING_FOREGROUND;
    ...
    option['blockedMemberWarning'] = yankee;
    yankee = {};
    romeon = 36;
    yankee['height'] = romeon;
    option['consolePreJoinPadding'] = yankee;
 ...
 0:
            ...
            option = verify.useIsStealthRemediationEnabled;
            golfie = {};
            romeon = 'voice_panel_pre_join_members_warning';
            golfie['location'] = romeon;
            ...
            entity = michal.bind(zuuluu)(entity);
            michal = 0;
            if(!(foxtra > michal)) { _fun00028_ip = 248; continue _fun00027 }
 241:
            if(!(!(verify > michal))) { _fun00028_ip = 420; continue _fun00027 }
 248:
            if(!(!(verify > michal))) { _fun00028_ip = 353; continue _fun00027 }
 252:
            zuuluu = _closure1_slot0;
            michal = _closure1_slot2;
            ...
            michal = zuuluu.bind(tangon)(michal);
            michal = michal.t;
            if(romeon) { _fun00028_ip = 324; continue _fun00027 }
 296:
            offset = michal.aP6jaG;
            zuuluu = {};
            zuuluu['n'] = foxtra;
            offset = oscard.bind(golfie)(offset, zuuluu);
            backup = null;
            _fun00028_ip = 477; continue _fun00027;
 324:
            zuuluu = michal.6X29zc;
            michal = {};
            michal['n'] = foxtra;
            offset = oscard.bind(golfie)(zuuluu, michal);
            backup = entity;
            _fun00028_ip = 477; continue _fun00027;
 353:
            zuuluu = _closure1_slot0;
 ...
 477:
            ...
            verify = kiloes;
            if(!romeon) { _fun00028_ip = 606; continue _fun00027 }
 600:
            verify = 'text-sm/bold';
 606:
            oscard['variant'] = verify;
            verify = undefined;
            if(!romeon) { _fun00028_ip = 621; continue _fun00027 }
 615:
 ...
 621:
            ...
            if(!romeon) { _fun00028_ip = 706; continue _fun00027 }
 664:
            foxtra = _closure1_slot23;
            romeon = _closure1_slot0;
            yankee = _closure1_slot2;
