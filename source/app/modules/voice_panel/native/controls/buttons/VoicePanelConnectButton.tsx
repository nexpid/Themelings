...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    mike = function(argFoo) { // Original name: ConnectButton
        _fun122362: for(var _fun122362_ip = 0; ; ) switch(_fun122362_ip) {
 0:
            entity = argFoo;
            verify = entity.props;
            tango = undefined;
            ...
            foxtrot = mike.canConnect;
            var _closure2_slot2 = foxtrot;
            romeo = mike.isAtMaxCapacity;
            var _closure2_slot3 = romeo;
            mike = 6;
            mike = options[mike];
            mike = zulu.bind(tango)(mike);
            offset = mike.bind(tango)(yankee);
            if(!offset) { _fun122362_ip = 143; continue _fun122362 }
 137:
            mike = null;
            offset = mike != entity;
 143:
            if(!offset) { _fun122362_ip = 152; continue _fun122362 }
 146:
            mike = null;
            offset = mike != yankee;
 152:
            ...
            mike[4] = entity;
            entity = function() {
                _fun122363: for(var _fun122363_ip = 0; ; ) switch(_fun122363_ip) {
 0:
                    entity = _closure2_slot2;
                    if(!entity) { _fun122363_ip = 69; continue _fun122363 }
 10:
 ...
 24:
                    ...
                    _fun122363_ip = 364; continue _fun122363;
 69:
                    entity = _closure2_slot2;
                    if(entity) { _fun122363_ip = 161; continue _fun122363 }
 76:
                    ...
                    zulu = tango.openAlert;
                    entity = 9;
                    mike = verify[entity];
                    mike = oscar.bind(golf)(mike);
                    mike = mike.VOICE_PANEL_NO_JOIN_PERMS_KEY;
 ...
 161:
                    entity = _closure2_slot3;
                    if(entity) { _fun122363_ip = 276; continue _fun122363 }
 168:
                    entity = _closure2_slot4;
                    if(!entity) { _fun122363_ip = 364; continue _fun122363 }
 178:
                    oscar = _closure1_slot0;
                    verify = _closure1_slot2;
                    entity = 8;
                    ...
                    mike = verify[entity];
                    mike = oscar.bind(golf)(mike);
                    mike = mike.VOICE_PANEL_NSFW_KEY;
                    oscar = _closure1_slot4;
                    report = _closure1_slot1;
                    entity = verify[entity];
                    report = report.bind(golf)(entity);
 ...
 276:
                    ...
                    mike = verify[entity];
                    mike = oscar.bind(golf)(mike);
                    mike = mike.VOICE_PANEL_MAX_CAPACITY_KEY;
                    oscar = _closure1_slot4;
                    report = _closure1_slot1;
                    entity = verify[entity];
                    report = report.bind(golf)(entity);
 ...
 364:
            ...
            offset = zulu.bind(options)(entity, mike);
            ...
            oscar = function() {
                ...
                mike = entity.Text;
                entity = {'variant': 'text-sm/semibold', 'color': 'always-white'};
                report = 13;
                oscar = verify[report];
