...
export default (function(_, argBar, __, ___, ____, argFre, argPlu) {
    ...
    option = ['APP_STATE_UPDATE', 'OVERLAY_INITIALIZE', 'CHANNEL_SELECT', 'VOICE_CHANNEL_SELECT', 'THREAD_CREATE', 'THREAD_LIST_SYNC', 'CHANNEL_CREATE', 'CHANNEL_PRELOAD', 'GUILD_CREATE', 'MESSAGE_END_EDIT', 'LOAD_MESSAGES_SUCCESS', 'UPLOAD_FAIL', 'CHANNEL_DELETE', 'THREAD_DELETE'];
    entity['actions'] = option;
    option = function() { // Original name: inlineRequire
        zuuluu = _closure1_slot0;
        michal = _closure1_slot1;
