...
export default (function(_, argBar, __, ___, ____, argFre, argPlu) {
    ...
    entity = {};
    option = ['CHANNEL_SELECT', 'AGE_GATE_MODAL_OPEN', 'AGE_GATE_MODAL_CLOSE'];
    entity['actions'] = option;
    option = function() { // Original name: inlineRequire
        zuuluu = _closure1_slot0;
        michal = _closure1_slot1;
    ...
    entity = {};
    option = ['GUILD_POWERUP_ENTITLEMENTS_CREATE', 'GUILD_POWERUP_ENTITLEMENTS_DELETE'];
    entity['actions'] = option;
    option = function() { // Original name: inlineRequire
        zuuluu = _closure1_slot0;
        michal = _closure1_slot1;
    ...
    entity = {};
    option = ['CONNECTION_OPEN_SUPPLEMENTAL', 'GUILD_SETTINGS_CLOSE', 'USER_SETTINGS_MODAL_CLOSE', 'CHANNEL_SETTINGS_CLOSE', 'NOTIFICATION_SETTINGS_MODAL_CLOSE', 'PREMIUM_PAYMENT_MODAL_CLOSE', 'EMAIL_VERIFICATION_MODAL_CLOSE', 'IFE_EXPERIMENT_SEARCH_MODAL_CLOSE', 'CREATE_INVITE_MODAL_CLOSE', 'QUICKSWITCHER_HIDE', 'EMAIL_VERIFICATION_MODAL_OPEN', 'USER_REQUIRED_ACTION_UPDATE', 'CHANNEL_SETTINGS_OPEN', 'GUILD_SETTINGS_OPEN', 'NOTIFICATION_SETTINGS_MODAL_OPEN', 'CREATE_INVITE_MODAL_OPEN'];
    entity['actions'] = option;
    option = function() { // Original name: inlineRequire
        zuuluu = _closure1_slot0;
        michal = _closure1_slot1;
