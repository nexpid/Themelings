...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    mike = 56;
    yankee = 'center';
    offset = {'width': 56, 'display': 'flex', 'flexDirection': 'column', 'justifyContent': 'space-between', 'alignItems': 'center', 'rowGap': 8, 'flex': 1};
    report['container'] = offset;
    offset = {'display': 'flex', 'justifyContent': 'center', 'alignItems': 'center', 'zIndex': 1};
    romeo = 4;
    backup = golf[romeo];
    ...
    report['marker'] = offset;
    offset = {'display': 'flex', 'borderRadius': null, 'backgroundColor': null, 'width': '100%', 'height': '100%'};
    backup = golf[romeo];
    backup = foxtrot.bind(entity)(backup);
    backup = backup.radii;
    backup = backup.round;
    ...
    report['label'] = offset;
    offset = {'alignItems': 'flex-start', 'textAlign': 'left'};
    report['firstOption'] = offset;
    offset = {'alignItems': 'flex-end', 'textAlign': 'right'};
    report['lastOption'] = offset;
 ...
 0:
            ...
            echo = entity.isSelected;
            var _closure2_slot1 = echo;
            sizing = entity.index;
            report = entity.onLayout;
            update = entity.size;
            result = entity.numOptions;
            entity = _closure1_slot6;
            tango = undefined;
            kilo = entity.bind(tango)();
            var _closure2_slot2 = kilo;
            options = {};
            vacuum = kilo.container;
            sequence = options;
            entity = copyDataProperties(sequence, vacuum);
            output = 0;
            if(!(output !== sizing)) { _fun100039_ip = 98; continue _fun100039 }
 94:
            entity = {};
            _fun100039_ip = 104; continue _fun100039;
 98:
 ...
 104:
            ...
            if(!(sizing !== entity)) { _fun100039_ip = 129; continue _fun100039 }
 125:
            entity = {};
            _fun100039_ip = 135; continue _fun100039;
 129:
 ...
 135:
            ...
            if(echo) { _fun100039_ip = 365; continue _fun100039 }
 170:
            ...
            romeo[backup] = update;
            update = 0;
            if(echo) { _fun100039_ip = 258; continue _fun100039 }
 218:
            update = 0;
            if(!(output === sizing)) { _fun100039_ip = 258; continue _fun100039 }
 224:
 ...
 258:
            ...
            romeo[backup] = update;
            backup = 0;
            if(echo) { _fun100039_ip = 316; continue _fun100039 }
 272:
            foxtrot = result - foxtrot;
            backup = 0;
            if(!(sizing === foxtrot)) { _fun100039_ip = 316; continue _fun100039 }
 282:
 ...
 0:
                    ...
                    if(entity) { _fun100040_ip = 80; continue _fun100040 }
 47:
                    ...
                    _fun100040_ip = 118; continue _fun100040;
 80:
                    report = {};
                    golf = {};
