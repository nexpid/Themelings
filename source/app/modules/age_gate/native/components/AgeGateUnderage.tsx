...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    tango = {};
    verify = {'alignItems': 'center', 'justifyContent': 'center', 'flex': 1, 'padding': 16, 'paddingTop': 0};
    yankee = 16;
    offset = 5;
    romeo = oscar[offset];
    ...
    tango['header'] = verify;
    verify = {'marginTop': 8, 'lineHeight': 20, 'textAlign': 'center'};
    tango['body'] = verify;
    verify = {'width': '100%', 'marginTop': 24, 'flexGrow': 0};
    tango['button'] = verify;
    verify = {'width': 13, 'height': 22, 'marginRight': 6};
    tango['leftButtonChevron'] = verify;
    verify = {};
    ...
    tango = 'modules/age_gate/native/components/AgeGateUnderage.tsx';
    tango = report.bind(oscar)(tango);
    mike = function(argFoo) { // Original name: AgeGateUnderage
        _fun111858: for(var _fun111858_ip = 0; ; ) switch(_fun111858_ip) {
 0:
            mike = argFoo;
            sizing = mike.onClose;
            var _closure2_slot0 = sizing;
            update = mike.underageMessage;
            golf = mike.existingUser;
            tango = undefined;
            if(!(golf === tango)) { _fun111858_ip = 35; continue _fun111858 }
 33:
            golf = false;
 35:
            var _closure2_slot1 = golf;
            offset = mike.fromRegister;
            if(!(offset === tango)) { _fun111858_ip = 51; continue _fun111858 }
 49:
            offset = false;
 51:
            mike = mike.disableSwipe;
            if(!(mike === tango)) { _fun111858_ip = 63; continue _fun111858 }
 61:
            mike = false;
 63:
 ...
 0:
                    ...
                    if(report) { _fun111859_ip = 64; continue _fun111859 }
 22:
                    ...
                    _fun111859_ip = 73; continue _fun111859;
 64:
                    report = function() {
                        entity = null;
                        return entity;
 ...
 73:
            ...
            entity = entity.t;
            if(golf) { _fun111858_ip = 249; continue _fun111858 }
 236:
            report = entity.nCB6GR;
            foxtrot = mike.bind(zulu)(report);
            _fun111858_ip = 260; continue _fun111858;
 249:
 ...
 260:
            ...
            oscar = {};
            oscar = verify.bind(tango)(backup, oscar);
            report[1] = oscar;
            ...
            backup = foxtrot.intl;
            if(offset) { _fun111858_ip = 631; continue _fun111858 }
 487:
            echo = backup.format;
            offset = romeo[result];
            ...
            offset = {};
            source = null;
            if(!(source == update)) { _fun111858_ip = 572; continue _fun111858 }
 520:
 ...
 572:
            ...
            _fun111858_ip = 661; continue _fun111858;
 631:
 ...
 661:
            ...
            report[4] = oscar;
            oscar = null;
            if(!golf) { _fun111858_ip = 920; continue _fun111858 }
 683:
            ...
            offset = output.bind(tango)(offset);
            romeo = offset.Text;
            offset = {'style': null, 'variant': 'text-md/medium', 'color': 'interactive-normal'};
            echo = kilo.body;
            offset['style'] = echo;
            echo = backup[result];
