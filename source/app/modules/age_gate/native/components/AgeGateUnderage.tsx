...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
    ...
    tangon['leftButtonChevron'] = verify;
    verify = {};
    ...
    tangon = 'modules/age_gate/native/components/AgeGateUnderage.tsx';
    tangon = report.bind(oscard)(tangon);
    michal = function(argFoo) { // Original name: AgeGateUnderage
        _fun00001: for(var _fun00002_ip = 0; ; ) switch(_fun00002_ip) {
 0:
            michal = argFoo;
            sizing = michal.onClose;
            var _closure2_slot0 = sizing;
            update = michal.underageMessage;
            golfie = michal.existingUser;
            tangon = undefined;
            if(!(golfie === tangon)) { _fun00002_ip = 35; continue _fun00001 }
 33:
            golfie = false;
 35:
            var _closure2_slot1 = golfie;
            offset = michal.fromRegister;
            if(!(offset === tangon)) { _fun00002_ip = 51; continue _fun00001 }
 49:
            offset = false;
 51:
            michal = michal.disableSwipe;
 ...
 264:
            ...
            oscard = {};
            oscard = verify.bind(tangon)(backup, oscard);
            report[1] = oscard;
