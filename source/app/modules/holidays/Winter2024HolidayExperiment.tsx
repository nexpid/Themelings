// app/modules/holidays/Winter2024HolidayExperiment.tsx
export default (function(_, argBar, __, ___, ____, argFre, argPlu) {
    ...
    michal = {'kind': 'user', 'id': '2024-12_winter_holiday', 'label': 'Winter Holiday'};
    tangon = {};
    verify = false;
    ...
    tangon = 'modules/holidays/Winter2024HolidayExperiment.tsx';
