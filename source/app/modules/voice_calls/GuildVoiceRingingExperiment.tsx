...
export default (function(_, argBar, __, ___, ____, argFre, argPlu) {
    ...
    michal = {'kind': 'guild', 'id': '2024-12_guild_voice_channel_ringing', 'label': 'Guild Voice Ringing'};
    verify = {};
    yankee = false;
    ...
    verify = {'id': 1, 'label': 'Allow users to ring each other in Guild Voice Channels'};
    option = {};
    ...
    tangon = 'modules/voice_calls/GuildVoiceRingingExperiment.tsx';
