...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    mike = function(argFoo) { // Original name: VoiceFeedbackActionSheet
        ...
        report = function(argFoo) { // Original name: trackReport
            _fun123541: for(var _fun123541_ip = 0; ; ) switch(_fun123541_ip) {
 0:
                mike = argFoo;
                tango = mike.rating;
                entity = mike.reason;
                ...
                verify = null;
                options = null;
                if(!mike) { _fun123541_ip = 44; continue _fun123541 }
 34:
                verify = entity.code;
 ...
 44:
                ...
                offset = zulu != report;
                oscar = '';
                if(!offset) { _fun123541_ip = 83; continue _fun123541 }
 80:
                oscar = report;
 83:
                ...
                if(!(zulu != tango)) { _fun123541_ip = 142; continue _fun123541 }
 112:
