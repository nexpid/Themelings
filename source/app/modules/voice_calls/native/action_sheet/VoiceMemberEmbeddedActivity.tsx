...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
    ...
    tangon = function(argFoo) { // Original name: VoiceMemberEmbeddedActivity
        _fun00001: for(var _fun00002_ip = 0; ; ) switch(_fun00002_ip) {
 0:
            entity = argFoo;
            oscard = entity.embeddedActivity;
            verify = entity.channelId;
            var _closure2_slot0 = verify;
            michal = entity.onItemPress;
 ...
 62:
            ...
            option = offset.getEmbeddedActivityLocationGuildId;
            ...
            oscard = option.useEmbeddedActivityJoinability;
            tangon = {};
            ...
            offset = undefined;
            if(romeon) { _fun00002_ip = 384; continue _fun00001 }
 379:
            offset = yankee.id;
 384:
            ...
            result = oscard.bind(option)(tangon);
 ...
 496:
            ...
            if(!(entity == romeon)) { _fun00002_ip = 534; continue _fun00001 }
 514:
 ...
 534:
            ...
            michal = function() { // Original name: onEmbeddedActivityItemPress
                ...
                michal['embeddedActivityJoinability'] = report;
            ...
            if(!(romeon !== foxtra)) { _fun00002_ip = 780; continue _fun00001 }
 772:
 ...
 786:
            ...
            papara = config.applicationName;
            sizing['style'] = papara;
            sizing['children'] = cntext;
            sizing = foxtra.bind(report)(ctrled, sizing);
            romeon['children'] = sizing;
            romeon = foxtra.bind(report)(kiloes, romeon);
            offset[1] = romeon;
 ...
 963:
            ...
            kiloes = kiloes.OverflowText;
            yankee['overflowComponent'] = kiloes;
            yankee['items'] = backup;
            backup = 5;
            yankee['max'] = backup;
 ...
 0:
                    ...
                    oscard = argBar;
                    report = undefined;
                    if(oscard) { _fun00010_ip = 157; continue _fun00009 }
 65:
                    oscard = {};
 ...
 157:
            ...
            offset = option.bind(report)(golfie, verify);
            verify = new Array(2);
            verify[0] = offset;
            ...
            foxtra[0] = backup;
            backup = {};
            kiloes = source.height;
            backup['height'] = kiloes;
            kiloes = 'center';
            backup['justifyContent'] = kiloes;
            foxtra[1] = backup;
            offset['style'] = foxtra;
            ...
            foxtra = {};
            foxtra['application'] = update;
            update = {};
            ctrled = 'absolute';
            update['position'] = ctrled;
            ctrled = source.width;
            update['width'] = ctrled;
            source = source.height;
            update['height'] = source;
            foxtra['dimensionsStyle'] = update;
            update = 8;
            foxtra['borderRadius'] = update;
            update = 'contain';
            foxtra['resizeMode'] = update;
 ...
 1429:
    ...
    zuuluu['calculateActivityRowHeight'] = michal;
    return entity;
})();