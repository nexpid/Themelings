...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
    ...
    verify = {'alignSelf': 'center', 'width': 231, 'height': 231, 'borderRadius': null, 'marginBottom': 16};
    foxtra = oscard[offset];
    foxtra = yankee.bind(entity)(foxtra);
    foxtra = foxtra.radii;
    foxtra = foxtra.sm;
    ...
    verify = {'tintColor': null, 'width': 32, 'height': 32, 'marginTop': 4294967294, 'marginLeft': 4294967280};
    romeon = oscard[offset];
    romeon = yankee.bind(entity)(romeon);
    ...
    tangon = 'modules/upsell_tooltip/native/PremiumUpsellTooltipActionSheet.tsx';
    tangon = report.bind(oscard)(tangon);
    michal = function(argFoo) { // Original name: PremiumUpsellTooltipActionSheet
        _fun00001: for(var _fun00002_ip = 0; ; ) switch(_fun00002_ip) {
 0:
            entity = argFoo;
            papara = entity.title;
            status = entity.backdropProps;
            vacuum = entity.description;
            config = entity.descriptionStyle;
            romeon = entity.imageSource;
            sizing = entity.imageStyle;
            michal = entity.dismissibleContent;
            var _closure2_slot0 = michal;
            output = entity.primaryButtonText;
            source = entity.primaryButtonIcon;
            echoed = entity.secondaryButtonText;
            michal = entity.onDismiss;
            var _closure2_slot1 = michal;
            michal = entity.onPrimaryButtonPress;
            var _closure2_slot2 = michal;
            entity = entity.onSecondaryButtonPress;
            var _closure2_slot3 = entity;
            entity = _closure1_slot8;
            tangon = undefined;
            update = entity.bind(tangon)();
            oscard = function(argFoo) { // Original name: handleDismiss
 ...
 248:
            ...
            verify = 9;
            record = romeon[verify];
            record = kiloes.bind(tangon)(record);
            cntext = record.Text;
            record = {'variant': 'heading-xl/bold', 'style': null, 'color': 'header-primary', 'accessibilityRole': 'header'};
            target = update.title;
            record['style'] = target;
            ...
            ctrled = yankee.bind(tangon)(offset, ctrled);
            option[1] = ctrled;
            verify = romeon[verify];
            ...
            verify = sizing.bind(tangon)(ctrled, verify);
            option[2] = verify;
            verify = {};
            update = update.buttonContainer;
            verify['style'] = update;
            update = 10;
