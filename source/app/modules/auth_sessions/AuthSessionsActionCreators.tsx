...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
 ...
 0:
                    ...
                    if(mike) { _fun95580_ip = 191; continue _fun95580 }
 10:
 ...
 76:
                    ...
                    if(tango) { _fun95580_ip = 188; continue _fun95580 }
 82:
                    golf = null;
                    tango = golf != mike;
                    if(!tango) { _fun95580_ip = 97; continue _fun95580 }
 91:
                    tango = mike.ok;
 97:
                    if(!tango) { _fun95580_ip = 124; continue _fun95580 }
 100:
                    options = mike.body;
                    verify = golf == options;
                    oscar = undefined;
                    if(verify) { _fun95580_ip = 120; continue _fun95580 }
 114:
                    oscar = options.user_sessions;
 120:
                    tango = golf != oscar;
 124:
                    if(!tango) { _fun95580_ip = 185; continue _fun95580 }
 127:
 ...
 0:
                    ...
                    tango = argFoo;
                    ResumeGenerator(result_out_reg=0, return_bool_out_reg=1);
                    if(mike) { _fun95583_ip = 223; continue _fun95583 }
 13:
                    mike = global;
                    zulu = mike.Array;
                    mike = zulu.isArray;
                    mike = mike.bind(zulu)(tango);
                    if(mike) { _fun95583_ip = 44; continue _fun95583 }
 34:
                    oscar = new Array(1);
                    oscar[0] = tango;
                    _fun95583_ip = 61; continue _fun95583;
 44:
                    zulu = tango.length;
                    mike = 0;
                    oscar = tango;
                    if(!(mike !== zulu)) { _fun95583_ip = 218; continue _fun95583 }
 61:
                    tango = _closure1_slot0;
                    report = _closure1_slot2;
                    mike = 2;
 ...
 141:
                    ResumeGenerator(result_out_reg=1, return_bool_out_reg=3);
                    if(tango) { _fun95583_ip = 215; continue _fun95583 }
 147:
                    tango = null;
                    tango = tango != mike;
                    if(!tango) { _fun95583_ip = 162; continue _fun95583 }
 156:
                    tango = mike.ok;
 162:
                    if(!tango) { _fun95583_ip = 212; continue _fun95583 }
 165:
                    tango = _closure1_slot1;
