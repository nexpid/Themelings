...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
    ...
    tangon = 'modules/notifications/settings/native/NotificationSettingsMessageUnreadActionSheet.tsx';
    tangon = report.bind(oscard)(tangon);
    michal = function(argFoo) { // Original name: NotificationSettingsMessageUnreadActionSheet
        result = argFoo;
        ...
        backup = {};
        echoed = result.disabledMentionOnlyWithReason;
        backup['subLabel'] = echoed;
        echoed = result.disabledMentionOnlyWithReason;
        result = null;
