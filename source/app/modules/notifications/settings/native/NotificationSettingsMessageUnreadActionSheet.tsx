...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    tango = 'modules/notifications/settings/native/NotificationSettingsMessageUnreadActionSheet.tsx';
    tango = report.bind(oscar)(tango);
    mike = function(argFoo) { // Original name: NotificationSettingsMessageUnreadActionSheet
        result = argFoo;
        ...
        backup = {};
        echo = result.disabledMentionOnlyWithReason;
        backup['subLabel'] = echo;
        echo = result.disabledMentionOnlyWithReason;
        result = null;
        result = result != echo;
