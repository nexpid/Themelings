...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
 ...
 0:
            ...
            mike = null;
            if(!(mike == verify)) { _fun86317_ip = 89; continue _fun86317 }
 79:
            mike = golf.channel;
            verify = mike.id;
 89:
            ...
            verify = options.GUILD_INVITE;
            options = 'impressionName';
            mike[options] = verify;
            options = {};
            verify = golf.channel;
            verify = verify.id;
            options['invite_channel_id'] = verify;
            golf = golf.channel;
            golf = golf.guild_id;
            options['invite_guild_id'] = golf;
