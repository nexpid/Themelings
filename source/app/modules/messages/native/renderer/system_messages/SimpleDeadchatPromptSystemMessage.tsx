...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
            ...
            zulu = entity.content;
            mike = null;
            if(!(mike != zulu)) { _fun72560_ip = 38; continue _fun72560 }
 25:
            zulu = entity.content;
            mike = '';
            if(!(mike === zulu)) { _fun72560_ip = 100; continue _fun72560 }
 38:
            ...
            _fun72560_ip = 105; continue _fun72560;
 100:
 ...
 105:
            ...
            yankee = options.resolveAssetSource;
            verify = _closure1_slot0;
            oscar = 6;
            golf = offset[oscar];
            backup = verify.bind(zulu)(golf);
            romeo = backup.makeSource;
            golf = 7;
            golf = offset[golf];
            ...
            golf = golf.uri;
            report['cameraButtonIcon'] = golf;
            golf = options.resolveAssetSource;
            oscar = offset[oscar];
            romeo = verify.bind(zulu)(oscar);
 ...
 0:
            ...
            tango = null;
            if(!(tango != report)) { _fun72561_ip = 76; continue _fun72561 }
 58:
            report = zulu.message;
            oscar = report.content;
            report = '';
            if(!(report === oscar)) { _fun72561_ip = 133; continue _fun72561 }
 76:
            verify = _closure1_slot0;
            offset = _closure1_slot2;
            report = 4;
            ...
            _fun72561_ip = 143; continue _fun72561;
 133:
            zulu = zulu.message;
            report = zulu.content;
 143:
            ...
            report = null;
            if(oscar) { _fun72561_ip = 255; continue _fun72561 }
 188:
 ...
 255:
            ...
            verify = verify.uri;
            zulu['emojiButtonIcon'] = verify;
            report = report[options];
            oscar = oscar.bind(golf)(report);
            report = oscar.isAndroid;
            report = report.bind(oscar)();
            tango = null;
            if(report) { _fun72561_ip = 410; continue _fun72561 }
 355:
            verify = _closure1_slot0;
            offset = _closure1_slot2;
            report = 4;
 ...
 410:
            ...
            zulu['emojiButtonText'] = mike;
            mike = 'channelPromptData';
            entity[mike] = zulu;
            return entity;
        }
    };
    zulu['createSimpleDeadchatPromptSystemMessage'] = mike;
    return entity;
})();