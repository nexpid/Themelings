// app/modules/messages/native/renderer/system_messages/StageStartSystemMessage.tsx
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
    ...
    tangon = 'modules/messages/native/renderer/system_messages/StageStartSystemMessage.tsx';
    tangon = report.bind(oscard)(tangon);
    tangon = function(argFoo) { // Original name: StageStartSystemMessage
        entity = argFoo;
        oscard = entity.row;
        ...
        zuuluu = new Array(0);
        offset = offset.bind(yankee)(verify, option, zuuluu);
        var _closure2_slot0 = offset;
        romeon = oscard.message;
        var _closure2_slot1 = romeon;
        verify = romeon.author;
 ...
 0:
                ...
                entity = entity.t;
                michal = entity.aZtRW1;
                entity = {};
                oscard = _closure2_slot3;
                entity['username'] = oscard;
                oscard = {};
                golfie = 'bindUserMenu';
                oscard['action'] = golfie;
                ...
                option = 'username';
                golfie = null;
                if(!(option === verify)) { _fun00002_ip = 112; continue _fun00001 }
 108:
                golfie = _closure2_slot4;
 112:
                oscard['linkColor'] = golfie;
                report = _closure2_slot1;
                golfie = report.channel_id;
                oscard['messageChannelId'] = golfie;
                golfie = true;
                oscard['medium'] = golfie;
    ...
    michal = function(argFoo) { // Original name: createStageStartSystemMessage
        _fun00003: for(var _fun00004_ip = 0; ; ) switch(_fun00004_ip) {
 0:
            tangon = argFoo;
            verify = tangon.message;
            output = tangon.roleStyle;
 ...
 207:
    ...
    zuuluu['createStageStartSystemMessage'] = michal;
    return entity;
})();