...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
            ...
            report = mike == entity;
            foxtrot = undefined;
            if(report) { _fun72331_ip = 156; continue _fun72331 }
 146:
 ...
 0:
                    ...
                    mike = null;
                    entity = mike != entity;
                    if(!entity) { _fun72334_ip = 61; continue _fun72334 }
 16:
                    ...
                    tango = mike == zulu;
                    mike = undefined;
                    if(tango) { _fun72334_ip = 58; continue _fun72334 }
 52:
                    mike = zulu.isPending;
 58:
                    entity = mike;
 ...
 0:
                    ...
                    zulu = null;
                    zulu = zulu != tango;
                    if(!zulu) { _fun72335_ip = 58; continue _fun72335 }
 18:
 ...
 58:
            ...
            mike = mike != golf;
            if(!mike) { _fun72331_ip = 387; continue _fun72331 }
 336:
            verify = _closure1_slot0;
 ...
 387:
            zulu = zulu.author;
            zulu = zulu.bot;
            if(!entity) { _fun72331_ip = 405; continue _fun72331 }
 402:
            entity = !report;
 405:
            if(!entity) { _fun72331_ip = 411; continue _fun72331 }
 408:
            entity = !tango;
 411:
            if(!entity) { _fun72331_ip = 417; continue _fun72331 }
 414:
            entity = !zulu;
 417:
            if(!entity) { _fun72331_ip = 423; continue _fun72331 }
 420:
            entity = mike;
 423:
            return entity;
 ...
 0:
            ...
            zulu = null;
            tango = zulu != report;
            if(!tango) { _fun72337_ip = 73; continue _fun72337 }
 31:
            ...
            oscar = zulu == report;
            zulu = undefined;
            if(oscar) { _fun72337_ip = 70; continue _fun72337 }
 64:
 ...
 73:
            ...
            zulu = zulu.author;
            zulu = zulu.bot;
            if(!entity) { _fun72337_ip = 153; continue _fun72337 }
 150:
            entity = !report;
 153:
            if(!entity) { _fun72337_ip = 159; continue _fun72337 }
 156:
            entity = !tango;
 159:
            if(!entity) { _fun72337_ip = 165; continue _fun72337 }
 162:
            entity = !zulu;
 165:
            if(!entity) { _fun72337_ip = 171; continue _fun72337 }
 168:
            entity = mike;
 171:
            return entity;
