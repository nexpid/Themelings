...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
            ...
            zulu = new Array(0);
            offset = yankee.bind(romeo)(offset, verify, zulu);
            ...
            report = romeo.messageReference;
            zulu = null;
            golf = zulu == report;
            verify = undefined;
            if(golf) { _fun72443_ip = 157; continue _fun72443 }
 152:
 ...
 157:
            ...
            golf = zulu == report;
            options = undefined;
            if(golf) { _fun72443_ip = 231; continue _fun72443 }
 226:
            options = report.name;
 231:
            if(!(zulu == options)) { _fun72443_ip = 240; continue _fun72443 }
 235:
 ...
 0:
                    ...
                    report['colorString'] = golf;
                    offset = _closure2_slot0;
                    verify = null;
                    options = 'username';
                    golf = null;
                    if(!(options === offset)) { _fun72446_ip = 130; continue _fun72446 }
 126:
                    golf = _closure2_slot3;
 130:
                    report['linkColor'] = golf;
                    golf = _closure2_slot3;
                    report['roleColor'] = golf;
                    options = _closure2_slot0;
                    golf = 'dot';
                    golf = golf === options;
                    if(!golf) { _fun72446_ip = 167; continue _fun72446 }
 159:
                    options = _closure2_slot3;
                    golf = verify != options;
 167:
                    report['shouldShowRoleDot'] = golf;
                    golf = _closure2_slot1;
                    golf = golf.channel_id;
                    report['messageChannelId'] = golf;
                    golf = true;
                    report['medium'] = golf;
                    entity['actorHook'] = report;
                    report = _closure2_slot5;
                    entity['threadName'] = report;
                    report = {'action': 'bindOpenThreadChannel', 'threadId': null, 'medium': true};
                    oscar = _closure2_slot4;
                    report['threadId'] = oscar;
                    entity['threadOnClick'] = report;
 ...
 0:
            ...
            golf = yankee.messageReference;
            offset = null;
            options = offset == golf;
            entity = undefined;
            if(options) { _fun72447_ip = 93; continue _fun72447 }
 88:
 ...
 93:
            ...
            oscar = report.veX9jo;
            report = {};
            report['actorName'] = verify;
            verify = {};
            foxtrot = 'bindUserMenu';
            verify['action'] = foxtrot;
            foxtrot = yankee.author;
            foxtrot = foxtrot.id;
            verify['userId'] = foxtrot;
            verify['colorString'] = backup;
            sizing = 'username';
            foxtrot = null;
            if(!(sizing === kilo)) { _fun72447_ip = 203; continue _fun72447 }
 200:
            foxtrot = backup;
 203:
            verify['linkColor'] = foxtrot;
            verify['roleColor'] = backup;
            foxtrot = 'dot';
            foxtrot = foxtrot === kilo;
            if(!foxtrot) { _fun72447_ip = 228; continue _fun72447 }
 224:
            foxtrot = offset != backup;
 228:
            verify['shouldShowRoleDot'] = foxtrot;
            foxtrot = yankee.channel_id;
            verify['messageChannelId'] = foxtrot;
            foxtrot = true;
            verify['medium'] = foxtrot;
            report['actorHook'] = verify;
            foxtrot = offset == romeo;
            verify = undefined;
            if(foxtrot) { _fun72447_ip = 269; continue _fun72447 }
 264:
            verify = romeo.name;
 269:
            if(!(offset == verify)) { _fun72447_ip = 278; continue _fun72447 }
 273:
 ...
 278:
            ...
            romeo = offset == yankee;
            offset = undefined;
            if(romeo) { _fun72447_ip = 317; continue _fun72447 }
 312:
 ...
 317:
            ...
            output = mike.bind(zulu)(tango);
            result = entity;
            mike = copyDataProperties(result, output);
            return entity;
        }
    };
    zulu['createNewThreadSystemMessage'] = mike;
    return entity;
})();