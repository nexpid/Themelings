...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
    ...
    tangon = 'modules/messages/native/renderer/system_messages/StageSpeakerSystemMessage.tsx';
    tangon = report.bind(oscard)(tangon);
    tangon = function(argFoo) { // Original name: StageSpeakerSystemMessage
        entity = argFoo;
        oscard = entity.row;
 ...
 112:
    ...
    michal = function(argFoo) { // Original name: createStageSpeakerSystemMessage
 ...
 207:
    ...
    zuuluu['createStageSpeakerSystemMessage'] = michal;
    return entity;
})();