...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
    ...
    tangon = 'modules/messages/native/renderer/system_messages/StageEndSystemMessage.tsx';
    tangon = report.bind(oscard)(tangon);
    tangon = function(argFoo) { // Original name: StageEndSystemMessage
        entity = argFoo;
        oscard = entity.row;
 ...
 112:
    ...
    michal = function(argFoo) { // Original name: createStageEndSystemMessage
 ...
 201:
    ...
    zuuluu['createStageEndSystemMessage'] = michal;
    return entity;
})();