...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
            ...
            entity = null;
            if(!(entity != tango)) { _fun71957_ip = 771; continue _fun71957 }
 224:
            if(!(entity != echo)) { _fun71957_ip = 771; continue _fun71957 }
 231:
            if(!(entity != mike)) { _fun71957_ip = 771; continue _fun71957 }
 238:
            if(!(entity != control)) { _fun71957_ip = 771; continue _fun71957 }
 245:
            zulu = _closure1_slot1;
            yankee = _closure1_slot2;
            mike = 18;
            ...
            foxtrot = yankee.intl;
            if(tango) { _fun71957_ip = 405; continue _fun71957 }
 331:
            if(mike) { _fun71957_ip = 373; continue _fun71957 }
 334:
            ...
            _fun71957_ip = 403; continue _fun71957;
 373:
 ...
 403:
            _fun71957_ip = 442; continue _fun71957;
 405:
 ...
 442:
            zulu = '';
            foxtrot = zulu;
            if(tango) { _fun71957_ip = 510; continue _fun71957 }
 452:
            foxtrot = zulu;
            if(mike) { _fun71957_ip = 510; continue _fun71957 }
 458:
            verify = _closure1_slot0;
 ...
 0:
                    ...
                    zulu = entity != zulu;
                    entity = undefined;
                    if(!zulu) { _fun71961_ip = 40; continue _fun71961 }
 18:
 ...
 40:
            ...
            tango = null;
            zulu = tango != options;
            if(!zulu) { _fun71959_ip = 137; continue _fun71959 }
 127:
            golf = options.isDM;
 ...
 137:
            ...
            golf = tango != entity;
            entity = null;
            if(!golf) { _fun71959_ip = 187; continue _fun71959 }
 152:
            entity = null;
            if(!zulu) { _fun71959_ip = 187; continue _fun71959 }
 157:
            zulu = tango != oscar;
            entity = null;
            if(!zulu) { _fun71959_ip = 187; continue _fun71959 }
 ...
 0:
            ...
            entity = tango.author;
            status = null;
            if(!(status != entity)) { _fun71962_ip = 398; continue _fun71962 }
 21:
 ...
 34:
            ...
            tango = status != offset;
            if(!tango) { _fun71962_ip = 380; continue _fun71962 }
 370:
            verify = offset.isDM;
 ...
 380:
            ...
            if(tango) { _fun71962_ip = 402; continue _fun71962 }
 398:
            tango = undefined;
            return tango;
 402:
            ...
            romeo = status == sierra;
            entity = undefined;
            if(romeo) { _fun71962_ip = 604; continue _fun71962 }
 598:
 ...
 604:
            ...
            entity = undefined;
            if(sizing) { _fun71962_ip = 634; continue _fun71962 }
 628:
            entity = sierra.referrer_id;
 634:
            entity = verify.bind(yankee)(entity);
            if(!(status != romeo)) { _fun71962_ip = 2382; continue _fun71962 }
 646:
            if(!(status != entity)) { _fun71962_ip = 2382; continue _fun71962 }
 653:
            ...
            if(!(status != sierra)) { _fun71962_ip = 2269; continue _fun71962 }
 785:
            ...
            update = status == echo;
            yankee = undefined;
            if(update) { _fun71962_ip = 836; continue _fun71962 }
 831:
            yankee = echo.id;
 836:
            yankee = output === yankee;
            if(!yankee) { _fun71962_ip = 846; continue _fun71962 }
 843:
            yankee = sizing;
 846:
            ...
            update = sizing;
            if(sizing) { _fun71962_ip = 913; continue _fun71962 }
 883:
            romeo = romeo.id;
            update = sizing;
            if(!(romeo === backup)) { _fun71962_ip = 913; continue _fun71962 }
 895:
 ...
 913:
            ...
            romeo = undefined;
            backup = undefined;
            if(!output) { _fun71962_ip = 1378; continue _fun71962 }
 976:
            romeo = undefined;
            backup = undefined;
            if(sizing) { _fun71962_ip = 1378; continue _fun71962 }
 986:
            romeo = undefined;
            backup = undefined;
            if(update) { _fun71962_ip = 1378; continue _fun71962 }
 996:
            romeo = undefined;
            backup = undefined;
            if(source) { _fun71962_ip = 1378; continue _fun71962 }
 1006:
            sequence = global;
            ...
            papa = echo / output;
            output = 1;
            if(!(!(papa < output))) { _fun71962_ip = 1146; continue _fun71962 }
 1067:
            ...
            _fun71962_ip = 1213; continue _fun71962;
 1146:
 ...
 1213:
            ...
            lima = undefined;
            if(equality) { _fun71962_ip = 1300; continue _fun71962 }
 1294:
 ...
 1300:
            ...
            lima = status == sierra;
            status = undefined;
            if(lima) { _fun71962_ip = 1326; continue _fun71962 }
 1320:
 ...
 1326:
            ...
            romeo = echo;
 1378:
            if(!update) { _fun71962_ip = 1514; continue _fun71962 }
 1384:
            if(entity) { _fun71962_ip = 1514; continue _fun71962 }
 1390:
            if(source) { _fun71962_ip = 1514; continue _fun71962 }
 1393:
            echo = _closure1_slot0;
            ...
            echo = undefined;
            _fun71962_ip = 1874; continue _fun71962;
 1514:
            if(update) { _fun71962_ip = 1813; continue _fun71962 }
 1520:
            if(!sizing) { _fun71962_ip = 1585; continue _fun71962 }
 1523:
            if(source) { _fun71962_ip = 1585; continue _fun71962 }
 1526:
            ...
            _fun71962_ip = 1874; continue _fun71962;
 1585:
            if(yankee) { _fun71962_ip = 1721; continue _fun71962 }
 1591:
            if(source) { _fun71962_ip = 1721; continue _fun71962 }
 1597:
            if(entity) { _fun71962_ip = 1721; continue _fun71962 }
 1600:
            control = _closure1_slot0;
 ...
 1874:
            sizing = !sizing;
            if(!sizing) { _fun71962_ip = 1883; continue _fun71962 }
 1880:
            sizing = !update;
 1883:
            if(!sizing) { _fun71962_ip = 1889; continue _fun71962 }
 1886:
            sizing = yankee;
 1889:
            if(!sizing) { _fun71962_ip = 1895; continue _fun71962 }
 1892:
            sizing = !entity;
 1895:
            yankee = {};
            ...
            yankee[romeo] = sizing;
            entity = yankee;
            if(!sizing) { _fun71962_ip = 2267; continue _fun71962 }
 1990:
            report = {};
            variable36 = report;
            quebec = yankee;
 ...
 0:
            ...
            zulu = mike.author;
            entity = null;
            if(!(entity != zulu)) { _fun71965_ip = 173; continue _fun71965 }
 21:
 ...
 34:
            ...
            mike = entity != oscar;
            if(!mike) { _fun71965_ip = 151; continue _fun71965 }
 141:
            zulu = oscar.isDM;
 ...
 151:
            ...
            if(!mike) { _fun71965_ip = 173; continue _fun71965 }
 169:
            if(!(entity == verify)) { _fun71965_ip = 177; continue _fun71965 }
 173:
            mike = undefined;
            return mike;
 177:
            ...
            if(!(entity != source)) { _fun71965_ip = 814; continue _fun71965 }
 226:
            if(!(entity != control)) { _fun71965_ip = 814; continue _fun71965 }
 233:
            zulu = _closure1_slot1;
            yankee = _closure1_slot2;
            mike = 18;
            ...
            result = zulu.intl;
            if(oscar) { _fun71965_ip = 420; continue _fun71965 }
 319:
            if(mike) { _fun71965_ip = 388; continue _fun71965 }
 322:
            ...
            _fun71965_ip = 418; continue _fun71965;
 388:
 ...
 418:
            _fun71965_ip = 484; continue _fun71965;
 420:
 ...
 484:
            zulu = '';
            yankee = zulu;
            if(oscar) { _fun71965_ip = 552; continue _fun71965 }
 494:
            yankee = zulu;
            if(mike) { _fun71965_ip = 552; continue _fun71965 }
 500:
            verify = _closure1_slot0;
            mike = _closure1_slot2;
            zulu = mike[sizing];
