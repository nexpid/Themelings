...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
 ...
 0:
            ...
            options = undefined;
            if(!(options === mike)) { _fun69354_ip = 52; continue _fun69354 }
 32:
            mike = entity.contentScanVersion;
            report = undefined;
            if(!(report !== mike)) { _fun69354_ip = 50; continue _fun69354 }
 44:
            report = entity.contentScanVersion;
 50:
            _fun69354_ip = 58; continue _fun69354;
 52:
            report = entity.content_scan_version;
 58:
            mike = tango;
            if(!tango) { _fun69354_ip = 98; continue _fun69354 }
 64:
 ...
 98:
            zulu = options !== offset;
            if(!zulu) { _fun69354_ip = 150; continue _fun69354 }
 105:
 ...
 150:
            if(!tango) { _fun69354_ip = 185; continue _fun69354 }
 153:
            verify = _closure1_slot2;
            report = verify.get;
            entity = 'obscure_blur_effect_enabled';
            entity = report.bind(verify)(entity);
            if(entity) { _fun69354_ip = 182; continue _fun69354 }
 179:
            entity = zulu;
 182:
            tango = entity;
 185:
            entity = {};
            zulu = oscar;
            if(!zulu) { _fun69354_ip = 199; continue _fun69354 }
 193:
            report = true;
            zulu = report === golf;
 199:
            ...
            zulu = '';
            report = zulu;
            if(!oscar) { _fun69354_ip = 291; continue _fun69354 }
 214:
            oscar = true;
            report = zulu;
            if(!(oscar === golf)) { _fun69354_ip = 291; continue _fun69354 }
 223:
 ...
 291:
            ...
            if(!tango) { _fun69354_ip = 362; continue _fun69354 }
 304:
 ...
 0:
            ...
            mike = !mike;
            if(!mike) { _fun69355_ip = 81; continue _fun69355 }
 45:
 ...
 81:
            if(!golf) { _fun69355_ip = 87; continue _fun69355 }
 84:
            golf = entity;
 87:
            ...
            oscar = null;
            if(!golf) { _fun69355_ip = 233; continue _fun69355 }
 168:
            yankee = _closure1_slot0;
            romeo = _closure1_slot1;
            golf = 4;
 ...
 233:
            ...
            zulu = null;
            if(!report) { _fun69355_ip = 303; continue _fun69355 }
 248:
            golf = _closure1_slot0;
            verify = _closure1_slot1;
            tango = 4;
