...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
 ...
 0:
            ...
            options = null;
            entity = options != zulu;
            if(!entity) { _fun61116_ip = 248; continue _fun61116 }
 18:
            mike = yankee.author;
            mike = mike.id;
            mike = mike === zulu;
            if(!mike) { _fun61116_ip = 245; continue _fun61116 }
 39:
            tango = yankee.state;
            zulu = _closure1_slot4;
            zulu = zulu.SENT;
            zulu = tango === zulu;
            if(!zulu) { _fun61116_ip = 242; continue _fun61116 }
 67:
            ...
            tango = !tango;
            if(!tango) { _fun61116_ip = 239; continue _fun61116 }
 103:
            ...
            oscar = !report;
            report = !oscar;
            if(oscar) { _fun61116_ip = 236; continue _fun61116 }
 143:
            golf = yankee.hasFlag;
            ...
            oscar = !oscar;
            if(!oscar) { _fun61116_ip = 233; continue _fun61116 }
 170:
            golf = yankee.referralTrialOfferId;
            golf = options == golf;
            if(!golf) { _fun61116_ip = 230; continue _fun61116 }
 183:
            options = yankee.isPoll;
            options = options.bind(yankee)();
            options = !options;
            if(!options) { _fun61116_ip = 227; continue _fun61116 }
 199:
