// app/modules/messages/AnnouncementViewTrackingExperiment.tsx
export default (function(_, argBar, __, ___, ____, argFre, argPlu) {
    ...
    michal = {'kind': 'user', 'id': '2023-07_announcement_views', 'label': 'Announcement Views'};
    tangon = {};
    verify = false;
    ...
    tangon = 'modules/messages/AnnouncementViewTrackingExperiment.tsx';
