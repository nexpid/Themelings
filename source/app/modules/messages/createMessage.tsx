...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
 ...
 0:
            ...
            options = verify.tts;
            echo = undefined;
            if(!(options === echo)) { _fun71509_ip = 27; continue _fun71509 }
 25:
            options = false;
 27:
            kilo = verify.type;
            if(!(kilo === echo)) { _fun71509_ip = 49; continue _fun71509 }
 36:
 ...
 49:
            ...
            yankee = yankee.REPLY;
            if(!(kilo === yankee)) { _fun71509_ip = 249; continue _fun71509 }
 125:
            ...
            if(!(yankee != entity)) { _fun71509_ip = 176; continue _fun71509 }
 167:
            entity = entity.replied_user;
            if(!entity) { _fun71509_ip = 249; continue _fun71509 }
 176:
            ...
            output = undefined;
            if(yankee) { _fun71509_ip = 205; continue _fun71509 }
 200:
            output = entity.state;
 205:
            yankee = _closure1_slot4;
            yankee = yankee.LOADED;
            if(!(output === yankee)) { _fun71509_ip = 249; continue _fun71509 }
 219:
            yankee = romeo.push;
 ...
 249:
            output = null;
            if(!(output == sizing)) { _fun71509_ip = 268; continue _fun71509 }
 255:
 ...
 268:
            ...
            yankee = sizing;
            if(!entity) { _fun71509_ip = 291; continue _fun71509 }
 282:
 ...
 291:
            ...
            entity = {};
            sizing = report;
            if(!(output == sizing)) { _fun71509_ip = 366; continue _fun71509 }
 336:
 ...
 366:
            ...
            if(verify) { _fun71509_ip = 496; continue _fun71509 }
 486:
 ...
 0:
            ...
            entity = {};
            report = null;
            if(!(report == tango)) { _fun71510_ip = 73; continue _fun71510 }
 38:
 ...
 73:
            ...
            if(!(report == zulu)) { _fun71510_ip = 168; continue _fun71510 }
 164:
            zulu = new Array(0);
 168:
            entity['embeds'] = zulu;
