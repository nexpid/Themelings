...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
 ...
 0:
            ...
            if(entity) { _fun60019_ip = 51; continue _fun60019 }
 38:
            entity = verify.apply;
            entity = entity.bind(verify)(tango, oscar);
            _fun60019_ip = 92; continue _fun60019;
 51:
            golf = global;
            options = golf.Reflect;
            golf = options.construct;
            if(oscar) { _fun60019_ip = 71; continue _fun60019 }
 67:
            oscar = new Array(0);
 71:
 ...
 70: // try_end0
            _fun60020_ip = 74; continue _fun60020;
 72: // catch_target0
 ...
 0:
            ...
            report = null;
            if(!(report != tango)) { _fun60023_ip = 324; continue _fun60023 }
 26:
            zulu = _closure1_slot5;
            entity = zulu.getChannel;
            entity = entity.bind(zulu)(tango);
            if(!(report != entity)) { _fun60023_ip = 324; continue _fun60023 }
 47:
            zulu = entity.guild_id;
            if(!(report != zulu)) { _fun60023_ip = 324; continue _fun60023 }
 59:
            zulu = entity.guild_id;
            oscar = _closure1_slot10;
            oscar = oscar[tango];
            if(!(report == oscar)) { _fun60023_ip = 86; continue _fun60023 }
 76:
 ...
 86:
            ...
            if(oscar) { _fun60023_ip = 328; continue _fun60023 }
 102:
            golf = _closure1_slot7;
            oscar = golf.isOptInEnabled;
            oscar = oscar.bind(golf)(zulu);
            if(!oscar) { _fun60023_ip = 147; continue _fun60023 }
 120:
            golf = _closure1_slot7;
            oscar = golf.isChannelOrParentOptedIn;
            entity = entity.id;
            entity = oscar.bind(golf)(zulu, entity);
            if(!entity) { _fun60023_ip = 328; continue _fun60023 }
 147:
            oscar = _closure1_slot10;
            entity = oscar[tango];
            entity = entity + 1;
            ...
            entity = entity[zulu];
            if(!(report == entity)) { _fun60023_ip = 210; continue _fun60023 }
 174:
 ...
 210:
            ...
            if(entity) { _fun60023_ip = 306; continue _fun60023 }
 229:
            entity = _closure1_slot9;
            entity = entity[zulu];
            if(!(report != entity)) { _fun60023_ip = 264; continue _fun60023 }
 241:
            entity = _closure1_slot9;
            oscar = entity[zulu];
            entity = oscar.has;
            ...
            entity = undefined;
            if(oscar) { _fun60023_ip = 304; continue _fun60023 }
 264:
            oscar = _closure1_slot10;
            golf = oscar[tango];
            oscar = 50;
 ...
 328:
            ...
            if(!entity) { _fun60023_ip = 369; continue _fun60023 }
 351:
 ...
 90:
                    ...
                    if(!(zulu == romeo)) { _fun60026_ip = 157; continue _fun60026 }
 131:
                    kilo = tango.Set;
 ...
 157:
                    ...
                    _fun60026_ip = 81; continue _fun60026;
                }
 163:
                if(!(zulu != offset)) { _fun60026_ip = 262; continue _fun60026 }
 167:
                options = offset;
                tango = global;
                for(report in options)
 ...
 189:
                    ...
                    if(!(zulu == yankee)) { _fun60026_ip = 256; continue _fun60026 }
 230:
                    backup = tango.Set;
 ...
 256:
                    ...
                    _fun60026_ip = 180; continue _fun60026;
                }
 262:
                if(!(zulu == entity)) { _fun60026_ip = 268; continue _fun60026 }
 266:
                entity = {};
 268:
 ...
 0:
            ...
            report = tango[mike];
            tango = null;
            if(!(tango == report)) { _fun60029_ip = 66; continue _fun60029 }
 30:
