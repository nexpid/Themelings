// app/modules/chat_input/native/guard/ChatInputGuard.tsx
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
            ...
            mike = {};
            zulu = undefined;
            if(!tango) { _fun101490_ip = 111; continue _fun101490 }
 83:
 ...
 111:
            ...
            zulu = undefined;
            if(!tango) { _fun101490_ip = 124; continue _fun101490 }
 120:
            zulu = 'hidden';
 124:
            mike['overflow'] = zulu;
            ...
            options = options.BACKGROUND_PRIMARY;
            ...
            yankee = golf.absoluteFillObject;
            romeo = mike;
            golf = copyDataProperties(romeo, yankee);
            golf = 'top';
            mike[golf] = report;
            entity['underlay'] = mike;
            mike = {};
            golf = zulu[oscar];
            golf = tango.bind(report)(golf);
            golf = golf.colors;
            golf = golf.BORDER_FAINT;
    ...
    tango = 'modules/chat_input/native/guard/ChatInputGuard.tsx';
    tango = report.bind(oscar)(tango);
    tango = function(argFoo) { // Original name: ChatInputGuard
 ...
 0:
            ...
            zulu = entity.type;
            mike = 'simple-action';
            if(!(mike !== zulu)) { _fun101491_ip = 635; continue _fun101491 }
 59:
            offset = entity.message;
            backup = entity.subtext;
            foxtrot = entity.buttonPrimaryText;
            yankee = entity.buttonPrimaryOnPress;
            sizing = entity.buttonPrimaryDisabled;
            kilo = entity.buttonPrimaryLoading;
            report = entity.buttonPrimaryVariant;
            sequence = entity.buttonSecondaryText;
            vacuum = entity.buttonSecondaryOnPress;
            record = entity.buttonSecondaryDisabled;
            config = entity.buttonSecondaryLoading;
            romeo = entity.countdown;
            ...
            mike['size'] = control;
            mike['variant'] = report;
            source = verify.bind(tango)(zulu, mike);
            ...
            verify = null;
            if(!offset) { _fun101491_ip = 373; continue _fun101491 }
 282:
            yankee = 'string';
            offset = typeof backup;
            verify = null;
            if(!(yankee === offset)) { _fun101491_ip = 373; continue _fun101491 }
 295:
 ...
 311:
            ...
            yankee = offset.Text;
            offset = {'style': null, 'variant': 'text-xs/medium', 'color': 'text-muted'};
            kilo = result.subtext;
            offset['style'] = kilo;
 ...
 373:
            ...
            verify = {};
            foxtrot = source;
            if(!(options != sequence)) { _fun101491_ip = 533; continue _fun101491 }
 416:
            foxtrot = source;
            if(!(options != vacuum)) { _fun101491_ip = 533; continue _fun101491 }
 423:
 ...
 533:
            ...
            options = null;
            if(!verify) { _fun101491_ip = 619; continue _fun101491 }
 556:
            yankee = _closure1_slot6;
            ...
            foxtrot = new Array(2);
            foxtrot[0] = backup;
            backup = result.spacing;
            foxtrot[1] = backup;
            verify['style'] = foxtrot;
            verify['deadline'] = romeo;
 ...
 635:
            ...
            report = entity.subtext;
            foxtrot = entity.actionIcon;
            kilo = entity.actionLabel;
            romeo = entity.actionOnPress;
            ...
            entity = {'arrow': false, 'accessibilityRole': 'button', 'onPress': null, 'icon': null, 'start': true, 'end': true};
            entity['onPress'] = romeo;
            entity['icon'] = golf;
            backup = null;
            if(!(backup != kilo)) { _fun101491_ip = 741; continue _fun101491 }
 737:
            if(!(backup == romeo)) { _fun101491_ip = 815; continue _fun101491 }
 741:
            options = backup != sizing;
            golf = null;
            if(!options) { _fun101491_ip = 813; continue _fun101491 }
 750:
            yankee = _closure1_slot6;
            offset = _closure1_slot1;
 ...
 813:
            _fun101491_ip = 915; continue _fun101491;
 815:
            yankee = _closure1_slot6;
            offset = _closure1_slot0;
            ...
            if(!(backup == foxtrot)) { _fun101491_ip = 893; continue _fun101491 }
 855:
 ...
 915:
    ...
    zulu['default'] = tango;
    mike = function(argFoo) { // Original name: ChatInputGuardContainer
 ...
 0:
            ...
            mike = function(argFoo) {
                ...
                zulu = tango.updateChatInputContainerHeight;
                mike = mike.height;
                mike = zulu.bind(tango)(mike);
                return entity;
            };
            ...
            oscar = null;
            if(romeo) { _fun101492_ip = 136; continue _fun101492 }
 110:
            options = _closure1_slot6;
            golf = _closure1_slot5;
            report = {};
            backup = foxtrot.underlay;
            report['style'] = backup;
 ...
 136:
            ...
            oscar['style'] = foxtrot;
            yankee = null;
            if(!romeo) { _fun101492_ip = 212; continue _fun101492 }
 168:
            foxtrot = _closure1_slot6;
 ...
 212:
    ...
    zulu['ChatInputGuardContainer'] = mike;
    return entity;
})();