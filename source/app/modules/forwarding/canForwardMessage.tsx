...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
            ...
            entity = mike !== entity;
            if(!entity) { _fun72645_ip = 182; continue _fun72645 }
 31:
            ...
            zulu = !mike;
            mike = !zulu;
            if(zulu) { _fun72645_ip = 179; continue _fun72645 }
 65:
            zulu = options.poll;
            verify = null;
            zulu = verify == zulu;
            if(!zulu) { _fun72645_ip = 176; continue _fun72645 }
 80:
            tango = options.activity;
            tango = verify == tango;
            if(!tango) { _fun72645_ip = 173; continue _fun72645 }
 93:
            report = options.call;
            report = verify == report;
            if(!report) { _fun72645_ip = 170; continue _fun72645 }
 105:
            oscar = options.activityInstance;
            oscar = verify == oscar;
            if(!oscar) { _fun72645_ip = 167; continue _fun72645 }
 118:
 ...
 0:
            ...
            if(entity) { _fun72646_ip = 24; continue _fun72646 }
 20:
            entity = false;
            return entity;
 24:
            ...
            oscar = entity == tango;
            report = undefined;
            if(oscar) { _fun72646_ip = 59; continue _fun72646 }
 54:
            report = tango.guild_id;
 59:
            entity = entity == report;
            if(entity) { _fun72646_ip = 90; continue _fun72646 }
 66:
 ...
 0:
                ...
                mike = null;
                if(!(mike != entity)) { _fun72648_ip = 153; continue _fun72648 }
 16:
                oscar = _closure1_slot4;
                ...
                golf = mike == report;
                oscar = undefined;
                if(golf) { _fun72648_ip = 56; continue _fun72648 }
 51:
                oscar = report.guild_id;
 56:
                report = mike == oscar;
                if(report) { _fun72648_ip = 110; continue _fun72648 }
 63:
                ...
                golf = mike == verify;
                entity = undefined;
                if(golf) { _fun72648_ip = 107; continue _fun72648 }
 86:
 ...
 110:
                entity = !report;
                if(!report) { _fun72648_ip = 151; continue _fun72648 }
 116:
                mike = mike != oscar;
                if(!mike) { _fun72648_ip = 148; continue _fun72648 }
 123:
 ...
 0:
                ...
                entity = !entity;
                if(!entity) { _fun72649_ip = 23; continue _fun72649 }
 13:
                tango = _closure2_slot0;
                zulu = null;
                entity = zulu != tango;
 23:
                if(!entity) { _fun72649_ip = 44; continue _fun72649 }
 26:
