...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
 ...
 0:
            ...
            oscar = report == zulu;
            tango = undefined;
            if(oscar) { _fun102200_ip = 56; continue _fun102200 }
 50:
 ...
 56:
            ...
            golf = report == zulu;
            oscar = undefined;
            if(golf) { _fun102200_ip = 75; continue _fun102200 }
 69:
 ...
 75:
            ...
            verify = report == golf;
            zulu = undefined;
            if(verify) { _fun102200_ip = 105; continue _fun102200 }
 100:
            zulu = golf.message;
 105:
            if(!(report != zulu)) { _fun102200_ip = 112; continue _fun102200 }
 109:
            yankee = zulu;
 112:
            golf = yankee.attachments;
            if(!(report == tango)) { _fun102200_ip = 132; continue _fun102200 }
 122:
            if(!(report != oscar)) { _fun102200_ip = 155; continue _fun102200 }
 126:
            golf = new Array(0);
            _fun102200_ip = 155; continue _fun102200;
 132:
 ...
 0:
                    ...
                    entity = null;
                    entity = entity != zulu;
                    if(!entity) { _fun102202_ip = 64; continue _fun102202 }
 16:
                    ...
                    entity = !zulu;
 64:
                    if(!entity) { _fun102202_ip = 107; continue _fun102202 }
 67:
 ...
 107:
            ...
            if(verify) { _fun102200_ip = 261; continue _fun102200 }
 215:
            verify = yankee.embeds;
            if(!(report == oscar)) { _fun102200_ip = 235; continue _fun102200 }
 225:
            if(!(report != tango)) { _fun102200_ip = 233; continue _fun102200 }
 229:
            verify = new Array(0);
 233:
            _fun102200_ip = 258; continue _fun102200;
 235:
 ...
 261:
            oscar = report != oscar;
            if(oscar) { _fun102200_ip = 296; continue _fun102200 }
 268:
            offset = yankee.content;
            verify = '';
            verify = verify === offset;
            if(!verify) { _fun102200_ip = 293; continue _fun102200 }
 284:
            offset = zulu.length;
 ...
 296:
            offset = yankee;
            if(!oscar) { _fun102200_ip = 348; continue _fun102200 }
 302:
            verify = yankee.set;
            oscar = zulu.map;
 ...
 348:
            ...
            oscar = '';
            entity = oscar === entity;
            if(!entity) { _fun102200_ip = 393; continue _fun102200 }
 364:
            verify = offset.embeds;
            verify = verify[options];
            yankee = report == verify;
            mike = undefined;
            if(yankee) { _fun102200_ip = 389; continue _fun102200 }
 383:
 ...
 393:
            mike = offset;
            if(!entity) { _fun102200_ip = 430; continue _fun102200 }
 399:
            verify = offset.set;
 ...
 430:
            ...
            zulu = mike.content;
            zulu = oscar !== zulu;
            if(!zulu) { _fun102200_ip = 458; continue _fun102200 }
 454:
            zulu = report == tango;
 458:
