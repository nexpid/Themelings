...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    tango = oscar[tango];
    tango = report.bind(entity)(tango);
    golf = tango.ContentDismissActionType;
    ...
    verify = {'width': 48, 'height': 48, 'alignItems': 'center', 'justifyContent': 'center'};
    verify['backgroundColor'] = romeo;
    tango['emojiContainer'] = verify;
    verify = {};
    verify['backgroundColor'] = romeo;
    tango['addReaction'] = verify;
    verify = {};
    offset = oscar[offset];
    ...
    verify['color'] = offset;
    tango['icon'] = verify;
    verify = {'marginLeft': 6, 'marginTop': 6};
    tango['sparklingIcon'] = verify;
 ...
 0:
            ...
            entity = '';
            if(!(entity === golf)) { _fun91157_ip = 113; continue _fun91157 }
 34:
            ...
            entity = {};
            offset = options.emoji;
            verify = new Array(2);
            verify[0] = offset;
            offset = options.emojiText;
            verify[1] = offset;
            entity['style'] = verify;
            verify = false;
            ...
            _fun91157_ip = 193; continue _fun91157;
 113:
            tango = _closure1_slot10;
 ...
 193:
    ...
    tango = function(argFoo) { // Original name: AddReactionButton
 ...
 0:
            ...
            report = golf.useThemeContext;
            report = report.bind(golf)();
            report = report.theme;
            entity = oscar[entity];
            zulu = zulu.bind(tango)(entity);
            entity = zulu.isThemeLight;
            ...
            if(zulu) { _fun91158_ip = 154; continue _fun91158 }
 146:
            verify = entity.PRIMARY_300;
            _fun91158_ip = 160; continue _fun91158;
 154:
 ...
 160:
            ...
            backup = offset.t;
            if(golf) { _fun91158_ip = 361; continue _fun91158 }
 348:
            offset = backup.lfIHs7;
            offset = kilo.bind(sizing)(offset);
            _fun91158_ip = 372; continue _fun91158;
 361:
 ...
 372:
            ...
            offset = function() { // Original name: onPress
                ...
                entity = verify[entity];
                mike = undefined;
                oscar = options.bind(mike)(entity);
                report = oscar.handleAddNewReactions;
            ...
            backup = foxtrot.emojiContainer;
            offset = new Array(2);
            offset[0] = backup;
            foxtrot = foxtrot.addReaction;
            offset[1] = foxtrot;
            report['style'] = offset;
            offset = _closure1_slot10;
            if(golf) { _fun91158_ip = 436; continue _fun91158 }
 422:
            golf = {};
            golf['color'] = verify;
            golf = offset.bind(tango)(options, golf);
            _fun91158_ip = 531; continue _fun91158;
 436:
            ...
            foxtrot = foxtrot.DismissibleContent;
            backup = foxtrot.SUPER_REACTIONS_SPARKLES_ACTION_SHEET_MOBILE;
            foxtrot = new Array(1);
            foxtrot[0] = backup;
            options['contentTypes'] = foxtrot;
            romeo = _closure1_slot7;
            romeo = romeo.SUPER_REACTIONS_SPARKLES;
            options['groupName'] = romeo;
 ...
 0:
                    ...
                    entity = entity.SUPER_REACTIONS_SPARKLES_ACTION_SHEET_MOBILE;
                    if(!(tango !== entity)) { _fun91160_ip = 91; continue _fun91160 }
 62:
                    ...
                    _fun91160_ip = 183; continue _fun91160;
 91:
                    tango = global;
 ...
 531:
    ...
    tango = function(argFoo) { // Original name: AddEmojiButton
 ...
 0:
            ...
            output = romeo == sizing;
            backup = undefined;
            if(output) { _fun91162_ip = 153; continue _fun91162 }
 148:
            backup = sizing.name;
 153:
 ...
 0:
                    ...
                    zulu = null;
                    if(!(zulu != yankee)) { _fun91163_ip = 209; continue _fun91163 }
 55:
                    offset = _closure1_slot0;
                    ...
                    mike = 12;
                    mike = tango[mike];
                    verify = offset.bind(entity)(mike);
                    options = verify.addReaction;
                    golf = report.channel_id;
                    oscar = report.id;
                    mike = 13;
                    mike = tango[mike];
                    offset = offset.bind(entity)(mike);
                    mike = offset.toReactionEmoji;
 ...
 209:
            ...
            golf = golf.emojiContainer;
            report['style'] = golf;
            options = romeo != sizing;
            golf = null;
            if(!options) { _fun91162_ip = 326; continue _fun91162 }
 206:
            offset = _closure1_slot10;
            ...
            yankee = undefined;
            if(!foxtrot) { _fun91162_ip = 235; continue _fun91162 }
 230:
            yankee = sizing.surrogates;
 235:
            options['surrogates'] = yankee;
            yankee = sizing.id;
            if(!(romeo == yankee)) { _fun91162_ip = 255; continue _fun91162 }
 248:
            yankee = sizing.url;
            _fun91162_ip = 316; continue _fun91162;
 255:
            ...
            foxtrot = backup.getEmojiURL;
            romeo = {};
            output = sizing.id;
            romeo['id'] = output;
            sizing = sizing.animated;
            romeo['animated'] = sizing;
 ...
 326:
    ...
    tango = 'modules/action_sheet/native/components/EmojiRow.tsx';
 ...
 0:
            ...
            golf = entity.bind(yankee)();
            foxtrot = _closure1_slot0;
            backup = _closure1_slot2;
            entity = 27;
            mike = backup[entity];
            zulu = foxtrot.bind(tango)(mike);
            mike = zulu.useFrequentlyUsedEmojis;
            zulu = mike.bind(zulu)(golf);
            entity = backup[entity];
            mike = foxtrot.bind(tango)(entity);
            entity = mike.useFrequentlyUsedReactionEmojis;
            entity = entity.bind(mike)(golf);
            mike = 28;
            mike = backup[mike];
            kilo = foxtrot.bind(tango)(mike);
            romeo = kilo.useCanSplitFrecencyList;
            golf = 'EmojiRow';
            result = true;
            mike = {'location': 'EmojiRow', 'autoTrackExposure': true};
            mike = romeo.bind(kilo)(mike);
            romeo = mike.canSplitFrecencyList;
            kilo = 29;
            mike = backup[kilo];
            output = foxtrot.bind(tango)(mike);
            sizing = output.useCanUseReactionFrecency;
            mike = {'location': 'EmojiRow', 'autoTrackExposure': true};
            mike = sizing.bind(output)(mike);
            kilo = backup[kilo];
            kilo = foxtrot.bind(tango)(kilo);
            output = kilo.RetriggerReactionFrecencyAlgorithmsExperiment;
            sizing = output.useExperiment;
            kilo = {};
            kilo['location'] = golf;
            golf = {};
            golf['autoTrackExposure'] = result;
            ...
            golf = new Array(0);
            golf = kilo.bind(sizing)(backup, foxtrot, golf);
            if(romeo) { _fun91164_ip = 281; continue _fun91164 }
 278:
            if(!mike) { _fun91164_ip = 284; continue _fun91164 }
 281:
            zulu = entity;
 284:
            mike = zulu.filter;
            entity = function(argFoo) {
                ...
                mike = zulu.isEmojiFilteredOrLocked;
                entity = {};
                report = argFoo;
                entity['emoji'] = report;
            ...
            entity = romeo.length;
            mike = null;
            if(!(entity < golf)) { _fun91164_ip = 331; continue _fun91164 }
 312:
            entity = romeo.push;
            entity = entity.bind(romeo)(mike);
            entity = romeo.length;
            if(entity < golf) { _fun91164_ip = 312; continue _fun91164 }
 331:
            zulu = _closure1_slot11;
            mike = _closure1_slot3;
            entity = {};
            foxtrot = oscar.emojiRow;
            oscar = new Array(2);
            oscar[0] = foxtrot;
            oscar[1] = options;
            entity['style'] = oscar;
            ...
            golf = golf - oscar;
            oscar = 0;
            golf = options.bind(romeo)(oscar, golf);
            oscar = golf.map;
 ...
 0:
                    ...
                    mike['emoji'] = oscar;
                    golf = null;
                    if(!(golf != oscar)) { _fun91167_ip = 99; continue _fun91167 }
 41:
                    golf = oscar.type;
                    ...
                    if(!(golf !== entity)) { _fun91167_ip = 91; continue _fun91167 }
 84:
                    entity = oscar.id;
                    _fun91167_ip = 96; continue _fun91167;
 91:
                    entity = oscar.surrogates;
 96:
                    report = entity;
 99:
                    entity = undefined;
