...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
    ...
    mike = function() {
        ...
        tango = function() { // Original name: ChannelReader
        ...
        zulu = function(argFoo, argBar) { // Original name: value
            ...
            mike = zulu.getManySyncUnsafe;
            zulu = mike.bind(zulu)(yankee);
            oscar = entity.performance;
            mike = oscar.now;
            ...
            result = 'synchronously loaded in ';
            sizing = 'ms (guild: ';
            backup = ', channels: ';
            romeo = ')';
            output = mike;
            kilo = yankee;
            entity = result[verify](output, sizing, kilo, backup, foxtrot, romeo, yankee);
 ...
 0:
                    ...
                    if(mike) { _fun38152_ip = 175; continue _fun38152 }
 13:
                    zulu = global;
 ...
 84:
                    ...
                    if(report) { _fun38152_ip = 172; continue _fun38152 }
 90:
                    golf = zulu.performance;
                    report = golf.now;
                    ...
                    foxtrot = ')';
                    sizing = romeo;
                    zulu = echo[verify](result, output, sizing, kilo, backup, foxtrot, romeo);
 ...
 175:
        ...
        golf = function() { // Original name: getAsync
            entity = undefined;
 ...
 0:
                    ...
                    if(tango) { _fun38155_ip = 236; continue _fun38155 }
 10:
                    oscar = undefined;
                    zulu = undefined;
                    mike = undefined;
 16: // try_start_0
                    ...
                    tango = report.channels;
                    report = tango.bind(report)();
                    mike = report;
                    tango = null;
                    if(!(tango != report)) { _fun38155_ip = 148; continue _fun38155 }
 58:
                    report = mike;
                    mike = report.getGuildIds;
 ...
 75:
                    ResumeGenerator(result_out_reg=1, return_bool_out_reg=4);
                    if(report) { _fun38155_ip = 145; continue _fun38155 }
 81:
                    zulu = mike;
                    if(!(tango == mike)) { _fun38155_ip = 94; continue _fun38155 }
 88:
                    report = new Array(0);
                    _fun38155_ip = 97; continue _fun38155;
 94:
                    report = zulu;
 97:
                    tango = report.filter;
 ...
 0:
                            ...
                            entity = null;
                            entity = entity !== mike;
                            if(!entity) { _fun38156_ip = 23; continue _fun38156 }
 12:
                            zulu = 'string';
                            mike = typeof mike;
                            entity = zulu === mike;
 ...
 236:
        ...
        oscar = function() { // Original name: getGuildIds
            entity = undefined;
    ...
    tango = 'modules/app_database/modules/channels/ChannelReader.tsx';
