...
export default (function(argFoo, argBar, argBaz, _, __, argFre, argPlu) {
 ...
 70:
    ...
    entity = function() { // Original name: experimentStoreUpdateHandler
 ...
 0:
            ...
            michal = tangon.isLibdiscoreLoaded;
            michal = michal.bind(tangon)();
            if(!michal) { _fun00010_ip = 263; continue _fun00009 }
 43:
            tangon = global;
            michal = tangon.Set;
            ...
            oscard = golfie.getExperimentCacher;
 ...
 60:
            ...
            report = null;
            if(!(report !== golfie)) { _fun00010_ip = 230; continue _fun00009 }
 147:
            option = _closure1_slot8;
            verify = option.size;
            golfie = michal.size;
            report = false;
            if(!(verify === golfie)) { _fun00010_ip = 227; continue _fun00009 }
 167:
            golfie = _closure1_slot10;
            offset = golfie.bind(entity)(option);
            option = offset.bind(entity)();
            golfie = option.done;
            report = true;
            if(golfie) { _fun00010_ip = 227; continue _fun00009 }
 190:
            romeon = option.value;
            golfie = michal.has;
            golfie = golfie.bind(michal)(romeon);
            report = false;
            if(!golfie) { _fun00010_ip = 227; continue _fun00009 }
 210:
 ...
 227:
            if(report) { _fun00010_ip = 263; continue _fun00009 }
 230:
            report = tangon.Array;
            tangon = report.from;
            report = tangon.bind(report)(michal);
            tangon = oscard.flushToCache;
 ...
 263:
    ...
    michal = function(argFoo) {
        tangon = function(argFoo) { // Original name: LibdiscoreExperimentManager
 ...
 118:
    ...
    tangon = 'modules/libdiscore/LibdiscoreExperimentManager.tsx';
