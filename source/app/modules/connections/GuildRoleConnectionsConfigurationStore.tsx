...
export default (function(argFoo, argBar, argBaz, _, __, argFre, argPlu) {
 ...
 76:
    ...
    michal = function(argFoo) {
        tangon = function() { // Original name: GuildRoleConnectionsConfigurationStore
 ...
 105:
        ...
        entity[0] = report;
        report = {};
        golfie = 'getGuildRoleConnectionsConfiguration';
        report['key'] = golfie;
    ...
    michal = 'GuildRoleConnectionsConfigurationStore';
    golfie['displayName'] = michal;
    michal = 7;
    michal = report[michal];
    romeon = oscard.bind(entity)(michal);
    michal = {};
    tangon = function(argFoo) { // Original name: GUILD_ROLE_CONNECTIONS_CONFIGURATIONS_FETCH_SUCCESS
        entity = argFoo;
    ...
    michal['GUILD_ROLE_CONNECTIONS_CONFIGURATIONS_FETCH_SUCCESS'] = tangon;
    ...
    tangon = 'modules/connections/GuildRoleConnectionsConfigurationStore.tsx';
