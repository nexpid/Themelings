...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
 ...
 117:
                ...
                ctrled = null;
                if(!entity) { _fun00006_ip = 156; continue _fun00005 }
 126:
 ...
 223:
                ...
                romeon = undefined;
                if(!entity) { _fun00006_ip = 360; continue _fun00005 }
 235:
                zuuluu = _closure1_slot16;
 ...
 414:
                ...
                backup = null;
                if(!yankee) { _fun00006_ip = 624; continue _fun00005 }
 458:
                ...
                record = echoed.icon;
                if(update) { _fun00006_ip = 563; continue _fun00005 }
 555:
                update = record.lightPNG;
                _fun00006_ip = 569; continue _fun00005;
 563:
 ...
 624:
                ...
                backup = null;
                if(!kiloes) { _fun00006_ip = 724; continue _fun00005 }
 641:
 ...
 724:
                ...
                sizing = undefined;
                if(update) { _fun00006_ip = 785; continue _fun00005 }
 780:
                sizing = echoed.name;
 785:
                if(!(output == sizing)) { _fun00006_ip = 806; continue _fun00005 }
 789:
                echoed = output == result;
                output = undefined;
                if(echoed) { _fun00006_ip = 803; continue _fun00005 }
 798:
                output = result.name;
 803:
                sizing = output;
 806:
    ...
    option['popoutCheckIcon'] = yankee;
    yankee = {'width': '100%', 'marginBottom': 24};
    option['popoutChecksGroup'] = yankee;
    ...
    option['popoutChecksGroupBottomMargin'] = yankee;
    yankee = {'flexDirection': 'row', 'alignItems': 'center'};
    option['popoutCheckGroupName'] = yankee;
    yankee = {};
    yankee['marginRight'] = foxtra;
    option['popoutCheckGroupPlatformIcon'] = yankee;
    yankee = {};
    yankee['marginBottom'] = foxtra;
    option['button'] = yankee;
    yankee = {};
