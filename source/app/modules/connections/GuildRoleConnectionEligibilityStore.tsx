...
export default (function(argFoo, argBar, argBaz, _, __, argFre, argPlu) {
 ...
 76:
    ...
    michal = function(argFoo) {
        tangon = function() { // Original name: GuildRoleConnectionEligibilityStore
            report = this;
            tangon = undefined;
            entity = undefined;
        ...
        report = {};
        oscard = 'getGuildRoleConnectionEligibility';
        report['key'] = oscard;
 ...
 31:
    ...
    michal = 'GuildRoleConnectionEligibilityStore';
    golfie['displayName'] = michal;
    michal = 6;
    michal = report[michal];
    romeon = oscard.bind(entity)(michal);
    michal = {};
    tangon = function(argFoo) { // Original name: GUILD_ROLE_CONNECTION_ELIGIBILITY_FETCH_SUCCESS
        entity = argFoo;
        tangon = entity.roleId;
        zuuluu = entity.roleConnectionEligibility;
    ...
    michal['GUILD_ROLE_CONNECTION_ELIGIBILITY_FETCH_SUCCESS'] = tangon;
    ...
    tangon = 'modules/connections/GuildRoleConnectionEligibilityStore.tsx';
