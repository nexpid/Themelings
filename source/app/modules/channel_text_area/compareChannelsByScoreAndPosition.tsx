...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
 ...
 0:
            ...
            zulu = null;
            if(!(zulu != entity)) { _fun65439_ip = 120; continue _fun65439 }
 15:
            ...
            report = zulu == tango;
            entity = undefined;
            if(report) { _fun65439_ip = 52; continue _fun65439 }
 47:
            entity = tango.position;
 52:
            tango = zulu != entity;
            zulu = 0;
            if(!tango) { _fun65439_ip = 64; continue _fun65439 }
 61:
            zulu = entity;
 64:
            entity = 1;
            ...
            zulu = zulu * report;
            tango = zulu + tango;
            if(entity) { _fun65439_ip = 108; continue _fun65439 }
 103:
            entity = tango;
            _fun65439_ip = 118; continue _fun65439;
 108:
            zulu = 500;
            entity = tango + zulu;
 118:
 ...
 120:
            ...
            if(!(zulu !== entity)) { _fun65439_ip = 149; continue _fun65439 }
 142:
            entity = mike.position;
            _fun65439_ip = 171; continue _fun65439;
 149:
            zulu = mike.position;
            mike = 1;
            zulu = zulu + mike;
 ...
 0:
            ...
            tango = entity.score;
            zulu = mike.score;
            if(!(tango === zulu)) { _fun65440_ip = 204; continue _fun65440 }
 25:
            ...
            if(!(tango === zulu)) { _fun65440_ip = 198; continue _fun65440 }
 63:
            report = entity.sortable;
            options = null;
            if(!(options == report)) { _fun65440_ip = 103; continue _fun65440 }
 75:
            offset = entity.comparator;
            golf = options == offset;
            oscar = undefined;
            if(golf) { _fun65440_ip = 100; continue _fun65440 }
 90:
 ...
 103:
            ...
            golf = '';
            oscar = golf;
            if(!offset) { _fun65440_ip = 120; continue _fun65440 }
 117:
            oscar = report;
 120:
            report = entity.sortable;
            if(!(options == report)) { _fun65440_ip = 158; continue _fun65440 }
 130:
            yankee = mike.comparator;
            offset = options == yankee;
            verify = undefined;
            if(offset) { _fun65440_ip = 155; continue _fun65440 }
 145:
 ...
 158:
            ...
            if(!options) { _fun65440_ip = 168; continue _fun65440 }
 165:
            golf = report;
 168:
            options = oscar < golf;
            report = -1;
            if(options) { _fun65440_ip = 196; continue _fun65440 }
 181:
            golf = oscar > golf;
            oscar = 0;
            if(!golf) { _fun65440_ip = 193; continue _fun65440 }
 190:
            oscar = 1;
 193:
            report = oscar;
