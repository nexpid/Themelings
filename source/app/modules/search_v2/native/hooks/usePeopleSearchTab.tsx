...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    tango = 'modules/search_v2/native/hooks/usePeopleSearchTab.tsx';
    tango = report.bind(oscar)(tango);
    tango = function(argFoo) { // Original name: usePeopleSearchTabCount
        golf = argFoo;
        ...
        zulu = tango.useIsPeopleTabVisible;
        ...
        report = 2;
        options = options.bind(offset)(verify, report);
        tango = options[tango];
        report = 1;
 ...
 0:
                ...
                if(oscar) { _fun112994_ip = 281; continue _fun112994 }
 36:
                golf = _closure2_slot6;
                oscar = tango.toLowerCase;
                ...
                oscar = tango.length;
                tango = 0;
                if(!(tango !== oscar)) { _fun112994_ip = 273; continue _fun112994 }
 103:
 ...
 0:
                        ...
                        zulu = mike === oscar;
                        mike = undefined;
                        if(zulu) { _fun112996_ip = 49; continue _fun112996 }
 24:
                        report = tango().value;
                        tango = entity;
                        tango = tango === oscar;
                        mike = undefined;
                        zulu = tango;
                        if(tango) { _fun112996_ip = 49; continue _fun112996 }
 43:
                        mike = report;
                        zulu = tango;
 49:
                        if(zulu) { _fun112996_ip = 55; continue _fun112996 }
 52:
                        entity.return();
 55:
                        entity = 0;
 ...
 0:
                        ...
                        entity = undefined;
                        zulu = zulu === entity;
                        if(zulu) { _fun112998_ip = 25; continue _fun112998 }
 22:
                        entity = tango;
 25:
                        if(zulu) { _fun112998_ip = 31; continue _fun112998 }
 28:
                        mike.return();
 31:
                        return entity;
 ...
 281:
        ...
        options = verify.bind(oscar)(report, options);
 ...
 0:
                ...
                oscar = golf.parseUserSearchResults;
                report = {'data': null, 'withGuildMembers': true, 'withAffinitySuggestions': true, 'withFriends': true, 'withFriendSuggestions': false, 'withFriendRequests': false, 'withFriendRequestsIncoming': false, 'withFriendRequestsOutgoing': false, 'excludeCurrentUser': true};
                report['data'] = options;
                ...
                report = 0;
                oscar = options;
                if(!(report !== golf)) { _fun112999_ip = 326; continue _fun112999 }
 111:
                golf = _closure2_slot6;
                verify = golf.current;
                golf = '';
                oscar = options;
                if(!(golf !== verify)) { _fun112999_ip = 326; continue _fun112999 }
 134:
                golf = {};
                ...
                verify = verify.t;
                verify = verify.qGlQra;
                verify = offset.bind(yankee)(verify);
                golf['title'] = verify;
                tango = _closure2_slot5;
                tango = tango.current;
                golf['items'] = tango;
                verify = options.findIndex;
                ...
                yankee = verify.bind(options)(tango);
                tango = -1;
                if(!(tango !== yankee)) { _fun112999_ip = 295; continue _fun112999 }
 237:
                tango = options.slice;
                kilo = tango.bind(options)(report, yankee);
                tango = new Array(1);
                sizing = tango;
                backup = 0;
                ...
                verify = options.slice;
                kilo = verify.bind(options)(yankee);
                sizing = tango;
                verify = arraySpread(sizing, kilo, backup);
                oscar = tango;
                _fun112999_ip = 326; continue _fun112999;
 295:
                tango = new Array(1);
                sizing = tango;
                kilo = options;
 ...
 326:
                ...
                report = tango.bind(oscar)(zulu, report);
 ...
 0:
                ...
                if(mike) { _fun113002_ip = 14; continue _fun113002 }
 10:
                mike = undefined;
                return mike;
 14:
    ...
    zulu['default'] = tango;
    mike = function() { // Original name: usePeopleSearchResults
    ...
    zulu['usePeopleSearchResults'] = mike;
    return entity;
})();