...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
            ...
            golf = options.usePeopleSearchResults;
            offset = golf.bind(options)();
            var _closure2_slot1 = offset;
            options = 5;
            golf = tango[options];
            yankee = zulu.bind(report)(golf);
            verify = yankee.useOnPressGroupDMItem;
            golf = {};
            ...
            verify = yankee.useOnPressDMItem;
            options = {};
            options['searchContext'] = oscar;
            foxtrot = verify.bind(yankee)(options);
 ...
 0:
                            ...
                            if(mike) { _fun113665_ip = 121; continue _fun113665 }
 10:
 ...
 50:
                            ...
                            if(oscar) { _fun113665_ip = 118; continue _fun113665 }
 56:
                            ...
                            golf = options.trackSearchResultClicked;
                            oscar = {};
 ...
 121:
            ...
            yankee = options.bind(report)();
            options = new Array(2);
            options[0] = foxtrot;
            options[1] = oscar;
            romeo = romeo.bind(verify)(yankee, options);
            ...
            yankee = yankee.bind(verify)(golf, options);
 ...
 0:
                        ...
                        zulu = mike.items;
                        mike = null;
                        if(!(mike != tango)) { _fun113669_ip = 83; continue _fun113669 }
 26:
                        report = zulu.length;
                        mike = 0;
                        if(!(report > mike)) { _fun113669_ip = 83; continue _fun113669 }
 37:
                        report = {};
 ...
 0:
                                ...
                                entity = 'user';
                                zulu = entity in mike;
                                if(zulu) { _fun113670_ip = 84; continue _fun113670 }
 17:
                                ...
                                _fun113670_ip = 188; continue _fun113670;
 84:
                                golf = mike.type;
                                report = mike.user;
                                oscar = mike.firstMatch;
                                ...
                                report = undefined;
                                if(!(golf !== oscar)) { _fun113670_ip = 163; continue _fun113670 }
 160:
                                report = oscar;
 163:
 ...
 188:
            ...
            entity = null;
            if(!(entity == oscar)) { _fun113662_ip = 429; continue _fun113662 }
 302:
            ...
            _fun113662_ip = 465; continue _fun113662;
 429:
 ...
 465:
    ...
    tango = 'modules/search_v2/native/components/tabs/pages/PeopleScreen.tsx';
