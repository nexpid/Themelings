...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
 ...
 29:
            ...
            entity = null;
            if(!(entity != foxtra)) { _fun00008_ip = 526; continue _fun00007 }
 140:
            report = _closure1_slot0;
 ...
 211:
            ...
            if(!tangon) { _fun00008_ip = 250; continue _fun00007 }
 243:
            if(!(entity == zuuluu)) { _fun00008_ip = 443; continue _fun00007 }
 250:
 ...
 108:
    ...
    tangon = function(argFoo) { // Original name: SearchEmbedMediaImage
        ...
        tangon = undefined;
        result = option.bind(tangon)(verify);
        ...
        ctrled = oscard * offset;
        record = undefined;
        echoed = record[source](config, sequen, vacuum, ctrled, source);
        result = _closure1_slot3;
        offset = 2;
        result = result.bind(tangon)(echoed, offset);
        offset = 0;
