...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
            ...
            tango = undefined;
            if(!(control === tango)) { _fun113350_ip = 73; continue _fun113350 }
 71:
            control = true;
 73:
            source = entity.accessibilityRole;
            if(!(source === tango)) { _fun113350_ip = 86; continue _fun113350 }
 82:
            source = 'button';
 86:
            ...
            yankee = oscar != zulu;
            entity = 0;
            if(!yankee) { _fun113350_ip = 130; continue _fun113350 }
 127:
            entity = zulu;
 130:
            ...
            kilo = typeof update;
            output = update;
            if(!(result === kilo)) { _fun113350_ip = 409; continue _fun113350 }
 347:
 ...
 409:
            ...
            report[1] = options;
            oscar = oscar != offset;
            if(!oscar) { _fun113350_ip = 498; continue _fun113350 }
 460:
