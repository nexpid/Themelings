...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
            ...
            mike = entity.iconSize;
            var _closure2_slot1 = mike;
            mike = entity.channelIconSize;
 ...
 50:
            ...
            romeo = zulu.bind(report)(romeo);
            romeo = romeo.AST_KEY;
            romeo = romeo.LINE_BREAK;
            backup = foxtrot[romeo];
            kilo = golf;
            romeo = copyDataProperties(kilo, backup);
            romeo = function() { // Original name: react
                entity = '\n';
                return entity;
            };
            golf[offset] = romeo;
 ...
 23:
                    ...
                    if(!options) { _fun00008_ip = 118; continue _fun00007 }
 105:
                    verify = {};
 ...
 0:
                    ...
                    zulu = golf.isStaticRouteIconType;
 ...
 0:
                    ...
                    zulu = 'ansi';
                    if(!(zulu === tango)) { _fun00012_ip = 138; continue _fun00011 }
 107:
 ...
 0:
                    ...
                    entity = null;
                    if(!(entity != mike)) { _fun00014_ip = 135; continue _fun00013 }
 21:
                    ...
                    mike = {};
                    entity = oscar.inContent;
                    verify = report.bind(golf)(entity, tango);
                    entity = new Array(3);
                    entity[0] = verify;
                    verify = ' › ';
                    entity[1] = verify;
                    ...
                    verify = verify.bind(offset)(oscar, report, tango);
                    entity[2] = verify;
 ...
 173:
            ...
            romeo = function(argFoo, argBar, argBaz) { // Original name: react
                ...
                golf = oscar.AttachmentIcon;
                oscar = {};
                romeo = _closure2_slot0;
                oscar['color'] = romeo;
                yankee = _closure2_slot1;
                oscar['size'] = yankee;
                golf = offset.bind(tango)(golf, oscar);
                oscar = new Array(2);
                oscar[0] = golf;
                golf = 4;
                golf = verify[golf];
                ...
                options = argFoo;
                golf = argBar;
                golf = verify.bind(offset)(options, golf, entity);
                oscar[1] = golf;
                mike['children'] = oscar;
                entity = entity.key;
                entity = report.bind(tango)(zulu, mike, entity);
 ...
 0:
                    ...
                    mike = 'text';
                    if(!(mike !== report)) { _fun00016_ip = 370; continue _fun00015 }
 23:
                    mike = 'forum';
                    if(!(mike !== report)) { _fun00016_ip = 370; continue _fun00015 }
 36:
 ...
 47:
                    mike = 'thread';
                    if(!(mike !== report)) { _fun00016_ip = 361; continue _fun00015 }
 58:
                    mike = 'post';
                    if(!(mike !== report)) { _fun00016_ip = 361; continue _fun00015 }
 69:
                    mike = 'message';
                    if(!(mike !== report)) { _fun00016_ip = 284; continue _fun00015 }
 80:
                    mike = undefined;
                    zulu = 'voice';
                    options = undefined;
                    golf = undefined;
                    if(!(zulu !== report)) { _fun00016_ip = 376; continue _fun00015 }
 97:
                    zulu = 'voice-locked';
                    options = undefined;
                    golf = undefined;
 ...
 376:
                    ...
                    verify = offset.smartOutput;
                    options = argBar;
                    options = verify.bind(offset)(yankee, options, entity);
                    oscar[1] = options;
                    oscar[2] = golf;
                    mike['children'] = oscar;
                    entity = entity.key;
 ...
 96:
    ...
    options = options.MUTED_OPACITY_CONTENT;
    ...
    foxtrot = report.ANSI_CONTROL_SEQUENCE_RE;
    report = offset.prototype;
    options = Object.create(report, {constructor: {value: offset}});
    romeo = 'g';
    backup = options;
    report = new backup[offset](foxtrot, romeo, yankee);
 ...
 0:
            ...
            tango = null;
            report = verify;
            if(!(tango != options)) { _fun00020_ip = 73; continue _fun00019 }
 54:
            entity = global;
            mike = entity.Math;
            entity = mike.min;
            report = entity.bind(mike)(verify, options);
 73:
            mike = _closure1_slot8;
            entity = {};
            options = argBar;
            entity['iconColor'] = options;
            options = oscar.messagePreview;
            options = options.messageTypeIconSizeNew;
            entity['iconSize'] = options;
            options = oscar.messagePreview;
            options = options.messageTypeIconSize;
            entity['channelIconSize'] = options;
            options = _closure1_slot0;
            verify = _closure1_slot2;
            golf = 6;
            golf = verify[golf];
            ...
            golf = golf.ICON_SIZE;
            oscar = oscar.messagePreview;
            oscar = oscar.messageTypeIconSizeNew;
            oscar = golf[oscar];
            golf = tango != oscar;
            tango = 0;
            if(!golf) { _fun00020_ip = 175; continue _fun00019 }
 172:
            tango = oscar;
 175:
            tango = tango * report;
            entity['customEmojiSize'] = tango;
            entity = mike.bind(zulu)(entity);
            return entity;
        }
    };
    zulu['default'] = tango;
    zulu['createMessagePreviewReactRules'] = mike;
    return entity;
})();