...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
                    ...
                    tango = null;
                    if(!(tango != oscar)) { _fun00006_ip = 63; continue _fun00005 }
 51:
                    golf = zulu.length;
                    if(!(options !== golf)) { _fun00006_ip = 196; continue _fun00005 }
 63:
                    options = zulu.length;
 ...
 248:
                    if(!(tango != oscar)) { _fun00006_ip = 270; continue _fun00005 }
 252:
                    tango = global;
 ...
 0:
                        ...
                        mike = 0;
                        if(!tango) { _fun00010_ip = 125; continue _fun00009 }
 115:
                        mike = 0.6;
 125:
                        tango = new Array(2);
