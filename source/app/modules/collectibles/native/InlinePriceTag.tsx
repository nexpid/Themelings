...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    tango['underline'] = verify;
    verify = {};
    offset = -2;
    verify['marginBottom'] = offset;
    tango['subscribeNowPressable'] = verify;
 ...
 0:
            ...
            mike = entity.price;
            kilo = mike.amount;
            backup = mike.currency;
            verify = entity.renderPrice;
            yankee = entity.style;
            options = entity.color;
            tango = undefined;
            if(!(options === tango)) { _fun99678_ip = 49; continue _fun99678 }
 43:
            options = 'interactive-active';
 49:
            golf = entity.icon;
            romeo = entity.variant;
            if(!(romeo === tango)) { _fun99678_ip = 67; continue _fun99678 }
 63:
 ...
 67:
            ...
            zulu = oscar.formatPrice;
            oscar = zulu.bind(oscar)(kilo, backup);
            ...
            golf = undefined;
            if(offset) { _fun99678_ip = 196; continue _fun99678 }
 191:
            golf = verify.bind(tango)(oscar);
 196:
            if(!(options != golf)) { _fun99678_ip = 203; continue _fun99678 }
 200:
            oscar = golf;
 203:
            report[1] = oscar;
 ...
 0:
            ...
            zulu = zulu.SHOP_PRODUCT_DETAILS;
            ...
            if(!(zulu === entity)) { _fun99679_ip = 159; continue _fun99679 }
 126:
            ...
            _fun99679_ip = 201; continue _fun99679;
 159:
            zulu = _closure1_slot0;
            tango = _closure1_slot2;
            entity = 10;
            ...
            zulu = tango.extractPriceByPurchaseTypes;
            entity = _closure1_slot6;
            entity = entity.MOBILE;
            oscar = zulu.bind(tango)(backup, entity);
 201:
            entity = null;
            if(!(entity != oscar)) { _fun99679_ip = 1020; continue _fun99679 }
 210:
            tango = oscar.amount;
            zulu = 0;
            if(!(!(tango <= zulu))) { _fun99679_ip = 997; continue _fun99679 }
 225:
            ...
            papa = verify.bind(yankee)(backup, tango);
            verify = _closure1_slot1;
            tango = 11;
            tango = zulu[tango];
            verify = verify.bind(report)(tango);
            tango = verify.canUseCollectibles;
            control = tango.bind(verify)(offset);
            tango = backup.type;
            zulu = zulu[output];
            ...
            zulu = zulu.BUNDLE;
            result = '';
            if(!(tango === zulu)) { _fun99679_ip = 386; continue _fun99679 }
 328:
            tango = _closure1_slot0;
            zulu = _closure1_slot2;
            zulu = zulu[golf];
            tango = tango.bind(report)(zulu);
            zulu = tango.getBundleDiscount;
            options = zulu.bind(tango)(backup, control);
            zulu = global;
            zulu = zulu.HermesInternal;
            golf = zulu.concat;
            tango = ' (-';
            zulu = ')';
            result = golf.bind(tango)(options, zulu);
 386:
            ...
            if(!control) { _fun99679_ip = 431; continue _fun99679 }
 429:
            yankee = undefined;
 431:
            options['variant'] = yankee;
            if(control) { _fun99679_ip = 446; continue _fun99679 }
 438:
            yankee = echo.regularPrice;
            _fun99679_ip = 452; continue _fun99679;
 446:
 ...
 452:
            ...
            sequence = config.formatPrice;
            update = oscar.amount;
            sizing = oscar.currency;
            sizing = sequence.bind(config)(update, sizing);
            yankee['price'] = sizing;
            ...
            options[0] = verify;
            verify = entity != papa;
            if(!verify) { _fun99679_ip = 981; continue _fun99679 }
 593:
            ...
            kilo = foxtrot.NitroWheelIcon;
            foxtrot = {};
            update = 'interactive-normal';
            sequence = update;
            if(!control) { _fun99679_ip = 650; continue _fun99679 }
 647:
            sequence = vacuum;
 650:
            ...
            kilo = {};
            kilo['price'] = papa;
            if(!control) { _fun99679_ip = 699; continue _fun99679 }
 696:
            update = vacuum;
 699:
            kilo['color'] = update;
            update = 'text-md/normal';
            if(!control) { _fun99679_ip = 714; continue _fun99679 }
 712:
            update = undefined;
 714:
            kilo['variant'] = update;
            update = undefined;
            if(!control) { _fun99679_ip = 842; continue _fun99679 }
 723:
            ...
            vacuum = vacuum.t;
            sequence = vacuum.kWkpdH;
            vacuum = {};
            target = entity != papa;
            context = null;
            if(!target) { _fun99679_ip = 831; continue _fun99679 }
 781:
            ...
            lima = entity == papa;
            target = undefined;
            if(lima) { _fun99679_ip = 819; continue _fun99679 }
 813:
            target = papa.amount;
 819:
            papa = papa.currency;
 ...
 842:
            ...
            update = undefined;
            if(control) { _fun99679_ip = 858; continue _fun99679 }
 851:
            update = function(argFoo) {
                ...
                report = function(argFoo) { // Original name: subscribeNowHook
                    ...
                    report = golf.subscribeNowPressable;
                    mike['style'] = report;
 ...
 858:
            ...
            backup = kilo === backup;
            if(!backup) { _fun99679_ip = 967; continue _fun99679 }
 914:
