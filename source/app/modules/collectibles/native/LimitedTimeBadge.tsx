// app/modules/collectibles/native/LimitedTimeBadge.tsx
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    tango = {};
    verify = {'position': 'absolute', 'top': 6, 'right': 4, 'zIndex': 999, 'borderRadius': null, 'paddingHorizontal': 8, 'paddingVertical': 2};
    offset = 6;
    romeo = oscar[offset];
    ...
    tango['backgroundDarkMode'] = verify;
    verify = {};
    offset = oscar[offset];
    ...
    tango['backgroundLightMode'] = verify;
 ...
 186:
            ...
            entity = entity.t;
            entity = entity.1LyF1t;
            entity = mike.bind(zulu)(entity);
            entity = offset + entity;
            mike = 1;
            if(!(!(foxtrot > mike))) { _fun00002_ip = 375; continue _fun00001 }
 300:
            if(!(foxtrot <= mike)) { _fun00002_ip = 310; continue _fun00001 }
 304:
            mike = 0;
            if(!(!(offset > mike))) { _fun00002_ip = 372; continue _fun00001 }
 310:
 ...
 390:
            if(!(foxtrot <= entity)) { _fun00002_ip = 400; continue _fun00001 }
 394:
            entity = 0;
 ...
 689:
            ...
            verify = verify.t;
            offset = verify.TlZULC;
            verify = {};
            verify['daysLeft'] = foxtrot;
            verify = yankee.bind(romeo)(offset, verify);
            report['accessibilityLabel'] = verify;
            verify = false;
            report['allowFontScaling'] = verify;
