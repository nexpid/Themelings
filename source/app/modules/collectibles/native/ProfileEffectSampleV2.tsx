...
export default (function(argFoo, argBar, argBaz, _, __, argFre, argPlu) {
    ...
    verify = {'position': 'absolute', 'bottom': 1, 'width': '100%', 'height': '100%', 'overflow': 'hidden'};
    offset = 3;
    ...
    tangon = 'modules/collectibles/native/ProfileEffectSampleV2.tsx';
 ...
 93:
            foxtra = romeon.profileSkeletonBackground;
            _fun00002_ip = 107; continue _fun00001;
 101:
            foxtra = romeon.profileSkeletonBackgroundBundle;
 107:
            romeon = new Array(1);
            romeon[0] = foxtra;
            report['style'] = romeon;
