...
export default (function(global, require, metroImportDefault, metroImportAll, moduleObject, exports, dependencyMap) {
    ...
    var7 = {'enabled': false, 'chatInputFloating': false, 'chatInputLegacySendButton': false};
    var4['defaultConfig'] = var7;
    var7 = {};
    var8 = {'enabled': false, 'chatInputFloating': false, 'chatInputLegacySendButton': false};
    var7[0] = var8;
    var8 = {'enabled': true, 'chatInputFloating': false, 'chatInputLegacySendButton': false};
    var7[1] = var8;
    var8 = {'enabled': true, 'chatInputFloating': true, 'chatInputLegacySendButton': false};
    var7[2] = var8;
    var8 = {'enabled': true, 'chatInputFloating': true, 'chatInputLegacySendButton': false};
    var7[3] = var8;
    var8 = {'enabled': true, 'chatInputFloating': true, 'chatInputLegacySendButton': true};
    var7[4] = var8;
