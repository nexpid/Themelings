...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
            ...
            echo = entity.selected;
            control = entity.title;
            ...
            romeo = {};
            romeo['selected'] = echo;
            report['accessibilityState'] = romeo;
            ...
            oscar = {};
            source = 'text-md/bold';
            oscar['variant'] = source;
            sequence = global;
            source = sequence.HermesInternal;
            source = source.concat;
            config = '';
            source = source.bind(config)(control);
            oscar['children'] = source;
            oscar = update.bind(tango)(result, oscar);
            result = new Array(2);
            result[0] = oscar;
            oscar = null;
            source = oscar != record;
            update = null;
            if(!source) { _fun73046_ip = 308; continue _fun73046 }
 244:
            ...
            control = source.Text;
            source = {};
            context = 'text-md/normal';
            source['variant'] = context;
            sequence = sequence.HermesInternal;
 ...
 308:
            ...
            report[1] = verify;
            oscar = null;
            if(!options) { _fun73046_ip = 459; continue _fun73046 }
 433:
 ...
 459:
    ...
    golf = {};
    tango = {'flex': 1, 'alignSelf': 'stretch', 'marginBottom': 16};
    golf['container'] = tango;
    tango = {};
    tango['flex'] = offset;
    golf['flex'] = tango;
    tango = {'minHeight': 48, 'marginBottom': 13};
    golf['rowContainer'] = tango;
    tango = 8;
    offset = {'marginHorizontal': 16, 'paddingTop': 14, 'marginBottom': 8, 'flexDirection': 'row', 'alignSelf': 'stretch'};
    golf['row'] = offset;
    offset = {'flex': 1, 'lineHeight': 20, 'marginEnd': 8};
    golf['optionText'] = offset;
    offset = {'alignSelf': 'stretch', 'marginStart': 16, 'height': 1};
    yankee = 4;
    yankee = oscar[yankee];
 ...
 0:
            ...
            entity = null;
            if(!(entity != zulu)) { _fun73047_ip = 114; continue _fun73047 }
 48:
            options = zulu.type;
            tango = 'checkbox';
            if(!(tango === options)) { _fun73047_ip = 114; continue _fun73047 }
 61:
            options = zulu.data;
 ...
 0:
                    ...
                    zulu = zulu === report;
                    verify = undefined;
                    if(zulu) { _fun73048_ip = 32; continue _fun73048 }
 29:
                    verify = entity;
 32:
                    var _closure3_slot0 = verify;
                    oscar = undefined;
                    if(zulu) { _fun73048_ip = 66; continue _fun73048 }
 41:
                    offset = tango().value;
                    entity = mike;
                    ...
                    oscar = undefined;
                    zulu = entity;
                    if(entity) { _fun73048_ip = 66; continue _fun73048 }
 60:
                    oscar = offset;
                    zulu = entity;
 66:
                    ...
                    entity = undefined;
                    if(zulu) { _fun73048_ip = 100; continue _fun73048 }
 75:
                    offset = tango().value;
                    tango = mike;
                    tango = tango === report;
                    entity = undefined;
                    zulu = tango;
                    if(tango) { _fun73048_ip = 100; continue _fun73048 }
 94:
                    entity = offset;
                    zulu = tango;
 100:
                    if(zulu) { _fun73048_ip = 106; continue _fun73048 }
 103:
                    mike.return();
 106:
                    mike = argBaz;
                    ...
                    oscar = '';
                    entity = '+button';
                    entity = golf.bind(oscar)(options, entity);
