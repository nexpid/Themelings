...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
    ...
    tangon = 'modules/in_app_reports/native/components/InAppReportsChannelPreview.tsx';
    tangon = report.bind(oscard)(tangon);
    michal = function(argFoo) { // Original name: ChannelPreview
        _fun00001: for(var _fun00002_ip = 0; ; ) switch(_fun00002_ip) {
 0:
            michal = argFoo;
            romeon = michal.stageInstance;
            ...
            entity = null;
            if(!(entity != echoed)) { _fun00002_ip = 551; continue _fun00001 }
 85:
            if(!(entity != romeon)) { _fun00002_ip = 551; continue _fun00001 }
 92:
