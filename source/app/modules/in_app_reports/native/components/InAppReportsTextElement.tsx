...
export default (function(argFoo, argBar, _, argCor, __, argFre, argPlu) {
    ...
    tangon = 'modules/in_app_reports/native/components/InAppReportsTextElement.tsx';
    tangon = report.bind(oscard)(tangon);
    michal = function(argFoo) { // Original name: TextElement
