...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
 ...
 84:
    ...
    michal = function(argFoo) { // Original name: showReportModalForApp
        ...
        option = entity.contextualGuildId;
        golfie = entity.contextualChannelId;
        ...
        tangon['name'] = offset;
        tangon['record'] = verify;
        tangon['contextualGuildId'] = option;
        tangon['contextualChannelId'] = golfie;
