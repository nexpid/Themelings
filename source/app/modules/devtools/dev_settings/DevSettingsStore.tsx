...
export default (function(argFoo, argBar, argBaz, _, __, argFre, argPlu) {
 ...
 74:
    ...
    michal = {};
    verify = {};
    offset = 'Blur view overrides for designers to test with';
    verify['label'] = offset;
    offset = tangon.OVERLAYS;
    verify['category'] = offset;
    michal['visual_effect_view_overrides'] = verify;
    verify = {};
    offset = 'Force explicit content obscure blur effect on for message media and embeds';
    verify['label'] = offset;
    offset = tangon.OVERLAYS;
    verify['category'] = offset;
    michal['obscure_blur_effect_explicit_content_enabled'] = verify;
    verify = {};
    offset = 'Force gore content obscure blur effect on for message media and embeds';
    verify['label'] = offset;
    offset = tangon.OVERLAYS;
    verify['category'] = offset;
    michal['obscure_blur_effect_gore_content_enabled'] = verify;
    verify = {};
    offset = 'Ignore pending scan on explicit media';
    verify['label'] = offset;
    offset = tangon.OVERLAYS;
    verify['category'] = offset;
    michal['explicit_media_redaction_ignore_pending_scan'] = verify;
    verify = {};
    offset = 'Uploads: Fail 50% of uploads with 500 status after a 1 second delay';
    verify['label'] = offset;
    offset = tangon.MESSAGING;
    verify['category'] = offset;
    michal['upload_fail_50'] = verify;
    verify = {};
    offset = 'Send: Fail with 500 status';
    verify['label'] = offset;
    offset = tangon.MESSAGING;
    verify['category'] = offset;
    michal['send_fail_100'] = verify;
    verify = {};
    offset = 'Enable all new premium roadblocks';
    verify['label'] = offset;
    offset = tangon.PREMIUM;
    verify['category'] = offset;
    michal['premium_roadblocks'] = verify;
    verify = {};
    offset = 'Enable staff only test iar menu options';
    verify['label'] = offset;
    offset = tangon.REPORTING;
    verify['category'] = offset;
    michal['iar_testing'] = verify;
    verify = {};
    offset = 'Enable to skip calling the API to skip submitting actual IAR reports';
    verify['label'] = offset;
    offset = tangon.REPORTING;
    verify['category'] = offset;
    michal['iar_skip_api_report_submit'] = verify;
    verify = {};
    offset = "Only show application collections (e.g. in App Directory, App Launcher in text) that have the 'preview' active state. This disables application collections cache, too, so you can see collections updates immediately.";
    verify['label'] = offset;
    offset = tangon.APP_COLLECTIONS;
    verify['category'] = offset;
    michal['only_show_preview_app_collections'] = verify;
    verify = {};
    offset = 'Disable application collections cache so that you can see updates to collections immediately.';
    verify['label'] = offset;
    offset = tangon.APP_COLLECTIONS;
    verify['category'] = offset;
    michal['disable_app_collections_cache'] = verify;
    verify = {};
    offset = 'Show debug log overlay in collectibles shop';
    verify['label'] = offset;
    offset = tangon.SHOP;
    verify['category'] = offset;
