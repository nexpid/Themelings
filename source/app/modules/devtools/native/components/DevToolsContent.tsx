...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    entity = function(argFoo) { // Original name: DevToolsContentSortButtons
 ...
 0:
            ...
            offset = foxtrot.button;
            oscar = new Array(2);
            oscar[0] = offset;
            if(!golf) { _fun99001_ip = 128; continue _fun99001 }
 122:
            golf = foxtrot.disabledButton;
 128:
            oscar[1] = golf;
            report['style'] = oscar;
            offset = 'button';
            ...
            oscar = 'Shift up';
            report['accessibilityLabel'] = oscar;
            ...
            output = sizing.ArrowSmallUpIcon;
            sizing = {};
            ...
            yankee = new Array(2);
            yankee[0] = backup;
            if(!romeo) { _fun99001_ip = 269; continue _fun99001 }
 263:
            romeo = foxtrot.disabledButton;
 269:
            yankee[1] = romeo;
            oscar['style'] = yankee;
            ...
            offset = verify.ArrowSmallDownIcon;
            verify = {};
    ...
    report = options.memo;
    tango = function(argFoo) { // Original name: DevToolsContent
 ...
 0:
            ...
            entity = function() { // Original name: useDevToolsContentSublabels
                oscar = _closure1_slot0;
                report = _closure1_slot2;
                tango = 8;
                golf = report[tango];
 ...
 0:
                        ...
                        tango = undefined;
                        entity = undefined;
                        if(oscar) { _fun99007_ip = 80; continue _fun99007 }
 36:
                        oscar = _closure1_slot0;
                        ...
                        zulu = zulu == mike;
                        entity = undefined;
                        if(zulu) { _fun99007_ip = 80; continue _fun99007 }
 75:
                        entity = mike.id;
 80:
                        return entity;
 ...
 0:
                        ...
                        zulu = mike === report;
                        mike = undefined;
                        if(zulu) { _fun99009_ip = 27; continue _fun99009 }
 24:
                        mike = tango;
 27:
                        if(zulu) { _fun99009_ip = 33; continue _fun99009 }
 30:
                        entity.return();
 33:
                        entity = 'buildOverride';
                        if(!(entity !== mike)) { _fun99009_ip = 117; continue _fun99009 }
 41:
                        entity = 'experiments';
                        if(!(entity !== mike)) { _fun99009_ip = 51; continue _fun99009 }
 49:
                        return report;
 51:
                        ...
                        mike = mike > entity;
                        entity = undefined;
                        if(!mike) { _fun99009_ip = 115; continue _fun99009 }
 69:
                        tango = _closure1_slot9;
                        zulu = _closure1_slot12;
                        mike = {};
                        golf = 'Experiments overriden: ';
                        mike['label'] = golf;
 ...
 117:
                        ...
                        mike = entity != mike;
                        entity = undefined;
                        if(!mike) { _fun99009_ip = 172; continue _fun99009 }
 135:
                        tango = _closure1_slot9;
                        zulu = _closure1_slot12;
                        mike = {};
 ...
 172:
            ...
            yankee = foxtrot.useState;
            entity = false;
            foxtrot = yankee.bind(foxtrot)(entity);
            yankee = _closure1_slot3;
            entity = 2;
            yankee = yankee.bind(report)(foxtrot, entity);
            entity = 0;
 ...
 0:
                    ...
                    zulu = yankee;
                    if(yankee) { _fun99010_ip = 37; continue _fun99010 }
 34:
                    report = golf;
 37:
                    golf = report;
                    ...
                    report = undefined;
                    golf = zulu;
                    if(golf) { _fun99010_ip = 75; continue _fun99010 }
 55:
                    oscar = oscar().value;
                    golf = mike;
                    golf = golf === options;
 ...
 72:
                    report = oscar;
 75: // try_start_0
                    romeo = report.headerTitle;
                    offset = report.Icon;
 87: // try_end0
                    report = zulu;
                    if(report) { _fun99010_ip = 96; continue _fun99010 }
 93:
                    mike.return();
 96:
                    kilo = foxtrot;
                    ...
                    romeo = offset;
                    offset = {};
                    offset = foxtrot.bind(options)(romeo, offset);
                    report['icon'] = offset;
                    romeo = _closure2_slot2;
                    offset = !romeo;
                    report['arrow'] = offset;
                    offset = undefined;
                    if(!romeo) { _fun99010_ip = 248; continue _fun99010 }
 190:
                    foxtrot = _closure1_slot9;
                    romeo = _closure1_slot13;
                    yankee = {};
                    sizing = tango;
                    yankee['screenKey'] = sizing;
                    sizing = 0;
                    sizing = sizing === kilo;
                    yankee['start'] = sizing;
                    ...
                    backup = kilo === backup;
                    yankee['end'] = backup;
                    offset = foxtrot.bind(options)(romeo, yankee);
 248:
 ...
 0:
                            ...
                            golf = 'sorting-enabled';
                            if(!options) { _fun99011_ip = 55; continue _fun99011 }
 49:
                            golf = 'sorting-disabled';
 55:
                            tango['key'] = golf;
                            options = _closure2_slot2;
                            golf = 'Sorting enabled';
                            if(!options) { _fun99011_ip = 78; continue _fun99011 }
 72:
                            golf = 'Sorting disabled';
 78:
                            tango['content'] = golf;
                            ...
                            tango = report.triggerHapticFeedback;
                            zulu = golf[zulu];
 ...
 0:
                            ...
                            if(mike) { _fun99013_ip = 98; continue _fun99013 }
 10:
                            mike = _closure2_slot0;
                            zulu = mike.push;
                            mike = null;
                            if(!(mike == zulu)) { _fun99013_ip = 77; continue _fun99013 }
 25:
                            ...
                            _fun99013_ip = 98; continue _fun99013;
 77:
                            zulu = _closure2_slot0;
                            mike = zulu.push;
 ...
 285: // catch_target0
                    ...
                    _fun99010_ip = 291; continue _fun99010;
 289:
                    CatchBlockStart(arg_register=0);
 291:
                    if(zulu) { _fun99010_ip = 297; continue _fun99010 }
 294:
                    mike.return();
 297:
                    throw entity;
            ...
            entity = oscar;
            if(mike) { _fun99005_ip = 311; continue _fun99005 }
 229:
            tango = _closure1_slot9;
            zulu = _closure1_slot6;
            mike = {};
            golf = golf.devToolsContainer;
            mike['style'] = golf;
            golf = {};
 ...
 311:
    ...
    report = 'modules/devtools/native/components/DevToolsContent.tsx';
    report = oscar.bind(golf)(report);
    zulu['default'] = tango;
    zulu['DevToolsContentSubLabel'] = mike;
    return entity;
})();