...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
            ...
            offset = 'home';
            report = offset;
            if(!verify) { _fun98981_ip = 85; continue _fun98981 }
 82:
            report = options;
 85:
            ...
            offset = function() { // Original name: options
                ...
                mike = function() { // Original name: headerTitle
                    ...
                    golf = oscar.Text;
                    oscar = {'style': null, 'variant': 'heading-md/semibold', 'color': 'header-primary', 'children': 'DevTools'};
                    verify = {};
 ...
 0:
                    ...
                    zulu = yankee;
                    if(yankee) { _fun98986_ip = 34; continue _fun98986 }
 31:
                    report = golf;
 34:
                    tango = report;
                    report = undefined;
                    golf = zulu;
                    if(golf) { _fun98986_ip = 65; continue _fun98986 }
 45:
                    oscar = oscar().value;
                    golf = mike;
                    golf = golf === options;
 ...
 62:
                    report = oscar;
 65: // try_start_0
                    oscar = report.headerTitle;
                    var _closure3_slot0 = oscar;
                    offset = report.render;
 81: // try_end0
                    report = zulu;
                    if(report) { _fun98986_ip = 90; continue _fun98986 }
 87:
                    mike.return();
 90:
 ...
 137: // catch_target0
                    ...
                    _fun98986_ip = 143; continue _fun98986;
 141:
                    CatchBlockStart(arg_register=0);
 143:
                    if(zulu) { _fun98986_ip = 149; continue _fun98986 }
 146:
                    mike.return();
 149:
                    throw entity;
    ...
    tango = 'modules/devtools/native/components/DevToolsNavigator.tsx';
    tango = report.bind(oscar)(tango);
    mike = function() { // Original name: navigateToDevTools
        _fun98988: for(var _fun98988_ip = 0; ; ) switch(_fun98988_ip) {
 0:
            mike = arguments[0];
            entity = undefined;
            if(!(mike === entity)) { _fun98988_ip = 11; continue _fun98988 }
 9:
            mike = {};
 11:
            mike = mike.screenKey;
            ...
            mike = 'DevToolsNavigator';
            mike = report.bind(oscar)(zulu, tango, mike);
            return entity;
        }
    };
    zulu['navigateToDevTools'] = mike;
    return entity;
})();