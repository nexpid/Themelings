...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
 ...
 0:
            ...
            yankee = entity.participantScreenIsFocused;
            ...
            result = golfie.bind(tangon)(sizing);
            ...
            option = sizing.useStateFromStores;
            ...
            golfie = option.bind(sizing)(golfie, oscard);
 ...
 520:
            golfie = option.screenOrientation;
 526:
            output = golfie;
 529:
            _closure2_slot10 = output;
            sizing = _closure1_slot4;
            option = sizing.useEffect;
            golfie = new Array(4);
            golfie[0] = result;
            golfie[1] = output;
            golfie[2] = zuuluu;
 ...
 78:
            ...
            zuuluu = option.bind(sizing)(zuuluu, golfie);
            ...
            zuuluu = zuuluu.bind(tangon)(golfie, report);
 ...
 146:
            ...
            golfie = yankee.bind(tangon)(entity);
            ...
            option['withTiming'] = verify;
            option['marginTopState'] = result;
            verify = _closure1_slot25;
            option['TIMING_CONFIG'] = verify;
            option['marginBottomState'] = sizing;
            entity['__closure'] = option;
            option = 17411027531876.0;
            entity['__workletHash'] = option;
            option = _closure1_slot27;
            entity['__initData'] = option;
            kiloes = zuuluu.bind(golfie)(entity);
            ...
            if(!(entity !== report)) { _fun00002_ip = 1015; continue _fun00001 }
 895:
            entity = _closure1_slot26;
            entity = entity.HANDLE_THERMAL_EVENT;
            if(!(entity !== report)) { _fun00002_ip = 918; continue _fun00001 }
 909:
            update = new Array(0);
 ...
 56:
            ...
            oscard = null;
            if(report) { _fun00002_ip = 1205; continue _fun00001 }
 1128:
 ...
 1205:
            ...
            sierra['marginLeft'] = backup;
            backup = _closure1_slot15;
            backup = limora + backup;
            sierra['marginRight'] = backup;
            backup = new Array(2);
            backup[0] = sierra;
            backup[1] = kiloes;
            offset['style'] = backup;
            ...
            verify['preferredPosition'] = status;
            verify['onMove'] = target;
            target = true;
            ...
            sizing = {};
            sizing['ref'] = cntext;
            if(!ctrled) { _fun00002_ip = 1406; continue _fun00001 }
 1403:
            ctrled = vacuum;
 1406:
            ctrled = !ctrled;
 ...
 35:
            ...
            verify = 'portrait';
            if(!foxtra) { _fun00002_ip = 1522; continue _fun00001 }
 1518:
            verify = 'landscape';
 1522:
 ...
 28:
            ...
            zuuluu = michal.isChannelCallModalOpen;
            if(!(zuuluu === report)) { _fun00014_ip = 44; continue _fun00013 }
 42:
            zuuluu = false;
 44:
            ...
            offset = tangon.bind(report)(verify);
            _closure2_slot2 = offset;
            yankee = _closure1_slot0;
            kiloes = 17;
            tangon = oscard[kiloes];
            backup = yankee.bind(report)(tangon);
 ...
 153:
            ...
            backup = foxtra.bind(backup)(romeon, golfie);
 ...
 74:
            ...
            if(!romeon) { _fun00014_ip = 244; continue _fun00013 }
 212:
            foxtra = tangon == offset;
            yankee = undefined;
            if(foxtra) { _fun00014_ip = 226; continue _fun00013 }
 221:
            yankee = offset.id;
 226:
            foxtra = tangon == oscard;
            offset = undefined;
            if(foxtra) { _fun00014_ip = 240; continue _fun00013 }
 235:
            offset = oscard.id;
 240:
            romeon = yankee === offset;
 244:
            if(!romeon) { _fun00014_ip = 250; continue _fun00013 }
 247:
            romeon = !golfie;
 250:
 ...
 262:
            ...
            oscard = 38;
            oscard = output[oscard];
            offset = result.bind(report)(oscard);
            golfie = offset.useIsStreamFocused;
            oscard = verify.id;
            yankee = golfie.bind(offset)(oscard);
            oscard = 24;
            oscard = output[oscard];
            offset = result.bind(report)(oscard);
            golfie = offset.useIsViewingActivity;
            oscard = {};
            foxtra = verify.id;
            oscard['channelId'] = foxtra;
            offset = golfie.bind(offset)(oscard);
            oscard = output[kiloes];
            source = result.bind(report)(oscard);
 ...
 181:
            ...
            foxtra = update.bind(source)(echoed, foxtra);
            echoed = output[kiloes];
            source = result.bind(report)(echoed);
            update = source.useStateFromStores;
            echoed = new Array(2);
            echoed[0] = oscard;
            echoed[1] = golfie;
 ...
 171:
            ...
            golfie = golfie.bind(report)(verify, option, output);
            if(!(tangon != sizing)) { _fun00014_ip = 475; continue _fun00013 }
 472:
            backup = sizing;
 475:
            if(!(tangon != backup)) { _fun00014_ip = 482; continue _fun00013 }
 479:
            oscard = backup;
 482:
            if(!(tangon != oscard)) { _fun00014_ip = 489; continue _fun00013 }
 486:
            golfie = oscard;
 489:
            oscard = null;
            if(!(foxtra !== golfie)) { _fun00014_ip = 498; continue _fun00013 }
 495:
            oscard = foxtra;
 498:
            ...
            if(!zuuluu) { _fun00014_ip = 556; continue _fun00013 }
 546:
            foxtra = verify.isGuildStageVoice;
            zuuluu = foxtra.bind(verify)();
 556:
            ...
            if(romeon) { _fun00014_ip = 587; continue _fun00013 }
 584:
            if(!yankee) { _fun00014_ip = 595; continue _fun00013 }
 587:
            if(entity) { _fun00014_ip = 595; continue _fun00013 }
 590:
            entity = null;
            if(!offset) { _fun00014_ip = 648; continue _fun00013 }
 595:
            if(!(tangon == oscard)) { _fun00014_ip = 608; continue _fun00013 }
 599:
 ...
 608:
            entity = null;
            if(zuuluu) { _fun00014_ip = 648; continue _fun00013 }
 613:
