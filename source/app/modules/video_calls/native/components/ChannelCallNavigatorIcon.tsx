...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    tango['pressableContainer'] = verify;
    verify = {};
    offset = 6;
    ...
    verify = {'flexDirection': 'row', 'height': 32, 'width': 32, 'borderRadius': null, 'alignItems': 'center', 'justifyContent': 'center', 'overflow': 'hidden'};
    foxtrot = oscar[offset];
    foxtrot = yankee.bind(entity)(foxtrot);
    foxtrot = foxtrot.radii;
    foxtrot = foxtrot.lg;
    ...
    verify = {'marginLeft': 4, 'fontSize': 14};
 ...
 0:
            ...
            kilo = entity.membersCount;
            foxtrot = entity.disabled;
            backup = entity.theme;
            tango = undefined;
            if(!(backup === tango)) { _fun00002_ip = 56; continue _fun00001 }
 52:
            backup = 'dark';
 56:
            offset = entity.disableBackground;
            if(!(offset === tango)) { _fun00002_ip = 68; continue _fun00001 }
 66:
            offset = true;
 68:
            ...
            entity = {};
            report = sizing.pressableContainer;
            entity['style'] = report;
 ...
 23:
            ...
            options = {};
            echo = sizing.container;
            yankee = new Array(3);
            yankee[0] = echo;
            yankee[1] = output;
            if(!foxtrot) { _fun00002_ip = 207; continue _fun00001 }
 202:
 ...
 258:
            ...
            offset = {};
            echo = 'dark';
            offset['blurTheme'] = echo;
            echo = _closure1_slot4;
            echo = echo.absoluteFill;
            offset['style'] = echo;
 ...
 403:
            output = _closure1_slot6;
            backup = {};
            echo = sizing.iconColor;
            echo = echo.color;
            backup['color'] = echo;
            echo = 'sm';
            backup['size'] = echo;
            foxtrot = output.bind(tango)(result, backup);
 438:
            offset[1] = foxtrot;
            yankee = yankee != kilo;
