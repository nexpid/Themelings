...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
    ...
    michal = function(argFoo, argBar) {
        ...
        update = {};
        update['translateY'] = result;
        source = yankee[golfie];
        source = oscard.bind(tangon)(source);
        source = source.interpolate;
        update['interpolate'] = source;
        source = 200;
        update['THRESHOLD_TRANSLATE'] = source;
        update['MAX_TRANSLATE'] = output;
        source = yankee[golfie];
        source = oscard.bind(tangon)(source);
        source = source.Extrapolate;
        update['Extrapolate'] = source;
        zuuluu['__closure'] = update;
        update = 4656393556747.0;
        zuuluu['__workletHash'] = update;
        update = _closure1_slot8;
        zuuluu['__initData'] = update;
        offset['onActive'] = zuuluu;
        zuuluu = function(argFoo) { // Original name: L
 ...
 274:
        ...
        update['MAX_TRANSLATE'] = output;
        source = 500;
        update['THRESHOLD_VELOCITY'] = source;
        source = 8;
    ...
    tangon = function(argFoo, argBar) {
        ...
        zuuluu = 0;
        output = offset.bind(romeon)(zuuluu);
        ...
        result = {};
        echoed = 200;
        result['THRESHOLD_TRANSLATE'] = echoed;
        result['position'] = output;
        zuuluu['__closure'] = result;
        result = 2684994560036.0;
 ...
 192:
        ...
        result['position'] = output;
        echoed = 500;
        result['THRESHOLD_VELOCITY'] = echoed;
        echoed = yankee[golfie];
        echoed = oscard.bind(tangon)(echoed);
