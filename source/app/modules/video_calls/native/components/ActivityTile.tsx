...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
 ...
 0:
                            ...
                            if(michal) { _fun00004_ip = 241; continue _fun00003 }
 10:
 ...
 34:
                            if(!michal) { _fun00004_ip = 233; continue _fun00003 }
 40:
 ...
 198:
                            ...
                            tangon = report.setOrientationLockState;
 ...
 0:
                    ...
                    zuuluu['embeddedActivityJoinability'] = report;
                    report = _closure2_slot8;
                    zuuluu['handleCanJoin'] = report;
 ...
 71:
            ...
            zuuluu = entity.bind(offset)();
            michal = offset.id;
            kiloes = null;
            backup = kiloes == record;
            entity = undefined;
            if(backup) { _fun00002_ip = 214; continue _fun00001 }
 210:
            entity = record[tangon];
 214:
            romeon = yankee.bind(romeon)(zuuluu, michal, entity);
            if(!(kiloes == romeon)) { _fun00002_ip = 269; continue _fun00001 }
 225:
            michal = _closure1_slot1;
            zuuluu = _closure1_slot2;
            entity = 18;
            ...
            entity = undefined;
            if(yankee) { _fun00002_ip = 264; continue _fun00001 }
 260:
            entity = record[tangon];
 264:
 ...
 35:
            ...
            tangon = backup.bind(output)(tangon, entity);
            ...
            entity = kiloes == foxtra;
            source = undefined;
            if(entity) { _fun00002_ip = 426; continue _fun00001 }
 421:
            source = foxtra.name;
 426:
            if(!(kiloes == source)) { _fun00002_ip = 487; continue _fun00001 }
 430:
            ...
            source = zuuluu.bind(yankee)(entity);
 487:
            zuuluu = _closure1_slot7;
            ...
            backup = undefined;
            if(zuuluu) { _fun00002_ip = 514; continue _fun00001 }
 509:
            backup = entity.id;
 514:
            entity = kiloes != michal;
            if(!entity) { _fun00002_ip = 544; continue _fun00001 }
 521:
            zuuluu = michal.id;
            yankee = kiloes == foxtra;
            michal = undefined;
            if(yankee) { _fun00002_ip = 540; continue _fun00001 }
 535:
            michal = foxtra.id;
 540:
            entity = zuuluu === michal;
 544:
            if(entity) { _fun00002_ip = 585; continue _fun00001 }
 547:
            michal = kiloes != backup;
            if(!michal) { _fun00002_ip = 582; continue _fun00001 }
 554:
            yankee = kiloes == tangon;
            zuuluu = undefined;
            if(yankee) { _fun00002_ip = 579; continue _fun00001 }
 563:
            yankee = tangon.userIds;
            tangon = yankee.has;
            zuuluu = tangon.bind(yankee)(backup);
 579:
            michal = zuuluu;
 582:
            entity = michal;
 585:
            ...
            zuuluu = yankee.useEmbeddedActivityJoinability;
            michal = {};
            ...
            backup = undefined;
            if(output) { _fun00002_ip = 640; continue _fun00001 }
 635:
            backup = sizing.id;
 640:
            ...
            michal['application'] = foxtra;
            output = zuuluu.bind(yankee)(michal);
            _closure2_slot7 = output;
            zuuluu = _closure1_slot0;
            michal = _closure1_slot2;
            michal = michal[tangon];
            michal = zuuluu.bind(report)(michal);
            michal = michal.EmbeddedActivityJoinability;
            sizing = michal.CAN_JOIN;
            michal = record.length;
            if(!(!(michal > oscard))) { _fun00002_ip = 770; continue _fun00001 }
 704:
            zuuluu = _closure1_slot0;
            ...
            michal = zuuluu.bind(report)(michal);
            michal = michal.t;
            zuuluu = michal.7Uuia2;
            michal = {};
            michal['username'] = romeon;
            cntext = tangon.bind(yankee)(zuuluu, michal);
 ...
 770:
            ...
            michal = zuuluu.bind(report)(michal);
            michal = michal.t;
            zuuluu = michal.cpe6CA;
            michal = {};
            michal['username'] = romeon;
            romeon = record.length;
            romeon = romeon - oscard;
            michal['count'] = romeon;
            cntext = tangon.bind(yankee)(zuuluu, michal);
 845:
            if(entity) { _fun00002_ip = 1422; continue _fun00001 }
 851:
            ...
            entity = {};
            tangon = 'button';
            entity['accessibilityRole'] = tangon;
            ctrled = 23;
            tangon = sequen[ctrled];
            tangon = echoed.bind(report)(tangon);
            backup = tangon.intl;
            romeon = backup.formatToPlainString;
            tangon = sequen[ctrled];
            tangon = echoed.bind(report)(tangon);
            tangon = tangon.t;
            yankee = tangon.Yw5Hr6;
            tangon = {};
            tangon['applicationName'] = source;
            tangon = romeon.bind(backup)(yankee, tangon);
            entity['accessibilityLabel'] = tangon;
            tangon = _closure1_slot15;
            entity['androidRippleConfig'] = tangon;
            entity['onPress'] = vacuum;
            tangon = option.pressableOpacity;
            entity['style'] = tangon;
            romeon = _closure1_slot10;
            result = _closure1_slot1;
            tangon = 31;
            tangon = sequen[tangon];
            yankee = result.bind(report)(tangon);
            tangon = {};
            tangon['application'] = foxtra;
            foxtra = 'cover';
            tangon['resizeMode'] = foxtra;
            yankee = romeon.bind(report)(yankee, tangon);
            tangon = new Array(2);
            tangon[0] = yankee;
            foxtra = _closure1_slot11;
            romeon = _closure1_slot5;
            yankee = {};
            papara = option.activityPreview;
            backup = new Array(2);
            backup[0] = papara;
            backup[1] = update;
            yankee['style'] = backup;
 ...
 84:
                    ...
                    oscard['radius'] = offset;
                    golfie = golfie[verify];
                    golfie = option.bind(zuuluu)(golfie);
                    golfie = golfie.CutoutDirection;
                    golfie = golfie.RIGHT;
                    oscard['direction'] = golfie;
                    golfie = -6;
                    oscard['inset'] = golfie;
                    report = oscard;
 177:
            ...
            update = {};
            papara = option.subtitleText;
            update['style'] = papara;
            papara = 2;
            update['numberOfLines'] = papara;
            ...
            result = {};
            sequen = option.titleText;
            result['style'] = sequen;
            result['children'] = source;
            result = update.bind(report)(echoed, result);
            backup[2] = result;
            kiloes = null;
            if(!(output === sizing)) { _fun00002_ip = 1392; continue _fun00001 }
 1260:
 ...
 1392:
            ...
            _fun00002_ip = 1541; continue _fun00001;
 1422:
            tangon = _closure1_slot10;
            zuuluu = _closure1_slot0;
            yankee = _closure1_slot2;
            ...
            option = option.activityViewContainer;
            michal['style'] = option;
            michal['onPress'] = golfie;
            michal['activeOpacity'] = oscard;
 ...
 1541:
    ...
    golfie = oscard[golfie];
    golfie = report.bind(entity)(golfie);
    golfie = golfie.ActivityLayoutMode;
    var _closure1_slot9 = golfie;
    golfie = 8;
    golfie = oscard[golfie];
    golfie = report.bind(entity)(golfie);
    golfie = golfie.getThemedRippleConfig;
    verify = 9;
    ...
    foxtra = verify.XSMALL;
    var _closure1_slot12 = foxtra;
    var _closure1_slot13 = tangon;
    tangon = 100;
    var _closure1_slot14 = tangon;
    tangon = {};
    tangon['foreground'] = option;
    ...
    tangon['pressableOpacity'] = verify;
    ...
    tangon['activityViewContainer'] = verify;
    ...
    verify['color'] = kiloes;
    kiloes = backup.DISPLAY_EXTRABOLD;
    ...
    tangon = 'modules/video_calls/native/components/ActivityTile.tsx';
    tangon = report.bind(oscard)(tangon);
    michal = function(argFoo) { // Original name: ActivityTile
        tangon = _closure1_slot10;
