// app/modules/group_dm/native/ChatGDMCustomize.tsx
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
    ...
    tangon['rateLimitedContainer'] = offset;
    offset = {};
    foxtra = 12;
 ...
 0:
            ...
            entity = tangon.useRef;
            option = null;
            golfie = entity.bind(tangon)(option);
            ...
            entity = {};
            source = true;
            entity['includeKeyboardHeightIOS'] = source;
            entity['scrollViewRef'] = golfie;
            ...
            entity = romeon.bind(foxtra)(tangon, entity);
            ...
            offset = '';
            if(!verify) { _fun00002_ip = 217; continue _fun00001 }
 214:
            offset = tangon;
 217:
            verify = _closure1_slot1;
            ...
            backup = verify.bind(romeon)(option);
            _closure2_slot4 = backup;
            verify = romeon.useState;
            romeon = verify.bind(romeon)(report);
            verify = _closure1_slot4;
            status = 2;
            verify = verify.bind(report)(romeon, status);
            romeon = 0;
            papara = verify[romeon];
            _closure2_slot5 = papara;
            sizing = 1;
            ctrled = verify[sizing];
            verify = option != papara;
            vacuum = offset;
            if(!verify) { _fun00002_ip = 323; continue _fun00001 }
 314:
            offset = papara.length;
            verify = offset > romeon;
 323:
            if(!verify) { _fun00002_ip = 330; continue _fun00001 }
 326:
            verify = papara !== tangon;
 330:
            _closure2_slot6 = verify;
            foxtra = _closure1_slot5;
            offset = foxtra.useState;
            foxtra = offset.bind(foxtra)(report);
            offset = _closure1_slot4;
            offset = offset.bind(report)(foxtra, status);
            cntext = offset[romeon];
            _closure2_slot7 = cntext;
            update = offset[sizing];
            _closure2_slot8 = update;
            output = 'CLEARED_ICON';
            echoed = undefined;
            if(!(cntext !== output)) { _fun00002_ip = 413; continue _fun00001 }
 386:
            offset = cntext;
            if(!(option == offset)) { _fun00002_ip = 410; continue _fun00001 }
 393:
 ...
 410:
            echoed = offset;
 413:
            foxtra = option == entity;
            offset = undefined;
            if(foxtra) { _fun00002_ip = 432; continue _fun00001 }
 422:
            foxtra = entity.isManaged;
            offset = foxtra.bind(entity)();
 432:
            kiloes = source !== offset;
            offset = kiloes;
            if(!offset) { _fun00002_ip = 477; continue _fun00001 }
 442:
            foxtra = option != cntext;
            if(!foxtra) { _fun00002_ip = 453; continue _fun00001 }
 449:
            foxtra = cntext !== output;
 453:
 ...
 477:
            ...
            result = sequen.useMemo;
            output = new Array(2);
            output[0] = entity;
            output[1] = target;
            foxtra = function() {
                entity = {};
                zuuluu = function(argFoo) { // Original name: makeURL
 ...
 64:
                        ...
                        report = oscard.getApplicationId;
 ...
 33:
                        ...
                        michal = undefined;
                        if(!tangon) { _fun00006_ip = 48; continue _fun00005 }
 42:
                        michal = 'CLEARED_ICON';
 48:
            ...
            output = result.bind(sequen)(foxtra, output);
            result = sequen.useCallback;
            foxtra = new Array(2);
            foxtra[0] = verify;
            foxtra[1] = cntext;
            verify = function() {
 ...
 20:
            ...
            foxtra = result.bind(sequen)(verify, foxtra);
            _closure2_slot9 = foxtra;
            verify = sequen.useState;
            verify = verify.bind(sequen)(option);
            config = _closure1_slot4;
            verify = config.bind(report)(verify, status);
            result = verify[romeon];
            _closure2_slot10 = result;
            verify = verify[sizing];
            _closure2_slot11 = verify;
            sierra = sequen.useState;
            verify = false;
            verify = sierra.bind(sequen)(verify);
            verify = config.bind(report)(verify, status);
            romeon = verify[romeon];
            verify = verify[sizing];
            _closure2_slot12 = verify;
            config = sequen.useCallback;
 ...
 0:
                        ...
                        if(zuuluu) { _fun00010_ip = 506; continue _fun00009 }
 10:
                        report = undefined;
                        golfie = undefined;
                        tangon = undefined;
 16: // try_start_0 // try_start_2
                        ...
                        zuuluu = option;
                        if(!option) { _fun00010_ip = 60; continue _fun00009 }
 46:
 ...
 63:
                        ...
                        offset = yankee.setIcon;
                        option = _closure2_slot0;
                        foxtra = _closure2_slot7;
                        romeon = 'CLEARED_ICON';
                        zuuluu = null;
                        if(!(foxtra !== romeon)) { _fun00010_ip = 116; continue _fun00009 }
 112:
                        zuuluu = _closure2_slot7;
 116:
 ...
 132: // try_end0 // try_end2
                        offset = _closure2_slot12;
                        option = false;
                        option = offset.bind(report)(option);
                        return zuuluu;
 146: // try_start_1 // try_start_3
                        option = _closure2_slot5;
                        option = verify != option;
                        zuuluu = option;
                        if(!option) { _fun00010_ip = 175; continue _fun00009 }
 160:
                        option = _closure2_slot5;
 ...
 225:
                        ResumeGenerator(result_out_reg=2, return_bool_out_reg=7);
                        if(option) { _fun00010_ip = 244; continue _fun00009 }
 231:
 ...
 244: // try_end3
                        ...
                        return zuuluu;
 258: // try_start_4 // catch_target0 // catch_target1
                        ...
                        zuuluu = undefined;
                        if(option) { _fun00010_ip = 288; continue _fun00009 }
 282:
                        zuuluu = golfie.retry_after;
 288:
                        if(!(oscard == zuuluu)) { _fun00010_ip = 436; continue _fun00009 }
 295:
 ...
 506:
            ...
            sizing = sizing.bind(report)(verify);
            verify = new Array(4);
            verify[0] = target;
            verify[1] = papara;
            verify[2] = cntext;
            verify[3] = record;
            sizing = config.bind(sequen)(sizing, verify);
            config = sequen.useEffect;
            verify = new Array(1);
            verify[0] = tangon;
            tangon = function() {
 ...
 42:
            ...
            tangon = config.bind(sequen)(tangon, verify);
            config = sequen.useEffect;
            verify = new Array(1);
            verify[0] = result;
            tangon = function() {
 ...
 50:
            ...
            tangon = config.bind(sequen)(tangon, verify);
            verify = sequen.useImperativeHandle;
            tangon = argBar;
            zuuluu = function() {
                entity = {};
            ...
            zuuluu = verify.bind(sequen)(tangon, zuuluu);
            if(!(option != entity)) { _fun00002_ip = 1542; continue _fun00001 }
 727:
            ...
            config = config.PX_16;
            golfie['paddingHorizontal'] = config;
            yankee = yankee.bottom;
            golfie['paddingBottom'] = yankee;
            ...
            golfie = {};
            sequen = oscard.iconUploader;
            golfie['style'] = sequen;
            golfie['onUpload'] = update;
            golfie['icon'] = echoed;
            echoed = output.makeURL;
            golfie['makeURL'] = echoed;
            kiloes = !kiloes;
            golfie['disabled'] = kiloes;
            verify = yankee.bind(report)(verify, golfie);
            golfie = new Array(5);
            golfie[0] = verify;
            verify = null;
            if(!offset) { _fun00002_ip = 1032; continue _fun00001 }
 878:
            ...
            echoed = output.Text;
            output = {'style': null, 'variant': 'text-sm/semibold', 'color': 'text-link'};
            update = oscard.iconClear;
            output['style'] = update;
            update = 16;
            sequen = cntext[update];
 ...
 1032:
            ...
            update = output.TextInput;
            output = {};
            output['ref'] = backup;
            backup = 16;
            sequen = kiloes[backup];
            ...
            sequen = echoed.bind(report)(sequen);
            sequen = sequen.t;
            sequen = sequen.GEGW3N;
            sequen = config.bind(record)(sequen);
            output['label'] = sequen;
            output['placeholder'] = vacuum;
            output['onChange'] = ctrled;
            output['isDisabled'] = romeon;
            output['isClearable'] = source;
            output = yankee.bind(report)(update, output);
            ...
            kiloes = kiloes.t;
            kiloes = kiloes.K344S0;
            kiloes = sizing.bind(output)(kiloes);
            verify['text'] = kiloes;
            sizing = foxtra.bind(report)();
            kiloes = 'secondary';
            if(!sizing) { _fun00002_ip = 1268; continue _fun00001 }
 1264:
            kiloes = 'primary';
 1268:
            ...
            foxtra = !foxtra;
            if(foxtra) { _fun00002_ip = 1286; continue _fun00001 }
 1282:
 ...
 1317:
            ...
            offset = _closure1_slot7;
            verify = {};
            romeon = oscard.rateLimitedContainer;
            verify['style'] = romeon;
            kiloes = _closure1_slot9;
            ...
            foxtra = romeon.Text;
            romeon = {'variant': 'text-sm/semibold', 'color': 'text-danger'};
 ...
 1526:
            ...
            _fun00002_ip = 1567; continue _fun00001;
 1542:
 ...
 1567:
    ...
    tangon = 'modules/group_dm/native/ChatGDMCustomize.tsx';
