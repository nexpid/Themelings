...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
 ...
 0:
            ...
            entity = null;
            if(!(entity != report)) { _fun118412_ip = 38; continue _fun118412 }
 25:
            tango = report.isStaff;
            tango = tango.bind(report)();
            if(tango) { _fun118412_ip = 68; continue _fun118412 }
 38:
            if(!(entity != zulu)) { _fun118412_ip = 54; continue _fun118412 }
 42:
            tango = zulu.userLimit;
            entity = 0;
            if(!(!(tango > entity))) { _fun118412_ip = 60; continue _fun118412 }
 54:
            entity = _closure1_slot1;
            _fun118412_ip = 66; continue _fun118412;
 60:
            entity = zulu.userLimit;
 66:
            _fun118412_ip = 72; continue _fun118412;
 68:
