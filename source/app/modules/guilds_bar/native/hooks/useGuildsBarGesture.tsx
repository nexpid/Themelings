...
export default (function(argFoo, argBar, argBaz, argCor, argGra, argFre, argPlu) {
 ...
 477:
    ...
    tangon = {};
    golfie = "function useGuildsBarGestureTsx9(){const{gestureState,runOnJS,handleGestureEnd}=this.__closure;console.log('ZZZZZZ - Pan.onEnd');if(gestureState.get().mode==='drag'){runOnJS(handleGestureEnd)('drop');}else if(gestureState.get().mode==='contextmenu'){runOnJS(handleGestureEnd)('contextmenu-open');}else{runOnJS(handleGestureEnd)('cancel');}}";
    tangon['code'] = golfie;
    var _closure1_slot26 = tangon;
    tangon = {};
    golfie = "function useGuildsBarGestureTsx10(){const{runOnJS,handleGestureEnd}=this.__closure;runOnJS(handleGestureEnd)('cancel');}";
    tangon['code'] = golfie;
