...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
    ...
    tangon['keyboardOpenPadding'] = verify;
    backup = 16;
 ...
 0:
            ...
            echoed = entity.prefilledFromContactBook;
            tangon = undefined;
            if(!(echoed === tangon)) { _fun00002_ip = 36; continue _fun00001 }
 34:
            echoed = false;
 36:
 ...
 297:
            oscard = foxtra.keyboardOpenPadding;
 303:
            report[1] = oscard;
            entity['style'] = report;
 ...
 483:
            ...
            output = update.bind(tangon)(output, kiloes);
            kiloes = new Array(5);
            kiloes[0] = output;
            ...
            cntext = foxtra.subtitle;
            output['style'] = cntext;
            papara = _closure1_slot0;
            cntext = _closure1_slot2;
            target = cntext[source];
            ...
            papara = cntext.t;
            if(backup) { _fun00002_ip = 608; continue _fun00001 }
 593:
            cntext = papara.xI496O;
            cntext = target.bind(status)(cntext);
            _fun00002_ip = 621; continue _fun00001;
 608:
            papara = papara.xCHh/v;
 ...
 621:
            ...
            cntext = papara.bind(tangon)(cntext);
            cntext = cntext.ClearButtonVisibility;
            cntext = cntext.WITH_CONTENT;
            output['clearButtonVisibility'] = cntext;
