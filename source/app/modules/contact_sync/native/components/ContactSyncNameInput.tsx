...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    tango['keyboardOpenPadding'] = verify;
    backup = 16;
    verify = {'flex': 1, 'padding': 16, 'paddingBottom': 0};
    tango['content'] = verify;
    offset = 8;
    verify = {'marginBottom': 8, 'textAlign': 'center'};
    tango['title'] = verify;
    verify = {'lineHeight': 18, 'textAlign': 'center', 'marginBottom': 16};
    tango['subtitle'] = verify;
    verify = {'width': '100%', 'marginTop': 8, 'marginBottom': 12, 'padding': 12};
    kilo = oscar[yankee];
 ...
 0:
            ...
            tango = undefined;
            if(!(echo === tango)) { _fun94035_ip = 36; continue _fun94035 }
 34:
            echo = false;
 36:
            mike = entity.onNext;
            ...
            entity = entity.t;
            if(backup) { _fun94035_ip = 231; continue _fun94035 }
 218:
            report = entity.PDTjLC;
            config = mike.bind(zulu)(report);
            _fun94035_ip = 242; continue _fun94035;
 231:
 ...
 242:
            ...
            report = new Array(2);
            report[0] = golf;
            if(!oscar) { _fun94035_ip = 303; continue _fun94035 }
 297:
 ...
 303:
            ...
            context = control.t;
            if(backup) { _fun94035_ip = 468; continue _fun94035 }
 455:
            control = context.sO+NIy;
            control = papa.bind(target)(control);
            _fun94035_ip = 479; continue _fun94035;
 468:
 ...
 479:
            ...
            papa = context.t;
            if(backup) { _fun94035_ip = 606; continue _fun94035 }
 593:
            context = papa.xI496O;
            context = target.bind(status)(context);
            _fun94035_ip = 617; continue _fun94035;
 606:
            papa = papa.xCHh/v;
 ...
 617:
            ...
            update = output.Text;
            output = {'variant': 'eyebrow', 'color': 'interactive-normal'};
            ...
            update = update.bind(tango)(output);
            output = {'value': null, 'onChangeText': null, 'style': null, 'autoFocus': true, 'showBorder': false, 'showTopContainer': false};
            output['value'] = sequence;
            output['onChangeText'] = record;
            record = foxtrot.input;
            output['style'] = record;
            record = true;
            context = target[context];
            context = papa.bind(tango)(context);
            context = context.ClearButtonVisibility;
            context = context.WITH_CONTENT;
            output['clearButtonVisibility'] = context;
            output['autoCorrect'] = record;
            record = 'name';
            output['autoComplete'] = record;
            output['textContentType'] = record;
            output = control.bind(tango)(update, output);
            kilo[3] = output;
            output = null;
            if(!echo) { _fun94035_ip = 951; continue _fun94035 }
 845:
            update = _closure1_slot7;
            papa = _closure1_slot0;
            control = _closure1_slot2;
 ...
 951:
            ...
            kilo = {};
            yankee = backup;
            if(!yankee) { _fun94035_ip = 995; continue _fun94035 }
 989:
 ...
 995:
            ...
            echo['variant'] = record;
            record = 'lg';
            if(!backup) { _fun94035_ip = 1050; continue _fun94035 }
 1046:
            record = 'md';
 1050:
            echo['size'] = record;
 ...
 0:
                    ...
                    zulu = undefined;
                    entity = undefined;
                    if(tango) { _fun94038_ip = 28; continue _fun94038 }
 20:
