...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    yankee = function() { // Original name: onClose
 ...
 0:
                            ...
                            if(mike) { _fun94974_ip = 233; continue _fun94974 }
 10:
                            tango = argFoo;
 ...
 67:
                            ...
                            if(oscar) { _fun94974_ip = 97; continue _fun94974 }
 73:
 ...
 92: // try_end0
                            _fun94974_ip = 230; continue _fun94974;
 97:
                            return tango;
 100: // catch_target0
                            ...
                            tango = 12;
                            tango = verify[tango];
                            oscar = options.bind(mike)(tango);
                            report = oscar.open;
                            tango = {};
                            offset = 'ERROR_GENERIC_TITLE';
                            tango['key'] = offset;
 ...
 233:
            ...
            report = {};
            report['onNext'] = offset;
            options = function() { // Original name: onRemoveName
            ...
            report['onRemoveName'] = options;
            report['loading'] = golf;
            golf = null;
            offset = golf == verify;
            options = undefined;
            if(offset) { _fun94971_ip = 181; continue _fun94971 }
 176:
            options = verify.name;
 181:
            verify = golf != options;
            golf = '';
            if(!verify) { _fun94971_ip = 195; continue _fun94971 }
 192:
            golf = options;
 195:
            report['initialName'] = golf;
    ...
    tango = {};
    options = golf.NAME_INPUT;
    golf = {'render': null, 'ignoreKeyboard': true, 'fullscreen': true, 'headerLeft': null, 'title': ''};
    ...
    tango = 'modules/contact_sync/native/components/ContactSyncNameUpdateModal.tsx';
    tango = report.bind(oscar)(tango);
    mike = function() { // Original name: ContactSyncNameUpdateModal
        tango = _closure1_slot8;
        mike = _closure1_slot0;
