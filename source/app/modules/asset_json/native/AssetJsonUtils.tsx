...
export default (function(argFoo, argBar, argBaz, _, __, argFre, argPlu) {
 ...
 218:
                    ...
                    romeon = verify.RNIntlManager;
                    verify = romeon.preload;
 ...
 393:
                    ...
                    offset = oscard.Proxy;
                    verify = {};
                    golfie = function(argFoo, argBar) { // Original name: get
 ...
 0:
                            ...
                            golfie = undefined;
                            report = 'toString';
                            if(!(report !== oscard)) { _fun00004_ip = 226; continue _fun00003 }
 26:
                            oscard = michal;
                            report = '$$typeof';
                            if(!(report !== oscard)) { _fun00004_ip = 220; continue _fun00003 }
 40:
                            option = michal;
                            report = global;
                            oscard = report.Symbol;
                            oscard = oscard.toStringTag;
                            if(!(option !== oscard)) { _fun00004_ip = 212; continue _fun00003 }
 64:
                            option = michal;
                            oscard = 'then';
                            if(!(oscard === option)) { _fun00004_ip = 77; continue _fun00003 }
 75:
                            return tangon;
 77:
                            oscard = michal;
                            report = report.Symbol;
                            report = report.iterator;
                            if(!(oscard !== report)) { _fun00004_ip = 205; continue _fun00003 }
 96:
                            oscard = michal;
                            report = zuuluu;
 ...
 109: // try_start_0
                            ...
                            yankee = option.RNIntlManager;
                            offset = yankee.getTranslationObject;
 ...
 205:
                            michal = function() {
                                ...
                                tangon = 'Cannot iterate over a proxy';
                                report = michal;
 ...
 226:
                    ...
                    result = option;
                    sizing = verify;
                    golfie = new result[offset](output, sizing, kiloes);
 ...
 468:
                    ...
                    output = "RTNFileManager doesn't exist?";
                    result = oscard;
