...
export default (function(argFoo, argBar, argBaz, _, __, argFre, argPlu) {
 ...
 70:
    ...
    tangon = tangon.CrashReportingManager;
    ...
    tangon = 'modules/debug/native/AppCrashedFatalReport.tsx';
    tangon = report.bind(oscard)(tangon);
    michal = function() { // Original name: init
        report = _closure1_slot4;
        tangon = report.addListener;
        zuuluu = 'onCrashReportsReceived';
        michal = function(argFoo) {
            _fun00007: for(var _fun00008_ip = 0; ; ) switch(_fun00008_ip) {
 0:
                entity = argFoo;
                zuuluu = entity.reports;
 ...
 45:
                ...
                yankee = backup.bind(entity)(michal);
                offset = yankee.track;
                michal = _closure1_slot2;
                verify = michal.APP_NATIVE_CRASH;
                michal = {};
                michal['did_crash'] = report;
                romeon = romeon[tangon];
                romeon = backup.bind(entity)(romeon);
                sizing = romeon.bind(entity)(foxtra);
                output = michal;
 ...
 133:
        ...
        entity = michal.initializeManager;
