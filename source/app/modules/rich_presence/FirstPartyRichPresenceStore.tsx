...
export default (function(argFoo, argBar, argBaz, _, __, argFre, argPlu) {
 ...
 36:
            option = tangon.value;
            entity = option.getActivity;
            option = entity.bind(option)();
            if(!(oscard != option)) { _fun00010_ip = 65; continue _fun00009 }
 55:
            entity = zuuluu.push;
 ...
 122:
    ...
    michal = function(argFoo) {
        tangon = function() { // Original name: FirstPartyRichPresenceStore
 ...
 105:
    ...
    michal = 'FirstPartyRichPresenceStore';
    oscard['displayName'] = michal;
    michal = 8;
    ...
    tangon = 'modules/rich_presence/FirstPartyRichPresenceStore.tsx';
