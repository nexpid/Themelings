...
export default (function(_, argBar, argBaz, __, ___, argFred, argPlugh) {
    ...
    tango = 'modules/screen/native/useIsWindowSmall.tsx';
    tango = report.bind(oscar)(tango);
    tango = function() { // Original name: getIsWindowSmall
    ...
    zulu['default'] = tango;
    mike = function() { // Original name: useIsWindowSmall
