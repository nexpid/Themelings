...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
 ...
 0:
            ...
            report = oscar == tango;
            tango = undefined;
            if(report) { _fun47635_ip = 98; continue _fun47635 }
 69:
 ...
 98:
            ...
            tango = oscar == tango;
            verify = undefined;
            if(tango) { _fun47635_ip = 163; continue _fun47635 }
 134:
            report = _closure1_slot1;
            tango = _closure1_slot2;
            tango = tango[offset];
 ...
 163:
            if(!(oscar == verify)) { _fun47635_ip = 185; continue _fun47635 }
 167:
            report = _closure1_slot3;
            tango = report.get;
            zulu = 'screen';
 ...
 185:
            ...
            offset = oscar == entity;
            zulu = undefined;
            if(offset) { _fun47635_ip = 220; continue _fun47635 }
 214:
 ...
 220:
            ...
            backup = options;
            yankee = verify;
            if(!(yankee === kilo)) { _fun47635_ip = 256; continue _fun47635 }
 250:
            backup = verify;
            yankee = options;
 256:
            ...
            offset = oscar == zulu;
            golf = undefined;
            if(offset) { _fun47635_ip = 352; continue _fun47635 }
 347:
            golf = zulu.width;
 352:
            if(!(golf === verify)) { _fun47635_ip = 365; continue _fun47635 }
 356:
            golf = zulu.height;
            if(!(golf !== options)) { _fun47635_ip = 378; continue _fun47635 }
 365:
            golf = {};
            golf['width'] = verify;
            golf['height'] = options;
 ...
 378:
            oscar = oscar == entity;
            mike = undefined;
            if(oscar) { _fun47635_ip = 393; continue _fun47635 }
 387:
            mike = entity.windowDimensions;
 393:
            if(!(mike === zulu)) { _fun47635_ip = 417; continue _fun47635 }
 397:
            mike = entity.fontScale;
            if(!(mike === report)) { _fun47635_ip = 417; continue _fun47635 }
 407:
            mike = entity.screenIsLandscape;
            if(!(mike !== tango)) { _fun47635_ip = 437; continue _fun47635 }
 417:
            mike = {};
