...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
    ...
    tangon = 'modules/message_request/hooks/useSortedSpamMessageRequests.tsx';
    tangon = report.bind(oscard)(tangon);
    michal = function() { // Original name: useSortedSpamMessageRequests
        ...
        oscard = function() {
            ...
            zuuluu = oscard.getSpamChannelIds;
