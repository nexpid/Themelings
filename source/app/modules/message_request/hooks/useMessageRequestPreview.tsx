...
export default (function(argFoo, argBar, argBaz, _, __, argFre, argPlu) {
 ...
 0:
                    StartGenerator();
                    ResumeGenerator(result_out_reg=0, return_bool_out_reg=1);
                    if(michal) { _fun00010_ip = 472; continue _fun00009 }
 10:
                    report = undefined;
                    zuuluu = undefined;
                    oscard = undefined;
                    ...
                    option = 0;
                    michal = 25;
                    zuuluu = verify.bind(offset)(option, michal);
 ...
 203: // try_end1
                    ...
                    oscard = option;
                    option = option.done;
                    if(option) { _fun00010_ip = 273; continue _fun00009 }
 233:
                    option = oscard;
                    offset = option.value;
 ...
 358:
                    ...
                    oscard = michal;
                    michal = michal.done;
                    if(!michal) { _fun00010_ip = 358; continue _fun00009 }
 398:
                    return report;
 401: // catch_target1 // catch_target2
                    CatchBlockStart(arg_register=1);
                    option = _closure1_slot10;
                    ...
                    oscard = zuuluu;
                    zuuluu = zuuluu.done;
                    if(zuuluu) { _fun00010_ip = 470; continue _fun00009 }
 430:
                    zuuluu = oscard;
                    verify = zuuluu.value;
                    option = _closure1_slot8;
