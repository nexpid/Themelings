...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
                    ...
                    entity = undefined;
                    zulu = undefined;
                    if(report) { _fun113760_ip = 29; continue _fun113760 }
 20:
                    report = _closure2_slot1;
                    zulu = report.id;
 29:
                    if(!(tango != zulu)) { _fun113760_ip = 100; continue _fun113760 }
 33:
 ...
 0:
                    ...
                    zulu = entity != zulu;
                    entity = undefined;
                    if(!zulu) { _fun113761_ip = 45; continue _fun113761 }
 18:
 ...
 0:
                    ...
                    if(tango) { _fun113763_ip = 175; continue _fun113763 }
 18:
 ...
 0:
                            ...
                            zulu = _closure1_slot6;
                            zulu = zulu.ONLINE;
                            if(!(mike !== zulu)) { _fun113767_ip = 154; continue _fun113767 }
 25:
                            zulu = _closure1_slot6;
                            zulu = zulu.OFFLINE;
                            if(!(mike !== zulu)) { _fun113767_ip = 95; continue _fun113767 }
 39:
                            report = _closure2_slot2;
                            zulu = null;
                            golf = zulu == report;
                            report = undefined;
                            if(golf) { _fun113767_ip = 79; continue _fun113767 }
 57:
 ...
 79:
                            oscar = zulu != report;
                            zulu = '';
                            if(!oscar) { _fun113767_ip = 93; continue _fun113767 }
 90:
                            zulu = report;
 93:
                            _fun113767_ip = 152; continue _fun113767;
 95:
 ...
 152:
                            _fun113767_ip = 211; continue _fun113767;
 154:
 ...
 211:
                            ...
                            oscar = tango == zulu;
                            zulu = undefined;
                            if(oscar) { _fun113767_ip = 256; continue _fun113767 }
 233:
 ...
 250:
                            zulu = report.userIds;
 256:
                            if(!(tango == zulu)) { _fun113767_ip = 264; continue _fun113767 }
 260:
                            zulu = new Array(0);
 264:
                            entity['userIds'] = zulu;
 ...
 175:
            ...
            if(!(zulu == tango)) { _fun113759_ip = 219; continue _fun113759 }
 215:
            entity = _closure1_slot7;
 219:
            return entity;
