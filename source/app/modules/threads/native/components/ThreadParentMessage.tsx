...
export default (function(native1, native2, native3, native4, native5, native6, native7) {
    ...
    var4 = {'renderCodedLinks': false, 'renderGiftCode': false, 'renderActivityInstanceEmbed': false, 'renderActivityInviteEmbed': false, 'renderEmbeds': true, 'ignoreMentioned': true, 'inlineAttachmentMedia': true, 'inlineEmbedMedia': true, 'renderReactions': false, 'renderReplies': true, 'renderThreadEmbeds': false};
