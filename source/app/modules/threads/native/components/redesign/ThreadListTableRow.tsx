...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    entity = function(argFoo) { // Original name: ThreadListTableRow
        mike = argFoo;
        backup = mike.thread;
 ...
 17:
        ...
        romeo = yankee.ThreadSubtext;
        yankee = {};
        yankee['thread'] = backup;
    ...
    tango = {};
    offset = {'maxWidth': '100%', 'marginTop': 2};
 ...
 127:
    ...
    tango = 'modules/threads/native/components/redesign/ThreadListTableRow.tsx';
