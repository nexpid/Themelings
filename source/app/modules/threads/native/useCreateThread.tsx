...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
    ...
    tangon = 'modules/threads/native/useCreateThread.tsx';
    tangon = report.bind(oscard)(tangon);
    tangon = function(argFoo) { // Original name: useCreateThread
        entity = argFoo;
        yankee = entity.parentChannel;
        var _closure2_slot0 = yankee;
        offset = entity.parentMessageId;
        verify = entity.threadSettings;
        option = entity.privateThreadMode;
        golfie = entity.location;
        oscard = entity.onThreadCreated;
        ...
        michal = zuuluu.useCreateThreadCommon;
        entity = {};
        entity['parentChannel'] = yankee;
        entity['parentMessageId'] = offset;
        entity['threadSettings'] = verify;
        entity['privateThreadMode'] = option;
        entity['location'] = golfie;
        entity['onThreadCreated'] = oscard;
        entity['useDefaultThreadName'] = report;
        tangon = function(argFoo, argBar, argBaz) { // Original name: uploadHandler
 ...
 0:
            entity = argFoo;
            golfie = entity.parentChannel;
            var _closure2_slot0 = golfie;
            verify = entity.threadSettings;
            oscard = entity.appliedTags;
            ...
            michal = zuuluu.useCreateForumPostCommon;
            entity = {};
            entity['parentChannel'] = golfie;
            golfie = null;
            offset = golfie == verify;
            if(offset) { _fun00004_ip = 115; continue _fun00003 }
 110:
            option = verify.name;
 115:
 ...
 129:
            entity['name'] = golfie;
            entity['appliedTags'] = oscard;
            entity['onThreadCreated'] = report;
            tangon = function(argFoo, argBar, argBaz) { // Original name: upload
                michal = argFoo;
 ...
 0:
                                ...
                                if(!(michal > entity)) { _fun00008_ip = 167; continue _fun00007 }
 23:
                                ...
                                entity['draftType'] = offset;
                                offset = true;
                                entity['resetState'] = offset;
 ...
 0:
                                ...
                                michal = michal.ENTITY_TOO_LARGE;
                                if(!(tangon === michal)) { _fun00010_ip = 81; continue _fun00009 }
 20:
                                michal = _closure1_slot1;
                                zuuluu = _closure1_slot2;
                                entity = 12;
 ...
 0:
                                ...
                                option = argBar;
                                report = null;
                                if(!(report != tangon)) { _fun00012_ip = 434; continue _fun00011 }
 17:
                                if(!(report != option)) { _fun00012_ip = 434; continue _fun00011 }
 24:
                                ...
                                if(!(golfie === michal)) { _fun00012_ip = 416; continue _fun00011 }
 104:
                                ...
                                golfie = golfie.bind(zuuluu)(michal);
                                michal = golfie.createNonce;
                                verify = michal.bind(golfie)();
                                var _closure5_slot0 = verify;
                                michal = tangon.attachments;
                                if(!(report != michal)) { _fun00012_ip = 168; continue _fun00011 }
 148:
                                michal = tangon.attachments;
                                report = michal.length;
                                michal = 0;
                                if(!(!(report > michal))) { _fun00012_ip = 306; continue _fun00011 }
 168:
 ...
 306:
                                ...
                                entity = {};
                                oscard = function() { // Original name: importer
 ...
 434:
    ...
    zuuluu['useCreateForumPost'] = michal;
    return entity;
})();