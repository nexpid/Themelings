...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
                    ...
                    if(mike) { _fun65424_ip = 67; continue _fun65424 }
 10:
                    mike = null;
                    mike = mike == golf;
                    if(mike) { _fun65424_ip = 64; continue _fun65424 }
 19:
 ...
 52:
                    ...
                    mike = zulu;
                    if(!tango) { _fun65424_ip = 64; continue _fun65424 }
 61:
                    return zulu;
 64:
                    return mike;
 ...
 0:
                    ...
                    options = argBaz;
                    ResumeGenerator(result_out_reg=0, return_bool_out_reg=1);
                    if(mike) { _fun65428_ip = 339; continue _fun65428 }
 16:
                    zulu = _closure1_slot6;
                    mike = zulu.getGuild;
                    tango = mike.bind(zulu)(oscar);
                    zulu = null;
                    if(!(zulu != tango)) { _fun65428_ip = 334; continue _fun65428 }
 42:
                    mike = zulu != tango;
                    if(!mike) { _fun65428_ip = 87; continue _fun65428 }
 49:
                    verify = tango.features;
                    tango = zulu == verify;
                    zulu = undefined;
                    if(tango) { _fun65428_ip = 84; continue _fun65428 }
 64:
                    golf = verify.has;
 ...
 84:
                    mike = zulu;
 87:
                    if(mike) { _fun65428_ip = 95; continue _fun65428 }
 90:
                    zulu = true;
                    return zulu;
 95:
                    if(!mike) { _fun65428_ip = 113; continue _fun65428 }
 98:
                    tango = _closure1_slot7;
                    zulu = tango.shouldFetchPrompts;
                    mike = zulu.bind(tango)(oscar);
 113:
                    if(!mike) { _fun65428_ip = 162; continue _fun65428 }
 116:
 ...
 153:
                    ...
                    if(zulu) { _fun65428_ip = 331; continue _fun65428 }
 162:
                    tango = _closure1_slot7;
                    ...
                    if(zulu) { _fun65428_ip = 258; continue _fun65428 }
 253:
                    zulu = true;
                    return zulu;
 258:
                    zulu = options.removingView;
                    if(!zulu) { _fun65428_ip = 284; continue _fun65428 }
 267:
                    tango = tango.length;
                    verify = tango - golf;
 ...
 284:
                    ...
                    if(tango) { _fun65428_ip = 299; continue _fun65428 }
 293:
                    tango = options.removingView;
 299:
                    if(!tango) { _fun65428_ip = 319; continue _fun65428 }
 302:
                    oscar = oscar.length;
                    oscar = oscar - golf;
 ...
 319:
                    zulu = !zulu;
                    if(!zulu) { _fun65428_ip = 328; continue _fun65428 }
 325:
                    zulu = !tango;
 328:
                    return zulu;
 ...
 0:
                    ...
                    offset = argBaz;
                    ResumeGenerator(result_out_reg=0, return_bool_out_reg=1);
                    if(mike) { _fun65431_ip = 717; continue _fun65431 }
 19:
                    mike = zulu.getGuildId;
                    golf = mike.bind(zulu)();
                    tango = null;
                    if(!(tango != golf)) { _fun65431_ip = 712; continue _fun65431 }
 38:
                    romeo = options;
                    if(!(tango != offset)) { _fun65431_ip = 101; continue _fun65431 }
 45:
 ...
 101:
                    ...
                    mike = mike[golf];
                    if(!(tango == mike)) { _fun65431_ip = 155; continue _fun65431 }
 115:
                    ...
                    _fun65431_ip = 223; continue _fun65431;
 155:
 ...
 223:
                    ...
                    if(!mike) { _fun65431_ip = 315; continue _fun65431 }
 274:
 ...
 315:
                    ...
                    tango = options.has;
                    mike = _closure1_slot11;
                    if(backup) { _fun65431_ip = 430; continue _fun65431 }
 366:
                    backup = mike.SEND_MESSAGES;
                    backup = tango.bind(options)(romeo, backup);
                    if(!backup) { _fun65431_ip = 422; continue _fun65431 }
 381:
 ...
 422:
                    ...
                    _fun65431_ip = 492; continue _fun65431;
 430:
                    mike = mike.SEND_MESSAGES_IN_THREADS;
                    mike = tango.bind(options)(romeo, mike);
                    if(!mike) { _fun65431_ip = 486; continue _fun65431 }
 445:
 ...
 492:
                    ...
                    mike = !mike;
                    if(!mike) { _fun65431_ip = 513; continue _fun65431 }
 504:
                    tango = oscar.removingView;
                    mike = !tango;
 513:
                    if(mike) { _fun65431_ip = 709; continue _fun65431 }
 519:
 ...
 539:
                    ResumeGenerator(result_out_reg=2, return_bool_out_reg=3);
                    if(tango) { _fun65431_ip = 706; continue _fun65431 }
 548:
                    oscar = !zulu;
                    tango = !oscar;
                    if(!oscar) { _fun65431_ip = 701; continue _fun65431 }
 560:
 ...
 701:
                    mike = tango;
                    _fun65431_ip = 709; continue _fun65431;
 706:
                    return zulu;
 709:
                    return mike;
