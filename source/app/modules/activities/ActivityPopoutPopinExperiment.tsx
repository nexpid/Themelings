...
export default (function(_, argBar, __, ___, ____, argFre, argPlu) {
    ...
    michal = {'kind': 'user', 'id': '2025-05_activity_popout__popin', 'label': 'Activity Pop-Out & Pop-In Experiment'};
    verify = {};
    yankee = false;
    ...
    verify = {'id': 1, 'label': 'Enable popping out an activity to another window and popping it back into the main Discord app window'};
    option = {};
    ...
    tangon = 'modules/activities/ActivityPopoutPopinExperiment.tsx';
