...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
    ...
    golfie = tangon.ActivityFeedbackReasons;
    ...
    tangon = 'modules/activities/native/ActivityFeedbackActionSheet.tsx';
    tangon = report.bind(oscard)(tangon);
    michal = function(argFoo) { // Original name: ActivityFeedbackActionSheet
        _fun00001: for(var _fun00002_ip = 0; ; ) switch(_fun00002_ip) {
 0:
            entity = argFoo;
            kiloes = entity.activityApplication;
 ...
 69:
            ...
            entity = {'headerLabel': null, 'showHeaderCloseButton': true, 'showDoNotShowAgainCheckbox': true};
            ...
            verify = yankee.bind(tangon)(verify);
            verify = verify.t;
            offset = verify.QXYwoK;
            verify = {};
            kiloes = kiloes.name;
            verify['applicationName'] = kiloes;
            ...
            oscard = function() { // Original name: trackOpen
                ...
                entity = {};
                oscard = 'Activity Feedback Sheet';
                entity['type'] = oscard;
                oscard = report.id;
                entity['application_id'] = oscard;
                oscard = report.name;
                entity['application_name'] = oscard;
                report = report.id;
                entity['game_id'] = report;
                report = 'Activity End';
 ...
 0:
                    zuuluu = argFoo;
                    tangon = zuuluu.rating;
                    michal = zuuluu.reason;
                    golfie = zuuluu.feedback;
                    entity = zuuluu.doNotShowAgain;
                    oscard = null;
                    option = oscard != michal;
                    report = null;
                    if(!option) { _fun00004_ip = 43; continue _fun00003 }
 38:
                    report = michal.value;
 43:
 ...
 78:
                    michal = zuuluu.rating;
 84:
                    entity['rating'] = michal;
                    foxtra = entity.applicationId;
                    romeon = entity.rating;
