...
export default (function(_, argBar, __, ___, ____, argFred, argPlugh) {
    ...
    mike = {'kind': 'user', 'id': '2025-02_activity_popout_window_v2', 'label': 'Activity Popout Window V2 Experiment'};
    verify = {};
    yankee = false;
    ...
    tango = 'modules/activities/ActivityPopoutWindowV2Experiment.tsx';
