...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
    ...
    tangon = {};
    option = 'function ActivityPanelFocusedViewTsx4(){const{IS_IOS,animatedKeyboardHeight,wrapperDimensions}=this.__closure;const keyboardHeight=IS_IOS?animatedKeyboardHeight.get():0;return{width:wrapperDimensions.width,height:wrapperDimensions.height-keyboardHeight};}';
    tangon['code'] = option;
 ...
 0:
            ...
            report = function() {
                ...
                entity = tangon.getEmbeddedActivityLocationChannelId;
 ...
 51:
            ...
            report = new Array(0);
            report = sizing.bind(echoed)(option, report);
            report = 12;
            report = backup[report];
            report = golfie.bind(romeon)(report);
            report = report.radii;
 ...
 509:
            ...
            result['animatedKeyboardHeight'] = kiloes;
 ...
 86:
            ...
            option = function() { // Original name: J
 ...
 28:
            ...
            backup['animatedKeyboardHeight'] = kiloes;
            backup['wrapperDimensions'] = foxtra;
            option['__closure'] = backup;
            backup = 10029372697959.0;
            ...
            if(!option) { _fun00002_ip = 857; continue _fun00001 }
 848:
 ...
 875:
            ...
            if(option) { _fun00002_ip = 888; continue _fun00001 }
 882:
            option = _closure1_slot10;
            _fun00002_ip = 892; continue _fun00001;
 888:
 ...
 70:
            ...
            offset = !tangon;
            if(offset) { _fun00002_ip = 948; continue _fun00001 }
 945:
            offset = !zuuluu;
 948:
