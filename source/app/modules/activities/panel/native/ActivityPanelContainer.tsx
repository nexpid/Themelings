...
export default (function(_, argBar, argBaz, argCorge, __, argFred, argPlugh) {
    ...
    mike = function() { // Original name: ActivityPanelContainer
        _fun121255: for(var _fun121255_ip = 0; ; ) switch(_fun121255_ip) {
 0:
 ...
 0:
                    ...
                    report = null;
                    if(!(report != tango)) { _fun121256_ip = 142; continue _fun121256 }
 23:
                    ...
                    mike = undefined;
                    oscar = undefined;
                    if(entity) { _fun121256_ip = 53; continue _fun121256 }
 48:
                    oscar = golf.type;
 53:
                    ...
                    entity = oscar === entity;
                    if(entity) { _fun121256_ip = 140; continue _fun121256 }
 92:
                    report = report == golf;
                    oscar = undefined;
                    if(report) { _fun121256_ip = 111; continue _fun121256 }
 101:
 ...
 111:
                    report = true;
                    mike = undefined;
                    if(!(report === oscar)) { _fun121256_ip = 137; continue _fun121256 }
 119:
 ...
 142:
            ...
            entity = null;
            if(!zulu) { _fun121255_ip = 139; continue _fun121255 }
 83:
