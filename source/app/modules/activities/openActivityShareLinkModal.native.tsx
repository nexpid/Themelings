...
export default (function(argFoo, argBar, argBaz, _, __, argFre, argPlu) {
    ...
    tangon = function(argFoo) {
        ...
        verify = entity.linkId;
        option = entity.message;
        zuuluu = entity.onShare;
        michal = entity.referrerId;
        ...
        tangon['customId'] = offset;
        tangon['linkId'] = verify;
        tangon['message'] = option;
        tangon['onShare'] = zuuluu;
        tangon['referrerId'] = michal;
        zuuluu = {};
        michal = 'modal';
