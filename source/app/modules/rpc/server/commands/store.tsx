...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
                    ...
                    if(mike) { _fun109678_ip = 127; continue _fun109678 }
 12:
                    mike = argFoo;
 ...
 0:
                                    StartGenerator();
                                    ResumeGenerator(result_out_reg=0, return_bool_out_reg=1);
                                    if(mike) { _fun109682_ip = 75; continue _fun109682 }
 7:
 ...
 63:
                                    ...
                                    if(zulu) { _fun109682_ip = 72; continue _fun109682 }
 69:
                                    return mike;
 72:
                                    return mike;
 ...
 90:
                    ResumeGenerator(result_out_reg=1, return_bool_out_reg=2);
                    if(zulu) { _fun109678_ip = 124; continue _fun109678 }
 96:
                    zulu = new Array(0);
 ...
 0:
                            zulu = argFoo;
                            entity = null;
                            if(!(entity != zulu)) { _fun109684_ip = 86; continue _fun109684 }
 11:
                            oscar = zulu.subscription_listings;
                            if(!(entity != oscar)) { _fun109684_ip = 84; continue _fun109684 }
 21:
                            report = new Array(0);
 ...
 0:
                                        ...
                                        entity = undefined;
                                        oscar = undefined;
                                        if(tango) { _fun109686_ip = 28; continue _fun109686 }
 22:
                                        oscar = report.price;
 28:
                                        ...
                                        if(!(mike != zulu)) { _fun109686_ip = 187; continue _fun109686 }
 59:
                                        tango = {};
                                        ...
                                        report = mike != zulu;
                                        mike = null;
                                        if(!report) { _fun109686_ip = 165; continue _fun109686 }
 162:
                                        mike = zulu;
 165:
 ...
 0:
                                    ...
                                    tango = mike == zulu;
                                    entity = undefined;
                                    if(tango) { _fun109688_ip = 20; continue _fun109688 }
 14:
                                    entity = zulu.price;
 20:
                                    entity = mike != entity;
 ...
 0:
                    StartGenerator();
                    ResumeGenerator(result_out_reg=0, return_bool_out_reg=1);
                    if(mike) { _fun109693_ip = 485; continue _fun109693 }
 12:
                    mike = argFoo;
                    tango = mike.socket;
                    oscar = undefined;
 ...
 27:
                    ResumeGenerator(result_out_reg=1, return_bool_out_reg=2);
                    if(zulu) { _fun109693_ip = 482; continue _fun109693 }
 36:
                    ...
                    options = tango.id;
                    tango = null;
                    if(!(tango != options)) { _fun109693_ip = 414; continue _fun109693 }
 95:
                    report = _closure1_slot6;
                    tango = report.inTestModeForApplication;
                    tango = tango.bind(report)(options);
                    if(tango) { _fun109693_ip = 301; continue _fun109693 }
 116:
 ...
 172:
                    ...
                    if(report) { _fun109693_ip = 298; continue _fun109693 }
 178:
                    verify = tango.filter;
 ...
 273:
                    ...
                    if(yankee) { _fun109693_ip = 295; continue _fun109693 }
 279:
                    kilo = verify;
                    backup = report;
                    foxtrot = offset;
 ...
 339:
                    ResumeGenerator(result_out_reg=3, return_bool_out_reg=4);
                    if(report) { _fun109693_ip = 411; continue _fun109693 }
 345:
 ...
 359:
                    ...
                    if(options) { _fun109693_ip = 408; continue _fun109693 }
 365:
 ...
 0:
            ...
            report = mike.id;
            mike = null;
            if(!(mike != report)) { _fun109699_ip = 100; continue _fun109699 }
 67:
 ...
 0:
                    StartGenerator();
                    ResumeGenerator(result_out_reg=0, return_bool_out_reg=1);
                    if(mike) { _fun109702_ip = 51; continue _fun109702 }
 7:
                    zulu = {};
 ...
 34:
                    ...
                    if(tango) { _fun109702_ip = 48; continue _fun109702 }
 40:
                    zulu['skus'] = mike;
                    return zulu;
 48:
 ...
 0:
                    StartGenerator();
                    ResumeGenerator(result_out_reg=0, return_bool_out_reg=1);
                    if(mike) { _fun109705_ip = 51; continue _fun109705 }
 7:
                    zulu = {};
 ...
 34:
                    ResumeGenerator(result_out_reg=1, return_bool_out_reg=3);
                    if(tango) { _fun109705_ip = 48; continue _fun109705 }
 40:
