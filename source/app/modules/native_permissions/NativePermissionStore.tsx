...
export default (function(argFoo, argBar, argBaz, _, __, argFre, argPlu) {
 ...
 74:
    ...
    tangon = tangon.NativePermissionStates;
    ...
    tangon = {};
    option = {};
    tangon['permissionStates'] = option;
 ...
 0:
                entity = _closure1_slot9;
                zuuluu = entity.permissionStates;
                entity = argFoo;
 ...
 43:
        ...
        entity[2] = report;
        report = {};
        golfie = 'handleSetNativePermission';
        report['key'] = golfie;
 ...
 0:
                entity = argFoo;
                golfie = entity.state;
                option = entity.permissionType;
                entity = _closure1_slot9;
                entity = entity.permissionStates;
                report = entity[option];
                entity[option] = golfie;
                if(!(report !== golfie)) { _fun00010_ip = 115; continue _fun00009 }
 39:
                ...
                michal = entity.PERMISSIONS_ACKED;
                entity = {};
                entity['type'] = option;
                entity['action'] = golfie;
                golfie = null;
                if(!(golfie == report)) { _fun00010_ip = 102; continue _fun00009 }
 92:
 ...
 115:
    ...
    tangon = 'NativePermissionStore';
    michal['displayName'] = tangon;
    tangon = 'NativePermissionsStore';
    michal['persistKey'] = tangon;
    tangon = 10;
    tangon = oscard[tangon];
    oscard = report.bind(entity)(tangon);
    report = oscard.fileFinishedImporting;
    tangon = 'modules/native_permissions/NativePermissionStore.tsx';
