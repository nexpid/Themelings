...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    entity = function(argFoo) { // Original name: PollDurationRadioGroup
        ...
        mike = function(argFoo) {
            ...
            oscar = report.AccessibilityAnnouncer;
            report = oscar.announce;
        ...
        report = function(argFoo) {
            _fun119361: for(var _fun119361_ip = 0; ; ) switch(_fun119361_ip) {
 0:
                zulu = argFoo;
                ...
                mike = mike === report;
                tango = undefined;
                if(mike) { _fun119361_ip = 27; continue _fun119361 }
 24:
                tango = oscar;
 27:
                oscar = undefined;
                if(mike) { _fun119361_ip = 57; continue _fun119361 }
 32:
                golf = zulu().value;
                zulu = entity;
                zulu = zulu === report;
                oscar = undefined;
                mike = zulu;
                if(zulu) { _fun119361_ip = 57; continue _fun119361 }
 51:
                oscar = golf;
                mike = zulu;
 57:
                if(mike) { _fun119361_ip = 63; continue _fun119361 }
 60:
                entity.return();
 63:
                zulu = _closure1_slot4;
    ...
    tango = 'modules/polls/native/PollDurationActionSheet.tsx';
    tango = report.bind(oscar)(tango);
    mike = function(argFoo) { // Original name: PollDurationActionSheet
        entity = argFoo;
