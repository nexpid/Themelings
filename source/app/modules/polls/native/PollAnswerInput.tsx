...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
 ...
 57:
            ...
            update = golfie;
            echoed = verify;
            option = sequen[option](vacuum, ctrled, source, update, echoed, result);
            verify = option.renderImage;
            romeon = option.upload;
            _closure2_slot2 = romeon;
            kiloes = option.setUploadSize;
 ...
 20:
                    ...
                    entity = zuuluu.emoji;
 30:
                    if(!(michal == entity)) { _fun00004_ip = 262; continue _fun00003 }
 37:
 ...
 45:
                    ...
                    entity = entity.t;
                    zuuluu = entity.ieNrxs;
                    entity = {};
                    verify = _closure2_slot1;
                    option = 1;
                    option = verify + option;
                    entity['answerNumber'] = option;
 ...
 155:
                    ...
                    entity = entity.t;
                    michal = entity.vcC7Qk;
                    entity = {};
                    golfie = 12;
                    golfie = offset[golfie];
                    option = option.bind(oscard)(golfie);
                    golfie = option.filterOutUUID;
                    golfie = golfie.bind(option)(verify);
                    entity['imageName'] = golfie;
                    option = _closure2_slot1;
                    golfie = 1;
                    golfie = option + golfie;
                    entity['answerNumber'] = golfie;
 ...
 262:
            ...
            output = backup.bind(output)(report, option);
 ...
 437:
    ...
    tangon = oscard[tangon];
    tangon = report.bind(entity)(tangon);
    golfie = tangon.MAX_POLL_ANSWER_LENGTH;
    var _closure1_slot9 = golfie;
    tangon = tangon.POLL_CREATION_IMAGE_INPUT_ACTION_SHEET_KEY;
    ...
    tangon['defaultContainer'] = verify;
    ...
    tangon['defaultImageAndTextContainer'] = verify;
    verify = {};
    backup = 30;
    verify['marginRight'] = backup;
    tangon['cannotRemove'] = verify;
    verify = {'width': 60, 'height': 48, 'justifyContent': 'center', 'alignItems': 'center'};
    tangon['defaultImageContainer'] = verify;
    verify = {'flex': 1, 'paddingStart': 0};
    tangon['pollAnswerTextInput'] = verify;
    ...
    verify['color'] = backup;
    tangon['defaultRemoveButtonContainer'] = verify;
    verify = {};
    backup = oscard[yankee];
    backup = romeon.bind(entity)(backup);
    backup = backup.radii;
    ...
    foxtra = '48%';
    verify['width'] = foxtra;
    tangon['imageOnlyContainer'] = verify;
    ...
    tangon['imageOnlyImageContainer'] = verify;
    verify = {};
    foxtra = 'flex-start';
    ...
    tangon = 'modules/polls/native/PollAnswerInput.tsx';
    tangon = report.bind(oscard)(tangon);
    michal = function(argFoo) { // Original name: PollAnswerInput
        _fun00005: for(var _fun00006_ip = 0; ; ) switch(_fun00006_ip) {
 0:
            michal = argFoo;
            entity = michal.answer;
            var _closure2_slot0 = entity;
            record = michal.index;
            var _closure2_slot1 = record;
            echoed = michal.inputRef;
            status = michal.channelId;
            var _closure2_slot2 = status;
            oscard = michal.layout;
            zuuluu = michal.onAnswerTextChange;
            var _closure2_slot3 = zuuluu;
            zuuluu = michal.onAnswerEmojiSelect;
            var _closure2_slot4 = zuuluu;
            kiloes = michal.canRemoveAnswer;
            zuuluu = michal.onRemoveAnswer;
            var _closure2_slot5 = zuuluu;
            zuuluu = michal.onRemoveAnswerImage;
            var _closure2_slot6 = zuuluu;
            target = michal.onSubmitEditing;
            backup = michal.error;
            michal = _closure1_slot16;
            tangon = undefined;
            ctrled = michal.bind(tangon)();
            cntext = entity.image;
            papara = entity.localCreationAnswerId;
            var _closure2_slot7 = papara;
            michal = _closure1_slot0;
            ...
            entity = function() {
                ...
                michal = michal.localCreationAnswerId;
 ...
 30:
                    ...
                    michal = zuuluu.openEmojiPickerActionSheet;
                    entity = {};
                    ...
                    tangon = tangon.POLLS;
                    entity['pickerIntention'] = tangon;
                    tangon = false;
                    entity['startExpanded'] = tangon;
                    entity['autoFocus'] = tangon;
 ...
 110:
            ...
            sequen = function() { // Original name: openImageInputActionSheet
                ...
                michal['answer'] = option;
                option = _closure2_slot9;
                michal['onSaveAltText'] = option;
                option = _closure2_slot6;
                michal['onRemoveAnswerImage'] = option;
                golfie = _closure2_slot8;
                michal['openExpressionPicker'] = golfie;
            ...
            entity = function(argFoo) { // Original name: handleSaveAltText
                ...
                zuuluu = _closure2_slot0;
                yankee = zuuluu.localCreationAnswerId;
 ...
 265:
            ...
            if(!(oscard !== report)) { _fun00006_ip = 556; continue _fun00005 }
 314:
            golfie = _closure1_slot13;
            oscard = _closure1_slot5;
            report = {};
            option = ctrled.imageOnlyContainer;
            report['style'] = option;
            foxtra = _closure1_slot12;
            romeon = _closure1_slot17;
            option = {};
            option['channelId'] = status;
            option['localCreationAnswerId'] = papara;
            option['image'] = cntext;
            option['openExpressionPicker'] = config;
            option['openImageInputActionSheet'] = sequen;
            output = _closure1_slot1;
            result = _closure1_slot2;
            sizing = 27;
            sizing = result[sizing];
            sizing = output.bind(tangon)(sizing);
            option['iconSrc'] = sizing;
            sizing = ctrled.imageOnlyImageContainer;
            option['containerStyle'] = sizing;
            sizing = 100;
            option['emojiSize'] = sizing;
            option['answerIndex'] = record;
            romeon = foxtra.bind(tangon)(romeon, option);
            option = new Array(2);
            option[0] = romeon;
            if(!verify) { _fun00006_ip = 537; continue _fun00005 }
 434:
            ...
            output = function() { // Original name: onPress
                ...
                zuuluu = tangon.openEditPollCreationImageAltTextModal;
                michal = {};
                oscard = _closure2_slot2;
                michal['channelId'] = oscard;
                oscard = _closure2_slot0;
                michal['answer'] = oscard;
                oscard = _closure2_slot1;
                michal['index'] = oscard;
                report = _closure2_slot9;
                michal['onSave'] = report;
                report = 250;
                michal['imageSize'] = report;
            ...
            verify = sizing.bind(tangon)(foxtra, romeon);
 537:
            option[1] = verify;
            report['children'] = option;
            report = golfie.bind(tangon)(oscard, report);
 ...
 556:
            ...
            verify = {};
            sizing = ctrled.defaultContainer;
            foxtra = new Array(2);
            foxtra[0] = sizing;
            sizing = !kiloes;
            if(!sizing) { _fun00006_ip = 598; continue _fun00005 }
 592:
            sizing = ctrled.cannotRemove;
 598:
            foxtra[1] = sizing;
            verify['style'] = foxtra;
            ...
            foxtra = {};
            source = ctrled.defaultImageAndTextContainer;
            result = new Array(2);
            result[0] = source;
            source = offset;
            if(!offset) { _fun00006_ip = 642; continue _fun00005 }
 636:
            source = ctrled.errorInput;
 642:
            result[1] = source;
            foxtra['style'] = result;
            ...
            result['localCreationAnswerId'] = papara;
            result['image'] = cntext;
            result['openExpressionPicker'] = config;
            result['openImageInputActionSheet'] = sequen;
            ...
            status = function(argFoo) { // Original name: onChange
                ...
                michal['localCreationAnswerId'] = entity;
                entity = undefined;
            ...
            source['blurOnSubmit'] = papara;
            papara = ctrled.pollAnswerTextInput;
            source['style'] = papara;
            papara = 'none';
            source['textContentType'] = papara;
            papara = sequen[echoed];
            ...
            sequen = sequen.t;
            papara = sequen.3+V8Gx;
            cntext = {};
            sequen = 1;
            sierra = record + sequen;
            cntext['answerNumber'] = sierra;
            cntext = target.bind(status)(papara, cntext);
            source['accessibilityLabel'] = cntext;
            cntext = _closure1_slot9;
            source['maxLength'] = cntext;
            cntext = 'next';
            source['returnKeyType'] = cntext;
            cntext = true;
            source['required'] = cntext;
            source['autoCorrect'] = cntext;
            source['aria-invalid'] = backup;
            source = config.bind(tangon)(vacuum, source);
            result[1] = source;
 ...
 1024:
            ...
            update = ctrled.defaultRemoveButtonContainer;
            sizing['style'] = update;
            ...
            echoed = echoed.t;
            update = echoed.22fjER;
            echoed = {};
            sequen = record + sequen;
            echoed['answerNumber'] = sequen;
            echoed = source.bind(vacuum)(update, echoed);
            sizing['accessibilityLabel'] = echoed;
            ...
            ctrled = ctrled.defaultRemoveButtonContainer;
            ctrled = ctrled.color;
            echoed['color'] = ctrled;
