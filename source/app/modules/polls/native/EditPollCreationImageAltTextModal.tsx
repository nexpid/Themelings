...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    mike = function(argFoo) { // Original name: EditPollCreationImageAltTextModal
        _fun119456: for(var _fun119456_ip = 0; ; ) switch(_fun119456_ip) {
 0:
            zulu = argFoo;
            ...
            offset = mike == options;
            golf = undefined;
            if(offset) { _fun119456_ip = 133; continue _fun119456 }
 128:
            golf = options.description;
 133:
            options = mike != golf;
            mike = '';
            if(!options) { _fun119456_ip = 147; continue _fun119456 }
 144:
            mike = golf;
 147:
            ...
            mike[1] = config;
            entity = function() {
                _fun119457: for(var _fun119457_ip = 0; ; ) switch(_fun119457_ip) {
 0:
                    zulu = _closure2_slot1;
                    mike = null;
                    if(!(mike != zulu)) { _fun119457_ip = 28; continue _fun119457 }
 13:
