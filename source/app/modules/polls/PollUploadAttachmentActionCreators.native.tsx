...
export default (function(argFoo, argBar, argBaz, _, __, argFre, argPlu) {
 ...
 118:
    ...
    michal = function(argFoo) { // Original name: sendPollMessageWithAttachments
        ...
        backup = entity.id;
        michal = {'content': '', 'tts': false};
        entity = new Array(0);
        michal['invalidEmojis'] = entity;
        entity = new Array(0);
        michal['validNonShortcutEmojis'] = entity;
        entity = {};
        entity['nonce'] = offset;
        entity['poll'] = verify;
        entity['attachmentsToUpload'] = option;
        ...
        entity['onAttachmentUploadError'] = golfie;
        kiloes = report;
        foxtra = michal;
        romeon = undefined;
        yankee = entity;
