...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
            ...
            entity['selectedGuildId'] = options;
            entity = zulu.bind(tango)(entity);
            zulu = entity.options;
            var _closure2_slot2 = zulu;
            options = entity.selectedGuild;
            ...
            verify = golf == options;
            golf = undefined;
            if(verify) { _fun107578_ip = 121; continue _fun107578 }
 116:
            golf = options.name;
 121:
            entity['label'] = golf;
 ...
 0:
                        zulu = argFoo;
                        tango = null;
                        if(!(tango != zulu)) { _fun107580_ip = 31; continue _fun107580 }
 9:
                        mike = _closure2_slot1;
                        if(!(tango != mike)) { _fun107580_ip = 31; continue _fun107580 }
 20:
                        mike = _closure2_slot1;
                        entity = undefined;
