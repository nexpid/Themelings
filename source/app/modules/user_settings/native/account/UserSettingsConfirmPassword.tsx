...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    foxtrot = 16;
    offset = {'paddingVertical': 12, 'paddingHorizontal': 16};
    ...
    tango = function(argFoo, argBar) {
        _fun88681: for(var _fun88681_ip = 0; ; ) switch(_fun88681_ip) {
 0:
            entity = argFoo;
            zulu = entity.onSubmit;
            var _closure2_slot0 = zulu;
            zulu = entity.onSuccess;
            var _closure2_slot1 = zulu;
            zulu = entity.onError;
            var _closure2_slot2 = zulu;
            output = entity.parentLoading;
            report = undefined;
            if(!(output === report)) { _fun88681_ip = 49; continue _fun88681 }
 47:
            output = false;
 49:
            options = entity.style;
            oscar = entity.hideUnverifiedBanner;
            if(!(oscar === report)) { _fun88681_ip = 66; continue _fun88681 }
 64:
            oscar = false;
 66:
 ...
 0:
                            ...
                            if(zulu) { _fun88685_ip = 470; continue _fun88685 }
 10:
                            report = undefined;
                            oscar = undefined;
 ...
 45:
                            ...
                            if(golf) { _fun88685_ip = 252; continue _fun88685 }
 54:
                            oscar = tango;
                            options = null;
                            if(!(options != tango)) { _fun88685_ip = 214; continue _fun88685 }
 66:
                            golf = oscar;
                            verify = golf.status;
                            golf = 400;
                            if(!(verify >= golf)) { _fun88685_ip = 102; continue _fun88685 }
 84:
                            golf = oscar;
                            verify = golf.status;
                            golf = 599;
                            if(!(!(verify <= golf))) { _fun88685_ip = 115; continue _fun88685 }
 102:
                            golf = _closure2_slot1;
                            golf = golf.bind(report)();
 110: // try_end0
                            _fun88685_ip = 441; continue _fun88685;
 115: // try_start_1
                            ...
                            offset = verify.V6OrEarlierAPIError;
                            romeo = oscar;
                            verify = offset.prototype;
                            verify = Object.create(verify, {constructor: {value: offset}});
                            foxtrot = verify;
                            oscar = new foxtrot[offset](romeo, yankee);
                            oscar = oscar instanceof Object ? oscar : verify;
                            oscar = golf.bind(report)(oscar);
                            golf = _closure2_slot2;
                            golf = options == golf;
                            oscar = golf;
                            if(golf) { _fun88685_ip = 198; continue _fun88685 }
 190:
                            golf = _closure2_slot2;
 ...
 214: // try_start_2 // try_start_4
                            ...
                            golf = options == golf;
                            oscar = golf;
                            if(golf) { _fun88685_ip = 236; continue _fun88685 }
 228:
                            golf = _closure2_slot2;
                            oscar = golf.bind(report)();
 ...
 266: // try_start_5 // catch_target0 // catch_target1 // catch_target2
                            ...
                            if(!(golf !== tango)) { _fun88685_ip = 423; continue _fun88685 }
 365:
                            ...
                            oscar = options[oscar];
                            oscar = golf.bind(report)(oscar);
                            golf = oscar.V6OrEarlierAPIError;
                            romeo = mike;
 ...
 423:
                            ...
                            mike = null;
                            if(!(mike != tango)) { _fun88685_ip = 441; continue _fun88685 }
 433:
 ...
 470:
            ...
            offset = 2;
            zulu = yankee.bind(report)(zulu, offset);
            verify = 0;
            sizing = zulu[verify];
            tango = 1;
            zulu = zulu[tango];
            ...
            zulu = function() {
                ...
                zulu = tango.trackPaneViewed;
                mike = _closure1_slot9;
                mike = mike.ACCOUNT_CONFIRM_PASSWORD;
            ...
            mike = foxtrot == entity;
            entity = null;
            if(mike) { _fun88681_ip = 1098; continue _fun88681 }
 321:
            tango = _closure1_slot11;
            zulu = _closure1_slot7;
            mike = {'style': null, 'keyboardShouldPersistTaps': 'handled', 'alwaysBounceVertical': false};
            verify = kilo.background;
            golf = new Array(2);
            golf[0] = verify;
            golf[1] = options;
            mike['style'] = golf;
            golf = null;
            if(oscar) { _fun88681_ip = 404; continue _fun88681 }
 372:
 ...
 404:
            ...
            echo = echo.t;
            echo = echo.x+d9t7;
            echo = control.bind(papa)(echo);
            offset['children'] = echo;
            romeo = source.bind(report)(romeo, offset);
            offset = new Array(5);
            offset[0] = romeo;
            ...
            echo = kilo.input;
            yankee['style'] = echo;
            echo = kilo.redesignInput;
            yankee['textStyle'] = echo;
            echo = context[vacuum];
            echo = record.bind(report)(echo);
            papa = echo.intl;
            control = papa.string;
            ...
            yankee['label'] = echo;
            echo = 'password';
            yankee['textContentType'] = echo;
            control = 18;
            control = context[control];
            control = record.bind(report)(control);
            control = control.KeyboardTypes;
            control = control.DEFAULT;
            yankee['keyboardType'] = control;
            control = true;
            yankee['secureTextEntry'] = control;
            yankee['value'] = config;
            yankee['onChangeText'] = sequence;
            yankee['onSubmitEditing'] = result;
            config = foxtrot == update;
            sequence = undefined;
            if(config) { _fun88681_ip = 814; continue _fun88681 }
 803:
 ...
 814:
            ...
            sequence = 'none';
            yankee['autoCapitalize'] = sequence;
            yankee['autoFocus'] = control;
            yankee = source.bind(report)(romeo, yankee);
            offset[2] = yankee;
            romeo = foxtrot != update;
            yankee = null;
            if(!romeo) { _fun88681_ip = 931; continue _fun88681 }
 860:
 ...
 931:
            ...
            kilo = backup.Button;
            backup = {'variant': 'primary', 'size': 'lg'};
            update = echo[vacuum];
            ...
            if(sizing) { _fun88681_ip = 1049; continue _fun88681 }
 1046:
            sizing = output;
 1049:
 ...
 1098:
    ...
    report = 'modules/user_settings/native/account/UserSettingsConfirmPassword.tsx';
    report = oscar.bind(golf)(report);
    zulu['default'] = tango;
    mike = function() { // Original name: UserSettingsConfirmPasswordWrapped
        zulu = _closure1_slot0;
        tango = _closure1_slot2;
        mike = 9;
        mike = tango[mike];
    ...
    zulu['UserSettingsConfirmPasswordWrapped'] = mike;
    return entity;
})();