...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    tango = function(argFoo) { // Original name: BlockedUsersList
 ...
 0:
            ...
            mike = mike.BLOCKED_USERS;
            mike = zulu.bind(report)(mike);
            tango = mike.analyticsLocations;
            zulu = echo.length;
            mike = 0;
            if(!(mike !== zulu)) { _fun94643_ip = 420; continue _fun94643 }
 85:
            ...
            backup = output.bind(report)(backup);
            backup = backup.t;
            sizing = backup.c+JVEB;
            backup = {};
            control = echo.length;
            backup['numberOfBlockedUsers'] = control;
            ...
            _fun94643_ip = 530; continue _fun94643;
 420:
            tango = _closure1_slot5;
 ...
 530:
    ...
    tango = 'modules/user_settings/native/BlockedUsersListV2.tsx';
    tango = report.bind(oscar)(tango);
    mike = function() { // Original name: ConnectedBlockedUsersList
