...
export default (function(_, argBar, argBaz, argCorge, __, argFred, argPlugh) {
 ...
 0:
            ...
            options = report == mike;
            entity = undefined;
            if(options) { _fun93328_ip = 230; continue _fun93328 }
 225:
            entity = mike.id;
 230:
 ...
 0:
                    ...
                    entity = zulu === entity;
                    if(entity) { _fun93331_ip = 44; continue _fun93331 }
 34:
 ...
 44:
            ...
            offset = options;
            if(offset) { _fun93328_ip = 454; continue _fun93328 }
 440:
            entity = _closure1_slot9;
 ...
 0:
                        ...
                        if(mike) { _fun93338_ip = 674; continue _fun93338 }
 10:
                        mike = _closure2_slot12;
                        if(mike) { _fun93338_ip = 669; continue _fun93338 }
 23:
                        mike = _closure2_slot0;
                        verify = null;
                        if(!(verify != mike)) { _fun93338_ip = 669; continue _fun93338 }
 36:
                        zulu = _closure1_slot0;
                        tango = _closure1_slot2;
                        mike = 13;
                        ...
                        mike = mike > golf;
                        offset = true;
                        if(!mike) { _fun93338_ip = 394; continue _fun93338 }
 205:
                        tango = _closure1_slot0;
                        ...
                        backup = verify == mike;
                        mike = undefined;
                        if(backup) { _fun93338_ip = 253; continue _fun93338 }
 244:
 ...
 263:
                        ...
                        if(tango) { _fun93338_ip = 666; continue _fun93338 }
 272:
                        tango = verify != mike;
                        if(!tango) { _fun93338_ip = 285; continue _fun93338 }
 279:
                        tango = mike.ok;
 285:
                        if(tango) { _fun93338_ip = 321; continue _fun93338 }
 288:
                        foxtrot = verify == mike;
                        yankee = undefined;
                        if(foxtrot) { _fun93338_ip = 317; continue _fun93338 }
 297:
                        foxtrot = mike.body;
                        backup = verify == foxtrot;
                        yankee = undefined;
                        if(backup) { _fun93338_ip = 317; continue _fun93338 }
 311:
                        yankee = foxtrot.avatar;
 317:
                        tango = verify == yankee;
 321:
                        if(tango) { _fun93338_ip = 366; continue _fun93338 }
 324:
 ...
 366:
                        tango = verify == mike;
                        yankee = undefined;
                        if(tango) { _fun93338_ip = 381; continue _fun93338 }
 375:
                        yankee = mike.ok;
 381:
                        tango = verify != yankee;
                        if(!tango) { _fun93338_ip = 391; continue _fun93338 }
 388:
                        tango = yankee;
 391:
                        offset = tango;
 394:
                        ...
                        zulu = zulu.length;
                        tango = offset;
                        if(!(zulu > golf)) { _fun93338_ip = 643; continue _fun93338 }
 425:
                        ...
                        foxtrot = verify == zulu;
                        zulu = undefined;
                        if(foxtrot) { _fun93338_ip = 473; continue _fun93338 }
 464:
 ...
 483:
                        ...
                        if(golf) { _fun93338_ip = 663; continue _fun93338 }
 492:
                        if(!(verify != zulu)) { _fun93338_ip = 505; continue _fun93338 }
 496:
                        golf = zulu.ok;
                        if(golf) { _fun93338_ip = 604; continue _fun93338 }
 505:
                        yankee = _closure1_slot0;
                        ...
                        if(!(verify != yankee)) { _fun93338_ip = 604; continue _fun93338 }
 573:
                        golf = _closure1_slot0;
                        romeo = _closure1_slot2;
                        oscar = 14;
 ...
 604:
                        oscar = offset;
                        golf = undefined;
                        if(!offset) { _fun93338_ip = 634; continue _fun93338 }
 612:
                        offset = verify == zulu;
                        options = undefined;
                        if(offset) { _fun93338_ip = 627; continue _fun93338 }
 621:
                        options = zulu.ok;
 627:
                        ...
                        golf = options;
 634:
                        if(!oscar) { _fun93338_ip = 640; continue _fun93338 }
 637:
                        oscar = golf;
 640:
                        tango = oscar;
 643:
                        if(!tango) { _fun93338_ip = 660; continue _fun93338 }
 646:
 ...
 674:
            ...
            output = report == mike;
            sizing = undefined;
            if(output) { _fun93328_ip = 543; continue _fun93328 }
 538:
            sizing = mike.id;
 543:
            yankee[10] = sizing;
            ...
            if(!(report != mike)) { _fun93328_ip = 620; continue _fun93328 }
 617:
            tango = mike;
 620:
            mike = 'guild';
