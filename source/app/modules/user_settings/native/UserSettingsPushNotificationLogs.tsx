...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    tango = 'modules/user_settings/native/UserSettingsPushNotificationLogs.tsx';
    tango = report.bind(oscar)(tango);
    mike = function() { // Original name: UserSettingsPushNotificationLogs
 ...
 0:
                ...
                zulu = tango.get;
                mike = 'push-notification-logs-query';
                entity = '';
                mike = zulu.bind(tango)(mike, entity);
                zulu = null;
                zulu = zulu != mike;
                if(!zulu) { _fun98235_ip = 64; continue _fun98235 }
 61:
                entity = mike;
 64:
                return entity;
        ...
        entity = new Array(0);
        entity = mike.bind(report)(entity);
        mike = options.bind(tango)(entity, golf);
        entity = mike[oscar];
        ...
        zulu = function() {
            mike = function() { // Original name: _load
                tango = undefined;
                entity = undefined;
 ...
 0:
                            ...
                            if(mike) { _fun98239_ip = 64; continue _fun98239 }
 7:
 ...
 40:
                            ...
                            if(tango) { _fun98239_ip = 61; continue _fun98239 }
 46:
 ...
 64:
            ...
            mike = function() { // Original name: load
                entity = undefined;
 ...
 0:
                ...
                mike = '';
                if(!(mike === tango)) { _fun98241_ip = 84; continue _fun98241 }
 17:
                ...
                report = oscar.set;
                tango = _closure2_slot0;
                zulu = 'push-notification-logs-query';
 ...
 0:
                                ...
                                zulu = null;
                                entity = zulu != entity;
                                if(entity) { _fun98243_ip = 59; continue _fun98243 }
 35:
                                golf = mike.title;
                                oscar = golf.match;
                                ...
                                entity = zulu != report;
 59:
                                if(entity) { _fun98243_ip = 95; continue _fun98243 }
 62:
                                oscar = mike.content;
                                report = zulu == oscar;
                                mike = undefined;
                                if(report) { _fun98243_ip = 91; continue _fun98243 }
 76:
                                report = oscar.match;
 ...
 95:
                        ...
                        zulu = entity.Storage;
                        mike = zulu.set;
                        entity = 'push-notification-logs-query';
                        entity = mike.bind(zulu)(entity, tango);
 126: // try_end0
                        _fun98242_ip = 130; continue _fun98242;
 128: // catch_target0
 ...
 0:
                    StartGenerator();
                    ResumeGenerator(result_out_reg=0, return_bool_out_reg=1);
                    if(mike) { _fun98246_ip = 120; continue _fun98246 }
 7:
 ...
 40:
                    ...
                    if(report) { _fun98246_ip = 117; continue _fun98246 }
 46:
                    ...
                    oscar = golf.showShareActionSheet;
                    report = {};
                    ...
                    tango = false;
                    tango = options.bind(zulu)(mike, tango);
                    report['message'] = tango;
                    tango = 'push-notification-logs';
 ...
 0:
                ...
                offset = entity.item;
                report = entity.index;
                entity = offset.silent;
                foxtrot = '';
                if(!entity) { _fun98247_ip = 32; continue _fun98247 }
 26:
                foxtrot = '~silent~ ';
 32:
                ...
                yankee = verify.Text;
                verify = {'style': null, 'variant': 'text-sm/normal', 'color': 'text-brand'};
                romeo = romeo.code;
                verify['style'] = romeo;
                romeo = new Array(5);
                romeo[0] = foxtrot;
                ...
                yankee = tango.bind(entity)(yankee, verify);
                verify = new Array(4);
                verify[0] = yankee;
                yankee = offset.title;
                verify[1] = yankee;
