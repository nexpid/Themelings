...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
    ...
    michal = function(argFoo) { // Original name: getBannerText
 ...
 41:
            ...
            tangon = tangon.t;
            tangon = tangon.13ofGh;
            tangon = report.bind(oscard)(tangon);
            zuuluu['button'] = tangon;
            michal = zuuluu;
 161:
 ...
 288:
    ...
    tangon = function() { // Original name: UserSettingsAccountUnverifiedHeader
 ...
 84:
            ...
            foxtra = verify.bind(report)(foxtra, oscard);
            oscard = new Array(2);
            oscard[0] = foxtra;
            golfie = romeon[golfie];
            golfie = option.bind(report)(golfie);
            option = golfie.Text;
            golfie = {'style': null, 'variant': 'text-xs/medium', 'color': 'always-white'};
