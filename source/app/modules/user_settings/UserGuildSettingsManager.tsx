...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
 ...
 0:
            ...
            if(entity) { _fun61479_ip = 51; continue _fun61479 }
 38:
            entity = verify.apply;
            entity = entity.bind(verify)(tango, oscar);
            _fun61479_ip = 92; continue _fun61479;
 51:
            golf = global;
            options = golf.Reflect;
            golf = options.construct;
            if(oscar) { _fun61479_ip = 71; continue _fun61479 }
 67:
            oscar = new Array(0);
 71:
 ...
 70: // try_end0
            _fun61480_ip = 74; continue _fun61480;
 72: // catch_target0
 ...
 0:
                    ...
                    if(mike) { _fun61489_ip = 177; continue _fun61489 }
 16:
                    options = null;
                    if(!(options != oscar)) { _fun61489_ip = 83; continue _fun61489 }
 22:
                    mike = _closure1_slot12;
                    if(!(oscar !== mike)) { _fun61489_ip = 83; continue _fun61489 }
 33:
                    tango = _closure1_slot22;
                    if(!(options == report)) { _fun61489_ip = 45; continue _fun61489 }
 41:
                    zulu = {};
                    _fun61489_ip = 63; continue _fun61489;
 45:
                    mike = {};
                    if(!(options == oscar)) { _fun61489_ip = 55; continue _fun61489 }
 51:
 ...
 74:
                    ...
                    if(!zulu) { _fun61489_ip = 169; continue _fun61489 }
 80:
                    return mike;
 83:
 ...
 163:
                    ResumeGenerator(result_out_reg=1, return_bool_out_reg=2);
                    if(zulu) { _fun61489_ip = 174; continue _fun61489 }
 169:
                    zulu = undefined;
                    return zulu;
 174:
 ...
 0:
                    ...
                    golf = argFoo;
                    ResumeGenerator(result_out_reg=0, return_bool_out_reg=1);
                    if(mike) { _fun61493_ip = 522; continue _fun61493 }
 13:
                    mike = global;
 ...
 114:
                        ...
                        if(output === sizing) { _fun61493_ip = 105; continue _fun61493 }
 133:
                        zulu[backup] = kilo;
                        _fun61493_ip = 105; continue _fun61493;
                    }
 139:
 ...
 160:
                        ...
                        sizing = _closure1_slot13;
                        sizing = sizing[backup];
                        if(output === sizing) { _fun61493_ip = 151; continue _fun61493 }
 179:
                        zulu[backup] = kilo;
                        _fun61493_ip = 151; continue _fun61493;
                    }
 185:
                    foxtrot = zulu;
                    verify = 'collapsed';
 ...
 226:
                        ...
                        sizing = options != echo;
                        if(!sizing) { _fun61493_ip = 259; continue _fun61493 }
 250:
                        output = echo.guild_id;
                        sizing = options != output;
 259:
                        if(!sizing) { _fun61493_ip = 211; continue _fun61493 }
 262:
                        sizing = echo.guild_id;
                        sizing = sizing in golf;
                        if(sizing) { _fun61493_ip = 285; continue _fun61493 }
 274:
                        output = echo.guild_id;
                        sizing = {};
                        golf[output] = sizing;
 285:
                        ...
                        if(!(options == sizing)) { _fun61493_ip = 321; continue _fun61493 }
 304:
                        sizing = echo.guild_id;
                        output = golf[sizing];
                        sizing = {};
 ...
 321:
                        ...
                        zulu = true;
                        _fun61493_ip = 211; continue _fun61493;
                    }
 399:
                    if(mike) { _fun61493_ip = 408; continue _fun61493 }
 402:
                    zulu = new Array(0);
                    _fun61493_ip = 516; continue _fun61493;
 408:
                    mike = {};
                    vacuum = mike;
                    control = tango;
 ...
 505:
                    ...
                    if(tango) { _fun61493_ip = 519; continue _fun61493 }
 511:
                    zulu = mike.body;
 516:
                    return zulu;
