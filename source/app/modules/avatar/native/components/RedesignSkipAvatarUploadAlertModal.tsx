...
export default (function(argFoo, argBar, _, argCorge, __, argFred, argPlugh) {
    ...
    tango = 'modules/avatar/native/components/RedesignSkipAvatarUploadAlertModal.tsx';
    tango = report.bind(oscar)(tango);
    mike = function(argFoo) { // Original name: RedesignSkipAvatarUploadAlertModal
        entity = argFoo;
