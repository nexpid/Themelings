...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
 ...
 226:
            ...
            option = 11;
            zuuluu = result[option];
            golfie = yankee.bind(tangon)(zuuluu);
            oscard = golfie.createPendingImage;
            zuuluu = {};
            echoed = 12;
 ...
 364:
            ...
            option['style'] = update;
            if(!output) { _fun00002_ip = 888; continue _fun00001 }
 794:
