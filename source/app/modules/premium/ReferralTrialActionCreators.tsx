...
export default (function(argFoo, argBar, argBaz, _, __, argFre, argPlu) {
 ...
 10:
                    ...
                    option = null;
                    golfie = 6;
                    if(tangon) { _fun00010_ip = 342; continue _fun00009 }
 100:
                    tangon = offset;
                    romeon = tangon.value;
 108: // try_start_0
 ...
 183:
                    ...
                    if(kiloes) { _fun00010_ip = 261; continue _fun00009 }
 189:
                    kiloes = tangon.body;
                    foxtra = kiloes;
                    sizing = option != kiloes;
                    kiloes = null;
                    if(!sizing) { _fun00010_ip = 209; continue _fun00009 }
 206:
                    kiloes = foxtra;
 209:
                    backup = kiloes;
                    if(!(option != kiloes)) { _fun00010_ip = 232; continue _fun00009 }
 216:
                    output = oscard;
                    sizing = output.push;
                    kiloes = backup;
 ...
 0:
                    StartGenerator();
                    ResumeGenerator(result_out_reg=0, return_bool_out_reg=1);
                    if(michal) { _fun00012_ip = 325; continue _fun00011 }
 10:
                    offset = argFoo;
                    michal = undefined;
                    option = undefined;
 ...
 103:
                    ...
                    if(!verify) { _fun00012_ip = 123; continue _fun00011 }
 120:
                    golfie = option;
 123:
 ...
 183: // catch_target0
                    ...
                    if(!(golfie === oscard)) { _fun00012_ip = 322; continue _fun00011 }
 257:
                    ...
                    tangon = golfie;
                    oscard = null;
                    if(!(oscard != golfie)) { _fun00012_ip = 322; continue _fun00011 }
 280:
 ...
 0:
                    StartGenerator();
                    ResumeGenerator(result_out_reg=0, return_bool_out_reg=1);
                    if(michal) { _fun00014_ip = 238; continue _fun00013 }
 10:
                    oscard = argFoo;
                    michal = undefined;
                    golfie = undefined;
 ...
 103:
                    ...
                    if(!option) { _fun00014_ip = 123; continue _fun00013 }
 120:
                    report = golfie;
 123:
