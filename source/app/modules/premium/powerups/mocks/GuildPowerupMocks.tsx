...
export default (function(_, argBar, __, ___, ____, argFre, argPlu) {
    ...
    michal['features'] = option;
    tangon[2] = michal;
    option = {'type': null, 'skuId': '4', 'title': 'Lorem ipsum', 'description': 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec placerat posuere lao', 'cost': 1, 'bundle': true};
    michal = verify.PERK;
    option['type'] = michal;
    michal = new Array(0);
    ...
    michal = new Array(4);
    michal[0] = option;
    option = {'type': null, 'skuId': '5', 'title': 'Lorem ipsum', 'description': 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec placerat posuere lao', 'cost': 1, 'bundle': true};
    offset = verify.PERK;
    option['type'] = offset;
    offset = new Array(0);
    option['dependencies'] = offset;
    michal[1] = option;
    option = {'type': null, 'skuId': '6', 'title': 'Lorem ipsum', 'description': 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec placerat posuere lao', 'cost': 1, 'bundle': false};
    offset = verify.PERK;
    option['type'] = offset;
    offset = new Array(0);
    option['dependencies'] = offset;
    michal[2] = option;
    option = {'type': null, 'skuId': '7', 'title': 'Lorem ipsum', 'description': 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec placerat posuere lao', 'cost': 1, 'bundle': false};
    verify = verify.PERK;
    option['type'] = verify;
    verify = new Array(0);
