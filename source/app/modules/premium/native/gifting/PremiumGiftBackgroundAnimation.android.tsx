...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    tango = {};
    verify = {'display': 'flex', 'alignItems': 'flex-end', 'justifyContent': 'center', 'flexDirection': 'row'};
    tango['container'] = verify;
    verify = {};
    offset = 300;
    verify['height'] = offset;
    tango['consistentHeight'] = verify;
    verify = {'maxWidth': 375, 'width': '100%', 'height': 'auto'};
    tango['animation'] = verify;
    verify = {'position': 'absolute', 'bottom': 0};
    tango['baseAnimation'] = verify;
    verify = {};
    offset = 275;
    verify['height'] = offset;
    tango['lottie'] = verify;
    ...
    tango = 'modules/premium/native/gifting/PremiumGiftBackgroundAnimation.android.tsx';
    tango = report.bind(oscar)(tango);
    mike = function(argFoo) { // Original name: PremiumGiftBackgroundAnimation
        _fun87982: for(var _fun87982_ip = 0; ; ) switch(_fun87982_ip) {
 0:
            mike = argFoo;
            context = mike.giftStyle;
            var _closure2_slot0 = context;
            oscar = mike.withConsistentHeight;
            ...
            romeo = 2;
            mike = sizing.bind(tango)(mike, romeo);
            control = 0;
            yankee = mike[control];
            ...
            romeo = sizing.bind(tango)(mike, romeo);
            mike = romeo[control];
            ...
            romeo = function() {
                ...
                zulu = tango.getGiftAnimationData;
                mike = _closure2_slot0;
                entity = 7;
                entity = golf[entity];
                entity = oscar.bind(report)(entity);
                entity = entity.AnimationState;
                entity = entity.ACTION;
                entity = zulu.bind(tango)(mike, entity);
                return entity;
            };
            config = output.bind(report)(romeo, sizing);
            output = report.useMemo;
            sizing = new Array(1);
            sizing[0] = context;
            romeo = function() {
            ...
            romeo = output.bind(report)(romeo, sizing);
            result = 8;
            golf = golf[result];
            options = options.bind(tango)(golf);
            golf = options.getLottieType;
            sizing = golf.bind(options)(context);
 ...
 0:
                    ...
                    if(!(zulu !== entity)) { _fun87986_ip = 133; continue _fun87986 }
 15:
                    ...
                    tango = tango.AnimationState;
                    tango = tango.LOOP;
                    tango = golf !== tango;
                    if(!tango) { _fun87986_ip = 90; continue _fun87986 }
 80:
 ...
 0:
                    ...
                    if(mike) { _fun87987_ip = 140; continue _fun87987 }
 16:
                    golf = _closure2_slot4;
                    options = _closure1_slot0;
                    ...
                    zulu = zulu.AnimationState;
                    zulu = zulu.LOOP;
                    zulu = golf === zulu;
                    if(zulu) { _fun87987_ip = 67; continue _fun87987 }
 64:
                    zulu = report;
 67:
                    if(zulu) { _fun87987_ip = 153; continue _fun87987 }
 70:
                    ...
                    _fun87987_ip = 153; continue _fun87987;
 140:
 ...
 153:
            ...
            sequence = golf.bind(report)(mike, zulu);
 ...
 0:
                    ...
                    zulu = zulu.AnimationState;
                    zulu = zulu.LOOP;
                    if(!(tango !== zulu)) { _fun87988_ip = 75; continue _fun87988 }
 48:
                    zulu = _closure2_slot3;
                    tango = zulu.current;
                    zulu = null;
                    if(!(zulu != tango)) { _fun87988_ip = 100; continue _fun87988 }
 63:
                    zulu = tango.reset;
                    zulu = zulu.bind(tango)();
                    _fun87988_ip = 100; continue _fun87988;
 75:
                    mike = _closure2_slot2;
                    zulu = mike.current;
                    mike = null;
                    if(!(mike != zulu)) { _fun87988_ip = 100; continue _fun87988 }
 90:
                    mike = zulu.reset;
                    mike = mike.bind(zulu)();
 100:
 ...
 0:
                    ...
                    if(!mike) { _fun87989_ip = 35; continue _fun87989 }
 10:
                    entity = _closure2_slot2;
                    mike = entity.current;
                    entity = null;
                    if(!(entity != mike)) { _fun87989_ip = 35; continue _fun87989 }
 25:
                    entity = mike.reset;
 ...
 35:
            ...
            report = new Array(2);
            report[0] = golf;
            if(!oscar) { _fun87982_ip = 515; continue _fun87982 }
 509:
            oscar = echo.consistentHeight;
 515:
            report[1] = oscar;
            entity['style'] = report;
            ...
            if(!vacuum) { _fun87982_ip = 611; continue _fun87982 }
 605:
            vacuum = echo.lottie;
 611:
            output[2] = vacuum;
            ...
            context = 0;
            if(!source) { _fun87982_ip = 664; continue _fun87982 }
 626:
            target = _closure1_slot0;
            papa = _closure1_slot2;
            papa = papa[foxtrot];
            papa = target.bind(tango)(papa);
            papa = papa.AnimationState;
            papa = papa.LOOP;
            context = 0;
            if(!(yankee !== papa)) { _fun87982_ip = 664; continue _fun87982 }
 661:
            context = update;
 664:
            vacuum['opacity'] = context;
            output[3] = vacuum;
            report['style'] = output;
            ...
            context = context.LottieType;
            context = context.LOTTIE;
            context = sizing === context;
            report['hardwareAccelerationAndroid'] = context;
            report['ref'] = record;
            report['source'] = config;
            config = !verify;
            report['autoPlay'] = config;
            report['onAnimationFinish'] = sequence;
            report['loop'] = kilo;
            ...
            if(!output) { _fun87982_ip = 821; continue _fun87982 }
 815:
            output = echo.lottie;
 821:
            kilo[1] = output;
            output = {};
            echo = 0;
            if(!source) { _fun87982_ip = 870; continue _fun87982 }
 832:
            vacuum = _closure1_slot0;
            ...
            source = source.LOOP;
            echo = 0;
            if(!(yankee === source)) { _fun87982_ip = 870; continue _fun87982 }
 867:
            echo = update;
 870:
            output['opacity'] = echo;
            ...
            kilo = kilo.LottieType;
            kilo = kilo.LOTTIE;
            kilo = sizing === kilo;
            oscar['hardwareAccelerationAndroid'] = kilo;
            oscar['ref'] = backup;
            oscar['source'] = romeo;
            verify = !verify;
            if(!verify) { _fun87982_ip = 967; continue _fun87982 }
 934:
