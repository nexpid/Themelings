...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
    ...
    entity = function(argFoo, argBar, argBaz) { // Original name: _callSuper
        _fun124646: for(var _fun124646_ip = 0; ; ) switch(_fun124646_ip) {
 0:
            tango = argFoo;
            oscar = argBaz;
            ...
            if(entity) { _fun124646_ip = 51; continue _fun124646 }
 38:
            entity = verify.apply;
            entity = entity.bind(verify)(tango, oscar);
            _fun124646_ip = 92; continue _fun124646;
 51:
            golf = global;
            options = golf.Reflect;
            golf = options.construct;
            if(oscar) { _fun124646_ip = 71; continue _fun124646 }
 67:
            oscar = new Array(0);
 71:
 ...
 92:
    ...
    entity = function() { // Original name: _isNativeReflectConstruct
        _fun124647: for(var _fun124647_ip = 0; ; ) switch(_fun124647_ip) {
 0:
 2: // try_start_0
            mike = global;
            zulu = mike.Boolean;
 ...
 72: // try_end0
            _fun124647_ip = 76; continue _fun124647;
 74: // catch_target0
 ...
 0:
                    ...
                    mike = null;
                    mike = mike != report;
                    if(!mike) { _fun124654_ip = 31; continue _fun124654 }
 25:
                    mike = report.verified;
 31:
                    if(!mike) { _fun124654_ip = 70; continue _fun124654 }
 34:
                    ...
                    mike = !zulu;
 70:
                    if(!mike) { _fun124654_ip = 87; continue _fun124654 }
 73:
                    tango = _closure1_slot9;
                    zulu = tango.shouldFetchOffer;
                    mike = zulu.bind(tango)();
 87:
                    if(!mike) { _fun124654_ip = 122; continue _fun124654 }
 90:
 ...
 122:
            ...
            mike = function(argFoo) {
                _fun124655: for(var _fun124655_ip = 0; ; ) switch(_fun124655_ip) {
 0:
                    entity = argFoo;
                    report = entity.userTrialOffer;
                    golf = null;
                    if(!(golf != report)) { _fun124655_ip = 426; continue _fun124655 }
 18:
                    ...
                    if(!entity) { _fun124655_ip = 426; continue _fun124655 }
 87:
                    ...
                    if(!options) { _fun124655_ip = 229; continue _fun124655 }
 226:
                    options = entity;
 229:
                    if(options) { _fun124655_ip = 267; continue _fun124655 }
 232:
                    ...
                    if(!entity) { _fun124655_ip = 264; continue _fun124655 }
 261:
                    entity = zulu;
 264:
                    options = entity;
 267:
                    ...
                    if(!options) { _fun124655_ip = 352; continue _fun124655 }
 335:
                    report = report.expires_at;
                    if(!(golf != report)) { _fun124655_ip = 354; continue _fun124655 }
 345:
                    if(!(tango === zulu)) { _fun124655_ip = 352; continue _fun124655 }
 349:
                    if(!entity) { _fun124655_ip = 354; continue _fun124655 }
 352:
                    return oscar;
 354:
