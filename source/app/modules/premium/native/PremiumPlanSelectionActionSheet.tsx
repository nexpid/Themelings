...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
 ...
 625:
            ...
            romeon = null;
            if(!offset) { _fun00004_ip = 865; continue _fun00003 }
 687:
 ...
 865:
            ...
            sequen = output;
            if(!result) { _fun00004_ip = 917; continue _fun00003 }
 911:
 ...
 917:
            ...
            verify[0] = offset;
            offset = null;
            if(!yankee) { _fun00004_ip = 1244; continue _fun00003 }
 961:
            ...
            if(!result) { _fun00004_ip = 1006; continue _fun00003 }
 1000:
            output = 'text-normal';
 1006:
            yankee['color'] = output;
            ...
            backup = backup.YEAR;
            if(!(sizing !== backup)) { _fun00004_ip = 1138; continue _fun00003 }
 1040:
            ...
            ctrled = undefined;
            if(update) { _fun00004_ip = 1109; continue _fun00003 }
 1103:
            ctrled = source.priceString;
 1109:
            vacuum = echoed != ctrled;
            update = '$...';
            if(!vacuum) { _fun00004_ip = 1125; continue _fun00003 }
 1122:
            update = ctrled;
 1125:
            backup['price'] = update;
            backup = output.bind(result)(sizing, backup);
            _fun00004_ip = 1234; continue _fun00003;
 1138:
            sizing = _closure1_slot0;
            update = _closure1_slot2;
            kiloes = 15;
            ...
            update = undefined;
            if(ctrled) { _fun00004_ip = 1207; continue _fun00003 }
 1201:
            update = source.priceString;
 1207:
            source = echoed != update;
            echoed = '$...';
            if(!source) { _fun00004_ip = 1223; continue _fun00003 }
 1220:
            echoed = update;
 1223:
            kiloes['price'] = echoed;
 ...
 68:
                    ...
                    output = null;
                    golfie = null;
                    if(!report) { _fun00020_ip = 374; continue _fun00019 }
 106:
                    ...
                    vacuum = undefined;
                    if(record) { _fun00020_ip = 262; continue _fun00019 }
 256:
 ...
 262:
                    ...
                    record = output == sequen;
                    vacuum = undefined;
                    if(record) { _fun00020_ip = 292; continue _fun00019 }
 286:
 ...
 374:
                    ...
                    golfie = {};
                    yankee = undefined;
                    if(!romeon) { _fun00020_ip = 468; continue _fun00019 }
 413:
                    sizing = _closure1_slot0;
                    result = _closure1_slot2;
                    foxtra = 15;
 ...
 468:
                    ...
                    yankee[0] = foxtra;
                    romeon = !romeon;
                    if(!romeon) { _fun00020_ip = 536; continue _fun00019 }
 526:
