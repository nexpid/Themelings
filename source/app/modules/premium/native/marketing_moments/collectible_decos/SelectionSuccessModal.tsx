...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 28:
        ...
        zulu = new Array(0);
        offset = offset.bind(yankee)(options, oscar, zulu);
        ...
        report = function() { // Original name: render
            ...
            report = verify.bind(zulu)(report);
            report = report.t;
            options = report.BWsAzc;
            golf = {};
            foxtrot = _closure2_slot0;
            golf['itemName'] = foxtrot;
        ...
        report = 'COLLECTIBLE_MARKETING_MOMENT_SELECTION_SUCCESS';
        oscar[report] = entity;
        entity = 10;
        entity = golf[entity];
    ...
    zulu['default'] = mike;
    mike = 'COLLECTIBLE_MARKETING_MOMENT_SELECTION_SUCCESS';
    zulu['SelectionSuccessModalKey'] = mike;
    return entity;
})();