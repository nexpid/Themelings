...
export default (function(_, argBar, __, ___, ____, argFred, argPlugh) {
    ...
    mike = {'kind': 'user', 'id': '2023-06_ios_premium_trials', 'label': 'iOS Premium Trials'};
    tango = {};
    verify = false;
    ...
    tango = 'modules/premium/experiments/IOSPremiumTrialsExperiment.tsx';
    tango = report.bind(oscar)(tango);
    zulu['IOSPremiumTrialsExperiment'] = mike;
    return entity;
})();