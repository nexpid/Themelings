...
export default (function(_, argBar, __, ___, ____, argFre, argPlu) {
    ...
    michal = {'kind': 'user', 'id': '2024-08_halloween_nitro_gifting_campaign', 'label': 'Halloween nitro gifting campaign'};
    verify = {};
    yankee = false;
    ...
    tangon = 'modules/premium/experiments/GiftNitroHalloweenAvatarDecoExperiment.tsx';
    tangon = report.bind(oscard)(tangon);
    zuuluu['HalloweenNitroGiftingCampaign'] = michal;
    return entity;
})();