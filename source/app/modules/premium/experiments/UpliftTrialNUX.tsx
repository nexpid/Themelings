...
export default (function(_, argBar, __, ___, ____, argFre, argPlu) {
    ...
    michal = {'kind': 'user', 'id': '2024-12_uplift_trial_nux', 'commonTriggerPoint': null, 'label': 'Uplift Trial NUX'};
    ...
    tangon = 'modules/premium/experiments/UpliftTrialNUX.tsx';
    tangon = report.bind(oscard)(tangon);
    zuuluu['UpliftTrialNUXExperiment'] = michal;
    return entity;
})();