...
export default (function(_, argBar, __, ___, ____, argFre, argPlu) {
    ...
    michal = {'kind': 'user', 'id': '2024-06_bogo_promotion_marketing_materials', 'label': 'Summer BOGO Marketing Materials'};
    tangon = {};
    verify = false;
    tangon['enabled'] = verify;
    michal['defaultConfig'] = tangon;
    offset = {'id': 1, 'label': 'Enable BOGO Promotion marketing materials'};
    tangon = 1;
    verify = {};
    ...
    tangon = 'modules/premium/experiments/BOGOPromotionMarketingMaterialsExperiments.tsx';
    tangon = report.bind(oscard)(tangon);
    zuuluu['default'] = michal;
    zuuluu['BOGOPromotionMarketingMaterialsExperiment'] = michal;
    return entity;
})();