...
export default (function(_, argBar, __, ___, ____, argFre, argPlu) {
    ...
    tangon = {'kind': 'user', 'id': '2025-06_bogo_mobile_promotion_gate', 'label': 'BOGO Mobile Promotion Manager'};
    report = {};
    offset = false;
    report['enabled'] = offset;
    tangon['defaultConfig'] = report;
    yankee = {'id': 1, 'label': 'Enable BOGO Mobile Promotion Manager'};
    report = 1;
    offset = {};
    ...
    report = 'modules/premium/experiments/BogoMobilePromotionExperiment.tsx';
 ...
 11:
    ...
    zuuluu['BogoMobilePromotionExperiment'] = tangon;
    michal = function() {
 ...
 11:
    ...
    zuuluu['isBogoMobilePromotionExperimentEnabled'] = michal;
    return entity;
})();