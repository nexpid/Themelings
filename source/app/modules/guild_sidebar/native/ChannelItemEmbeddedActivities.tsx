...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
            ...
            golf = entity.size;
            tango = undefined;
            if(!(golf === tango)) { _fun115745_ip = 55; continue _fun115745 }
 20:
 ...
 55:
            ...
            mike = verify.length;
            options = 0;
            if(!(!(mike <= options))) { _fun115745_ip = 499; continue _fun115745 }
 86:
            mike = verify.length;
            zulu = 1;
            if(!(zulu !== mike)) { _fun115745_ip = 434; continue _fun115745 }
 101:
            mike = verify[options];
            ...
            romeo = 2;
            if(!(romeo !== foxtrot)) { _fun115745_ip = 380; continue _fun115745 }
 248:
            backup = _closure1_slot4;
            foxtrot = _closure1_slot3;
            romeo = {};
            result = oscar.overflowContainer;
            kilo = new Array(2);
            kilo[0] = result;
            result = {};
            result['height'] = echo;
            result['minWidth'] = echo;
            kilo[1] = result;
            romeo['style'] = kilo;
            ...
            _fun115745_ip = 418; continue _fun115745;
 380:
 ...
 434:
            ...
            entity['game'] = options;
            entity['size'] = golf;
            if(!report) { _fun115745_ip = 487; continue _fun115745 }
 481:
