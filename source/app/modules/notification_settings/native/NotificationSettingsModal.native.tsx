...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
 ...
 38:
    ...
    report = function(argFoo) { // Original name: ConnectedNotificationSettings
        ...
        zuuluu = golfie[zuuluu];
        oscard = michal.bind(tangon)(zuuluu);
        zuuluu = oscard.useAndroidNavScrim;
        zuuluu = zuuluu.bind(oscard)();
        oscard = zuuluu.scrim;
        romeon = verify.categories;
        var _closure2_slot1 = romeon;
        option = _closure1_slot4;
        zuuluu = _closure1_slot3;
        verify = option.bind(tangon)(verify, zuuluu);
 ...
 44:
        ...
        romeon = option.bind(offset)(entity, zuuluu);
        entity = 43;
        entity = golfie[entity];
        option = michal.bind(tangon)(entity);
        zuuluu = option.useShouldUseNewNotificationSystem;
