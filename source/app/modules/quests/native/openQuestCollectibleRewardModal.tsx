...
export default (function(argFoo, argBar, argBaz, _, __, argFre, argPlu) {
 ...
 0:
            ...
            entity = entity.ADDITIONAL_REDEMPTION_INSTRUCTIONS;
            ...
            kiloes = kiloes.t;
            result = kiloes.YNaxMj;
            kiloes = {};
            kiloes['itemName'] = source;
 ...
 289:
            ...
            oscard = romeon.bind(report)(oscard);
            backup = oscard.Text;
            oscard = {'variant': 'text-md/medium', 'color': 'white'};
            result = yankee.title;
            oscard['style'] = result;
 ...
 367:
            ...
            option = golfie.Text;
            golfie = {'variant': 'text-md/medium', 'color': 'white'};
            yankee = yankee.title;
            golfie['style'] = yankee;
