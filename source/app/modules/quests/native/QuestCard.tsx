...
export default (function(global, require, metroImportDefault, metroImportAll, moduleObject, exports, dependencyMap) {
 ...
 3070:
            ...
            var7['style'] = var23;
            if(!(var21 != var20)) { _fun0001_ip = 3623; continue _fun0001 }
 3367:
            if(var17) { _fun0001_ip = 3623; continue _fun0001 }
 3373:
            if(var11) { _fun0001_ip = 3623; continue _fun0001 }
 3379:
            if(var10) { _fun0001_ip = 3623; continue _fun0001 }
 3385:
            ...
            _fun0001_ip = 3678; continue _fun0001;
 3623:
 ...
 3678:
            var10 = new Array(3);
            var10[0] = var17;
            if(!var11) { _fun0001_ip = 3692; continue _fun0001 }
 3689:
            var11 = var13;
 3692:
 ...
 3695:
            var11 = var12;
 3698:
            if(!var11) { _fun0001_ip = 3819; continue _fun0001 }
 3701:
