...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
 ...
 0:
            michal = argFoo;
            report = michal.style;
            zuuluu = michal.withQuestName;
            tangon = undefined;
            yankee = tangon === zuuluu;
            if(yankee) { _fun00002_ip = 28; continue _fun00001 }
 25:
            yankee = zuuluu;
 28:
            michal = michal.withRewardAvailableCopy;
            verify = tangon === michal;
            if(verify) { _fun00002_ip = 44; continue _fun00001 }
 41:
            verify = michal;
 44:
 ...
 337:
            ...
            backup = backup.t;
            kiloes = backup.EAYZAg;
            backup = {};
            result = result.config;
            result = result.messages;
            result = result.questName;
            backup['questName'] = result;
 ...
 473:
            ...
            yankee = offset.Text;
            offset = {'variant': 'heading-sm/medium', 'color': 'text-secondary'};
            foxtra = 9;
