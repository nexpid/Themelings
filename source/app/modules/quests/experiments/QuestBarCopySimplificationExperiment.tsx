...
export default (function(argFoo, argBar, _, __, ___, argFred, argPlugh) {
    ...
    tango = {'id': '2025-01_quest_bar_copy_simplification', 'kind': 'user', 'label': 'Quest Bar Copy Simplification'};
    report = {};
    offset = false;
 ...
 0:
            ...
            mike = undefined;
            if(!(report === mike)) { _fun70813_ip = 22; continue _fun70813 }
 20:
            report = true;
 22:
    ...
    zulu['useIsQuestBarCopySimplificationEnabled'] = mike;
    return entity;
})();