...
export default (function(_, argBar, __, ___, ____, argFre, argPlu) {
    ...
    golfie = {'id': 1, 'label': 'Server Rail Entrypoint + Legacy Inbox'};
    romeon = {};
    backup = oscard.LEGACY;
    romeon['notificationCenterVariant'] = backup;
    backup = report.SERVER_RAIL_TOP;
    romeon['entrypoint'] = backup;
    romeon['filterStyle'] = foxtra;
    golfie['config'] = romeon;
    romeon = new Array(4);
    romeon[0] = golfie;
    foxtra = {'id': 2, 'label': 'Title Bar Entrypoint + Popout'};
    golfie = 2;
    backup = {};
    ...
    romeon[1] = foxtra;
    foxtra = {'id': 3, 'label': 'Server Rail Entrypoint + Sidebar'};
    backup = {};
    kiloes = oscard.SIDEBAR;
    backup['notificationCenterVariant'] = kiloes;
    kiloes = report.SERVER_RAIL_TOP;
    backup['entrypoint'] = kiloes;
    kiloes = tangon.DROPDOWN;
    backup['filterStyle'] = kiloes;
    foxtra['config'] = backup;
    romeon[2] = foxtra;
    foxtra = {'id': 4, 'label': 'Server Rail Entrypoint + Popout'};
    backup = {};
    kiloes = oscard.POPOUT;
    backup['notificationCenterVariant'] = kiloes;
    kiloes = report.SERVER_RAIL_TOP;
