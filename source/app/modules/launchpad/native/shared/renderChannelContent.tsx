...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
        ...
        kilo = -1;
        output = kilo;
        if(!result) { _fun121019_ip = 238; continue _fun121019 }
 235:
        output = yankee;
 238:
        ...
        if(!output) { _fun121019_ip = 345; continue _fun121019 }
 342:
        kilo = sizing;
 345:
        ...
        backup = 0;
        if(!kilo) { _fun121019_ip = 414; continue _fun121019 }
 411:
        backup = yankee;
 414:
        ...
        offset = 0;
        if(!romeo) { _fun121019_ip = 456; continue _fun121019 }
 453:
        offset = yankee;
 456:
 ...
 0:
                ...
                kilo = zulu.subtitle;
                target = zulu.unread;
                papa = zulu.resolvedUnreadSetting;
                entity = zulu.locked;
                control = zulu.muted;
                result = zulu.lastMessageTimestampString;
                mike = zulu.channel;
                context = zulu.connected;
                ...
                sequence = null;
                lima = sequence != mike;
                if(!lima) { _fun121020_ip = 148; continue _fun121020 }
 117:
                if(entity) { _fun121020_ip = 145; continue _fun121020 }
 120:
                report = _closure1_slot1;
 ...
 148:
                ...
                if(!sierra) { _fun121020_ip = 165; continue _fun121020 }
 155:
                entity = mike.isNSFW;
 ...
 165:
                ...
                romeo = echo;
                if(!echo) { _fun121020_ip = 194; continue _fun121020 }
 190:
                romeo = sequence == output;
 194:
                update = 'text-muted';
                variable36 = update;
                if(!control) { _fun121020_ip = 212; continue _fun121020 }
 206:
 ...
 212:
                ...
                verify = {};
                yankee = 'center';
                if(!offset) { _fun121020_ip = 291; continue _fun121020 }
 285:
 ...
 291:
                ...
                sizing = 0;
                source = 0;
                if(!romeo) { _fun121020_ip = 337; continue _fun121020 }
 334:
                source = 30;
 337:
                ...
                if(!(sequence == papa)) { _fun121020_ip = 401; continue _fun121020 }
 391:
                target = _closure1_slot6;
                papa = target.ONLY_MENTIONS;
 401:
                backup['resolvedUnreadSetting'] = papa;
                backup['connected'] = context;
                source = record.bind(tango)(source, backup);
                backup = new Array(2);
                backup[0] = source;
                source = lima;
                if(lima) { _fun121020_ip = 434; continue _fun121020 }
 431:
                source = sierra;
 434:
                if(!source) { _fun121020_ip = 715; continue _fun121020 }
 440:
                ...
                quebec = 1;
                variable37 = quebec;
                if(!lima) { _fun121020_ip = 488; continue _fun121020 }
 479:
                variable37 = quebec;
                if(!sierra) { _fun121020_ip = 488; continue _fun121020 }
 485:
                variable37 = 2;
 488:
                quebec = 14;
                ...
                target[1] = whiskey;
                record['style'] = target;
                if(!lima) { _fun121020_ip = 575; continue _fun121020 }
 511:
 ...
 575:
                target = new Array(3);
                target[0] = lima;
                if(!sierra) { _fun121020_ip = 650; continue _fun121020 }
 586:
                quebec = _closure1_slot7;
                whiskey = _closure1_slot0;
                variable37 = _closure1_slot2;
 ...
 650:
                target[1] = sierra;
                if(!status) { _fun121020_ip = 701; continue _fun121020 }
 657:
 ...
 715:
                ...
                options[0] = verify;
                verify = null;
                if(!offset) { _fun121020_ip = 832; continue _fun121020 }
 742:
                ...
                sequence = 0;
                if(!record) { _fun121020_ip = 766; continue _fun121020 }
 763:
                sequence = config;
 766:
                sequence = sequence > sizing;
                sizing = 0;
                if(!sequence) { _fun121020_ip = 778; continue _fun121020 }
 775:
                sizing = 20;
 778:
 ...
 832:
                ...
                if(romeo) { _fun121020_ip = 879; continue _fun121020 }
 871:
                yankee = backup.rightBox;
                _fun121020_ip = 885; continue _fun121020;
 879:
                yankee = backup.rightContentAbsolute;
 885:
                options['style'] = yankee;
                backup = echo;
                if(!echo) { _fun121020_ip = 1001; continue _fun121020 }
 895:
                ...
                if(!control) { _fun121020_ip = 943; continue _fun121020 }
 937:
 ...
 943:
                ...
                source = 1;
                if(control) { _fun121020_ip = 968; continue _fun121020 }
 964:
 ...
 1001:
                ...
                result[0] = update;
                if(!echo) { _fun121020_ip = 1056; continue _fun121020 }
 1044:
                update = {};
                source = 5;
 ...
 1056:
                ...
                yankee[1] = backup;
                if(!romeo) { _fun121020_ip = 1110; continue _fun121020 }
 1081:
