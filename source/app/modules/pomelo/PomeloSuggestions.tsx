...
export default (function(_, argBar, __, ___, ____, argFred, argPlugh) {
    ...
    golf = {'kind': 'user', 'label': 'Pomelo Suggestions', 'id': '2023-04_pomelo_suggestions'};
    tango = {};
    offset = false;
    ...
    tango = 'modules/pomelo/PomeloSuggestions.tsx';
    ...
    zulu['isInPomeloSuggestionsExperiment'] = mike;
    return entity;
})();