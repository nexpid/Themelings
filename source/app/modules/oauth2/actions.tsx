...
export default (function(argFoo, argBar, argBaz, argCorge, argGrault, argFred, argPlugh) {
 ...
 0:
            ...
            golf = tango == report;
            oscar = undefined;
            if(golf) { _fun73751_ip = 50; continue _fun73751 }
 45:
            oscar = report.guild_id;
 50:
            if(!(tango == oscar)) { _fun73751_ip = 58; continue _fun73751 }
 54:
 ...
 58:
            ...
            golf = tango == report;
            oscar = undefined;
            if(golf) { _fun73751_ip = 76; continue _fun73751 }
 71:
            oscar = report.id;
 76:
            if(!(tango == oscar)) { _fun73751_ip = 84; continue _fun73751 }
 80:
 ...
 84:
            ...
            oscar = tango == report;
            mike = undefined;
            if(oscar) { _fun73751_ip = 102; continue _fun73751 }
 97:
            mike = report.type;
 102:
            if(!(tango == mike)) { _fun73751_ip = 116; continue _fun73751 }
 106:
 ...
 0:
                    ...
                    if(zulu) { _fun73754_ip = 347; continue _fun73754 }
 13:
 ...
 94:
                    ...
                    if(zulu) { _fun73754_ip = 344; continue _fun73754 }
 103:
                    ...
                    sizing = backup != romeo;
                    kilo = undefined;
                    if(!sizing) { _fun73754_ip = 241; continue _fun73754 }
 229:
 ...
 241:
                    ...
                    kilo = backup == romeo;
                    romeo = undefined;
                    if(!kilo) { _fun73754_ip = 267; continue _fun73754 }
 255:
                    backup = backup != foxtrot;
                    romeo = undefined;
                    if(!backup) { _fun73754_ip = 267; continue _fun73754 }
 264:
                    romeo = foxtrot;
 267:
 ...
 327:
                    ...
                    if(tango) { _fun73754_ip = 341; continue _fun73754 }
 333:
                    tango = zulu.body;
                    return tango;
 341:
 ...
 0:
                    ...
                    mike = argFoo;
                    ResumeGenerator(result_out_reg=0, return_bool_out_reg=2);
                    if(zulu) { _fun73757_ip = 247; continue _fun73757 }
 13:
 ...
 78:
                    ResumeGenerator(result_out_reg=1, return_bool_out_reg=2);
                    if(zulu) { _fun73757_ip = 244; continue _fun73757 }
 87:
                    tango = _closure1_slot0;
 ...
 227:
                    ResumeGenerator(result_out_reg=2, return_bool_out_reg=3);
                    if(tango) { _fun73757_ip = 241; continue _fun73757 }
 233:
                    tango = zulu.body;
                    return tango;
 241:
 ...
 0:
                    ...
                    if(mike) { _fun73760_ip = 156; continue _fun73760 }
 13:
                    tango = _closure1_slot0;
 ...
 144:
                    ...
                    if(tango) { _fun73760_ip = 153; continue _fun73760 }
 150:
                    return zulu;
 153:
                    return mike;
 ...
 0:
                    StartGenerator();
                    ResumeGenerator(result_out_reg=0, return_bool_out_reg=1);
                    if(mike) { _fun73763_ip = 110; continue _fun73763 }
 7:
                    tango = _closure1_slot0;
                    zulu = _closure1_slot2;
                    mike = 4;
 ...
 93:
                    ResumeGenerator(result_out_reg=1, return_bool_out_reg=2);
                    if(zulu) { _fun73763_ip = 107; continue _fun73763 }
 99:
                    zulu = mike.body;
                    return zulu;
 107:
 ...
 0:
                    StartGenerator();
                    ResumeGenerator(result_out_reg=0, return_bool_out_reg=1);
                    if(mike) { _fun73766_ip = 100; continue _fun73766 }
 7:
                    tango = _closure1_slot0;
                    zulu = _closure1_slot2;
                    mike = 4;
 ...
 88:
                    ResumeGenerator(result_out_reg=1, return_bool_out_reg=2);
                    if(zulu) { _fun73766_ip = 97; continue _fun73766 }
 94:
                    return mike;
 97:
                    return mike;
 ...
 0:
                    StartGenerator();
                    ResumeGenerator(result_out_reg=0, return_bool_out_reg=1);
                    if(mike) { _fun73769_ip = 108; continue _fun73769 }
 7:
                    tango = _closure1_slot0;
                    zulu = _closure1_slot2;
                    mike = 4;
 ...
 96:
                    ResumeGenerator(result_out_reg=1, return_bool_out_reg=2);
                    if(zulu) { _fun73769_ip = 105; continue _fun73769 }
 102:
                    return mike;
 105:
                    return mike;
 ...
 0:
                    StartGenerator();
                    ResumeGenerator(result_out_reg=0, return_bool_out_reg=1);
                    if(mike) { _fun73772_ip = 132; continue _fun73772 }
 10:
                    tango = _closure1_slot0;
                    zulu = _closure1_slot2;
                    mike = 4;
 ...
 120:
                    ResumeGenerator(result_out_reg=1, return_bool_out_reg=2);
                    if(zulu) { _fun73772_ip = 129; continue _fun73772 }
 126:
                    return mike;
 129:
                    return mike;
