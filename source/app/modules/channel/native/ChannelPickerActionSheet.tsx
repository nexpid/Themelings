...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
            ...
            echo = entity.bottom;
            sizing = report.header;
            entity = report.guild;
            var _closure2_slot1 = entity;
            kilo = report.channels;
            var _closure2_slot2 = kilo;
            entity = report.onSelect;
            var _closure2_slot3 = entity;
            output = report.selectedChannel;
            romeo = null;
            entity = romeo != sizing;
            golf = undefined;
 ...
 118:
            ...
            entity = mike.bind(tango)(entity);
            mike = entity.ActionSheetCloseButton;
            entity = {};
 ...
 227:
            ...
            report = report.noChannelOptionLabel;
            entity['label'] = report;
            report = 9;
            report = yankee[report];
            report = oscar.bind(tango)(report);
            oscar = report.TableRowIcon;
            report = {};
 ...
 466:
            echo = romeo != result;
            output = '';
            if(!echo) { _fun00002_ip = 480; continue _fun00001 }
 477:
            output = result;
 480:
            verify['value'] = output;
 ...
 17:
                    ...
                    zulu = null;
                    if(!(zulu == mike)) { _fun00004_ip = 112; continue _fun00003 }
 36:
                    ...
                    tango = null;
                    if(!(tango != report)) { _fun00004_ip = 108; continue _fun00003 }
 64:
 ...
 0:
                    ...
                    mike = verify[mike];
                    report = undefined;
                    tango = options.bind(report)(mike);
                    ...
                    oscar = verify.bind(yankee)(entity, options, oscar);
                    mike['label'] = oscar;
                    oscar = null;
                    options = oscar != offset;
                    if(!options) { _fun00006_ip = 168; continue _fun00005 }
 126:
