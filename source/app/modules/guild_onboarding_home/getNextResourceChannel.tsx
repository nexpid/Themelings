...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
 ...
 0:
            ...
            entity = 0;
            if(!(!(tango < entity))) { _fun100641_ip = 92; continue _fun100641 }
 54:
            mike = zulu[tango];
            entity = new Array(2);
            entity[0] = mike;
            ...
            mike = zulu[mike];
            entity[1] = mike;
            _fun100641_ip = 102; continue _fun100641;
 92:
            entity = [null, null];
 102:
            return entity;
 ...
 0:
            ...
            entity = 0;
            if(!(!(mike < entity))) { _fun100643_ip = 191; continue _fun100643 }
 95:
            entity = zulu.length;
            if(!(!(entity <= tango))) { _fun100643_ip = 191; continue _fun100643 }
 104:
            report = zulu.length;
            entity = 2;
            if(!(entity !== report)) { _fun100643_ip = 164; continue _fun100643 }
 116:
            report = mike - tango;
            entity = zulu.length;
            ...
            report = zulu[report];
            entity[1] = report;
            _fun100643_ip = 189; continue _fun100643;
 164:
            mike = tango - mike;
            zulu = zulu[mike];
            mike = [null];
            ...
            entity = mike;
 189:
            _fun100643_ip = 201; continue _fun100643;
 191:
            entity = [null, null];
 201:
            return entity;
