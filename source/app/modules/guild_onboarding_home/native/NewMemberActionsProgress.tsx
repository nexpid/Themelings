...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    entity = function(argFoo) { // Original name: ProgressBar
        entity = argFoo;
        foxtrot = entity.percent;
        ...
        entity = {};
        oscar = options.progressBackground;
        entity['style'] = oscar;
        ...
        report = {};
        verify = options.progressForeground;
        options = new Array(2);
        options[0] = verify;
        verify = {};
        offset = global;
        ...
        options = ['rgba(103, 203, 134, 1)', 'rgba(59, 165, 92, 1)'];
        report['colors'] = options;
        options = true;
        report['useAngle'] = options;
        options = -90;
        report['angle'] = options;
    ...
    tango['spaceBetween'] = verify;
    verify = {};
    verify['marginBottom'] = offset;
    tango['spaceBelow'] = verify;
    verify = {};
    yankee = 9;
    ...
    tango = 'modules/guild_onboarding_home/native/NewMemberActionsProgress.tsx';
    tango = report.bind(oscar)(tango);
    mike = function(argFoo) { // Original name: NewMemberActionsProgress
 ...
 0:
            ...
            entity = offset.bind(yankee)(verify, entity, options);
            ...
            zulu = tango == entity;
            options = undefined;
            if(zulu) { _fun115665_ip = 188; continue _fun115665 }
 183:
 ...
 188:
            ...
            zulu = 0;
            yankee = 0;
            if(!verify) { _fun115665_ip = 202; continue _fun115665 }
 199:
            yankee = options;
 202:
 ...
 0:
                    ...
                    tango = null;
                    if(!(tango != zulu)) { _fun115669_ip = 56; continue _fun115669 }
 15:
 ...
 0:
                            ...
                            mike = mike[entity];
                            entity = null;
                            if(!(entity != mike)) { _fun115670_ip = 39; continue _fun115670 }
 25:
 ...
 56:
            ...
            offset = verify.bind(offset)(entity, options);
            ...
            romeo = tango == mike;
            entity = undefined;
            if(romeo) { _fun115665_ip = 276; continue _fun115665 }
 271:
            entity = mike.flags;
 276:
            romeo = tango != entity;
            mike = 0;
            if(!romeo) { _fun115665_ip = 288; continue _fun115665 }
 285:
            mike = entity;
 288:
            ...
            entity = null;
            if(mike) { _fun115665_ip = 850; continue _fun115665 }
 312:
            entity = null;
            if(!(zulu !== yankee)) { _fun115665_ip = 850; continue _fun115665 }
 321:
            mike = offset + yankee;
            entity = null;
            if(!(mike !== zulu)) { _fun115665_ip = 850; continue _fun115665 }
 334:
            ...
            mike = {'accessibilityRole': 'button', 'activeOpacity': 0.4};
            ...
            oscar = {};
            romeo = backup.horizontal;
            verify = new Array(3);
            verify[0] = romeo;
            romeo = backup.spaceBetween;
            verify[1] = romeo;
            romeo = backup.spaceBelow;
            verify[2] = romeo;
            oscar['style'] = verify;
            ...
            romeo = verify.Text;
            verify = {'variant': 'text-xs/bold', 'color': 'header-primary'};
            output = 16;
            ...
            output = output.t;
            output = output.LhlgY2;
            output = result.bind(echo)(output);
            verify['children'] = output;
            romeo = foxtrot.bind(report)(romeo, verify);
            verify = new Array(2);
            verify[0] = romeo;
            foxtrot = _closure1_slot4;
            romeo = {};
            backup = backup.horizontal;
            romeo['style'] = backup;
            result = _closure1_slot10;
            backup = update[kilo];
            backup = sizing.bind(report)(backup);
            output = backup.Text;
            backup = {'variant': 'text-xs/bold', 'color': 'header-primary'};
            backup['children'] = offset;
            ...
            output = sizing.bind(report)(output);
            result = output.Text;
            output = {'variant': 'text-xs/medium', 'color': 'header-secondary', 'children': '/'};
            ...
            sizing = kilo.Text;
            kilo = {'variant': 'text-xs/bold', 'color': 'header-primary'};
            kilo['children'] = yankee;
 ...
 850:
    ...
    zulu['NewMemberActionsProgress'] = mike;
    return entity;
})();