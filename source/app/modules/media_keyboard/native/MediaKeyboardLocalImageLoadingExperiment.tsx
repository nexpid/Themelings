...
export default (function(global, require, metroImportDefault, metroImportAll, moduleObject, exports, dependencyMap) {
    ...
    var2 = {'kind': 'user', 'id': '2025-10_android_local_image_loading_serialization', 'label': 'Android Local Image Loading Serialization'};
    var9 = {};
    var11 = false;
    var9['enabled'] = var11;
    ...
    var9 = {'id': 1, 'label': 'Use serialization when loading local images'};
    var8 = {};
    var8['enabled'] = var10;
    var9['config'] = var8;
    var8 = new Array(1);
