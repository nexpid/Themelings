// app/modules/report_to_mod/ReportToModExperiment.tsx
export default (function(_, argBar, __, ___, ____, argFre, argPlu) {
    ...
    michal = {'kind': 'guild', 'id': '2025-04_report_to_mod', 'label': 'Report to moderator'};
    ...
    verify = {'id': 1, 'label': 'report to moderator triggering'};
    option = {};
    ...
    tangon = 'modules/report_to_mod/ReportToModExperiment.tsx';
