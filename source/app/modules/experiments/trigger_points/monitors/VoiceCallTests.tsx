...
export default (function(_, argBar, argBaz, __, ___, argFre, argPlu) {
    ...
    michal = {'kind': 'user', 'id': '2024-06_ctp_voice_call_vanilla', 'label': 'CTP voice call - A/A test - Vanilla'};
    tangon = {};
    kiloes = false;
    tangon['doSomething'] = kiloes;
    michal['defaultConfig'] = tangon;
    tangon = romeon.VOICE_CALL;
    ...
    michal = {'kind': 'user', 'id': '2024-06_ctp_voice_call_filters', 'label': 'CTP voice call - A/A test - Filters'};
    tangon = {};
    tangon['doSomething'] = kiloes;
    michal['defaultConfig'] = tangon;
    tangon = romeon.VOICE_CALL;
    ...
    michal = {'kind': 'user', 'id': '2024-06_ctp_voice_call_multiple_buckets', 'label': 'CTP voice call - A/A test - Multiple buckets'};
    tangon = {};
    tangon['doSomething'] = kiloes;
    michal['defaultConfig'] = tangon;
    tangon = romeon.VOICE_CALL;
    ...
    michal = {'kind': 'user', 'id': '2024-06_ctp_voice_call_everyone', 'label': 'CTP voice call - A/A test - Everyone'};
    tangon = {};
    tangon['doSomething'] = kiloes;
    michal['defaultConfig'] = tangon;
    tangon = romeon.VOICE_CALL;
    ...
    michal = {'kind': 'user', 'id': '2024-06_ctp_voice_call_uneven_buckets', 'label': 'CTP voice call - A/A test - Uneven buckets'};
    foxtra = {};
    foxtra['doSomething'] = kiloes;
    michal['defaultConfig'] = foxtra;
    romeon = romeon.VOICE_CALL;
    ...
    option = 'modules/experiments/trigger_points/monitors/VoiceCallTests.tsx';
