...
export default (function(_, argBar, argBaz, __, ___, argFre, argPlu) {
    ...
    michal = {'kind': 'user', 'id': '2024-07_ctp_open_nitro_vanilla', 'label': 'CTP open nitro - A/A test - Vanilla'};
    tangon = {};
    kiloes = false;
    tangon['doSomething'] = kiloes;
    michal['defaultConfig'] = tangon;
    tangon = romeon.OPEN_NITRO;
    ...
    michal = {'kind': 'user', 'id': '2024-07_ctp_open_nitro_filters', 'label': 'CTP open nitro - A/A test - Filters'};
    tangon = {};
    tangon['doSomething'] = kiloes;
    michal['defaultConfig'] = tangon;
    tangon = romeon.OPEN_NITRO;
    ...
    michal = {'kind': 'user', 'id': '2024-07_ctp_open_nitro_multiple_buckets', 'label': 'CTP open nitro - A/A test - Multiple buckets'};
    tangon = {};
    tangon['doSomething'] = kiloes;
    michal['defaultConfig'] = tangon;
    tangon = romeon.OPEN_NITRO;
    ...
    michal = {'kind': 'user', 'id': '2024-07_ctp_open_nitro_everyone', 'label': 'CTP open nitro - A/A test - Everyone'};
    tangon = {};
    tangon['doSomething'] = kiloes;
    michal['defaultConfig'] = tangon;
    tangon = romeon.OPEN_NITRO;
    ...
    michal = {'kind': 'user', 'id': '2024-07_ctp_open_nitro_uneven_buckets', 'label': 'CTP open nitro - A/A test - Uneven buckets'};
    foxtra = {};
    foxtra['doSomething'] = kiloes;
    michal['defaultConfig'] = foxtra;
    romeon = romeon.OPEN_NITRO;
    ...
    option = 'modules/experiments/trigger_points/monitors/OpenNitroTests.tsx';
