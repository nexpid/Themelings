...
export default (function(_, argBar, argBaz, __, ___, argFred, argPlugh) {
    ...
    mike = {'kind': 'user', 'id': '2024-08_ctp_dmgdm_list_render__vanilla_', 'label': 'CTP DM/GDM List Render - A/A test - Vanilla'};
    tango = {};
    kilo = false;
    tango['doSomething'] = kilo;
    mike['defaultConfig'] = tango;
    tango = romeo.DM_GDM_LIST_RENDER;
    ...
    mike = {'kind': 'user', 'id': '2024-08_ctp_dmgdm_list_render__filters', 'label': 'CTP DM/GDM List Render - A/A test - Filters'};
    tango = {};
    tango['doSomething'] = kilo;
    mike['defaultConfig'] = tango;
    tango = romeo.DM_GDM_LIST_RENDER;
    ...
    mike = {'kind': 'user', 'id': '2024-08_ctp_dmgdm_list_render__multiple_buckets', 'label': 'CTP DM/GDM List Render - A/A test - Multiple buckets'};
    tango = {};
    tango['doSomething'] = kilo;
    mike['defaultConfig'] = tango;
    tango = romeo.DM_GDM_LIST_RENDER;
    ...
    mike = {'kind': 'user', 'id': '2024-08_ctp_dmgdm_list_render__everyone', 'label': 'CTP DM/GDM List Render - A/A test - Everyone'};
    tango = {};
    tango['doSomething'] = kilo;
    mike['defaultConfig'] = tango;
    tango = romeo.DM_GDM_LIST_RENDER;
    ...
    mike = {'kind': 'user', 'id': '2024-08_ctp_dmgdm_list_render__uneven_buckets', 'label': 'CTP DM/GDM List Render - A/A test - Uneven buckets'};
    foxtrot = {};
    foxtrot['doSomething'] = kilo;
    mike['defaultConfig'] = foxtrot;
    romeo = romeo.DM_GDM_LIST_RENDER;
    ...
    options = 'modules/experiments/trigger_points/monitors/DmGdmListRenderTests.tsx';
