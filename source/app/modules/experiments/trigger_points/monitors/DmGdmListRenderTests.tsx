...
export default (function(_, argBar, argBaz, __, ___, argFre, argPlu) {
    ...
    michal = {'kind': 'user', 'id': '2024-08_ctp_dmgdm_list_render__vanilla_', 'label': 'CTP DM/GDM List Render - A/A test - Vanilla'};
    tangon = {};
    kiloes = false;
    tangon['doSomething'] = kiloes;
    michal['defaultConfig'] = tangon;
    tangon = romeon.DM_GDM_LIST_RENDER;
    ...
    michal = {'kind': 'user', 'id': '2024-08_ctp_dmgdm_list_render__filters', 'label': 'CTP DM/GDM List Render - A/A test - Filters'};
    tangon = {};
    tangon['doSomething'] = kiloes;
    michal['defaultConfig'] = tangon;
    tangon = romeon.DM_GDM_LIST_RENDER;
    ...
    michal = {'kind': 'user', 'id': '2024-08_ctp_dmgdm_list_render__multiple_buckets', 'label': 'CTP DM/GDM List Render - A/A test - Multiple buckets'};
    tangon = {};
    tangon['doSomething'] = kiloes;
    michal['defaultConfig'] = tangon;
    tangon = romeon.DM_GDM_LIST_RENDER;
    ...
    michal = {'kind': 'user', 'id': '2024-08_ctp_dmgdm_list_render__everyone', 'label': 'CTP DM/GDM List Render - A/A test - Everyone'};
    tangon = {};
    tangon['doSomething'] = kiloes;
    michal['defaultConfig'] = tangon;
    tangon = romeon.DM_GDM_LIST_RENDER;
    ...
    michal = {'kind': 'user', 'id': '2024-08_ctp_dmgdm_list_render__uneven_buckets', 'label': 'CTP DM/GDM List Render - A/A test - Uneven buckets'};
    foxtra = {};
    foxtra['doSomething'] = kiloes;
    michal['defaultConfig'] = foxtra;
    romeon = romeon.DM_GDM_LIST_RENDER;
    ...
    option = 'modules/experiments/trigger_points/monitors/DmGdmListRenderTests.tsx';
