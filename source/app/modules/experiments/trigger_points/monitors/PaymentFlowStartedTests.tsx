...
export default (function(_, argBar, argBaz, __, ___, argFred, argPlugh) {
    ...
    mike = {'kind': 'user', 'id': '2024-07_ctp_payment_flow_started_vanilla', 'label': 'CTP payment flow started - A/A test - Vanilla'};
    tango = {};
    kilo = false;
    tango['doSomething'] = kilo;
    mike['defaultConfig'] = tango;
    tango = romeo.PAYMENT_FLOW_STARTED;
    ...
    mike = {'kind': 'user', 'id': '2024-07_ctp_payment_flow_started_filters_', 'label': 'CTP payment flow started - A/A test - Filters'};
    tango = {};
    tango['doSomething'] = kilo;
    mike['defaultConfig'] = tango;
    tango = romeo.PAYMENT_FLOW_STARTED;
    ...
    mike = {'kind': 'user', 'id': '2024-07_ctp_payment_flow_started_multiple_buckets', 'label': 'CTP payment flow started - A/A test - Multiple buckets'};
    tango = {};
    tango['doSomething'] = kilo;
    mike['defaultConfig'] = tango;
    tango = romeo.PAYMENT_FLOW_STARTED;
    ...
    mike = {'kind': 'user', 'id': '2024-07_ctp_payment_flow_started_everyone', 'label': 'CTP payment flow started - A/A test - Everyone'};
    tango = {};
    tango['doSomething'] = kilo;
    mike['defaultConfig'] = tango;
    tango = romeo.PAYMENT_FLOW_STARTED;
    ...
    mike = {'kind': 'user', 'id': '2024-07_ctp_payment_flow_started_uneven_buckets_', 'label': 'CTP payment flow started - A/A test - Uneven buckets'};
    foxtrot = {};
    foxtrot['doSomething'] = kilo;
    mike['defaultConfig'] = foxtrot;
    romeo = romeo.PAYMENT_FLOW_STARTED;
    ...
    options = 'modules/experiments/trigger_points/monitors/PaymentFlowStartedTests.tsx';
