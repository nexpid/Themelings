...
export default (function(_, argBar, argBaz, __, ___, argFre, argPlu) {
    ...
    michal = {'kind': 'user', 'id': '2025-02_test_user_auth_apply_filter_marketing', 'label': 'Test User Auth Apply Filter Marketing'};
    golfie = {};
    option = false;
    ...
    tangon = 'modules/experiments/test_experiments/TestUserAuthApplyFilterMarketingExperiment.tsx';
    tangon = report.bind(oscard)(tangon);
    zuuluu['TestUserAuthApplyFilterMarketingExperiment'] = michal;
    return entity;
})();