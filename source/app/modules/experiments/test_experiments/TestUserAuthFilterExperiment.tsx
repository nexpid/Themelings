...
export default (function(_, argBar, argBaz, __, ___, argFre, argPlu) {
    ...
    michal = {'kind': 'user', 'id': '2025-02_test_user_auth_filter', 'label': 'Test User Auth Filter'};
    golfie = {};
    option = false;
    ...
    tangon = 'modules/experiments/test_experiments/TestUserAuthFilterExperiment.tsx';
    tangon = report.bind(oscard)(tangon);
    zuuluu['TestUserAuthFilterExperiment'] = michal;
    return entity;
})();