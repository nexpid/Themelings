...
export default (function(_, argBar, argBaz, __, ___, argFred, argPlugh) {
    ...
    mike = {'kind': 'user', 'id': '2025-02_test_user_auth_filter', 'label': 'Test User Auth Filter'};
    golf = {};
    options = false;
    ...
    tango = 'modules/experiments/test_experiments/TestUserAuthFilterExperiment.tsx';
    tango = report.bind(oscar)(tango);
    zulu['TestUserAuthFilterExperiment'] = mike;
    return entity;
})();