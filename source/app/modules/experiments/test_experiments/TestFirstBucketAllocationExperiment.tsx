...
export default (function(_, argBar, argBaz, __, ___, argFre, argPlu) {
    ...
    michal = {'kind': 'user', 'id': '2025-02_test_first_bucket_allocation', 'label': 'Test First Bucket Allocation Experiment'};
    tangon = {};
    option = false;
    ...
    tangon = 'modules/experiments/test_experiments/TestFirstBucketAllocationExperiment.tsx';
    tangon = report.bind(oscard)(tangon);
    zuuluu['TestFirstBucketAllocationExperiment'] = michal;
    return entity;
})();