...
export default (function(_, argBar, argBaz, __, ___, argFre, argPlu) {
    ...
    michal = {'kind': 'user', 'id': '2025-02_test_third_bucket_allocation', 'label': 'Test Third Bucket Allocation Experiment'};
    tangon = {};
    option = false;
    ...
    tangon = 'modules/experiments/test_experiments/TestThirdBucketAllocationExperiment.tsx';
    tangon = report.bind(oscard)(tangon);
    zuuluu['TestThirdBucketAllocationExperiment'] = michal;
    return entity;
})();