...
export default (function(_, argBar, argBaz, __, ___, argFre, argPlu) {
    ...
    michal = {'kind': 'user', 'id': '2025-02_test_user_auth_apply_filter', 'label': 'Test User Auth Apply Filter'};
    golfie = {};
    option = false;
    ...
    tangon = 'modules/experiments/test_experiments/TestUserAuthApplyFilterExperiment.tsx';
    tangon = report.bind(oscard)(tangon);
    zuuluu['TestUserAuthApplyFilterExperiment'] = michal;
    return entity;
})();