...
export default (function(_, argBar, argBaz, __, ___, argFre, argPlu) {
    ...
    michal = {'kind': 'user', 'id': '2025-02_test_user_auth_filter_badges', 'label': 'Test User Auth Filter Badges'};
    golfie = {};
    option = false;
    ...
    tangon = 'modules/experiments/test_experiments/TestUserAuthFilterBadgesExperiment.tsx';
    tangon = report.bind(oscard)(tangon);
    zuuluu['TestUserAuthFilterBadgesExperiment'] = michal;
    return entity;
})();