...
export default (function(_, argBar, argBaz, __, ___, argFred, argPlugh) {
    ...
    mike = {'kind': 'user', 'id': '2025-02_test_user_auth_apply_filter_install', 'label': 'Test User Auth Apply Filter Install'};
    golf = {};
    options = false;
    ...
    tango = 'modules/experiments/test_experiments/TestUserAuthApplyFilterInstallExperiment.tsx';
    tango = report.bind(oscar)(tango);
    zulu['TestUserAuthApplyFilterInstallExperiment'] = mike;
    return entity;
})();