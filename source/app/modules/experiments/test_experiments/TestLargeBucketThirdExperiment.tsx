...
export default (function(_, argBar, argBaz, __, ___, argFre, argPlu) {
    ...
    michal = {'kind': 'user', 'id': '2025-02_test_large_bucket_third', 'label': 'Test Large Bucket Third Experiment'};
    tangon = {};
    option = false;
    ...
    tangon = 'modules/experiments/test_experiments/TestLargeBucketThirdExperiment.tsx';
    tangon = report.bind(oscard)(tangon);
    zuuluu['TestLargeBucketThirdExperiment'] = michal;
    return entity;
})();