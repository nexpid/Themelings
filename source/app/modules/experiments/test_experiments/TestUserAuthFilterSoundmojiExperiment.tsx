...
export default (function(_, argBar, argBaz, __, ___, argFre, argPlu) {
    ...
    michal = {'kind': 'user', 'id': '2025-02_test_user_auth_filter_soundmoji', 'label': 'Test User Auth Filter Soundmoji'};
    golfie = {};
    option = false;
    ...
    tangon = 'modules/experiments/test_experiments/TestUserAuthFilterSoundmojiExperiment.tsx';
    tangon = report.bind(oscard)(tangon);
    zuuluu['TestUserAuthFilterSoundmojiExperiment'] = michal;
    return entity;
})();