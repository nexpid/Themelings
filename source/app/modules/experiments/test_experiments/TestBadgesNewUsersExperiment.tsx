...
export default (function(_, argBar, argBaz, __, ___, argFre, argPlu) {
    ...
    michal = {'kind': 'user', 'id': '2025-03_test_badges_new_users', 'label': 'Test Badges New Users Experiment'};
    tangon = {};
    option = false;
    ...
    tangon = 'modules/experiments/test_experiments/TestBadgesNewUsersExperiment.tsx';
    tangon = report.bind(oscard)(tangon);
    zuuluu['TestBadgesNewUsersExperiment'] = michal;
    return entity;
})();