...
export default (function(_, argBar, argBaz, __, ___, argFre, argPlu) {
    ...
    michal = {'kind': 'user', 'id': '2025-02_test_user_auth_filter_anniversaries', 'label': 'Test User Auth Filter Anniversaries'};
    golfie = {};
    option = false;
    ...
    tangon = 'modules/experiments/test_experiments/TestUserAuthFilterAnniversariesExperiment.tsx';
    tangon = report.bind(oscard)(tangon);
    zuuluu['TestUserAuthFilterAnniversariesExperiment'] = michal;
    return entity;
})();