...
export default (function(_, argBar, argBaz, __, ___, argFre, argPlu) {
    ...
    michal = {'kind': 'user', 'id': '2025-03_test_tile_existing_users', 'label': 'Test Tile Existing Users Experiment'};
    tangon = {};
    option = false;
    ...
    tangon = 'modules/experiments/test_experiments/TestTileExistingUsersExperiment.tsx';
    tangon = report.bind(oscard)(tangon);
    zuuluu['TestTileExistingUsersExperiment'] = michal;
    return entity;
})();