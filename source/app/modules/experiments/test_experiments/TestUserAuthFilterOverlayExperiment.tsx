...
export default (function(_, argBar, argBaz, __, ___, argFre, argPlu) {
    ...
    michal = {'kind': 'user', 'id': '2025-02_test_user_auth_filter_overlay', 'label': 'Test User Auth Filter Overlay'};
    golfie = {};
    option = false;
    ...
    tangon = 'modules/experiments/test_experiments/TestUserAuthFilterOverlayExperiment.tsx';
    tangon = report.bind(oscard)(tangon);
    zuuluu['TestUserAuthFilterOverlayExperiment'] = michal;
    return entity;
})();