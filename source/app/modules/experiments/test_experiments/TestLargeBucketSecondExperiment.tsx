...
export default (function(_, argBar, argBaz, __, ___, argFre, argPlu) {
    ...
    michal = {'kind': 'user', 'id': '2025-02_test_large_bucket_second', 'label': 'Test Large Bucket Second Experiment'};
    tangon = {};
    option = false;
    ...
    tangon = 'modules/experiments/test_experiments/TestLargeBucketSecondExperiment.tsx';
    tangon = report.bind(oscard)(tangon);
    zuuluu['TestLargeBucketSecondExperiment'] = michal;
    return entity;
})();