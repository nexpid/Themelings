...
export default (function(_, argBar, argBaz, __, ___, argFre, argPlu) {
    ...
    michal = {'kind': 'user', 'id': '2025-03_test_badges_existing_users', 'label': 'Test Badges Existing Users Experiment'};
    tangon = {};
    option = false;
    ...
    tangon = 'modules/experiments/test_experiments/TestBadgesExistingUsersExperiment.tsx';
    tangon = report.bind(oscard)(tangon);
    zuuluu['TestBadgesExistingUsersExperiment'] = michal;
    return entity;
})();