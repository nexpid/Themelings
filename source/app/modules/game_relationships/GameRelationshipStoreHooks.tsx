...
export default (function(argFoo, argBar, argBaz, _, __, argFre, argPlu) {
    ...
    tangon = function(argFoo) { // Original name: useOutgoingGameRelationshipsForUser
        tangon = _closure1_slot5;
        entity = _closure1_slot4;
        zuuluu = entity.PENDING_INCOMING;
        michal = undefined;
    ...
    zuuluu['useOutgoingGameRelationshipsForUser'] = tangon;
    michal = function(argFoo) { // Original name: useGameRelationshipsForUser
        zuuluu = argFoo;
        var _closure2_slot0 = zuuluu;
        verify = _closure1_slot0;
        offset = _closure1_slot1;
    ...
    zuuluu['useGameRelationshipsForUser'] = michal;
    return entity;
})();