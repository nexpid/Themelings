...
export default (function(argFoo, argBar, argBaz, _, __, argFre, argPlu) {
 ...
 76:
    ...
    michal = function(argFoo) {
        tangon = function() { // Original name: BlockedDomainManager
            report = this;
            tangon = undefined;
            entity = undefined;
        ...
        entity = function() { // Original name: value
            ...
            tangon = function() {
                ...
                entity = michal.fetchBlockedDomainList;
                entity = entity.bind(michal)();
                return entity;
            };
            tangon = golfie.bind(entity)(tangon, report);
            tangon = zuuluu.setInterval;
            report = _closure1_slot0;
            zuuluu = 8;
            zuuluu = oscard[zuuluu];
            zuuluu = report.bind(entity)(zuuluu);
            zuuluu = zuuluu.fetchBlockedDomainList;
            michal = _closure1_slot9;
            zuuluu = tangon.bind(entity)(zuuluu, michal);
            michal = this;
            michal['intervalID'] = zuuluu;
            return entity;
        };
        report['value'] = entity;
        entity = new Array(2);
    ...
    tangon = 'modules/blocked_domains/BlockedDomainManager.tsx';
