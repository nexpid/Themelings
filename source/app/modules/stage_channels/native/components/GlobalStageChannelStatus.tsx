...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
 ...
 1054:
    ...
    kiloes = kiloes.WHITE;
    offset['tintColor'] = kiloes;
    report['activeSpeakerIcon'] = offset;
    offset = {};
    kiloes = golfie[yankee];
    kiloes = romeon.bind(entity)(kiloes);
    kiloes = kiloes.spacing;
 ...
 48:
            ...
            echoed = report.bind(oscard)(yankee);
            option = _closure1_slot0;
            report = 11;
            report = verify[report];
            ...
            report = verify.bind(offset)(option, tangon, report);
            if(echoed) { _fun00012_ip = 170; continue _fun00011 }
 151:
            if(!(entity == report)) { _fun00012_ip = 162; continue _fun00011 }
 155:
            result = update.icon;
            _fun00012_ip = 168; continue _fun00011;
 162:
            result = update.activeStageIcon;
 168:
            _fun00012_ip = 176; continue _fun00011;
 170:
            result = update.activeSpeakerIcon;
 176:
            option = _closure1_slot1;
            verify = _closure1_slot3;
            tangon = 22;
            ...
            if(echoed) { _fun00012_ip = 246; continue _fun00011 }
 203:
            if(michal) { _fun00012_ip = 246; continue _fun00011 }
 206:
            option = _closure1_slot0;
 ...
 252:
            if(!(entity != golfie)) { _fun00012_ip = 786; continue _fun00011 }
 259:
            if(!(entity != source)) { _fun00012_ip = 786; continue _fun00011 }
 266:
            verify = source.name;
            option = golfie.name;
            tangon = global;
            ...
            tangon = undefined;
            if(option) { _fun00012_ip = 321; continue _fun00011 }
 315:
            tangon = report.topic;
 321:
            report = entity != tangon;
            vacuum = romeon;
            if(!report) { _fun00012_ip = 334; continue _fun00011 }
 331:
            vacuum = tangon;
 334:
            ...
            if(michal) { _fun00012_ip = 764; continue _fun00011 }
 361:
            ...
            if(!foxtra) { _fun00012_ip = 651; continue _fun00011 }
 561:
            ...
            source[0] = sequen;
            sequen = echoed;
            if(!echoed) { _fun00012_ip = 616; continue _fun00011 }
 610:
 ...
 616:
            ...
            source = new Array(2);
            source[0] = vacuum;
            if(!backup) { _fun00012_ip = 637; continue _fun00011 }
 635:
            ctrled = null;
 637:
            source[1] = ctrled;
 ...
 651:
            ...
            romeon[0] = foxtra;
            foxtra = !backup;
            if(backup) { _fun00012_ip = 734; continue _fun00011 }
 665:
            ...
            result = new Array(2);
            result[0] = source;
            if(!echoed) { _fun00012_ip = 716; continue _fun00011 }
 710:
 ...
 734:
            ...
            _fun00012_ip = 784; continue _fun00011;
 764:
