...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
 ...
 0:
            ...
            backup = entity.icon;
            tangon = undefined;
            if(!(backup === tangon)) { _fun00002_ip = 48; continue _fun00001 }
 25:
 ...
 48:
            ...
            report['style'] = offset;
            offset = null;
            if(!(offset == foxtra)) { _fun00002_ip = 164; continue _fun00001 }
 116:
 ...
 164:
            ...
            yankee['color'] = backup;
            offset = romeon.bind(tangon)(foxtra, yankee);
 219:
    ...
    tangon = {};
    verify = {'width': 88, 'height': 88, 'alignItems': 'center', 'justifyContent': 'center'};
    tangon['container'] = verify;
    verify = {'backgroundColor': null, 'borderRadius': 28, 'height': 56, 'width': 56, 'alignItems': 'center', 'justifyContent': 'center'};
    offset = 4;
    ...
    verify = {'tintColor': null, 'height': 32, 'width': 32};
    ...
    verify = {'position': 'absolute', 'top': 0};
    ...
    tangon = 'modules/stage_channels/native/components/StageSparkle.tsx';
    tangon = report.bind(oscard)(tangon);
    michal = function(argFoo) { // Original name: StageSparkle
