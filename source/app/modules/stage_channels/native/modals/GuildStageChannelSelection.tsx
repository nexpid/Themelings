...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
    ...
    tangon = 'modules/stage_channels/native/modals/GuildStageChannelSelection.tsx';
    tangon = report.bind(oscard)(tangon);
    michal = function(argFoo) { // Original name: GuildStageChannelSelection
 ...
 0:
                    ...
                    verify = romeon.bind(entity)(zuuluu);
                    zuuluu = 9;
 ...
 221:
            ...
            yankee = function(argFoo, argBar) { // Original name: renderChannelHook
                ...
                zuuluu = entity.Text;
                michal = {'variant': 'text-sm/bold', 'color': 'header-primary'};
                entity = argFoo;
            ...
            entity = michal.useChannelsUserCanStartStageIn;
