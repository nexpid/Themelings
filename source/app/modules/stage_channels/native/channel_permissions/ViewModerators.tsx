...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    mike = function(argFoo) { // Original name: openAddModeratorsActionSheet
        _fun119991: for(var _fun119991_ip = 0; ; ) switch(_fun119991_ip) {
 0:
            options = argFoo;
            golf = arguments[1];
            entity = undefined;
            if(!(golf === entity)) { _fun119991_ip = 14; continue _fun119991 }
 12:
            golf = false;
 14:
    ...
    report = 'modules/stage_channels/native/channel_permissions/ViewModerators.tsx';
    report = oscar.bind(golf)(report);
    tango = function(argFoo) { // Original name: ViewModerators
        _fun119992: for(var _fun119992_ip = 0; ; ) switch(_fun119992_ip) {
 0:
            entity = argFoo;
            ...
            tango[0] = entity;
            entity = function() {
                _fun119995: for(var _fun119995_ip = 0; ; ) switch(_fun119995_ip) {
 0:
                    entity = {};
                    ...
                    report = mike != report;
                    mike = undefined;
                    if(!report) { _fun119995_ip = 60; continue _fun119995 }
 41:
 ...
 60:
            ...
            entity = golf.bind(options)(oscar, entity, tango);
            options = entity.guild;
            golf = entity.guildRoles;
            entity = 13;
            entity = zulu[entity];
            zulu = mike.bind(report)(entity);
            mike = zulu.useCanUpdateStageChannelModerators;
            entity = verify.id;
            source = mike.bind(zulu)(entity);
            _closure2_slot2 = source;
            entity = null;
            if(!(entity != options)) { _fun119992_ip = 879; continue _fun119992 }
 211:
            if(!(entity != golf)) { _fun119992_ip = 879; continue _fun119992 }
 218:
            mike = verify.isGuildStageVoice;
            oscar = mike.bind(verify)();
            tango = _closure1_slot5;
            zulu = tango.getMemberIds;
            yankee = entity == options;
            mike = undefined;
            if(yankee) { _fun119992_ip = 252; continue _fun119992 }
 247:
            mike = options.id;
 252:
            ...
            kilo = sizing.getExistingMembersRows;
            yankee = _closure1_slot0;
            mike = 15;
            foxtrot = romeo[mike];
            foxtrot = yankee.bind(report)(foxtrot);
            record = foxtrot.MODERATE_STAGE_CHANNEL_PERMISSIONS;
            status = sizing;
            target = output;
            papa = verify;
            context = options;
            sizing = status[kilo](target, papa, context, record, config);
            zulu = romeo[zulu];
            tango = tango.bind(report)(zulu);
            zulu = tango.getExistingRolesRowWithPermissionDisabled;
            mike = romeo[mike];
            mike = yankee.bind(report)(mike);
            record = mike.MODERATE_STAGE_CHANNEL_PERMISSIONS;
            status = tango;
            target = options;
            papa = golf;
            context = verify;
            control = status[zulu](target, papa, context, record, config);
            mike = function(argFoo) { // Original name: handleRemovePermission
                _fun119996: for(var _fun119996_ip = 0; ; ) switch(_fun119996_ip) {
 0:
                    backup = argFoo;
                    ...
                    oscar = golf.removeModeratorOverwrite;
                    tango = backup.id;
                    zulu = backup.rowType;
                    mike = _closure1_slot8;
                    mike = mike.ROLE;
                    if(!(zulu !== mike)) { _fun119996_ip = 99; continue _fun119996 }
 65:
                    zulu = _closure1_slot0;
                    ...
                    zulu = mike.MEMBER;
                    _fun119996_ip = 131; continue _fun119996;
 99:
 ...
 131:
                    ...
                    verify = verify.t;
                    verify = verify.fKxYb2;
                    verify = offset.bind(yankee)(verify);
                    mike['confirmText'] = verify;
                    verify = _closure1_slot4;
                    options = function* () {
                        entity = function* () { // Original name: ?anon_0_
                            _fun119998: for(var _fun119998_ip = 0; ; ) switch(_fun119998_ip) {
 0:
                                StartGenerator();
                                ResumeGenerator(result_out_reg=0, return_bool_out_reg=1);
                                if(mike) { _fun119998_ip = 260; continue _fun119998 }
 10:
                                ...
                                oscar = golf.isEmptyOverwrite;
                                mike = _closure3_slot2;
                                mike = oscar.bind(golf)(mike);
                                if(mike) { _fun119998_ip = 125; continue _fun119998 }
 56:
                                oscar = _closure1_slot0;
                                golf = _closure1_slot3;
                                mike = 20;
 ...
 116:
                                ...
                                if(!oscar) { _fun119998_ip = 188; continue _fun119998 }
 122:
                                return mike;
 125:
                                ...
                                mike = golf[mike];
                                options = oscar.bind(zulu)(mike);
                                golf = options.clearPermissionOverwrite;
                                mike = _closure2_slot0;
                                oscar = mike.id;
                                mike = _closure3_slot2;
                                mike = mike.id;
 ...
 182:
                                ResumeGenerator(result_out_reg=1, return_bool_out_reg=5);
                                if(oscar) { _fun119998_ip = 257; continue _fun119998 }
 188:
                                ...
                                golf = options.memberOrRoleRemovedToast;
 ...
 260:
            ...
            mike = {};
            if(!oscar) { _fun119992_ip = 867; continue _fun119992 }
 394:
            ...
            romeo = {};
            yankee = 16;
            romeo['paddingHorizontal'] = yankee;
            golf['style'] = romeo;
            golf['spacing'] = yankee;
            foxtrot = _closure1_slot9;
            yankee = 25;
            offset = update[yankee];
            offset = echo.bind(report)(offset);
            romeo = offset.TableRowGroup;
            offset = {};
            kilo = 18;
            output = update[kilo];
            ...
            sequence = vacuum.CirclePlusIcon;
            vacuum = {};
            vacuum = foxtrot.bind(report)(sequence, vacuum);
            output['icon'] = vacuum;
            vacuum = update[kilo];
            vacuum = echo.bind(report)(vacuum);
            config = vacuum.intl;
            ...
            vacuum = echo.bind(report)(vacuum);
            vacuum = vacuum.t;
            vacuum = vacuum.n3bcy8;
            vacuum = sequence.bind(config)(vacuum);
            output['label'] = vacuum;
            vacuum = function() { // Original name: onPress
                _fun120000: for(var _fun120000_ip = 0; ; ) switch(_fun120000_ip) {
 0:
                    zulu = _closure2_slot0;
                    mike = null;
                    if(!(mike != zulu)) { _fun120000_ip = 31; continue _fun120000 }
 13:
 ...
 879:
    ...
    zulu['default'] = tango;
    zulu['openAddModeratorsActionSheet'] = mike;
    return entity;
})();