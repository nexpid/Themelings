...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    entity = function(argFoo, argBar, argBaz) { // Original name: getComponentPropsForScreen
        _fun127082: for(var _fun127082_ip = 0; ; ) switch(_fun127082_ip) {
 0:
            options = argFoo;
            entity = argBar;
            mike = entity[options];
            ...
            entity = zulu == entity;
            if(entity) { _fun127082_ip = 94; continue _fun127082 }
 84:
            entity = mike.getRuntimeProps;
            tango = entity.bind(mike)();
 94:
            if(!(zulu == tango)) { _fun127082_ip = 100; continue _fun127082 }
 98:
            tango = {};
 100:
            entity = {};
            ...
            if(!(zulu == mike)) { _fun127082_ip = 146; continue _fun127082 }
 142:
            mike = new Array(0);
 146:
            offset = entity;
 ...
 0:
            zulu = argBar;
            mike = null;
            if(!(mike != zulu)) { _fun127083_ip = 24; continue _fun127083 }
 9:
            entity = argFoo;
            entity = zulu[entity];
            if(!(mike == entity)) { _fun127083_ip = 22; continue _fun127083 }
 20:
            entity = {};
 22:
            return entity;
 24:
    ...
    entity = function(argFoo, argBar) { // Original name: buildInitialRouteStack
        _fun127087: for(var _fun127087_ip = 0; ; ) switch(_fun127087_ip) {
 0:
            zulu = argFoo;
            oscar = argBar;
            ...
            mike = null;
            if(!(mike != oscar)) { _fun127087_ip = 116; continue _fun127087 }
 60:
            mike = new Array(0);
            tango = zulu.length;
            tango = entity < tango;
            report = 0;
            if(!tango) { _fun127087_ip = 114; continue _fun127087 }
 78:
            tango = zulu[report];
            options = mike.push;
            golf = {};
            ...
            if(!(tango !== oscar)) { _fun127087_ip = 114; continue _fun127087 }
 102:
            report = report + 1;
            tango = zulu.length;
            if(report < tango) { _fun127087_ip = 78; continue _fun127087 }
 114:
            return mike;
 116:
            mike = {};
    ...
    entity = function(argFoo, argBar) { // Original name: orderify
        _fun127088: for(var _fun127088_ip = 0; ; ) switch(_fun127088_ip) {
 0:
            zulu = argFoo;
            mike = argBar;
            entity = 1;
            ...
            mike = 'string';
            entity = typeof zulu;
            if(!(mike !== entity)) { _fun127088_ip = 47; continue _fun127088 }
 24:
            entity = {};
            oscar = entity;
            report = zulu;
            ...
            mike = 'stepNumber';
            entity[mike] = tango;
            _fun127088_ip = 62; continue _fun127088;
 47:
            mike = {};
 ...
 62:
    ...
    entity = function(argFoo, argBar) { // Original name: buildScreenMap
        _fun127089: for(var _fun127089_ip = 0; ; ) switch(_fun127089_ip) {
 0:
            tango = argFoo;
            backup = tango.steps;
            ...
            verify = 'stepsCount';
            options = 1;
            if(!mike) { _fun127089_ip = 230; continue _fun127089 }
 146:
            mike = romeo[golf];
            kilo = mike.scene;
            mike = golf + options;
            ...
            mike = undefined;
            if(output) { _fun127089_ip = 179; continue _fun127089 }
 173:
            mike = sizing.scene;
 179:
            output = foxtrot != mike;
            sizing = null;
            if(!output) { _fun127089_ip = 191; continue _fun127089 }
 188:
            sizing = mike;
 191:
            mike = {};
            ...
            golf = golf + 1;
            mike = backup.length;
            if(golf < mike) { _fun127089_ip = 146; continue _fun127089 }
 230:
 ...
 0:
                ...
                entity = null;
                if(!(entity != zulu)) { _fun127102_ip = 27; continue _fun127102 }
 13:
 ...
 27:
        ...
        entity = function() {
            ...
            entity = function(argFoo) {
                _fun127104: for(var _fun127104_ip = 0; ; ) switch(_fun127104_ip) {
 0:
                    mike = argFoo;
                    tango = 'string';
                    zulu = typeof mike;
                    entity = mike;
                    if(!(tango !== zulu)) { _fun127104_ip = 23; continue _fun127104 }
 17:
                    entity = mike.scene;
 23:
                    return entity;
        ...
        sizing = function(argFoo) { // Original name: onWillFocus
            _fun127106: for(var _fun127106_ip = 0; ; ) switch(_fun127106_ip) {
 0:
                entity = argFoo;
                entity = entity.route;
                report = entity.name;
                ...
                entity = null;
                if(!(entity != report)) { _fun127106_ip = 77; continue _fun127106 }
 26:
                ...
                tango = 0;
                if(!(mike >= tango)) { _fun127106_ip = 77; continue _fun127106 }
 68:
