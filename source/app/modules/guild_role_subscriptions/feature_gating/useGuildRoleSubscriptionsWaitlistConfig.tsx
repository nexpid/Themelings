...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
 ...
 0:
            ...
            if(!(entity !== report)) { _fun126893_ip = 245; continue _fun126893 }
 73:
            oscar = _closure1_slot0;
            entity = _closure1_slot2;
            entity = entity[golf];
            ...
            if(!(entity !== report)) { _fun126893_ip = 108; continue _fun126893 }
 106:
            return options;
 108:
            entity = {};
            ...
            oscar = true;
            entity['ctaClickable'] = oscar;
            oscar = function() { // Original name: onCtaClicked
                ...
                mike = 'https://dis.gd/creators-waitlist';
 ...
 0:
                    ...
                    zulu = null;
                    verify = zulu != oscar;
                    tango = 'Guild must be not null open COMMUNITY settings';
                    tango = offset.bind(entity)(verify, tango);
                    tango = 4;
                    tango = options[tango];
                    ...
                    options = zulu == oscar;
                    oscar = undefined;
                    if(options) { _fun126894_ip = 86; continue _fun126894 }
 77:
 ...
 86:
                    golf = zulu != oscar;
                    zulu = '';
                    if(!golf) { _fun126894_ip = 100; continue _fun126894 }
 97:
                    zulu = oscar;
 100:
