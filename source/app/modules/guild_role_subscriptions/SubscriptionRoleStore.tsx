...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
            ...
            if(entity) { _fun44438_ip = 51; continue _fun44438 }
 38:
            entity = verify.apply;
            entity = entity.bind(verify)(tango, oscar);
            _fun44438_ip = 92; continue _fun44438;
 51:
            golf = global;
            options = golf.Reflect;
            golf = options.construct;
            if(oscar) { _fun44438_ip = 71; continue _fun44438 }
 67:
            oscar = new Array(0);
 71:
 ...
 70: // try_end0
            _fun44439_ip = 74; continue _fun44439;
 72: // catch_target0
 ...
 0:
            ...
            options = null;
            if(!(options != mike)) { _fun44443_ip = 517; continue _fun44443 }
 42:
            if(!(options != verify)) { _fun44443_ip = 517; continue _fun44443 }
 49:
            report = global;
            zulu = report.Set;
            ...
            if(!offset) { _fun44443_ip = 468; continue _fun44443 }
 182:
            ...
            kilo = undefined;
            report = undefined;
            if(yankee) { _fun44443_ip = 226; continue _fun44443 }
 220:
            report = offset.roles;
 226:
            if(!(options == report)) { _fun44443_ip = 234; continue _fun44443 }
 230:
            report = new Array(0);
 234:
 ...
 308:
                ...
                if(!sizing) { _fun44443_ip = 420; continue _fun44443 }
 346:
                sizing = golf.add;
 ...
 420:
                sizing = backup.has;
                sizing = sizing.bind(backup)(output);
                if(!sizing) { _fun44443_ip = 442; continue _fun44443 }
 433:
                output = _closure1_slot21;
                sizing = output.bind(kilo)(result);
 442:
                if(!sizing) { _fun44443_ip = 296; continue _fun44443 }
 448:
                output = _closure1_slot17;
                sizing = output.set;
                sizing = sizing.bind(output)(tango, report);
                _fun44443_ip = 296; continue _fun44443;
            }
 468:
 ...
 0:
            ...
            entity = null;
            if(!(entity != zulu)) { _fun44445_ip = 219; continue _fun44445 }
 29:
            report = _closure1_slot9;
            zulu = report.getGuild;
            report = zulu.bind(report)(tango);
            if(!(entity != report)) { _fun44445_ip = 215; continue _fun44445 }
 50:
            zulu = report.hasFeature;
            entity = _closure1_slot12;
            entity = entity.ROLE_SUBSCRIPTIONS_AVAILABLE_FOR_PURCHASE;
            entity = zulu.bind(report)(entity);
            if(!entity) { _fun44445_ip = 141; continue _fun44445 }
 74:
            report = _closure1_slot18;
            zulu = report.has;
            zulu = zulu.bind(report)(tango);
            if(zulu) { _fun44445_ip = 141; continue _fun44445 }
 91:
            zulu = global;
            oscar = zulu.Set;
            ...
            return zulu;
 141:
            if(entity) { _fun44445_ip = 211; continue _fun44445 }
 144:
            zulu = _closure1_slot18;
            entity = zulu.has;
 ...
 0:
            ...
            zulu = !entity;
            entity = !zulu;
            if(zulu) { _fun44446_ip = 45; continue _fun44446 }
 34:
 ...
 0:
                ...
                entity = null;
                if(!(entity != mike)) { _fun44450_ip = 19; continue _fun44450 }
 13:
                entity = _closure1_slot18;
                _fun44450_ip = 131; continue _fun44450;
 19:
 ...
 81:
                    ...
                    if(!offset) { _fun44450_ip = 72; continue _fun44450 }
 112:
                    offset = mike.add;
                    offset = offset.bind(mike)(yankee);
                    _fun44450_ip = 72; continue _fun44450;
                }
 124:
 ...
 0:
                ...
                if(mike) { _fun44451_ip = 34; continue _fun44451 }
 23:
 ...
 0:
                ...
                entity = entity.bind(zulu)(tango);
                zulu = null;
                if(!(zulu == entity)) { _fun44452_ip = 44; continue _fun44452 }
 40:
 ...
 0:
                ...
                entity = entity.bind(zulu)(tango);
                zulu = null;
                if(!(zulu == entity)) { _fun44453_ip = 44; continue _fun44453 }
 40:
                entity = _closure1_slot13;
 44:
                return entity;
 ...
 0:
                ...
                entity = entity.bind(zulu)(tango);
                zulu = null;
                if(!(zulu == entity)) { _fun44454_ip = 44; continue _fun44454 }
 40:
                entity = _closure1_slot13;
 44:
                return entity;
 ...
 0:
                ...
                entity = null;
                entity = entity != mike;
                if(!entity) { _fun44455_ip = 46; continue _fun44455 }
 43:
                entity = mike;
 46:
                return entity;
 ...
 0:
            ...
            entity = undefined;
            tango = undefined;
            if(mike) { _fun44456_ip = 43; continue _fun44456 }
 33:
            mike = oscar.has;
            tango = mike.bind(oscar)(report);
 43:
            mike = true;
            if(!(mike === tango)) { _fun44456_ip = 97; continue _fun44456 }
 49:
            mike = global;
            oscar = mike.Set;
            golf = _closure1_slot18;
 ...
 0:
            ...
            zulu = undefined;
            entity = undefined;
            if(golf) { _fun44457_ip = 52; continue _fun44457 }
 47:
            entity = oscar.id;
 52:
            report = report !== entity;
            if(report) { _fun44457_ip = 76; continue _fun44457 }
 59:
 ...
 76:
            entity = !report;
            if(report) { _fun44457_ip = 91; continue _fun44457 }
 82:
            mike = _closure1_slot22;
