...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
 ...
 0:
            ...
            entity = zulu == verify;
            oscar = undefined;
            if(entity) { _fun116038_ip = 138; continue _fun116038 }
 117:
 ...
 138:
            entity = true;
            entity = entity === oscar;
            if(!entity) { _fun116038_ip = 183; continue _fun116038 }
 147:
            zulu = zulu == verify;
            oscar = undefined;
            if(zulu) { _fun116038_ip = 177; continue _fun116038 }
 156:
            offset = verify.hasFeature;
 ...
 183:
            ...
            oscar = entity;
            if(!entity) { _fun116038_ip = 223; continue _fun116038 }
 220:
            oscar = tango;
 223:
            if(!oscar) { _fun116038_ip = 229; continue _fun116038 }
 226:
            oscar = zulu;
 229:
            if(!oscar) { _fun116038_ip = 285; continue _fun116038 }
 232:
            oscar = _closure1_slot0;
            ...
            report = oscar.bind(golf)(report);
 285:
            if(!entity) { _fun116038_ip = 291; continue _fun116038 }
 288:
            entity = tango;
 291:
            if(!entity) { _fun116038_ip = 297; continue _fun116038 }
 294:
            entity = zulu;
 297:
            if(!entity) { _fun116038_ip = 303; continue _fun116038 }
 300:
            entity = mike;
 303:
            return entity;
