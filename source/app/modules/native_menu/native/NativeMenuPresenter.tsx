...
export default (function(_, argBar, argBaz, argCorge, __, argFred, argPlugh) {
    ...
    mike = function() { // Original name: MenuContainer
        _fun120622: for(var _fun120622_ip = 0; ; ) switch(_fun120622_ip) {
 0:
            ...
            report[0] = entity;
            zulu = function() {
                _fun120624: for(var _fun120624_ip = 0; ; ) switch(_fun120624_ip) {
 0:
                    zulu = _closure2_slot0;
                    entity = null;
                    entity = entity != zulu;
                    if(!entity) { _fun120624_ip = 56; continue _fun120624 }
 16:
 ...
 56:
            ...
            report = null;
            if(!(report != entity)) { _fun120622_ip = 147; continue _fun120622 }
 143:
            if(!(report == oscar)) { _fun120622_ip = 155; continue _fun120622 }
 147:
            entity = {};
            entity['children'] = report;
            _fun120622_ip = 164; continue _fun120622;
 155:
            report = {};
