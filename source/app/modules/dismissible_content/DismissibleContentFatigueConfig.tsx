...
export default (function(_, argBar, __, ___, ____, argFre, argPlu) {
    ...
    option = report.bind(entity)(option);
    option = option.DismissibleContent;
    option = option.CLIENT_THEMES_APPEARANCE_SETTINGS_NEW_BADGE;
    michal[15] = option;
    option = oscard[tangon];
    option = report.bind(entity)(option);
    option = option.DismissibleContent;
    ...
    option = report.bind(entity)(option);
    option = option.DismissibleContent;
    option = option.VIRTUAL_CURRENCY_DISCOVERY_ONBOARDING_COACHMARK;
    michal[70] = option;
    option = oscard[tangon];
    option = report.bind(entity)(option);
    option = option.DismissibleContent;
    option = option.VIRTUAL_CURRENCY_SHOP_ONBOARDING_COACHMARK;
    michal[71] = option;
    option = oscard[tangon];
    option = report.bind(entity)(option);
    option = option.DismissibleContent;
    ...
    option = report.bind(entity)(option);
    option = option.DismissibleContent;
    option = option.NAMEPLATE_USER_SETTINGS_PROFILE_PAGE_NEW_BADGE;
    michal[75] = option;
    option = oscard[tangon];
    option = report.bind(entity)(option);
    option = option.DismissibleContent;
    option = option.REPORT_TO_MOD_NEW_TAG;
    michal[76] = option;
    option = oscard[tangon];
    option = report.bind(entity)(option);
    option = option.DismissibleContent;
    ...
    option = report.bind(entity)(option);
    option = option.DismissibleContent;
    option = option.RING_USER_TO_VC_NEW_BADGE;
    michal[85] = option;
    option = oscard[tangon];
    option = report.bind(entity)(option);
    option = option.DismissibleContent;
    option = option.DESKTOP_REFRESH_ONBOARDING_MODAL;
    michal[86] = option;
    option = oscard[tangon];
    option = report.bind(entity)(option);
    option = option.DismissibleContent;
    option = option.CHAT_WALLPAPERS_PICKER_COACHMARK;
    michal[87] = option;
    option = oscard[tangon];
    option = report.bind(entity)(option);
    option = option.DismissibleContent;
    option = option.GUILD_TAG_USER_PROFILE_NEW_BADGE;
    michal[88] = option;
    option = oscard[tangon];
    option = report.bind(entity)(option);
    option = option.DismissibleContent;
    option = option.GUILD_TAG_SERVER_SETTINGS_NEW_BADGE;
    michal[89] = option;
    option = oscard[tangon];
    option = report.bind(entity)(option);
    option = option.DismissibleContent;
    option = option.Q2_2025_MARKETING_MOMENT_NITRO_TAB_BADGE_V2;
    michal[90] = option;
    option = oscard[tangon];
    option = report.bind(entity)(option);
    option = option.DismissibleContent;
    option = option.Q2_2025_MARKETING_MOMENT_FOLLOW_UP_MODAL;
    michal[91] = option;
    option = oscard[tangon];
    option = report.bind(entity)(option);
    option = option.DismissibleContent;
    ...
    option = report.bind(entity)(option);
    option = option.DismissibleContent;
    option = option.CUSTOM_THEME_ENTRYPOINT_NEW_BADGE;
    michal[93] = option;
    option = oscard[tangon];
    option = report.bind(entity)(option);
    option = option.DismissibleContent;
    option = option.CUSTOM_THEME_ENTRYPOINT_GRADIENT;
    michal[94] = option;
    option = oscard[tangon];
    option = report.bind(entity)(option);
    option = option.DismissibleContent;
    option = option.MOBILE_BOGO_PROMOTION_ACTION_SHEET;
    michal[95] = option;
    option = oscard[tangon];
    option = report.bind(entity)(option);
    option = option.DismissibleContent;
    option = option.GOOGLE_PLAY_PRICE_CHANGE_ACTION_SHEET;
    michal[96] = option;
    option = oscard[tangon];
    option = report.bind(entity)(option);
    option = option.DismissibleContent;
    option = option.FAMILY_CENTER_NEW_BADGE;
    michal[97] = option;
    option = oscard[tangon];
    option = report.bind(entity)(option);
    option = option.DismissibleContent;
    option = option.NAMEPLATE_USER_SETTINGS_MENU_NEW_BADGE;
    michal[98] = option;
    option = oscard[tangon];
    option = report.bind(entity)(option);
    option = option.DismissibleContent;
    option = option.RECENT_AVATARS_SETTINGS_MENU_NEW_BADGE;
    michal[99] = option;
    option = oscard[tangon];
    option = report.bind(entity)(option);
    option = option.DismissibleContent;
    ...
    option = report.bind(entity)(option);
    option = option.DismissibleContent;
    option = option.COLLECTIBLES_SHOP_ENTRY_MARKETING;
    michal[103] = option;
    tangon = oscard[tangon];
    tangon = report.bind(entity)(tangon);
    tangon = tangon.DismissibleContent;
    tangon = tangon.NITRO_PRIVATE_BROWSING_SURVEY;
    michal[104] = tangon;
