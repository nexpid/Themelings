...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    golf = {};
    offset = {'width': '100%', 'marginTop': 12, 'display': 'flex', 'flexDirection': 'column', 'alignSelf': 'flex-start', 'padding': 16, 'backgroundColor': null, 'borderColor': null, 'borderWidth': 1};
    tango = 12;
    romeo = 5;
    backup = oscar[romeo];
    ...
    golf['guildInfoRow'] = offset;
    offset = {'backgroundColor': null, 'height': 1, 'border': 'none', 'marginVertical': 16};
    romeo = oscar[romeo];
 ...
 0:
            ...
            options = entity.joinRequest;
            var _closure2_slot1 = options;
            echo = entity.joinRequestGuild;
 ...
 0:
                    ...
                    entity = undefined;
                    if(report) { _fun101694_ip = 40; continue _fun101694 }
 31:
 ...
 40:
            ...
            mike = verify == options;
            entity = null;
            if(mike) { _fun101693_ip = 514; continue _fun101693 }
 128:
 ...
 146:
            ...
            mike['style'] = oscar;
            yankee = verify != echo;
            if(!yankee) { _fun101693_ip = 328; continue _fun101693 }
 175:
            foxtrot = _closure1_slot6;
            romeo = _closure1_slot3;
            oscar = {};
            backup = backup.guildInfoRow;
            oscar['style'] = backup;
            ...
            sizing = kilo.Text;
            kilo = {'variant': 'heading-sm/semibold', 'color': 'header-primary'};
            echo = echo.name;
            kilo['children'] = echo;
 ...
 328:
            ...
            if(!verify) { _fun101693_ip = 456; continue _fun101693 }
 343:
            ...
            yankee = offset.Text;
            offset = {'variant': 'heading-xl/semibold', 'color': 'header-primary'};
            foxtrot = 10;
            kilo = result[foxtrot];
            ...
            foxtrot = foxtrot.t;
            backup = foxtrot.jDV3i4;
            foxtrot = {};
            output = output.globalName;
 ...
 0:
                    ...
                    if(!(mike === entity)) { _fun101696_ip = 62; continue _fun101696 }
 50:
                    mike = foxtrot.response;
                    entity = null;
                    if(!(entity == mike)) { _fun101696_ip = 70; continue _fun101696 }
 62:
                    verify = foxtrot.response;
                    _fun101696_ip = 86; continue _fun101696;
 70:
 ...
 86:
                    ...
                    golf = backup.divider;
                    entity['style'] = golf;
                    golf = options.bind(report)(zulu, entity);
                    entity = new Array(3);
                    entity[0] = golf;
                    ...
                    romeo = yankee.Text;
                    yankee = {'style': null, 'variant': 'text-xs/semibold', 'color': 'text-muted'};
                    backup = backup.formQuestion;
                    yankee['style'] = backup;
                    foxtrot = foxtrot.label;
                    ...
                    golf = oscar.Text;
                    oscar = {'variant': 'text-md/medium', 'color': 'text-primary'};
