...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
    ...
    tango = tango.DirectoryEntryCategories;
 ...
 0:
            zulu = argBar;
            mike = argFoo;
            if(!mike) { _fun101987_ip = 22; continue _fun101987 }
 11:
            tango = zulu.length;
            mike = 0;
            if(!(mike !== tango)) { _fun101987_ip = 76; continue _fun101987 }
 22:
            tango = zulu.length;
            mike = 0;
            if(!(mike !== tango)) { _fun101987_ip = 70; continue _fun101987 }
 33:
            tango = zulu.sort;
 ...
 0:
                    ...
                    report = tango != zulu;
                    entity = 0;
                    if(!report) { _fun101988_ip = 23; continue _fun101988 }
 20:
                    entity = zulu;
 23:
                    zulu = argFoo;
                    ...
                    tango = tango != zulu;
                    mike = 0;
                    if(!tango) { _fun101988_ip = 44; continue _fun101988 }
 41:
                    mike = zulu;
 44:
                    entity = entity - mike;
            ...
            _fun101987_ip = 74; continue _fun101987;
 70:
            entity = new Array(0);
 74:
            _fun101987_ip = 83; continue _fun101987;
 76:
 ...
 0:
            tango = argBar;
            mike = argFoo;
            if(!mike) { _fun101990_ip = 25; continue _fun101990 }
 11:
            zulu = tango.length;
            mike = 0;
            if(!(mike !== zulu)) { _fun101990_ip = 501; continue _fun101990 }
 25:
            mike = tango.length;
            oscar = 0;
            if(!(oscar !== mike)) { _fun101990_ip = 495; continue _fun101990 }
 39:
            zulu = _closure1_slot2;
            report = zulu.ALL;
            zulu = argBaz;
            if(!(zulu === report)) { _fun101990_ip = 443; continue _fun101990 }
 62:
            options = new Array(0);
            ...
            output = report.bind(yankee)(zulu);
            ...
            zulu = yankee.length;
            golf = options;
            if(!(zulu > oscar)) { _fun101990_ip = 272; continue _fun101990 }
 160:
            report = options.push;
            zulu = {};
            ...
            offset = 2;
            romeo = sizing[offset];
            romeo = kilo.bind(foxtrot)(romeo);
            backup = romeo.intl;
            romeo = backup.string;
            offset = sizing[offset];
            offset = kilo.bind(foxtrot)(offset);
            offset = offset.t;
            offset = offset.CbaapK;
 ...
 272:
            ...
            zulu = zulu[verify];
            report = report.bind(foxtrot)(zulu);
            zulu = report.orderByTotalMemberCount;
            verify = zulu.bind(report)(options);
            report = verify.length;
            zulu = golf;
            if(!(report > oscar)) { _fun101990_ip = 441; continue _fun101990 }
 329:
            oscar = golf.push;
            report = {};
 ...
 501:
    ...
    zulu['generateDirectoryRows'] = mike;
    return entity;
})();