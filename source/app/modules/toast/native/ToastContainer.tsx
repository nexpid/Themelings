...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    entity = function(argFoo) { // Original name: AnimatedToast
 ...
 0:
            ...
            target = report;
            papa = tango;
            offset = copyDataProperties(status, target, papa);
            ...
            sequence = zulu.bind(golf)(backup);
            ...
            zulu = backup.useMainTabsHeight;
            vacuum = zulu.bind(backup)();
 ...
 0:
                    ...
                    if(mike) { _fun105803_ip = 29; continue _fun105803 }
 16:
                    entity = _closure2_slot0;
                    mike = entity.disableAnimations;
 29:
                    entity = null;
                    entity = entity != mike;
                    if(!entity) { _fun105803_ip = 41; continue _fun105803 }
 38:
                    entity = mike;
 41:
                    return entity;
            ...
            output = backup.bind(kilo)(golf, zulu);
            ...
            tango = entity != golf;
            if(!tango) { _fun105802_ip = 305; continue _fun105802 }
 294:
            backup = 'string';
            foxtrot = typeof golf;
 ...
 305:
            ...
            context = 'top';
            if(!(report !== foxtrot)) { _fun105802_ip = 325; continue _fun105802 }
 322:
            context = foxtrot;
 325:
            _closure2_slot11 = context;
            ...
            if(output) { _fun105802_ip = 366; continue _fun105802 }
 358:
            foxtrot = sizing.START;
            _fun105802_ip = 372; continue _fun105802;
 366:
            foxtrot = sizing.END;
 372:
            result = backup.bind(kilo)(foxtrot);
            _closure2_slot12 = result;
            control = _closure1_slot0;
            source = _closure1_slot2;
            foxtrot = source[mike];
            kilo = control.bind(report)(foxtrot);
            backup = kilo.useAnimatedStyle;
            foxtrot = function() { // Original name: C
                _fun105804: for(var _fun105804_ip = 0; ; ) switch(_fun105804_ip) {
 0:
                    entity = _closure2_slot11;
                    verify = 'top';
                    if(!(verify !== entity)) { _fun105804_ip = 57; continue _fun105804 }
 15:
                    ...
                    options = zulu - entity;
                    _fun105804_ip = 72; continue _fun105804;
 57:
 ...
 72:
                    ...
                    entity = _closure2_slot11;
                    if(!(verify !== entity)) { _fun105804_ip = 159; continue _fun105804 }
 128:
                    ...
                    verify = verify - entity;
                    _fun105804_ip = 163; continue _fun105804;
 159:
 ...
 163:
                    ...
                    entity[0] = verify;
                    entity[1] = options;
                    offset = oscar.bind(golf)(tango, zulu, entity);
                    entity = {};
                    zulu = _closure2_slot8;
                    if(zulu) { _fun105804_ip = 241; continue _fun105804 }
 191:
                    tango = _closure1_slot0;
                    oscar = _closure1_slot2;
                    zulu = 12;
                    zulu = oscar[zulu];
                    golf = tango.bind(backup)(zulu);
                    ...
                    _fun105804_ip = 254; continue _fun105804;
 241:
 ...
 254:
                    ...
                    zulu = offset;
                    if(oscar) { _fun105804_ip = 422; continue _fun105804 }
 273:
                    foxtrot = _closure1_slot0;
                    romeo = _closure1_slot2;
                    oscar = 12;
                    oscar = romeo[oscar];
                    verify = foxtrot.bind(backup)(oscar);
 ...
 0:
                            entity = argFoo;
                            if(!entity) { _fun105805_ip = 54; continue _fun105805 }
 6:
                            ...
                            entity = zulu === mike;
 54:
                            if(!entity) { _fun105805_ip = 103; continue _fun105805 }
 57:
                            zulu = _closure1_slot0;
 ...
 103:
                    ...
                    sizing = 13;
                    sizing = romeo[sizing];
                    sizing = foxtrot.bind(backup)(sizing);
                    ...
                    update = offset;
                    output = oscar;
                    zulu = source[options](update, echo, result, output, sizing);
 422:
            ...
            sizing = {};
            sizing['position'] = context;
            sizing['safeAreaTop'] = record;
            record = _closure1_slot11;
            sizing['CONTAINER_DISTANCE_VERTICAL'] = record;
            sizing['screenHeight'] = config;
            sizing['toastHeight'] = sequence;
            sizing['bottomTabsHeight'] = vacuum;
            vacuum = source[mike];
            vacuum = control.bind(report)(vacuum);
            vacuum = vacuum.interpolate;
            sizing['interpolate'] = vacuum;
            sizing['animationState'] = result;
            vacuum = _closure1_slot9;
            sizing['ANIMATION_STATE_INPUT'] = vacuum;
            vacuum = _closure1_slot10;
            sizing['CONTAINER_TOP_POSITION_START'] = vacuum;
            sizing['isReducedMotion'] = output;
            vacuum = 12;
            ...
            sizing['OPACITY_SPRING_PHYSICS'] = vacuum;
            vacuum = _closure1_slot14;
            sizing['TOAST_SPRING_PHYSICS'] = vacuum;
            sizing['state'] = echo;
            vacuum = 13;
            vacuum = source[vacuum];
            vacuum = control.bind(report)(vacuum);
            vacuum = vacuum.TransitionStates;
            sizing['TransitionStates'] = vacuum;
            source = source[mike];
            source = control.bind(report)(source);
            source = source.runOnJS;
            sizing['runOnJS'] = source;
            sizing['cleanUp'] = yankee;
            sizing['screenWidth'] = update;
            update = _closure1_slot12;
            sizing['CONTAINER_DISTANCE_SIDES'] = update;
            foxtrot['__closure'] = sizing;
            sizing = 15232111823130.0;
            foxtrot['__workletHash'] = sizing;
            sizing = _closure1_slot15;
            foxtrot['__initData'] = sizing;
 ...
 0:
                    ...
                    tango = tango.YEETED;
                    if(!(report !== tango)) { _fun105806_ip = 74; continue _fun105806 }
 48:
                    oscar = _closure2_slot12;
                    report = oscar.set;
                    ...
                    _fun105806_ip = 113; continue _fun105806;
 74:
                    ...
                    zulu = _closure2_slot8;
                    if(!zulu) { _fun105806_ip = 113; continue _fun105806 }
 105:
 ...
 113:
            ...
            yankee = kilo.bind(sizing)(yankee, backup);
 ...
 0:
                    ...
                    if(!mike) { _fun105807_ip = 56; continue _fun105807 }
 10:
                    tango = _closure1_slot0;
 ...
 56:
            ...
            golf = backup.bind(kilo)(golf, yankee);
            if(!tango) { _fun105802_ip = 734; continue _fun105802 }
 729:
            entity = null;
            if(zulu) { _fun105802_ip = 849; continue _fun105802 }
 734:
            ...
            oscar = options.bind(report)(golf, oscar, verify);
            mike['children'] = oscar;
 ...
 849:
    ...
    entity = function(argFoo) { // Original name: wrapChildren
        ...
        zulu = undefined;
        entity = mike.bind(zulu)(entity);
        mike = entity.NonExpandingOverlayView;
        entity = {};
        report = argFoo;
    ...
    tango = {};
    romeo = {'position': 'absolute', 'alignSelf': 'center', 'flexDirection': 'row', 'justifyContent': 'center'};
    foxtrot = 5;
    foxtrot = oscar[foxtrot];
    foxtrot = report.bind(entity)(foxtrot);
    foxtrot = foxtrot.TOAST_CONTAINER_SHADOW_COLOR;
    romeo['shadowColor'] = foxtrot;
 ...
 0:
                ...
                entity = null;
                if(!(entity != mike)) { _fun105813_ip = 33; continue _fun105813 }
 23:
                entity = new Array(1);
                entity[0] = mike;
                _fun105813_ip = 37; continue _fun105813;
 33:
                entity = new Array(0);
 37:
                return entity;
 ...
 0:
                ...
                tango = zulu.length;
                zulu = 0;
                if(!(zulu === tango)) { _fun105814_ip = 24; continue _fun105814 }
 20:
                tango = undefined;
                return tango;
 24:
                ...
                mike = mike[zulu];
                mike = mike.toastDurationMs;
                zulu = null;
                zulu = zulu != mike;
                tango = 2000;
                if(!zulu) { _fun105814_ip = 64; continue _fun105814 }
 61:
                tango = mike;
 64:
                zulu = undefined;
        ...
        entity = options.bind(verify)(entity, zulu);
    ...
    tango = 'modules/toast/native/ToastContainer.tsx';
    tango = report.bind(oscar)(tango);
    zulu['default'] = mike;
    return entity;
})();