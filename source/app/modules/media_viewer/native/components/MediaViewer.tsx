...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
 ...
 0:
            tangon = argFoo;
            offset = tangon.source;
            report = tangon.origin;
            oscard = tangon.renderMedia;
            verify = tangon.windowWidth;
            option = tangon.windowHeight;
            output = tangon.sourceWidth;
            var _closure2_slot0 = output;
            sizing = tangon.sourceHeight;
            var _closure2_slot1 = sizing;
            echoed = tangon.entranceAnimationDriver;
            ...
            limora = null;
            whisks = zuuluu;
            michal = silentSetPrototypeOf(whisks, limora);
            romeon = 0;
            whisks = {};
            limora = tangon;
            sierra = zuuluu;
            vacuum = copyDataProperties(whisks, limora, sierra);
            tangon = undefined;
            ...
            michal = foxtra.useEntranceAnimation;
            foxtra = michal.bind(foxtra)(echoed);
            michal = foxtra.loads;
            result = foxtra.handleLoad;
            backup = foxtra.handleError;
            record = foxtra.handleLoadStart;
            kiloes = 7;
            zuuluu = zuuluu[kiloes];
            foxtra = golfie.bind(tangon)(zuuluu);
            golfie = foxtra.useSharedValue;
 ...
 215:
            zuuluu = 0;
 217:
            update = golfie.bind(foxtra)(zuuluu);
            _closure2_slot3 = update;
            ctrled = _closure1_slot4;
            foxtra = ctrled.useEffect;
            golfie = new Array(1);
            golfie[0] = update;
            zuuluu = function() {
                michal = global;
            ...
            zuuluu = foxtra.bind(ctrled)(zuuluu, golfie);
            foxtra = new Array(0);
            ctrled = global;
            golfie = ctrled.Array;
 ...
 284:
            ...
            target = vacuum.index;
            papara = offset.uri;
            sequen = ctrled.HermesInternal;
            cntext = sequen.concat;
            config = '0:';
            sequen = ':';
            config = cntext.bind(config)(target, sequen, papara);
            sequen = 'key';
            zuuluu[sequen] = config;
            sequen = 'onLoadStart';
            zuuluu[sequen] = record;
            sequen = 'onLoad';
            zuuluu[sequen] = result;
            sequen = 'onError';
            zuuluu[sequen] = backup;
            sequen = 'source';
            zuuluu[sequen] = offset;
            sequen = _closure1_slot15;
            config = sequen.platformStyles;
            sequen = 'style';
            zuuluu[sequen] = config;
 ...
 428:
            ...
            whisks = zuuluu;
            limora = vacuum;
            config = copyDataProperties(whisks, limora);
            status = vacuum.index;
            config = offset[romeon];
            target = config.uri;
            config = ctrled.HermesInternal;
            papara = config.concat;
            cntext = '0:';
            config = ':';
            cntext = papara.bind(cntext)(status, config, target);
            config = 'key';
            zuuluu[config] = cntext;
            config = 'onLoadStart';
            zuuluu[config] = record;
            config = 'onLoad';
            zuuluu[config] = result;
            config = 'onError';
            zuuluu[config] = backup;
            record = offset[romeon];
            config = 'source';
            zuuluu[config] = record;
 ...
 572:
            ...
            sequen = copyDataProperties(whisks, limora);
            record = vacuum.index;
            vacuum = offset[romeon];
            config = vacuum.uri;
            ctrled = ctrled.HermesInternal;
            sequen = ctrled.concat;
            vacuum = '1:';
            ctrled = ':';
            vacuum = sequen.bind(vacuum)(record, ctrled, config);
            ctrled = 'key';
            michal[ctrled] = vacuum;
            ctrled = offset[source];
            offset = 'source';
            michal[offset] = ctrled;
            offset = _closure1_slot15;
            ctrled = offset.platformStyles;
            offset = 'style';
            michal[offset] = ctrled;
            offset = 'onLoad';
 ...
 1004:
            ...
            entity = function() { // Original name: Y
                ...
                verify[1] = zuuluu;
                zuuluu = [0, 1];
                zuuluu = yankee.bind(romeon)(offset, zuuluu, verify);
                entity['width'] = zuuluu;
                zuuluu = option[tangon];
                romeon = golfie.bind(oscard)(zuuluu);
                yankee = romeon.interpolate;
                ...
                offset[1] = zuuluu;
                verify = [0, 1];
                verify = romeon.bind(foxtra)(yankee, verify, offset);
                entity['top'] = verify;
            ...
            report = {};
            golfie = false;
            report['collapsable'] = golfie;
            golfie = {};
            golfie['width'] = verify;
            golfie['height'] = option;
            option = 'center';
            golfie['alignItems'] = option;
            golfie['justifyContent'] = option;
            report['style'] = golfie;
    ...
    tangon = oscard[tangon];
    tangon = report.bind(entity)(tangon);
    option = tangon.useMediaSourceSpoilerStore;
    var _closure1_slot9 = option;
    tangon = tangon.removeSpoiler;
    ...
    tangon = {};
    option = 'function MediaViewerTsx3(){const{start,translatePos,isInteracting}=this.__closure;start.set({x:0,y:translatePos.get()});isInteracting.set(true);}';
    tangon['code'] = option;
    var _closure1_slot19 = tangon;
    tangon = {};
    option = 'function MediaViewerTsx4({velocityY:velocityY,translationY:translationY}){const{translatePos,start,velocity}=this.__closure;translatePos.set(translationY+start.get().y);velocity.set(velocityY);}';
    tangon['code'] = option;
    var _closure1_slot20 = tangon;
    tangon = {};
    option = 'function MediaViewerTsx5(_,manager){const{enabled}=this.__closure;if(!enabled.get()){manager.fail();}}';
    tangon['code'] = option;
    var _closure1_slot21 = tangon;
    tangon = {};
    option = 'function MediaViewerTsx6(){const{isInteracting,velocity,swipeVelocityThreshold,dismiss,translatePos,withSpring,SPRING_CONFIG}=this.__closure;isInteracting.set(false);const willClose=Math.abs(velocity.get())>swipeVelocityThreshold;if(willClose){dismiss();}else if(translatePos.get()!==0){translatePos.set(withSpring(0,{velocity:velocity.get(),...SPRING_CONFIG}));}}';
    tangon['code'] = option;
 ...
 0:
            ...
            tangon = undefined;
            michal = michal.bind(tangon)(sizing, kiloes, sequen);
            update = michal.width;
            echoed = michal.height;
            romeon = michal.maximumZoomScale;
            report = _closure1_slot4;
            michal = report.useRef;
            oscard = null;
            output = michal.bind(report)(oscard);
            ...
            vacuum = false;
            oscard = michal.bind(report)(vacuum);
            ...
            michal = new Array(0);
            michal = oscard.bind(offset)(report, michal);
            offset = _closure1_slot4;
 ...
 0:
                    ...
                    zuuluu = null;
                    if(!(zuuluu == michal)) { _fun00008_ip = 129; continue _fun00007 }
 24:
                    michal = _closure2_slot8;
                    michal = michal.current;
                    if(!(zuuluu !== michal)) { _fun00008_ip = 219; continue _fun00007 }
 40:
 ...
 219:
            ...
            status = oscard.bind(offset)(michal, report);
 ...
 11:
                    ...
                    michal = michal.current;
                    zuuluu = null;
                    if(!(zuuluu == michal)) { _fun00010_ip = 87; continue _fun00009 }
 29:
                    michal = _closure2_slot8;
                    michal = michal.current;
                    if(!(zuuluu !== michal)) { _fun00010_ip = 148; continue _fun00009 }
 42:
                    zuuluu = _closure1_slot0;
 ...
 148:
            ...
            config = oscard.bind(offset)(michal, report);
 ...
 154:
            ...
            yankee = oscard.bind(offset)(michal, report);
            ...
            report = report.bind(offset)(sequen);
            cntext = report.obscure;
            var _closure2_slot12 = cntext;
            sequen = report.channelId;
 ...
 27:
                    if(michal) { _fun00014_ip = 60; continue _fun00013 }
 30:
 ...
 60:
            ...
            target = target.bind(sierra)(report, sequen);
            var _closure2_slot16 = target;
            sierra = _closure1_slot4;
            sequen = sierra.useRef;
            report = -1;
            report = sequen.bind(sierra)(report);
 ...
 57:
            ...
            report = sierra.bind(limora)(report, sequen);
            var _closure2_slot18 = report;
            sequen = 16;
            sequen = oscard[sequen];
            limora = papara.bind(tangon)(sequen);
            ...
            var _closure2_slot22 = limora;
            equals = 7;
            ctrled = oscard[equals];
            sierra = michal.bind(tangon)(ctrled);
            papara = sierra.useAnimatedReaction;
            sequen = function() { // Original name: R
            ...
            ctrled = function(argFoo) { // Original name: F
                _fun00017: for(var _fun00018_ip = 0; ; ) switch(_fun00018_ip) {
 0:
                    zuuluu = argFoo;
                    michal = _closure2_slot19;
                    if(!michal) { _fun00018_ip = 16; continue _fun00017 }
 13:
                    michal = zuuluu;
 16:
 ...
 126:
                    ...
                    offset = tangon.bind(option)(verify);
                    option = offset.enabled;
                    tangon = _closure2_slot14;
                    tangon = !tangon;
                    offset = option.bind(offset)(tangon);
                    tangon = offset.numberOfTaps;
                    option = 1;
                    offset = tangon.bind(offset)(option);
                    tangon = offset.maxDistance;
                    zuuluu = zuuluu[foxtra];
                    romeon = romeon.bind(oscard)(zuuluu);
                    zuuluu = romeon.isAndroid;
                    romeon = zuuluu.bind(romeon)();
                    zuuluu = report;
                    if(!romeon) { _fun00022_ip = 253; continue _fun00021 }
 250:
                    zuuluu = 20;
 253:
                    offset = tangon.bind(offset)(zuuluu);
                    tangon = offset.onStart;
                    ...
                    tangon = romeon.enabled;
                    zuuluu = _closure2_slot14;
                    if(!zuuluu) { _fun00022_ip = 335; continue _fun00021 }
 328:
 ...
 335:
                    ...
                    zuuluu = tangon.maxDistance;
                    romeon = _closure1_slot0;
                    option = _closure1_slot2;
                    option = option[foxtra];
                    romeon = romeon.bind(oscard)(option);
                    option = romeon.isAndroid;
                    option = option.bind(romeon)();
                    if(!option) { _fun00022_ip = 389; continue _fun00021 }
 386:
                    report = 20;
 389:
            ...
            report = ctrled.bind(sequen)(report, source);
            ctrled = _closure1_slot4;
 ...
 33:
            ...
            ctrled = michal.bind(tangon)(source);
 ...
 0:
                    ...
                    michal = michal.current;
                    if(!michal) { _fun00026_ip = 28; continue _fun00025 }
 15:
                    zuuluu = _closure2_slot11;
                    michal = undefined;
                    entity = false;
 ...
 28:
            ...
            option = ctrled.bind(vacuum)(option, source);
            source = entity.bind(tangon)(zuuluu);
            zuuluu = _closure1_slot11;
            entity = 11;
            entity = oscard[entity];
            ...
            verify = _closure1_slot11;
            if(oscard) { _fun00006_ip = 1308; continue _fun00005 }
 1233:
            option = _closure1_slot7;
            oscard = {'ref': null, 'style': null, 'automaticallyAdjustContentInsets': false, 'showsHorizontalScrollIndicator': false, 'showsVerticalScrollIndicator': false, 'minimumZoomScale': 1, 'maximumZoomScale': null, 'centerContent': true, 'scrollEventThrottle': 16};
            oscard['ref'] = output;
            output = {};
            output['width'] = sizing;
            output['height'] = kiloes;
            oscard['style'] = output;
            oscard['maximumZoomScale'] = romeon;
            oscard['onScroll'] = yankee;
            output = 'auto';
 ...
 1308:
            ...
            golfie['style'] = backup;
            golfie['minimumZoomScale'] = foxtra;
            golfie['maximumZoomScale'] = romeon;
            golfie['onZoomChanged'] = yankee;
            golfie['children'] = offset;
 ...
 38:
        ...
        zuuluu = function(argFoo, argBar) { // Original name: usePanGesture
            michal = argFoo;
            report = argBar;
            yankee = michal.swipeVelocityThreshold;
            var _closure3_slot0 = yankee;
            offset = michal.velocity;
            var _closure3_slot1 = offset;
            verify = michal.isInteracting;
            var _closure3_slot2 = verify;
            option = michal.translatePos;
            var _closure3_slot3 = option;
            golfie = michal.start;
            var _closure3_slot4 = golfie;
            oscard = michal.dismiss;
            ...
            entity = function() {
                ...
                report = golfie.maxPointers;
                tangon = 1;
                golfie = report.bind(golfie)(tangon);
                report = golfie.activeOffsetY;
                tangon = new Array(2);
                romeon = -10;
                tangon[0] = romeon;
                option = 10;
                tangon[1] = option;
                golfie = report.bind(golfie)(tangon);
                report = golfie.failOffsetX;
                tangon = new Array(2);
                tangon[0] = romeon;
                tangon[1] = option;
                golfie = report.bind(golfie)(tangon);
                report = golfie.onStart;
                ...
                sizing['translatePos'] = romeon;
                kiloes = _closure3_slot2;
                sizing['isInteracting'] = kiloes;
                tangon['__closure'] = sizing;
                sizing = 16330592786264.0;
                tangon['__workletHash'] = sizing;
                sizing = _closure1_slot19;
                tangon['__initData'] = sizing;
                golfie = report.bind(golfie)(tangon);
                report = golfie.onUpdate;
                tangon = function(argFoo) { // Original name: w
                    entity = argFoo;
                ...
                tangon['__initData'] = sizing;
                golfie = report.bind(golfie)(tangon);
                report = golfie.onTouchesDown;
                tangon = function(argFoo, argBar) { // Original name: _
 ...
 0:
                        ...
                        michal = _closure3_slot0;
                        if(!(!(zuuluu > michal))) { _fun00032_ip = 161; continue _fun00031 }
 59:
                        zuuluu = _closure3_slot3;
                        michal = zuuluu.get;
                        michal = michal.bind(zuuluu)();
                        golfie = 0;
                        if(!(golfie !== michal)) { _fun00032_ip = 171; continue _fun00031 }
 78:
 ...
 171:
                ...
                golfie = {};
                golfie['isInteracting'] = kiloes;
                golfie['velocity'] = backup;
                backup = _closure3_slot0;
                golfie['swipeVelocityThreshold'] = backup;
                foxtra = _closure3_slot5;
                golfie['dismiss'] = foxtra;
                golfie['translatePos'] = romeon;
                option = yankee[option];
                option = offset.bind(verify)(option);
                option = option.withSpring;
                golfie['withSpring'] = option;
                option = _closure1_slot16;
                golfie['SPRING_CONFIG'] = option;
                zuuluu['__closure'] = golfie;
                golfie = 3592509938594.0;
 ...
 0:
            ...
            update = 1;
            equals = entity[update];
            var _closure2_slot0 = equals;
            verify = romeon.swipeVelocityThreshold;
            report = romeon.onClose;
            entity = romeon.syncer;
            zuuluu = 21;
            zuuluu = kiloes[zuuluu];
            zuuluu = yankee.bind(tangon)(zuuluu);
            zuuluu = zuuluu.bind(tangon)();
            papara = zuuluu.width;
            target = zuuluu.height;
            var _closure2_slot1 = target;
            yankee = _closure1_slot35;
            sizing = entity.sources;
            zuuluu = romeon.initialIndex;
            zuuluu = sizing[zuuluu];
            zuuluu = yankee.bind(tangon)(papara, target, zuuluu);
            zuuluu = zuuluu.height;
            zuuluu = target + zuuluu;
            variable37 = zuuluu / offset;
            var _closure2_slot2 = variable37;
            sizing = _closure1_slot0;
            yankee = 7;
            zuuluu = kiloes[yankee];
            output = sizing.bind(tangon)(zuuluu);
            zuuluu = output.useSharedValue;
            status = zuuluu.bind(output)(foxtra);
            var _closure2_slot3 = status;
            zuuluu = 17;
            output = kiloes[zuuluu];
            result = sizing.bind(tangon)(output);
            ...
            kiloes = sizing.useAnimatedRef;
            sequen = kiloes.bind(sizing)();
            var _closure2_slot5 = sequen;
            kiloes = entity.sources;
            sizing = entity.index;
            entity = entity.sources;
            entity = entity.length;
            ctrled = entity > update;
 ...
 332:
            ...
            entity = output.bind(tangon)(entity, offset);
            sierra = entity[foxtra];
 ...
 0:
                    zuuluu = _closure2_slot8;
                    michal = _closure2_slot4;
                    if(!michal) { _fun00036_ip = 18; continue _fun00035 }
 14:
 ...
 18:
            ...
            entity = result.bind(echoed)(entity, offset);
 ...
 0:
                        ...
                        tangon = null;
                        if(!(tangon != report)) { _fun00038_ip = 56; continue _fun00037 }
 48:
                        zuuluu = _closure3_slot2;
 ...
 0:
                        ...
                        michal = entity.bind(michal)();
                        entity = 0;
                        if(!(!(michal < entity))) { _fun00040_ip = 44; continue _fun00039 }
 38:
 ...
 51:
            ...
            cntext = entity.bind(tangon)(variable37, verify, report);
            echoed = cntext.dismiss;
            limora = cntext.translatePos;
            var _closure2_slot9 = limora;
            record = cntext.isClosing;
            var _closure2_slot10 = record;
            quebec = cntext.isInteracting;
            var _closure2_slot11 = quebec;
            result = cntext.overlayEnabled;
            var _closure2_slot12 = result;
            verify = _closure1_slot6;
            whisks = verify.absoluteFillObject;
            var _closure2_slot13 = whisks;
            report = _closure1_slot0;
            entity = _closure1_slot2;
            offset = entity[yankee];
            config = report.bind(tangon)(offset);
            ...
            offset = output.bind(tangon)(offset, update);
            update = offset[foxtra];
            offset = entity[yankee];
            output = report.bind(tangon)(offset);
            foxtra = output.useAnimatedStyle;
 ...
 0:
                    ...
                    michal = 0;
                    if(zuuluu) { _fun00042_ip = 314; continue _fun00041 }
 26:
 ...
 38:
                    ...
                    zuuluu = tangon.get;
                    zuuluu = zuuluu.bind(tangon)();
                    if(!zuuluu) { _fun00042_ip = 152; continue _fun00041 }
 54:
                    tangon = _closure2_slot11;
                    zuuluu = tangon.get;
                    zuuluu = zuuluu.bind(tangon)();
 ...
 314:
            ...
            vacuum = report.bind(tangon)(vacuum);
            ...
            source['setShowHeader'] = equals;
            offset['__closure'] = source;
            source = 5516819508737.0;
            offset['__workletHash'] = source;
            source = _closure1_slot31;
            offset['__initData'] = source;
            output = foxtra.bind(output)(offset);
            offset = entity[yankee];
            source = report.bind(tangon)(offset);
            foxtra = source.useDerivedValue;
 ...
 0:
                    ...
                    michal = zuuluu.get;
                    michal = michal.bind(zuuluu)();
                    if(!michal) { _fun00044_ip = 35; continue _fun00043 }
 19:
                    tangon = _closure2_slot11;
                    zuuluu = tangon.get;
                    zuuluu = zuuluu.bind(tangon)();
 ...
 0:
                    ...
                    michal = _closure2_slot7;
                    zuuluu = 0;
                    if(michal) { _fun00046_ip = 161; continue _fun00045 }
 84:
                    option = _closure1_slot0;
 ...
 161:
            ...
            vacuum = {};
            vacuum['absoluteFillObject'] = whisks;
            vacuum['translatePos'] = limora;
            vacuum['hideMediaDuringOrientationChange'] = sierra;
            record = entity[record];
            record = report.bind(tangon)(record);
            ...
            offset['__initData'] = vacuum;
            vacuum = foxtra.bind(source)(offset);
            source = _closure1_slot4;
            foxtra = source.useCallback;
            offset = new Array(2);
            offset[0] = ctrled;
            offset[1] = sequen;
 ...
 0:
                    michal = _closure2_slot6;
                    if(!michal) { _fun00048_ip = 25; continue _fun00047 }
 10:
                    zuuluu = _closure2_slot5;
                    ...
                    michal = zuuluu != tangon;
 25:
                    if(!michal) { _fun00048_ip = 61; continue _fun00047 }
 28:
                    zuuluu = _closure2_slot8;
                    entity = argFoo;
 ...
 61:
                    ...
                    if(!michal) { _fun00048_ip = 103; continue _fun00047 }
 71:
                    zuuluu = _closure1_slot0;
                    michal = _closure1_slot2;
                    entity = 8;
 ...
 103:
            ...
            option = foxtra.bind(source)(option, offset);
            zuuluu = entity[zuuluu];
            report = report.bind(tangon)(zuuluu);
            zuuluu = report.useOrientationListener;
            ...
            verify = {};
            ctrled = 'light-content';
            verify['barStyle'] = ctrled;
            ctrled = !backup;
            verify['hidden'] = ctrled;
            foxtra = source.bind(tangon)(foxtra, verify);
            verify = new Array(6);
            verify[0] = foxtra;
