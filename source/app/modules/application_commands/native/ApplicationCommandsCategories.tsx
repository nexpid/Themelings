...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    tango = oscar[tango];
    tango = report.bind(entity)(tango);
    result = tango.ICON_SIZE;
    romeo = tango.NODE_SIZE;
    backup = tango.NODE_MARGIN;
    tango = tango.ITEM_WIDTH;
    ...
    tango = {};
    offset = {'backgroundColor': null, 'paddingHorizontal': 8, 'paddingVertical': 4, 'flexDirection': 'row', 'alignItems': 'center'};
    kilo = 6;
    yankee = oscar[kilo];
    ...
    tango['categoryImage'] = offset;
    offset = {};
    result = 0.5;
    offset['opacity'] = result;
    tango['fadedItem'] = offset;
    offset = {};
    offset['opacity'] = output;
    kilo = oscar[kilo];
 ...
 0:
            ...
            mike = null;
            verify = mike != options;
            if(!verify) { _fun100930_ip = 134; continue _fun100930 }
 88:
            ...
            zulu = zulu.bind(report)(mike);
            mike = {};
            offset = romeo.categoryImage;
            mike['style'] = offset;
            mike['source'] = options;
            verify = tango.bind(report)(zulu, mike);
 134:
            tango = _closure1_slot9;
            zulu = _closure1_slot0;
            ...
            options = golf.t;
            if(yankee) { _fun100930_ip = 258; continue _fun100930 }
 232:
            ...
            _fun100930_ip = 282; continue _fun100930;
 258:
 ...
 282:
            ...
            offset = new Array(2);
            offset[0] = foxtrot;
            if(yankee) { _fun100930_ip = 320; continue _fun100930 }
 312:
            yankee = romeo.fadedItem;
            _fun100930_ip = 326; continue _fun100930;
 320:
 ...
 326:
    ...
    tango = 'modules/application_commands/native/ApplicationCommandsCategories.tsx';
 ...
 0:
            mike = argFoo;
            golf = mike.style;
            foxtrot = mike.sections;
            entity = mike.onPressSection;
            var _closure2_slot0 = entity;
            yankee = mike.selectedIndex;
 ...
 0:
                    ...
                    mike = mike.current;
                    zulu = null;
                    if(!(zulu != mike)) { _fun100933_ip = 131; continue _fun100933 }
 18:
 ...
 57:
                    ...
                    mike = mike.current;
                    mike = tango > mike;
                    if(mike) { _fun100933_ip = 101; continue _fun100933 }
 88:
                    zulu = _closure2_slot2;
                    zulu = zulu.current;
                    mike = tango < zulu;
 101:
                    if(!mike) { _fun100933_ip = 131; continue _fun100933 }
 104:
 ...
 131:
            ...
            mike = verify.bind(options)(mike, zulu);
            ...
            mike = new Array(0);
            offset = verify.bind(options)(zulu, mike);
            verify = options.useCallback;
            zulu = function(argFoo) {
                entity = argFoo;
                entity = entity.nativeEvent;
            ...
            mike = new Array(0);
            verify = verify.bind(options)(zulu, mike);
            backup = options.useCallback;
            ...
            mike = new Array(0);
            backup = backup.bind(options)(zulu, mike);
            zulu = options.useCallback;
            mike = new Array(2);
            mike[0] = yankee;
            mike[1] = entity;
            entity = function(argFoo) {
                ...
                mike['handlePressCategory'] = entity;
                entity = undefined;
                entity = tango.bind(entity)(zulu, mike);
                return entity;
            };
            yankee = zulu.bind(options)(entity, mike);
            ...
            sizing = 'light';
            if(!output) { _fun100932_ip = 368; continue _fun100932 }
 364:
            sizing = 'dark';
 368:
            ...
            yankee = false;
            oscar['showsHorizontalScrollIndicator'] = yankee;
            oscar['onScroll'] = offset;
