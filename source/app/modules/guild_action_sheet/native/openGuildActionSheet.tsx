...
export default (function(argFoo, argBar, argBaz, _, __, argFre, argPlu) {
    ...
    tangon = 'modules/guild_action_sheet/native/openGuildActionSheet.tsx';
    tangon = report.bind(oscard)(tangon);
    michal = function(argFoo) { // Original name: openGuildActionSheet
        _fun00001: for(var _fun00002_ip = 0; ; ) switch(_fun00002_ip) {
 0:
            michal = argFoo;
            verify = arguments[1];
            entity = undefined;
            if(!(verify === entity)) { _fun00002_ip = 14; continue _fun00001 }
 12:
            verify = true;
 14:
 ...
 188:
            ...
            report = zuuluu.paths;
            yankee = oscard.bind(entity)(offset, report);
            romeon = michal.id;
            report = global;
            report = report.HermesInternal;
            offset = report.concat;
            report = 'GuildActionSheet:';
            offset = offset.bind(report)(romeon);
            report = {};
            report['guild'] = michal;
 ...
 258:
            ...
            zuuluu = zuuluu.paths;
            oscard = oscard.bind(entity)(report, zuuluu);
            offset = michal.id;
            zuuluu = global;
            zuuluu = zuuluu.HermesInternal;
            report = zuuluu.concat;
            zuuluu = 'GuildActionSheet:';
