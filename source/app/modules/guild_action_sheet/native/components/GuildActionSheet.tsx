...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
 ...
 238:
            ...
            vacuum = ctrled.GuildActionSheetPrimaryActions;
            ctrled = {};
            ctrled['guild'] = source;
            ctrled = foxtra.bind(tangon)(vacuum, ctrled);
            result[2] = ctrled;
            ctrled = output[echoed];
            ctrled = sizing.bind(tangon)(ctrled);
            vacuum = ctrled.GuildActionSheetSecondaryActions;
            ctrled = {};
            ctrled['guild'] = source;
            ctrled = foxtra.bind(tangon)(vacuum, ctrled);
            result[3] = ctrled;
    ...
    tangon = 'modules/guild_action_sheet/native/components/GuildActionSheet.tsx';
