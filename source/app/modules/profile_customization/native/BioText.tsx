...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    entity = function(argFoo) { // Original name: LinkButton
        entity = argFoo;
        ...
        oscar = report.Text;
        report = {'variant': 'text-md/normal', 'color': 'text-link'};
    ...
    tango['span'] = verify;
    verify = {'alignSelf': 'stretch', 'textAlignVertical': 'bottom', 'width': '100%', 'flexGrow': 1, 'bottom': 4294967292, 'position': 'relative'};
    tango['link'] = verify;
 ...
 0:
            ...
            report = undefined;
            if(!(output === report)) { _fun77723_ip = 54; continue _fun77723 }
 48:
 ...
 54:
            ...
            entity = 0;
            sizing = entity === zulu;
            if(!sizing) { _fun77723_ip = 137; continue _fun77723 }
 109:
            zulu = _closure1_slot1;
            tango = _closure1_slot2;
            entity = 10;
 ...
 137:
            ...
            entity = zulu.bind(report)(entity);
            entity = entity.bind(report)(mike);
            if(entity) { _fun77723_ip = 266; continue _fun77723 }
 165:
            if(!sizing) { _fun77723_ip = 177; continue _fun77723 }
 168:
            entity = null;
            mike = entity == options;
            if(mike) { _fun77723_ip = 261; continue _fun77723 }
 177:
            ...
            mike['variant'] = output;
            verify = 'text-normal';
            if(!sizing) { _fun77723_ip = 227; continue _fun77723 }
 221:
            verify = 'text-muted';
 227:
            mike['color'] = verify;
            ...
            verify = yankee.text;
            mike['style'] = verify;
            if(!sizing) { _fun77723_ip = 251; continue _fun77723 }
 248:
            oscar = options;
 251:
            mike['children'] = oscar;
 ...
 261:
            _fun77723_ip = 591; continue _fun77723;
 266:
            ...
            foxtrot = 'text-normal';
            oscar = foxtrot;
            if(!sizing) { _fun77723_ip = 325; continue _fun77723 }
 319:
            oscar = 'text-muted';
 325:
            offset['color'] = oscar;
            ...
            oscar = oscar.t;
            oscar = oscar.OJmNR0;
            update = update.bind(source)(oscar);
            oscar = new Array(2);
            oscar[0] = update;
            update = '\n';
            oscar[1] = update;
            ...
            oscar = 'changelog-bio';
            offset = tango.bind(report)(echo, offset, oscar);
            oscar = new Array(2);
            oscar[0] = offset;
            ...
            if(!sizing) { _fun77723_ip = 472; continue _fun77723 }
 466:
            foxtrot = 'text-muted';
 472:
            ...
            yankee = golf.RCYeBA;
            golf = {};
            backup = function(argFoo, argBar) { // Original name: blogHook
                report = _closure1_slot8;
                tango = _closure1_slot11;
                zulu = {};
                entity = _closure2_slot1;
                zulu['lineClamp'] = entity;
                entity = argFoo;
                zulu['text'] = entity;
                mike = undefined;
                entity = argBar;
            ...
            golf['blogHook'] = backup;
            golf = romeo.bind(foxtrot)(yankee, golf);
            options['children'] = golf;
            golf = 'changelog-cta';
            golf = offset.bind(report)(verify, options, golf);
            oscar[1] = golf;
            mike['children'] = oscar;
            entity = tango.bind(report)(zulu, mike);
 591:
