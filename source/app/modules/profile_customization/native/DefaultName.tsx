...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
            ...
            report = '';
            tango = report;
            if(!entity) { _fun99672_ip = 105; continue _fun99672 }
 19:
            ...
            mike = mike.Types;
            if(oscar) { _fun99672_ip = 71; continue _fun99672 }
 63:
            oscar = mike.BOT;
            _fun99672_ip = 77; continue _fun99672;
 71:
 ...
 105:
            ...
            mike = entity.concat;
            entity = ', ';
            entity = mike.bind(report)(zulu, entity, tango);
            return entity;
        }
    };
    ...
    verify['flex'] = offset;
    tango['flex'] = verify;
    verify = {'display': 'flex', 'flexDirection': 'row', 'alignItems': 'center', 'flexWrap': 'wrap', 'position': 'relative'};
    tango['defaultNameContainer'] = verify;
    verify = {'flexDirection': 'row', 'flexWrap': 'wrap', 'alignItems': 'flex-start'};
    ...
    tango['botTag'] = verify;
    verify = {'flex': 1, 'flexDirection': 'row', 'alignItems': 'center', 'marginTop': 4};
    tango['AKAContainer'] = verify;
    verify = {'position': 'absolute', 'top': 2, 'left': 0};
    tango['defaultAvatar'] = verify;
 ...
 0:
            ...
            romeo = report.canShowNicknames;
            mike = report.showGuildAvatar;
            kilo = report.onPress;
            ...
            tango = undefined;
            if(!(entity === tango)) { _fun99673_ip = 62; continue _fun99673 }
 60:
            entity = false;
 62:
            control = report.lineClamp;
            context = report.textVariant;
            if(!(context === tango)) { _fun99673_ip = 84; continue _fun99673 }
 78:
            context = 'heading-xl/extrabold';
 84:
            source = report.hideSubname;
            report = _closure1_slot6;
            offset = report.bind(tango)();
            report = yankee.hasAvatarForGuild;
            foxtrot = report.bind(yankee)(options);
            if(foxtrot) { _fun99673_ip = 118; continue _fun99673 }
 115:
            foxtrot = mike;
 118:
            vacuum = '';
            if(!foxtrot) { _fun99673_ip = 143; continue _fun99673 }
 125:
            oscar = '\xa0';
            report = oscar.repeat;
            mike = 5;
            vacuum = report.bind(oscar)(mike);
 143:
            mike = yankee.isPomelo;
            mike = mike.bind(yankee)();
            verify = null;
            record = null;
            if(mike) { _fun99673_ip = 212; continue _fun99673 }
 160:
            record = null;
            if(entity) { _fun99673_ip = 212; continue _fun99673 }
 165:
            ...
            if(entity) { _fun99673_ip = 212; continue _fun99673 }
 180:
            if(!(verify == zulu)) { _fun99673_ip = 190; continue _fun99673 }
 184:
 ...
 212:
            ...
            entity = entity.bind(yankee)();
            if(entity) { _fun99673_ip = 301; continue _fun99673 }
 257:
            entity = yankee.isClyde;
            entity = entity.bind(yankee)();
            if(!entity) { _fun99673_ip = 330; continue _fun99673 }
 270:
            mike = _closure1_slot1;
            entity = _closure1_slot2;
            entity = entity[echo];
            ...
            entity = entity.Types;
            result = entity.AI;
            _fun99673_ip = 330; continue _fun99673;
 301:
            mike = _closure1_slot1;
            entity = _closure1_slot2;
            entity = entity[echo];
 ...
 330:
            ...
            backup = null;
            if(!foxtrot) { _fun99673_ip = 508; continue _fun99673 }
 422:
            sizing = _closure1_slot4;
            kilo = _closure1_slot1;
            sequence = _closure1_slot2;
            output = 7;
            foxtrot = sequence[output];
            ...
            output = output.XSMALL;
            foxtrot['size'] = output;
            foxtrot['user'] = yankee;
            foxtrot['guildId'] = tango;
            output = true;
            foxtrot['animate'] = output;
 ...
 508:
            ...
            backup = {};
            output = offset.usernameContainer;
            backup['style'] = output;
            update = _closure1_slot0;
            ...
            update = output.Text;
            output = {};
            papa = offset.username;
            output['style'] = papa;
            output['variant'] = context;
            context = 'header-primary';
            output['color'] = context;
            output['lineClamp'] = control;
            control = new Array(2);
            control[0] = vacuum;
            vacuum = yankee.username;
            control[1] = vacuum;
            output['children'] = control;
            update = sizing.bind(tango)(update, output);
            output = new Array(2);
            output[0] = update;
            update = null;
            if(source) { _fun99673_ip = 744; continue _fun99673 }
 631:
            ...
            sequence[0] = record;
            if(!config) { _fun99673_ip = 730; continue _fun99673 }
 682:
            ...
            context = status.bind(tango)(record);
            record = {};
            target = 10;
 ...
 744:
            ...
            kilo = yankee.bot;
            backup = null;
            if(!kilo) { _fun99673_ip = 831; continue _fun99673 }
 773:
            ...
            kilo['style'] = echo;
            kilo['type'] = result;
            result = yankee.isVerifiedBot;
            result = result.bind(yankee)();
            kilo['verified'] = result;
 ...
 831:
            ...
            report[0] = oscar;
            oscar = null;
            if(!romeo) { _fun99673_ip = 922; continue _fun99673 }
 858:
            options = verify == options;
            oscar = null;
            if(!options) { _fun99673_ip = 922; continue _fun99673 }
 867:
