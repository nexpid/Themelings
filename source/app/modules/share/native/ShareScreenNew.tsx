// app/modules/share/native/ShareScreenNew.tsx
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
        ...
        entity = function(argFoo) { // Original name: getAttachmentsRestriction
            _fun107612: for(var _fun107612_ip = 0; ; ) switch(_fun107612_ip) {
 0:
                report = argFoo;
                entity = _closure1_slot8;
                entity = report instanceof entity;
                if(!entity) { _fun107612_ip = 36; continue _fun107612 }
 17:
                mike = _closure1_slot9;
                entity = report.type;
                golf = undefined;
                entity = mike.bind(golf)(entity);
                if(entity) { _fun107612_ip = 40; continue _fun107612 }
 36:
                entity = undefined;
                return entity;
 40:
                ...
                mike = mike.bind(tango)(entity, report);
                entity = undefined;
                if(mike) { _fun107612_ip = 135; continue _fun107612 }
 71:
                mike = {};
 ...
 135:
        ...
        tango = oscar[tango];
        tango = report.bind(entity)(tango);
        golf = tango.ChannelRecordBase;
        var _closure1_slot8 = golf;
        tango = tango.isGuildChannelType;
        ...
        foxtrot = 0;
        if(!backup) { _fun107611_ip = 459; continue _fun107611 }
 436:
        backup = 14;
        backup = oscar[backup];
        backup = yankee.bind(entity)(backup);
        backup = backup.spacing;
        foxtrot = backup.PX_16;
 459:
        ...
        offset = 0;
        if(!romeo) { _fun107611_ip = 510; continue _fun107611 }
 487:
        romeo = 14;
        romeo = oscar[romeo];
 ...
 510:
        ...
        tango = 'modules/share/native/ShareScreenNew.tsx';
        tango = report.bind(oscar)(tango);
        mike = function(argFoo) { // Original name: ShareScreenNew
            _fun107613: for(var _fun107613_ip = 0; ; ) switch(_fun107613_ip) {
 0:
                entity = argFoo;
                source = entity.sharedContent;
                var _closure2_slot0 = source;
                record = entity.onClose;
                tango = undefined;
 ...
 0:
                        ...
                        entity = new Array(0);
                        mike = tango.targetUserId;
                        zulu = null;
                        if(!(zulu != mike)) { _fun107614_ip = 53; continue _fun107614 }
 23:
                        report = entity.push;
                        mike = {};
                        oscar = 'user';
                        mike['type'] = oscar;
                        oscar = tango.targetUserId;
                        mike['id'] = oscar;
                        mike = report.bind(entity)(mike);
 53:
                        mike = tango.targetChannelId;
                        if(!(zulu != mike)) { _fun107614_ip = 93; continue _fun107614 }
 63:
                        zulu = entity.push;
                        mike = {};
                        report = 'channel';
                        mike['type'] = report;
                        tango = tango.targetChannelId;
                        mike['id'] = tango;
 ...
 93:
                ...
                entity = new Array(0);
                control = options.bind(zulu)(golf, entity);
                golf = zulu.useState;
                entity = false;
                ...
                if(!(!(kilo <= mike))) { _fun107613_ip = 275; continue _fun107613 }
 211:
                ...
                entity = {};
                entity['count'] = kilo;
                output = oscar.bind(golf)(zulu, entity);
                _fun107613_ip = 330; continue _fun107613;
 275:
 ...
 330:
                ...
                options = entity != golf;
                entity = '';
                if(!options) { _fun107613_ip = 360; continue _fun107613 }
 357:
                entity = golf;
 360:
                ...
                entity = zulu.bind(tango)(entity);
                entity = entity.bind(tango)(update);
                golf = entity.embed;
 ...
 0:
                            ...
                            if(mike) { _fun107617_ip = 1044; continue _fun107617 }
 12:
                            mike = undefined;
                            ...
                            zulu = null;
                            if(!(zulu == tango)) { _fun107617_ip = 144; continue _fun107617 }
 61:
                            romeo = _closure1_slot0;
                            foxtrot = _closure1_slot2;
                            zulu = 17;
                            zulu = foxtrot[zulu];
                            oscar = romeo.bind(mike)(zulu);
                            tango = oscar.showInformationToast;
                            zulu = 15;
                            verify = foxtrot[zulu];
                            ...
                            zulu = foxtrot[zulu];
                            zulu = romeo.bind(mike)(zulu);
                            zulu = zulu.t;
                            zulu = zulu.+ohEiI;
                            zulu = verify.bind(yankee)(zulu);
                            zulu = tango.bind(oscar)(zulu);
                            _fun107617_ip = 1041; continue _fun107617;
 144:
                            zulu = _closure2_slot6;
                            zulu = zulu.current;
                            if(zulu) { _fun107617_ip = 1041; continue _fun107617 }
 162:
                            zulu = _closure2_slot6;
                            oscar = true;
                            zulu['current'] = oscar;
 ...
 183: // try_start_0
                            ...
                            zulu = 18;
                            zulu = backup[zulu];
                            zulu = foxtrot.bind(mike)(zulu);
                            zulu = zulu.getOrResolveChannelIdFromDestinationId;
 ...
 246:
                            ...
                            if(oscar) { _fun107617_ip = 992; continue _fun107617 }
 255:
                            verify = zulu.filter;
                            ...
                            oscar = oscar.length;
                            verify = 0;
                            if(!(verify !== oscar)) { _fun107617_ip = 888; continue _fun107617 }
 308:
                            oscar = _closure2_slot0;
                            romeo = oscar.attachments;
                            _closure4_slot1 = romeo;
                            yankee = romeo.map;
 ...
 0:
                                    ...
                                    zulu = entity != mike;
                                    entity = 'unknown';
                                    if(!zulu) { _fun107618_ip = 25; continue _fun107618 }
 22:
                                    entity = mike;
 25:
                                    return entity;
 ...
 0:
                                            StartGenerator();
                                            ResumeGenerator(result_out_reg=0, return_bool_out_reg=1);
                                            if(mike) { _fun107621_ip = 226; continue _fun107621 }
 10:
                                            ...
                                            mike = null;
                                            if(!(mike != verify)) { _fun107621_ip = 221; continue _fun107621 }
 39:
                                            ...
                                            report = oscar.sendAttachmentsAsync;
                                            mike = {};
 ...
 115:
                                            ...
                                            if(report) { _fun107621_ip = 218; continue _fun107621 }
 121:
                                            ...
                                            report = tango.SHARE_MESSAGE_SENT;
                                            tango = {};
                                            offset = verify.guild_id;
                                            tango['guild_id'] = offset;
                                            offset = verify.id;
                                            tango['channel_id'] = offset;
                                            verify = verify.type;
                                            tango['channel_type'] = verify;
                                            verify = _closure4_slot1;
                                            verify = verify.length;
                                            tango['num_attachments'] = verify;
                                            options = _closure4_slot2;
                                            tango['attachment_mimetypes'] = options;
 ...
 396:
                            ...
                            if(yankee) { _fun107617_ip = 864; continue _fun107617 }
 405:
                            ...
                            if(yankee) { _fun107617_ip = 668; continue _fun107617 }
 433:
                            ...
                            foxtrot = output.bind(mike)(offset);
                            romeo = foxtrot.openAlert;
                            yankee = _closure1_slot17;
                            offset = {};
                            sizing = 15;
                            result = update[sizing];
                            result = output.bind(mike)(result);
                            source = result.intl;
                            echo = source.string;
                            result = update[sizing];
                            result = output.bind(mike)(result);
                            result = result.t;
                            result = result.dA1gb2;
                            ...
                            sizing = output.bind(mike)(sizing);
                            sizing = sizing.t;
                            output = sizing.thm88P;
                            sizing = {};
                            update = kilo.length;
                            sizing['count'] = update;
                            sizing = result.bind(echo)(output, sizing);
                            offset['content'] = sizing;
                            offset['failedDestinations'] = kilo;
                            yankee = yankee.bind(mike)(backup, offset);
                            offset = 'share-failed-alert-modal';
 ...
 716:
                            ...
                            if(verify) { _fun107617_ip = 840; continue _fun107617 }
 722:
                            ...
                            romeo = foxtrot.transitionToChannel;
                            verify = options;
                            options = {'navigationReplace': true, 'openTextInVoiceIfVoiceChannel': true};
                            ...
                            options = verify;
                            if(!verify) { _fun107617_ip = 814; continue _fun107617 }
 794:
                            verify = _closure1_slot6;
                            offset = verify.ShareManager;
                            verify = offset.launchApp;
 ...
 888: // try_start_2
                            ...
                            golf = offset.bind(mike)(report);
                            oscar = golf.showInformationToast;
                            report = 15;
 ...
 992:
                            ...
                            return zulu;
 1016: // catch_target0 // catch_target1 // catch_target2
 ...
 1044:
                ...
                mike = new Array(3);
                mike[0] = vacuum;
                romeo = source.attachments;
                mike[1] = romeo;
                mike[2] = update;
                foxtrot = options.bind(report)(oscar, mike);
                oscar = report.useMemo;
                mike = new Array(3);
                mike[0] = golf;
                mike[1] = entity;
                entity = source.attachments;
                mike[2] = entity;
                entity = function() {
 ...
 0:
                        ...
                        foxtrot = null;
                        if(!(foxtrot == entity)) { _fun107626_ip = 39; continue _fun107626 }
 13:
                        ...
                        mike = 0;
                        entity = null;
                        if(!(mike !== zulu)) { _fun107626_ip = 192; continue _fun107626 }
 39:
                        ...
                        oscar['attachments'] = offset;
                        offset = true;
                        oscar['isRevamp'] = offset;
                        ...
                        romeo = undefined;
                        if(foxtrot) { _fun107626_ip = 153; continue _fun107626 }
 143:
 ...
 153:
                        ...
                        golf['isLoadingEmbed'] = yankee;
                        golf['isRevamp'] = offset;
 ...
 192:
                ...
                result = oscar.bind(report)(entity, mike);
                entity = 29;
                entity = sequence[entity];
                entity = zulu.bind(tango)(entity);
 ...
 0:
                        ...
                        mike = {};
                        if(entity) { _fun107627_ip = 51; continue _fun107627 }
 39:
                        entity = 1;
                        mike['flex'] = entity;
                        entity = mike;
                        _fun107627_ip = 79; continue _fun107627;
 51:
 ...
 79:
                ...
                options = golf.Header;
                golf = {};
                config = verify.header;
                golf['headerStyle'] = config;
                config = 15;
                ...
                config = config.t;
                config = config.MR7/kp;
                config = context.bind(papa)(config);
                golf['title'] = config;
                yankee = function(argFoo) { // Original name: headerTitle
 ...
 0:
                        ...
                        oscar = null;
                        if(!options) { _fun107628_ip = 235; continue _fun107628 }
 114:
                        verify = _closure1_slot17;
                        yankee = _closure1_slot0;
 ...
 235:
                ...
                golf['headerTitle'] = yankee;
                yankee = 'center';
                golf['headerTitleAlign'] = yankee;
                yankee = 33;
                yankee = sequence[yankee];
                config = romeo.bind(tango)(yankee);
                yankee = config.getHeaderCloseButton;
                yankee = yankee.bind(config)(record);
                golf['headerLeft'] = yankee;
                yankee = 13;
                yankee = sequence[yankee];
                ...
                yankee = undefined;
                if(!romeo) { _fun107613_ip = 799; continue _fun107613 }
 797:
                yankee = 0;
 799:
                golf['headerStatusBarHeight'] = yankee;
                ...
                sequence = sequence.TOGGLE;
                verify['rowMode'] = sequence;
                verify['initialSelectedDestinations'] = vacuum;
                verify['onSelectedDestinationChange'] = control;
                source = source.attachments;
                source = source.length;
                control = source > sizing;
                source = undefined;
                if(!control) { _fun107613_ip = 922; continue _fun107613 }
 918:
                source = _closure1_slot21;
 922:
                verify['getRowIsUnavailable'] = source;
                verify['insetEnd'] = sizing;
                source = true;
                verify['disableGradient'] = source;
                verify['disableStickySections'] = source;
                source = _closure1_slot15;
                source = kilo >= source;
                verify['disableSelection'] = source;
                ...
                offset['text'] = update;
                offset['setText'] = echo;
                offset['preview'] = result;
                offset['sendLabel'] = output;
                kilo = kilo > sizing;
                offset['canSend'] = kilo;
                offset['isSending'] = backup;
                offset['onSend'] = foxtrot;
