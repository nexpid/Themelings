...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    entity = function(argFoo) { // Original name: FailedGroupDMRow
        entity = argFoo;
        ...
        verify = entity.bind(tango)(foxtrot);
        ...
        golf = oscar.Text;
        oscar = {'style': null, 'variant': 'text-md/medium', 'lineClamp': 1, 'ellipsizeMode': 'tail'};
        offset = offset.label;
        oscar['style'] = offset;
    ...
    entity = function(argFoo) { // Original name: FailedUserRow
 ...
 0:
            ...
            offset = options.bind(verify)(golf, oscar);
            mike = tango[mike];
            ...
            mike = romeo != foxtrot;
            entity = null;
            if(!mike) { _fun102213_ip = 394; continue _fun102213 }
 142:
            ...
            result = kilo.OFFLINE;
            kilo = null;
            if(!(result !== output)) { _fun102213_ip = 215; continue _fun102213 }
 212:
            kilo = output;
 215:
            oscar['status'] = kilo;
            oscar['isMobileOnline'] = options;
            ...
            oscar['avatarDecoration'] = sizing;
            sizing = true;
            oscar['autoStatusCutout'] = sizing;
            ...
            options = golf.Text;
            golf = {'style': null, 'variant': 'text-md/medium', 'lineClamp': 1, 'ellipsizeMode': 'tail'};
            backup = backup.label;
            golf['style'] = backup;
            if(!(romeo == offset)) { _fun102213_ip = 370; continue _fun102213 }
 339:
            ...
            offset = yankee.bind(romeo)(foxtrot);
 370:
 ...
 394:
    ...
    entity = function(argFoo) { // Original name: FailedChannelRow
        mike = argFoo;
        backup = mike.channel;
 ...
 0:
                ...
                entity = undefined;
                if(report) { _fun102217_ip = 39; continue _fun102217 }
 30:
 ...
 39:
        ...
        verify = entity.bind(tango)(backup);
        zulu = _closure1_slot11;
        mike = _closure1_slot3;
        entity = {};
        report = offset.row;
        ...
        options = report.GuildIconWithChannelType;
        report = {};
        sizing = '';
        report['aria-label'] = sizing;
        report['guild'] = kilo;
        report['channel'] = backup;
        foxtrot = yankee[foxtrot];
        foxtrot = golf.bind(tango)(foxtrot);
        foxtrot = foxtrot.GuildIconWithChannelTypeSizes;
    ...
    entity = function(argFoo) { // Original name: FailedDestinationRow
        _fun102218: for(var _fun102218_ip = 0; ; ) switch(_fun102218_ip) {
 0:
            mike = argFoo;
            mike = mike.destination;
 ...
 0:
                    ...
                    report = 'channel';
                    tango = null;
                    if(!(report === oscar)) { _fun102219_ip = 50; continue _fun102219 }
 24:
                    golf = _closure1_slot4;
 ...
 50:
                    ...
                    tango = 'user';
                    mike = null;
                    if(!(tango === report)) { _fun102219_ip = 100; continue _fun102219 }
 73:
 ...
 100:
            ...
            options = entity.user;
            entity = null;
            if(!(entity != oscar)) { _fun102218_ip = 108; continue _fun102218 }
 95:
            zulu = oscar.isGroupDM;
            zulu = zulu.bind(oscar)();
            if(zulu) { _fun102218_ip = 165; continue _fun102218 }
 108:
            if(!(entity == options)) { _fun102218_ip = 143; continue _fun102218 }
 112:
            zulu = entity != oscar;
            entity = null;
            if(!zulu) { _fun102218_ip = 141; continue _fun102218 }
 121:
 ...
 141:
            _fun102218_ip = 163; continue _fun102218;
 143:
            golf = _closure1_slot10;
            ...
            entity = golf.bind(report)(tango, zulu);
 163:
            _fun102218_ip = 185; continue _fun102218;
 165:
 ...
 185:
    ...
    verify = {'display': 'flex', 'flexDirection': 'row', 'alignItems': 'center', 'gap': null, 'height': 40};
    foxtrot = oscar[yankee];
    foxtrot = romeo.bind(entity)(foxtrot);
    foxtrot = foxtrot.spacing;
    ...
    tango = 'modules/share/native/DestinationFailedAlertModal.tsx';
    tango = report.bind(oscar)(tango);
    mike = function(argFoo) { // Original name: DestinationFailedAlertModal
        _fun102220: for(var _fun102220_ip = 0; ; ) switch(_fun102220_ip) {
 0:
            entity = argFoo;
            golf = entity.title;
            report = entity.content;
            foxtrot = entity.failedDestinations;
            ...
            report = {};
            options = null;
            if(!(options == romeo)) { _fun102220_ip = 265; continue _fun102220 }
 161:
            ...
            offset = options.AlertActionButton;
            verify = {};
            options = 'primary';
            ...
            verify['text'] = options;
            options = 'confirm';
            options = yankee.bind(tango)(offset, verify, options);
            _fun102220_ip = 488; continue _fun102220;
 265:
            ...
            output = foxtrot.AlertActionButton;
            sizing = {};
            foxtrot = 'primary';
            ...
            romeo = romeo.t;
            romeo = romeo.5911LS;
            romeo = source.bind(control)(romeo);
            sizing['text'] = romeo;
            romeo = 'confirm';
            sizing = result.bind(tango)(output, sizing, romeo);
            romeo = new Array(2);
            romeo[0] = sizing;
            sizing = _closure1_slot10;
            backup = update[backup];
            backup = echo.bind(tango)(backup);
            kilo = backup.AlertActionButton;
            backup = {};
            output = 'secondary';
