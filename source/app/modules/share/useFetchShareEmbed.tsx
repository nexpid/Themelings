...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    tango = 'modules/share/useFetchShareEmbed.tsx';
    tango = report.bind(oscar)(tango);
    mike = function(argFoo) { // Original name: useFetchShareEmbed
        options = argFoo;
        ...
        offset = 2;
        zulu = yankee.bind(oscar)(mike, offset);
        mike = 0;
        tango = zulu[mike];
        verify = 1;
        zulu = zulu[verify];
        ...
        report = yankee.bind(oscar)(zulu, offset);
        zulu = report[mike];
        report = report[verify];
        var _closure2_slot2 = report;
        report = golf.useState;
        report = report.bind(golf)(romeo);
        report = yankee.bind(oscar)(report, offset);
        mike = report[mike];
        report = report[verify];
 ...
 0:
                ...
                report = null;
                if(!(report != mike)) { _fun107624_ip = 229; continue _fun107624 }
 18:
                tango = _closure2_slot0;
                mike = '';
                if(!(mike !== tango)) { _fun107624_ip = 229; continue _fun107624 }
 33:
                ...
                tango = tango.URL_REGEX;
                options = oscar.bind(golf)(tango);
                oscar = report == options;
                tango = undefined;
                if(oscar) { _fun107624_ip = 101; continue _fun107624 }
 88:
                golf = options.at;
                oscar = 0;
 ...
 101:
                ...
                oscar = oscar.current;
                if(!(tango === oscar)) { _fun107624_ip = 120; continue _fun107624 }
 118:
                return mike;
 120:
                oscar = _closure2_slot5;
                oscar['current'] = tango;
                if(!(report != tango)) { _fun107624_ip = 206; continue _fun107624 }
 134:
                tango = function() {
 ...
 0:
                                ...
                                if(mike) { _fun107627_ip = 341; continue _fun107627 }
 12:
                                oscar = undefined;
                                offset = undefined;
 ...
 83:
                                ...
                                if(golf) { _fun107627_ip = 197; continue _fun107627 }
 89:
                                offset = mike;
                                golf = mike.embeds;
                                golf = golf.length;
                                yankee = 0;
                                if(!(yankee !== golf)) { _fun107627_ip = 145; continue _fun107627 }
 109:
                                options = _closure2_slot1;
                                golf = {};
                                offset = offset.embeds;
 ...
 143: // try_end0
                                _fun107627_ip = 252; continue _fun107627;
 145: // try_start_1
                                report = _closure2_slot1;
                                report = report.bind(oscar)(oscar);
 ...
 341:
                ...
                tango = tango.current;
                if(!tango) { _fun107624_ip = 173; continue _fun107624 }
 157:
                report = _closure2_slot4;
                tango = false;
                report['current'] = tango;
                tango = oscar.bind(mike)();
 173:
                tango = global;
