...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
 ...
 175:
    ...
    oscard = 'modules/user_profile/hooks/useDisplayProfile.tsx';
    oscard = golfie.bind(option)(oscard);
    zuuluu['default'] = report;
    tangon = function(argFoo, argBar) { // Original name: useDisplayProfileWithFetchEffect
        tangon = argFoo;
        zuuluu = argBar;
 ...
 53:
                ...
                michal = tangon.bind(entity)(zuuluu, entity, michal);
                return entity;
            }
        };
    ...
    zuuluu['useDisplayProfileWithFetchEffect'] = tangon;
    zuuluu['getDisplayProfile'] = michal;
    return entity;
})();