...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
 ...
 0:
            ...
            entity = null;
            if(!(entity != report)) { _fun77614_ip = 235; continue _fun77614 }
 133:
            options = entity == report;
            oscar = undefined;
            if(options) { _fun77614_ip = 152; continue _fun77614 }
 142:
            options = report.getBadges;
            oscar = options.bind(report)();
 152:
            if(!(entity == oscar)) { _fun77614_ip = 160; continue _fun77614 }
 156:
            oscar = new Array(0);
 160:
            entity = entity != golf;
            if(!entity) { _fun77614_ip = 181; continue _fun77614 }
 167:
            golf = golf.id;
            report = report.userId;
            entity = golf === report;
 181:
            if(!entity) { _fun77614_ip = 187; continue _fun77614 }
 184:
            entity = tango;
 187:
            tango = oscar;
            if(!entity) { _fun77614_ip = 210; continue _fun77614 }
 193:
            report = oscar.filter;
 ...
 210:
            entity = tango;
            if(!zulu) { _fun77614_ip = 233; continue _fun77614 }
 216:
            zulu = tango.map;
 ...
 0:
                    ...
                    if(!(tango !== zulu)) { _fun77618_ip = 37; continue _fun77618 }
 30:
                    zulu = mike.description;
                    _fun77618_ip = 97; continue _fun77618;
 37:
