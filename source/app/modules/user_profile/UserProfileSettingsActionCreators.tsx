...
case 8:
            ...
            var4 = var8.getMember;
            var3 = var6.id;
            var12 = var4.bind(var8)(var5, var3);
case 7:
            var4 = {};
            var3 = 'globalName';
            var3 = var3 in var2;
...
case 12:
            var8 = var2.globalName;
            var3 = '';
            if(!(var3 === var8)) { _fun0001_ip = 13; continue _fun0001 }
case 14:
            var3 = var6.globalName;
...
case 30:
            var8 = var10.pronouns;
case 29:
            if(!(var9 !== var8)) { _fun0001_ip = 31; continue _fun0001 }
case 32:
            var8 = var2.pronouns;
...
case 34:
            if(!(var7 != var5)) { _fun0001_ip = 35; continue _fun0001 }
case 36:
            var9 = var2.avatar;
            var13 = var7 == var9;
            var3 = undefined;
...
case 40:
            var8 = var12.avatar;
case 39:
            if(!(var3 !== var8)) { _fun0001_ip = 41; continue _fun0001 }
case 35:
            if(!(var7 == var5)) { _fun0001_ip = 42; continue _fun0001 }
case 43:
            var3 = var2.avatar;
            var9 = var7 == var3;
            var8 = undefined;
...
case 44:
            var3 = var6.avatar;
            if(!(var8 !== var3)) { _fun0001_ip = 41; continue _fun0001 }
case 42:
            var3 = var2.avatar;
...
case 54:
            var3 = var9.skuId;
case 52:
            if(!(var8 !== var3)) { _fun0001_ip = 55; continue _fun0001 }
case 48:
            if(!(var7 == var5)) { _fun0001_ip = 56; continue _fun0001 }
case 57:
...
case 61:
            var8 = var9.skuId;
case 60:
            if(!(var3 !== var8)) { _fun0001_ip = 55; continue _fun0001 }
case 56:
            var3 = var2.avatarDecoration;
...
case 63:
            if(!(var7 != var5)) { _fun0001_ip = 64; continue _fun0001 }
case 65:
            var3 = var2.nameplate;
            var9 = var7 == var3;
            var8 = undefined;
...
case 71:
            var3 = var9.skuId;
case 68:
            if(!(var8 !== var3)) { _fun0001_ip = 72; continue _fun0001 }
case 64:
...
case 86:
            var8 = var13.skuId;
case 84:
            if(!(var9 !== var8)) { _fun0001_ip = 87; continue _fun0001 }
case 88:
            var8 = var2.profileEffect;
...
case 95:
            var8 = var13.skuId;
case 93:
            if(!(var9 !== var8)) { _fun0001_ip = 96; continue _fun0001 }
case 97:
            var8 = var2.profileFrame;
...
case 99:
            if(!(var7 != var5)) { _fun0001_ip = 100; continue _fun0001 }
case 101:
            var9 = var2.banner;
            var13 = var7 == var12;
            var3 = undefined;
...
case 103:
            var8 = var12.banner;
case 102:
            if(!(var9 !== var8)) { _fun0001_ip = 104; continue _fun0001 }
case 100:
            if(!(var7 == var5)) { _fun0001_ip = 105; continue _fun0001 }
case 106:
            var9 = var2.banner;
            var8 = var6.banner;
            if(!(var9 !== var8)) { _fun0001_ip = 107; continue _fun0001 }
case 105:
            var8 = var2.banner;
            var4['pendingBanner'] = var8;
            var9 = var2.bannerOriginalMd5;
            var12 = var7 != var9;
            var8 = null;
            if(!var12) { _fun0001_ip = 108; continue _fun0001 }
case 109:
            var8 = var9;
case 108:
            var4['pendingBannerOriginalMd5'] = var8;
...
case 119:
            ...
            var8 = var11[var9];
case 118:
            if(!(var7 == var8)) { _fun0001_ip = 120; continue _fun0001 }
case 116:
            var9 = var7 == var10;
            var8 = undefined;
...
case 127:
            var8 = var10.bio;
case 126:
            if(!(var9 !== var8)) { _fun0001_ip = 128; continue _fun0001 }
case 129:
            var8 = var2.bio;
...
case 132:
            ...
            if(!(var6 !== var7)) { _fun0001_ip = 134; continue _fun0001 }
case 135:
            var6 = var2.primaryGuildId;
