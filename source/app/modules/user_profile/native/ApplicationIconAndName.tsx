...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
 ...
 0:
            ...
            tango = undefined;
            if(!(verify === tango)) { _fun101681_ip = 34; continue _fun101681 }
 32:
            verify = false;
 34:
            ...
            golf = {};
            report = report.gameIcon;
            golf['style'] = report;
            report = 'contain';
            golf['resizeMode'] = report;
            report = {};
            romeo = offset.getIconURL;
            kilo = romeo.bind(offset)(backup);
            romeo = null;
            sizing = romeo != kilo;
            romeo = '';
            backup = romeo;
            if(!sizing) { _fun101681_ip = 133; continue _fun101681 }
 130:
            backup = kilo;
 133:
            report['uri'] = backup;
            golf['source'] = report;
            report = true;
            golf['disableColor'] = report;
            report = offset.id;
            golf = foxtrot.bind(tango)(options, golf, report);
            report = new Array(2);
            report[0] = golf;
            ...
            yankee = offset.name;
            offset = romeo;
            if(!verify) { _fun101681_ip = 220; continue _fun101681 }
 214:
            offset = ', ';
 220:
            verify = global;
            ...
            verify = verify.bind(romeo)(yankee, offset);
