...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    tango = 'modules/user_profile/native/BotUserProfileOverflowMenu.tsx';
    tango = report.bind(oscar)(tango);
    mike = function(argFoo) { // Original name: BotUserProfileOverflowMenu
 ...
 0:
            ...
            entity = 8;
            mike = sizing[entity];
            verify = yankee.bind(report)(mike);
            ...
            kilo = mike.relationshipType;
            foxtrot = mike.isIgnored;
            entity = sizing[entity];
            golf = yankee.bind(report)(entity);
            ...
            golf = oscar.bind(golf)(mike, entity);
            var _closure2_slot3 = golf;
            entity = 9;
            entity = sizing[entity];
            oscar = yankee.bind(report)(entity);
            mike = oscar.isIarUserReportingEnabled;
            entity = 'User Profile Options - Mobile';
            verify = mike.bind(oscar)(entity);
            entity = 10;
            entity = sizing[entity];
            mike = yankee.bind(report)(entity);
            ...
            mike = 11;
            entity = sizing[mike];
            oscar = output.bind(report)(entity);
            entity = 12;
            entity = sizing[entity];
            entity = output.bind(report)(entity);
            entity = entity.USER_PROFILE_OVERFLOW_MENU;
            ...
            entity = 13;
            entity = sizing[entity];
            sizing = yankee.bind(report)(entity);
            yankee = sizing.useIsStealthRemediationEnabled;
            entity = {};
            output = 'BotUserProfileOverflowMenu';
            entity['location'] = output;
            sizing = yankee.bind(sizing)(entity);
            ...
            update = entity == tango;
            echo = undefined;
            if(update) { _fun81984_ip = 390; continue _fun81984 }
 385:
            echo = tango.id;
 390:
            yankee[1] = echo;
 ...
 0:
                    ...
                    report = report == oscar;
                    oscar = undefined;
                    if(report) { _fun81987_ip = 95; continue _fun81987 }
 86:
 ...
 95:
            ...
            output = entity == tango;
            romeo = undefined;
            if(output) { _fun81984_ip = 455; continue _fun81984 }
 445:
            output = tango.getGuildId;
            romeo = output.bind(tango)();
 455:
            _closure2_slot11 = romeo;
            romeo = _closure1_slot10;
            romeo = romeo.BLOCKED;
            romeo = kilo === romeo;
            if(!sizing) { _fun81984_ip = 566; continue _fun81984 }
 476:
            if(!foxtrot) { _fun81984_ip = 566; continue _fun81984 }
 479:
            if(romeo) { _fun81984_ip = 566; continue _fun81984 }
 482:
            kilo = offset.push;
            foxtrot = {};
 ...
 0:
                    ...
                    zulu = undefined;
                    if(options) { _fun81988_ip = 96; continue _fun81988 }
 87:
                    options = _closure2_slot2;
                    zulu = options.id;
 96:
            ...
            foxtrot['action'] = output;
            foxtrot = kilo.bind(offset)(foxtrot);
            _fun81984_ip = 660; continue _fun81984;
 566:
            foxtrot = sizing;
            if(!sizing) { _fun81984_ip = 575; continue _fun81984 }
 572:
            foxtrot = !romeo;
 575:
            if(!foxtrot) { _fun81984_ip = 660; continue _fun81984 }
 578:
            kilo = offset.push;
            foxtrot = {};
            update = _closure1_slot0;
            ...
            foxtrot = kilo.bind(offset)(foxtrot);
 660:
            if(sizing) { _fun81984_ip = 750; continue _fun81984 }
 663:
            if(!romeo) { _fun81984_ip = 750; continue _fun81984 }
 666:
            kilo = yankee.push;
            foxtrot = {};
            update = _closure1_slot0;
            ...
            _fun81984_ip = 844; continue _fun81984;
 750:
            foxtrot = sizing;
            if(!foxtrot) { _fun81984_ip = 759; continue _fun81984 }
 756:
            foxtrot = romeo;
 759:
            if(!foxtrot) { _fun81984_ip = 844; continue _fun81984 }
 762:
            kilo = offset.push;
            foxtrot = {};
            update = _closure1_slot0;
 ...
 0:
                    ...
                    zulu = report[zulu];
                    oscar = tango.bind(entity)(zulu);
                    report = oscar.showUnblockSuccessToast;
                    tango = _closure2_slot10;
                    golf = _closure2_slot2;
                    zulu = null;
                    golf = zulu == golf;
                    zulu = undefined;
                    if(golf) { _fun81992_ip = 128; continue _fun81992 }
 119:
                    golf = _closure2_slot2;
                    zulu = golf.id;
 128:
            ...
            foxtrot = kilo.bind(offset)(foxtrot);
 844:
            if(romeo) { _fun81984_ip = 1169; continue _fun81984 }
 850:
            kilo = offset.push;
            romeo = {};
            update = _closure1_slot0;
            ...
            foxtrot = foxtrot.t;
            foxtrot = foxtrot.l4EmaW;
            foxtrot = output.bind(result)(foxtrot);
            romeo['label'] = foxtrot;
            foxtrot = 'destructive';
            romeo['variant'] = foxtrot;
            if(sizing) { _fun81984_ip = 947; continue _fun81984 }
 929:
            ...
            romeo['action'] = sizing;
            sizing = kilo.bind(offset)(romeo);
            _fun81984_ip = 963; continue _fun81984;
 947:
            sizing = function() { // Original name: action
 ...
 0:
                    ...
                    options = undefined;
                    if(offset) { _fun81993_ip = 134; continue _fun81993 }
 125:
 ...
 963:
            if(verify) { _fun81984_ip = 1086; continue _fun81984 }
 966:
            ...
            verify = romeo.isAndroid;
            verify = verify.bind(romeo)();
            if(!verify) { _fun81984_ip = 1169; continue _fun81984 }
 1001:
            romeo = offset.push;
            verify = {};
            ...
            _fun81984_ip = 1169; continue _fun81984;
 1086:
            romeo = offset.push;
            verify = {};
            result = _closure1_slot0;
 ...
 0:
                    ...
                    mike = '@me';
                    golf = undefined;
                    if(!(mike !== tango)) { _fun81996_ip = 65; continue _fun81996 }
 49:
                    tango = _closure2_slot11;
                    mike = null;
                    golf = undefined;
 ...
 1169:
            ...
            if(!(entity != backup)) { _fun81984_ip = 1427; continue _fun81984 }
 1258:
            romeo = _closure1_slot0;
            foxtrot = _closure1_slot2;
            verify = 30;
            ...
            foxtrot = sizing.hasFlag;
            verify = backup.flags;
            output = entity != verify;
            romeo = 0;
            if(!output) { _fun81984_ip = 1301; continue _fun81984 }
 1298:
            romeo = verify;
 1301:
            verify = _closure1_slot9;
            verify = verify.EMBEDDED;
            verify = foxtrot.bind(sizing)(romeo, verify);
            _closure2_slot12 = verify;
            output = _closure1_slot0;
            foxtrot = _closure1_slot2;
            verify = 31;
            verify = foxtrot[verify];
            romeo = output.bind(report)(verify);
            verify = romeo.getInstallAppPropsFromProfileApplication;
            verify = verify.bind(romeo)(backup);
 ...
 0:
                    ...
                    tango = oscar[tango];
                    report = report.bind(entity)(tango);
                    if(zulu) { _fun81999_ip = 104; continue _fun81999 }
 65:
                    tango = report.getApplicationInstallURL;
                    zulu = {};
                    ...
                    _fun81999_ip = 159; continue _fun81999;
 104:
                    tango = report.getActivityLaunchURL;
                    zulu = {};
                    ...
                    verify = golf == verify;
                    golf = undefined;
                    if(verify) { _fun81999_ip = 149; continue _fun81999 }
 140:
                    options = _closure2_slot8;
                    golf = options.id;
 149:
                    zulu['referrerId'] = golf;
                    oscar = tango.bind(report)(zulu);
 159:
 ...
 1427:
            ...
            romeo = verify.DeveloperMode;
            verify = romeo.getSetting;
            verify = verify.bind(romeo)();
            if(!verify) { _fun81984_ip = 1545; continue _fun81984 }
 1466:
            romeo = yankee.push;
            verify = {};
            output = _closure1_slot0;
 ...
 1545:
            tango = entity != tango;
            if(!tango) { _fun81984_ip = 1556; continue _fun81984 }
 1552:
            tango = entity != golf;
 1556:
            if(!tango) { _fun81984_ip = 1638; continue _fun81984 }
 1559:
            golf = yankee.push;
            tango = {};
            ...
            verify = function() { // Original name: action
                ...
                golf = golf.ApplicationCommandType;
                golf = golf.USER;
                zulu['commandType'] = golf;
                golf = _closure2_slot10;
                zulu['commandTargetId'] = golf;
                mike = _closure2_slot9;
                zulu['onBack'] = mike;
                ...
                zulu['onPressAppCommand'] = mike;
                mike = 'CommandContextMenuActionSheet';
 ...
 1638:
            tango = yankee.length;
            golf = 0;
            if(!(golf === tango)) { _fun81984_ip = 1660; continue _fun81984 }
 1649:
            tango = offset.length;
            entity = null;
            if(!(golf !== tango)) { _fun81984_ip = 1757; continue _fun81984 }
 1660:
