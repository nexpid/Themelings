...
export default (function(argFoo, argBar, _, argCor, __, argFre, argPlu) {
    ...
    tangon = 'modules/user_profile/native/UserProfileConfirmBlockUser.tsx';
    tangon = report.bind(oscard)(tangon);
    michal = function(argFoo) { // Original name: UserProfileConfirmBlockUser
        entity = argFoo;
