...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
            ...
            options = options.PROFILE_MODAL_MUTUALS;
            entity['location'] = options;
            golf = golf.bind(tango)(entity);
            entity = null;
            if(golf) { _fun102583_ip = 213; continue _fun102583 }
 211:
            return entity;
 213:
            golf = entity != zulu;
            if(!golf) { _fun102583_ip = 231; continue _fun102583 }
 220:
            options = zulu.length;
            zulu = 0;
            golf = options > zulu;
 231:
            ...
            options = entity != mike;
            if(!options) { _fun102583_ip = 253; continue _fun102583 }
 242:
            zulu = mike.length;
            mike = 0;
            options = zulu > mike;
 253:
            ...
            if(golf) { _fun102583_ip = 265; continue _fun102583 }
 260:
            if(options) { _fun102583_ip = 265; continue _fun102583 }
 263:
            return entity;
 265:
            entity = function(argFoo) { // Original name: handlePress
                options = argFoo;
                report = _closure2_slot4;
                tango = {};
                entity = 'PRESS_SECTION';
                tango['action'] = entity;
                ...
                report = tango[report];
                tango = tango.paths;
                foxtrot = verify.bind(entity)(report, tango);
                tango = {};
                ...
                tango['guildId'] = zulu;
                zulu = function(argFoo) { // Original name: onPressMutualFriend
                    zulu = _closure2_slot4;
                    mike = {};
                    entity = 'PRESS_MUTUAL_FRIEND';
                    mike['action'] = entity;
                    entity = undefined;
                ...
                tango['onPressMutualFriend'] = zulu;
                mike = function(argFoo) { // Original name: onPressMutualGuild
                    zulu = _closure2_slot4;
                    mike = {};
                ...
                tango['onPressMutualGuild'] = mike;
                romeo = 'UserProfileMutualsActionSheet';
                offset = 'stack';
                backup = golf;
                yankee = tango;
 ...
 0:
                    ...
                    if(entity) { _fun102587_ip = 16; continue _fun102587 }
 12:
                    entity = null;
                    return entity;
 16:
            ...
            report = new Array(3);
            report[0] = verify;
            if(!golf) { _fun102583_ip = 320; continue _fun102583 }
 317:
            golf = options;
 320:
            if(!golf) { _fun102583_ip = 380; continue _fun102583 }
 323:
            ...
            verify = options.Text;
            options = {'variant': 'text-sm/medium', 'color': 'header-secondary', 'accessible': false, 'accessibilityRole': 'none'};
 ...
 0:
                    ...
                    if(entity) { _fun102592_ip = 16; continue _fun102592 }
 12:
                    entity = null;
                    return entity;
 16:
                    ...
                    oscar = !report;
                    if(report) { _fun102592_ip = 250; continue _fun102592 }
 132:
                    options = _closure1_slot7;
                    ...
                    report['children'] = yankee;
                    oscar = options.bind(zulu)(golf, report);
 250:
                    report = new Array(2);
                    report[0] = oscar;
                    options = _closure1_slot7;
