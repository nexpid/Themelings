...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
            ...
            golf = options == backup;
            report = undefined;
            if(golf) { _fun00004_ip = 126; continue _fun00003 }
 121:
 ...
 126:
            ...
            report['style'] = verify;
            if(!(options != backup)) { _fun00004_ip = 303; continue _fun00003 }
 161:
            verify = backup.length;
            options = 0;
            if(!(options !== verify)) { _fun00004_ip = 233; continue _fun00003 }
 172:
            ...
            verify = options.UserProfileStackedActionSheetList;
            options = {};
            options['data'] = backup;
