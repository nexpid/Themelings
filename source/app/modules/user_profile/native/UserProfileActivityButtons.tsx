...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
 ...
 177:
            ...
            if(!option) { _fun00002_ip = 605; continue _fun00001 }
 402:
            if(!(entity != tangon)) { _fun00002_ip = 605; continue _fun00001 }
 409:
 ...
 0:
            ...
            zuuluu = null;
            entity = null;
            if(!tangon) { _fun00004_ip = 306; continue _fun00003 }
 79:
 ...
 0:
            ...
            tangon = null;
            entity = null;
            if(!golfie) { _fun00008_ip = 196; continue _fun00007 }
 79:
 ...
 214:
            _fun00010_ip = 273; continue _fun00009;
 216:
 ...
 278:
            if(offset) { _fun00010_ip = 371; continue _fun00009 }
 281:
 ...
 294:
            ...
            offset = offset.t;
            if(option) { _fun00010_ip = 356; continue _fun00009 }
 341:
            option = offset.BXxdl5;
            option = yankee.bind(romeon)(option);
            _fun00010_ip = 369; continue _fun00009;
 356:
 ...
 431:
            entity['text'] = oscard;
            oscard = 'active';
            if(!golfie) { _fun00010_ip = 446; continue _fun00009 }
 442:
            oscard = 'secondary';
 446:
 ...
 0:
            ...
            if(michal) { _fun00014_ip = 385; continue _fun00013 }
 127:
 ...
 0:
                    ...
                    if(!(golfie === oscard)) { _fun00016_ip = 42; continue _fun00015 }
 36:
 ...
 0:
            ...
            entity = null;
            if(michal) { _fun00018_ip = 252; continue _fun00017 }
 63:
 ...
 86:
            ...
            if(offset) { _fun00018_ip = 159; continue _fun00017 }
 147:
 ...
 0:
                        StartGenerator();
                        ResumeGenerator(result_out_reg=0, return_bool_out_reg=1);
                        if(michal) { _fun00020_ip = 351; continue _fun00019 }
 12:
                        michal = undefined;
                        verify = undefined;
                        oscard = undefined;
 ...
 100:
                        ...
                        if(offset) { _fun00020_ip = 343; continue _fun00019 }
 109:
                        verify = zuuluu;
                        offset = zuuluu.button_urls;
                        yankee = offset.length;
                        offset = _closure2_slot2;
                        if(!(!(yankee <= offset))) { _fun00020_ip = 340; continue _fun00019 }
 134:
                        ...
                        if(!(verify === option)) { _fun00020_ip = 337; continue _fun00019 }
 165:
                        offset = _closure1_slot1;
                        ...
                        oscard = undefined;
                        if(offset) { _fun00020_ip = 219; continue _fun00019 }
 210:
                        offset = report;
                        oscard = offset.protocol;
 219:
                        if(!(verify != oscard)) { _fun00020_ip = 334; continue _fun00019 }
 223:
                        oscard = report;
                        offset = verify == oscard;
                        oscard = undefined;
                        if(offset) { _fun00020_ip = 244; continue _fun00019 }
 235:
                        offset = report;
