...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
                    ...
                    zulu = mike == entity;
                    mike = undefined;
                    if(zulu) { _fun102527_ip = 32; continue _fun102527 }
 27:
                    mike = entity.id;
 32:
            ...
            if(!oscar) { _fun102526_ip = 206; continue _fun102526 }
 203:
            oscar = !options;
 206:
            entity['editEnabled'] = oscar;
            oscar = undefined;
            if(options) { _fun102526_ip = 219; continue _fun102526 }
 216:
            oscar = golf;
 219:
 ...
 0:
            ...
            zulu = undefined;
            if(output) { _fun102534_ip = 128; continue _fun102534 }
 123:
            zulu = foxtrot.guildId;
 128:
            sizing = options.bind(backup)(zulu, sizing, kilo);
            backup = sizing;
            if(!(romeo != mike)) { _fun102534_ip = 169; continue _fun102534 }
 142:
            zulu = mike.trim;
            zulu = zulu.bind(mike)();
            options = zulu.length;
            zulu = 0;
            backup = sizing;
            if(!(options > zulu)) { _fun102534_ip = 169; continue _fun102534 }
 166:
            backup = mike;
 169:
            zulu = _closure1_slot0;
            ...
            kilo = undefined;
            if(sizing) { _fun102534_ip = 283; continue _fun102534 }
 278:
            kilo = foxtrot.guildId;
 283:
            entity['guildId'] = kilo;
            entity['displayName'] = backup;
            if(!(romeo == yankee)) { _fun102534_ip = 313; continue _fun102534 }
 295:
            backup = romeo == foxtrot;
            romeo = undefined;
            if(backup) { _fun102534_ip = 310; continue _fun102534 }
 304:
 ...
 313:
            ...
            verify = undefined;
            if(report) { _fun102534_ip = 335; continue _fun102534 }
 332:
            verify = options;
 335:
            ...
            oscar = undefined;
            if(report) { _fun102534_ip = 408; continue _fun102534 }
 405:
            oscar = options;
 408:
            entity['onPressUserTag'] = oscar;
            oscar = undefined;
            if(report) { _fun102534_ip = 425; continue _fun102534 }
 418:
            oscar = function() {
                zulu = _closure2_slot1;
                mike = {};
 ...
 0:
            ...
            options['icon'] = report;
            report = null;
            if(!(report == golf)) { _fun102537_ip = 366; continue _fun102537 }
 309:
            ...
            _fun102537_ip = 421; continue _fun102537;
 366:
 ...
 421:
            ...
            golf = report != golf;
            report = undefined;
            if(!golf) { _fun102537_ip = 635; continue _fun102537 }
 466:
            options = _closure1_slot13;
 ...
 0:
            ...
            zulu = entity == output;
            target = undefined;
            if(zulu) { _fun102541_ip = 235; continue _fun102541 }
 230:
            target = output.id;
 235:
            record = result.id;
            ...
            if(!(entity == sizing)) { _fun102541_ip = 449; continue _fun102541 }
 433:
            zulu = entity == kilo;
            variable39 = undefined;
            if(zulu) { _fun102541_ip = 447; continue _fun102541 }
 442:
            variable39 = kilo.guild_id;
 447:
            _fun102541_ip = 469; continue _fun102541;
 449:
            tango = sizing.guildId;
            oscar = entity != tango;
            zulu = undefined;
            if(!oscar) { _fun102541_ip = 466; continue _fun102541 }
 463:
            zulu = tango;
 466:
            variable39 = zulu;
 ...
 0:
                    ...
                    mike = null;
                    if(!(mike != entity)) { _fun102544_ip = 21; continue _fun102544 }
 13:
                    entity = _closure2_slot0;
                    if(!(mike == entity)) { _fun102544_ip = 25; continue _fun102544 }
 21:
                    entity = {};
                    _fun102544_ip = 56; continue _fun102544;
 25:
                    mike = {};
 ...
 56:
            ...
            tango = undefined;
            if(!golf) { _fun102541_ip = 683; continue _fun102541 }
 680:
            tango = foxtrot;
 683:
            ...
            if(!(entity != result)) { _fun102541_ip = 2657; continue _fun102541 }
 788:
            if(!(entity != output)) { _fun102541_ip = 2657; continue _fun102541 }
 795:
            equality = {};
            ...
            offset = undefined;
            if(!golf) { _fun102541_ip = 863; continue _fun102541 }
 860:
            offset = control;
 863:
            oscar['pendingBanner'] = offset;
            offset = undefined;
            if(!golf) { _fun102541_ip = 876; continue _fun102541 }
 873:
            offset = variable48;
 876:
            oscar['pendingAvatar'] = offset;
            offset = undefined;
            if(!golf) { _fun102541_ip = 898; continue _fun102541 }
 886:
            control = entity != source;
            offset = undefined;
            if(!control) { _fun102541_ip = 898; continue _fun102541 }
 895:
            offset = source;
 898:
            oscar['pendingAccentColor'] = offset;
            offset = undefined;
            if(!golf) { _fun102541_ip = 920; continue _fun102541 }
 908:
            source = entity != foxtrot;
            offset = undefined;
            if(!source) { _fun102541_ip = 920; continue _fun102541 }
 917:
            offset = foxtrot;
 920:
            ...
            vacuum = undefined;
            if(!golf) { _fun102541_ip = 1005; continue _fun102541 }
 1002:
            vacuum = variable48;
 1005:
            foxtrot['pendingAvatar'] = vacuum;
            vacuum = undefined;
            if(!golf) { _fun102541_ip = 1018; continue _fun102541 }
 1015:
            vacuum = variable44;
 1018:
            ...
            sequence[0] = config;
            config = {};
            if(!(target === record)) { _fun102541_ip = 1103; continue _fun102541 }
 1098:
            record = 0;
            if(!golf) { _fun102541_ip = 1116; continue _fun102541 }
 1103:
            target = entity != context;
            record = 0;
            if(target) { _fun102541_ip = 1116; continue _fun102541 }
 1112:
 ...
 1116:
            ...
            papa = entity == kilo;
            context = undefined;
            if(papa) { _fun102541_ip = 1180; continue _fun102541 }
 1175:
            context = kilo.id;
 1180:
            ...
            if(variable48) { _fun102541_ip = 1261; continue _fun102541 }
 1256:
            variable44 = kilo.id;
 1261:
            ...
            variable44 = undefined;
            if(!golf) { _fun102541_ip = 1278; continue _fun102541 }
 1275:
            variable44 = variable47;
 1278:
            papa['displayNameOverride'] = variable44;
            variable44 = undefined;
            if(!golf) { _fun102541_ip = 1291; continue _fun102541 }
 1288:
 ...
 1291:
            ...
            if(!target) { _fun102541_ip = 1377; continue _fun102541 }
 1337:
 ...
 1377:
            ...
            if(!target) { _fun102541_ip = 1477; continue _fun102541 }
 1398:
            variable44 = _closure1_slot13;
            sierra = _closure1_slot1;
            variable45 = _closure1_slot2;
            ...
            if(variable47) { _fun102541_ip = 1442; continue _fun102541 }
 1437:
            variable45 = kilo.id;
 1442:
            ...
            status['guildId'] = variable39;
            variable45 = undefined;
            if(!echo) { _fun102541_ip = 1458; continue _fun102541 }
 1455:
 ...
 1477:
            papa[2] = target;
            target = echo;
            if(!target) { _fun102541_ip = 1504; continue _fun102541 }
 1487:
            sierra = lima.map;
 ...
 0:
                    ...
                    golf = undefined;
                    if(options) { _fun102548_ip = 85; continue _fun102548 }
 76:
                    options = _closure2_slot1;
                    golf = options.id;
 85:
 ...
 1504:
            ...
            target = output.id;
            target = status === target;
            if(!target) { _fun102541_ip = 1572; continue _fun102541 }
 1569:
            target = !golf;
 1572:
            if(!target) { _fun102541_ip = 1595; continue _fun102541 }
 1575:
 ...
 1595:
            ...
            target = output.id;
            target = status !== target;
            if(!target) { _fun102541_ip = 1712; continue _fun102541 }
 1616:
            lima = _closure1_slot13;
            sierra = _closure1_slot1;
            variable44 = _closure1_slot2;
            ...
            if(variable42) { _fun102541_ip = 1668; continue _fun102541 }
 1654:
            variable43 = _closure1_slot11;
            variable43 = variable43.BLOCKED;
            variable42 = update === variable43;
 1668:
            if(variable42) { _fun102541_ip = 1677; continue _fun102541 }
 1671:
 ...
 1712:
            ...
            if(!target) { _fun102541_ip = 1818; continue _fun102541 }
 1759:
            sierra = _closure1_slot13;
 ...
 1818:
            ...
            target = output.id;
            target = status === target;
            if(!target) { _fun102541_ip = 1846; continue _fun102541 }
 1843:
            target = !golf;
 1846:
            if(!target) { _fun102541_ip = 1910; continue _fun102541 }
 1849:
            lima = _closure1_slot13;
            sierra = _closure1_slot1;
 ...
 0:
                    ...
                    zulu = null;
                    if(!(zulu != tango)) { _fun102546_ip = 56; continue _fun102546 }
 48:
                    mike = _closure2_slot3;
                    mike = mike.bind(entity)();
 56:
 ...
 0:
                    ...
                    zulu = null;
                    if(!(zulu != tango)) { _fun102547_ip = 56; continue _fun102547 }
 48:
 ...
 1910:
            ...
            target = 0;
            target = status > target;
            if(!target) { _fun102541_ip = 2031; continue _fun102541 }
 1981:
            lima = _closure1_slot13;
            sierra = _closure1_slot1;
 ...
 2031:
            ...
            lima = undefined;
            if(!golf) { _fun102541_ip = 2083; continue _fun102541 }
 2080:
            lima = quebec;
 2083:
            ...
            if(!target) { _fun102541_ip = 2239; continue _fun102541 }
 2112:
 ...
 2239:
            ...
            papa[7] = target;
            target = !golf;
            if(!target) { _fun102541_ip = 2398; continue _fun102541 }
 2348:
            lima = _closure1_slot13;
            sierra = _closure1_slot1;
 ...
 2398:
            ...
            oscar[1] = options;
            golf = !golf;
            if(!golf) { _fun102541_ip = 2641; continue _fun102541 }
 2453:
            offset = _closure1_slot14;
            verify = _closure1_slot4;
            options = {};
            ...
            yankee = output.id;
            foxtrot = null;
            if(!(source !== yankee)) { _fun102541_ip = 2569; continue _fun102541 }
 2489:
            yankee = result.bot;
            foxtrot = null;
            if(yankee) { _fun102541_ip = 2569; continue _fun102541 }
 2500:
            yankee = _closure1_slot11;
            yankee = yankee.FRIEND;
            if(!(update !== yankee)) { _fun102541_ip = 2546; continue _fun102541 }
 2514:
            yankee = null;
            if(!echo) { _fun102541_ip = 2544; continue _fun102541 }
 2519:
            yankee = null;
            if(!backup) { _fun102541_ip = 2544; continue _fun102541 }
 2524:
 ...
 2544:
            _fun102541_ip = 2566; continue _fun102541;
 2546:
            update = _closure1_slot13;
