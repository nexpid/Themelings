...
export default (function(argFoo, argBar, _, argCor, __, argFre, argPlu) {
    ...
    tangon = 'modules/user_profile/native/UserProfileConfirmStartCall.tsx';
    tangon = report.bind(oscard)(tangon);
    michal = function(argFoo) { // Original name: UserProfileConfirmStartCall
        entity = argFoo;
