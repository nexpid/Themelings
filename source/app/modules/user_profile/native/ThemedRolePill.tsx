// app/modules/user_profile/native/ThemedRolePill.tsx
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
            ...
            entity = mike.useProfileThemeValues;
            mike = entity.bind(mike)(zulu);
            foxtrot = {};
            offset = null;
            zulu = offset == mike;
            entity = undefined;
            if(zulu) { _fun64851_ip = 126; continue _fun64851 }
 120:
            entity = mike.rolePillBackgroundColor;
 126:
            foxtrot['backgroundColor'] = entity;
            mike = _closure1_slot0;
            ...
            if(!(mike > entity)) { _fun64851_ip = 297; continue _fun64851 }
 239:
            options = result.name;
            zulu = options.slice;
            ...
            romeo = entity;
 297:
            if(!(offset == source)) { _fun64851_ip = 307; continue _fun64851 }
 301:
            source = result.colorString;
 307:
            if(!(offset == source)) { _fun64851_ip = 322; continue _fun64851 }
 311:
 ...
 322:
            ...
            mike = offset == entity;
            options = undefined;
            if(mike) { _fun64851_ip = 343; continue _fun64851 }
 337:
 ...
 343:
            ...
            entity = {};
            oscar = !oscar;
            if(oscar) { _fun64851_ip = 381; continue _fun64851 }
 378:
            oscar = golf;
 381:
            ...
            yankee[1] = foxtrot;
            report['style'] = yankee;
            if(!(tango === options)) { _fun64851_ip = 492; continue _fun64851 }
 446:
            foxtrot = _closure1_slot6;
            yankee = _closure1_slot3;
            options = {};
            update = sizing.bubble;
            backup = new Array(2);
            backup[0] = update;
            update = {};
            update['backgroundColor'] = source;
            backup[1] = update;
            options['style'] = backup;
            yankee = foxtrot.bind(tango)(yankee, options);
            _fun64851_ip = 594; continue _fun64851;
 492:
            ...
            options = {};
            update = sizing.verifiedContainer;
            options['style'] = update;
            update = result.id;
            options['roleId'] = update;
            if(!(offset == echo)) { _fun64851_ip = 546; continue _fun64851 }
 542:
            echo = _closure1_slot4;
 546:
            options['guildId'] = echo;
            result = result.colorString;
            if(!(offset == result)) { _fun64851_ip = 571; continue _fun64851 }
 560:
            echo = sizing.bubble;
            result = echo.backgroundColor;
 571:
            options['roleColor'] = result;
            result = 14;
            options['size'] = result;
            options['displayRoleIcon'] = output;
            yankee = backup.bind(tango)(foxtrot, options);
 594:
            options = new Array(3);
            options[0] = yankee;
            yankee = offset != kilo;
            offset = null;
            if(!yankee) { _fun64851_ip = 641; continue _fun64851 }
 611:
            backup = _closure1_slot6;
            foxtrot = _closure1_slot3;
            yankee = {};
            sizing = sizing.roleIcon;
            yankee['style'] = sizing;
