...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
            ...
            sizing = tango.onBack;
            zulu = {'title': 0, 'children': 0, 'onBack': 0};
            entity = null;
            config = zulu;
            sequence = null;
            ...
            offset = {};
            foxtrot = 'center';
            if(!yankee) { _fun79910_ip = 146; continue _fun79910 }
 140:
 ...
 146:
            ...
            report['style'] = golf;
            golf = yankee;
            if(!yankee) { _fun79910_ip = 306; continue _fun79910 }
 167:
            ...
            foxtrot = offset.PressableOpacity;
            offset = {};
            update = 'button';
            ...
            result = sizing.ArrowLargeLeftIcon;
            sizing = {};
            echo = 'md';
            sizing['size'] = echo;
            sizing = backup.bind(tango)(result, sizing);
            offset['children'] = sizing;
            golf = backup.bind(tango)(foxtrot, offset);
 306:
            offset = new Array(3);
            offset[0] = golf;
            ...
            backup = golf.Text;
            foxtrot = {'variant': 'redesign/heading-18/bold', 'color': 'header-primary', 'accessibilityRole': 'header'};
            golf = 'header';
            foxtrot['children'] = output;
            foxtrot = sizing.bind(tango)(backup, foxtrot);
            offset[1] = foxtrot;
            if(!yankee) { _fun79910_ip = 400; continue _fun79910 }
 374:
            backup = _closure1_slot4;
            foxtrot = _closure1_slot3;
            romeo = {};
            kilo = kilo.headerSpacer;
            romeo['style'] = kilo;
 ...
 0:
            ...
            oscar = zulu.contentContainerStyle;
            entity = zulu.renderItem;
            var _closure2_slot1 = entity;
            mike = {'data': 0, 'contentContainerStyle': 0, 'renderItem': 0};
            sizing = null;
            output = mike;
            ...
            sizing = zulu;
            kilo = mike;
            sizing = copyDataProperties(output, sizing, kilo);
            mike = _closure1_slot6;
            tango = undefined;
            ...
            yankee = 0;
            if(!romeo) { _fun79911_ip = 196; continue _fun79911 }
 193:
            yankee = 16;
 196:
            offset = offset + yankee;
            options['marginBottom'] = offset;
            verify[1] = options;
            options = 'style';
            entity[options] = verify;
            ...
            options = 'ItemSeparatorComponent';
            entity[options] = verify;
 ...
 0:
                    ...
                    entity = 0;
                    tango = entity === oscar;
                    if(!tango) { _fun79913_ip = 49; continue _fun79913 }
 39:
 ...
 49:
                    ...
                    tango = golf - tango;
                    tango = oscar === tango;
                    if(!tango) { _fun79913_ip = 90; continue _fun79913 }
 80:
                    report = _closure2_slot2;
 ...
 90:
    ...
    zulu['UserProfileStackedActionSheetList'] = tango;
    mike = function(argFoo) { // Original name: UserProfileStackedActionSheetSectionList
        zulu = argFoo;
        golf = zulu.contentContainerStyle;
        entity = zulu.renderItem;
        var _closure2_slot0 = entity;
        entity = null;
        mike = Object.create(entity);
        entity = 0;
        mike['contentContainerStyle'] = entity;
        ...
        entity = mike.bind(tango)(entity);
        mike = entity.BottomSheetSectionList;
        entity = {};
        yankee = entity;
 ...
 0:
                ...
                golf = 0;
                golf = golf === oscar;
                if(!golf) { _fun79915_ip = 68; continue _fun79915 }
 58:
 ...
 68:
                ...
                tango = golf - tango;
                tango = oscar === tango;
                if(!tango) { _fun79915_ip = 106; continue _fun79915 }
 96:
 ...
 106:
        ...
        oscar = 'renderItem';
        entity[oscar] = golf;
        oscar = function() { // Original name: ItemSeparatorComponent
            tango = _closure1_slot4;
            mike = _closure1_slot0;
            zulu = _closure1_slot2;
            entity = 8;
        ...
        report = 'ItemSeparatorComponent';
        entity[report] = oscar;
        entity = zulu.bind(tango)(mike, entity);
        return entity;
    };
    zulu['UserProfileStackedActionSheetSectionList'] = mike;
    return entity;
})();