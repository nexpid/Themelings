...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    tango = oscar[tango];
    tango = report.bind(entity)(tango);
    foxtrot = tango.CARD_PADDING;
    yankee = tango.CARD_ROWS_COLUMN_GAP;
    offset = tango.CARD_ROWS_ICON_SIZE;
    ...
    tango = {};
    verify = {'marginBottom': 12, 'flexDirection': 'row', 'alignItems': 'center', 'gap': 4};
    tango['title'] = verify;
    verify = {};
    ...
    tango['rowDivider'] = verify;
    verify = {'flexDirection': 'column', 'paddingVertical': 20};
    tango['row'] = verify;
    verify = {'flexDirection': 'row', 'alignItems': 'center'};
    verify['columnGap'] = yankee;
    tango['rowLabel'] = verify;
    verify = {};
    verify['flex'] = romeo;
    verify['lineHeight'] = offset;
    tango['rowLabelText'] = verify;
    verify = {};
    offset = offset + yankee;
    verify['marginHorizontal'] = offset;
    tango['rowSublabel'] = verify;
 ...
 0:
            zulu = argFoo;
            backup = zulu.title;
            yankee = zulu.titleIcon;
            foxtrot = zulu.titleStyle;
            report = zulu.children;
            verify = zulu.style;
            mike = {'title': 0, 'titleIcon': 0, 'titleStyle': 0, 'children': 0, 'style': 0};
            oscar = null;
            echo = mike;
            result = null;
            ...
            result = zulu;
            output = mike;
            result = copyDataProperties(echo, result, output);
            ...
            golf = oscar != backup;
            if(!golf) { _fun77761_ip = 263; continue _fun77761 }
 146:
            ...
            romeo = offset.Text;
            offset = {'style': null, 'accessibilityRole': 'header', 'variant': 'text-sm/semibold', 'color': 'header-secondary', 'lineClamp': 1};
            kilo = kilo.text;
            offset['style'] = kilo;
 ...
 0:
            mike = argFoo;
            result = mike.label;
            offset = mike.sublabel;
            kilo = mike.icon;
            sizing = mike.hint;
            oscar = mike.disabled;
            entity = mike.isDestructive;
            report = mike.onPress;
            update = mike.labelColor;
            romeo = mike.arrow;
            tango = undefined;
            if(!(romeo === tango)) { _fun77762_ip = 63; continue _fun77762 }
 61:
            romeo = false;
 63:
            mike = _closure1_slot9;
            ...
            output = undefined;
            if(!entity) { _fun77762_ip = 85; continue _fun77762 }
 79:
            output = 'text-danger';
 85:
            echo = 'header-primary';
            if(!entity) { _fun77762_ip = 100; continue _fun77762 }
 94:
            echo = 'text-danger';
 100:
            zulu = _closure1_slot7;
            ...
            oscar = null;
            if(!(oscar != update)) { _fun77762_ip = 250; continue _fun77762 }
 247:
            echo = update;
 250:
            foxtrot['color'] = echo;
            echo = yankee.rowLabelText;
            foxtrot['style'] = echo;
            foxtrot['children'] = result;
            foxtrot = kilo.bind(tango)(backup, foxtrot);
            verify[1] = foxtrot;
            foxtrot = oscar != sizing;
            if(!foxtrot) { _fun77762_ip = 309; continue _fun77762 }
 285:
            kilo = _closure1_slot6;
            backup = {};
 ...
 309:
            verify[2] = foxtrot;
            if(!romeo) { _fun77762_ip = 362; continue _fun77762 }
 316:
            kilo = _closure1_slot6;
            ...
            backup = foxtrot.ChevronSmallRightIcon;
            foxtrot = {};
            sizing = 'sm';
            foxtrot['size'] = sizing;
 ...
 362:
            ...
            report[0] = options;
            oscar = oscar != offset;
            if(!oscar) { _fun77762_ip = 421; continue _fun77762 }
 391:
            verify = _closure1_slot6;
            options = _closure1_slot4;
            golf = {};
            yankee = yankee.rowSublabel;
            golf['style'] = yankee;
 ...
 421:
    ...
    zulu['UserProfileFormRow'] = tango;
    mike = function(argFoo) { // Original name: UserProfileCardRows
        entity = argFoo;
 ...
 0:
                ...
                golf = 0;
                oscar = null;
                if(!(golf !== report)) { _fun77764_ip = 47; continue _fun77764 }
 29:
                verify = _closure1_slot6;
                options = _closure1_slot10;
                golf = undefined;
                entity = {};
                oscar = verify.bind(golf)(options, entity);
 47:
                entity = new Array(2);
                entity[0] = oscar;
                oscar = argFoo;
