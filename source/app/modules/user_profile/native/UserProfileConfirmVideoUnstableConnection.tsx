...
export default (function(argFoo, argBar, _, argCorge, __, argFred, argPlugh) {
    ...
    tango = 'modules/user_profile/native/UserProfileConfirmVideoUnstableConnection.tsx';
    tango = report.bind(oscar)(tango);
    mike = function(argFoo) { // Original name: UserProfileConfirmVideoUnstableConnection
        entity = argFoo;
