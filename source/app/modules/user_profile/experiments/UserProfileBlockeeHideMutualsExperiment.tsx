...
export default (function(argFoo, argBar, _, __, ___, argFred, argPlugh) {
    ...
    tango = {'kind': 'user', 'id': '2024-08_user_profile_blockee_hide_mutuals', 'label': 'User Profile Blockee Hide Mutuals'};
    report = {};
    offset = false;
 ...
 0:
            ...
            mike = undefined;
            if(!(report === mike)) { _fun80062_ip = 22; continue _fun80062 }
 20:
            report = true;
 22:
 ...
 0:
            ...
            report = mike.autoTrackExposure;
            mike = undefined;
            if(!(report === mike)) { _fun80063_ip = 22; continue _fun80063 }
 20:
            report = true;
 22:
            tango = _closure1_slot0;
    ...
    zulu['useIsEligibleForUserProfileBlockeeHideMutuals'] = mike;
    return entity;
})();