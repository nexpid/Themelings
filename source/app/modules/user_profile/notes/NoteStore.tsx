...
export default (function(argFoo, argBar, argBaz, _, __, argFre, argPlu) {
 ...
 105:
    ...
    golfie['OVERLAY_INITIALIZE'] = verify;
    ...
    golfie['USER_NOTE_UPDATE'] = verify;
    tangon = function(argFoo, argBar) { // Original name: USER_NOTE_LOAD_START
        report = argBar;
        tangon = report.set;
        entity = argFoo;
    ...
    golfie['USER_NOTE_LOAD_START'] = tangon;
    michal = oscard[michal];
    michal = report.bind(entity)(michal);
