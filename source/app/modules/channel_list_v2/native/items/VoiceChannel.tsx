...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
                    ...
                    if(mike) { _fun115753_ip = 210; continue _fun115753 }
 13:
                    mike = verify.getGuildId;
                    report = mike.bind(verify)();
                    mike = null;
                    if(!(mike != report)) { _fun115753_ip = 68; continue _fun115753 }
 29:
                    ...
                    if(zulu) { _fun115753_ip = 145; continue _fun115753 }
 68:
                    ...
                    golf = zulu[golf];
                    zulu = zulu.paths;
                    zulu = options.bind(oscar)(golf, zulu);
                    SaveGenerator(address=115);
 113:
                    return zulu;
 115:
                    ResumeGenerator(result_out_reg=2, return_bool_out_reg=6);
                    if(golf) { _fun115753_ip = 142; continue _fun115753 }
 121:
                    options = zulu.openGuildVoiceModal;
                    golf = 'Channel List';
 ...
 187:
                    ...
                    if(zulu) { _fun115753_ip = 207; continue _fun115753 }
 193:
 ...
 210:
    ...
    tango = golf.bind(entity)(tango);
    backup = tango.CHANNEL_MARGIN_VERTICAL;
    tango = 9;
    tango = options[tango];
    tango = golf.bind(entity)(tango);
    ...
    oscar = {};
    tango = {'flexDirection': 'row', 'alignItems': 'center', 'gap': null, 'maxHeight': 1};
    yankee = 11;
    ...
    offset = offset.PX_8;
    tango['gap'] = offset;
    oscar['channelInfo'] = tango;
    tango = -4;
    offset = {'marginLeft': 36, 'marginTop': 4294967292, 'marginBottom': 2};
    oscar['voiceStates'] = offset;
    offset = {};
    kilo = 16;
    offset['marginLeft'] = kilo;
    oscar['voiceStatesCollapsed'] = offset;
    offset = {};
 ...
 0:
            ...
            foxtrot = entity.collapsed;
            oscar = entity.voiceStates;
            zulu = entity.subtitle;
            tango = undefined;
            ...
            mike = report.useEnsureSyncedChannelVoiceStates;
            entity = yankee.id;
            backup = mike.bind(report)(entity, oscar);
            entity = backup.length;
            report = null;
            mike = report != entity;
            golf = 0;
            echo = 0;
            if(!mike) { _fun115754_ip = 139; continue _fun115754 }
 136:
            echo = entity;
 139:
            mike = _closure1_slot0;
            ...
            kilo = update.useStateFromStoresObject;
            ...
            entity = function() {
                ...
                entity['resolvedUnreadSetting'] = mike;
                return entity;
            };
            entity = kilo.bind(update)(romeo, entity, offset);
            kilo = entity.hasUnread;
            update = entity.mentionCount;
            romeo = entity.resolvedUnreadSetting;
            entity = 20;
            entity = oscar[entity];
            mike = mike.bind(tango)(entity);
            entity = mike.getChannelSubtitleData;
            mike = entity.bind(mike)(zulu);
            entity = report == zulu;
            offset = undefined;
            if(entity) { _fun115754_ip = 285; continue _fun115754 }
 280:
            offset = zulu.type;
 285:
            oscar = 'voice';
            entity = null;
            if(!(oscar === offset)) { _fun115754_ip = 319; continue _fun115754 }
 295:
            oscar = zulu.text;
            oscar = oscar.length;
            oscar = oscar > golf;
            entity = null;
            if(!oscar) { _fun115754_ip = 319; continue _fun115754 }
 314:
            entity = zulu.text;
 319:
            ...
            zulu = report != entity;
            offset = null;
            if(!zulu) { _fun115754_ip = 378; continue _fun115754 }
 332:
            oscar = _closure1_slot1;
            control = _closure1_slot2;
            zulu = 21;
            zulu = control[zulu];
            vacuum = oscar.bind(tango)(zulu);
            control = vacuum.parseVoiceChannelStatus;
            oscar = {};
            zulu = yankee.id;
            oscar['channelId'] = zulu;
            zulu = true;
            offset = control.bind(vacuum)(entity, zulu, oscar);
 378:
            oscar = _closure1_slot1;
            control = _closure1_slot2;
            zulu = 22;
            ...
            zulu['channel'] = yankee;
            zulu['unread'] = kilo;
            zulu['mentionCount'] = update;
            zulu['userCount'] = echo;
            echo = oscar.bind(tango)(zulu);
            update = _closure1_slot4;
            oscar = update.useEffect;
            control = yankee.id;
            zulu = new Array(3);
            zulu[0] = control;
            control = yankee.guild_id;
            zulu[1] = control;
            zulu[2] = entity;
            entity = function() {
 ...
 0:
                    ...
                    entity = null;
                    if(!(entity !== mike)) { _fun115756_ip = 83; continue _fun115756 }
 13:
                    ...
                    mike = entity.VOICE_CHANNEL_TOPIC_VIEWED;
                    entity = {};
 ...
 83:
            ...
            entity = oscar.bind(update)(entity, zulu);
            if(!(report == offset)) { _fun115754_ip = 494; continue _fun115754 }
 476:
            zulu = report == mike;
            entity = undefined;
            if(zulu) { _fun115754_ip = 491; continue _fun115754 }
 485:
            entity = mike.subtitle;
 491:
            offset = entity;
 494:
            ...
            entity['isChannelCollapsed'] = foxtrot;
            ...
            control = function() { // Original name: onPress
                ...
                mike = function() { // Original name: handleVoiceChannelPress
                    entity = undefined;
            ...
            if(!kilo) { _fun115754_ip = 644; continue _fun115754 }
 641:
            kilo = sizing;
 644:
            entity['unread'] = kilo;
            entity['resolvedUnreadSetting'] = romeo;
            entity['subtitle'] = offset;
            options = report != options;
            entity['isChannelLive'] = options;
            entity['channelInfo'] = oscar;
            oscar = backup.length;
            report = null;
            if(!(golf !== oscar)) { _fun115754_ip = 933; continue _fun115754 }
 687:
            if(foxtrot) { _fun115754_ip = 771; continue _fun115754 }
 690:
 ...
 771:
            ...
            golf = options.computeSummarizedVoiceUsers;
            oscar = {'channels': null, 'selectedChannelId': null, 'selectedVoiceChannelId': null};
            offset = new Array(1);
            offset[0] = yankee;
            oscar['channels'] = offset;
            offset = {};
            romeo = yankee.id;
            offset[romeo] = backup;
            oscar['voiceStates'] = offset;
 ...
 0:
            ...
            entity = function() {
                ...
                report = tango.CONNECT;
                mike = _closure2_slot0;
                report = golf.bind(oscar)(report, mike);
                report = !report;
                entity['locked'] = report;
                report = oscar.can;
                tango = tango.MOVE_MEMBERS;
                tango = report.bind(oscar)(tango, mike);
                entity['bypassLimit'] = tango;
            ...
            golf = entity.locked;
            oscar = entity.bypassLimit;
            romeo = entity.collapsed;
            zulu = _closure1_slot13;
            mike = _closure1_slot15;
            entity = {};
            entity['channel'] = verify;
            entity['collapsed'] = romeo;
            verify = verify.id;
            verify = yankee[verify];
            yankee = null;
            if(!(yankee == verify)) { _fun115760_ip = 172; continue _fun115760 }
 168:
 ...
 172:
    ...
    oscar = 'modules/channel_list_v2/native/items/VoiceChannel.tsx';
    oscar = golf.bind(options)(oscar);
    zulu['default'] = report;
    zulu['VOICE_USERS_MARGIN_TOP'] = tango;
    zulu['VOICE_USERS_MARGIN_BOTTOM'] = mike;
    return entity;
})();