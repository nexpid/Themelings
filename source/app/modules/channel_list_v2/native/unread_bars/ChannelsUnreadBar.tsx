...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
            ...
            golf = 9;
            report = 5;
            if(!tango) { _fun115539_ip = 34; continue _fun115539 }
 31:
            report = 6;
 34:
            ...
            verify = romeo.bind(oscar)(verify);
            if(tango) { _fun115539_ip = 131; continue _fun115539 }
 104:
            romeo = verify.colors;
            tango = argBar;
            if(tango) { _fun115539_ip = 123; continue _fun115539 }
 115:
            tango = romeo.BG_SURFACE_OVERLAY;
            _fun115539_ip = 129; continue _fun115539;
 123:
            tango = romeo.ACTION_SHEET_GRADIENT_BG;
 129:
            _fun115539_ip = 142; continue _fun115539;
 131:
 ...
 142:
            ...
            zulu = 0;
            if(!tango) { _fun115539_ip = 298; continue _fun115539 }
 292:
            zulu = -1;
 298:
            mike['marginTop'] = zulu;
 ...
 0:
            ...
            if(!options) { _fun115540_ip = 155; continue _fun115540 }
 152:
            options = report;
 155:
 ...
 0:
                    ...
                    mike = null;
                    if(!(mike != zulu)) { _fun115541_ip = 28; continue _fun115541 }
 13:
 ...
 0:
                    ...
                    report = entity.width;
                    entity = 0;
                    if(!(entity !== report)) { _fun115542_ip = 42; continue _fun115542 }
 25:
 ...
 42:
                    ...
                    mike = mike.layout;
                    zulu = mike.height;
                    if(!(entity !== zulu)) { _fun115542_ip = 79; continue _fun115542 }
 62:
 ...
 0:
                    ...
                    if(!entity) { _fun115543_ip = 76; continue _fun115543 }
 10:
 ...
 0:
                    ...
                    entity = 'bottom';
                    if(!(entity !== zulu)) { _fun115547_ip = 27; continue _fun115547 }
 15:
                    entity = {};
                    mike = _closure2_slot8;
                    entity['top'] = mike;
                    _fun115547_ip = 38; continue _fun115547;
 27:
                    mike = {};
                    zulu = 0;
                    mike['bottom'] = zulu;
 ...
 0:
                    ...
                    mike = null;
                    if(!(mike != zulu)) { _fun115548_ip = 26; continue _fun115548 }
 13:
 ...
 0:
                    entity = _closure2_slot1;
                    if(!entity) { _fun115551_ip = 90; continue _fun115551 }
 10:
                    zulu = _closure2_slot0;
                    mike = 'top';
                    if(!(mike !== zulu)) { _fun115551_ip = 31; continue _fun115551 }
 22:
                    mike = _closure2_slot15;
                    mike = !mike;
                    _fun115551_ip = 87; continue _fun115551;
 31:
                    zulu = _closure2_slot5;
                    report = null;
                    zulu = report != zulu;
                    if(!zulu) { _fun115551_ip = 52; continue _fun115551 }
 44:
                    tango = _closure2_slot6;
                    zulu = report != tango;
 52:
                    if(!zulu) { _fun115551_ip = 84; continue _fun115551 }
 55:
 ...
 90:
                    mike = _closure2_slot15;
                    if(!mike) { _fun115551_ip = 140; continue _fun115551 }
 97:
 ...
 140:
                    ...
                    report = _closure2_slot0;
                    zulu = 'bottom';
                    if(entity) { _fun115551_ip = 190; continue _fun115551 }
 171:
                    mike = -1;
                    if(!(zulu === report)) { _fun115551_ip = 184; continue _fun115551 }
 181:
                    mike = 1;
 184:
                    foxtrot = tango * mike;
                    _fun115551_ip = 230; continue _fun115551;
 190:
                    mike = 0;
                    if(!(zulu === report)) { _fun115551_ip = 227; continue _fun115551 }
 196:
                    report = _closure2_slot4;
                    zulu = null;
                    zulu = zulu != report;
                    mike = 0;
                    if(!zulu) { _fun115551_ip = 227; continue _fun115551 }
 211:
 ...
 230:
                    mike = 0;
                    backup = 0;
                    if(!entity) { _fun115551_ip = 240; continue _fun115551 }
 237:
                    backup = 1;
 240:
                    ...
                    entity = entity > mike;
                    report = 1;
                    if(!entity) { _fun115551_ip = 300; continue _fun115551 }
 263:
 ...
 300:
            ...
            if(yankee) { _fun115540_ip = 971; continue _fun115540 }
 907:
            entity = 'bottom';
            if(!(entity !== mike)) { _fun115540_ip = 943; continue _fun115540 }
 915:
            ...
            _fun115540_ip = 969; continue _fun115540;
 943:
            mike = _closure1_slot0;
            oscar = _closure1_slot2;
            entity = 17;
 ...
 969:
            _fun115540_ip = 997; continue _fun115540;
 971:
            mike = _closure1_slot0;
            oscar = _closure1_slot2;
            entity = 16;
 ...
 997:
            ...
            if(yankee) { _fun115540_ip = 1036; continue _fun115540 }
 1023:
            oscar = backup.colors;
            oscar = oscar.TEXT_BRAND;
            _fun115540_ip = 1047; continue _fun115540;
 1036:
 ...
 1047:
            ...
            entity['style'] = backup;
            backup = 'none';
            if(!kilo) { _fun115540_ip = 1112; continue _fun115540 }
 1108:
            backup = 'auto';
 1112:
            ...
            offset = 'text-brand';
            if(!yankee) { _fun115540_ip = 1217; continue _fun115540 }
 1211:
            offset = 'always-white';
 1217:
            oscar['color'] = offset;
