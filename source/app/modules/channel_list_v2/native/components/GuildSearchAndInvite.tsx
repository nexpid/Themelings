...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
                    ...
                    golf = 'secondary';
                    if(!options) { _fun113503_ip = 69; continue _fun113503 }
 63:
                    golf = 'tertiary';
 69:
                    entity['variant'] = golf;
 ...
 0:
                    ...
                    entity = null;
                    if(!mike) { _fun113504_ip = 199; continue _fun113504 }
 15:
                    ...
                    options = 'secondary';
                    if(!verify) { _fun113504_ip = 69; continue _fun113504 }
 63:
                    options = 'tertiary';
 69:
 ...
 0:
                    ...
                    entity = null;
                    if(!mike) { _fun113505_ip = 251; continue _fun113505 }
 15:
                    ...
                    offset = 'secondary';
                    if(!romeo) { _fun113505_ip = 79; continue _fun113505 }
 73:
                    offset = 'tertiary';
 79:
                    ...
                    if(!golf) { _fun113505_ip = 237; continue _fun113505 }
 207:
 ...
 251:
            ...
            report['style'] = oscar;
            if(entity) { _fun113501_ip = 680; continue _fun113501 }
 404:
            ...
            entity[0] = oscar;
            oscar = null;
            if(!offset) { _fun113501_ip = 667; continue _fun113501 }
 531:
 ...
 667:
            ...
            entity = report;
            _fun113501_ip = 703; continue _fun113501;
 680:
            oscar = new Array(3);
            oscar[0] = verify;
            oscar[1] = options;
 ...
 0:
            ...
            tango = 10;
            golf = argFoo;
            if(!golf) { _fun113506_ip = 97; continue _fun113506 }
 69:
            options = _closure1_slot1;
 ...
 0:
            ...
            tango = undefined;
            if(!(report === tango)) { _fun113507_ip = 28; continue _fun113507 }
 26:
            report = false;
 28:
            oscar = entity.useEventsButton;
            if(!(oscar === tango)) { _fun113507_ip = 40; continue _fun113507 }
 38:
            oscar = false;
 40:
            golf = _closure1_slot0;
            ...
            if(!oscar) { _fun113507_ip = 267; continue _fun113507 }
 264:
            oscar = golf;
 267:
