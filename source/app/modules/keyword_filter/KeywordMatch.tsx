...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
            ...
            entity = argCorge;
            if(!(entity !== zulu)) { _fun00004_ip = 108; continue _fun00003 }
 29:
            zulu = options - oscar;
 ...
 0:
            ...
            entity = argCorge;
            if(!(entity !== mike)) { _fun00006_ip = 171; continue _fun00005 }
 32:
            entity = report.length;
            golf = 1;
            entity = entity - golf;
            mike = oscar;
            if(!(oscar < entity)) { _fun00006_ip = 138; continue _fun00005 }
 51:
            zulu = _closure1_slot1;
