...
export default (function(_, argBar, __, ___, ____, argFred, argPlugh) {
    ...
    mike = {'kind': 'user', 'id': '2024-11_expression_suggestions_disabled', 'label': 'Expression Suggestions Disabled Experiment'};
    verify = {};
    yankee = false;
    ...
    tango = 'modules/expression_suggestions/ExpressionSuggestionsDisabledExperiment.tsx';
    tango = report.bind(oscar)(tango);
    zulu['ExpressionSuggestionsDisabledExperiment'] = mike;
    return entity;
})();