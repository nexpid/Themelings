...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
 ...
 0:
            ...
            if(entity) { _fun93767_ip = 51; continue _fun93767 }
 38:
            entity = verify.apply;
            entity = entity.bind(verify)(tango, oscar);
            _fun93767_ip = 92; continue _fun93767;
 51:
            golf = global;
            options = golf.Reflect;
            golf = options.construct;
            if(oscar) { _fun93767_ip = 71; continue _fun93767 }
 67:
            oscar = new Array(0);
 71:
 ...
 72: // try_end0
            _fun93768_ip = 76; continue _fun93768;
 74: // catch_target0
 ...
 0:
                    ...
                    entity = undefined;
                    options = undefined;
                    if(!tango) { _fun93773_ip = 56; continue _fun93773 }
 43:
                    report = mike.features;
                    tango = oscar != report;
                    options = report;
 56:
                    if(!tango) { _fun93773_ip = 79; continue _fun93773 }
 59:
                    golf = options.has;
 ...
 79:
                    if(!tango) { _fun93773_ip = 149; continue _fun93773 }
 82:
                    report = _closure3_slot0;
                    report = report.onClose;
                    if(!(oscar != report)) { _fun93773_ip = 113; continue _fun93773 }
 99:
                    report = _closure3_slot0;
