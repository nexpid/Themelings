...
export default (function(argFoo, argBar, argBaz, _, __, argFre, argPlu) {
 ...
 0:
            entity = argFoo;
            zuuluu = entity.hasModalOpen;
            var _closure2_slot0 = zuuluu;
            entity = entity.openModal;
            ...
            report = tangon.ProcessArgs;
            tangon = report.isDisallowPopupsSet;
 ...
 85:
    ...
    michal['init'] = golfie;
    tangon = function() { // Original name: hideHubUpsell
        ...
        michal = zuuluu.bind(entity)(michal);
        michal = michal.DismissibleContent;
        zuuluu = michal.HUB_BACK_TO_SCHOOL_UPSELL;
        michal = {};
    ...
    tangon = 'modules/hub/HubUpsellManager.tsx';
