...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
    ...
    tangon = function(argFoo) { // Original name: presentResendToast
    ...
    tangon = 'modules/hub/native/components/HubEmailConnectionPinVerify.tsx';
    tangon = report.bind(oscard)(tangon);
    michal = function(argFoo) { // Original name: HubEmailConnectionPinVerify
 ...
 16: // try_start_0
                        ...
                        zuuluu = true;
                        zuuluu = verify.bind(offset)(golfie, zuuluu, oscard);
                        SaveGenerator(address=69);
 67:
                        return zuuluu;
 69:
                        ResumeGenerator(result_out_reg=2, return_bool_out_reg=5);
                        if(oscard) { _fun00004_ip = 146; continue _fun00003 }
 75:
 ...
 234:
                        report = oscard;
                        if(!(golfie == oscard)) { _fun00004_ip = 300; continue _fun00003 }
 241:
 ...
 311:
            ...
            michal = 1000;
            config = oscard.bind(golfie)(report, michal);
 ...
 77:
                            ...
                            tangon = option;
                            golfie = null;
                            if(!(golfie != option)) { _fun00006_ip = 151; continue _fun00005 }
 104:
 ...
 225:
            ...
            yankee = output.bind(tangon)(yankee);
            romeon = yankee.CodeBlocks;
            yankee = {'hasError': false, 'count': 8};
            yankee['onCodeEntered'] = echoed;
            sizing = result[sizing];
            sizing = output.bind(tangon)(sizing);
            ...
            if(!verify) { _fun00002_ip = 728; continue _fun00001 }
 659:
