// app/modules/hub/native/components/HubEmailConnectionPinVerify.tsx
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    verify = {'textAlign': 'center', 'marginBottom': 12};
    tango['label'] = verify;
    verify = {'alignSelf': 'center', 'marginVertical': 8};
    tango['error'] = verify;
    tango = golf.bind(options)(tango);
    var _closure1_slot11 = tango;
    tango = function(argFoo) { // Original name: presentResendToast
    ...
    tango = 'modules/hub/native/components/HubEmailConnectionPinVerify.tsx';
    tango = report.bind(oscar)(tango);
    mike = function(argFoo) { // Original name: HubEmailConnectionPinVerify
 ...
 0:
                        ...
                        if(mike) { _fun93761_ip = 307; continue _fun93761 }
 10:
                        mike = undefined;
                        report = undefined;
                        options = undefined;
 16: // try_start_0
                        ...
                        verify = offset.sendVerificationEmail;
                        golf = _closure2_slot0;
                        oscar = _closure2_slot1;
                        zulu = true;
                        zulu = verify.bind(offset)(golf, zulu, oscar);
                        SaveGenerator(address=69);
 67:
                        return zulu;
 69:
                        ResumeGenerator(result_out_reg=2, return_bool_out_reg=5);
                        if(oscar) { _fun93761_ip = 144; continue _fun93761 }
 75:
 ...
 139: // try_end0
                        _fun93761_ip = 304; continue _fun93761;
 144:
                        return zulu;
 147: // catch_target0
                        ...
                        verify = golf == oscar;
                        oscar = undefined;
                        if(verify) { _fun93761_ip = 232; continue _fun93761 }
 219:
                        verify = options;
 ...
 232:
                        report = oscar;
                        if(!(golf == oscar)) { _fun93761_ip = 296; continue _fun93761 }
 239:
                        ...
                        _fun93761_ip = 299; continue _fun93761;
 296:
                        zulu = report;
 299:
 ...
 307:
            ...
            mike = 1000;
            config = oscar.bind(golf)(report, mike);
            mike = zulu.useState;
            verify = null;
 ...
 0:
                            StartGenerator();
                            ResumeGenerator(result_out_reg=0, return_bool_out_reg=1);
                            if(mike) { _fun93764_ip = 225; continue _fun93764 }
 10:
                            zulu = argFoo;
                            mike = undefined;
                            tango = undefined;
 ...
 71:
                            ...
                            if(golf) { _fun93764_ip = 153; continue _fun93764 }
 77:
                            ...
                            tango = options;
                            golf = null;
                            if(!(golf != options)) { _fun93764_ip = 151; continue _fun93764 }
 104:
                            ...
                            tango = report.bind(oscar)(tango);
 151: // try_end0
                            _fun93764_ip = 222; continue _fun93764;
 153:
                            return zulu;
 156: // catch_target0
 ...
 225:
            ...
            update = output.bind(tango)(update);
            update = update.t;
            source = update.b+W0oq;
            update = {};
            update['onClick'] = config;
            ...
            yankee = output.bind(tango)(yankee);
            romeo = yankee.Text;
            yankee = {'style': null, 'variant': 'text-sm/semibold', 'color': 'text-muted'};
            update = foxtrot.label;
            yankee['style'] = update;
            update = result[sizing];
            update = output.bind(tango)(update);
            source = update.intl;
            ...
            yankee = output.bind(tango)(yankee);
            romeo = yankee.CodeBlocks;
            yankee = {'hasError': false, 'count': 8};
            yankee['onCodeEntered'] = echo;
            sizing = result[sizing];
            sizing = output.bind(tango)(sizing);
            sizing = sizing.CodeType;
            sizing = sizing.ALPHANUMERIC;
            yankee['codeType'] = sizing;
            yankee = zulu.bind(tango)(romeo, yankee);
            options[4] = yankee;
            verify = verify != backup;
            if(!verify) { _fun93756_ip = 726; continue _fun93756 }
 657:
            ...
            yankee = offset.Text;
            offset = {'variant': 'text-sm/medium', 'color': 'text-danger'};
