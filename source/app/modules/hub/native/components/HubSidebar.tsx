...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
    ...
    tangon = oscard[tangon];
    tangon = report.bind(entity)(tangon);
    tangon = tangon.GUILD_EVENTS_LIST_ACTION_SHEET_KEY;
    ...
    tangon = function(argFoo) { // Original name: HubItem
        _fun00001: for(var _fun00002_ip = 0; ; ) switch(_fun00002_ip) {
 0:
            entity = argFoo;
            option = entity.IconComponent;
            backup = entity.label;
            golfie = entity.handleItemClick;
            ...
            if(michal) { _fun00002_ip = 82; continue _fun00001 }
 74:
 ...
 88:
            ...
            golfie = true;
            entity['disableHighlightOnPress'] = golfie;
            entity['mode'] = offset;
            golfie = _closure1_slot0;
            romeon = report[yankee];
            romeon = golfie.bind(tangon)(romeon);
            foxtra = romeon.BaseChannelName;
            romeon = {};
            romeon['name'] = backup;
            romeon['mode'] = offset;
            ...
            golfie = report.BaseChannelIcon;
            report = {};
            report['mode'] = offset;
            report['IconComponent'] = option;
 ...
 269:
    ...
    tangon = function(argFoo) { // Original name: EventHubItem
 ...
 0:
            ...
            michal = entity.showHubEventsList;
            zuuluu = _closure1_slot0;
            entity = 12;
            entity = tangon[entity];
 ...
 53:
                    ...
                    if(!(zuuluu == michal)) { _fun00006_ip = 66; continue _fun00005 }
 62:
                    michal = new Array(0);
 66:
 ...
 71:
            ...
            offset = tangon.bind(golfie)(zuuluu, entity);
            entity = 0;
 ...
 230:
            ...
            verify = tangon.intl;
            tangon = verify.formatToPlainString;
            entity = yankee[entity];
            entity = zuuluu.bind(report)(entity);
            entity = entity.t;
            zuuluu = entity.IBdqSk;
            entity = {};
            entity['number'] = offset;
            golfie = tangon.bind(verify)(zuuluu, entity);
 293:
            entity = null;
            if(!michal) { _fun00004_ip = 361; continue _fun00003 }
 298:
            ...
            option = option.CalendarIcon;
            michal['IconComponent'] = option;
            michal['label'] = golfie;
            oscard = function() { // Original name: handleItemClick
                ...
                report = oscard.fetchDirectoryEntries;
 ...
 361:
    ...
    tangon = 'modules/hub/native/components/HubSidebar.tsx';
    tangon = report.bind(oscard)(tangon);
 ...
 0:
            ...
            backup = romeon.bind(foxtra)(verify, oscard, golfie);
            ...
            tangon = verify.bind(romeon)(oscard, tangon);
 ...
 46:
            ...
            foxtra = oscard.bind(verify)(tangon, entity);
            entity = 13;
            entity = zuuluu[entity];
            michal = michal.bind(report)(entity);
            entity = michal.useHubUnreadCount;
            romeon = entity.bind(michal)(backup);
            oscard = null;
            michal = oscard == backup;
            entity = null;
            if(michal) { _fun00008_ip = 628; continue _fun00007 }
 217:
 ...
 238:
            ...
            foxtra = backup.bind(report)(foxtra);
            foxtra = foxtra.t;
            foxtra = foxtra.K50GHR;
            foxtra = sizing.bind(output)(foxtra);
            golfie['label'] = foxtra;
            foxtra = function() { // Original name: handleItemClick
                zuuluu = _closure1_slot0;
                michal = _closure1_slot3;
                entity = 17;
                michal = michal[entity];
            ...
            golfie['handleItemClick'] = foxtra;
            golfie['unreadCount'] = romeon;
            golfie = verify.bind(report)(option, golfie);
            oscard[2] = golfie;
            golfie = {};
            romeon = 18;
            ...
            romeon = backup.bind(report)(romeon);
            romeon = romeon.t;
            romeon = romeon.emRpdX;
            romeon = foxtra.bind(sizing)(romeon);
            golfie['label'] = romeon;
            romeon = function() { // Original name: handleItemClick
                zuuluu = _closure1_slot1;
                michal = _closure1_slot3;
                entity = 19;
                michal = michal[entity];
