// app/modules/go_live/native/ApplicationStreamingManager.tsx
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    mike = oscar[mike];
    mike = report.bind(entity)(mike);
    mike = mike.ApplicationStreamPresets;
    var _closure1_slot9 = mike;
    mike = 8;
    mike = oscar[mike];
    mike = report.bind(entity)(mike);
    verify = mike.ApplicationStreamDeleteReasons;
    var _closure1_slot10 = verify;
    verify = mike.Endpoints;
    var _closure1_slot11 = verify;
    mike = mike.Base64JPEGPrefix;
    var _closure1_slot12 = mike;
    mike = 9;
    mike = oscar[mike];
    mike = report.bind(entity)(mike);
    mike = mike.getAppIntentScheme;
    ...
    romeo = 'ApplicationStreamingManager';
    foxtrot = golf;
 ...
 0:
                    ...
                    if(oscar) { _fun75384_ip = 376; continue _fun75384 }
 18:
                    options = tango;
                    ...
                    golf = oscar.DisableStreamPreviews;
                    oscar = golf.getSetting;
                    oscar = oscar.bind(golf)();
                    golf = 15;
                    golf = yankee[golf];
                    yankee = offset.bind(mike)(golf);
                    offset = yankee.getSecureFramesUIExperiment;
                    golf = {};
                    romeo = 'handleThumbnailUpload';
                    golf['location'] = romeo;
                    golf = offset.bind(yankee)(golf);
                    golf = golf.enabled;
                    if(!golf) { _fun75384_ip = 124; continue _fun75384 }
 118:
                    if(oscar) { _fun75384_ip = 373; continue _fun75384 }
 124:
                    ...
                    oscar = report.concat;
                    report = '';
                    offset = oscar.bind(report)(offset, golf);
                    verify = offset;
                    ...
                    oscar = golf.dispatch;
                    report = {};
                    yankee = 'STREAM_PREVIEW_FETCH_SUCCESS';
                    report['type'] = yankee;
                    yankee = options;
                    report['streamKey'] = yankee;
                    report['previewURL'] = offset;
 ...
 226: // try_start_0
                    ...
                    offset = yankee.STREAM_PREVIEW;
                    options = offset.bind(yankee)(options);
                    report['url'] = options;
                    options = {};
                    options['thumbnail'] = verify;
                    report['body'] = options;
                    options = true;
 ...
 311:
                    ...
                    if(oscar) { _fun75384_ip = 319; continue _fun75384 }
 317: // try_end0
                    _fun75384_ip = 373; continue _fun75384;
 319:
                    return report;
 322: // catch_target0
                    ...
                    oscar = golf.error;
                    report = 'Failed to post stream preview';
 ...
 376:
    ...
    golf = function() { // Original name: init
        ...
        oscar = golf.setBroadcastRequestCallback;
        zulu = function() {
            _fun75388: for(var _fun75388_ip = 0; ; ) switch(_fun75388_ip) {
 0:
                report = _closure1_slot16;
                tango = report.log;
                mike = 'Broadcast Requested';
                ...
                mike = tango.getCurrentAppIntent;
                report = mike.bind(tango)();
                mike = null;
                if(!(mike == oscar)) { _fun75388_ip = 122; continue _fun75388 }
 84:
                verify = _closure2_slot0;
                options = verify.stopBroadcastWithError;
                golf = -1;
                tango = 'Not currently in a voice channel';
                tango = options.bind(verify)(golf, tango);
                _fun75388_ip = 351; continue _fun75388;
 122:
                ...
                verify = offset.startStream;
                options = oscar.id;
                golf = {};
                romeo = 'screen:0';
                golf['sourceId'] = romeo;
                golf = verify.bind(offset)(yankee, options, golf);
                options = _closure1_slot5;
                golf = options.getCurrentUserActiveStream;
                yankee = golf.bind(options)();
                var _closure3_slot0 = yankee;
                if(!(mike != yankee)) { _fun75388_ip = 351; continue _fun75388 }
 210:
                ...
                options = verify.selectParticipant;
                golf = oscar.id;
                offset = _closure1_slot0;
                oscar = 22;
                oscar = romeo[oscar];
                offset = offset.bind(tango)(oscar);
                oscar = offset.encodeStreamKey;
                oscar = oscar.bind(offset)(yankee);
                oscar = options.bind(verify)(golf, oscar);
                oscar = _closure2_slot0;
                golf = oscar.platform;
                oscar = 'android';
                if(!(oscar === golf)) { _fun75388_ip = 323; continue _fun75388 }
 295:
                ...
                zulu = function() {
                    ...
                    oscar = _closure2_slot0;
                    report = oscar.setBroadcastThumbnailCallback;
                    offset = zulu * entity;
                    verify = mike * entity;
                    options = 300;
                    golf = function(argFoo) {
                        ...
                        report = oscar.log;
                        zulu = tango.length;
                        entity = 'Broadcast thumbnail of size:';
 ...
 323:
                if(!(mike != report)) { _fun75388_ip = 351; continue _fun75388 }
 327:
 ...
 351:
        ...
        oscar = golf.setBroadcastFinishedCallback;
        zulu = function() {
            tango = _closure1_slot16;
            zulu = tango.log;
            mike = 'Broadcast Finished';
            ...
            mike = zulu.handleCloseScreenshare;
            mike = mike.bind(zulu)();
            return entity;
        };
        zulu = oscar.bind(golf)(zulu);
        oscar = golf.setBroadcastAnnotatedCallback;
 ...
 0:
                ...
                report = _closure1_slot16;
                tango = report.log;
                mike = 'Broadcast Annotated:';
                mike = tango.bind(report)(mike, zulu);
                mike = 'com.hammerandchisel.discord';
                if(!(mike !== zulu)) { _fun75392_ip = 98; continue _fun75392 }
 38:
                ...
                mike = -1;
                if(!(oscar > mike)) { _fun75392_ip = 84; continue _fun75392 }
 65:
                report = _closure1_slot21;
                tango = report.splice;
                mike = 1;
 ...
 98:
        ...
        zulu = oscar.bind(golf)(zulu);
        oscar = golf.setBroadcastBlockedCallback;
        zulu = function() {
            zulu = _closure1_slot16;
            mike = zulu.log;
            entity = 'Broadcast Blocked';
            entity = mike.bind(zulu)(entity);
 ...
 0:
                    ...
                    if(!(zulu !== mike)) { _fun75395_ip = 108; continue _fun75395 }
 30:
                    ...
                    if(!(tango !== mike)) { _fun75395_ip = 108; continue _fun75395 }
 74:
 ...
 0:
                ...
                mike = mike.STREAM_FULL;
                if(!(zulu === mike)) { _fun75396_ip = 75; continue _fun75396 }
 26:
                zulu = _closure1_slot1;
                mike = _closure1_slot2;
                entity = 26;
 ...
 0:
                ...
                if(!(tango !== mike)) { _fun75400_ip = 73; continue _fun75400 }
 25:
                report = _closure2_slot0;
                tango = report.stopBroadcast;
                tango = tango.bind(report)();
                report = _closure1_slot5;
                tango = report.getAllActiveStreams;
 ...
 0:
                        ...
                        if(!(mike !== entity)) { _fun75401_ip = 81; continue _fun75401 }
 19:
                        zulu = _closure1_slot0;
                        report = _closure1_slot2;
                        entity = 22;
 ...
 0:
                ...
                entity = null;
                if(!(entity == oscar)) { _fun75402_ip = 63; continue _fun75402 }
 15:
                zulu = _closure1_slot16;
                mike = zulu.warn;
                entity = global;
                ...
                tango = 'invalid start_stream: both application + display modes were specified (source-id: ';
                entity = ')';
                entity = report.bind(tango)(oscar, entity);
                entity = mike.bind(zulu)(entity);
                _fun75402_ip = 169; continue _fun75402;
 63:
                zulu = _closure1_slot1;
                mike = _closure1_slot2;
                entity = 29;
                ...
                entity = {};
                report = {};
                report['sourceId'] = oscar;
                oscar = true;
                report['sound'] = oscar;
                entity['desktopSettings'] = report;
                report = {'preset': null, 'resolution': 720, 'frameRate': 30};
                oscar = _closure1_slot9;
                oscar = oscar.PRESET_CUSTOM;
                report['preset'] = oscar;
                entity['qualityOptions'] = report;
 ...
 169:
    ...
    mike['init'] = golf;
    tango = function() { // Original name: getApplicationNames
        entity = _closure1_slot21;
        return entity;
    };
    mike['getApplicationNames'] = tango;
    tango = 30;
    tango = oscar[tango];
    oscar = report.bind(entity)(tango);
    report = oscar.fileFinishedImporting;
    tango = 'modules/go_live/native/ApplicationStreamingManager.tsx';
