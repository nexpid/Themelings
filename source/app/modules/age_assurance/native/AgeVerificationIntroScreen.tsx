...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
    ...
    michal = function() { // Original name: GetStartedScreen
        ...
        ctrled = yankee.getStartedHeaderText;
        update['style'] = ctrled;
        ctrled = output[kiloes];
        ctrled = backup.bind(tangon)(ctrled);
        sequen = ctrled.intl;
        ...
        papara = sizing.bind(tangon)(cntext);
        cntext = papara.getArticleURL;
        record = _closure1_slot8;
        record = record.TIGGER_PAWTECT_UK_AND_AUS_ONLY_GET_STARTED;
        record = cntext.bind(papara)(record);
        ctrled['helpUrl'] = record;
        ...
        result = {};
        ctrled = function() { // Original name: onRequest
            zuuluu = _closure1_slot4;
            michal = zuuluu.openURL;
            entity = _closure1_slot9;
            entity = entity.APPEALS_LINK;
            entity = michal.bind(zuuluu)(entity);
            return entity;
        };
        result['onRequest'] = ctrled;
