...
export default (function(argFoo, argBar, argBaz, _, __, argFre, argPlu) {
    ...
    report = function(argFoo) { // Original name: markCompletedProgressSeen
        ...
        michal = function() {
            ...
            entity = {};
            tangon = 'GUILD_PROGRESS_COMPLETED_SEEN';
            entity['type'] = tangon;
    ...
    michal['markCompletedProgressSeen'] = report;
    ...
    tangon = 'modules/guild_progress/GuildProgressActionCreators.tsx';
