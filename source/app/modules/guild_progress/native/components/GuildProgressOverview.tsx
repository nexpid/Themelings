...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    mike = function(argFoo) { // Original name: GuildProgressOverviewView
        entity = argFoo;
        control = entity.titleStyle;
        golf = entity.onPress;
        report = entity.onLongPress;
        update = entity.title;
        echo = entity.subtitle;
    ...
    options['horizontal'] = yankee;
    yankee = {'fontSize': 16, 'lineHeight': 20, 'fontFamily': null, 'color': null, 'marginBottom': 2};
    ...
    yankee = {};
    yankee['lineHeight'] = report;
    options['step'] = yankee;
    yankee = {};
    romeo = 8;
    yankee['marginTop'] = romeo;
    options['progressBar'] = yankee;
    options = verify.bind(offset)(options);
    var _closure1_slot8 = options;
    report = golf[report];
    golf = oscar.bind(entity)(report);
    oscar = golf.fileFinishedImporting;
    report = 'modules/guild_progress/native/components/GuildProgressOverview.tsx';
    report = oscar.bind(golf)(report);
    tango = function(argFoo) { // Original name: GuildProgressOverview
        _fun114291: for(var _fun114291_ip = 0; ; ) switch(_fun114291_ip) {
 0:
            mike = argFoo;
            entity = mike.guild;
            var _closure2_slot0 = entity;
            offset = mike.titleStyle;
            zulu = mike.longPressDisabled;
            tango = undefined;
            if(!(zulu === tango)) { _fun114291_ip = 34; continue _fun114291 }
 32:
            zulu = false;
 34:
            var _closure2_slot1 = zulu;
            golf = mike.resume;
            if(!(golf === tango)) { _fun114291_ip = 50; continue _fun114291 }
 48:
            golf = false;
 50:
            ...
            report = mike.percentComplete;
            oscar = mike.subtitle;
            romeo = mike.completed;
 ...
 0:
                    ...
                    if(!mike) { _fun114292_ip = 55; continue _fun114292 }
 10:
 ...
 0:
                    ...
                    if(entity) { _fun114293_ip = 55; continue _fun114293 }
 10:
                    tango = _closure1_slot1;
                    zulu = _closure1_slot2;
                    entity = 7;
 ...
 0:
                    ...
                    if(entity) { _fun114294_ip = 139; continue _fun114294 }
 13:
                    ...
                    entity = {};
                    tango = 'GuildProgressOverviewLongPress';
                    entity['key'] = tango;
                    report = {};
                    tango = 9;
                    oscar = offset[tango];
 ...
 139:
            ...
            options = options.t;
            if(golf) { _fun114291_ip = 247; continue _fun114291 }
 234:
            golf = options.o3HK3d;
            golf = verify.bind(offset)(golf);
            _fun114291_ip = 258; continue _fun114291;
 247:
 ...
 258:
    ...
    zulu['default'] = tango;
    zulu['GuildProgressOverviewView'] = mike;
    return entity;
})();