...
export default (function(_, argBar, __, ___, ____, argFred, argPlugh) {
    ...
    mike = {'kind': 'user', 'id': '2024-08_js_watchdog', 'label': 'JS Watchdog Experiment'};
    tango = {};
    verify = false;
    ...
    tango = 'modules/js_watchdog/native/JSWatchdogExperiment.tsx';
    tango = report.bind(oscar)(tango);
    zulu['JSWatchdogExperiment'] = mike;
    return entity;
})();