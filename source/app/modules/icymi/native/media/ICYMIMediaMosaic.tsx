...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
 ...
 143:
    ...
    report = golfie[report];
    report = oscard.bind(entity)(report);
    option = report.AnalyticsObjectTypes;
    var _closure1_slot11 = option;
    option = report.AnalyticsObjects;
    var _closure1_slot12 = option;
    report = report.AnalyticsPages;
    ...
    report = {};
    option = 'function ICYMIMediaMosaicTsx1(){const{withTiming,imageFinishedLoading}=this.__closure;return{opacity:withTiming(imageFinishedLoading?0:1,{duration:150})};}';
    report['code'] = option;
    ...
    report = 'modules/icymi/native/media/ICYMIMediaMosaic.tsx';
    report = oscard.bind(golfie)(report);
    tangon = function(argFoo) { // Original name: ICYMIMediaMosaic
 ...
 0:
                        ...
                        verify = offset.ack;
                        michal = _closure2_slot0;
                        sizing = michal.channel_id;
                        oscard = {};
                        yankee = _closure1_slot13;
                        yankee = yankee.ICYMI;
                        oscard['page'] = yankee;
                        yankee = _closure1_slot12;
                        yankee = yankee.ACK_MEDIA_VIEWED;
                        oscard['object'] = yankee;
                        report = _closure1_slot11;
                        report = report.ACK_SEMI_AUTOMATIC;
                        oscard['objectType'] = report;
                        romeon = michal.id;
                        output = offset;
                        kiloes = oscard;
                        backup = true;
                        foxtra = true;
                        michal = output[verify](sizing, kiloes, backup, foxtra, romeon, yankee);
                        michal = new Array(0);
                        ...
                        oscard = undefined;
                        if(option) { _fun00032_ip = 208; continue _fun00031 }
 199:
 ...
 208:
                        ...
                        option = michal == oscard;
                        oscard = undefined;
                        if(option) { _fun00032_ip = 247; continue _fun00031 }
 238:
                        option = _closure2_slot3;
                        oscard = option.type;
 247:
                        ...
                        option = michal == oscard;
                        oscard = undefined;
                        if(option) { _fun00032_ip = 274; continue _fun00031 }
 265:
 ...
 274:
                        ...
                        michal = undefined;
                        if(!oscard) { _fun00032_ip = 305; continue _fun00031 }
 302:
                        michal = report;
 305:
