...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
            ...
            backup = mike.iconStyle;
            romeo = mike.textStyle;
            yankee = mike.maxFontSizeMultiplier;
            report = mike.hideIcon;
            tango = undefined;
            if(!(report === tango)) { _fun00002_ip = 43; continue _fun00001 }
 41:
            report = false;
 43:
            oscar = mike.hideText;
            if(!(oscar === tango)) { _fun00002_ip = 55; continue _fun00001 }
 53:
            oscar = false;
 55:
 ...
 64:
            ...
            foxtrot = verify.bind(foxtrot)(options, zulu);
            verify = foxtrot.with;
            options = {};
            zulu = mike.LISTENING;
            options['type'] = zulu;
            ...
            verify = verify.bind(foxtrot)(options, zulu);
            options = verify.with;
            zulu = {};
            mike = mike.COMPETING;
            zulu['type'] = mike;
