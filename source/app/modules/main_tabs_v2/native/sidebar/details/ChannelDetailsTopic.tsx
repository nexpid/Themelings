...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
 ...
 0:
            ...
            verify = update.bind(tangon)(zuuluu);
            report = verify.useDerivedStateFromSharedValue;
            zuuluu = function(argFoo) {
                entity = argFoo;
                return entity;
            };
            status = report.bind(verify)(golfie, zuuluu);
            ...
            michal = source[michal];
            report = update.bind(tangon)(michal);
            zuuluu = report.useDerivedStateFromSharedValue;
            michal = function(argFoo) {
                entity = argFoo;
                return entity;
            };
            target = zuuluu.bind(report)(verify, michal);
            michal = source[offset];
            zuuluu = update.bind(tangon)(michal);
            michal = zuuluu.useSharedValue;
            ...
            romeon = update.bind(tangon)(option);
 ...
 0:
                    ...
                    entity = null;
                    if(!(entity != zuuluu)) { _fun00004_ip = 106; continue _fun00003 }
 35:
                    if(!(entity != oscard)) { _fun00004_ip = 106; continue _fun00003 }
 39:
                    entity = {};
 ...
 50:
            ...
            foxtra['gradient'] = zuuluu;
            echoed = _closure1_slot8;
            foxtra['springChannelDetails'] = echoed;
            option['__closure'] = foxtra;
            foxtra = 13036700961746.0;
            option['__workletHash'] = foxtra;
            foxtra = _closure1_slot18;
            option['__initData'] = foxtra;
            update = yankee.bind(romeon)(option);
 ...
 63:
                    entity = tangon.HIDDEN;
                    _fun00008_ip = 77; continue _fun00007;
 71:
                    entity = tangon.VISIBLE;
 77:
                    entity = michal.bind(zuuluu)(entity);
                    entity = undefined;
                    return entity;
            ...
            vacuum = yankee.bind(romeon)(golfie, option);
            ...
            ctrled = option.bind(yankee)(report, golfie);
 ...
 62:
            ...
            source = golfie.bind(option)(zuuluu, report);
            golfie = _closure1_slot3;
 ...
 55:
            ...
            sierra = report.bind(golfie)(michal, zuuluu);
            golfie = _closure1_slot3;
            report = golfie.useMemo;
            michal = oscard.id;
            zuuluu = new Array(2);
            ...
            cntext = report.bind(golfie)(michal, zuuluu);
            ...
            entity = null;
            if(!(entity != source)) { _fun00002_ip = 858; continue _fun00001 }
 830:
            ...
            echoed = entity.PressableOpacity;
 ...
 862:
            ...
            whisks = 15;
            option = verify[whisks];
            option = yankee.bind(tangon)(option);
            yankee = option.Text;
            option = {};
            sequen = 'heading-sm/normal';
            option['variant'] = sequen;
            option['onTextLayout'] = vacuum;
            option['onLayout'] = ctrled;
            option['children'] = papara;
            ...
            source = {};
            if(target) { _fun00002_ip = 1088; continue _fun00001 }
 1082:
            sequen = foxtra;
            if(status) { _fun00002_ip = 1090; continue _fun00001 }
 1088:
            sequen = undefined;
 1090:
            ...
            sierra = undefined;
            if(target) { _fun00002_ip = 1149; continue _fun00001 }
 1145:
            sierra = _closure1_slot7;
 1149:
            sequen['lineClamp'] = sierra;
            if(target) { _fun00002_ip = 1166; continue _fun00001 }
 1157:
            if(!status) { _fun00002_ip = 1166; continue _fun00001 }
 1160:
 ...
 1172:
            ...
            status[1] = sierra;
            sequen['style'] = status;
            if(!target) { _fun00002_ip = 1200; continue _fun00001 }
 1197:
            cntext = papara;
 1200:
            ...
            source = kiloes.absoluteFill;
            kiloes = new Array(2);
            kiloes[0] = source;
            kiloes[1] = update;
            offset['style'] = kiloes;
            offset['pointerEvents'] = foxtra;
            kiloes = _closure1_slot10;
            foxtra = 16;
    ...
    entity = function(argFoo) { // Original name: GroupDMChannelDetailsTopic
        ...
        zuuluu = function() {
            ...
            zuuluu = tangon.getPrivateChannelUserTagsString;
    ...
    tangon = {};
    romeon = {'flex': 1, 'flexGrow': 1, 'position': 'absolute', 'opacity': 0};
    tangon['hidden'] = romeon;
    romeon = {};
    foxtra = 'hidden';
    romeon['overflow'] = foxtra;
    tangon['topic'] = romeon;
    romeon = {'flex': 1, 'flexGrow': 1};
    tangon['gradient'] = romeon;
    romeon = {};
    foxtra = 'center';
    romeon['textAlign'] = foxtra;
    tangon['expanded'] = romeon;
    ...
    tangon = {};
    option = 'function ChannelDetailsTopicTsx2(){const{expandedHeight,EMPTY_STYLE}=this.__closure;if(expandedHeight.get()==null)return EMPTY_STYLE;return{height:expandedHeight.get()};}';
    tangon['code'] = option;
    ...
    tangon = golfie.memo;
    michal = function(argFoo) { // Original name: ChannelDetailsTopic
        _fun00015: for(var _fun00016_ip = 0; ; ) switch(_fun00016_ip) {
 0:
            entity = argFoo;
            option = entity.channel;
            golfie = entity.containerStyle;
            tangon = entity.textAlign;
            report = undefined;
            if(!(tangon === report)) { _fun00016_ip = 29; continue _fun00015 }
 25:
            tangon = 'center';
 29:
            entity = option.isDM;
 ...
 42:
            ...
            entity = entity.bind(option)();
            if(entity) { _fun00016_ip = 128; continue _fun00015 }
 55:
            michal = option.topic;
            entity = null;
 ...
 94:
            oscard = undefined;
            if(!entity) { _fun00016_ip = 184; continue _fun00015 }
 99:
            zuuluu = _closure1_slot10;
            michal = _closure1_slot19;
            entity = {};
            entity['channel'] = option;
            entity['textAlign'] = tangon;
 ...
 220:
    ...
    tangon = 'modules/main_tabs_v2/native/sidebar/details/ChannelDetailsTopic.tsx';
