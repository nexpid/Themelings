...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
 ...
 52:
        ...
        option = {};
        option['isActive'] = sizing;
        sizing = 25;
        sizing = kiloes[sizing];
        sizing = romeon.bind(tangon)(sizing);
        sizing = sizing.withTiming;
        option['withTiming'] = sizing;
        sizing = 27;
        sizing = kiloes[sizing];
        sizing = romeon.bind(tangon)(sizing);
        sizing = sizing.timingFast;
        option['timingFast'] = sizing;
        sizing = kiloes[entity];
        sizing = romeon.bind(tangon)(sizing);
        sizing = sizing.runOnJS;
        option['runOnJS'] = sizing;
        option['cleanUp'] = backup;
        option['width'] = foxtra;
        zuuluu['__closure'] = option;
        option = 15139742229370.0;
 ...
 201:
        ...
        verify = report.bind(option)(michal, zuuluu);
    ...
    michal = function(argFoo, argBar) {
        ...
        backup = michal.onBackPress;
        var _closure2_slot1 = backup;
        golfie = michal.componentWidth;
        romeon = michal.searchBarLayoutProps;
        ...
        michal = zuuluu.useChannelDetailWidth;
 ...
 50:
        ...
        verify = verify.bind(golfie)(michal, zuuluu);
