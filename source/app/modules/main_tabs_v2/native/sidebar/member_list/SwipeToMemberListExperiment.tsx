...
export default (function(_, argBar, __, ___, ____, argFre, argPlu) {
    ...
    michal = {'kind': 'user', 'id': '2024-12_swipe_to_view_memberlist', 'label': 'Swipe to view member list'};
    verify = {};
    yankee = false;
    ...
    verify = {'id': 1, 'label': 'Swipe to view member list is enabled'};
    option = {};
    ...
    tangon = 'modules/main_tabs_v2/native/sidebar/member_list/SwipeToMemberListExperiment.tsx';
