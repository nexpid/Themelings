...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
    ...
    tangon = 'modules/main_tabs_v2/native/friends/components/IncomingRequestRowActions.tsx';
    tangon = report.bind(oscard)(tangon);
    michal = function(argFoo) { // Original name: IncomingRequestRowActions
        _fun00001: for(var _fun00002_ip = 0; ; ) switch(_fun00002_ip) {
 0:
            tangon = argFoo;
            entity = tangon.user;
            var _closure2_slot0 = entity;
            yankee = tangon.applicationId;
            var _closure2_slot1 = yankee;
            zuuluu = tangon.pressed;
            var _closure2_slot2 = zuuluu;
            backup = tangon.onAcceptIncomingRequest;
            var _closure2_slot3 = backup;
            michal = tangon.onDeclineIncomingRequest;
            var _closure2_slot4 = michal;
            source = tangon.animate;
            var _closure2_slot5 = source;
            record = tangon.acceptRequestAccessibilityLabel;
            config = tangon.ignoreRequestAccessibilityLabel;
            ...
            ctrled = 4;
            oscard = romeon[ctrled];
            option = vacuum.bind(tangon)(oscard);
            golfie = option.useSharedValue;
            oscard = 0;
            foxtra = golfie.bind(option)(oscard);
            var _closure2_slot6 = foxtra;
            oscard = romeon[ctrled];
            golfie = vacuum.bind(tangon)(oscard);
            oscard = golfie.useSharedValue;
            option = -1;
            kiloes = oscard.bind(golfie)(option);
            ...
            golfie = vacuum.bind(tangon)(oscard);
            oscard = golfie.useSharedValue;
            sizing = oscard.bind(golfie)(option);
 ...
 141:
            ...
            verify['pressed'] = zuuluu;
            update = 5;
            offset = romeon[update];
            offset = vacuum.bind(tangon)(offset);
            offset = offset.withTiming;
            verify['withTiming'] = offset;
            oscard['__closure'] = verify;
            verify = 1291516991185.0;
            oscard['__workletHash'] = verify;
            verify = _closure1_slot8;
            oscard['__initData'] = verify;
            golfie = golfie.bind(option)(oscard);
            oscard = romeon[ctrled];
            verify = vacuum.bind(tangon)(oscard);
 ...
 0:
                    ...
                    verify = 0.5;
                    if(!tangon) { _fun00006_ip = 58; continue _fun00005 }
 55:
                    verify = 1;
 58:
                    report = _closure2_slot2;
                    ...
                    tangon = tangon.bind(report)();
                    option = 0;
                    if(tangon) { _fun00006_ip = 80; continue _fun00005 }
 76:
 ...
 209:
                    ...
                    zuuluu = 0;
                    if(!tangon) { _fun00006_ip = 230; continue _fun00005 }
 227:
                    zuuluu = 1;
 230:
 ...
 232:
                    ...
                    oscard = 0;
                    if(!golfie) { _fun00006_ip = 283; continue _fun00005 }
 280:
                    oscard = 1;
 283:
 ...
 288:
                    ...
                    zuuluu = michal.bind(zuuluu)();
                    michal = 'none';
                    if(!zuuluu) { _fun00006_ip = 316; continue _fun00005 }
 312:
                    michal = 'auto';
 316:
                    entity['pointerEvents'] = michal;
            ...
            offset = {};
            offset['buttonWidth'] = kiloes;
            offset['buttonOffsetX'] = foxtra;
            offset['pressed'] = zuuluu;
            offset['animate'] = source;
            foxtra = romeon[update];
            foxtra = vacuum.bind(tangon)(foxtra);
            foxtra = foxtra.withTiming;
            offset['withTiming'] = foxtra;
            oscard['__closure'] = offset;
            offset = 2207673076655.0;
            ...
            foxtra = {};
            foxtra['waveWidth'] = echoed;
            foxtra['waveHeight'] = sizing;
            oscard['__closure'] = foxtra;
            foxtra = 4308223742756.0;
 ...
 0:
                    ...
                    output = undefined;
                    golfie = tangon.bind(output)(michal);
                    oscard = golfie.withDelay;
                    michal = report[offset];
                    verify = tangon.bind(output)(michal);
                    option = verify.withRepeat;
                    michal = 5;
                    michal = report[michal];
                    romeon = tangon.bind(output)(michal);
 ...
 98:
                    ...
                    michal['easing'] = foxtra;
                    report = yankee.bind(romeon)(report, michal);
                    michal = true;
                    report = option.bind(verify)(report, offset, michal);
                    michal = 450;
            ...
            sequen = sequen.withDelay;
            foxtra['withDelay'] = sequen;
            sequen = romeon[ctrled];
            sequen = vacuum.bind(tangon)(sequen);
            sequen = sequen.withRepeat;
            foxtra['withRepeat'] = sequen;
            update = romeon[update];
            update = vacuum.bind(tangon)(update);
            update = update.withTiming;
            foxtra['withTiming'] = update;
            foxtra['pressed'] = zuuluu;
            update = romeon[ctrled];
            update = vacuum.bind(tangon)(update);
            update = update.Easing;
            foxtra['Easing'] = update;
            foxtra['waveWidth'] = echoed;
            foxtra['waveHeight'] = sizing;
            oscard['__closure'] = foxtra;
            foxtra = 6870822621980.0;
            oscard['__workletHash'] = foxtra;
            foxtra = _closure1_slot11;
            oscard['__initData'] = foxtra;
            update = option.bind(verify)(oscard);
            oscard = romeon[ctrled];
            verify = vacuum.bind(tangon)(oscard);
            option = verify.useAnimatedProps;
            oscard = function() { // Original name: X
                entity = {};
                zuuluu = _closure2_slot2;
                michal = zuuluu.get;
            ...
            zuuluu = function() {
                ...
                oscard = golfie.acceptIncomingRequest;
                report = {};
                michal = _closure2_slot0;
                tangon = michal.id;
                report['userId'] = tangon;
                tangon = _closure2_slot1;
                report['applicationId'] = tangon;
            ...
            cntext = foxtra.bind(oscard)(zuuluu, option);
            ...
            michal = function() {
                ...
                entity = undefined;
                michal = zuuluu.bind(entity)(michal, report);
            ...
            papara = option.bind(oscard)(michal, zuuluu);
            ...
            report['onLayout'] = backup;
            report['style'] = golfie;
            golfie = 7;
            golfie = romeon[golfie];
            golfie = vacuum.bind(tangon)(golfie);
            backup = golfie.Stack;
            golfie = {'direction': 'horizontal', 'spacing': 8};
            echoed = 8;
            sizing = romeon[echoed];
            sizing = vacuum.bind(tangon)(sizing);
            sequen = sizing.IconButton;
            sizing = {'size': 'sm', 'variant': 'tertiary'};
            target = 9;
            target = romeon[target];
            target = foxtra.bind(tangon)(target);
            sizing['icon'] = target;
            sizing['onPress'] = papara;
            sizing['accessibilityLabel'] = config;
            config = 2;
            sizing['maxFontSizeMultiplier'] = config;
            sequen = option.bind(tangon)(sequen, sizing);
            sizing = new Array(2);
            sizing[0] = sequen;
            echoed = romeon[echoed];
            echoed = vacuum.bind(tangon)(echoed);
            sequen = echoed.IconButton;
            echoed = {'size': 'sm', 'variant': 'active'};
            papara = 10;
            papara = romeon[papara];
            papara = foxtra.bind(tangon)(papara);
            echoed['icon'] = papara;
            echoed['onPress'] = cntext;
            echoed['accessibilityLabel'] = record;
            echoed['maxFontSizeMultiplier'] = config;
            echoed = option.bind(tangon)(sequen, echoed);
            sizing[1] = echoed;
            golfie['children'] = sizing;
            golfie = zuuluu.bind(tangon)(backup, golfie);
            ...
            backup = null;
            if(!source) { _fun00002_ip = 1211; continue _fun00001 }
 1208:
            backup = kiloes;
 1211:
            romeon['style'] = backup;
            ...
            backup = {};
            echoed = null;
            if(!source) { _fun00002_ip = 1253; continue _fun00001 }
 1250:
            echoed = update;
 1253:
            backup['style'] = echoed;
    ...
    zuuluu['IncomingRequestRowActions'] = michal;
    return entity;
})();