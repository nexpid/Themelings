...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
    ...
    tangon = oscard[tangon];
    tangon = report.bind(entity)(tangon);
    yankee = tangon.MIDNIGHT_BORDER_WIDTH;
    tangon = 5;
    tangon = oscard[tangon];
    tangon = report.bind(entity)(tangon);
    ...
    tangon['midnightContainerStyles'] = offset;
    tangon = option.bind(verify)(tangon);
    var _closure1_slot15 = tangon;
    option = golfie.memo;
    tangon = function(argFoo) { // Original name: FirstChannelScreen
        _fun00001: for(var _fun00002_ip = 0; ; ) switch(_fun00002_ip) {
 0:
            michal = argFoo;
            source = michal.guildId;
            update = michal.channelId;
            echoed = michal.showCreateThread;
            sizing = michal.frame;
            kiloes = michal.index;
            report = michal.freeze;
            sequen = michal.isDragging;
            foxtra = michal.translateX;
            result = michal.containerWidth;
            backup = michal.isActive;
            offset = michal.maxWidth;
            verify = michal.focusChatPressableComponent;
            output = michal.transitionState;
            var _closure2_slot0 = output;
            vacuum = michal.cleanup;
            ...
            zuuluu = golfie.useMainTabsChannelScreenStyles;
            offset = zuuluu.bind(golfie)(sequen, foxtra, offset);
            foxtra = _closure1_slot4;
            golfie = foxtra.useEffect;
            zuuluu = new Array(2);
            zuuluu[0] = vacuum;
            zuuluu[1] = output;
            entity = function() {
 ...
 56:
            ...
            entity = golfie.bind(foxtra)(entity, zuuluu);
            ...
            offset = null;
            if(!foxtra) { _fun00002_ip = 269; continue _fun00001 }
 260:
            foxtra = {};
            foxtra['width'] = result;
            offset = foxtra;
 269:
            ...
            offset = undefined;
            if(!(ctrled === foxtra)) { _fun00002_ip = 295; continue _fun00001 }
 289:
 ...
 295:
            ...
            option['style'] = foxtra;
            foxtra = 'box-only';
            if(!backup) { _fun00002_ip = 340; continue _fun00001 }
 336:
            foxtra = 'auto';
 340:
 ...
 353:
            ...
            if(!backup) { _fun00002_ip = 369; continue _fun00001 }
 367:
            foxtra = undefined;
 369:
            ...
            romeon['isNavigationScreen'] = output;
            romeon['frame'] = sizing;
            romeon['screenIndex'] = kiloes;
    ...
    option = golfie.memo;
    tangon = function(argFoo) { // Original name: ChannelScreen
 ...
 0:
                    ...
                    if(!(golfie !== report)) { _fun00010_ip = 106; continue _fun00009 }
 69:
                    ...
                    if(!(report === tangon)) { _fun00010_ip = 122; continue _fun00009 }
 106:
                    foxtra = true;
                    yankee = 0;
                    backup = undefined;
 ...
 122:
                    ...
                    if(tangon) { _fun00010_ip = 162; continue _fun00009 }
 134:
                    zuuluu = _closure2_slot3;
                    report = true;
 ...
 554:
            ...
            yankee['channelId'] = sizing;
            yankee['showCreateThread'] = kiloes;
            kiloes = true;
            yankee['isNavigationScreen'] = kiloes;
            kiloes = null;
            yankee['frame'] = kiloes;
            yankee['screenIndex'] = backup;
    ...
    tangon = {};
    option = 'function MainTabsChannelScreenStackTsx1(){const{translateX,maxWidth}=this.__closure;return translateX.get()===maxWidth;}';
    tangon['code'] = option;
    var _closure1_slot18 = tangon;
    tangon = {};
    option = 'function MainTabsChannelScreenStackTsx2(value,prev){const{runOnJS,setIsHidden}=this.__closure;if(value===prev)return;runOnJS(setIsHidden)(value);}';
    tangon['code'] = option;
    var _closure1_slot19 = tangon;
    tangon = golfie.memo;
    michal = function(argFoo) { // Original name: MainTabsChannelScreenStack
        _fun00011: for(var _fun00012_ip = 0; ; ) switch(_fun00012_ip) {
 0:
            entity = argFoo;
            kiloes = entity.screens;
            var _closure2_slot0 = kiloes;
            verify = entity.screenStackActive;
            var _closure2_slot1 = verify;
            sizing = entity.translateX;
            var _closure2_slot2 = sizing;
            output = entity.isDragging;
            var _closure2_slot3 = output;
            tangon = entity.maxWidth;
            var _closure2_slot4 = tangon;
            oscard = entity.shouldFreeze;
            result = entity.focusChatPressableComponent;
            var _closure2_slot5 = result;
            backup = entity.firstScreenWidth;
            var _closure2_slot6 = backup;
            romeon = entity.firstScreenFrame;
            ...
            entity = 2;
            option = zuuluu.bind(report)(golfie, entity);
            zuuluu = 0;
            ...
            golfie = {};
            golfie['translateX'] = sizing;
            golfie['maxWidth'] = tangon;
            option['__closure'] = golfie;
            golfie = 1182927208903.0;
            option['__workletHash'] = golfie;
            golfie = _closure1_slot18;
            option['__initData'] = golfie;
            golfie = function(argFoo, argBar) { // Original name: F
 ...
 57:
            ...
            source['setIsHidden'] = ctrled;
            golfie['__closure'] = source;
            source = 2718765910383.0;
            golfie['__workletHash'] = source;
            source = _closure1_slot19;
            golfie['__initData'] = source;
            golfie = echoed.bind(update)(option, golfie);
            echoed = offset.useMemo;
            option = new Array(1);
            option[0] = kiloes;
            golfie = function() {
 ...
 88:
            ...
            golfie = echoed.bind(offset)(golfie, option);
            echoed = offset.useEffect;
            option = new Array(1);
            option[0] = golfie;
            golfie = function() {
 ...
 0:
                    ...
                    entity = 0;
                    if(!(entity !== verify)) { _fun00020_ip = 165; continue _fun00019 }
 36:
                    zuuluu = _closure1_slot13;
                    ...
                    yankee = golfie.showCreateThread;
                    tangon = null;
                    tangon = tangon != yankee;
                    if(!tangon) { _fun00020_ip = 85; continue _fun00019 }
 82:
                    tangon = yankee;
 85:
                    entity['showCreateThread'] = tangon;
                    entity['index'] = verify;
                    entity['transitionState'] = offset;
                    ...
                    entity['freeze'] = tangon;
                    entity = zuuluu.bind(report)(michal, entity, oscard);
 ...
 165:
                    ...
                    if(!golfie) { _fun00020_ip = 214; continue _fun00019 }
 211:
                    golfie = yankee;
 214:
                    michal['showCreateThread'] = golfie;
                    yankee = _closure2_slot5;
                    michal['focusChatPressableComponent'] = yankee;
                    michal['index'] = verify;
                    michal['transitionState'] = offset;
                    michal['cleanup'] = option;
                    option = _closure2_slot3;
                    michal['isDragging'] = option;
                    option = _closure2_slot2;
                    michal['translateX'] = option;
                    option = _closure2_slot1;
                    if(!option) { _fun00020_ip = 290; continue _fun00019 }
 270:
 ...
 290:
                    michal['isActive'] = option;
                    option = _closure2_slot0;
                    offset = option.length;
                    option = 2;
                    option = offset - option;
                    option = verify < option;
                    michal['freeze'] = option;
                    option = _closure2_slot6;
                    michal['containerWidth'] = option;
                    option = _closure2_slot7;
                    michal['frame'] = option;
                    golfie = _closure2_slot4;
                    michal['maxWidth'] = golfie;
 ...
 354:
            ...
            if(!oscard) { _fun00012_ip = 481; continue _fun00011 }
 478:
            oscard = entity;
 481:
            if(!oscard) { _fun00012_ip = 537; continue _fun00011 }
 484:
            entity = null;
            entity = entity == zuuluu;
            if(entity) { _fun00012_ip = 534; continue _fun00011 }
 493:
            golfie = zuuluu.type;
            option = _closure1_slot0;
 ...
 537:
            ...
            offset = undefined;
            if(tangon) { _fun00012_ip = 566; continue _fun00011 }
 561:
            offset = zuuluu.channelId;
 566:
            romeon = entity != offset;
            tangon = null;
            if(!romeon) { _fun00012_ip = 578; continue _fun00011 }
 575:
            tangon = offset;
 578:
            ...
            tangon = undefined;
            if(golfie) { _fun00012_ip = 624; continue _fun00011 }
 619:
            tangon = zuuluu.type;
 624:
            golfie = new Array(2);
            ...
            tangon = undefined;
            if(romeon) { _fun00012_ip = 646; continue _fun00011 }
 641:
 ...
 29:
                    ...
                    if(!michal) { _fun00022_ip = 58; continue _fun00021 }
 36:
 ...
 64:
                    ...
                    michal = michal.current;
                    if(!(zuuluu !== michal)) { _fun00022_ip = 125; continue _fun00021 }
 101:
                    zuuluu = _closure2_slot11;
                    michal = _closure2_slot9;
                    michal = michal.channelId;
                    zuuluu['current'] = michal;
                    _fun00022_ip = 318; continue _fun00021;
 125:
                    michal = _closure2_slot9;
                    zuuluu = michal.type;
                    tangon = _closure1_slot0;
                    ...
                    michal = zuuluu !== michal;
                    if(michal) { _fun00022_ip = 212; continue _fun00021 }
 176:
                    tangon = _closure1_slot0;
                    oscard = _closure1_slot2;
                    zuuluu = 23;
                    ...
                    zuuluu = tangon.getChatLayout;
                    zuuluu = zuuluu.bind(tangon)();
                    michal = zuuluu.isChatLockedOpen;
 212:
                    if(michal) { _fun00022_ip = 318; continue _fun00021 }
 215:
                    ...
                    option = option.ACK_CHANNEL_SELECT_SAME_CHANNEL_DISPATCH;
                    oscard['object'] = option;
                    golfie = _closure1_slot9;
                    golfie = golfie.ACK_AUTOMATIC;
 ...
 318:
            ...
            tangon = option.bind(offset)(tangon, golfie);
            option = _closure1_slot4;
            ...
            if(!oscard) { _fun00012_ip = 719; continue _fun00011 }
 696:
            tangon = entity == zuuluu;
            michal = undefined;
            if(tangon) { _fun00012_ip = 711; continue _fun00011 }
 705:
            michal = zuuluu.showCreateThread;
 711:
            entity = null;
            if(michal) { _fun00012_ip = 940; continue _fun00011 }
 719:
            tangon = _closure1_slot13;
            zuuluu = _closure1_slot0;
            option = _closure1_slot2;
            ...
            option = !verify;
            if(option) { _fun00012_ip = 807; continue _fun00011 }
 805:
            option = undefined;
 807:
            oscard['accessibilityElementsHidden'] = option;
            option = 'no-hide-descendants';
            if(!verify) { _fun00012_ip = 823; continue _fun00011 }
 821:
            option = undefined;
 823:
            oscard['importantForAccessibility'] = option;
 ...
 940:
    ...
    tangon = 'modules/main_tabs_v2/native/panels/MainTabsChannelScreenStack.tsx';
