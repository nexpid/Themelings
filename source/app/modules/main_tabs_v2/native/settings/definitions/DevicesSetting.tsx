// app/modules/main_tabs_v2/native/settings/definitions/DevicesSetting.tsx
export default (function(_, argBar, __, ___, ____, argFre, argPlu) {
    ...
    tangon = tangon.LaptopPhoneIcon;
    michal['IconComponent'] = tangon;
    tangon = {};
    option = option.SESSIONS;
    tangon['route'] = option;
    ...
    tangon = 'modules/main_tabs_v2/native/settings/definitions/DevicesSetting.tsx';
