...
export default (function(_, argBar, __, ___, ____, argFre, argPlu) {
    ...
    golfie = golfie.NativePhoneIntegrationEnabled;
    golfie = golfie.useSetting;
    michal['useValue'] = golfie;
    tangon = oscard[tangon];
    tangon = report.bind(entity)(tangon);
    tangon = tangon.NativePhoneIntegrationEnabled;
    ...
    tangon = 'modules/main_tabs_v2/native/settings/definitions/IOSNativePhoneIntegrationSetting.tsx';
