// app/modules/main_tabs_v2/native/settings/definitions/AuthorizedAppsSetting.tsx
export default (function(_, argBar, __, ___, ____, argFre, argPlu) {
    ...
    tangon = tangon.KeyIcon;
    michal['IconComponent'] = tangon;
    tangon = {};
    option = option.AUTHORIZED_APPS;
    tangon['route'] = option;
    ...
    tangon = 'modules/main_tabs_v2/native/settings/definitions/AuthorizedAppsSetting.tsx';
