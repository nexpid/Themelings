...
export default (function(argFoo, argBar, argBaz, _, __, argFre, argPlu) {
    ...
    golfie = function() { // Original name: useDiscoveryByPhoneSettingValue
        report = _closure1_slot0;
        oscard = _closure1_slot2;
        michal = 4;
        michal = oscard[michal];
    ...
    tangon = function(argFoo) { // Original name: onDiscoveryByPhoneSettingValueChange
        report = _closure1_slot0;
    ...
    tangon = 'modules/main_tabs_v2/native/settings/definitions/DiscoveryByPhoneSetting.tsx';
