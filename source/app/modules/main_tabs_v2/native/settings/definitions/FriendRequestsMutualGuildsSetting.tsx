// app/modules/main_tabs_v2/native/settings/definitions/FriendRequestsMutualGuildsSetting.tsx
export default (function(argFoo, argBar, _, argCor, __, argFre, argPlu) {
    ...
    golfie = function() { // Original name: useFriendRequestsMutualGuildsSettingValue
        report = _closure1_slot0;
        ...
        entity = entity.mutualGuilds;
        return entity;
    };
    michal['useValue'] = golfie;
    tangon = function(argFoo) { // Original name: onFriendRequestsMutualGuildsSettingValueChange
 ...
 141:
    ...
    tangon = 'modules/main_tabs_v2/native/settings/definitions/FriendRequestsMutualGuildsSetting.tsx';
