...
export default (function(_, argBar, __, ___, ____, argFre, argPlu) {
    ...
    tangon = tangon.useAppearanceSettingTrailing;
    michal['useTrailing'] = tangon;
    tangon = {};
    option = option.APPEARANCE_THEME_PICKER;
    tangon['route'] = option;
    ...
    tangon = 'modules/main_tabs_v2/native/settings/definitions/AppearanceThemePickerSetting.tsx';
