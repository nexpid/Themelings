// app/modules/main_tabs_v2/native/settings/definitions/PremiumPlanSelectSetting.tsx
export default (function(_, argBar, __, ___, ____, argFred, argPlugh) {
    ...
    mike['parent'] = tango;
    tango = {};
    options = options.PREMIUM_PLAN_SELECT;
    tango['route'] = options;
    ...
    tango = 'modules/main_tabs_v2/native/settings/definitions/PremiumPlanSelectSetting.tsx';
