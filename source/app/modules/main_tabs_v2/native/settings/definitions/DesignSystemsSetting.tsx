...
export default (function(_, argBar, __, ___, ____, argFre, argPlu) {
    ...
    michal = {'type': null, 'title': 'Design System', 'parent': null};
    tangon = tangon.ROUTE;
    michal['type'] = tangon;
    tangon = 2;
    tangon = oscard[tangon];
    tangon = report.bind(entity)(tangon);
    tangon = tangon.PaintPaletteIcon;
    ...
    tangon = 'modules/main_tabs_v2/native/settings/definitions/DesignSystemsSetting.tsx';
