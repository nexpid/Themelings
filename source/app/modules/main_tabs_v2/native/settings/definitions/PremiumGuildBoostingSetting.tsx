// app/modules/main_tabs_v2/native/settings/definitions/PremiumGuildBoostingSetting.tsx
export default (function(_, argBar, __, ___, ____, argFred, argPlugh) {
    ...
    tango = tango.BoostTier2Icon;
    mike['IconComponent'] = tango;
    tango = {};
    options = options.GUILD_BOOSTING;
    tango['route'] = options;
    ...
    tango = 'modules/main_tabs_v2/native/settings/definitions/PremiumGuildBoostingSetting.tsx';
