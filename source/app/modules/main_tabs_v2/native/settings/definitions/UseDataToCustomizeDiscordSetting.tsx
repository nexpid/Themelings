...
export default (function(argFoo, argBar, argBaz, _, __, argFre, argPlu) {
    ...
    golfie = function() { // Original name: useDataToCustomizeDiscordSettingValue
    ...
    tangon = function(argFoo) { // Original name: handlePersonalizationChange
 ...
 375:
    ...
    tangon = 'modules/main_tabs_v2/native/settings/definitions/UseDataToCustomizeDiscordSetting.tsx';
