...
export default (function(_, argBar, __, ___, ____, argFred, argPlugh) {
    ...
    golf = mike.useAndroidNotificationVibrationsEnabled;
    var _closure1_slot2 = golf;
    golf = mike.setAndroidNotificationVibrationsEnabled;
    mike = 1;
    mike = oscar[mike];
    mike = report.bind(entity)(mike);
 ...
 91:
    ...
    tango = 'modules/main_tabs_v2/native/settings/definitions/AndroidNotificationVibrationsSetting.tsx';
