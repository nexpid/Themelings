...
export default (function(_, argBar, argBaz, __, ___, argFre, argPlu) {
    ...
    option = function() { // Original name: useAccountEmailSettingTrailing
 ...
 33:
    ...
    golfie = function() { // Original name: onAccountEmailSettingPress
    ...
    tangon = 'modules/main_tabs_v2/native/settings/definitions/AccountEmailSetting.tsx';
