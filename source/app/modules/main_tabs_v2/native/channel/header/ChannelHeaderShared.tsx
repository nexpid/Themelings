...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
                ...
                entity = null;
                if(!(entity != foxtrot)) { _fun79767_ip = 284; continue _fun79767 }
 113:
                ...
                backup = undefined;
                if(!sizing) { _fun79767_ip = 184; continue _fun79767 }
 181:
                backup = kilo;
 184:
                ...
                _fun79767_ip = 322; continue _fun79767;
 284:
 ...
 0:
                ...
                tango = undefined;
                if(!(romeo === tango)) { _fun79769_ip = 34; continue _fun79769 }
 32:
                romeo = false;
 34:
                ...
                verify[0] = foxtrot;
                romeo = !romeo;
                if(!romeo) { _fun79769_ip = 249; continue _fun79769 }
 166:
 ...
 249:
                ...
                oscar = null;
                oscar = oscar != offset;
                if(!oscar) { _fun79769_ip = 310; continue _fun79769 }
 280:
 ...
 0:
                ...
                golf = null;
                if(verify) { _fun79771_ip = 124; continue _fun79771 }
 121:
                golf = options;
 124:
                entity['status'] = golf;
 ...
 0:
                ...
                entity = null;
                if(!(entity == report)) { _fun79773_ip = 112; continue _fun79773 }
 33:
                ...
                _fun79773_ip = 136; continue _fun79773;
 112:
                zulu = _closure1_slot11;
 ...
 136:
        ...
        if(!backup) { _fun79766_ip = 617; continue _fun79766 }
 611:
        foxtrot = 'baseline';
 617:
 ...
 0:
                report = arguments[3];
                tango = undefined;
                if(!(report === tango)) { _fun79777_ip = 11; continue _fun79777 }
 9:
                report = false;
 11:
                zulu = _closure1_slot11;
 ...
 0:
                ...
                verify = undefined;
                if(offset) { _fun79780_ip = 81; continue _fun79780 }
 75:
 ...
 0:
                ...
                options = arguments[2];
                tango = undefined;
                if(!(options === tango)) { _fun79781_ip = 17; continue _fun79781 }
 15:
                options = false;
 17:
                foxtrot = 'online';
                entity = 0;
                yankee = foxtrot;
                if(!(entity === oscar)) { _fun79781_ip = 43; continue _fun79781 }
 30:
                entity = null;
                yankee = foxtrot;
                if(!(entity !== romeo)) { _fun79781_ip = 43; continue _fun79781 }
 39:
                yankee = 'total';
 43:
                zulu = _closure1_slot13;
                ...
                report = {};
                report['type'] = yankee;
                if(!(foxtrot === yankee)) { _fun79781_ip = 93; continue _fun79781 }
 90:
                romeo = oscar;
 93:
                oscar = null;
                foxtrot = oscar != romeo;
                yankee = undefined;
                if(!foxtrot) { _fun79781_ip = 107; continue _fun79781 }
 104:
                yankee = romeo;
 107:
                report['count'] = yankee;
                ...
                report[0] = verify;
                oscar = null;
                if(!options) { _fun79781_ip = 189; continue _fun79781 }
 140:
                verify = _closure1_slot11;
                options = _closure1_slot0;
 ...
 0:
                ...
                report = 0;
                if(!(!(golf > report))) { _fun79784_ip = 262; continue _fun79784 }
 205:
                foxtrot = _closure1_slot0;
                backup = _closure1_slot2;
                offset = 19;
                ...
                _fun79784_ip = 325; continue _fun79784;
 262:
 ...
 325:
                ...
                offset = golf > report;
                verify = undefined;
                if(!offset) { _fun79784_ip = 352; continue _fun79784 }
 343:
 ...
 352:
                ...
                golf = golf > report;
                report = null;
                if(!golf) { _fun79784_ip = 408; continue _fun79784 }
 402:
