...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
            ...
            if(!options) { _fun117333_ip = 73; continue _fun117333 }
 67:
            options = foxtrot.noServerContainer;
 73:
            golf[1] = options;
            options = report == romeo;
            if(!options) { _fun117333_ip = 87; continue _fun117333 }
 84:
            options = !oscar;
 87:
            if(!options) { _fun117333_ip = 96; continue _fun117333 }
 90:
            options = foxtrot.noServerExtraContainer;
 96:
            golf[2] = options;
            entity['style'] = golf;
            if(!(report == romeo)) { _fun117333_ip = 192; continue _fun117333 }
 108:
            report = null;
            if(!oscar) { _fun117333_ip = 190; continue _fun117333 }
 113:
 ...
 190:
            _fun117333_ip = 267; continue _fun117333;
 192:
            options = _closure1_slot12;
 ...
 0:
                    ...
                    entity = undefined;
                    oscar = undefined;
                    if(!options) { _fun117335_ip = 47; continue _fun117335 }
 39:
 ...
 0:
                    ...
                    mike = mike.length;
                    if(!(!(zulu < mike))) { _fun117336_ip = 59; continue _fun117336 }
 20:
                    zulu = _closure2_slot1;
                    mike = _closure2_slot0;
                    mike = mike.length;
                    if(!(zulu !== mike)) { _fun117336_ip = 132; continue _fun117336 }
 37:
                    ...
                    _fun117336_ip = 132; continue _fun117336;
 59:
                    mike = _closure2_slot3;
                    tango = mike.current;
                    mike = null;
                    if(!(mike != tango)) { _fun117336_ip = 112; continue _fun117336 }
 74:
 ...
 0:
                    ...
                    offset = mike > tango;
                    mike = 0;
                    if(!offset) { _fun117337_ip = 58; continue _fun117337 }
 55:
                    mike = 1;
 58:
                    ...
                    offset = mike > tango;
                    mike = 0;
                    if(!offset) { _fun117337_ip = 111; continue _fun117337 }
 107:
 ...
 111:
                    ...
                    oscar = oscar > tango;
                    tango = 0;
                    if(!oscar) { _fun117337_ip = 191; continue _fun117337 }
 160:
 ...
 191:
            ...
            if(!(!(backup >= offset))) { _fun117334_ip = 383; continue _fun117334 }
 377:
            offset = _closure1_slot16;
            _fun117334_ip = 392; continue _fun117334;
 383:
 ...
 0:
            ...
            report = !verify;
            if(!report) { _fun117338_ip = 104; continue _fun117338 }
 83:
 ...
 104:
            ...
            mike = offset != mike;
            sizing = undefined;
            if(!mike) { _fun117338_ip = 160; continue _fun117338 }
 121:
 ...
 160:
            ...
            if(!(offset == options)) { _fun117338_ip = 323; continue _fun117338 }
 277:
            ...
            _fun117338_ip = 375; continue _fun117338;
 323:
 ...
 0:
            ...
            source = undefined;
            if(!output) { _fun117341_ip = 515; continue _fun117341 }
 438:
 ...
 515:
            foxtrot['icon'] = source;
            if(!sizing) { _fun117341_ip = 582; continue _fun117341 }
 522:
            if(echo) { _fun117341_ip = 582; continue _fun117341 }
 525:
            vacuum = _closure1_slot0;
            ...
            _fun117341_ip = 656; continue _fun117341;
 582:
            ...
            source = update.t;
            if(output) { _fun117341_ip = 642; continue _fun117341 }
 629:
            update = source.XqMe3N;
            update = control.bind(vacuum)(update);
            _fun117341_ip = 653; continue _fun117341;
 642:
 ...
 656:
            ...
            if(sizing) { _fun117341_ip = 682; continue _fun117341 }
 675:
            sizing = 'active';
            if(output) { _fun117341_ip = 686; continue _fun117341 }
 682:
            sizing = 'secondary';
 686:
 ...
 0:
                    ...
                    if(tango) { _fun117348_ip = 148; continue _fun117348 }
 118:
                    ...
                    _fun117348_ip = 176; continue _fun117348;
 148:
                    tango = function(argFoo) {
                        zulu = argFoo;
                        mike = zulu.delete;
 ...
 0:
                        ...
                        if(mike) { _fun117355_ip = 496; continue _fun117355 }
 10:
 ...
 93:
                        ...
                        if(zulu) { _fun117355_ip = 493; continue _fun117355 }
 102:
                        tango = _closure1_slot1;
                        zulu = _closure1_slot2;
                        if(mike) { _fun117355_ip = 309; continue _fun117355 }
 116:
                        options = 29;
 ...
 347:
                        ...
                        if(tango) { _fun117355_ip = 490; continue _fun117355 }
 356:
 ...
 387:
                        ...
                        if(options) { _fun117355_ip = 487; continue _fun117355 }
 393:
                        options = _closure1_slot1;
                        offset = _closure1_slot2;
                        verify = offset[golf];
 ...
 0:
                    ...
                    if(!(!(zulu > mike))) { _fun117356_ip = 111; continue _fun117356 }
 15:
                    mike = _closure2_slot0;
                    zulu = mike.length;
                    mike = 150;
 ...
 111:
            ...
            oscar = oscar.size;
            oscar = oscar >= golf;
            if(!oscar) { _fun117344_ip = 1140; continue _fun117344 }
 989:
