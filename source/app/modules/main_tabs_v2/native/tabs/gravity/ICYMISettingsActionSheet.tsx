// app/modules/main_tabs_v2/native/tabs/gravity/ICYMISettingsActionSheet.tsx
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    entity = function(argFoo) { // Original name: getLabelForDoubleTapBehavior
 ...
 0:
            ...
            if(!(mike !== zulu)) { _fun116999_ip = 194; continue _fun116999 }
 47:
            tango = _closure1_slot0;
            mike = _closure1_slot2;
            mike = mike[oscar];
            ...
            mike = mike.GravityICYMIDoubleTapBehavior;
            mike = mike.BOOKMARKS;
            if(!(mike !== zulu)) { _fun116999_ip = 137; continue _fun116999 }
 80:
 ...
 194:
    ...
    tango = 'modules/main_tabs_v2/native/tabs/gravity/ICYMISettingsActionSheet.tsx';
    tango = report.bind(oscar)(tango);
    mike = function() { // Original name: ICYMISettingsActionSheet
 ...
 0:
            ...
            entity = romeo[mike];
            tango = undefined;
            golf = output.bind(tango)(entity);
            report = golf.useStateFromStoresObject;
            ...
            control = report.bind(golf)(zulu, entity);
 ...
 0:
                    ...
                    zulu = mike == entity;
                    mike = undefined;
                    if(zulu) { _fun117002_ip = 33; continue _fun117002 }
 27:
 ...
 33:
            ...
            golf = zulu.ICYMINegativeExperiment;
            report = golf.useExperiment;
            zulu = {};
            options = 'settings action sheet';
            ...
            source = mike.roleFilter;
            var _closure2_slot1 = source;
            echo = mike.everyoneFilter;
            ...
            sequence = null;
            romeo = null;
            if(!yankee) { _fun117000_ip = 518; continue _fun117000 }
 400:
            ...
            output = output.t;
            output = output.L9TfrK;
            output = result.bind(vacuum)(output);
            yankee['label'] = output;
            result = control.showNSFW;
            output = sequence != result;
            if(!output) { _fun117000_ip = 496; continue _fun117000 }
 493:
            output = result;
 496:
            yankee['value'] = output;
            output = function() { // Original name: onValueChange
                ...
                oscar = golf.setFilters;
                report = {};
                options = _closure2_slot0;
                yankee = report;
                offset = options;
                verify = copyDataProperties(yankee, offset);
                options = options.showNSFW;
                verify = !options;
                options = 'showNSFW';
            ...
            romeo = kilo.bind(tango)(backup, yankee);
 518:
            yankee = new Array(6);
            yankee[0] = romeo;
            romeo = null;
            if(!foxtrot) { _fun117000_ip = 649; continue _fun117000 }
 531:
            ...
            backup['label'] = result;
            vacuum = control.negativeContentOnly;
            result = sequence != vacuum;
            if(!result) { _fun117000_ip = 627; continue _fun117000 }
 624:
            result = vacuum;
 627:
            backup['value'] = result;
            result = function() { // Original name: onValueChange
                ...
                offset = options;
                verify = copyDataProperties(yankee, offset);
                options = options.negativeContentOnly;
                verify = !options;
                options = 'negativeContentOnly';
                report[options] = verify;
                report = oscar.bind(golf)(report);
                mike = tango[mike];
                zulu = zulu.bind(entity)(mike);
                mike = zulu.fetchDehydrated;
                mike = mike.bind(zulu)();
                return entity;
            };
 ...
 649:
            yankee[1] = romeo;
            romeo = null;
            if(!foxtrot) { _fun117000_ip = 776; continue _fun117000 }
 658:
            output = _closure1_slot11;
            record = _closure1_slot0;
            result = _closure1_slot2;
            ...
            result = vacuum.bind(config)(result);
            backup['label'] = result;
            vacuum = control.filterStaffContent;
            result = sequence != vacuum;
            if(!result) { _fun117000_ip = 754; continue _fun117000 }
 751:
            result = vacuum;
 754:
            backup['value'] = result;
            result = function() { // Original name: onValueChange
                ...
                offset = options;
                verify = copyDataProperties(yankee, offset);
                options = options.filterStaffContent;
                verify = !options;
                options = 'filterStaffContent';
                report[options] = verify;
                report = oscar.bind(golf)(report);
                mike = tango[mike];
                zulu = zulu.bind(entity)(mike);
 ...
 776:
            yankee[2] = romeo;
            romeo = null;
            if(!foxtrot) { _fun117000_ip = 932; continue _fun117000 }
 788:
            ...
            output = {};
            papa = 'clear read states';
            output['label'] = papa;
            papa = function() { // Original name: onPress
                zulu = _closure1_slot7;
                mike = zulu.getDehydratedItems;
 ...
 0:
                        ...
                        tango = tango.MESSAGE;
                        tango = report === tango;
                        if(!tango) { _fun117009_ip = 99; continue _fun117009 }
 52:
                        report = mike.data;
                        oscar = report.channel_type;
                        ...
                        tango = oscar === report;
 99:
                        if(!tango) { _fun117009_ip = 176; continue _fun117009 }
 102:
                        ...
                        tango = oscar >= report;
 176:
                        if(!tango) { _fun117009_ip = 267; continue _fun117009 }
 179:
                        ...
                        zulu = golf.atPreviousMillisecond;
                        mike = mike.data;
 ...
 267:
            ...
            output['onPress'] = papa;
            context = config.bind(tango)(context, output);
            output = new Array(2);
            output[0] = context;
 ...
 0:
                        ...
                        if(mike) { _fun117011_ip = 284; continue _fun117011 }
 10:
                        zulu = _closure1_slot7;
                        mike = zulu.getDehydratedItems;
                        tango = mike.bind(zulu)();
 ...
 0:
                                ...
                                tango = tango.MESSAGE;
                                tango = report === tango;
                                if(!tango) { _fun117012_ip = 99; continue _fun117012 }
 52:
                                report = mike.data;
                                oscar = report.channel_type;
                                golf = _closure1_slot0;
                                ...
                                tango = oscar === report;
 99:
                                if(!tango) { _fun117012_ip = 176; continue _fun117012 }
 102:
                                oscar = _closure1_slot1;
                                golf = _closure1_slot2;
                                report = 22;
                                ...
                                tango = oscar >= report;
 176:
                                if(!tango) { _fun117012_ip = 267; continue _fun117012 }
 179:
                                report = _closure1_slot0;
                                options = _closure1_slot2;
                                tango = 23;
 ...
 82:
                        ...
                        if(zulu) { _fun117011_ip = 281; continue _fun117011 }
 91:
                        tango = _closure1_slot1;
                        zulu = _closure1_slot2;
                        zulu = zulu[golf];
                        report = tango.bind(oscar)(zulu);
                        tango = report.fetchDehydrated;
 ...
 137:
                        ...
                        if(tango) { _fun117011_ip = 278; continue _fun117011 }
 146:
                        report = _closure1_slot1;
                        tango = _closure1_slot2;
                        tango = tango[golf];
                        report = report.bind(oscar)(tango);
                        tango = report.reloadICYMITab;
 ...
 177:
                        ...
                        if(report) { _fun117011_ip = 275; continue _fun117011 }
 183:
                        options = _closure1_slot1;
                        report = _closure1_slot2;
                        report = report[golf];
                        options = options.bind(oscar)(report);
                        report = options.getGuildChannelScores;
 ...
 214:
                        ...
                        if(options) { _fun117011_ip = 272; continue _fun117011 }
 220:
                        options = _closure1_slot1;
                        verify = _closure1_slot2;
                        golf = verify[golf];
                        offset = options.bind(oscar)(golf);
                        golf = offset.getRecommendedGuilds;
 ...
 284:
            ...
            result = config.bind(tango)(vacuum, result);
            output[1] = result;
 ...
 932:
            yankee[3] = romeo;
            romeo = golf;
            if(!golf) { _fun117000_ip = 1128; continue _fun117000 }
 945:
            kilo = _closure1_slot11;
            ...
            output = function() { // Original name: onPress
                ...
                oscar = 'icymi_settings_action_sheet';
                report = 'double_tap_behavior_button';
                ...
                zulu = mike[zulu];
                mike = mike.paths;
                romeo = tango.bind(entity)(zulu, mike);
                yankee = 'ICYMISettingsDoubleTapActionSheet';
                offset = {};
                verify = 'stack';
                foxtrot = golf;
            ...
            output = result.bind(tango)(output);
            result = output.TableRowTrailingText;
            output = {};
            vacuum = _closure1_slot15;
            control = control.doubleTapBehavior;
            if(!(sequence == control)) { _fun117000_ip = 1102; continue _fun117000 }
 1070:
            config = _closure1_slot0;
            record = _closure1_slot2;
            sequence = 9;
            ...
            sequence = sequence.GravityICYMIDoubleTapBehavior;
            control = sequence.DEFAULT;
 1102:
            control = vacuum.bind(tango)(control);
            output['text'] = control;
            output = kilo.bind(tango)(result, output);
            foxtrot['trailing'] = output;
            romeo = kilo.bind(tango)(backup, foxtrot);
 1128:
            yankee[4] = romeo;
            ...
            kilo = function() { // Original name: onPress
                ...
                golf = options.trackItemInteraction;
                oscar = 'icymi_settings_action_sheet';
                zulu = 'custom_scoring_button';
                zulu = golf.bind(options)(oscar, oscar, zulu);
                zulu = _closure1_slot1;
                mike = 29;
                mike = tango[mike];
                ...
                yankee = mike.ICYMI_CUSTOM_SCORES_MODAL_KEY;
                report = {};
                mike = 'modal';
                report['presentation'] = mike;
                romeo = {};
                backup = verify;
                foxtrot = golf;
                offset = report;
            ...
            report = new Array(3);
            report[0] = offset;
            if(!golf) { _fun117000_ip = 1646; continue _fun117000 }
 1257:
            ...
            source = output.bind(tango)(source);
            source = source.t;
            source = source.asInfn;
            source = control.bind(vacuum)(source);
            romeo['label'] = source;
            source = 32;
            source = result[source];
            source = output.bind(tango)(source);
            control = source.AtIcon;
            source = {};
            source = kilo.bind(tango)(control, source);
            romeo['icon'] = source;
            ...
            backup = foxtrot.TableSwitchRow;
            foxtrot = {};
            update = function() { // Original name: onValueChange
                zulu = _closure2_slot3;
                mike = {};
