// app/modules/main_tabs_v2/native/tabs/gravity/custom_scores/ICYMIContentSettingControl.tsx
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    entity = function(argFoo) { // Original name: customScoreToIndex
 ...
 0:
            ...
            zulu = zulu.LESS;
            if(!(zulu !== mike)) { _fun116978_ip = 87; continue _fun116978 }
 44:
            ...
            entity = entity.MORE;
            if(!(entity !== mike)) { _fun116978_ip = 82; continue _fun116978 }
 77:
            entity = 1;
            return entity;
 82:
 ...
 87:
    ...
    entity = function(argFoo) { // Original name: ContentSettingsControl
        _fun116979: for(var _fun116979_ip = 0; ; ) switch(_fun116979_ip) {
 0:
            entity = argFoo;
            zulu = entity.initialValue;
            mike = entity.onValueUpdated;
            ...
            mike = 10;
            options = oscar[mike];
            romeo = output.bind(tango)(options);
            options = {};
            backup = 11;
            backup = oscar[backup];
            ...
            oscar = oscar.ICYMICustomScore;
            result = oscar.LESS;
            oscar = null;
            sizing = null;
            if(!(verify === result)) { _fun116979_ip = 241; continue _fun116979 }
 235:
            sizing = kilo.iconSelected;
 241:
            backup[1] = sizing;
            ...
            romeo = result[mike];
            foxtrot = update.bind(tango)(romeo);
            romeo = {};
            sizing = 12;
            ...
            result = result.ICYMICustomScore;
            echo = result.DEFAULT;
            result = null;
            if(!(verify === echo)) { _fun116979_ip = 421; continue _fun116979 }
 415:
            result = kilo.iconSelected;
 421:
            sizing[1] = result;
            romeo['style'] = sizing;
            ...
            backup = backup.ICYMICustomScore;
            sizing = backup.MORE;
            backup = null;
            if(!(verify === sizing)) { _fun116979_ip = 597; continue _fun116979 }
 591:
            backup = kilo.iconSelected;
 597:
            foxtrot[1] = backup;
            mike['style'] = foxtrot;
 ...
 0:
                    ...
                    zulu = zulu.DEFAULT;
                    tango = 0;
                    if(!(tango !== oscar)) { _fun116980_ip = 84; continue _fun116980 }
 46:
                    tango = 2;
                    if(!(tango === oscar)) { _fun116980_ip = 113; continue _fun116980 }
 53:
                    oscar = _closure1_slot0;
                    ...
                    zulu = tango.MORE;
                    _fun116980_ip = 113; continue _fun116980;
 84:
                    tango = _closure1_slot0;
 ...
 113:
            ...
            entity = {};
            oscar = null;
            if(!golf) { _fun116979_ip = 727; continue _fun116979 }
 708:
            verify = {};
            offset = 0.7;
 ...
 727:
            entity['style'] = oscar;
            oscar = 'auto';
            if(!golf) { _fun116979_ip = 742; continue _fun116979 }
 738:
            oscar = 'none';
 742:
            ...
            oscar = report.SegmentedControl;
            report = {};
            verify = 'experimental_Large';
    ...
    tango['customScoreWrapper'] = verify;
    verify = {};
    romeo = oscar[offset];
    romeo = yankee.bind(entity)(romeo);
    romeo = romeo.spacing;
    ...
    tango = 'modules/main_tabs_v2/native/tabs/gravity/custom_scores/ICYMIContentSettingControl.tsx';
    tango = report.bind(oscar)(tango);
    tango = function(argFoo) { // Original name: GuildScoreSettings
 ...
 0:
            ...
            zulu = report.numberToCustomScore;
            update = zulu.bind(report)(options);
 ...
 0:
                    ...
                    golf = options.customScoreToNumber;
                    report = verify[report];
                    report = oscar.bind(entity)(report);
                    oscar = report.ICYMICustomScore;
                    report = argFoo;
                    if(report) { _fun116983_ip = 104; continue _fun116983 }
 91:
                    report = oscar.MUTED;
                    report = golf.bind(options)(report);
                    _fun116983_ip = 115; continue _fun116983;
 104:
                    oscar = oscar.DEFAULT;
                    report = golf.bind(options)(oscar);
 115:
                    mike['guildScore'] = report;
                    mike = zulu.bind(tango)(mike);
                    return entity;
                }
            };
            result = report.bind(options)(mike, zulu);
 ...
 0:
                    ...
                    if(!(entity !== oscar)) { _fun116984_ip = 92; continue _fun116984 }
 14:
                    ...
                    tango = report.customScoreToNumber;
                    tango = tango.bind(report)(oscar);
                    entity['guildScore'] = tango;
                    entity = mike.bind(zulu)(entity);
 92:
                    entity = undefined;
                    return entity;
            ...
            romeo = {};
            source = source.name;
            romeo['guildName'] = source;
            romeo = kilo.bind(sizing)(backup, romeo);
            options['children'] = romeo;
            options = yankee.bind(tango)(verify, options);
            report[1] = options;
            options = null;
            if(echo) { _fun116981_ip = 472; continue _fun116981 }
 416:
            romeo = _closure1_slot8;
            yankee = _closure1_slot5;
            verify = {};
            backup = offset.customScoreWrapper;
            verify['style'] = backup;
            sizing = _closure1_slot8;
            kilo = _closure1_slot12;
            backup = {};
            backup['initialValue'] = update;
            backup['onValueUpdated'] = output;
 ...
 472:
            ...
            options = {};
            verify = echo;
            if(!verify) { _fun116981_ip = 498; continue _fun116981 }
 492:
            verify = offset.muted;
 498:
    ...
    zulu['GuildScoreSettings'] = tango;
    mike = function(argFoo) { // Original name: ChannelScoreSettings
 ...
 0:
                    ...
                    tango = tango.ICYMICustomScore;
                    tango = tango.UNKNOWN;
                    if(!(entity === tango)) { _fun116986_ip = 135; continue _fun116986 }
 68:
                    ...
                    zulu = zulu.ICYMICustomScore;
                    if(mike) { _fun116986_ip = 126; continue _fun116986 }
 118:
                    mike = zulu.DEFAULT;
                    _fun116986_ip = 132; continue _fun116986;
 126:
                    mike = zulu.MUTED;
 132:
                    entity = mike;
 135:
            ...
            control = yankee.bind(foxtrot)(offset, report);
            ...
            result = true;
            vacuum = report.bind(tango)(verify, result);
            zulu = romeo[zulu];
            verify = backup.bind(tango)(zulu);
 ...
 0:
                    ...
                    if(!(entity !== golf)) { _fun116988_ip = 115; continue _fun116988 }
 14:
                    mike = _closure1_slot1;
                    verify = _closure1_slot2;
                    entity = 17;
                    ...
                    tango = oscar.customScoreToNumber;
                    tango = tango.bind(oscar)(golf);
                    report['score'] = tango;
                    tango = new Array(1);
                    tango[0] = report;
                    entity['channelScores'] = tango;
                    entity = mike.bind(zulu)(entity);
 115:
                    entity = undefined;
                    return entity;
            ...
            output = report.bind(verify)(mike, zulu);
            report = _closure1_slot4;
            zulu = report.useCallback;
            mike = new Array(2);
            mike[0] = options;
 ...
 0:
                    ...
                    options = verify.customScoreToNumber;
                    report = offset[report];
                    report = golf.bind(entity)(report);
                    golf = report.ICYMICustomScore;
                    report = argFoo;
                    if(report) { _fun116989_ip = 114; continue _fun116989 }
 101:
                    report = golf.MUTED;
                    report = options.bind(verify)(report);
                    _fun116989_ip = 125; continue _fun116989;
 114:
                    golf = golf.DEFAULT;
 ...
 125:
            ...
            backup = romeo.KzkF1t;
            romeo = {};
            romeo['channelName'] = vacuum;
            romeo = kilo.bind(sizing)(backup, romeo);
            options['children'] = romeo;
            options = yankee.bind(tango)(verify, options);
            report[1] = options;
            options = null;
            if(source) { _fun116985_ip = 585; continue _fun116985 }
 525:
            romeo = _closure1_slot8;
            yankee = _closure1_slot5;
            verify = {};
            ...
            kilo = _closure1_slot12;
            backup = {};
            backup['disabled'] = echo;
            backup['initialValue'] = control;
            backup['onValueUpdated'] = output;
            backup = sizing.bind(tango)(kilo, backup);
            verify['children'] = backup;
            options = romeo.bind(tango)(yankee, verify);
 585:
            ...
            options = {};
            verify = source;
            if(!verify) { _fun116985_ip = 611; continue _fun116985 }
 605:
            verify = offset.muted;
 611:
            options['style'] = verify;
            ...
            source = !source;
            kilo['value'] = source;
            kilo['onValueChange'] = update;
            update = verify[foxtrot];
    ...
    zulu['ChannelScoreSettings'] = mike;
    return entity;
})();