...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
            ...
            yankee = mike.lineClamp;
            tango = undefined;
            if(!(yankee === tango)) { _fun117692_ip = 29; continue _fun117692 }
 26:
            yankee = 100;
 29:
            output = mike.visible;
            if(!(output === tango)) { _fun117692_ip = 41; continue _fun117692 }
 39:
            output = false;
 41:
            ...
            echo = mike.GRAVITY_VALID_EMBED_TYPES;
            vacuum = report;
            control = romeo;
            source = romeo;
            update = undefined;
            oscar = vacuum[zulu](control, source, update, echo, result);
 ...
 0:
                    ...
                    entity = 1;
                    zulu = entity !== zulu;
                    if(zulu) { _fun117693_ip = 49; continue _fun117693 }
 28:
                    entity = _closure2_slot0;
 ...
 49:
                    entity = !zulu;
                    if(zulu) { _fun117693_ip = 85; continue _fun117693 }
 55:
 ...
 85:
            ...
            entity = {};
            golf = backup.messagePreview;
            entity['style'] = golf;
            golf = !report;
            if(!golf) { _fun117692_ip = 330; continue _fun117692 }
 200:
            ...
            kilo = 0;
            yankee = undefined;
            if(!(kilo === foxtrot)) { _fun117692_ip = 310; continue _fun117692 }
 261:
            foxtrot = romeo.attachments;
            foxtrot = foxtrot.length;
            foxtrot = foxtrot > kilo;
            yankee = undefined;
            if(!foxtrot) { _fun117692_ip = 310; continue _fun117692 }
 281:
            foxtrot = romeo.embeds;
            foxtrot = foxtrot.length;
            yankee = undefined;
            if(!(kilo === foxtrot)) { _fun117692_ip = 310; continue _fun117692 }
 298:
            foxtrot = {};
            kilo = true;
            foxtrot['renderAttachments'] = kilo;
            yankee = foxtrot;
 310:
 ...
 330:
            ...
            options = 0;
            golf = golf > options;
            if(!golf) { _fun117692_ip = 468; continue _fun117692 }
 352:
            ...
            kilo = kilo.length;
            kilo = options === kilo;
            if(!kilo) { _fun117692_ip = 409; continue _fun117692 }
 393:
            sizing = {};
 ...
 409:
            ...
            backup = {};
            backup['message'] = romeo;
            backup['visible'] = output;
            backup = sizing.bind(tango)(kilo, backup);
            verify['children'] = backup;
            golf = foxtrot.bind(tango)(yankee, verify);
 468:
            report[1] = golf;
            oscar = oscar.length;
            oscar = options === oscar;
            if(!oscar) { _fun117692_ip = 499; continue _fun117692 }
 484:
            golf = romeo.embeds;
            golf = golf.length;
            oscar = golf > options;
 499:
            if(!oscar) { _fun117692_ip = 574; continue _fun117692 }
 502:
            verify = _closure1_slot7;
 ...
 0:
            ...
            tango = 0;
            if(!report) { _fun117694_ip = 136; continue _fun117694 }
 130:
            tango = -2;
 136:
            mike['marginTop'] = tango;
 ...
 0:
            ...
            sizing = mike.visible;
            offset = mike.messageContext;
            report = undefined;
            var _closure2_slot1 = report;
            mike = _closure1_slot9;
            context = mike.bind(report)();
            ...
            oscar = yankee == offset;
            mike = undefined;
            if(oscar) { _fun117695_ip = 86; continue _fun117695 }
 80:
            mike = offset.external_content_application_id;
 86:
            ...
            golf = yankee == vacuum;
            mike = undefined;
            if(golf) { _fun117695_ip = 131; continue _fun117695 }
 126:
            mike = vacuum.id;
 131:
            zulu[1] = mike;
 ...
 0:
                    ...
                    oscar = report == zulu;
                    zulu = undefined;
                    if(oscar) { _fun117696_ip = 86; continue _fun117696 }
 77:
                    oscar = _closure2_slot1;
                    zulu = oscar.id;
 86:
                    if(!(report != zulu)) { _fun117696_ip = 178; continue _fun117696 }
 90:
 ...
 0:
                    ...
                    zulu = null;
                    if(!(zulu != tango)) { _fun117697_ip = 162; continue _fun117697 }
 98:
                    zulu = 0;
                    oscar = tango[zulu];
                    zulu = _closure1_slot0;
 ...
 162:
            ...
            entity = function() {
                ...
                report = {};
                oscar = true;
                report['isICYMIGameContentForwarding'] = oscar;
            ...
            mike = yankee == vacuum;
            entity = null;
            if(mike) { _fun117695_ip = 1061; continue _fun117695 }
 234:
            zulu = yankee == offset;
            mike = undefined;
            if(zulu) { _fun117695_ip = 249; continue _fun117695 }
 243:
            mike = offset.external_content_application_id;
 249:
            mike = yankee == mike;
 ...
 261:
            ...
            golf = oscar.Text;
            oscar = {'variant': 'text-xs/semibold', 'color': 'text-muted'};
            kilo = context.header;
            oscar['style'] = kilo;
            sequence = 19;
            kilo = echo[sequence];
            kilo = options.bind(report)(kilo);
            config = kilo.intl;
            ...
            kilo = {};
            record = vacuum.name;
            kilo['applicationName'] = record;
            kilo = update.bind(config)(result, kilo);
            oscar['children'] = kilo;
            ...
            if(!(yankee == kilo)) { _fun117695_ip = 462; continue _fun117695 }
 457:
            kilo = output.id;
 462:
            ...
            record = 21;
            kilo = echo[record];
            result = papa.bind(report)(kilo);
            kilo = {};
            config = 22;
            config = echo[config];
            target = papa.bind(report)(config);
            papa = target.getApplicationIconSource;
            config = {};
            status = vacuum.id;
            config['id'] = status;
            status = vacuum.icon;
            ...
            kilo['size'] = record;
            kilo = update.bind(report)(result, kilo);
            golf['avatar'] = kilo;
            update = _closure1_slot7;
            kilo = echo[backup];
            kilo = config.bind(report)(kilo);
            result = kilo.Text;
            kilo = {'lineClamp': 1, 'variant': 'text-sm/medium', 'color': 'header-secondary'};
            vacuum = vacuum.name;
            ...
            backup = result.bind(report)(kilo, backup);
            golf['subtitle'] = backup;
            golf['onHeaderPress'] = romeo;
            golf['onHeaderLongPress'] = romeo;
            offset = offset.reference_message_id;
            if(!(yankee == offset)) { _fun117695_ip = 752; continue _fun117695 }
 747:
            offset = output.id;
 752:
            golf['id'] = offset;
            ...
            offset = {};
            backup = context.pressable;
            offset['style'] = backup;
            offset['onPress'] = foxtrot;
            kilo = _closure1_slot7;
            backup = _closure1_slot11;
            foxtrot = {};
            foxtrot['message'] = output;
            foxtrot['visible'] = sizing;
            ...
            config = config.bind(report)(control);
            control = {};
            context = context.icon;
            control['style'] = context;
            context = 'custom';
            control['size'] = context;
            control = record.bind(report)(config, control);
            output['icon'] = control;
            control = 'tertiary';
 ...
 1061:
    ...
    tango = function(argFoo) { // Original name: MessageRowWrapper
        ...
        mike = zulu.useGravityMessage;
        golf = mike.bind(zulu)(golf);
        zulu = _closure1_slot7;
        mike = _closure1_slot10;
        entity = {};
        entity['message'] = golf;
        entity['messageContext'] = oscar;
