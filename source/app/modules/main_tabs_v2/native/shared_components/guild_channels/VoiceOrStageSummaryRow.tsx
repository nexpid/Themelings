...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    tango = function(argFoo) {
        golf = argFoo;
        entity = {};
        mike = {'flexDirection': 'row', 'alignItems': 'center', 'marginLeft': 4294967294};
        entity['container'] = mike;
        mike = {'backgroundColor': null, 'borderRadius': null, 'display': 'flex', 'flexDirection': 'row', 'alignItems': 'center', 'justifyContent': 'center'};
        ...
        options = report.bind(tango)(options);
        options = options.colors;
        options = options.BG_BASE_PRIMARY;
 ...
 0:
            ...
            oscar = entity.max;
            tango = undefined;
            if(!(oscar === tango)) { _fun113407_ip = 25; continue _fun113407 }
 22:
            oscar = 5;
 25:
            ...
            entity = entity - oscar;
            romeo = 0;
            entity = mike.bind(zulu)(entity, romeo);
 ...
 0:
                    ...
                    if(!(!(options >= entity))) { _fun113408_ip = 384; continue _fun113408 }
 17:
                    entity = _closure2_slot0;
                    romeo = 1;
                    entity = entity - romeo;
                    if(!(options === entity)) { _fun113408_ip = 45; continue _fun113408 }
 32:
                    entity = _closure2_slot3;
                    golf = 0;
                    if(!(!(entity > golf))) { _fun113408_ip = 194; continue _fun113408 }
 45:
                    ...
                    oscar = 0;
                    oscar = oscar !== options;
                    if(!oscar) { _fun113408_ip = 101; continue _fun113408 }
 85:
                    verify = {};
                    offset = -12;
 ...
 101:
                    ...
                    _fun113408_ip = 382; continue _fun113408;
 194:
                    ...
                    mike[0] = verify;
                    golf = golf !== options;
                    if(!golf) { _fun113408_ip = 248; continue _fun113408 }
 232:
                    options = {};
                    verify = -12;
 ...
 248:
                    ...
                    verify = options.bind(zulu)(offset, verify);
 ...
 384:
            ...
            oscar = null;
            oscar = oscar != output;
            if(!oscar) { _fun113407_ip = 240; continue _fun113407 }
 236:
            oscar = output > romeo;
 240:
            if(!oscar) { _fun113407_ip = 521; continue _fun113407 }
 246:
            verify = _closure1_slot4;
            options = _closure1_slot3;
            golf = {};
            foxtrot = kilo.wrapper;
            offset = new Array(2);
            offset[0] = foxtrot;
            yankee = yankee.length;
            yankee = yankee > romeo;
            if(!yankee) { _fun113407_ip = 298; continue _fun113407 }
 282:
            romeo = {};
            foxtrot = -12;
 ...
 521:
    ...
    tango = 'modules/main_tabs_v2/native/shared_components/guild_channels/VoiceOrStageSummaryRow.tsx';
