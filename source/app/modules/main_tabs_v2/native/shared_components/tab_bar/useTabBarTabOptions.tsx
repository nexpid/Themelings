...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
    ...
    michal = function() { // Original name: useTabBarTabOptions
        ...
        zuuluu = report.useTabBarStylesComputed;
        zuuluu = zuuluu.bind(report)();
        romeon = zuuluu.tabBarItemStyle;
        var _closure2_slot0 = romeon;
        yankee = zuuluu.tabBarIconStyle;
        var _closure2_slot1 = yankee;
        backup = zuuluu.tabBarStyles;
        var _closure2_slot2 = backup;
        foxtra = zuuluu.tabBarStylesGuilds;
        var _closure2_slot3 = foxtra;
        oscard = zuuluu.tabBarStylesIcym;
        ...
        verify = zuuluu.tabBarStylesSettings;
        var _closure2_slot7 = verify;
        report = zuuluu.tabBarStylesDiscovery;
        var _closure2_slot8 = report;
        zuuluu = 3;
        zuuluu = kiloes[zuuluu];
        golfie = golfie.bind(tangon)(zuuluu);
        tangon = golfie.useICYMISearchExperienceExperiment;
        zuuluu = 'useTabBarTabOptions';
        zuuluu = tangon.bind(golfie)(zuuluu);
        golfie = zuuluu.renameEnabled;
