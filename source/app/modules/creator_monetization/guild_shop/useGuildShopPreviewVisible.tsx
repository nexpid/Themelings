...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
 ...
 0:
                    ...
                    entity = null;
                    entity = entity != zulu;
                    if(!entity) { _fun81455_ip = 49; continue _fun81455 }
 16:
 ...
 49:
            ...
            zulu = undefined;
            if(oscar) { _fun81454_ip = 169; continue _fun81454 }
 148:
 ...
 169:
            oscar = entity != zulu;
            if(!oscar) { _fun81454_ip = 179; continue _fun81454 }
 176:
            oscar = zulu;
 179:
            ...
            zulu = entity == options;
            offset = undefined;
            if(zulu) { _fun81454_ip = 219; continue _fun81454 }
 214:
            offset = options.id;
 219:
 ...
 0:
                    ...
                    zulu = mike == zulu;
                    mike = undefined;
                    if(zulu) { _fun81456_ip = 36; continue _fun81456 }
 18:
 ...
 36:
            ...
            if(!entity) { _fun81454_ip = 295; continue _fun81454 }
 292:
            entity = golf;
 295:
            if(!entity) { _fun81454_ip = 301; continue _fun81454 }
 298:
            entity = !oscar;
 301:
            if(!entity) { _fun81454_ip = 307; continue _fun81454 }
 304:
            entity = report;
 307:
            if(!entity) { _fun81454_ip = 313; continue _fun81454 }
 310:
            entity = tango;
 313:
            if(!entity) { _fun81454_ip = 319; continue _fun81454 }
 316:
            entity = zulu;
 319:
            if(!entity) { _fun81454_ip = 325; continue _fun81454 }
 322:
            entity = !mike;
 325:
            return entity;
