...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    entity = function(argFoo) { // Original name: DiscoverabilityLandingScene
        _fun124316: for(var _fun124316_ip = 0; ; ) switch(_fun124316_ip) {
 0:
            entity = argFoo;
            golf = entity.onComplete;
            ...
            report[0] = zulu;
            zulu = function() {
                _fun124317: for(var _fun124317_ip = 0; ; ) switch(_fun124317_ip) {
 0:
                    ...
                    zulu = entity == mike;
                    entity = undefined;
                    if(zulu) { _fun124317_ip = 33; continue _fun124317 }
 27:
                    entity = mike.phone;
 33:
                    return entity;
            ...
            romeo = zulu.allowPhone;
            var _closure2_slot3 = romeo;
            yankee = zulu.allowEmail;
            var _closure2_slot4 = yankee;
            offset = romeo;
            if(offset) { _fun124316_ip = 141; continue _fun124316 }
 138:
            offset = yankee;
 141:
            ...
            zulu[5] = golf;
            mike = function() {
                _fun124318: for(var _fun124318_ip = 0; ; ) switch(_fun124318_ip) {
 0:
                    ...
                    if(!tango) { _fun124318_ip = 83; continue _fun124318 }
 66:
                    report = _closure2_slot2;
                    tango = null;
                    if(!(tango != report)) { _fun124318_ip = 83; continue _fun124318 }
 76:
                    tango = _closure2_slot3;
                    if(tango) { _fun124318_ip = 93; continue _fun124318 }
 83:
                    tango = _closure2_slot0;
                    tango = tango.bind(entity)();
                    _fun124318_ip = 139; continue _fun124318;
 93:
 ...
 139:
    ...
    entity = function(argFoo) { // Original name: DiscoverabilityNameScene
        _fun124319: for(var _fun124319_ip = 0; ; ) switch(_fun124319_ip) {
 0:
            mike = argFoo;
            options = mike.onComplete;
            ...
            golf = offset.useEffect;
            zulu = new Array(2);
            zulu[0] = mike;
            zulu[1] = options;
            mike = function() {
                _fun124320: for(var _fun124320_ip = 0; ; ) switch(_fun124320_ip) {
 0:
                    mike = _closure2_slot1;
                    if(mike) { _fun124320_ip = 20; continue _fun124320 }
 10:
 ...
 20:
            ...
            entity = function(argFoo) {
                ...
                zulu = tango.startContactSyncForDiscoverability;
                mike = argFoo;
                mike = zulu.bind(tango)(mike);
                mike = _closure2_slot0;
            ...
            options = '';
            if(!offset) { _fun124319_ip = 188; continue _fun124319 }
 185:
            options = verify;
 188:
    ...
    mike = function(argFoo) { // Original name: RedesignDiscoverabilityModal
        entity = argFoo;
        entity = entity.route;
        entity = entity.params;
        yankee = entity.onComplete;
        ...
        entity = {};
        golf = golf.header;
        entity['headerStyle'] = golf;
        offset = _closure1_slot3;
        golf = offset.useMemo;
        oscar = new Array(1);
        oscar[0] = yankee;
        report = function() {
            _fun124323: for(var _fun124323_ip = 0; ; ) switch(_fun124323_ip) {
 0:
                tango = _closure2_slot0;
                zulu = null;
                if(!(zulu == tango)) { _fun124323_ip = 24; continue _fun124323 }
 15:
                zulu = function() {
                    entity = undefined;
                    return entity;
                };
                _fun124323_ip = 28; continue _fun124323;
 24:
 ...
 28:
                mike = function(argFoo) { // Original name: getScreens
                    ...
                    offset = function(argFoo) { // Original name: headerRight
        ...
        report = golf.bind(offset)(report, oscar);
    ...
    tango = {};
    yankee = {'borderBottomWidth': 0, 'backgroundColor': null, 'shadowColor': 'transparent'};
    romeo = 7;
    backup = oscar[romeo];
    ...
    tango = 'modules/nuf/native/components/RedesignDiscoverabilityModal.tsx';
    tango = report.bind(oscar)(tango);
    zulu['default'] = mike;
    return entity;
})();