...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
    ...
    tango = tango.GameConsoleCommandResultErrorCodes;
    ...
    mike = function(argFoo, argBar, argBaz) { // Original name: getErrorMessageForCommandResult
        _fun123665: for(var _fun123665_ip = 0; ; ) switch(_fun123665_ip) {
 0:
            mike = argFoo;
            report = argBar;
            oscar = argBaz;
            entity = 'failed';
            if(!(entity !== report)) { _fun123665_ip = 213; continue _fun123665 }
 22:
            tango = 'n/a';
            entity = null;
            if(!(tango === report)) { _fun123665_ip = 950; continue _fun123665 }
 37:
            golf = oscar.code;
            kilo = mike.platform;
            offset = mike.name;
            ...
            zulu = null;
            if(!(golf === tango)) { _fun123665_ip = 205; continue _fun123665 }
 75:
            tango = {};
            ...
            options = yankee.bind(golf)(options);
            options = options.t;
            verify = options.KchfhI;
            options = {};
            options['deviceType'] = kilo;
            options = foxtrot.bind(backup)(verify, options);
            tango['title'] = options;
            options = romeo[report];
            options = yankee.bind(golf)(options);
            verify = options.intl;
            ...
            golf = report.21ndz8;
            report = {};
            report['deviceName'] = offset;
            report = options.bind(verify)(golf, report);
            tango['body'] = report;
            zulu = tango;
 205:
            entity = zulu;
            _fun123665_ip = 950; continue _fun123665;
 213:
            zulu = oscar.code;
            ...
            if(!(mike !== zulu)) { _fun123665_ip = 825; continue _fun123665 }
 249:
            mike = _closure1_slot3;
            mike = mike.CONSOLE_DEVICE_INVALID_POWER_MODE;
            if(!(mike !== zulu)) { _fun123665_ip = 693; continue _fun123665 }
 266:
            mike = _closure1_slot3;
            mike = mike.CONSOLE_DEVICE_UNVAILABLE_FROM_OTHER_USERS;
            if(!(mike !== zulu)) { _fun123665_ip = 558; continue _fun123665 }
 283:
            mike = _closure1_slot3;
            mike = mike.CONSOLE_DEVICE_ACCOUNT_LINK_ERROR;
            if(!(mike !== zulu)) { _fun123665_ip = 424; continue _fun123665 }
 300:
            mike = {};
            ...
            mike['body'] = zulu;
            _fun123665_ip = 947; continue _fun123665;
 424:
            zulu = {};
 ...
 558:
            ...
            options = romeo.bind(golf)(options);
            options = options.t;
            offset = options.M6Vzam;
            options = {};
            options['deviceType'] = verify;
            options = backup.bind(kilo)(offset, options);
            zulu['title'] = options;
            options = foxtrot[report];
            options = romeo.bind(golf)(options);
            offset = options.intl;
 ...
 950:
            mike = null;
            if(!(mike != entity)) { _fun123665_ip = 1066; continue _fun123665 }
 956:
            ...
            golf = options.getSubmitRequestURL;
            golf = golf.bind(options)();
            mike['supportURL'] = golf;
            oscar = oscar.code;
            mike['errorCode'] = oscar;
            mike = tango.bind(report)(zulu, mike);
            entity['errorCodeMessage'] = mike;
 1066:
            return entity;
        }
    };
