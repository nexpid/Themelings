...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    tango = {};
    offset = {'flex': 1, 'alignSelf': 'stretch', 'justifyContent': 'center', 'alignItems': 'center'};
    tango['container'] = offset;
    offset = {'height': 480, 'width': 480, 'borderRadius': 240, 'position': 'absolute', 'backgroundColor': null, 'opacity': 0.5, 'zIndex': 0};
    yankee = 4;
    ...
    tango['outerCircle'] = offset;
    offset = {'height': 400, 'width': 400, 'borderRadius': 200, 'position': 'absolute', 'backgroundColor': null, 'zIndex': 1};
    yankee = oscar[yankee];
    yankee = romeo.bind(entity)(yankee);
    yankee = yankee.colors;
    yankee = yankee.BACKGROUND_PRIMARY;
    offset['backgroundColor'] = yankee;
    tango['innerCircle'] = offset;
    offset = {'flex': 1, 'alignSelf': 'stretch', 'justifyContent': 'center', 'alignItems': 'center', 'zIndex': 2, 'position': 'relative'};
    tango['content'] = offset;
    offset = {'width': 120, 'height': 80};
    tango['image'] = offset;
    offset = {'textAlign': 'center', 'marginTop': 16, 'marginHorizontal': 20};
    tango['title'] = offset;
    offset = {'textAlign': 'center', 'marginTop': 4, 'marginHorizontal': 20};
 ...
 27:
            yankee = 0;
 29:
            control = entity.channelName;
            source = entity.tagFilter;
 ...
 183:
            ...
            kilo = output.isThemeLight;
            kilo = kilo.bind(output)(result);
            result = _closure1_slot1;
            echo = _closure1_slot2;
            if(kilo) { _fun00002_ip = 271; continue _fun00001 }
 257:
            kilo = 9;
            kilo = echo[kilo];
 ...
 283:
            ...
            backup = romeo.Text;
            romeo = {'style': null, 'accessibilityRole': 'header', 'variant': 'heading-lg/semibold', 'color': 'header-primary'};
 ...
 627:
            ...
            offset = {};
            backup = foxtrot.innerCircle;
            offset['style'] = backup;
            offset = romeo.bind(tango)(yankee, offset);
            verify[1] = offset;
            offset = {};
            foxtrot = foxtrot.outerCircle;
 ...
 755:
    ...
    tango = 'modules/forums/native/ForumChannelEmptyState.tsx';
