...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 38:
                    ...
                    if(!(zulu == offset)) { _fun00006_ip = 175; continue _fun00005 }
 125:
 ...
 215:
                    ...
                    options = 0;
                    if(!(!(yankee > options))) { _fun00006_ip = 275; continue _fun00005 }
 226:
                    verify = verify.length;
                    if(!(!(verify > options))) { _fun00006_ip = 275; continue _fun00005 }
 235:
                    yankee = zulu == offset;
                    verify = undefined;
                    if(yankee) { _fun00006_ip = 249; continue _fun00005 }
 244:
                    verify = offset.name;
 249:
                    offset = zulu != verify;
                    zulu = '';
                    if(!offset) { _fun00006_ip = 263; continue _fun00005 }
 260:
                    zulu = verify;
 263:
                    zulu = zulu.length;
 ...
 679:
            ...
            mike = zulu == sizing;
            entity = null;
            if(mike) { _fun00002_ip = 554; continue _fun00001 }
 361:
