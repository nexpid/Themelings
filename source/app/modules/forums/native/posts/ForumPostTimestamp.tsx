...
export default (function(argFoo, argBar, _, argCorge, __, argFred, argPlugh) {
    ...
    tango = {};
    verify = {'lineHeight': 18, 'height': 18};
    tango['text'] = verify;
 ...
 0:
            ...
            zulu = offset.parent_id;
            zulu = report.bind(tango)(zulu);
            oscar = zulu.sortOrder;
            ...
            oscar = 'text-muted';
            if(!mike) { _fun00002_ip = 108; continue _fun00001 }
 102:
 ...
 108:
            ...
            mike = entity.Text;
            entity = {'lineClamp': 1, 'variant': 'text-xs/normal'};
            entity['color'] = oscar;
            oscar = new Array(2);
            oscar[0] = options;
            golf = golf.text;
