...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 0:
                    ...
                    entity = null;
                    if(!(entity != zulu)) { _fun81083_ip = 217; continue _fun81083 }
 16:
                    tango = _closure2_slot0;
                    zulu = '';
                    if(!(zulu !== tango)) { _fun81083_ip = 217; continue _fun81083 }
 31:
                    ...
                    report = oscar.generateDisplayableCode;
                    tango = _closure2_slot2;
                    zulu = _closure2_slot1;
                    report = report.bind(oscar)(golf, tango, zulu);
                    if(!(entity != report)) { _fun81083_ip = 215; continue _fun81083 }
 112:
                    zulu = global;
                    golf = zulu.RegExp;
                    ...
                    tango = '.{1,';
                    mike = '}';
                    yankee = oscar.bind(tango)(options, mike);
                    mike = golf.prototype;
                    ...
                    tango = entity == report;
                    mike = null;
                    if(tango) { _fun81083_ip = 213; continue _fun81083 }
 197:
                    tango = zulu.Array;
                    zulu = tango.from;
 ...
 217:
            ...
            mike = null;
            if(!(mike != tango)) { _fun81082_ip = 94; continue _fun81082 }
 82:
            zulu = '';
            if(!(zulu !== tango)) { _fun81082_ip = 94; continue _fun81082 }
 90:
            if(!(mike != entity)) { _fun81082_ip = 96; continue _fun81082 }
 94:
            return entity;
 96:
            entity = global;
            ...
            verify = '[useReadableSecureFramesCode] Failed to parse base 64 code.';
            offset = mike;
    ...
    zulu['useReadableSecureFramesFingerprint'] = mike;
    return entity;
})();