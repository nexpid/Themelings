...
export default (function(argFoo, argBar, argBaz, _, __, argFred, argPlugh) {
    ...
    entity = function(argFoo, argBar, argBaz) { // Original name: _callSuper
        _fun123735: for(var _fun123735_ip = 0; ; ) switch(_fun123735_ip) {
 0:
            tango = argFoo;
            oscar = argBaz;
            ...
            if(entity) { _fun123735_ip = 51; continue _fun123735 }
 38:
            entity = verify.apply;
            entity = entity.bind(verify)(tango, oscar);
            _fun123735_ip = 92; continue _fun123735;
 51:
            golf = global;
            options = golf.Reflect;
            golf = options.construct;
            if(oscar) { _fun123735_ip = 71; continue _fun123735 }
 67:
            oscar = new Array(0);
 71:
 ...
 92:
    ...
    entity = function() { // Original name: _isNativeReflectConstruct
        _fun123736: for(var _fun123736_ip = 0; ; ) switch(_fun123736_ip) {
 0:
 2: // try_start_0
            mike = global;
            zulu = mike.Boolean;
 ...
 72: // try_end0
            _fun123736_ip = 76; continue _fun123736;
 74: // catch_target0
 ...
 76:
    ...
    mike = function(argFoo) {
        zulu = function(argFoo) { // Original name: MemberVerificationApplicationManager
            ...
            entity['actions'] = zulu;
            mike = function() {
                _fun123744: for(var _fun123744_ip = 0; ; ) switch(_fun123744_ip) {
 0:
                    ...
                    tango = null;
                    if(!(tango != offset)) { _fun123744_ip = 445; continue _fun123744 }
 32:
                    ...
                    entity = undefined;
                    report = undefined;
                    if(zulu) { _fun123744_ip = 68; continue _fun123744 }
 62:
 ...
 68:
                    ...
                    zulu = zulu.APPROVED;
                    if(!(report === zulu)) { _fun123744_ip = 443; continue _fun123744 }
 107:
                    report = _closure3_slot0;
                    report = report.isShowingAlert;
                    if(!report) { _fun123744_ip = 145; continue _fun123744 }
 123:
                    golf = tango == oscar;
                    report = undefined;
                    if(golf) { _fun123744_ip = 138; continue _fun123744 }
 132:
                    report = oscar.lastSeen;
 138:
                    if(!(tango === report)) { _fun123744_ip = 401; continue _fun123744 }
 145:
                    report = _closure3_slot0;
                    report = report.isShowingAlert;
                    if(report) { _fun123744_ip = 443; continue _fun123744 }
 161:
                    if(!(tango != oscar)) { _fun123744_ip = 443; continue _fun123744 }
 168:
                    golf = tango == oscar;
                    report = undefined;
                    if(golf) { _fun123744_ip = 183; continue _fun123744 }
 177:
                    report = oscar.lastSeen;
 183:
                    if(!(tango === report)) { _fun123744_ip = 443; continue _fun123744 }
 190:
                    ...
                    report = tango == golf;
                    tango = undefined;
                    if(report) { _fun123744_ip = 234; continue _fun123744 }
 213:
 ...
 234:
                    if(tango) { _fun123744_ip = 278; continue _fun123744 }
 237:
                    ...
                    _fun123744_ip = 387; continue _fun123744;
 278:
 ...
 387:
                    ...
                    _fun123744_ip = 443; continue _fun123744;
 401:
 ...
 445:
                    ...
                    if(!zulu) { _fun123744_ip = 505; continue _fun123744 }
 461:
