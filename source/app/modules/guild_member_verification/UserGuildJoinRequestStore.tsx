...
export default (function(argFoo, argBar, argBaz, _, __, argFre, argPlu) {
 ...
 0:
            ...
            if(!(entity === zuuluu)) { _fun00006_ip = 28; continue _fun00005 }
 22:
            entity = null;
 ...
 0:
            ...
            oscard = null;
            if(!(oscard != report)) { _fun00008_ip = 118; continue _fun00007 }
 20:
            ...
            if(!(oscard != tangon)) { _fun00008_ip = 65; continue _fun00007 }
 51:
            oscard = report.userId;
            tangon = tangon.id;
            if(!(oscard === tangon)) { _fun00008_ip = 122; continue _fun00007 }
 65:
