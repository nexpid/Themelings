...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    tango = ['discord', 'hypesquad', 'snowsgiving', 'system message', 'system mesage', 'sustem mesage', 'sustem message'];
    ...
    tango = 'modules/auth/native/components/RegisterDisplayName.tsx';
 ...
 0:
                    ...
                    zulu = entity != mike;
                    entity = '';
                    if(!zulu) { _fun111705_ip = 45; continue _fun111705 }
 42:
                    entity = mike;
 45:
                    return entity;
            ...
            if(mike) { _fun111703_ip = 296; continue _fun111703 }
 170:
            ...
            yankee = 0;
            romeo = undefined;
            if(!mike) { _fun111703_ip = 351; continue _fun111703 }
 193:
            output = oscar[yankee];
            mike = foxtrot.toLowerCase;
            kilo = mike.bind(foxtrot)();
            mike = kilo.includes;
            mike = mike.bind(kilo)(output);
            if(mike) { _fun111703_ip = 239; continue _fun111703 }
 220:
            yankee = yankee + 1;
            mike = oscar.length;
            mike = yankee < mike;
            romeo = undefined;
            if(mike) { _fun111703_ip = 193; continue _fun111703 }
 237:
            _fun111703_ip = 351; continue _fun111703;
 239:
 ...
 351:
            ...
            mike = oscar.useUURegistrationExperiment;
            mike = mike.bind(oscar)();
            output = mike.suggestions;
            var _closure2_slot4 = output;
            oscar = options.useContext;
            mike = 13;
            mike = report[mike];
            mike = golf.bind(tango)(mike);
            mike = mike.TrackRegistrationContext;
            kilo = oscar.bind(options)(mike);
            ...
            oscar = function() {
                ...
                tango = tango.ACCOUNT_DISPLAY_NAME;
                mike['step'] = tango;
            ...
            oscar = yankee.bind(options)(oscar, golf);
 ...
 0:
                            ...
                            if(mike) { _fun111709_ip = 325; continue _fun111709 }
 13:
                            report = _closure1_slot8;
                            tango = {};
                            tango['globalName'] = golf;
                            mike = undefined;
                            tango = report.bind(mike)(tango);
                            report = _closure1_slot9;
                            tango = report.getState;
                            tango = tango.bind(report)();
                            report = tango.registrationOptions;
                            ...
                            oscar['actionType'] = verify;
                            oscar = options.bind(mike)(oscar);
                            options = report.username;
                            oscar = null;
                            oscar = oscar != options;
                            if(!oscar) { _fun111709_ip = 125; continue _fun111709 }
 112:
                            options = report.username;
                            report = '';
 ...
 125:
                            report = !oscar;
                            if(oscar) { _fun111709_ip = 135; continue _fun111709 }
 131:
                            report = _closure2_slot4;
 135:
                            if(!report) { _fun111709_ip = 224; continue _fun111709 }
 138:
                            oscar = _closure2_slot1;
                            report = true;
                            report = oscar.bind(mike)(report);
                            oscar = _closure1_slot7;
                            report = oscar.wasRegistrationSuggestionFetched;
                            report = report.bind(oscar)(golf);
                            if(report) { _fun111709_ip = 213; continue _fun111709 }
 169:
                            ...
                            report = oscar.fetchSuggestionsRegistration;
                            report = report.bind(oscar)(golf);
 ...
 204:
                            ...
                            if(!oscar) { _fun111709_ip = 213; continue _fun111709 }
 210:
                            return report;
 213:
                            oscar = _closure2_slot1;
 ...
 224:
                            ...
                            options = golf.ACCOUNT_DISPLAY_NAME;
                            report['step'] = options;
                            golf = golf.ACCOUNT_INFORMATION;
                            report['toStep'] = golf;
                            golf = _closure1_slot11;
                            golf = golf.SUCCESS;
                            report['actionType'] = golf;
                            report = oscar.bind(mike)(report);
                            ...
                            zulu = zulu.AuthStates;
                            zulu = zulu.REGISTER_ACCOUNT_INFORMATION;
 ...
 325:
            ...
            oscar[1] = output;
            oscar[2] = kilo;
            yankee = yankee.bind(options)(golf, oscar);
            ...
            yankee = null;
            output = romeo;
            if(!(yankee != entity)) { _fun111703_ip = 580; continue _fun111703 }
 577:
            output = entity;
 580:
 ...
 0:
                    ...
                    mike = '';
                    if(!(mike !== tango)) { _fun111714_ip = 31; continue _fun111714 }
 28:
                    mike = entity;
 31:
                    entity = undefined;
            ...
            update = 'next';
            options['returnKeyType'] = update;
            update = function() { // Original name: onSubmitEditing
                zulu = _closure2_slot6;
            ...
            options['onSubmitEditing'] = update;
            update = 'nickname';
            options['textContentType'] = update;
            options['errorMessage'] = output;
            update = result[echo];
 ...
 862:
            ...
            options['isClearable'] = output;
            options = golf.bind(tango)(kilo, options);
            ...
            yankee = yankee != romeo;
            if(yankee) { _fun111703_ip = 1047; continue _fun111703 }
 1029:
            romeo = foxtrot.trim;
