...
export default (function(argFoo, argBar, argBaz, argCor, _, argFre, argPlu) {
 ...
 0:
            vacuum = function() { // Original name: handleSubmit
                entity = undefined;
 ...
 10:
                            ...
                            verify = golfie.bind(michal)(tangon);
                            option = _closure2_slot2;
                            golfie = null;
                            option = golfie != option;
                            golfie = 'birthday was not null';
                            golfie = verify.bind(michal)(option, golfie);
                            option = _closure1_slot10;
                            golfie = {};
                            verify = _closure2_slot2;
                            golfie['birthday'] = verify;
 ...
 86:
                            ...
                            verify = !yankee;
 93:
                            golfie['consent'] = verify;
                            golfie = option.bind(michal)(golfie);
                            option = _closure1_slot11;
                            golfie = option.getState;
                            golfie = golfie.bind(option)();
                            option = golfie.registrationOptions;
                            offset = option;
                            verify = _closure2_slot1;
                            golfie = {};
                            romeon = _closure1_slot12;
                            yankee = romeon.AGE_GATE;
                            golfie['step'] = yankee;
                            yankee = _closure1_slot13;
                            foxtra = yankee.SUBMITTED;
                            golfie['actionType'] = foxtra;
 ...
 557:
            ...
            michal = result.useContext;
            entity = 15;
            entity = oscard[entity];
            entity = zuuluu.bind(tangon)(entity);
            entity = entity.TrackRegistrationContext;
            entity = michal.bind(result)(entity);
 ...
 287:
            michal = kiloes;
 290:
            michal = romeon.bind(result)(michal);
            michal = backup.bind(tangon)(michal, option);
 ...
 32:
            ...
            romeon = kiloes.bind(result)(michal, romeon);
            michal = result.useState;
            output = false;
            michal = michal.bind(result)(output);
            michal = backup.bind(tangon)(michal, option);
            ...
            michal = {};
            option = 'RegisterAgeGate';
            michal['location'] = option;
            michal = golfie.bind(tangon)(michal);
            option = michal.streamlineErrorsCTAsEnabled;
            michal = 17;
            michal = oscard[michal];
            ...
            source = golfie.bind(backup)(zuuluu, michal);
            ...
            if(!(foxtra == papara)) { _fun00002_ip = 533; continue _fun00001 }
 528:
 ...
 533:
            ...
            entity = entity.bind(tangon)(quebec);
            ctrled = !entity;
            ...
            output = backup.bind(tangon)(golfie);
            golfie = {};
            ...
            result = echoed.bind(sequen)(result);
            golfie['headerText'] = result;
            result = verify.flexGrow;
            golfie['contentStyle'] = result;
            result = {};
            sequen = verify.inputGroup;
            echoed = new Array(2);
            echoed[0] = sequen;
            sequen = null;
            if(!source) { _fun00002_ip = 754; continue _fun00001 }
 748:
            sequen = verify.inputGroupConsentRequired;
 754:
            echoed[1] = sequen;
            result['style'] = echoed;
            sequen = null;
 ...
 767:
            ...
            sequen = null;
            if(!echoed) { _fun00002_ip = 822; continue _fun00001 }
 776:
            echoed = '';
            sequen = null;
            if(!(echoed !== papara)) { _fun00002_ip = 822; continue _fun00001 }
 786:
            ...
            config = config.bind(tangon)(echoed);
            echoed = {};
            echoed['children'] = papara;
            sequen = record.bind(tangon)(config, echoed);
 822:
            echoed = new Array(2);
            echoed[0] = sequen;
            record = _closure1_slot14;
            ...
            target = target.t;
            target = target.xNpFJy;
            target = status.bind(sierra)(target);
            sequen['label'] = target;
            target = null;
            if(!ctrled) { _fun00002_ip = 976; continue _fun00001 }
 915:
            status = foxtra != quebec;
            target = null;
            if(!status) { _fun00002_ip = 976; continue _fun00001 }
 924:
 ...
 976:
            ...
            status = target.InputButton;
            target = {};
            whisks = foxtra == quebec;
            limora = undefined;
            if(whisks) { _fun00002_ip = 1036; continue _fun00001 }
 1022:
 ...
 1036:
            ...
            limora = limora[backup];
            limora = quebec.bind(tangon)(limora);
            limora = limora.t;
            limora = limora.hZaF/P;
            limora = whisks.bind(equals)(limora);
            target['accessibilityHint'] = limora;
 ...
 1253:
            ...
            echoed['style'] = record;
            record = !option;
            if(!record) { _fun00002_ip = 1381; continue _fun00001 }
 1267:
            sierra = _closure1_slot14;
            quebec = _closure1_slot0;
            limora = _closure1_slot2;
            ...
            status = target.Button;
            target = {};
            whisks = 'lg';
            target['size'] = whisks;
            target['loading'] = update;
            target['disabled'] = ctrled;
            ...
            limora = quebec.bind(tangon)(limora);
            limora = limora.t;
            limora = limora.wC4TlZ;
            limora = whisks.bind(equals)(limora);
            target['text'] = limora;
            record = sierra.bind(tangon)(status, target);
 1381:
            echoed['children'] = record;
            echoed = config.bind(tangon)(sequen, echoed);
            result[1] = echoed;
            echoed = null;
            if(option) { _fun00002_ip = 1455; continue _fun00001 }
 1400:
            sequen = foxtra == papara;
            echoed = null;
            if(sequen) { _fun00002_ip = 1455; continue _fun00001 }
 1409:
            sequen = '';
            echoed = null;
            if(!(sequen !== papara)) { _fun00002_ip = 1455; continue _fun00001 }
 1419:
            record = _closure1_slot14;
            config = _closure1_slot1;
            target = _closure1_slot2;
 ...
 1455:
            result[2] = echoed;
            echoed = !option;
            if(!echoed) { _fun00002_ip = 1532; continue _fun00001 }
 1465:
            record = _closure1_slot14;
            config = _closure1_slot1;
            ...
            sequen = {};
            papara = global;
            papara = papara.Boolean;
            papara = papara.bind(tangon)(source);
            sequen['consentRequired'] = papara;
            sequen['consent'] = cntext;
            cntext = function() { // Original name: onToggleConsent
 ...
 1532:
            ...
            golfie = new Array(2);
            golfie[0] = output;
            if(!option) { _fun00002_ip = 1619; continue _fun00001 }
 1557:
            ...
            update = true;
            output['privacy'] = update;
            output['consentRequired'] = source;
            output['finalPage'] = update;
 ...
 1619:
            ...
            backup = 'dark';
            if(!kiloes) { _fun00002_ip = 1773; continue _fun00001 }
 1769:
            backup = 'light';
 1773:
            oscard['theme'] = backup;
            if(!(foxtra == romeon)) { _fun00002_ip = 1785; continue _fun00001 }
 1781:
