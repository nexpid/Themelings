...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
    ...
    tango = 'modules/auth/native/components/VerifyPhone.tsx';
    tango = report.bind(oscar)(tango);
    mike = function(argFoo) { // Original name: VerifyPhone
        entity = argFoo;
        kilo = entity.title;
        backup = entity.description;
        echo = entity.phone;
        var _closure2_slot0 = echo;
        result = entity.onPhoneTokenReceived;
        var _closure2_slot1 = result;
        zulu = entity.onClose;
        var _closure2_slot2 = zulu;
        verify = entity.onBail;
        sizing = _closure1_slot5;
        zulu = sizing.useState;
        golf = false;
        zulu = zulu.bind(sizing)(golf);
        yankee = _closure1_slot4;
        tango = undefined;
        offset = 2;
        zulu = yankee.bind(tango)(zulu, offset);
        oscar = 0;
        report = zulu[oscar];
        options = 1;
        zulu = zulu[options];
        ...
        zulu = function() {
            ...
            tango = tango.PHONE_VERIFICATION;
            mike['step'] = tango;
        ...
        zulu = romeo.bind(sizing)(zulu, golf);
        zulu = 8;
        zulu = offset[zulu];
        golf = options.bind(tango)(zulu);
        zulu = function() {
 ...
 0:
                    ...
                    tango = undefined;
                    entity = undefined;
                    if(zulu) { _fun111756_ip = 38; continue _fun111756 }
 20:
                    zulu = _closure2_slot2;
 ...
 0:
                        ...
                        if(mike) { _fun111759_ip = 345; continue _fun111759 }
 10:
                        tango = argFoo;
                        mike = undefined;
                        oscar = undefined;
 ...
 31: // try_start_0
                        ...
                        offset = offset.PHONE_VERIFICATION;
                        golf['step'] = offset;
 ...
 121:
                        ...
                        if(report) { _fun111759_ip = 157; continue _fun111759 }
 127:
                        golf = tango.token;
 ...
 152: // try_end0
                        _fun111759_ip = 342; continue _fun111759;
 157:
                        return tango;
 160: // catch_target0
                        ...
                        options = options.PHONE_VERIFICATION;
                        tango['step'] = options;
                        options = _closure1_slot7;
                        options = options.RESPONSE_ERROR;
                        tango['actionType'] = options;
                        options = ['code'];
                        tango['details'] = options;
                        tango = golf.bind(mike)(tango);
                        ...
                        golf = report == golf;
                        report = undefined;
                        if(golf) { _fun111759_ip = 258; continue _fun111759 }
 253:
                        report = oscar.message;
 258:
                        zulu = report;
                        if(report) { _fun111759_ip = 337; continue _fun111759 }
 264:
                        oscar = _closure1_slot0;
                        offset = _closure1_slot2;
                        report = 10;
                        golf = offset[report];
                        golf = oscar.bind(mike)(golf);
                        options = golf.intl;
                        golf = options.format;
 ...
 345:
        ...
        zulu[1] = result;
        zulu[2] = output;
        romeo = romeo.bind(sizing)(golf, zulu);
 ...
 0:
                        StartGenerator();
                        ResumeGenerator(result_out_reg=0, return_bool_out_reg=1);
                        if(mike) { _fun111763_ip = 62; continue _fun111763 }
 7:
 ...
 39:
                        ...
                        if(report) { _fun111763_ip = 59; continue _fun111763 }
 45:
                        report = _closure2_slot5;
                        tango = false;
 ...
 62:
        ...
        mike = new Array(1);
        mike[0] = romeo;
        zulu = golf.bind(sizing)(zulu, mike);
        mike = 11;
        mike = offset[mike];
        ...
        entity['error'] = foxtrot;
        entity['onCodeEntered'] = romeo;
        golf = offset[golf];
        golf = yankee.bind(tango)(golf);
        golf = golf.CodeType;
        golf = golf.NUMERIC;
        entity['codeType'] = golf;
        golf = 13;
        golf = offset[golf];
