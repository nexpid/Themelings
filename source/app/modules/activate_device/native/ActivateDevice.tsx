...
export default (function(argFoo, argBar, argBaz, argCorge, _, argFred, argPlugh) {
 ...
 120:
                    ...
                    tango = report.bind(oscar)(tango);
                    if(!tango) { _fun00004_ip = 231; continue _fun00003 }
 171:
 ...
 53:
            ...
            mike = golf.type;
            if(!(entity !== mike)) { _fun00002_ip = 525; continue _fun00001 }
 362:
            entity = 'authorization';
            if(!(entity !== mike)) { _fun00002_ip = 502; continue _fun00001 }
 373:
            entity = 'success';
            if(!(entity !== mike)) { _fun00002_ip = 442; continue _fun00001 }
 381:
            entity = 'error';
            yankee = null;
            if(!(entity === mike)) { _fun00002_ip = 592; continue _fun00001 }
 394:
